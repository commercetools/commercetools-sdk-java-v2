...
public class ByProjectKeyApiClientsGet {
   ...
   public com.commercetools.models.ApiClient.ApiClientPagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.ApiClient.ApiClientPagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
