...
public class ByProjectKeyCartDiscountsGet {
   ...
   public com.commercetools.models.CartDiscount.CartDiscountPagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.CartDiscount.CartDiscountPagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
