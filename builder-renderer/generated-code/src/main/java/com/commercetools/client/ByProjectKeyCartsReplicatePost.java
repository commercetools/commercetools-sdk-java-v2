...
public class ByProjectKeyCartsReplicatePost {
   ...
   private com.commercetools.models.Cart.ReplicaCartDraft replicaCartDraft;
   
   public ByProjectKeyCartsReplicatePost(final ApiHttpClient apiHttpClient, String projectKey, com.commercetools.models.Cart.ReplicaCartDraft replicaCartDraft){
   ...
   public ApiHttpRequest createHttpRequest() {
      ...
      try{httpRequest.setBody(CommercetoolsJsonUtils.toJsonString(replicaCartDraft));}catch(Exception e){e.printStackTrace();}
      return httpRequest;
   }
