...
public class ByProjectKeyCategoriesGet {
   ...
   public com.commercetools.models.Category.CategoryPagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.Category.CategoryPagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
