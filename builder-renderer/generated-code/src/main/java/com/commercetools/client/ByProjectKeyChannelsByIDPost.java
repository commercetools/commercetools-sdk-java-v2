...
public class ByProjectKeyChannelsByIDPost {
   ...
   private com.commercetools.models.Channel.ChannelUpdate channelUpdate;
   
   public ByProjectKeyChannelsByIDPost(final ApiHttpClient apiHttpClient, String projectKey, String ID, com.commercetools.models.Channel.ChannelUpdate channelUpdate){
   ...
   public ApiHttpRequest createHttpRequest() {
      ...
      try{httpRequest.setBody(CommercetoolsJsonUtils.toJsonString(channelUpdate));}catch(Exception e){e.printStackTrace();}
      return httpRequest;
   }
