...
public class ByProjectKeyChannelsGet {
   ...
   public com.commercetools.models.Channel.ChannelPagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.Channel.ChannelPagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
