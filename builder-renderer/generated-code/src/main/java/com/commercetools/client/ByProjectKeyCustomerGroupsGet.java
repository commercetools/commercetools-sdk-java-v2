...
public class ByProjectKeyCustomerGroupsGet {
   ...
   public com.commercetools.models.CustomerGroup.CustomerGroupPagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.CustomerGroup.CustomerGroupPagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
