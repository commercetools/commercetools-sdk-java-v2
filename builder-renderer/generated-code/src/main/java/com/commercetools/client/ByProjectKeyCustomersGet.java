...
public class ByProjectKeyCustomersGet {
   ...
   public com.commercetools.models.Customer.CustomerPagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.Customer.CustomerPagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
