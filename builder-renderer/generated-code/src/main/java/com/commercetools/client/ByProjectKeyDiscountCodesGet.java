...
public class ByProjectKeyDiscountCodesGet {
   ...
   public com.commercetools.models.DiscountCode.DiscountCodePagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.DiscountCode.DiscountCodePagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
