...
public class ByProjectKeyExtensionsGet {
   ...
   public com.commercetools.models.Extension.ExtensionPagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.Extension.ExtensionPagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
