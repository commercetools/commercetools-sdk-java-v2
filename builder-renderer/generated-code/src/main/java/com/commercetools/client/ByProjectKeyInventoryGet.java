...
public class ByProjectKeyInventoryGet {
   ...
   public com.commercetools.models.Inventory.InventoryPagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.Inventory.InventoryPagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
