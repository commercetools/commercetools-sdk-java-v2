...
public class ByProjectKeyMessagesGet {
   ...
   public com.commercetools.models.Message.MessagePagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.Message.MessagePagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
