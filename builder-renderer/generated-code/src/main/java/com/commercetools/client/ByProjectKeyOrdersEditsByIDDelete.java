...
public class ByProjectKeyOrdersEditsByIDDelete {
   ...
   public ByProjectKeyOrdersEditsByIDDelete withVersion(final List<Long> version){
   ...
   public ByProjectKeyOrdersEditsByIDDelete withExpand(final List<String> expand){
      this.expand = expand;
      return this;
   }
   
   public ByProjectKeyOrdersEditsByIDDelete addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyOrdersEditsByIDDelete withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyOrdersEditsByIDDelete addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyOrdersEditsByIDDelete setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
