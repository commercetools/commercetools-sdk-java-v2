...
public class ByProjectKeyOrdersEditsGet {
   ...
   public com.commercetools.models.OrderEdit.OrderEditPagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.OrderEdit.OrderEditPagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
