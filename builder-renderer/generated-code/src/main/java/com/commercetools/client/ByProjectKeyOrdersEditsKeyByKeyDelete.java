...
public class ByProjectKeyOrdersEditsKeyByKeyDelete {
   ...
   public com.commercetools.models.OrderEdit.OrderEdit executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.OrderEdit.OrderEdit.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
   ...
   public ByProjectKeyOrdersEditsKeyByKeyDelete withVersion(final List<Long> version){
   ...
   public ByProjectKeyOrdersEditsKeyByKeyDelete withExpand(final List<String> expand){
      this.expand = expand;
      return this;
   }
   
   public ByProjectKeyOrdersEditsKeyByKeyDelete addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyOrdersEditsKeyByKeyDelete withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyOrdersEditsKeyByKeyDelete addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyOrdersEditsKeyByKeyDelete setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
