...
public class ByProjectKeyOrdersEditsPost {
   ...
   private com.commercetools.models.OrderEdit.OrderEditDraft orderEditDraft;
   
   public ByProjectKeyOrdersEditsPost(final ApiHttpClient apiHttpClient, String projectKey, com.commercetools.models.OrderEdit.OrderEditDraft orderEditDraft){
   ...
   public ApiHttpRequest createHttpRequest() {
      ...
      try{httpRequest.setBody(CommercetoolsJsonUtils.toJsonString(orderEditDraft));}catch(Exception e){e.printStackTrace();}
      return httpRequest;
   }
