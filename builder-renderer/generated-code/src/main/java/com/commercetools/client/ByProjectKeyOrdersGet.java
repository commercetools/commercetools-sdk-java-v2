...
public class ByProjectKeyOrdersGet {
   ...
   public com.commercetools.models.Order.OrderPagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.Order.OrderPagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
