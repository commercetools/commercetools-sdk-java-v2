...
public class ByProjectKeyOrdersOrderNumberByOrderNumberPost {
   ...
   public ByProjectKeyOrdersOrderNumberByOrderNumberPost(final ApiHttpClient apiHttpClient, String projectKey, String orderNumber, com.commercetools.models.Order.OrderUpdate orderUpdate){
   ...
   public ByProjectKeyOrdersOrderNumberByOrderNumberPost addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyOrdersOrderNumberByOrderNumberPost withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyOrdersOrderNumberByOrderNumberPost addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyOrdersOrderNumberByOrderNumberPost setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
