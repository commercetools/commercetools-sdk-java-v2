...
public class ByProjectKeyPaymentsGet {
   ...
   public com.commercetools.models.Payment.PaymentPagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.Payment.PaymentPagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
