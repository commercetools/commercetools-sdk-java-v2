...
public class ByProjectKeyProductProjectionsByIDGet {
   ...
   public com.commercetools.models.Product.ProductProjection executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.Product.ProductProjection.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
