...
public class ByProjectKeyProductProjectionsGet {
   ...
   public com.commercetools.models.Product.ProductProjectionPagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.Product.ProductProjectionPagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
