...
public class ByProjectKeyProductProjectionsSearchGet {
   ...
   public com.commercetools.models.Product.ProductProjectionPagedSearchResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.Product.ProductProjectionPagedSearchResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
