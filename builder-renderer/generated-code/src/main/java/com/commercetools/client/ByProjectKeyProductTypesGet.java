...
public class ByProjectKeyProductTypesGet {
   ...
   public com.commercetools.models.ProductType.ProductTypePagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.ProductType.ProductTypePagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
