...
public class ByProjectKeyProductsByIDPost {
   ...
   public ByProjectKeyProductsByIDPost(final ApiHttpClient apiHttpClient, String projectKey, String ID, com.commercetools.models.Product.ProductUpdate productUpdate){
   ...
   public ApiHttpRequest createHttpRequest() {
      ...
      try{httpRequest.setBody(CommercetoolsJsonUtils.toJsonString(productUpdate));}catch(Exception e){e.printStackTrace();}
      return httpRequest;
   }
   ...
   public ByProjectKeyProductsByIDPost addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyProductsByIDPost withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyProductsByIDPost addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyProductsByIDPost setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
