...
public class ByProjectKeyReviewsPost {
   ...
   public ApiHttpRequest createHttpRequest() {
      ...
      try{httpRequest.setBody(CommercetoolsJsonUtils.toJsonString(reviewDraft));}catch(Exception e){e.printStackTrace();}
      return httpRequest;
   }
   ...
   public ByProjectKeyReviewsPost addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyReviewsPost withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyReviewsPost addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyReviewsPost setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
