...
public class ByProjectKeyShippingMethodsGet {
   ...
   public com.commercetools.models.ShippingMethod.ShippingMethodPagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.ShippingMethod.ShippingMethodPagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
