...
public class ByProjectKeyShoppingListsGet {
   ...
   public com.commercetools.models.ShoppingList.ShoppingListPagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.ShoppingList.ShoppingListPagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
