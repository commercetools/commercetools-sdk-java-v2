...
public class ByProjectKeyStoresByIDPost {
   ...
   public ByProjectKeyStoresByIDPost(final ApiHttpClient apiHttpClient, String projectKey, String ID, com.commercetools.models.Store.StoreUpdate storeUpdate){
