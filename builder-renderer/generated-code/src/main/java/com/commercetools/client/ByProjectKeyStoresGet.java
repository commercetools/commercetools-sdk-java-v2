...
public class ByProjectKeyStoresGet {
   ...
   public com.commercetools.models.Store.StorePagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.Store.StorePagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
