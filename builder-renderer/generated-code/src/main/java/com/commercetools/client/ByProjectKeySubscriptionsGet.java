...
public class ByProjectKeySubscriptionsGet {
   ...
   public com.commercetools.models.Subscription.SubscriptionPagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.Subscription.SubscriptionPagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
