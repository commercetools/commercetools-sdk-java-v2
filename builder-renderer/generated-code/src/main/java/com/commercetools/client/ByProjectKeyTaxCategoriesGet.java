...
public class ByProjectKeyTaxCategoriesGet {
   ...
   public com.commercetools.models.TaxCategory.TaxCategoryPagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.TaxCategory.TaxCategoryPagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
