...
public class ByProjectKeyZonesGet {
   ...
   public com.commercetools.models.Zone.ZonePagedQueryResponse executeBlocking() {
      ApiHttpResponse response;
      try {
         response = apiHttpClient.executeBlocking(this.createHttpRequest());
         return CommercetoolsJsonUtils.fromJsonString(response.getBody(),  com.commercetools.models.Zone.ZonePagedQueryResponse.class);
      } catch (Exception e) {
         e.printStackTrace();
      }
      return null;
