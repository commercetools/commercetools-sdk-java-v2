...
public final class CustomerResourceIdentifierImpl implements CustomerResourceIdentifier {
   ...
   @JsonCreator
   CustomerResourceIdentifierImpl(@JsonProperty("id") final java.lang.String id, @JsonProperty("key") final java.lang.String key) {
      this.id = id;
      this.key = key;
