...
public final class DiscountCodeUpdateImpl implements DiscountCodeUpdate {
   ...
   @JsonCreator
   DiscountCodeUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.models.DiscountCode.DiscountCodeUpdateAction> actions, @JsonProperty("version") final java.lang.Long version) {
   ...
   public void setActions(final java.util.List<com.commercetools.models.DiscountCode.DiscountCodeUpdateAction> actions){
      this.actions = actions;
   }
