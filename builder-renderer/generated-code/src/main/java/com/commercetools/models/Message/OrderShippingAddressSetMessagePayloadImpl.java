...
public final class OrderShippingAddressSetMessagePayloadImpl implements OrderShippingAddressSetMessagePayload {
   ...
   @JsonCreator
   OrderShippingAddressSetMessagePayloadImpl(@JsonProperty("oldAddress") final com.commercetools.models.Common.Address oldAddress, @JsonProperty("address") final com.commercetools.models.Common.Address address) {
