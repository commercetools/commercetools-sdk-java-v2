...
public final class ProductDiscountPagedQueryResponseImpl implements ProductDiscountPagedQueryResponse {
   ...
   @JsonCreator
   ProductDiscountPagedQueryResponseImpl(@JsonProperty("total") final java.lang.Long total, @JsonProperty("offset") final java.lang.Long offset, @JsonProperty("count") final java.lang.Long count, @JsonProperty("results") final java.util.List<com.commercetools.models.ProductDiscount.ProductDiscount> results) {
      this.total = total;
      this.offset = offset;
      this.count = count;
   ...
   public void setResults(final java.util.List<com.commercetools.models.ProductDiscount.ProductDiscount> results){
      this.results = results;
   }
