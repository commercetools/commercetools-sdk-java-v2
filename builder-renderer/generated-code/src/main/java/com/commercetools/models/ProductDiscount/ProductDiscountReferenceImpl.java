...
public final class ProductDiscountReferenceImpl implements ProductDiscountReference {
   ...
   @JsonCreator
   ProductDiscountReferenceImpl(@JsonProperty("id") final java.lang.String id, @JsonProperty("obj") final com.commercetools.models.ProductDiscount.ProductDiscount obj) {
      this.id = id;
      this.obj = obj;
