...
public final class ProductDiscountUpdateImpl implements ProductDiscountUpdate {
   ...
   @JsonCreator
   ProductDiscountUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.models.ProductDiscount.ProductDiscountUpdateAction> actions, @JsonProperty("version") final java.lang.Long version) {
   ...
   public void setActions(final java.util.List<com.commercetools.models.ProductDiscount.ProductDiscountUpdateAction> actions){
      this.actions = actions;
   }
