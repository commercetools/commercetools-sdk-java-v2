...
public final class ProductTypeChangeAttributeConstraintActionImpl implements ProductTypeChangeAttributeConstraintAction {
   ...
   @JsonCreator
   ProductTypeChangeAttributeConstraintActionImpl(@JsonProperty("newValue") final com.commercetools.models.ProductType.AttributeConstraintEnumDraft newValue, @JsonProperty("attributeName") final java.lang.String attributeName) {
   ...
   public void setNewValue(final com.commercetools.models.ProductType.AttributeConstraintEnumDraft newValue){
      this.newValue = newValue;
   }
