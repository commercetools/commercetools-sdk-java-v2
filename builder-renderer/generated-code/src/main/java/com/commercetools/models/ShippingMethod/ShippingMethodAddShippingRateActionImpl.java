...
public final class ShippingMethodAddShippingRateActionImpl implements ShippingMethodAddShippingRateAction {
   ...
   @JsonCreator
   ShippingMethodAddShippingRateActionImpl(@JsonProperty("shippingRate") final com.commercetools.models.ShippingMethod.ShippingRateDraft shippingRate, @JsonProperty("zone") final com.commercetools.models.Zone.ZoneResourceIdentifier zone) {
