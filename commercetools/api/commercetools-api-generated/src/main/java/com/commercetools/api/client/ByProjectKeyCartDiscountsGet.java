...
public class ByProjectKeyCartDiscountsGet {
   ...
   public ByProjectKeyCartDiscountsGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyCartDiscountsGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyCartDiscountsGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyCartDiscountsGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
