...
public class ByProjectKeyCategoriesGet {
   ...
   public ByProjectKeyCategoriesGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyCategoriesGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyCategoriesGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyCategoriesGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
