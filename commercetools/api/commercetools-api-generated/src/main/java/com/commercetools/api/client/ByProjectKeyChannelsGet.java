...
public class ByProjectKeyChannelsGet {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.models.channel.ChannelPagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  ...
                  return Utils.convertResponse(response,com.commercetools.api.models.channel.ChannelPagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyChannelsGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyChannelsGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyChannelsGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyChannelsGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
   ...
   public ByProjectKeyChannelsGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyChannelsGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyChannelsGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyChannelsGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
