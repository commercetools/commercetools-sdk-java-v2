...
public class ByProjectKeyCustomerGroupsGet {
   ...
   public ByProjectKeyCustomerGroupsGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyCustomerGroupsGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyCustomerGroupsGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyCustomerGroupsGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
