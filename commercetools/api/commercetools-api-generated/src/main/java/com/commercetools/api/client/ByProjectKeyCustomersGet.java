...
public class ByProjectKeyCustomersGet {
   ...
   public ByProjectKeyCustomersGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyCustomersGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyCustomersGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyCustomersGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
   ...
   public ByProjectKeyCustomersGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyCustomersGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyCustomersGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyCustomersGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
