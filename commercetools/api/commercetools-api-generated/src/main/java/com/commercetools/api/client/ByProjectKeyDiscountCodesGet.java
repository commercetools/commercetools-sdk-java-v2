...
public class ByProjectKeyDiscountCodesGet {
   ...
   public ByProjectKeyDiscountCodesGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyDiscountCodesGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyDiscountCodesGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyDiscountCodesGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
