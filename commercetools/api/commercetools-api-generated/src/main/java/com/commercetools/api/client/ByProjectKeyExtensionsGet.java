...
public class ByProjectKeyExtensionsGet {
   ...
   public ByProjectKeyExtensionsGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyExtensionsGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyExtensionsGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyExtensionsGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
