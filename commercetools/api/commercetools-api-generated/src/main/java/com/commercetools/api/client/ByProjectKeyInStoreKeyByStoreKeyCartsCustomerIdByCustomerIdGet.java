...
public class ByProjectKeyInStoreKeyByStoreKeyCartsCustomerIdByCustomerIdGet {
   ...
   public ByProjectKeyInStoreKeyByStoreKeyCartsCustomerIdByCustomerIdGet withExpand(final List<String> expand){
      this.expand = expand;
      return this;
   }
   
   public ByProjectKeyInStoreKeyByStoreKeyCartsCustomerIdByCustomerIdGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyInStoreKeyByStoreKeyCartsCustomerIdByCustomerIdGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyInStoreKeyByStoreKeyCartsCustomerIdByCustomerIdGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyInStoreKeyByStoreKeyCartsCustomerIdByCustomerIdGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
