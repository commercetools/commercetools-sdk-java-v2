...
public class ByProjectKeyInStoreKeyByStoreKeyCustomersGet {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.models.customer.CustomerPagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  ...
                  return Utils.convertResponse(response,com.commercetools.api.models.customer.CustomerPagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyInStoreKeyByStoreKeyCustomersGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyInStoreKeyByStoreKeyCustomersGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyInStoreKeyByStoreKeyCustomersGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyInStoreKeyByStoreKeyCustomersGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
