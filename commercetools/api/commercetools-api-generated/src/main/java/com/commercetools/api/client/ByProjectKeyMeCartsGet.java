...
public class ByProjectKeyMeCartsGet {
   ...
   public ByProjectKeyMeCartsGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyMeCartsGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyMeCartsGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyMeCartsGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
