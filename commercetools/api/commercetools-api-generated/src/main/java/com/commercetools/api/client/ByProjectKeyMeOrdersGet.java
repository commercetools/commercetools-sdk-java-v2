...
public class ByProjectKeyMeOrdersGet {
   ...
   public ByProjectKeyMeOrdersGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyMeOrdersGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyMeOrdersGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyMeOrdersGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
