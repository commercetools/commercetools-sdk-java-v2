...
public class ByProjectKeyMePaymentsGet {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.models.me.MyPaymentPagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  ...
                  return Utils.convertResponse(response,com.commercetools.api.models.me.MyPaymentPagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyMePaymentsGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyMePaymentsGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyMePaymentsGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyMePaymentsGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
   ...
   public ByProjectKeyMePaymentsGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyMePaymentsGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyMePaymentsGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyMePaymentsGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
