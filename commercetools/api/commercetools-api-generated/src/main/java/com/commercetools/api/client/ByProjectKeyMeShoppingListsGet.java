...
public class ByProjectKeyMeShoppingListsGet {
   ...
   public ByProjectKeyMeShoppingListsGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyMeShoppingListsGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyMeShoppingListsGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyMeShoppingListsGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
