...
public class ByProjectKeyMeShoppingListsKeyByKeyGet {
   ...
   public ByProjectKeyMeShoppingListsKeyByKeyGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyMeShoppingListsKeyByKeyGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyMeShoppingListsKeyByKeyGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyMeShoppingListsKeyByKeyGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
