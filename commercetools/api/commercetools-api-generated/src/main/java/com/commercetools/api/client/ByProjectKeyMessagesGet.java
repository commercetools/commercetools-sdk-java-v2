...
public class ByProjectKeyMessagesGet {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.models.message.MessagePagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  ...
                  return Utils.convertResponse(response,com.commercetools.api.models.message.MessagePagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyMessagesGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyMessagesGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyMessagesGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyMessagesGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
   ...
   public ByProjectKeyMessagesGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyMessagesGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyMessagesGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyMessagesGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
