...
public class ByProjectKeyOrdersByIDPost {
    ...
    public ByProjectKeyOrdersByIDPost(final ApiHttpClient apiHttpClient, String projectKey, String ID, com.commercetools.api.models.order.OrderUpdate orderUpdate){
