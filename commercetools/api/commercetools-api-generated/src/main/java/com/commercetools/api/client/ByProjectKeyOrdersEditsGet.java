...
public class ByProjectKeyOrdersEditsGet {
   ...
   public ByProjectKeyOrdersEditsGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyOrdersEditsGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyOrdersEditsGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyOrdersEditsGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
