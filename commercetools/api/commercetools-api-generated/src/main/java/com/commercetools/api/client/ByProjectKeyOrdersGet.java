...
public class ByProjectKeyOrdersGet {
   ...
   public ByProjectKeyOrdersGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyOrdersGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyOrdersGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyOrdersGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
