...
public class ByProjectKeyPaymentsGet {
   ...
   public ByProjectKeyPaymentsGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyPaymentsGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyPaymentsGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyPaymentsGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
