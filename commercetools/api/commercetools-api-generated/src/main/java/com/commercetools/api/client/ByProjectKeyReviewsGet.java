...
public class ByProjectKeyReviewsGet {
   ...
   public ByProjectKeyReviewsGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyReviewsGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyReviewsGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyReviewsGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
