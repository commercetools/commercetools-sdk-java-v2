...
public class ByProjectKeyShoppingListsGet {
   ...
   public ByProjectKeyShoppingListsGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyShoppingListsGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyShoppingListsGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyShoppingListsGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
