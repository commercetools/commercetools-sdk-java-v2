...
public class ByProjectKeyStatesGet {
   ...
   public ByProjectKeyStatesGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyStatesGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyStatesGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyStatesGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
