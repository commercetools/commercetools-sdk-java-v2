...
public class ByProjectKeyStoresGet {
   ...
   public ByProjectKeyStoresGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyStoresGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyStoresGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyStoresGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
