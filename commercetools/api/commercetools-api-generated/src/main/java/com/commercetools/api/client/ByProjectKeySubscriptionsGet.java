...
public class ByProjectKeySubscriptionsGet {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.models.subscription.SubscriptionPagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  ...
                  return Utils.convertResponse(response,com.commercetools.api.models.subscription.SubscriptionPagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeySubscriptionsGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeySubscriptionsGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeySubscriptionsGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeySubscriptionsGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
   ...
   public ByProjectKeySubscriptionsGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeySubscriptionsGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeySubscriptionsGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeySubscriptionsGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
