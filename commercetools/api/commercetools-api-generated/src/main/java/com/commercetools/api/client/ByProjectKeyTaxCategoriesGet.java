...
public class ByProjectKeyTaxCategoriesGet {
   ...
   public ByProjectKeyTaxCategoriesGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyTaxCategoriesGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyTaxCategoriesGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyTaxCategoriesGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
