...
public class ByProjectKeyTypesGet {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.models.type.TypePagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  ...
                  return Utils.convertResponse(response,com.commercetools.api.models.type.TypePagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyTypesGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyTypesGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyTypesGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyTypesGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
