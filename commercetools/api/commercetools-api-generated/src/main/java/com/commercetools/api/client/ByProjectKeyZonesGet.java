...
public class ByProjectKeyZonesGet {
   ...
   public ByProjectKeyZonesGet addLimit(final Double limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyZonesGet withLimit(final List<Double> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyZonesGet addOffset(final Double offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyZonesGet withOffset(final List<Double> offset){
      this.offset = offset;
      return this;
   }
