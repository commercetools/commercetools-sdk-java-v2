...
public final class CartUpdateImpl implements CartUpdate {
   ...
   @JsonCreator
   CartUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.api.models.cart.CartUpdateAction> actions, @JsonProperty("version") final Long version) {
