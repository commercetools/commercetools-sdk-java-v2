...
public final class DiscountedLineItemPortionImpl implements DiscountedLineItemPortion {
   ...
   @JsonCreator
   DiscountedLineItemPortionImpl(@JsonProperty("discountedAmount") final com.commercetools.api.models.common.TypedMoney discountedAmount, @JsonProperty("discount") final com.commercetools.api.models.cart_discount.CartDiscountReference discount) {
