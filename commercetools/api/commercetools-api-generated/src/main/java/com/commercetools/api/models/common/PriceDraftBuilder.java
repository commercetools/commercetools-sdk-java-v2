...
public final class PriceDraftBuilder {
    ...
    public PriceDraftBuilder discounted(@Nullable final com.commercetools.api.models.common.DiscountedPrice discounted) {
    ...
    public PriceDraft build() {
        return new PriceDraftImpl(value, country, customerGroup, channel, validFrom, validUntil, custom, tiers, discounted);
    }
