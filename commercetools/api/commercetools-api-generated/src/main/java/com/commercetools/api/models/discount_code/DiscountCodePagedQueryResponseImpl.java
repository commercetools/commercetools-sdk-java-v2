...
public final class DiscountCodePagedQueryResponseImpl implements DiscountCodePagedQueryResponse {
   ...
   @JsonCreator
   DiscountCodePagedQueryResponseImpl(@JsonProperty("total") final Long total, @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count, @JsonProperty("limit") final Long limit, @JsonProperty("results") final java.util.List<com.commercetools.api.models.discount_code.DiscountCode> results) {
      this.total = total;
      this.offset = offset;
      this.count = count;
      this.limit = limit;
