...
public final class DiscountCodeSetCustomTypeActionImpl implements DiscountCodeSetCustomTypeAction {
   ...
   @JsonCreator
   DiscountCodeSetCustomTypeActionImpl(@JsonProperty("fields") final com.commercetools.api.models.type.FieldContainer fields, @JsonProperty("type") final com.commercetools.api.models.type.TypeResourceIdentifier type) {
      this.fields = fields;
      this.type = type;
