...
public final class VariantValuesImpl implements VariantValues {
   ...
   @JsonCreator
   VariantValuesImpl(@JsonProperty("attributes") final java.util.List<com.commercetools.api.models.product.Attribute> attributes, @JsonProperty("prices") final java.util.List<com.commercetools.api.models.common.PriceDraft> prices, @JsonProperty("sku") final String sku) {
