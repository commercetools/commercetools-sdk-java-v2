...
public final class ExtensionInputImpl implements ExtensionInput {
   ...
   @JsonCreator
   ExtensionInputImpl(@JsonProperty("resource") final com.commercetools.api.models.common.Reference resource, @JsonProperty("action") final com.commercetools.api.models.extension.ExtensionAction action) {
