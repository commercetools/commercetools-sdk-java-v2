...
public final class MyPaymentDraftImpl implements MyPaymentDraft {
   ...
   @JsonCreator
   MyPaymentDraftImpl(@JsonProperty("paymentMethodInfo") final com.commercetools.api.models.payment.PaymentMethodInfo paymentMethodInfo, @JsonProperty("custom") final com.commercetools.api.models.type.CustomFieldsDraft custom, @JsonProperty("amountPlanned") final com.commercetools.api.models.common.Money amountPlanned, @JsonProperty("transaction") final com.commercetools.api.models.me.MyTransactionDraft transaction) {
