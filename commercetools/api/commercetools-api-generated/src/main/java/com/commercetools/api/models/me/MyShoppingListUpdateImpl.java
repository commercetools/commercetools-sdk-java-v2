...
public final class MyShoppingListUpdateImpl implements MyShoppingListUpdate {
   ...
   @JsonCreator
   MyShoppingListUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.api.models.me.MyShoppingListUpdateAction> actions, @JsonProperty("version") final Long version) {
