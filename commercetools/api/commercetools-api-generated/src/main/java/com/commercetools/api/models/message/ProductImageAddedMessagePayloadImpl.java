...
public final class ProductImageAddedMessagePayloadImpl implements ProductImageAddedMessagePayload {
   ...
   @JsonCreator
   ProductImageAddedMessagePayloadImpl(@JsonProperty("image") final com.commercetools.api.models.common.Image image, @JsonProperty("staged") final Boolean staged, @JsonProperty("variantId") final Long variantId) {
      this.image = image;
      this.staged = staged;
