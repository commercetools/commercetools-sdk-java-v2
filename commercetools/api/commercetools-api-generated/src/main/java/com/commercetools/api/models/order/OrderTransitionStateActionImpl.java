...
public final class OrderTransitionStateActionImpl implements OrderTransitionStateAction {
   ...
   @JsonCreator
   OrderTransitionStateActionImpl(@JsonProperty("force") final Boolean force, @JsonProperty("state") final com.commercetools.api.models.state.StateResourceIdentifier state) {
      this.force = force;
      this.state = state;
