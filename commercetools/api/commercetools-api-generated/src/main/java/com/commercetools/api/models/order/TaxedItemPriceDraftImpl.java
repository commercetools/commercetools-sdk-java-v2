...
public final class TaxedItemPriceDraftImpl implements TaxedItemPriceDraft {
   ...
   @JsonCreator
   TaxedItemPriceDraftImpl(@JsonProperty("totalGross") final com.commercetools.api.models.common.Money totalGross, @JsonProperty("totalNet") final com.commercetools.api.models.common.Money totalNet) {
