...
public final class OrderEditPagedQueryResponseImpl implements OrderEditPagedQueryResponse {
   ...
   @JsonCreator
   OrderEditPagedQueryResponseImpl(@JsonProperty("limit") final Long limit, @JsonProperty("count") final Long count, @JsonProperty("total") final Long total, @JsonProperty("offset") final Long offset, @JsonProperty("results") final java.util.List<com.commercetools.api.models.order_edit.OrderEdit> results) {
      this.limit = limit;
      this.count = count;
      this.total = total;
      this.offset = offset;
