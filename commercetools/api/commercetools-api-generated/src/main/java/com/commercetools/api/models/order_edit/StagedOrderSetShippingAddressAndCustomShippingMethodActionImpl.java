...
public final class StagedOrderSetShippingAddressAndCustomShippingMethodActionImpl implements StagedOrderSetShippingAddressAndCustomShippingMethodAction {
   ...
   @JsonCreator
   StagedOrderSetShippingAddressAndCustomShippingMethodActionImpl(@JsonProperty("shippingRate") final com.commercetools.api.models.shipping_method.ShippingRateDraft shippingRate, @JsonProperty("externalTaxRate") final com.commercetools.api.models.cart.ExternalTaxRateDraft externalTaxRate, @JsonProperty("address") final com.commercetools.api.models.common.Address address, @JsonProperty("shippingMethodName") final String shippingMethodName, @JsonProperty("taxCategory") final com.commercetools.api.models.tax_category.TaxCategoryResourceIdentifier taxCategory) {
