...
public final class ProductChangePriceActionImpl implements ProductChangePriceAction {
   ...
   @JsonCreator
   ProductChangePriceActionImpl(@JsonProperty("price") final com.commercetools.api.models.common.PriceDraft price, @JsonProperty("staged") final Boolean staged, @JsonProperty("priceId") final String priceId) {
      this.price = price;
      this.staged = staged;
