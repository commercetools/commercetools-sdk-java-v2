...
public final class ProjectUpdateImpl implements ProjectUpdate {
   ...
   @JsonCreator
   ProjectUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.api.models.project.ProjectUpdateAction> actions, @JsonProperty("version") final Long version) {
