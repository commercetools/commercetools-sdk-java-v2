...
public final class ReviewTransitionStateActionImpl implements ReviewTransitionStateAction {
   ...
   @JsonCreator
   ReviewTransitionStateActionImpl(@JsonProperty("force") final Boolean force, @JsonProperty("state") final com.commercetools.api.models.state.StateResourceIdentifier state) {
      this.force = force;
      this.state = state;
