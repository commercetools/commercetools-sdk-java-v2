...
public final class StoreUpdateImpl implements StoreUpdate {
   ...
   @JsonCreator
   StoreUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.api.models.store.StoreUpdateAction> actions, @JsonProperty("version") final Long version) {
