...
public final class TaxCategoryDraftImpl implements TaxCategoryDraft {
   ...
   @JsonCreator
   TaxCategoryDraftImpl(@JsonProperty("rates") final java.util.List<com.commercetools.api.models.tax_category.TaxRateDraft> rates, @JsonProperty("name") final String name, @JsonProperty("description") final String description, @JsonProperty("key") final String key) {
      this.rates = rates;
      this.name = name;
