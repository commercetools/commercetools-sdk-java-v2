...
public final class TaxCategoryUpdateImpl implements TaxCategoryUpdate {
   ...
   @JsonCreator
   TaxCategoryUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.api.models.tax_category.TaxCategoryUpdateAction> actions, @JsonProperty("version") final Long version) {
