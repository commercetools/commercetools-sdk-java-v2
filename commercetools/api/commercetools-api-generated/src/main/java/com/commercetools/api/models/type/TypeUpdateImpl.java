...
public final class TypeUpdateImpl implements TypeUpdate {
   ...
   @JsonCreator
   TypeUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.api.models.type.TypeUpdateAction> actions, @JsonProperty("version") final Long version) {
