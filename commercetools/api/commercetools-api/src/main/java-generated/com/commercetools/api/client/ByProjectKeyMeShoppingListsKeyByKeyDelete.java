...
public class ByProjectKeyMeShoppingListsKeyByKeyDelete {
    ...
    public ByProjectKeyMeShoppingListsKeyByKeyDelete addHeader(final String key, final String value) {
        this.headers.addHeader(key, value);
        return this;
    }
    
    public ByProjectKeyMeShoppingListsKeyByKeyDelete withHeaders(final ApiHttpHeaders headers) {
    ...
    public ByProjectKeyMeShoppingListsKeyByKeyDelete addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
        this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
        return this;
    }
    
    public ByProjectKeyMeShoppingListsKeyByKeyDelete setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
