...
public final class DeliveryAddressSetMessageBuilder {
    ...
    public DeliveryAddressSetMessage build() {
        return new DeliveryAddressSetMessageImpl(id, version, createdAt, lastModifiedAt, lastModifiedBy, createdBy, sequenceNumber, resource, resourceVersion, resourceUserProvidedIdentifiers, deliveryId, address, oldAddress);
    }
