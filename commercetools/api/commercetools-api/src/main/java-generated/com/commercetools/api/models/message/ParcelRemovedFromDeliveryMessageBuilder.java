...
public final class ParcelRemovedFromDeliveryMessageBuilder {
    ...
    public ParcelRemovedFromDeliveryMessage build() {
        return new ParcelRemovedFromDeliveryMessageImpl(id, version, createdAt, lastModifiedAt, lastModifiedBy, createdBy, sequenceNumber, resource, resourceVersion, resourceUserProvidedIdentifiers, deliveryId, parcel);
    }
