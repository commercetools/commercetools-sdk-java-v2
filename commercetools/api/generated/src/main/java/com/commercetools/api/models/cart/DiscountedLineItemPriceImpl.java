...
public final class DiscountedLineItemPriceImpl implements DiscountedLineItemPrice {
   ...
   @JsonCreator
   DiscountedLineItemPriceImpl(@JsonProperty("includedDiscounts") final java.util.List<com.commercetools.api.models.cart.DiscountedLineItemPortion> includedDiscounts, @JsonProperty("value") final com.commercetools.api.models.common.TypedMoney value) {
