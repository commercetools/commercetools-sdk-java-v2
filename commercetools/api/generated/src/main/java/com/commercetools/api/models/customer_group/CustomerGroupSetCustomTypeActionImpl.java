...
public final class CustomerGroupSetCustomTypeActionImpl implements CustomerGroupSetCustomTypeAction {
   ...
   @JsonCreator
   CustomerGroupSetCustomTypeActionImpl(@JsonProperty("fields") final com.commercetools.api.models.type.FieldContainer fields, @JsonProperty("type") final com.commercetools.api.models.type.TypeResourceIdentifier type) {
      this.fields = fields;
      this.type = type;
