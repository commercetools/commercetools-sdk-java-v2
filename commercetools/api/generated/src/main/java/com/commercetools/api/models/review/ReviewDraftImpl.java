...
public final class ReviewDraftImpl implements ReviewDraft {
   ...
   @JsonCreator
   ReviewDraftImpl(@JsonProperty("uniquenessValue") final String uniquenessValue, @JsonProperty("authorName") final String authorName, @JsonProperty("custom") final com.commercetools.api.models.type.CustomFieldsDraft custom, @JsonProperty("rating") final Integer rating, @JsonProperty("state") final com.commercetools.api.models.state.StateResourceIdentifier state, @JsonProperty("text") final String text, @JsonProperty("title") final String title, @JsonProperty("locale") final String locale, @JsonProperty("key") final String key, @JsonProperty("customer") final com.commercetools.api.models.customer.CustomerResourceIdentifier customer, @JsonProperty("target") final com.fasterxml.jackson.databind.JsonNode target) {
