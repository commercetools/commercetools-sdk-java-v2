...
public final class ShippingRateImpl implements ShippingRate {
   ...
   @JsonCreator
   ShippingRateImpl(@JsonProperty("tiers") final java.util.List<com.commercetools.api.models.shipping_method.ShippingRatePriceTier> tiers, @JsonProperty("price") final com.commercetools.api.models.common.TypedMoney price, @JsonProperty("freeAbove") final com.commercetools.api.models.common.TypedMoney freeAbove, @JsonProperty("isMatching") final Boolean isMatching) {
      this.tiers = tiers;
      this.price = price;
