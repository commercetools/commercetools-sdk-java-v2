...
public class ByProjectKeyCartDiscountsGet {
   ...
   public ApiHttpResponse<com.commercetools.api.generated.models.cart_discount.CartDiscountPagedQueryResponse> executeBlocking(){
      try {
          return execute().get();
      } catch (Exception e) {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.generated.models.cart_discount.CartDiscountPagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  if(response.getStatusCode() >= 400){
                      throw new ApiHttpException(response.getStatusCode(), new String(response.getBody()), response.getHeaders());
                  }
                  return Utils.convertResponse(response,com.commercetools.api.generated.models.cart_discount.CartDiscountPagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyCartDiscountsGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyCartDiscountsGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyCartDiscountsGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyCartDiscountsGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
