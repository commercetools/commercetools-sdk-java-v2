...
public class ByProjectKeyCategoriesGet {
   ...
   public ApiHttpResponse<com.commercetools.api.generated.models.category.CategoryPagedQueryResponse> executeBlocking(){
      try {
          return execute().get();
      } catch (Exception e) {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.generated.models.category.CategoryPagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  if(response.getStatusCode() >= 400){
                      throw new ApiHttpException(response.getStatusCode(), new String(response.getBody()), response.getHeaders());
                  }
                  return Utils.convertResponse(response,com.commercetools.api.generated.models.category.CategoryPagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyCategoriesGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyCategoriesGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyCategoriesGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyCategoriesGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
