...
public class ByProjectKeyChannelsByIDDelete {
   ...
   public ByProjectKeyChannelsByIDDelete addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyChannelsByIDDelete withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyChannelsByIDDelete addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyChannelsByIDDelete setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
