...
public class ByProjectKeyCustomerGroupsGet {
   ...
   public ApiHttpResponse<com.commercetools.api.generated.models.customer_group.CustomerGroupPagedQueryResponse> executeBlocking(){
      try {
          return execute().get();
      } catch (Exception e) {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.generated.models.customer_group.CustomerGroupPagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  if(response.getStatusCode() >= 400){
                      throw new ApiHttpException(response.getStatusCode(), new String(response.getBody()), response.getHeaders());
                  }
                  return Utils.convertResponse(response,com.commercetools.api.generated.models.customer_group.CustomerGroupPagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyCustomerGroupsGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyCustomerGroupsGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyCustomerGroupsGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyCustomerGroupsGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
