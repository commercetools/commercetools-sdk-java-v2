...
public class ByProjectKeyDiscountCodesByIDDelete {
   ...
   public ByProjectKeyDiscountCodesByIDDelete addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyDiscountCodesByIDDelete withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyDiscountCodesByIDDelete addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyDiscountCodesByIDDelete setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
