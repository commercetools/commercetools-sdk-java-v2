...
public class ByProjectKeyDiscountCodesByIDPost {
   ...
   private com.commercetools.api.generated.models.discount_code.DiscountCodeUpdate discountCodeUpdate;
   
   public ByProjectKeyDiscountCodesByIDPost(final ApiHttpClient apiHttpClient, String projectKey, String ID, com.commercetools.api.generated.models.discount_code.DiscountCodeUpdate discountCodeUpdate){
   ...
   public ApiHttpRequest createHttpRequest() {
      ...
      try{httpRequest.setBody(VrapJsonUtils.toJsonByteArray(discountCodeUpdate));}catch(Exception e){e.printStackTrace();}
      return httpRequest;
   }
