...
public class ByProjectKeyDiscountCodesGet {
   ...
   public ApiHttpResponse<com.commercetools.api.generated.models.discount_code.DiscountCodePagedQueryResponse> executeBlocking(){
      try {
          return execute().get();
      } catch (Exception e) {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.generated.models.discount_code.DiscountCodePagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  if(response.getStatusCode() >= 400){
                      throw new ApiHttpException(response.getStatusCode(), new String(response.getBody()), response.getHeaders());
                  }
                  return Utils.convertResponse(response,com.commercetools.api.generated.models.discount_code.DiscountCodePagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyDiscountCodesGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyDiscountCodesGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyDiscountCodesGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyDiscountCodesGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
