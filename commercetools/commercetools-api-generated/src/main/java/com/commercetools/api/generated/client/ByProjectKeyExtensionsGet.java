...
public class ByProjectKeyExtensionsGet {
   ...
   public ApiHttpResponse<com.commercetools.api.generated.models.extension.ExtensionPagedQueryResponse> executeBlocking(){
      try {
          return execute().get();
      } catch (Exception e) {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.generated.models.extension.ExtensionPagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  if(response.getStatusCode() >= 400){
                      throw new ApiHttpException(response.getStatusCode(), new String(response.getBody()), response.getHeaders());
                  }
                  return Utils.convertResponse(response,com.commercetools.api.generated.models.extension.ExtensionPagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyExtensionsGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyExtensionsGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyExtensionsGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyExtensionsGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
