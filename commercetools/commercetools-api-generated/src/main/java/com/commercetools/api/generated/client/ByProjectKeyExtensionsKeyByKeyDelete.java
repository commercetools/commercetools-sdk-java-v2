...
public class ByProjectKeyExtensionsKeyByKeyDelete {
   ...
   public ByProjectKeyExtensionsKeyByKeyDelete addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyExtensionsKeyByKeyDelete withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyExtensionsKeyByKeyDelete addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyExtensionsKeyByKeyDelete setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
