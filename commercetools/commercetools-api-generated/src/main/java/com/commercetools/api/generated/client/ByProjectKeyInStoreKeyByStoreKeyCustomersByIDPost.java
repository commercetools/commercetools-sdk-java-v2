...
public class ByProjectKeyInStoreKeyByStoreKeyCustomersByIDPost {
   ...
   public ByProjectKeyInStoreKeyByStoreKeyCustomersByIDPost(final ApiHttpClient apiHttpClient, String projectKey, String storeKey, String ID, com.commercetools.api.generated.models.common.Update update){
   ...
   public ByProjectKeyInStoreKeyByStoreKeyCustomersByIDPost addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyInStoreKeyByStoreKeyCustomersByIDPost withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyInStoreKeyByStoreKeyCustomersByIDPost addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyInStoreKeyByStoreKeyCustomersByIDPost setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
