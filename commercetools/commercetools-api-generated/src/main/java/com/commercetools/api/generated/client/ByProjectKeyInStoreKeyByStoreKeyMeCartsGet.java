...
public class ByProjectKeyInStoreKeyByStoreKeyMeCartsGet {
   ...
   public ByProjectKeyInStoreKeyByStoreKeyMeCartsGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyInStoreKeyByStoreKeyMeCartsGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyInStoreKeyByStoreKeyMeCartsGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyInStoreKeyByStoreKeyMeCartsGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
