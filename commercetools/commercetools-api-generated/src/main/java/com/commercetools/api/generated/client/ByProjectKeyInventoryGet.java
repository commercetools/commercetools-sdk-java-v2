...
public class ByProjectKeyInventoryGet {
   ...
   public ApiHttpResponse<com.commercetools.api.generated.models.inventory.InventoryPagedQueryResponse> executeBlocking(){
      try {
          return execute().get();
      } catch (Exception e) {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.generated.models.inventory.InventoryPagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  if(response.getStatusCode() >= 400){
                      throw new ApiHttpException(response.getStatusCode(), new String(response.getBody()), response.getHeaders());
                  }
                  return Utils.convertResponse(response,com.commercetools.api.generated.models.inventory.InventoryPagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyInventoryGet withExpand(final List<String> expand){
      this.expand = expand;
      return this;
   }
   ...
   public ByProjectKeyInventoryGet withWhere(final List<String> where){
      this.where = where;
      return this;
   }
   ...
   public ByProjectKeyInventoryGet withSort(final List<String> sort){
      this.sort = sort;
      return this;
   }
   ...
   public ByProjectKeyInventoryGet withWithTotal(final List<Boolean> withTotal){
      this.withTotal = withTotal;
      return this;
   }
   
   public ByProjectKeyInventoryGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyInventoryGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyInventoryGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyInventoryGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
