...
public class ByProjectKeyMePaymentsPost {
   ...
   private com.commercetools.api.generated.models.me.MyPaymentDraft myPaymentDraft;
   
   public ByProjectKeyMePaymentsPost(final ApiHttpClient apiHttpClient, String projectKey, com.commercetools.api.generated.models.me.MyPaymentDraft myPaymentDraft){
   ...
   public ByProjectKeyMePaymentsPost addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyMePaymentsPost withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyMePaymentsPost addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyMePaymentsPost setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
