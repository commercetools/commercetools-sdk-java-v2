...
public class ByProjectKeyMeShoppingListsByIDPost {
   ...
   public ByProjectKeyMeShoppingListsByIDPost(final ApiHttpClient apiHttpClient, String projectKey, String ID, com.commercetools.api.generated.models.me.MyShoppingListUpdate myShoppingListUpdate){
   ...
   public ByProjectKeyMeShoppingListsByIDPost addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyMeShoppingListsByIDPost withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyMeShoppingListsByIDPost addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyMeShoppingListsByIDPost setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
