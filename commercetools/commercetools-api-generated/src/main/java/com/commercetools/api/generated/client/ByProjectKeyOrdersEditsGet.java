...
public class ByProjectKeyOrdersEditsGet {
   ...
   public ApiHttpResponse<com.commercetools.api.generated.models.order_edit.OrderEditPagedQueryResponse> executeBlocking(){
      try {
          return execute().get();
      } catch (Exception e) {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.generated.models.order_edit.OrderEditPagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  if(response.getStatusCode() >= 400){
                      throw new ApiHttpException(response.getStatusCode(), new String(response.getBody()), response.getHeaders());
                  }
                  return Utils.convertResponse(response,com.commercetools.api.generated.models.order_edit.OrderEditPagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyOrdersEditsGet addLimit(final Integer limit){
   ...
   public ByProjectKeyOrdersEditsGet addOffset(final Integer offset){
   ...
   public ByProjectKeyOrdersEditsGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyOrdersEditsGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyOrdersEditsGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyOrdersEditsGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
