...
public class ByProjectKeyOrdersEditsKeyByKeyPost {
   ...
   public ByProjectKeyOrdersEditsKeyByKeyPost(final ApiHttpClient apiHttpClient, String projectKey, String key, com.commercetools.api.generated.models.order_edit.OrderEditUpdate orderEditUpdate){
   ...
   public ByProjectKeyOrdersEditsKeyByKeyPost addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyOrdersEditsKeyByKeyPost withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyOrdersEditsKeyByKeyPost addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyOrdersEditsKeyByKeyPost setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
