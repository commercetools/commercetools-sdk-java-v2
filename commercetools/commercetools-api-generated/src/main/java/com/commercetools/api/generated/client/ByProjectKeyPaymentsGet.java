...
public class ByProjectKeyPaymentsGet {
   ...
   public ApiHttpResponse<com.commercetools.api.generated.models.payment.PaymentPagedQueryResponse> executeBlocking(){
      try {
          return execute().get();
      } catch (Exception e) {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.generated.models.payment.PaymentPagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  if(response.getStatusCode() >= 400){
                      throw new ApiHttpException(response.getStatusCode(), new String(response.getBody()), response.getHeaders());
                  }
                  return Utils.convertResponse(response,com.commercetools.api.generated.models.payment.PaymentPagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyPaymentsGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyPaymentsGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyPaymentsGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyPaymentsGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
