...
public class ByProjectKeyProductProjectionsGet {
   ...
   public ApiHttpResponse<com.commercetools.api.generated.models.product.ProductProjectionPagedQueryResponse> executeBlocking(){
      try {
          return execute().get();
      } catch (Exception e) {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.generated.models.product.ProductProjectionPagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  if(response.getStatusCode() >= 400){
                      throw new ApiHttpException(response.getStatusCode(), new String(response.getBody()), response.getHeaders());
                  }
                  return Utils.convertResponse(response,com.commercetools.api.generated.models.product.ProductProjectionPagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyProductProjectionsGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyProductProjectionsGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyProductProjectionsGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyProductProjectionsGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
