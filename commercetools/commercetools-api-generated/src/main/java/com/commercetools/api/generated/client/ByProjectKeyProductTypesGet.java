...
public class ByProjectKeyProductTypesGet {
   ...
   public ApiHttpResponse<com.commercetools.api.generated.models.product_type.ProductTypePagedQueryResponse> executeBlocking(){
      try {
          return execute().get();
      } catch (Exception e) {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.generated.models.product_type.ProductTypePagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  if(response.getStatusCode() >= 400){
                      throw new ApiHttpException(response.getStatusCode(), new String(response.getBody()), response.getHeaders());
                  }
                  return Utils.convertResponse(response,com.commercetools.api.generated.models.product_type.ProductTypePagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyProductTypesGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyProductTypesGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyProductTypesGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyProductTypesGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
