...
public class ByProjectKeyReviewsGet {
   ...
   public ApiHttpResponse<com.commercetools.api.generated.models.review.ReviewPagedQueryResponse> executeBlocking(){
      try {
          return execute().get();
      } catch (Exception e) {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.generated.models.review.ReviewPagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  if(response.getStatusCode() >= 400){
                      throw new ApiHttpException(response.getStatusCode(), new String(response.getBody()), response.getHeaders());
                  }
                  return Utils.convertResponse(response,com.commercetools.api.generated.models.review.ReviewPagedQueryResponse.class);
              });
   }
