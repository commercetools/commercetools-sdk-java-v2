...
public class ByProjectKeyShoppingListsGet {
   ...
   public ApiHttpResponse<com.commercetools.api.generated.models.shopping_list.ShoppingListPagedQueryResponse> executeBlocking(){
      try {
          return execute().get();
      } catch (Exception e) {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.generated.models.shopping_list.ShoppingListPagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  if(response.getStatusCode() >= 400){
                      throw new ApiHttpException(response.getStatusCode(), new String(response.getBody()), response.getHeaders());
                  }
                  return Utils.convertResponse(response,com.commercetools.api.generated.models.shopping_list.ShoppingListPagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyShoppingListsGet addLimit(final Integer limit){
   ...
   public ByProjectKeyShoppingListsGet addOffset(final Integer offset){
   ...
   public ByProjectKeyShoppingListsGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyShoppingListsGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyShoppingListsGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyShoppingListsGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
