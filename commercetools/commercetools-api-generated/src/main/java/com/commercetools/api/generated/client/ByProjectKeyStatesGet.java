...
public class ByProjectKeyStatesGet {
   ...
   public ApiHttpResponse<com.commercetools.api.generated.models.state.StatePagedQueryResponse> executeBlocking(){
      try {
          return execute().get();
      } catch (Exception e) {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.generated.models.state.StatePagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  if(response.getStatusCode() >= 400){
                      throw new ApiHttpException(response.getStatusCode(), new String(response.getBody()), response.getHeaders());
                  }
                  return Utils.convertResponse(response,com.commercetools.api.generated.models.state.StatePagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyStatesGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyStatesGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyStatesGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyStatesGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
