...
public class ByProjectKeyTypesGet {
   ...
   public ApiHttpResponse<com.commercetools.api.generated.models.type.TypePagedQueryResponse> executeBlocking(){
      try {
          return execute().get();
      } catch (Exception e) {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.generated.models.type.TypePagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  if(response.getStatusCode() >= 400){
                      throw new ApiHttpException(response.getStatusCode(), new String(response.getBody()), response.getHeaders());
                  }
                  return Utils.convertResponse(response,com.commercetools.api.generated.models.type.TypePagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyTypesGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyTypesGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyTypesGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyTypesGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
