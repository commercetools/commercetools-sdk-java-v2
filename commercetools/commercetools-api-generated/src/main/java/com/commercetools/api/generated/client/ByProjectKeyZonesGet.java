...
public class ByProjectKeyZonesGet {
   ...
   public ApiHttpResponse<com.commercetools.api.generated.models.zone.ZonePagedQueryResponse> executeBlocking(){
      try {
          return execute().get();
      } catch (Exception e) {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.generated.models.zone.ZonePagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  if(response.getStatusCode() >= 400){
                      throw new ApiHttpException(response.getStatusCode(), new String(response.getBody()), response.getHeaders());
                  }
                  return Utils.convertResponse(response,com.commercetools.api.generated.models.zone.ZonePagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyZonesGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyZonesGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyZonesGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyZonesGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
