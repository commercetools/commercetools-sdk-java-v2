...
public final class CartSetLineItemCustomFieldActionImpl implements CartSetLineItemCustomFieldAction {
   ...
   @JsonCreator
   CartSetLineItemCustomFieldActionImpl(@JsonProperty("lineItemId") final String lineItemId, @JsonProperty("name") final String name, @JsonProperty("value") final JsonNode value) {
