...
public final class CartSetLineItemPriceActionImpl implements CartSetLineItemPriceAction {
   ...
   @JsonCreator
   CartSetLineItemPriceActionImpl(@JsonProperty("lineItemId") final String lineItemId, @JsonProperty("externalPrice") final com.commercetools.api.generated.models.common.Money externalPrice) {
