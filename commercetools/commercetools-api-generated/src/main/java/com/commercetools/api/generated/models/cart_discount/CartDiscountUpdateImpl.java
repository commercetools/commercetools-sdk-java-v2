...
public final class CartDiscountUpdateImpl implements CartDiscountUpdate {
   ...
   @JsonCreator
   CartDiscountUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.api.generated.models.cart_discount.CartDiscountUpdateAction> actions, @JsonProperty("version") final Long version) {
   ...
   public void setActions(final java.util.List<com.commercetools.api.generated.models.cart_discount.CartDiscountUpdateAction> actions){
      this.actions = actions;
   }
