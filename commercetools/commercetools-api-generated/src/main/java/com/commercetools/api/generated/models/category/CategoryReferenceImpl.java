...
public final class CategoryReferenceImpl implements CategoryReference {
   ...
   @JsonCreator
   CategoryReferenceImpl(@JsonProperty("id") final String id, @JsonProperty("obj") final com.commercetools.api.generated.models.category.Category obj) {
      this.id = id;
      this.obj = obj;
   ...
   public void setObj(final com.commercetools.api.generated.models.category.Category obj){
      this.obj = obj;
   }
