...
public final class CategorySetAssetSourcesActionImpl implements CategorySetAssetSourcesAction {
   ...
   @JsonCreator
   CategorySetAssetSourcesActionImpl(@JsonProperty("sources") final java.util.List<com.commercetools.api.generated.models.common.AssetSource> sources, @JsonProperty("assetId") final String assetId, @JsonProperty("assetKey") final String assetKey) {
