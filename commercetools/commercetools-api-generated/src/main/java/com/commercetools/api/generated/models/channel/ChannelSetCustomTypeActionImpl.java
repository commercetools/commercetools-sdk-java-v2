...
public final class ChannelSetCustomTypeActionImpl implements ChannelSetCustomTypeAction {
   ...
   @JsonCreator
   ChannelSetCustomTypeActionImpl(@JsonProperty("fields") final com.commercetools.api.generated.models.type.FieldContainer fields, @JsonProperty("type") final com.commercetools.api.generated.models.type.TypeResourceIdentifier type) {
      this.fields = fields;
      this.type = type;
