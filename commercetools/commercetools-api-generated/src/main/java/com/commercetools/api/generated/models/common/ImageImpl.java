...
public final class ImageImpl implements Image {
   ...
   @JsonCreator
   ImageImpl(@JsonProperty("label") final String label, @JsonProperty("url") final String url, @JsonProperty("dimensions") final com.commercetools.api.generated.models.common.ImageDimensions dimensions) {
      this.label = label;
      this.url = url;
   ...
   public void setDimensions(final com.commercetools.api.generated.models.common.ImageDimensions dimensions){
      this.dimensions = dimensions;
   }
