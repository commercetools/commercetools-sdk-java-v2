...
public final class PriceTierImpl implements PriceTier {
   ...
   @JsonCreator
   PriceTierImpl(@JsonProperty("value") final com.commercetools.api.generated.models.common.TypedMoney value, @JsonProperty("minimumQuantity") final Long minimumQuantity) {
      this.value = value;
