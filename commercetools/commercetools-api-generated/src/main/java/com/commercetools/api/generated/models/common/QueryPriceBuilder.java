...
public final class QueryPriceBuilder {
   ...
   public QueryPriceBuilder discounted(@Nullable final com.commercetools.api.generated.models.common.DiscountedPrice discounted) {
   ...
   public QueryPriceBuilder tiers(@Nullable final java.util.List<com.commercetools.api.generated.models.common.PriceTierDraft> tiers) {
      this.tiers = tiers;
      return this;
   }
   
   public QueryPriceBuilder customerGroup(@Nullable final com.commercetools.api.generated.models.customer_group.CustomerGroupReference customerGroup) {
      this.customerGroup = customerGroup;
      return this;
   }
   
   public QueryPriceBuilder custom(@Nullable final com.commercetools.api.generated.models.type.CustomFields custom) {
      this.custom = custom;
      return this;
   }
   
   public QueryPriceBuilder channel(@Nullable final com.commercetools.api.generated.models.channel.ChannelReference channel) {
   ...
   public QueryPriceBuilder value( final com.commercetools.api.generated.models.common.Money value) {
      this.value = value;
      return this;
   }
