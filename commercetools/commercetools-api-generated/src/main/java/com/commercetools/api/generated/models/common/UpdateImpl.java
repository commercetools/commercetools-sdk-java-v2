...
public final class UpdateImpl implements Update {
   ...
   @JsonCreator
   UpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.api.generated.models.common.UpdateAction> actions, @JsonProperty("version") final Long version) {
   ...
   public void setActions(final java.util.List<com.commercetools.api.generated.models.common.UpdateAction> actions){
      this.actions = actions;
   }
