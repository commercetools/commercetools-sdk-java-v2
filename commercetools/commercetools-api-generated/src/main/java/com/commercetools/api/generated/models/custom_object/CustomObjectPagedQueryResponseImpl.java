...
public final class CustomObjectPagedQueryResponseImpl implements CustomObjectPagedQueryResponse {
   ...
   @JsonCreator
   CustomObjectPagedQueryResponseImpl(@JsonProperty("total") final Long total, @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count, @JsonProperty("limit") final Long limit, @JsonProperty("results") final java.util.List<com.commercetools.api.generated.models.custom_object.CustomObject> results) {
      this.total = total;
      this.offset = offset;
      this.count = count;
      this.limit = limit;
   ...
   public void setResults(final java.util.List<com.commercetools.api.generated.models.custom_object.CustomObject> results){
      this.results = results;
   }
