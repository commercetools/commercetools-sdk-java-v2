...
public final class CustomObjectReferenceImpl implements CustomObjectReference {
   ...
   @JsonCreator
   CustomObjectReferenceImpl(@JsonProperty("id") final String id, @JsonProperty("obj") final com.commercetools.api.generated.models.custom_object.CustomObject obj) {
      this.id = id;
      this.obj = obj;
   ...
   public void setObj(final com.commercetools.api.generated.models.custom_object.CustomObject obj){
      this.obj = obj;
   }
