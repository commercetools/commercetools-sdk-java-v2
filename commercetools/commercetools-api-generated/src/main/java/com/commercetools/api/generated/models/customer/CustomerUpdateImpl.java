...
public final class CustomerUpdateImpl implements CustomerUpdate {
   ...
   @JsonCreator
   CustomerUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.api.generated.models.customer.CustomerUpdateAction> actions, @JsonProperty("version") final Long version) {
   ...
   public void setActions(final java.util.List<com.commercetools.api.generated.models.customer.CustomerUpdateAction> actions){
      this.actions = actions;
   }
