...
public final class DiscountCodeReferenceImpl implements DiscountCodeReference {
   ...
   @JsonCreator
   DiscountCodeReferenceImpl(@JsonProperty("id") final String id, @JsonProperty("obj") final com.commercetools.api.generated.models.discount_code.DiscountCode obj) {
      this.id = id;
      this.obj = obj;
   ...
   public void setObj(final com.commercetools.api.generated.models.discount_code.DiscountCode obj){
      this.obj = obj;
   }
