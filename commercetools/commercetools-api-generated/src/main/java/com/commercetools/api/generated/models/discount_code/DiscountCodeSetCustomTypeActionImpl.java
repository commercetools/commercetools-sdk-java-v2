...
public final class DiscountCodeSetCustomTypeActionImpl implements DiscountCodeSetCustomTypeAction {
   ...
   @JsonCreator
   DiscountCodeSetCustomTypeActionImpl(@JsonProperty("fields") final com.commercetools.api.generated.models.type.FieldContainer fields, @JsonProperty("type") final com.commercetools.api.generated.models.type.TypeResourceIdentifier type) {
      this.fields = fields;
      this.type = type;
