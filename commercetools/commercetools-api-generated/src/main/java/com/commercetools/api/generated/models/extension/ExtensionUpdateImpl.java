...
public final class ExtensionUpdateImpl implements ExtensionUpdate {
   ...
   @JsonCreator
   ExtensionUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.api.generated.models.extension.ExtensionUpdateAction> actions, @JsonProperty("version") final Long version) {
   ...
   public void setActions(final java.util.List<com.commercetools.api.generated.models.extension.ExtensionUpdateAction> actions){
      this.actions = actions;
   }
