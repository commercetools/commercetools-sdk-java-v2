...
public final class InventoryEntryReferenceImpl implements InventoryEntryReference {
   ...
   private com.commercetools.api.generated.models.inventory.InventoryEntry obj;

   @JsonCreator
   InventoryEntryReferenceImpl(@JsonProperty("id") final String id, @JsonProperty("obj") final com.commercetools.api.generated.models.inventory.InventoryEntry obj) {
      this.id = id;
      this.obj = obj;
   ...
   public com.commercetools.api.generated.models.inventory.InventoryEntry getObj(){
      return this.obj;
   }
   ...
   public void setObj(final com.commercetools.api.generated.models.inventory.InventoryEntry obj){
      this.obj = obj;
   }
