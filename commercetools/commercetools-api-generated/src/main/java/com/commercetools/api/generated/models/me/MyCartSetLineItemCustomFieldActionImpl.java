...
public final class MyCartSetLineItemCustomFieldActionImpl implements MyCartSetLineItemCustomFieldAction {
   ...
   @JsonCreator
   MyCartSetLineItemCustomFieldActionImpl(@JsonProperty("lineItemId") final String lineItemId, @JsonProperty("name") final String name, @JsonProperty("value") final JsonNode value) {
