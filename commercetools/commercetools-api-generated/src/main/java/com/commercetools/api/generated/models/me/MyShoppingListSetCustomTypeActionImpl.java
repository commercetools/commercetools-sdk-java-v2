...
public final class MyShoppingListSetCustomTypeActionImpl implements MyShoppingListSetCustomTypeAction {
   ...
   @JsonCreator
   MyShoppingListSetCustomTypeActionImpl(@JsonProperty("fields") final com.commercetools.api.generated.models.type.FieldContainer fields, @JsonProperty("type") final com.commercetools.api.generated.models.type.TypeResourceIdentifier type) {
      this.fields = fields;
      this.type = type;
