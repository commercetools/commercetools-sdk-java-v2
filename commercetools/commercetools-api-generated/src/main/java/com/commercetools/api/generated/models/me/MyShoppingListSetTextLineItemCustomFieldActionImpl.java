...
public final class MyShoppingListSetTextLineItemCustomFieldActionImpl implements MyShoppingListSetTextLineItemCustomFieldAction {
   ...
   @JsonCreator
   MyShoppingListSetTextLineItemCustomFieldActionImpl(@JsonProperty("name") final String name, @JsonProperty("value") final JsonNode value, @JsonProperty("textLineItemId") final String textLineItemId) {
      this.name = name;
      this.value = value;
