...
public final class InventoryEntryDeletedMessagePayloadImpl implements InventoryEntryDeletedMessagePayload {
   ...
   @JsonCreator
   InventoryEntryDeletedMessagePayloadImpl(@JsonProperty("supplyChannel") final com.commercetools.api.generated.models.channel.ChannelReference supplyChannel, @JsonProperty("sku") final String sku) {
