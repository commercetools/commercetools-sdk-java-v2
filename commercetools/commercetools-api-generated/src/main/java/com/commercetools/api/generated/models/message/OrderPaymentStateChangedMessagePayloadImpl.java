...
public final class OrderPaymentStateChangedMessagePayloadImpl implements OrderPaymentStateChangedMessagePayload {
   ...
   @JsonCreator
   OrderPaymentStateChangedMessagePayloadImpl(@JsonProperty("oldPaymentState") final com.commercetools.api.generated.models.order.PaymentState oldPaymentState, @JsonProperty("paymentState") final com.commercetools.api.generated.models.order.PaymentState paymentState) {
   ...
   public void setOldPaymentState(final com.commercetools.api.generated.models.order.PaymentState oldPaymentState){
      this.oldPaymentState = oldPaymentState;
   }
