...
public final class OrderShipmentStateChangedMessagePayloadImpl implements OrderShipmentStateChangedMessagePayload {
   ...
   @JsonCreator
   OrderShipmentStateChangedMessagePayloadImpl(@JsonProperty("shipmentState") final com.commercetools.api.generated.models.order.ShipmentState shipmentState, @JsonProperty("oldShipmentState") final com.commercetools.api.generated.models.order.ShipmentState oldShipmentState) {
   ...
   public void setOldShipmentState(final com.commercetools.api.generated.models.order.ShipmentState oldShipmentState){
      this.oldShipmentState = oldShipmentState;
   }
