...
public final class ParcelTrackingDataUpdatedMessagePayloadImpl implements ParcelTrackingDataUpdatedMessagePayload {
   ...
   @JsonCreator
   ParcelTrackingDataUpdatedMessagePayloadImpl(@JsonProperty("deliveryId") final String deliveryId, @JsonProperty("trackingData") final com.commercetools.api.generated.models.order.TrackingData trackingData, @JsonProperty("parcelId") final String parcelId) {
