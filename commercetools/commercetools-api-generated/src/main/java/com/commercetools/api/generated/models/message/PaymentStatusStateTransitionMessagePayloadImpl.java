...
public final class PaymentStatusStateTransitionMessagePayloadImpl implements PaymentStatusStateTransitionMessagePayload {
   ...
   @JsonCreator
   PaymentStatusStateTransitionMessagePayloadImpl(@JsonProperty("force") final Boolean force, @JsonProperty("state") final com.commercetools.api.generated.models.state.StateReference state) {
      this.force = force;
      this.state = state;
