...
public final class ProductAddedToCategoryMessagePayloadImpl implements ProductAddedToCategoryMessagePayload {
   ...
   @JsonCreator
   ProductAddedToCategoryMessagePayloadImpl(@JsonProperty("staged") final Boolean staged, @JsonProperty("category") final com.commercetools.api.generated.models.category.CategoryReference category) {
      this.staged = staged;
