...
public final class ProductPublishedMessageImpl implements ProductPublishedMessage {
   ...
   public void setRemovedImageUrls(final java.util.List<JsonNode> removedImageUrls){
      this.removedImageUrls = removedImageUrls;
   }
