...
@JsonSubTypes({
   @JsonSubTypes.Type(value = com.commercetools.api.generated.models.order.CustomLineItemReturnItemImpl.class, name = "CustomLineItemReturnItem"),
   @JsonSubTypes.Type(value = com.commercetools.api.generated.models.order.LineItemReturnItemImpl.class, name = "LineItemReturnItem")
})
@JsonTypeInfo(
