...
public final class OrderEditBuilder {
   ...
   public OrderEditBuilder createdBy(@Nullable final com.commercetools.api.generated.models.common.CreatedBy createdBy) {
      this.createdBy = createdBy;
      return this;
   }
   
   public OrderEditBuilder lastModifiedBy(@Nullable final com.commercetools.api.generated.models.common.LastModifiedBy lastModifiedBy) {
      this.lastModifiedBy = lastModifiedBy;
      return this;
   }
   
   public OrderEditBuilder result( final com.commercetools.api.generated.models.order_edit.OrderEditResult result) {
      this.result = result;
      return this;
   }
   
   public OrderEditBuilder resource( final com.commercetools.api.generated.models.order.OrderReference resource) {
      this.resource = resource;
      return this;
   }
   
   public OrderEditBuilder custom(@Nullable final com.commercetools.api.generated.models.type.CustomFields custom) {
      this.custom = custom;
      return this;
   }
   ...
   public OrderEditBuilder stagedActions( final java.util.List<com.commercetools.api.generated.models.order.StagedOrderUpdateAction> stagedActions) {
