...
public final class OrderEditPreviewSuccessImpl implements OrderEditPreviewSuccess {
   ...
   @JsonCreator
   OrderEditPreviewSuccessImpl(@JsonProperty("preview") final com.commercetools.api.generated.models.order_edit.StagedOrder preview, @JsonProperty("messagePayloads") final java.util.List<com.commercetools.api.generated.models.message.MessagePayload> messagePayloads) {
   ...
   public void setPreview(final com.commercetools.api.generated.models.order_edit.StagedOrder preview){
      this.preview = preview;
   }
   
   public void setMessagePayloads(final java.util.List<com.commercetools.api.generated.models.message.MessagePayload> messagePayloads){
      this.messagePayloads = messagePayloads;
   }
