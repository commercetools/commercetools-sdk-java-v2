...
public final class OrderExcerptImpl implements OrderExcerpt {
   ...
   @JsonCreator
   OrderExcerptImpl(@JsonProperty("totalPrice") final com.commercetools.api.generated.models.common.TypedMoney totalPrice, @JsonProperty("taxedPrice") final com.commercetools.api.generated.models.cart.TaxedPrice taxedPrice, @JsonProperty("version") final Integer version) {
