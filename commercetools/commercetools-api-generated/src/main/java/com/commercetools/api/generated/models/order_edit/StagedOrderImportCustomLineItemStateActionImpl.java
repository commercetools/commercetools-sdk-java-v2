...
public final class StagedOrderImportCustomLineItemStateActionImpl implements StagedOrderImportCustomLineItemStateAction {
   ...
   @JsonCreator
   StagedOrderImportCustomLineItemStateActionImpl(@JsonProperty("customLineItemId") final String customLineItemId, @JsonProperty("state") final java.util.List<com.commercetools.api.generated.models.order.ItemState> state) {
