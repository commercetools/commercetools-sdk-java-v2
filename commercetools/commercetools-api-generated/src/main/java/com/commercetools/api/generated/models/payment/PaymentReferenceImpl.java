...
public final class PaymentReferenceImpl implements PaymentReference {
   ...
   @JsonCreator
   PaymentReferenceImpl(@JsonProperty("id") final String id, @JsonProperty("obj") final com.commercetools.api.generated.models.payment.Payment obj) {
      this.id = id;
      this.obj = obj;
   ...
   public void setObj(final com.commercetools.api.generated.models.payment.Payment obj){
      this.obj = obj;
   }
