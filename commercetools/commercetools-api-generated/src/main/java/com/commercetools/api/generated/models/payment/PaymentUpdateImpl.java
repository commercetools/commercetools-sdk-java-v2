...
public final class PaymentUpdateImpl implements PaymentUpdate {
   ...
   @JsonCreator
   PaymentUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.api.generated.models.payment.PaymentUpdateAction> actions, @JsonProperty("version") final Long version) {
   ...
   public void setActions(final java.util.List<com.commercetools.api.generated.models.payment.PaymentUpdateAction> actions){
      this.actions = actions;
   }
