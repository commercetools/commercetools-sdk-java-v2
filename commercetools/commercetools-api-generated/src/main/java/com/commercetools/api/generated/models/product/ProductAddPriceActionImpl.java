...
public final class ProductAddPriceActionImpl implements ProductAddPriceAction {
   ...
   @JsonCreator
   ProductAddPriceActionImpl(@JsonProperty("price") final com.commercetools.api.generated.models.common.PriceDraft price, @JsonProperty("staged") final Boolean staged, @JsonProperty("variantId") final Long variantId, @JsonProperty("sku") final String sku) {
      this.price = price;
      this.staged = staged;
