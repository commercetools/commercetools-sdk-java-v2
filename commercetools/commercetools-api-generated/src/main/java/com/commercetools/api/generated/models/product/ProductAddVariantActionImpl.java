...
public final class ProductAddVariantActionImpl implements ProductAddVariantAction {
   ...
   @JsonCreator
   ProductAddVariantActionImpl(@JsonProperty("images") final java.util.List<com.commercetools.api.generated.models.common.Image> images, @JsonProperty("assets") final java.util.List<com.commercetools.api.generated.models.common.Asset> assets, @JsonProperty("attributes") final java.util.List<com.commercetools.api.generated.models.product.Attribute> attributes, @JsonProperty("staged") final Boolean staged, @JsonProperty("prices") final java.util.List<com.commercetools.api.generated.models.common.PriceDraft> prices, @JsonProperty("sku") final String sku, @JsonProperty("key") final String key) {
      this.images = images;
      this.assets = assets;
