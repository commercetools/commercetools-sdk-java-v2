...
public final class ProductReferenceImpl implements ProductReference {
   ...
   @JsonCreator
   ProductReferenceImpl(@JsonProperty("id") final String id, @JsonProperty("obj") final com.commercetools.api.generated.models.product.Product obj) {
      this.id = id;
      this.obj = obj;
   ...
   public void setObj(final com.commercetools.api.generated.models.product.Product obj){
      this.obj = obj;
   }
