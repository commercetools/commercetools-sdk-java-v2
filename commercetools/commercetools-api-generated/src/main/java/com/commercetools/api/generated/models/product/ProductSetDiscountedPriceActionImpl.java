...
public final class ProductSetDiscountedPriceActionImpl implements ProductSetDiscountedPriceAction {
   ...
   @JsonCreator
   ProductSetDiscountedPriceActionImpl(@JsonProperty("discounted") final com.commercetools.api.generated.models.common.DiscountedPrice discounted, @JsonProperty("staged") final Boolean staged, @JsonProperty("priceId") final String priceId) {
