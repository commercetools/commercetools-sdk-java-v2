...
public final class ProductVariantChannelAvailabilityMapBuilder {
   ...
   public ProductVariantChannelAvailabilityMapBuilder values( final Map<String, com.commercetools.api.generated.models.product.ProductVariantChannelAvailability> values){
      this.values = values;
      return this;
   }
   
   
   public Map<String, com.commercetools.api.generated.models.product.ProductVariantChannelAvailability> getValues(){
      return this.values;
   }
