...
public final class ProductDiscountReferenceImpl implements ProductDiscountReference {
   ...
   @JsonCreator
   ProductDiscountReferenceImpl(@JsonProperty("id") final String id, @JsonProperty("obj") final com.commercetools.api.generated.models.product_discount.ProductDiscount obj) {
      this.id = id;
      this.obj = obj;
   ...
   public void setObj(final com.commercetools.api.generated.models.product_discount.ProductDiscount obj){
      this.obj = obj;
   }
