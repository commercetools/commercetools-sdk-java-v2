...
public final class AttributeDefinitionDraftBuilder {
   ...
   public AttributeDefinitionDraftBuilder attributeConstraint(@Nullable final com.commercetools.api.generated.models.product_type.AttributeConstraintEnum attributeConstraint) {
   ...
   public AttributeDefinitionDraftBuilder inputHint(@Nullable final com.commercetools.api.generated.models.product_type.TextInputHint inputHint) {
   ...
   public AttributeDefinitionDraftBuilder label( final com.commercetools.api.generated.models.common.LocalizedString label) {
      this.label = label;
      return this;
   }
   
   public AttributeDefinitionDraftBuilder type( final com.commercetools.api.generated.models.product_type.AttributeType type) {
      this.type = type;
      return this;
   }
   
   public AttributeDefinitionDraftBuilder inputTip(@Nullable final com.commercetools.api.generated.models.common.LocalizedString inputTip) {
