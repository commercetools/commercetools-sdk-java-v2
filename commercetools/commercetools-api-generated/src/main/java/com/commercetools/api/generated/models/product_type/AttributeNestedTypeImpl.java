...
public final class AttributeNestedTypeImpl implements AttributeNestedType {
   ...
   @JsonCreator
   AttributeNestedTypeImpl(@JsonProperty("typeReference") final com.commercetools.api.generated.models.product_type.ProductTypeReference typeReference) {
   ...
   public void setTypeReference(final com.commercetools.api.generated.models.product_type.ProductTypeReference typeReference){
      this.typeReference = typeReference;
   }
