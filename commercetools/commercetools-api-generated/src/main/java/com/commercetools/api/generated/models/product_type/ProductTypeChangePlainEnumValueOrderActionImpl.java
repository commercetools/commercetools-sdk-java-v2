...
public final class ProductTypeChangePlainEnumValueOrderActionImpl implements ProductTypeChangePlainEnumValueOrderAction {
   ...
   @JsonCreator
   ProductTypeChangePlainEnumValueOrderActionImpl(@JsonProperty("values") final java.util.List<com.commercetools.api.generated.models.product_type.AttributePlainEnumValue> values, @JsonProperty("attributeName") final String attributeName) {
      this.values = values;
