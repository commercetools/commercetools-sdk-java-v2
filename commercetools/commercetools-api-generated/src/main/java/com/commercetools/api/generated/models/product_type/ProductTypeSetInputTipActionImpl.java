...
public final class ProductTypeSetInputTipActionImpl implements ProductTypeSetInputTipAction {
   ...
   @JsonCreator
   ProductTypeSetInputTipActionImpl(@JsonProperty("attributeName") final String attributeName, @JsonProperty("inputTip") final com.commercetools.api.generated.models.common.LocalizedString inputTip) {
