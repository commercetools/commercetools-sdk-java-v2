...
public final class ProductTypeUpdateImpl implements ProductTypeUpdate {
   ...
   @JsonCreator
   ProductTypeUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.api.generated.models.product_type.ProductTypeUpdateAction> actions, @JsonProperty("version") final Long version) {
   ...
   public void setActions(final java.util.List<com.commercetools.api.generated.models.product_type.ProductTypeUpdateAction> actions){
      this.actions = actions;
   }
