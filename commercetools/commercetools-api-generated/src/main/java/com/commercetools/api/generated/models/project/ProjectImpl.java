...
public final class ProjectImpl implements Project {
   ...
   @JsonCreator
   ProjectImpl(@JsonProperty("externalOAuth") final com.commercetools.api.generated.models.project.ExternalOAuth externalOAuth, @JsonProperty("shippingRateInputType") final com.commercetools.api.generated.models.project.ShippingRateInputType shippingRateInputType, @JsonProperty("createdAt") final java.time.ZonedDateTime createdAt, @JsonProperty("languages") final java.util.List<String> languages, @JsonProperty("name") final String name, @JsonProperty("messages") final com.commercetools.api.generated.models.message.MessageConfiguration messages, @JsonProperty("countries") final java.util.List<String> countries, @JsonProperty("trialUntil") final String trialUntil, @JsonProperty("version") final Long version, @JsonProperty("key") final String key, @JsonProperty("currencies") final java.util.List<String> currencies) {
   ...
   */
   ...
   public void setMessages(final com.commercetools.api.generated.models.message.MessageConfiguration messages){
      this.messages = messages;
   }
