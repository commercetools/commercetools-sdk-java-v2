...
public final class ProjectUpdateImpl implements ProjectUpdate {
   ...
   @JsonCreator
   ProjectUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.api.generated.models.project.ProjectUpdateAction> actions, @JsonProperty("version") final Long version) {
   ...
   public void setActions(final java.util.List<com.commercetools.api.generated.models.project.ProjectUpdateAction> actions){
      this.actions = actions;
   }
