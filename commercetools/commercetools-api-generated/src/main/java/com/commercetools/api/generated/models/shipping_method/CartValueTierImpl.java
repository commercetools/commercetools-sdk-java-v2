...
public final class CartValueTierImpl implements CartValueTier {
   ...
   @JsonCreator
   CartValueTierImpl(@JsonProperty("minimumCentAmount") final Long minimumCentAmount, @JsonProperty("price") final com.commercetools.api.generated.models.common.Money price, @JsonProperty("isMatching") final Boolean isMatching) {
