...
public final class ShippingMethodBuilder {
   ...
   public ShippingMethodBuilder createdBy(@Nullable final com.commercetools.api.generated.models.common.CreatedBy createdBy) {
      this.createdBy = createdBy;
      return this;
   }
   
   public ShippingMethodBuilder lastModifiedBy(@Nullable final com.commercetools.api.generated.models.common.LastModifiedBy lastModifiedBy) {
      this.lastModifiedBy = lastModifiedBy;
      return this;
   }
   
   public ShippingMethodBuilder zoneRates( final java.util.List<com.commercetools.api.generated.models.shipping_method.ZoneRate> zoneRates) {
   ...
   public ShippingMethodBuilder taxCategory( final com.commercetools.api.generated.models.tax_category.TaxCategoryReference taxCategory) {
