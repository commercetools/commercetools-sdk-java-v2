...
public final class ZoneRateBuilder {
   ...
   public ZoneRateBuilder zone( final com.commercetools.api.generated.models.zone.ZoneReference zone) {
      this.zone = zone;
      return this;
   }
   
   public ZoneRateBuilder shippingRates( final java.util.List<com.commercetools.api.generated.models.shipping_method.ShippingRate> shippingRates) {
