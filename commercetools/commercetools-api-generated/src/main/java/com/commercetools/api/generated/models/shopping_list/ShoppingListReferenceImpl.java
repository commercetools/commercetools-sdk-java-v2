...
public final class ShoppingListReferenceImpl implements ShoppingListReference {
   ...
   @JsonCreator
   ShoppingListReferenceImpl(@JsonProperty("id") final String id, @JsonProperty("obj") final com.commercetools.api.generated.models.shopping_list.ShoppingList obj) {
      this.id = id;
      this.obj = obj;
   ...
   public void setObj(final com.commercetools.api.generated.models.shopping_list.ShoppingList obj){
      this.obj = obj;
   }
