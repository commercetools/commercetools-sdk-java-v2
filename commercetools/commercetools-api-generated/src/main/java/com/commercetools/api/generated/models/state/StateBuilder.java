...
public final class StateBuilder {
   ...
   public StateBuilder createdBy(@Nullable final com.commercetools.api.generated.models.common.CreatedBy createdBy) {
      this.createdBy = createdBy;
      return this;
   }
   
   public StateBuilder lastModifiedBy(@Nullable final com.commercetools.api.generated.models.common.LastModifiedBy lastModifiedBy) {
   ...
   public StateBuilder roles(@Nullable final java.util.List<com.commercetools.api.generated.models.state.StateRoleEnum> roles) {
      this.roles = roles;
      return this;
   }
   ...
   public StateBuilder transitions(@Nullable final java.util.List<com.commercetools.api.generated.models.state.StateReference> transitions) {
