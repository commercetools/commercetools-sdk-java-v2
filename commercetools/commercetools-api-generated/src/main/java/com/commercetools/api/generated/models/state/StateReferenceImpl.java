...
public final class StateReferenceImpl implements StateReference {
   ...
   @JsonCreator
   StateReferenceImpl(@JsonProperty("id") final String id, @JsonProperty("obj") final com.commercetools.api.generated.models.state.State obj) {
      this.id = id;
      this.obj = obj;
   ...
   public void setObj(final com.commercetools.api.generated.models.state.State obj){
      this.obj = obj;
   }
