...
public final class StateUpdateImpl implements StateUpdate {
   ...
   @JsonCreator
   StateUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.api.generated.models.state.StateUpdateAction> actions, @JsonProperty("version") final Long version) {
   ...
   public void setActions(final java.util.List<com.commercetools.api.generated.models.state.StateUpdateAction> actions){
      this.actions = actions;
   }
