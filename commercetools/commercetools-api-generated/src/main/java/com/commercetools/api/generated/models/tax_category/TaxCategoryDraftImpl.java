...
public final class TaxCategoryDraftImpl implements TaxCategoryDraft {
   ...
   @JsonCreator
   TaxCategoryDraftImpl(@JsonProperty("rates") final java.util.List<com.commercetools.api.generated.models.tax_category.TaxRateDraft> rates, @JsonProperty("name") final String name, @JsonProperty("description") final String description, @JsonProperty("key") final String key) {
      this.rates = rates;
      this.name = name;
   ...
   public void setRates(final java.util.List<com.commercetools.api.generated.models.tax_category.TaxRateDraft> rates){
      this.rates = rates;
   }
