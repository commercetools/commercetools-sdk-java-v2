...
public final class TypeChangeFieldDefinitionLabelActionImpl implements TypeChangeFieldDefinitionLabelAction {
   ...
   @JsonCreator
   TypeChangeFieldDefinitionLabelActionImpl(@JsonProperty("fieldName") final String fieldName, @JsonProperty("label") final com.commercetools.api.generated.models.common.LocalizedString label) {
