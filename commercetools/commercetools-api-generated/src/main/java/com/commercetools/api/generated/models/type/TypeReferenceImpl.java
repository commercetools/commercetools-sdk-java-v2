...
public final class TypeReferenceImpl implements TypeReference {
   ...
   @JsonCreator
   TypeReferenceImpl(@JsonProperty("id") final String id, @JsonProperty("obj") final com.commercetools.api.generated.models.type.Type obj) {
      this.id = id;
      this.obj = obj;
   ...
   public void setObj(final com.commercetools.api.generated.models.type.Type obj){
      this.obj = obj;
   }
