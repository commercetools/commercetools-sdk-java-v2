...
public final class ZoneDraftImpl implements ZoneDraft {
   ...
   @JsonCreator
   ZoneDraftImpl(@JsonProperty("name") final String name, @JsonProperty("description") final String description, @JsonProperty("locations") final java.util.List<com.commercetools.api.generated.models.zone.Location> locations, @JsonProperty("key") final String key) {
      this.name = name;
   ...
   public void setLocations(final java.util.List<com.commercetools.api.generated.models.zone.Location> locations){
      this.locations = locations;
   }
