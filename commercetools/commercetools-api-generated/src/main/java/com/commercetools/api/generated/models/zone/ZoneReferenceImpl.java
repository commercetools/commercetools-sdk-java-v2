...
public final class ZoneReferenceImpl implements ZoneReference {
   ...
   @JsonCreator
   ZoneReferenceImpl(@JsonProperty("id") final String id, @JsonProperty("obj") final com.commercetools.api.generated.models.zone.Zone obj) {
      this.id = id;
      this.obj = obj;
   ...
   public void setObj(final com.commercetools.api.generated.models.zone.Zone obj){
      this.obj = obj;
   }
