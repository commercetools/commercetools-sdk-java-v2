...
public final class ZoneRemoveLocationActionImpl implements ZoneRemoveLocationAction {
   ...
   @JsonCreator
   ZoneRemoveLocationActionImpl(@JsonProperty("location") final com.commercetools.api.generated.models.zone.Location location) {
   ...
   public void setLocation(final com.commercetools.api.generated.models.zone.Location location){
      this.location = location;
   }
