...
public final class ZoneUpdateImpl implements ZoneUpdate {
   ...
   @JsonCreator
   ZoneUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.api.generated.models.zone.ZoneUpdateAction> actions, @JsonProperty("version") final Long version) {
   ...
   public void setActions(final java.util.List<com.commercetools.api.generated.models.zone.ZoneUpdateAction> actions){
      this.actions = actions;
   }
