...
public class ByProjectKeyCartsCustomerIdByCustomerIdGet {
    ...
    public ByProjectKeyCartsCustomerIdByCustomerIdGet addHeader(final String key, final String value) {
        this.headers.addHeader(key, value);
        return this;
    }
    
    public ByProjectKeyCartsCustomerIdByCustomerIdGet withHeaders(final ApiHttpHeaders headers) {
    ...
    public ByProjectKeyCartsCustomerIdByCustomerIdGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
        this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
        return this;
    }
    
    public ByProjectKeyCartsCustomerIdByCustomerIdGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
