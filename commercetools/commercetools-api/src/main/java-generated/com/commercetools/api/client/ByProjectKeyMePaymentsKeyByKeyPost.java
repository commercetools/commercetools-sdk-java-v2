...
public class ByProjectKeyMePaymentsKeyByKeyPost {
    ...
    public ByProjectKeyMePaymentsKeyByKeyPost withExpand(final List<String> expand){
        this.expand = expand;
        return this;
    }

    public ByProjectKeyMePaymentsKeyByKeyPost addHeader(final String key, final String value) {
        this.headers.addHeader(key, value);
        return this;
    }
    
    public ByProjectKeyMePaymentsKeyByKeyPost withHeaders(final ApiHttpHeaders headers) {
    ...
    public ByProjectKeyMePaymentsKeyByKeyPost addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
        this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
        return this;
    }
    
    public ByProjectKeyMePaymentsKeyByKeyPost setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
