...
public class ByProjectKeyCustomersByIDGet {
   ...
   public ByProjectKeyCustomersByIDGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyCustomersByIDGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyCustomersByIDGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyCustomersByIDGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
