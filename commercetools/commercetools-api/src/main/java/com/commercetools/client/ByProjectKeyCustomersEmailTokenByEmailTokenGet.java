...
public class ByProjectKeyCustomersEmailTokenByEmailTokenGet {
   ...
   public ByProjectKeyCustomersEmailTokenByEmailTokenGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyCustomersEmailTokenByEmailTokenGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyCustomersEmailTokenByEmailTokenGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyCustomersEmailTokenByEmailTokenGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
