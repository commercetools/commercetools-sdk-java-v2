...
public class ByProjectKeyCustomersPasswordTokenByPasswordTokenGet {
   ...
   public ByProjectKeyCustomersPasswordTokenByPasswordTokenGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyCustomersPasswordTokenByPasswordTokenGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyCustomersPasswordTokenByPasswordTokenGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyCustomersPasswordTokenByPasswordTokenGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
