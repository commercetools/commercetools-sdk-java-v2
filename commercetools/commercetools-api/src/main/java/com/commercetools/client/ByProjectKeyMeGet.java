...
public class ByProjectKeyMeGet {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.models.me.MyCustomer>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  ...
                  return Utils.convertResponse(response,com.commercetools.models.me.MyCustomer.class);
              });
   }
   ...
   public ByProjectKeyMeGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyMeGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyMeGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyMeGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
