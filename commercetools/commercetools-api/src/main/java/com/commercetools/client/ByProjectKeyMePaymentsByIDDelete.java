...
public class ByProjectKeyMePaymentsByIDDelete {
   ...
   if(response.getStatusCode() == 503){
      try{
          ...
          throw new RuntimeException(e.getMessage());
                  ...
                  return Utils.convertResponse(response,com.commercetools.models.me.MyPayment.class);
              });
   }
   ...
   public ByProjectKeyMePaymentsByIDDelete withVersion(final List<Long> version){
   ...
   public ByProjectKeyMePaymentsByIDDelete withExpand(final List<String> expand){
      this.expand = expand;
      return this;
   }
   
   public ByProjectKeyMePaymentsByIDDelete addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyMePaymentsByIDDelete withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyMePaymentsByIDDelete addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyMePaymentsByIDDelete setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
