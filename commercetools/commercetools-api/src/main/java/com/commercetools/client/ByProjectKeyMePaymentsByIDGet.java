...
public class ByProjectKeyMePaymentsByIDGet {
   ...
   public ByProjectKeyMePaymentsByIDGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyMePaymentsByIDGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyMePaymentsByIDGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyMePaymentsByIDGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
