...
public class ByProjectKeyMeShoppingListsByIDGet {
   ...
   public ByProjectKeyMeShoppingListsByIDGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyMeShoppingListsByIDGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyMeShoppingListsByIDGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyMeShoppingListsByIDGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
