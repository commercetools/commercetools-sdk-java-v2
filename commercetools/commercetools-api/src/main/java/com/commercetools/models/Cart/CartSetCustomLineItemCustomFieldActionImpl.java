...
public final class CartSetCustomLineItemCustomFieldActionImpl implements CartSetCustomLineItemCustomFieldAction {
   ...
   @JsonCreator
   CartSetCustomLineItemCustomFieldActionImpl(@JsonProperty("customLineItemId") final java.lang.String customLineItemId, @JsonProperty("name") final java.lang.String name, @JsonProperty("value") final java.lang.Object value) {
