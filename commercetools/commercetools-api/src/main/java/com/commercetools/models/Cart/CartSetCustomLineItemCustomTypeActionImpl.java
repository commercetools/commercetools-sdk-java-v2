...
public final class CartSetCustomLineItemCustomTypeActionImpl implements CartSetCustomLineItemCustomTypeAction {
   ...
   @JsonCreator
   CartSetCustomLineItemCustomTypeActionImpl(@JsonProperty("customLineItemId") final String customLineItemId, @JsonProperty("fields") final com.commercetools.models.type.FieldContainer fields, @JsonProperty("type") final com.commercetools.models.type.TypeResourceIdentifier type) {
