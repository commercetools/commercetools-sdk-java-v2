...
public final class CartSetCustomLineItemTaxRateActionImpl implements CartSetCustomLineItemTaxRateAction {
   ...
   @JsonCreator
   CartSetCustomLineItemTaxRateActionImpl(@JsonProperty("customLineItemId") final String customLineItemId, @JsonProperty("externalTaxRate") final com.commercetools.models.cart.ExternalTaxRateDraft externalTaxRate) {
