...
public final class CategoryUpdateImpl implements CategoryUpdate {
   ...
   @JsonCreator
   CategoryUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.models.category.CategoryUpdateAction> actions, @JsonProperty("version") final Long version) {
