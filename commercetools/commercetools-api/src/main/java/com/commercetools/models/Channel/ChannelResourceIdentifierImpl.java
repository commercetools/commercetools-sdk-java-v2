...
public final class ChannelResourceIdentifierImpl implements ChannelResourceIdentifier {
   ...
   @JsonCreator
   ChannelResourceIdentifierImpl(@JsonProperty("id") final java.lang.String id, @JsonProperty("key") final java.lang.String key) {
      this.id = id;
      this.key = key;
