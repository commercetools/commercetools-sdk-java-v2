...
public final class CustomObjectReferenceImpl implements CustomObjectReference {
   ...
   @JsonCreator
   CustomObjectReferenceImpl(@JsonProperty("id") final java.lang.String id, @JsonProperty("obj") final com.commercetools.models.CustomObject.CustomObject obj) {
      this.id = id;
      this.obj = obj;
   ...
   public void setObj(final com.commercetools.models.CustomObject.CustomObject obj){
      this.obj = obj;
   }
