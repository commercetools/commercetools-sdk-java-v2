...
public final class CustomerUpdateImpl implements CustomerUpdate {
   ...
   @JsonCreator
   CustomerUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.models.customer.CustomerUpdateAction> actions, @JsonProperty("version") final Long version) {
