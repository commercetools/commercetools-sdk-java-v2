...
public final class CustomerGroupUpdateImpl implements CustomerGroupUpdate {
   ...
   @JsonCreator
   CustomerGroupUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.models.CustomerGroup.CustomerGroupUpdateAction> actions, @JsonProperty("version") final java.lang.Long version) {
   ...
   public void setActions(final java.util.List<com.commercetools.models.CustomerGroup.CustomerGroupUpdateAction> actions){
      this.actions = actions;
   }
