...
public final class DiscountCodePagedQueryResponseImpl implements DiscountCodePagedQueryResponse {
   ...
   @JsonCreator
   DiscountCodePagedQueryResponseImpl(@JsonProperty("total") final java.lang.Long total, @JsonProperty("offset") final java.lang.Long offset, @JsonProperty("count") final java.lang.Long count, @JsonProperty("results") final java.util.List<com.commercetools.models.DiscountCode.DiscountCode> results) {
      this.total = total;
      this.offset = offset;
      this.count = count;
   ...
   public void setResults(final java.util.List<com.commercetools.models.DiscountCode.DiscountCode> results){
      this.results = results;
   }
