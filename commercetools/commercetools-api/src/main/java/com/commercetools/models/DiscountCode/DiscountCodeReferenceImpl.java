...
public final class DiscountCodeReferenceImpl implements DiscountCodeReference {
   ...
   @JsonCreator
   DiscountCodeReferenceImpl(@JsonProperty("id") final java.lang.String id, @JsonProperty("obj") final com.commercetools.models.DiscountCode.DiscountCode obj) {
      this.id = id;
      this.obj = obj;
   ...
   public void setObj(final com.commercetools.models.DiscountCode.DiscountCode obj){
      this.obj = obj;
   }
