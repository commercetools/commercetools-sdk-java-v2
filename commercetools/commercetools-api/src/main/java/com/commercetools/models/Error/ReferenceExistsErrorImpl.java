...
public final class ReferenceExistsErrorImpl implements ReferenceExistsError {
   ...
   @JsonCreator
   ReferenceExistsErrorImpl(@JsonProperty("message") final String message, @JsonProperty("referencedBy") final com.commercetools.models.common.ReferenceTypeId referencedBy) {
