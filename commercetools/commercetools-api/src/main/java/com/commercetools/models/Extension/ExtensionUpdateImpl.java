...
public final class ExtensionUpdateImpl implements ExtensionUpdate {
   ...
   @JsonCreator
   ExtensionUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.models.extension.ExtensionUpdateAction> actions, @JsonProperty("version") final Long version) {
