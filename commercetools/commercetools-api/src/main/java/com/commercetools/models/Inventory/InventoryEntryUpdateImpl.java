...
public final class InventoryEntryUpdateImpl implements InventoryEntryUpdate {
   ...
   @JsonCreator
   InventoryEntryUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.models.inventory.InventoryEntryUpdateAction> actions, @JsonProperty("version") final Long version) {
