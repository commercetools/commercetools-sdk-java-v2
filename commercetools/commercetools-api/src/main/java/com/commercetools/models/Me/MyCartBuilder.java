...
public final class MyCartBuilder {
   ...
   public MyCartBuilder id( final java.lang.String id) {
      this.id = id;
      return this;
   }
   
   public MyCartBuilder version( final java.lang.Long version) {
   ...
   public MyCartBuilder country(@Nullable final java.lang.String country) {
   ...
   public MyCartBuilder deleteDaysAfterLastModification(@Nullable final java.lang.Integer deleteDaysAfterLastModification) {
   ...
   public MyCartBuilder refusedGifts( final java.util.List<com.commercetools.models.CartDiscount.CartDiscountReference> refusedGifts) {
      this.refusedGifts = refusedGifts;
      return this;
   }
   
   public MyCartBuilder locale(@Nullable final java.lang.String locale) {
      this.locale = locale;
      return this;
   }
   ...
   public MyCartBuilder customerEmail(@Nullable final java.lang.String customerEmail) {
   ...
   public MyCartBuilder customerId(@Nullable final java.lang.String customerId) {
      this.customerId = customerId;
      return this;
   }
   
   public MyCartBuilder anonymousId(@Nullable final java.lang.String anonymousId) {
   ...
   public MyCartBuilder customerGroup(@Nullable final com.commercetools.models.CustomerGroup.CustomerGroupReference customerGroup) {
