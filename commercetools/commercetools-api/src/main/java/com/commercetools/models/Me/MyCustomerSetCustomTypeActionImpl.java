...
public final class MyCustomerSetCustomTypeActionImpl implements MyCustomerSetCustomTypeAction {
   ...
   @JsonCreator
   MyCustomerSetCustomTypeActionImpl(@JsonProperty("fields") final com.commercetools.models.Type.FieldContainer fields, @JsonProperty("type") final com.commercetools.models.Type.TypeResourceIdentifier type) {
      this.fields = fields;
      this.type = type;
