...
public final class MyOrderBuilder {
   ...
   public MyOrderBuilder createdBy(@Nullable final com.commercetools.models.common.CreatedBy createdBy) {
      this.createdBy = createdBy;
      return this;
   }
   
   public MyOrderBuilder lastModifiedBy(@Nullable final com.commercetools.models.common.LastModifiedBy lastModifiedBy) {
      this.lastModifiedBy = lastModifiedBy;
      return this;
   }
   
   public MyOrderBuilder shipmentState(@Nullable final com.commercetools.models.order.ShipmentState shipmentState) {
   ...
   public MyOrderBuilder totalPrice( final com.commercetools.models.common.TypedMoney totalPrice) {
      this.totalPrice = totalPrice;
      return this;
   }
   
   public MyOrderBuilder shippingRateInput(@Nullable final com.commercetools.models.cart.ShippingRateInput shippingRateInput) {
      this.shippingRateInput = shippingRateInput;
      return this;
   }
   
   public MyOrderBuilder taxedPrice(@Nullable final com.commercetools.models.cart.TaxedPrice taxedPrice) {
      this.taxedPrice = taxedPrice;
      return this;
   }
   
   public MyOrderBuilder origin( final com.commercetools.models.cart.CartOrigin origin) {
      this.origin = origin;
      return this;
   }
   
   public MyOrderBuilder shippingInfo(@Nullable final com.commercetools.models.cart.ShippingInfo shippingInfo) {
      this.shippingInfo = shippingInfo;
      return this;
   }
   
   public MyOrderBuilder refusedGifts( final java.util.List<com.commercetools.models.cart_discount.CartDiscountReference> refusedGifts) {
   ...
   public MyOrderBuilder cart(@Nullable final com.commercetools.models.cart.CartReference cart) {
      this.cart = cart;
      return this;
   }
   
   public MyOrderBuilder inventoryMode(@Nullable final com.commercetools.models.cart.InventoryMode inventoryMode) {
      this.inventoryMode = inventoryMode;
      return this;
   }
   
   public MyOrderBuilder orderState( final com.commercetools.models.order.OrderState orderState) {
      this.orderState = orderState;
      return this;
   }
   
   public MyOrderBuilder returnInfo(@Nullable final java.util.List<com.commercetools.models.order.ReturnInfo> returnInfo) {
      this.returnInfo = returnInfo;
      return this;
   }
   
   public MyOrderBuilder lineItems( final java.util.List<com.commercetools.models.cart.LineItem> lineItems) {
      this.lineItems = lineItems;
      return this;
   }
   
   public MyOrderBuilder customLineItems( final java.util.List<com.commercetools.models.cart.CustomLineItem> customLineItems) {
      this.customLineItems = customLineItems;
      return this;
   }
   
   public MyOrderBuilder itemShippingAddresses(@Nullable final java.util.List<com.commercetools.models.common.Address> itemShippingAddresses) {
   ...
   public MyOrderBuilder state(@Nullable final com.commercetools.models.state.StateReference state) {
      this.state = state;
      return this;
   }
   
   public MyOrderBuilder paymentState(@Nullable final com.commercetools.models.order.PaymentState paymentState) {
   ...
   public MyOrderBuilder discountCodes(@Nullable final java.util.List<com.commercetools.models.cart.DiscountCodeInfo> discountCodes) {
   ...
   public MyOrderBuilder customerGroup(@Nullable final com.commercetools.models.customer_group.CustomerGroupReference customerGroup) {
      this.customerGroup = customerGroup;
      return this;
   }
   
   public MyOrderBuilder custom(@Nullable final com.commercetools.models.type.CustomFields custom) {
      this.custom = custom;
      return this;
   }
   
   public MyOrderBuilder taxCalculationMode(@Nullable final com.commercetools.models.cart.TaxCalculationMode taxCalculationMode) {
      this.taxCalculationMode = taxCalculationMode;
      return this;
   }
   
   public MyOrderBuilder store(@Nullable final com.commercetools.models.store.StoreKeyReference store) {
      this.store = store;
      return this;
   }
   ...
   public MyOrderBuilder syncInfo( final java.util.List<com.commercetools.models.order.SyncInfo> syncInfo) {
      this.syncInfo = syncInfo;
      return this;
   }
   
   public MyOrderBuilder taxRoundingMode(@Nullable final com.commercetools.models.cart.RoundingMode taxRoundingMode) {
      this.taxRoundingMode = taxRoundingMode;
      return this;
   }
   
   public MyOrderBuilder taxMode(@Nullable final com.commercetools.models.cart.TaxMode taxMode) {
      this.taxMode = taxMode;
      return this;
   }
   
   public MyOrderBuilder shippingAddress(@Nullable final com.commercetools.models.common.Address shippingAddress) {
      this.shippingAddress = shippingAddress;
      return this;
   }
   
   public MyOrderBuilder billingAddress(@Nullable final com.commercetools.models.common.Address billingAddress) {
      this.billingAddress = billingAddress;
      return this;
   }
   
   public MyOrderBuilder paymentInfo(@Nullable final com.commercetools.models.order.PaymentInfo paymentInfo) {
