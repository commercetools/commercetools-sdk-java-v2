...
public final class MyShoppingListSetCustomTypeActionImpl implements MyShoppingListSetCustomTypeAction {
   ...
   @JsonCreator
   MyShoppingListSetCustomTypeActionImpl(@JsonProperty("fields") final com.commercetools.models.Type.FieldContainer fields, @JsonProperty("type") final com.commercetools.models.Type.TypeResourceIdentifier type) {
      this.fields = fields;
      this.type = type;
