...
public final class MyShoppingListSetTextLineItemCustomFieldActionImpl implements MyShoppingListSetTextLineItemCustomFieldAction {
   ...
   @JsonCreator
   MyShoppingListSetTextLineItemCustomFieldActionImpl(@JsonProperty("name") final java.lang.String name, @JsonProperty("value") final java.lang.Object value, @JsonProperty("textLineItemId") final java.lang.String textLineItemId) {
      this.name = name;
      this.value = value;
