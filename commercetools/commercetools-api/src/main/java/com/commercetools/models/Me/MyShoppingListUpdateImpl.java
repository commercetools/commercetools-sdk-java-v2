...
public final class MyShoppingListUpdateImpl implements MyShoppingListUpdate {
   ...
   @JsonCreator
   MyShoppingListUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.models.me.MyShoppingListUpdateAction> actions, @JsonProperty("version") final Long version) {
   ...
   public void setActions(final java.util.List<com.commercetools.models.me.MyShoppingListUpdateAction> actions){
      this.actions = actions;
   }
