...
public final class MessageConfigurationImpl implements MessageConfiguration {
   ...
   @JsonCreator
   MessageConfigurationImpl(@JsonProperty("deleteDaysAfterCreation") final java.lang.Integer deleteDaysAfterCreation, @JsonProperty("enabled") final java.lang.Boolean enabled) {
