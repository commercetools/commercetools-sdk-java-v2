...
public final class OrderDeletedMessageBuilder {
   ...
   public OrderDeletedMessageBuilder id( final java.lang.String id) {
      this.id = id;
      return this;
   }
   
   public OrderDeletedMessageBuilder version( final java.lang.Long version) {
      this.version = version;
      return this;
   }
   
   public OrderDeletedMessageBuilder sequenceNumber( final java.lang.Long sequenceNumber) {
   ...
   public OrderDeletedMessageBuilder resourceVersion( final java.lang.Long resourceVersion) {
      this.resourceVersion = resourceVersion;
      return this;
   }
   
   public OrderDeletedMessageBuilder type( final java.lang.String type) {
      this.type = type;
      return this;
   }
   ...
   public OrderDeletedMessage build() {
       return new OrderDeletedMessageImpl(createdAt, lastModifiedAt, id, version, sequenceNumber, resource, resourceUserProvidedIdentifiers, resourceVersion, type, order);
   }
