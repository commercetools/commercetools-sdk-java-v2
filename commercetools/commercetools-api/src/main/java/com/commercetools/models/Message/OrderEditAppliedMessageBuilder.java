...
public final class OrderEditAppliedMessageBuilder {
   ...
   public OrderEditAppliedMessageBuilder id( final java.lang.String id) {
      this.id = id;
      return this;
   }
   
   public OrderEditAppliedMessageBuilder version( final java.lang.Long version) {
      this.version = version;
      return this;
   }
   
   public OrderEditAppliedMessageBuilder sequenceNumber( final java.lang.Long sequenceNumber) {
   ...
   public OrderEditAppliedMessageBuilder resourceVersion( final java.lang.Long resourceVersion) {
      this.resourceVersion = resourceVersion;
      return this;
   }
   
   public OrderEditAppliedMessageBuilder type( final java.lang.String type) {
      this.type = type;
      return this;
   }
   ...
   public OrderEditAppliedMessage build() {
       return new OrderEditAppliedMessageImpl(createdAt, lastModifiedAt, id, version, sequenceNumber, resource, resourceUserProvidedIdentifiers, resourceVersion, type, result, edit);
   }
