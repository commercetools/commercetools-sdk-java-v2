...
public final class PaymentStatusStateTransitionMessagePayloadImpl implements PaymentStatusStateTransitionMessagePayload {
   ...
   @JsonCreator
   PaymentStatusStateTransitionMessagePayloadImpl(@JsonProperty("force") final java.lang.Boolean force, @JsonProperty("state") final com.commercetools.models.state.StateReference state) {
      this.force = force;
      this.state = state;
