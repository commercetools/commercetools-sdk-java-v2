...
public final class ProductStateTransitionMessagePayloadImpl implements ProductStateTransitionMessagePayload {
   ...
   @JsonCreator
   ProductStateTransitionMessagePayloadImpl(@JsonProperty("force") final Boolean force, @JsonProperty("state") final com.commercetools.models.state.StateReference state) {
      this.force = force;
      this.state = state;
