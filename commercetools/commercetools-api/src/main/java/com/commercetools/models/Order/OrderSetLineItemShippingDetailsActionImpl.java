...
public final class OrderSetLineItemShippingDetailsActionImpl implements OrderSetLineItemShippingDetailsAction {
   ...
   @JsonCreator
   OrderSetLineItemShippingDetailsActionImpl(@JsonProperty("shippingDetails") final com.commercetools.models.cart.ItemShippingDetailsDraft shippingDetails, @JsonProperty("lineItemId") final String lineItemId) {
