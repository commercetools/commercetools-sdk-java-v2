...
public final class OrderUpdateImpl implements OrderUpdate {
   ...
   @JsonCreator
   OrderUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.models.order.OrderUpdateAction> actions, @JsonProperty("version") final Long version) {
