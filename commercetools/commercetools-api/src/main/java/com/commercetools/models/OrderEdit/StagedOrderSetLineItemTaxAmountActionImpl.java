...
public final class StagedOrderSetLineItemTaxAmountActionImpl implements StagedOrderSetLineItemTaxAmountAction {
   ...
   @JsonCreator
   StagedOrderSetLineItemTaxAmountActionImpl(@JsonProperty("lineItemId") final java.lang.String lineItemId, @JsonProperty("externalTaxAmount") final com.commercetools.models.Cart.ExternalTaxAmountDraft externalTaxAmount) {
