...
public final class PaymentTransitionStateActionImpl implements PaymentTransitionStateAction {
   ...
   @JsonCreator
   PaymentTransitionStateActionImpl(@JsonProperty("force") final Boolean force, @JsonProperty("state") final com.commercetools.models.state.StateResourceIdentifier state) {
      this.force = force;
      this.state = state;
