...
public final class ProductDraftBuilder {
   ...
   public ProductDraftBuilder taxCategory(@Nullable final com.commercetools.models.tax_category.TaxCategoryResourceIdentifier taxCategory) {
   ...
   public ProductDraftBuilder productType( final com.commercetools.models.product_type.ProductTypeResourceIdentifier productType) {
