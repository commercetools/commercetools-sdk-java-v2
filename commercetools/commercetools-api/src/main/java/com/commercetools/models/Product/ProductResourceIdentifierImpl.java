...
public final class ProductResourceIdentifierImpl implements ProductResourceIdentifier {
   ...
   @JsonCreator
   ProductResourceIdentifierImpl(@JsonProperty("id") final java.lang.String id, @JsonProperty("key") final java.lang.String key) {
      this.id = id;
      this.key = key;
