...
public final class ProductSetAssetCustomFieldActionImpl implements ProductSetAssetCustomFieldAction {
   ...
   @JsonCreator
   ProductSetAssetCustomFieldActionImpl(@JsonProperty("assetId") final java.lang.String assetId, @JsonProperty("name") final java.lang.String name, @JsonProperty("staged") final java.lang.Boolean staged, @JsonProperty("variantId") final java.lang.Long variantId, @JsonProperty("sku") final java.lang.String sku, @JsonProperty("value") final java.lang.Object value, @JsonProperty("assetKey") final java.lang.String assetKey) {
