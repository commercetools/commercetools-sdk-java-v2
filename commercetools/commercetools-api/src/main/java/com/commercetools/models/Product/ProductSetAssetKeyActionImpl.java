...
public final class ProductSetAssetKeyActionImpl implements ProductSetAssetKeyAction {
   ...
   @JsonCreator
   ProductSetAssetKeyActionImpl(@JsonProperty("assetId") final java.lang.String assetId, @JsonProperty("staged") final java.lang.Boolean staged, @JsonProperty("variantId") final java.lang.Long variantId, @JsonProperty("sku") final java.lang.String sku, @JsonProperty("assetKey") final java.lang.String assetKey) {
