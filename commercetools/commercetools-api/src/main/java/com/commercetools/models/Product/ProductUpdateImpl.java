...
public final class ProductUpdateImpl implements ProductUpdate {
   ...
   @JsonCreator
   ProductUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.models.product.ProductUpdateAction> actions, @JsonProperty("version") final Long version) {
