...
public final class AttributeDefinitionDraftImpl implements AttributeDefinitionDraft {
   ...
   @JsonCreator
   AttributeDefinitionDraftImpl(@JsonProperty("isRequired") final java.lang.Boolean isRequired, @JsonProperty("attributeConstraint") final com.commercetools.models.ProductType.AttributeConstraintEnum attributeConstraint, @JsonProperty("name") final java.lang.String name, @JsonProperty("inputHint") final com.commercetools.models.ProductType.TextInputHint inputHint, @JsonProperty("isSearchable") final java.lang.Boolean isSearchable, @JsonProperty("label") final com.commercetools.models.Common.LocalizedString label, @JsonProperty("type") final com.commercetools.models.ProductType.AttributeType type, @JsonProperty("inputTip") final com.commercetools.models.Common.LocalizedString inputTip) {
