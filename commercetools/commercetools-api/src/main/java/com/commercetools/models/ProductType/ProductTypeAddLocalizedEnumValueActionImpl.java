...
public final class ProductTypeAddLocalizedEnumValueActionImpl implements ProductTypeAddLocalizedEnumValueAction {
   ...
   @JsonCreator
   ProductTypeAddLocalizedEnumValueActionImpl(@JsonProperty("attributeName") final java.lang.String attributeName, @JsonProperty("value") final com.commercetools.models.ProductType.AttributeLocalizedEnumValue value) {
   ...
   public void setValue(final com.commercetools.models.ProductType.AttributeLocalizedEnumValue value){
      this.value = value;
   }
