...
public final class ShippingMethodBuilder {
   ...
   public ShippingMethodBuilder zoneRates( final java.util.List<com.commercetools.models.ShippingMethod.ZoneRate> zoneRates) {
   ...
   public ShippingMethodBuilder taxCategory( final com.commercetools.models.TaxCategory.TaxCategoryReference taxCategory) {
