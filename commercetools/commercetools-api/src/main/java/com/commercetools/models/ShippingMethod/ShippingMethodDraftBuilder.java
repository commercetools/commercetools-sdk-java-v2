...
public final class ShippingMethodDraftBuilder {
   ...
   public ShippingMethodDraftBuilder zoneRates( final java.util.List<com.commercetools.models.ShippingMethod.ZoneRateDraft> zoneRates) {
   ...
   public ShippingMethodDraftBuilder taxCategory( final com.commercetools.models.TaxCategory.TaxCategoryResourceIdentifier taxCategory) {
