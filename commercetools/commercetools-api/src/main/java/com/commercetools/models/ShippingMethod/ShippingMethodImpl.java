...
public final class ShippingMethodImpl implements ShippingMethod {
   ...
   private java.util.List<com.commercetools.models.ShippingMethod.ZoneRate> zoneRates;
   ...
   public java.util.List<com.commercetools.models.ShippingMethod.ZoneRate> getZoneRates(){
   ...
   public void setZoneRates(final java.util.List<com.commercetools.models.ShippingMethod.ZoneRate> zoneRates){
      this.zoneRates = zoneRates;
   }
