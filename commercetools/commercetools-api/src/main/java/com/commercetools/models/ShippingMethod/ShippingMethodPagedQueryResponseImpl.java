...
public final class ShippingMethodPagedQueryResponseImpl implements ShippingMethodPagedQueryResponse {
   ...
   @JsonCreator
   ShippingMethodPagedQueryResponseImpl(@JsonProperty("total") final java.lang.Long total, @JsonProperty("offset") final java.lang.Long offset, @JsonProperty("count") final java.lang.Long count, @JsonProperty("results") final java.util.List<com.commercetools.models.ShippingMethod.ShippingMethod> results) {
      this.total = total;
      this.offset = offset;
      this.count = count;
   ...
   public void setResults(final java.util.List<com.commercetools.models.ShippingMethod.ShippingMethod> results){
      this.results = results;
   }
