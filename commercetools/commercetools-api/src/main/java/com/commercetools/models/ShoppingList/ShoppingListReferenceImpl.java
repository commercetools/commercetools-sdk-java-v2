...
public final class ShoppingListReferenceImpl implements ShoppingListReference {
   ...
   @JsonCreator
   ShoppingListReferenceImpl(@JsonProperty("id") final java.lang.String id, @JsonProperty("obj") final com.commercetools.models.ShoppingList.ShoppingList obj) {
      this.id = id;
      this.obj = obj;
   ...
   public void setObj(final com.commercetools.models.ShoppingList.ShoppingList obj){
      this.obj = obj;
   }
