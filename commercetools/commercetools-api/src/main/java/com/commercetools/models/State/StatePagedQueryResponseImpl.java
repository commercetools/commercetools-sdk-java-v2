...
public final class StatePagedQueryResponseImpl implements StatePagedQueryResponse {
   ...
   @JsonCreator
   StatePagedQueryResponseImpl(@JsonProperty("total") final Long total, @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count, @JsonProperty("limit") final Long limit, @JsonProperty("results") final java.util.List<com.commercetools.models.state.State> results) {
      this.total = total;
      this.offset = offset;
      this.count = count;
      this.limit = limit;
