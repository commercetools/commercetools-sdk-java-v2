...
public final class StateResourceIdentifierImpl implements StateResourceIdentifier {
   ...
   @JsonCreator
   StateResourceIdentifierImpl(@JsonProperty("id") final java.lang.String id, @JsonProperty("key") final java.lang.String key) {
      this.id = id;
      this.key = key;
