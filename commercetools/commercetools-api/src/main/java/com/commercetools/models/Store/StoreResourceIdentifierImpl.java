...
public final class StoreResourceIdentifierImpl implements StoreResourceIdentifier {
   ...
   @JsonCreator
   StoreResourceIdentifierImpl(@JsonProperty("id") final java.lang.String id, @JsonProperty("key") final java.lang.String key) {
      this.id = id;
      this.key = key;
