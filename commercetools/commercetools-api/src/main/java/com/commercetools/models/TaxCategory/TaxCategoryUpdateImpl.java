...
public final class TaxCategoryUpdateImpl implements TaxCategoryUpdate {
   ...
   @JsonCreator
   TaxCategoryUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.models.TaxCategory.TaxCategoryUpdateAction> actions, @JsonProperty("version") final java.lang.Long version) {
   ...
   public void setActions(final java.util.List<com.commercetools.models.TaxCategory.TaxCategoryUpdateAction> actions){
      this.actions = actions;
   }
