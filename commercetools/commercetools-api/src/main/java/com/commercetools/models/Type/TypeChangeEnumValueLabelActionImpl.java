...
public final class TypeChangeEnumValueLabelActionImpl implements TypeChangeEnumValueLabelAction {
   ...
   @JsonCreator
   TypeChangeEnumValueLabelActionImpl(@JsonProperty("fieldName") final String fieldName, @JsonProperty("value") final com.commercetools.models.type.CustomFieldEnumValue value) {
