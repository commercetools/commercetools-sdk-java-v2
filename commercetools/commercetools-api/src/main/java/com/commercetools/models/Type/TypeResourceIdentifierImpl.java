...
public final class TypeResourceIdentifierImpl implements TypeResourceIdentifier {
   ...
   @JsonCreator
   TypeResourceIdentifierImpl(@JsonProperty("id") final java.lang.String id, @JsonProperty("key") final java.lang.String key) {
      this.id = id;
      this.key = key;
