...
public final class CartDiscountDraftBuilder {
   ...
   public CartDiscountDraftBuilder stackingMode(@Nullable final com.commercetools.models.cart_discount.StackingMode stackingMode) {
   ...
   public CartDiscountDraftBuilder target(@Nullable final com.commercetools.models.cart_discount.CartDiscountTarget target) {
      this.target = target;
      return this;
   }
