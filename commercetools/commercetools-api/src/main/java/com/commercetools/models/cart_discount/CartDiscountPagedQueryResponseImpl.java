...
public final class CartDiscountPagedQueryResponseImpl implements CartDiscountPagedQueryResponse {
   ...
   @JsonCreator
   CartDiscountPagedQueryResponseImpl(@JsonProperty("total") final java.lang.Long total, @JsonProperty("offset") final java.lang.Long offset, @JsonProperty("count") final java.lang.Long count, @JsonProperty("results") final java.util.List<com.commercetools.models.cart_discount.CartDiscount> results) {
      this.total = total;
      this.offset = offset;
      this.count = count;
