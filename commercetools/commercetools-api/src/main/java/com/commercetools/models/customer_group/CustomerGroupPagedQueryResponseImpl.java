...
public final class CustomerGroupPagedQueryResponseImpl implements CustomerGroupPagedQueryResponse {
   ...
   @JsonCreator
   CustomerGroupPagedQueryResponseImpl(@JsonProperty("total") final Long total, @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count, @JsonProperty("limit") final Long limit, @JsonProperty("results") final java.util.List<com.commercetools.models.customer_group.CustomerGroup> results) {
      this.total = total;
      this.offset = offset;
      this.count = count;
      this.limit = limit;
   ...
   public void setResults(final java.util.List<com.commercetools.models.customer_group.CustomerGroup> results){
      this.results = results;
   }
