...
public final class CustomerGroupPagedQueryResponseImpl implements CustomerGroupPagedQueryResponse {
   ...
   @JsonCreator
   CustomerGroupPagedQueryResponseImpl(@JsonProperty("total") final java.lang.Long total, @JsonProperty("offset") final java.lang.Long offset, @JsonProperty("count") final java.lang.Long count, @JsonProperty("results") final java.util.List<com.commercetools.models.customer_group.CustomerGroup> results) {
      this.total = total;
      this.offset = offset;
      this.count = count;
