...
public final class CustomerGroupUpdateImpl implements CustomerGroupUpdate {
   ...
   @JsonCreator
   CustomerGroupUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.models.customer_group.CustomerGroupUpdateAction> actions, @JsonProperty("version") final Long version) {
