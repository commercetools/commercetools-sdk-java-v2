...
public final class DiscountCodeReferenceImpl implements DiscountCodeReference {
   ...
   private com.commercetools.models.discount_code.DiscountCode obj;

   @JsonCreator
   DiscountCodeReferenceImpl(@JsonProperty("id") final java.lang.String id, @JsonProperty("obj") final com.commercetools.models.discount_code.DiscountCode obj) {
      this.id = id;
      this.obj = obj;
   ...
   public com.commercetools.models.discount_code.DiscountCode getObj(){
      return this.obj;
   }
   ...
   public void setObj(final com.commercetools.models.discount_code.DiscountCode obj){
      this.obj = obj;
   }
