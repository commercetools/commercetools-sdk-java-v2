...
public final class DiscountCodeUpdateImpl implements DiscountCodeUpdate {
   ...
   @JsonCreator
   DiscountCodeUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.models.discount_code.DiscountCodeUpdateAction> actions, @JsonProperty("version") final Long version) {
