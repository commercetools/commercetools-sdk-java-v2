...
public final class OrderEditAppliedBuilder {
   ...
   public OrderEditAppliedBuilder excerptAfterEdit( final com.commercetools.models.order_edit.OrderExcerpt excerptAfterEdit) {
      this.excerptAfterEdit = excerptAfterEdit;
      return this;
   }
   
   public OrderEditAppliedBuilder excerptBeforeEdit( final com.commercetools.models.order_edit.OrderExcerpt excerptBeforeEdit) {
