...
public final class StagedOrderSetLineItemShippingDetailsActionImpl implements StagedOrderSetLineItemShippingDetailsAction {
   ...
   @JsonCreator
   StagedOrderSetLineItemShippingDetailsActionImpl(@JsonProperty("shippingDetails") final com.commercetools.models.cart.ItemShippingDetailsDraft shippingDetails, @JsonProperty("lineItemId") final String lineItemId) {
