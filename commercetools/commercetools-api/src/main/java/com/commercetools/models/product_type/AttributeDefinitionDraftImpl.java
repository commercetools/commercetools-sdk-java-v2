...
public final class AttributeDefinitionDraftImpl implements AttributeDefinitionDraft {
   ...
   public void setAttributeConstraint(final com.commercetools.models.product_type.AttributeConstraintEnum attributeConstraint){
      this.attributeConstraint = attributeConstraint;
   }
   ...
   public void setInputHint(final com.commercetools.models.product_type.TextInputHint inputHint){
      this.inputHint = inputHint;
   }
   ...
   public void setType(final com.commercetools.models.product_type.AttributeType type){
      this.type = type;
   }
