...
public final class ProductTypeAddAttributeDefinitionActionImpl implements ProductTypeAddAttributeDefinitionAction {
   ...
   @JsonCreator
   ProductTypeAddAttributeDefinitionActionImpl(@JsonProperty("attribute") final com.commercetools.models.product_type.AttributeDefinitionDraft attribute) {
   ...
   public void setAttribute(final com.commercetools.models.product_type.AttributeDefinitionDraft attribute){
      this.attribute = attribute;
   }
