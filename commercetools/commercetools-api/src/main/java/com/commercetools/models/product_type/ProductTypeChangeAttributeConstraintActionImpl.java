...
public final class ProductTypeChangeAttributeConstraintActionImpl implements ProductTypeChangeAttributeConstraintAction {
   ...
   @JsonCreator
   ProductTypeChangeAttributeConstraintActionImpl(@JsonProperty("newValue") final com.commercetools.models.product_type.AttributeConstraintEnumDraft newValue, @JsonProperty("attributeName") final java.lang.String attributeName) {
