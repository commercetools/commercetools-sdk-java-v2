...
public final class ProductTypeChangeLocalizedEnumValueLabelActionImpl implements ProductTypeChangeLocalizedEnumValueLabelAction {
   ...
   @JsonCreator
   ProductTypeChangeLocalizedEnumValueLabelActionImpl(@JsonProperty("newValue") final com.commercetools.models.product_type.AttributeLocalizedEnumValue newValue, @JsonProperty("attributeName") final java.lang.String attributeName) {
   ...
   public void setNewValue(final com.commercetools.models.product_type.AttributeLocalizedEnumValue newValue){
      this.newValue = newValue;
   }
