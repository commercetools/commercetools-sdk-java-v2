...
public final class ProductTypeChangeLocalizedEnumValueOrderActionImpl implements ProductTypeChangeLocalizedEnumValueOrderAction {
   ...
   @JsonCreator
   ProductTypeChangeLocalizedEnumValueOrderActionImpl(@JsonProperty("values") final java.util.List<com.commercetools.models.product_type.AttributeLocalizedEnumValue> values, @JsonProperty("attributeName") final String attributeName) {
      this.values = values;
