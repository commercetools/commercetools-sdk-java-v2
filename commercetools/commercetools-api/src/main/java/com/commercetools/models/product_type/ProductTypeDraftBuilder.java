...
public final class ProductTypeDraftBuilder {
   ...
   public ProductTypeDraftBuilder attributes(@Nullable final java.util.List<com.commercetools.models.product_type.AttributeDefinitionDraft> attributes) {
   ...
   @Nullable
   public java.util.List<com.commercetools.models.product_type.AttributeDefinitionDraft> getAttributes(){
