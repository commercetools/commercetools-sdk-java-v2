...
public final class ShippingMethodAddShippingRateActionImpl implements ShippingMethodAddShippingRateAction {
   ...
   @JsonCreator
   ShippingMethodAddShippingRateActionImpl(@JsonProperty("shippingRate") final com.commercetools.models.shipping_method.ShippingRateDraft shippingRate, @JsonProperty("zone") final com.commercetools.models.zone.ZoneResourceIdentifier zone) {
