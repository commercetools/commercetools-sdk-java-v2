...
public final class ShippingRateDraftImpl implements ShippingRateDraft {
   ...
   private java.util.List<com.commercetools.models.shipping_method.ShippingRatePriceTier> tiers;
   ...
   @JsonCreator
   ShippingRateDraftImpl(@JsonProperty("tiers") final java.util.List<com.commercetools.models.shipping_method.ShippingRatePriceTier> tiers, @JsonProperty("price") final com.commercetools.models.common.Money price, @JsonProperty("freeAbove") final com.commercetools.models.common.Money freeAbove) {
      this.tiers = tiers;
      this.price = price;
   ...
   public java.util.List<com.commercetools.models.shipping_method.ShippingRatePriceTier> getTiers(){
      return this.tiers;
   }
   ...
   public void setTiers(final java.util.List<com.commercetools.models.shipping_method.ShippingRatePriceTier> tiers){
      this.tiers = tiers;
   }
