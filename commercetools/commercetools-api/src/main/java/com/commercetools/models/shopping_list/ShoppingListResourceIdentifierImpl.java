...
public final class ShoppingListResourceIdentifierImpl implements ShoppingListResourceIdentifier {
   ...
   @JsonCreator
   ShoppingListResourceIdentifierImpl(@JsonProperty("id") final java.lang.String id, @JsonProperty("key") final java.lang.String key) {
      this.id = id;
      this.key = key;
