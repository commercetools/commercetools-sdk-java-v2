...
public final class ShoppingListSetCustomTypeActionImpl implements ShoppingListSetCustomTypeAction {
   ...
   @JsonCreator
   ShoppingListSetCustomTypeActionImpl(@JsonProperty("fields") final com.commercetools.models.type.FieldContainer fields, @JsonProperty("type") final com.commercetools.models.type.TypeResourceIdentifier type) {
      this.fields = fields;
      this.type = type;
