...
public final class ShoppingListSetTextLineItemCustomTypeActionImpl implements ShoppingListSetTextLineItemCustomTypeAction {
   ...
   @JsonCreator
   ShoppingListSetTextLineItemCustomTypeActionImpl(@JsonProperty("fields") final com.commercetools.models.type.FieldContainer fields, @JsonProperty("type") final com.commercetools.models.type.TypeResourceIdentifier type, @JsonProperty("textLineItemId") final String textLineItemId) {
      this.fields = fields;
      this.type = type;
