...
public final class TaxCategoryAddTaxRateActionImpl implements TaxCategoryAddTaxRateAction {
   ...
   @JsonCreator
   TaxCategoryAddTaxRateActionImpl(@JsonProperty("taxRate") final com.commercetools.models.tax_category.TaxRateDraft taxRate) {
   ...
   public void setTaxRate(final com.commercetools.models.tax_category.TaxRateDraft taxRate){
      this.taxRate = taxRate;
   }
