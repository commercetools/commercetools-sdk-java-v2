...
public final class TaxCategoryReferenceImpl implements TaxCategoryReference {
   ...
   @JsonCreator
   TaxCategoryReferenceImpl(@JsonProperty("id") final java.lang.String id, @JsonProperty("obj") final com.commercetools.models.tax_category.TaxCategory obj) {
      this.id = id;
      this.obj = obj;
   ...
   public void setObj(final com.commercetools.models.tax_category.TaxCategory obj){
      this.obj = obj;
   }
