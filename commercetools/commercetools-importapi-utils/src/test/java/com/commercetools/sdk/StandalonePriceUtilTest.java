...
class StandalonePriceUtilTest {
    ...
    void shouldMapRequiredFields() {
        var price = JsonUtils.fromJsonString(stringFromResource("src/test/resources/standalone-price.example.json"),
    ...
    void shouldHandleNullDiscounted() {
        ...
        var price = JsonUtils.fromJsonString(stringFromResource("src/test/resources/standalone-price.no-discount.json"),
            StandalonePrice.class);
    ...
    void shouldMapPriceTiers() {
        var price = JsonUtils.fromJsonString(stringFromResource("src/test/resources/standalone-price.with-tiers.json"),
            StandalonePrice.class);
        var result = util.toStandalonePriceImport(price);
