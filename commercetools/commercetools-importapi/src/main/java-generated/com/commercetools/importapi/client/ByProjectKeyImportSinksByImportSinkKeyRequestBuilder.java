...
public class ByProjectKeyImportSinksByImportSinkKeyRequestBuilder {
    ...
    public ByProjectKeyImportSinksByImportSinkKeyRequestBuilder (final ApiHttpClient apiHttpClient,final String projectKey,final String importSinkKey) {
        this.apiHttpClient = apiHttpClient;
        this.projectKey = projectKey;
        this.importSinkKey = importSinkKey;
    }

    public ByProjectKeyImportSinksByImportSinkKeyPut put(com.commercetools.importapi.models.importsinks.ImportSinkDraft importSinkDraft) {
