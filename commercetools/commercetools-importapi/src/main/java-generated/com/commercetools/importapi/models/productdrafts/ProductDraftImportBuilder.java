...
public final class ProductDraftImportBuilder {
    ...
    public ProductDraftImport build() {
        return new ProductDraftImportImpl(key, productType, name, slug, description, categories, metaTitle, metaDescription, metaKeywords, masterVariant, variants, taxCategory, searchKeywords, state, publish);
    }
