...
public class TelemetryMiddlewareTest {
    ...
    @ParameterizedTest
    @MethodSource("responses")
    public void testCountsWithAttributes(int statusCode, int count) throws ApiException {
        MetricsApi metricsApi = Mockito.mock(MetricsApi.class);
        Mockito.when(metricsApi.submitMetrics(Mockito.any())).thenReturn(null);
    ...
    @ParameterizedTest
    @MethodSource("responses")
    public void testHttpCountsWithAttributes(int statusCode, int count) throws URISyntaxException, ApiException {
        MetricsApi metricsApi = Mockito.mock(MetricsApi.class);
        Mockito.when(metricsApi.submitMetrics(Mockito.any())).thenReturn(null);
        Map<String, String> tags = new HashMap<>();
        tags.put("foo", "bar");
