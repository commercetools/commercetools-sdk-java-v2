...
public class ByProjectKeyInStoreKeyByStoreKeyCustomersByIDGet {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyCustomersByIDGet withExpand(final List<String> expand){
        this.expand = expand;
        return this;
    }

    public ByProjectKeyInStoreKeyByStoreKeyCustomersByIDGet addHeader(final String key, final String value) {
        this.headers.addHeader(key, value);
        return this;
    }
    
    public ByProjectKeyInStoreKeyByStoreKeyCustomersByIDGet withHeaders(final ApiHttpHeaders headers) {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyCustomersByIDGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
        this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
        return this;
    }
    
    public ByProjectKeyInStoreKeyByStoreKeyCustomersByIDGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
