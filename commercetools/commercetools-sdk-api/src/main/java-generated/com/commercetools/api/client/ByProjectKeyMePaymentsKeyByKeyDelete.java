...
public class ByProjectKeyMePaymentsKeyByKeyDelete {
    ...
    public ByProjectKeyMePaymentsKeyByKeyDelete addHeader(final String key, final String value) {
        this.headers.addHeader(key, value);
        return this;
    }
    
    public ByProjectKeyMePaymentsKeyByKeyDelete withHeaders(final ApiHttpHeaders headers) {
    ...
    public ByProjectKeyMePaymentsKeyByKeyDelete addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
        this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
        return this;
    }
    
    public ByProjectKeyMePaymentsKeyByKeyDelete setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
