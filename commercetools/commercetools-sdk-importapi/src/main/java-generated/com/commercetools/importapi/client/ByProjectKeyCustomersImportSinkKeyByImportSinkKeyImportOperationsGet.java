...
public class ByProjectKeyCustomersImportSinkKeyByImportSinkKeyImportOperationsGet {
    ...
    public ByProjectKeyCustomersImportSinkKeyByImportSinkKeyImportOperationsGet withResourceKey(final List<String> resourceKey){
    ...
    public ByProjectKeyCustomersImportSinkKeyByImportSinkKeyImportOperationsGet withState(final List<ProcessingState> state){
        this.state = state;
        return this;
    }

    public ByProjectKeyCustomersImportSinkKeyByImportSinkKeyImportOperationsGet addHeader(final String key, final String value) {
        this.headers.addHeader(key, value);
        return this;
    }

    public ByProjectKeyCustomersImportSinkKeyByImportSinkKeyImportOperationsGet withHeaders(final ApiHttpHeaders headers) {
    ...
    public ByProjectKeyCustomersImportSinkKeyByImportSinkKeyImportOperationsGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
        this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
        return this;
    }

    public ByProjectKeyCustomersImportSinkKeyByImportSinkKeyImportOperationsGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
