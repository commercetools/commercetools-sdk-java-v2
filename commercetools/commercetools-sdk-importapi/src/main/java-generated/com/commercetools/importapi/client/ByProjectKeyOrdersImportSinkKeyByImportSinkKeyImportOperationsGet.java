...
public class ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsGet {
    ...
    public ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsGet withResourceKey(final List<String> resourceKey){
    ...
    public ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsGet withState(final List<ProcessingState> state){
        this.state = state;
        return this;
    }

    public ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsGet addHeader(final String key, final String value) {
        this.headers.addHeader(key, value);
        return this;
    }
    
    public ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsGet withHeaders(final ApiHttpHeaders headers) {
    ...
    public ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
        this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
        return this;
    }
    
    public ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
