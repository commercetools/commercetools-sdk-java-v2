...
public final class ImportOperationPagedResponseImpl implements ImportOperationPagedResponse {
    ...
    @JsonCreator
    ImportOperationPagedResponseImpl(@JsonProperty("limit") final Integer limit, @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count, @JsonProperty("results") final java.util.List<com.commercetools.importer.models.importoperations.ImportOperation> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
