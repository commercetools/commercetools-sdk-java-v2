...
public final class DiscountedLineItemPriceDraftImpl implements DiscountedLineItemPriceDraft {
    ...
    @JsonCreator
    DiscountedLineItemPriceDraftImpl(@JsonProperty("value") final com.commercetools.importer.models.common.Money value, @JsonProperty("includedDiscounts") final java.util.List<com.commercetools.importer.models.orders.DiscountedLineItemPortion> includedDiscounts) {
        this.value = value;
    ...
    public void setIncludedDiscounts(final java.util.List<com.commercetools.importer.models.orders.DiscountedLineItemPortion> includedDiscounts){
        this.includedDiscounts = includedDiscounts;
    }
