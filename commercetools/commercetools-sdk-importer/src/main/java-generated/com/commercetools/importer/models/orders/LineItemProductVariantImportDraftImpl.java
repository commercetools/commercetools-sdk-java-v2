...
public final class LineItemProductVariantImportDraftImpl implements LineItemProductVariantImportDraft {
    ...
    @JsonCreator
    LineItemProductVariantImportDraftImpl(@JsonProperty("product") final com.commercetools.importer.models.common.ProductKeyReference product, @JsonProperty("sku") final String sku, @JsonProperty("prices") final java.util.List<com.commercetools.importer.models.orders.LineItemPrice> prices, @JsonProperty("attributes") final java.util.List<com.commercetools.importer.models.productvariants.Attribute> attributes, @JsonProperty("images") final java.util.List<com.commercetools.importer.models.common.Image> images) {
    ...
    */
    ...
    public void setPrices(final java.util.List<com.commercetools.importer.models.orders.LineItemPrice> prices){
        this.prices = prices;
    }
