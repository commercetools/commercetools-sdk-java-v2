...
public final class OrderImportBuilder {
    ...
    public OrderImportBuilder customer(@Nullable final com.commercetools.importer.models.common.CustomerKeyReference customer) {
    ...
    public OrderImportBuilder lineItems(@Nullable final java.util.List<com.commercetools.importer.models.orders.LineItemImportDraft> lineItems) {
        this.lineItems = lineItems;
        return this;
    }
    
    public OrderImportBuilder customLineItems(@Nullable final java.util.List<com.commercetools.importer.models.orders.CustomLineItemDraft> customLineItems) {
        this.customLineItems = customLineItems;
        return this;
    }
    
    public OrderImportBuilder totalPrice( final com.commercetools.importer.models.common.TypedMoney totalPrice) {
        this.totalPrice = totalPrice;
        return this;
    }
    
    public OrderImportBuilder taxedPrice(@Nullable final com.commercetools.importer.models.orders.TaxedPrice taxedPrice) {
        this.taxedPrice = taxedPrice;
        return this;
    }
    
    public OrderImportBuilder shippingAddress(@Nullable final com.commercetools.importer.models.common.Address shippingAddress) {
        this.shippingAddress = shippingAddress;
        return this;
    }
    
    public OrderImportBuilder billingAddress(@Nullable final com.commercetools.importer.models.common.Address billingAddress) {
        this.billingAddress = billingAddress;
        return this;
    }
    
    public OrderImportBuilder customerGroup(@Nullable final com.commercetools.importer.models.common.CustomerGroupKeyReference customerGroup) {
    ...
    public OrderImportBuilder orderState(@Nullable final com.commercetools.importer.models.orders.OrderState orderState) {
        this.orderState = orderState;
        return this;
    }
    
    public OrderImportBuilder shipmentState(@Nullable final com.commercetools.importer.models.orders.ShipmentState shipmentState) {
        this.shipmentState = shipmentState;
        return this;
    }
    
    public OrderImportBuilder paymentState(@Nullable final com.commercetools.importer.models.orders.PaymentState paymentState) {
        this.paymentState = paymentState;
        return this;
    }
    
    public OrderImportBuilder shippingInfo(@Nullable final com.commercetools.importer.models.orders.ShippingInfoImportDraft shippingInfo) {
    ...
    public OrderImportBuilder custom(@Nullable final com.commercetools.importer.models.customfields.Custom custom) {
        this.custom = custom;
        return this;
    }
    
    public OrderImportBuilder inventoryMode(@Nullable final com.commercetools.importer.models.orders.InventoryMode inventoryMode) {
        this.inventoryMode = inventoryMode;
        return this;
    }
    
    public OrderImportBuilder taxRoundingMode(@Nullable final com.commercetools.importer.models.orders.RoundingMode taxRoundingMode) {
        this.taxRoundingMode = taxRoundingMode;
        return this;
    }
    
    public OrderImportBuilder taxCalculationMode(@Nullable final com.commercetools.importer.models.orders.TaxCalculationMode taxCalculationMode) {
        this.taxCalculationMode = taxCalculationMode;
        return this;
    }
    
    public OrderImportBuilder origin(@Nullable final com.commercetools.importer.models.orders.CartOrigin origin) {
        this.origin = origin;
        return this;
    }
    
    public OrderImportBuilder itemShippingAddresses(@Nullable final java.util.List<com.commercetools.importer.models.common.Address> itemShippingAddresses) {
