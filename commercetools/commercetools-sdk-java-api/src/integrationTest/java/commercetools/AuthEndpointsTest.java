...
public class AuthEndpointsTest {
    ...
    public void introspection() throws ExecutionException, InterruptedException {
        ...
        final String auth = Base64.getEncoder()
                .encodeToString((credentials.getClientId() + ":" + credentials.getClientSecret()).getBytes(StandardCharsets.UTF_8));
        ...
        final ApiHttpResponse<TokenIntrospection> tokenIntrospection = client.execute(
                        request)
    ...
    public void revoke() throws ExecutionException, InterruptedException {
        ...
        final ApiHttpRequest introspectRequest = new ApiHttpRequest(
                ApiHttpMethod.POST,
                URI.create(ServiceRegion.GCP_EUROPE_WEST1.getAuthUrl() + "/oauth/introspect"),
                headers,
