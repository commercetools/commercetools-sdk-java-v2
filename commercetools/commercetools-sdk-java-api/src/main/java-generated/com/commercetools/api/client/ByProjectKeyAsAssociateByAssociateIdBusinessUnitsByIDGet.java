...
public class ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet extends ApiMethod<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet, com.commercetools.api.models.business_unit.BusinessUnit> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet> {
    ...
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet(final ApiHttpClient apiHttpClient, String projectKey, String associateId, String ID) {
        super(apiHttpClient);
    ...
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet(ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet t) {
        super(t);
     ...
     * @return ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet
     */
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet
     */
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet
     */
    public <TValue> ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet
     */
    public <TValue> ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet addExpand(final Collection<TValue> expand) {
