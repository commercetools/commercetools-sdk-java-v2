...
public class ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDPost extends
    ...
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDPost(final ApiHttpClient apiHttpClient,
    ...
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDPost(
            ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDPost t) {
        super(t);
     ...
     * @return ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDPost
     */
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDPost withExpand(
     ...
     * @return ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDPost
     */
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDPost addExpand(
            final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDPost
     */
    public <TValue> ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDPost withExpand(
     ...
     * @return ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDPost
     */
    public <TValue> ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDPost addExpand(
            final Collection<TValue> expand) {
    ...
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDPost withBody(
            com.commercetools.api.models.business_unit.BusinessUnitUpdate businessUnitUpdate) {
