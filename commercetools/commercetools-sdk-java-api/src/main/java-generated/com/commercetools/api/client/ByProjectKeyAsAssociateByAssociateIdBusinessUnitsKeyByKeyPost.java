...
public class ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPost extends BodyApiMethod<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPost, com.commercetools.api.models.business_unit.BusinessUnit, com.commercetools.api.models.business_unit.BusinessUnitUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPost> {
    ...
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPost(final ApiHttpClient apiHttpClient, String projectKey, String associateId, String key, com.commercetools.api.models.business_unit.BusinessUnitUpdate businessUnitUpdate) {
        super(apiHttpClient);
    ...
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPost(ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPost t) {
        super(t);
     ...
     * @return ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPost
     */
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPost withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPost
     */
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPost addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPost
     */
    public <TValue> ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPost
     */
    public <TValue> ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPost addExpand(final Collection<TValue> expand) {
    ...
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPost withBody(com.commercetools.api.models.business_unit.BusinessUnitUpdate businessUnitUpdate) {
