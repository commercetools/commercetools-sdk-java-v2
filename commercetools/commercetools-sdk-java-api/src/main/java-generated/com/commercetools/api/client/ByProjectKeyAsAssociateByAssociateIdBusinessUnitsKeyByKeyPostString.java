...
public class ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPostString extends
        StringBodyApiMethod<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPostString, com.commercetools.api.models.business_unit.BusinessUnit>
        implements
        com.commercetools.api.client.ConflictingTrait<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPostString>,
        com.commercetools.api.client.ExpandableTrait<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPostString>,
    ...
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPostString(final ApiHttpClient apiHttpClient,
            String projectKey, String associateId, String key, String businessUnitUpdate) {
        super(apiHttpClient);
    ...
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPostString(
            ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPostString t) {
        super(t);
     ...
     */
    public <TValue> ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPostString withExpand(
            final TValue expand) {
     ...
     * @return ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPostString
     */
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPostString withExpand(
     ...
     * @return ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPostString
     */
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPostString addExpand(
            final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPostString
     */
    public <TValue> ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyPostString addExpand(
            final Collection<TValue> expand) {
