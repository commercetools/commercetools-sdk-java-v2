...
public class ByProjectKeyAsAssociateByAssociateIdBusinessUnitsPost extends BodyApiMethod<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsPost, com.commercetools.api.models.business_unit.BusinessUnit, com.commercetools.api.models.business_unit.BusinessUnitDraft> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsPost> {
    ...
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsPost(final ApiHttpClient apiHttpClient, String projectKey, String associateId, com.commercetools.api.models.business_unit.BusinessUnitDraft businessUnitDraft) {
        super(apiHttpClient);
    ...
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsPost(ByProjectKeyAsAssociateByAssociateIdBusinessUnitsPost t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(businessUnitDraft)));
     ...
     * @return ByProjectKeyAsAssociateByAssociateIdBusinessUnitsPost
     */
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsPost withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyAsAssociateByAssociateIdBusinessUnitsPost
     */
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsPost addExpand(final Function<StringBuilder, StringBuilder> op) {
    ...
    public ByProjectKeyAsAssociateByAssociateIdBusinessUnitsPost withBody(com.commercetools.api.models.business_unit.BusinessUnitDraft businessUnitDraft) {
