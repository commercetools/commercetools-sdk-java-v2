...
/**
 *  <p>Checks if one or more Quotes exist for the provided query predicate in a BusinessUnit. Returns a <code>200 OK</code> status if any Quotes match the query predicate, or a <span>Not Found</span> error otherwise.</p>
 *
 * <hr>
...
public class ByProjectKeyAsAssociateByAssociateIdInBusinessUnitKeyByBusinessUnitKeyQuotesHead extends
        TypeApiMethod<ByProjectKeyAsAssociateByAssociateIdInBusinessUnitKeyByBusinessUnitKeyQuotesHead, tools.jackson.databind.JsonNode>
        implements
