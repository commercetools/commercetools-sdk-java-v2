...
public class ByProjectKeyAssociateRolesByIDPostString extends
        StringBodyApiMethod<ByProjectKeyAssociateRolesByIDPostString, com.commercetools.api.models.associate_role.AssociateRole>
        implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyAssociateRolesByIDPostString>,
        com.commercetools.api.client.ExpandableTrait<ByProjectKeyAssociateRolesByIDPostString>,
    ...
    public ByProjectKeyAssociateRolesByIDPostString(final ApiHttpClient apiHttpClient, String projectKey, String ID,
            String associateRoleUpdate) {
        super(apiHttpClient);
