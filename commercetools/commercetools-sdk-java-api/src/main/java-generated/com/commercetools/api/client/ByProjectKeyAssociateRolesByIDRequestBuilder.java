...
public class ByProjectKeyAssociateRolesByIDRequestBuilder  {
    ...
    public ByProjectKeyAssociateRolesByIDRequestBuilder (final ApiHttpClient apiHttpClient,final String projectKey,final String ID) {
    ...
    public ByProjectKeyAssociateRolesByIDPost post(com.commercetools.api.models.associate_role.AssociateRoleUpdate associateRoleUpdate) {
    ...
    public ByProjectKeyAssociateRolesByIDPost post(UnaryOperator<com.commercetools.api.models.associate_role.AssociateRoleUpdateBuilder> op) {
