...
public class ByProjectKeyAssociateRolesKeyByKeyPost extends BodyApiMethod<ByProjectKeyAssociateRolesKeyByKeyPost, com.commercetools.api.models.associate_role.AssociateRole, com.commercetools.api.models.associate_role.AssociateRoleUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyAssociateRolesKeyByKeyPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyAssociateRolesKeyByKeyPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyAssociateRolesKeyByKeyPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyAssociateRolesKeyByKeyPost> {
    ...
    public ByProjectKeyAssociateRolesKeyByKeyPost(final ApiHttpClient apiHttpClient, String projectKey, String key, com.commercetools.api.models.associate_role.AssociateRoleUpdate associateRoleUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(associateRoleUpdate)));
    ...
    public ByProjectKeyAssociateRolesKeyByKeyPost withBody(com.commercetools.api.models.associate_role.AssociateRoleUpdate associateRoleUpdate) {
