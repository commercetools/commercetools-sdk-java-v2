...
public class ByProjectKeyAssociateRolesKeyByKeyPostString extends
        StringBodyApiMethod<ByProjectKeyAssociateRolesKeyByKeyPostString, com.commercetools.api.models.associate_role.AssociateRole>
        implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyAssociateRolesKeyByKeyPostString>,
        com.commercetools.api.client.ExpandableTrait<ByProjectKeyAssociateRolesKeyByKeyPostString>,
        com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyAssociateRolesKeyByKeyPostString>,
        com.commercetools.api.client.ErrorableTrait<ByProjectKeyAssociateRolesKeyByKeyPostString> {
    ...
    public ByProjectKeyAssociateRolesKeyByKeyPostString(final ApiHttpClient apiHttpClient, String projectKey,
            String key, String associateRoleUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(),
            associateRoleUpdate.getBytes(StandardCharsets.UTF_8));
