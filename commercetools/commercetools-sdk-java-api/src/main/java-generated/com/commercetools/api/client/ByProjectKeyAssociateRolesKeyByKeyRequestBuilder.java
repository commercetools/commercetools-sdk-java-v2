...
public class ByProjectKeyAssociateRolesKeyByKeyRequestBuilder  {
    ...
    public ByProjectKeyAssociateRolesKeyByKeyRequestBuilder (final ApiHttpClient apiHttpClient,final String projectKey,final String key) {
    ...
    public ByProjectKeyAssociateRolesKeyByKeyPost post(com.commercetools.api.models.associate_role.AssociateRoleUpdate associateRoleUpdate) {
    ...
    public ByProjectKeyAssociateRolesKeyByKeyPost post(UnaryOperator<com.commercetools.api.models.associate_role.AssociateRoleUpdateBuilder> op) {
