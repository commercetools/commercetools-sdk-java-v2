...
public class ByProjectKeyAssociateRolesPost extends BodyApiMethod<ByProjectKeyAssociateRolesPost, com.commercetools.api.models.associate_role.AssociateRole, com.commercetools.api.models.associate_role.AssociateRoleDraft> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyAssociateRolesPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyAssociateRolesPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyAssociateRolesPost> {
    ...
    public ByProjectKeyAssociateRolesPost(final ApiHttpClient apiHttpClient, String projectKey, com.commercetools.api.models.associate_role.AssociateRoleDraft associateRoleDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(associateRoleDraft)));
    ...
    public ByProjectKeyAssociateRolesPost withBody(com.commercetools.api.models.associate_role.AssociateRoleDraft associateRoleDraft) {
