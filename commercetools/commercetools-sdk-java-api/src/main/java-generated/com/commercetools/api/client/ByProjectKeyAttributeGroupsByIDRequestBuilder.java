...
public class ByProjectKeyAttributeGroupsByIDRequestBuilder  {
    ...
    public ByProjectKeyAttributeGroupsByIDRequestBuilder (final ApiHttpClient apiHttpClient,final String projectKey,final String ID) {
    ...
    public ByProjectKeyAttributeGroupsByIDPost post(com.commercetools.api.models.attribute_group.AttributeGroupUpdate attributeGroupUpdate) {
    ...
    public ByProjectKeyAttributeGroupsByIDPost post(UnaryOperator<com.commercetools.api.models.attribute_group.AttributeGroupUpdateBuilder> op) {
