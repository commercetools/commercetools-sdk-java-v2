...
public class ByProjectKeyAttributeGroupsPostString extends StringBodyApiMethod<ByProjectKeyAttributeGroupsPostString, com.commercetools.api.models.attribute_group.AttributeGroup> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyAttributeGroupsPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyAttributeGroupsPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyAttributeGroupsPostString> {
    ...
    public ByProjectKeyAttributeGroupsPostString(final ApiHttpClient apiHttpClient, String projectKey, String attributeGroupDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), attributeGroupDraft.getBytes(StandardCharsets.UTF_8));
