...
public class ByProjectKeyBusinessUnitsByIDGet
        extends TypeApiMethod<ByProjectKeyBusinessUnitsByIDGet, com.commercetools.api.models.business_unit.BusinessUnit>
        implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyBusinessUnitsByIDGet>,
        com.commercetools.api.client.ErrorableTrait<ByProjectKeyBusinessUnitsByIDGet>,
        com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyBusinessUnitsByIDGet> {
    ...
    public ByProjectKeyBusinessUnitsByIDGet(final ApiHttpClient apiHttpClient, String projectKey, String ID) {
        super(apiHttpClient);
        this.projectKey = projectKey;
        this.ID = ID;
    }

    public ByProjectKeyBusinessUnitsByIDGet(ByProjectKeyBusinessUnitsByIDGet t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        String httpRequestPath = String.format("%s/business-units/%s", encodePathParam(this.projectKey),
    ...
    public boolean equals(Object o) {
        ...
        ByProjectKeyBusinessUnitsByIDGet that = (ByProjectKeyBusinessUnitsByIDGet) o;
    ...
    @Override
    protected ByProjectKeyBusinessUnitsByIDGet copy() {
        return new ByProjectKeyBusinessUnitsByIDGet(this);
    }
}
