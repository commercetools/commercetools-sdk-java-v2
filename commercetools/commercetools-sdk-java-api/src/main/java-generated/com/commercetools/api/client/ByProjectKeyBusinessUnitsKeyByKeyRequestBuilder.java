...
public class ByProjectKeyBusinessUnitsKeyByKeyRequestBuilder  {
    ...
    public ByProjectKeyBusinessUnitsKeyByKeyRequestBuilder (final ApiHttpClient apiHttpClient,final String projectKey,final String key) {
    ...
    public ByProjectKeyBusinessUnitsKeyByKeyPost post(com.commercetools.api.models.business_unit.BusinessUnitUpdate businessUnitUpdate) {
    ...
    public ByProjectKeyBusinessUnitsKeyByKeyPost post(UnaryOperator<com.commercetools.api.models.business_unit.BusinessUnitUpdateBuilder> op) {
