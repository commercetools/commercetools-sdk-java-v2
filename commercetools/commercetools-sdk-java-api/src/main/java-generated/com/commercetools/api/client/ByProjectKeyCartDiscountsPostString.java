...
public class ByProjectKeyCartDiscountsPostString extends StringBodyApiMethod<ByProjectKeyCartDiscountsPostString, com.commercetools.api.models.cart_discount.CartDiscount> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyCartDiscountsPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyCartDiscountsPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyCartDiscountsPostString> {
    ...
    public ByProjectKeyCartDiscountsPostString(final ApiHttpClient apiHttpClient, String projectKey, String cartDiscountDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), cartDiscountDraft.getBytes(StandardCharsets.UTF_8));
