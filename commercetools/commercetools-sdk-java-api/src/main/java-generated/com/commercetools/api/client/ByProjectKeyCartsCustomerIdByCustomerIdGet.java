...
public class ByProjectKeyCartsCustomerIdByCustomerIdGet
        extends TypeApiMethod<ByProjectKeyCartsCustomerIdByCustomerIdGet, com.commercetools.api.models.cart.Cart>
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        String httpRequestPath = String.format("%s/carts/customer-id=%s", encodePathParam(this.projectKey),
