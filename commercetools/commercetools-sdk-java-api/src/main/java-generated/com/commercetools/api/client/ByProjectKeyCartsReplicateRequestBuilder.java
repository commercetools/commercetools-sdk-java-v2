...
public class ByProjectKeyCartsReplicateRequestBuilder  {
    ...
    public ByProjectKeyCartsReplicatePostString post(final String replicaCartDraft) {
        return new ByProjectKeyCartsReplicatePostString(apiHttpClient, projectKey, replicaCartDraft);
    }
    public ByProjectKeyCartsReplicatePost post(UnaryOperator<com.commercetools.api.models.cart.ReplicaCartDraftBuilder> op) {
