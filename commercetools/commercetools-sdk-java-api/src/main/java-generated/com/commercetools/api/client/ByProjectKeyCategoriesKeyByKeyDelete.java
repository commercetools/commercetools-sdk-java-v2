...
public class ByProjectKeyCategoriesKeyByKeyDelete extends ApiMethod<ByProjectKeyCategoriesKeyByKeyDelete> {
    ...
    public ByProjectKeyCategoriesKeyByKeyDelete withVersion(final Long version){
        return new ByProjectKeyCategoriesKeyByKeyDelete(this).addQueryParam("version", version);
    }
    
    public ByProjectKeyCategoriesKeyByKeyDelete withExpand(final String expand){
        return new ByProjectKeyCategoriesKeyByKeyDelete(this).addQueryParam("expand", expand);
    }
}
