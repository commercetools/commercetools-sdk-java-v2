...
public class ByProjectKeyCategoriesKeyByKeyPost extends BodyApiMethod<ByProjectKeyCategoriesKeyByKeyPost, com.commercetools.api.models.category.Category, com.commercetools.api.models.category.CategoryUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyCategoriesKeyByKeyPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyCategoriesKeyByKeyPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyCategoriesKeyByKeyPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyCategoriesKeyByKeyPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(categoryUpdate)));
     ...
     * @return ByProjectKeyCategoriesKeyByKeyPost
     */
    public <TValue> ByProjectKeyCategoriesKeyByKeyPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyCategoriesKeyByKeyPost
     */
    public <TValue> ByProjectKeyCategoriesKeyByKeyPost addExpand(final Collection<TValue> expand) {
    ...
    public ByProjectKeyCategoriesKeyByKeyPost withBody(com.commercetools.api.models.category.CategoryUpdate categoryUpdate) {
