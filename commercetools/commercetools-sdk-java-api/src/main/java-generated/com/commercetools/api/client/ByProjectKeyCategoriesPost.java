...
public class ByProjectKeyCategoriesPost extends BodyApiMethod<ByProjectKeyCategoriesPost, com.commercetools.api.models.category.Category, com.commercetools.api.models.category.CategoryDraft> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyCategoriesPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyCategoriesPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyCategoriesPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(categoryDraft)));
     ...
     * @return ByProjectKeyCategoriesPost
     */
    public <TValue> ByProjectKeyCategoriesPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyCategoriesPost
     */
    public <TValue> ByProjectKeyCategoriesPost addExpand(final Collection<TValue> expand) {
