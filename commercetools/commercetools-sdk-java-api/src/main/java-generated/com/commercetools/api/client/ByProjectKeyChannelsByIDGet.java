...
public class ByProjectKeyChannelsByIDGet extends ApiMethod<ByProjectKeyChannelsByIDGet, com.commercetools.api.models.channel.Channel> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyChannelsByIDGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyChannelsByIDGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyChannelsByIDGet> {
     ...
     */
    public <TValue> ByProjectKeyChannelsByIDGet withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyChannelsByIDGet
     */
    public <TValue> ByProjectKeyChannelsByIDGet addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyChannelsByIDGet
     */
    public ByProjectKeyChannelsByIDGet withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyChannelsByIDGet
     */
    public ByProjectKeyChannelsByIDGet addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyChannelsByIDGet
     */
    public ByProjectKeyChannelsByIDGet withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyChannelsByIDGet
     */
    public ByProjectKeyChannelsByIDGet addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyChannelsByIDGet
     */
    public <TValue> ByProjectKeyChannelsByIDGet withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyChannelsByIDGet
     */
    public <TValue> ByProjectKeyChannelsByIDGet addExpand(final Collection<TValue> expand) {
    ...
    public boolean equals(Object o) {
        ...
        ByProjectKeyChannelsByIDGet that = (ByProjectKeyChannelsByIDGet) o;
