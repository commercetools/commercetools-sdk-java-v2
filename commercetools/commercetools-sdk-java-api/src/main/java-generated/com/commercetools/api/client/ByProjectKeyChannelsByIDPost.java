...
public class ByProjectKeyChannelsByIDPost extends BodyApiMethod<ByProjectKeyChannelsByIDPost, com.commercetools.api.models.channel.Channel, com.commercetools.api.models.channel.ChannelUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyChannelsByIDPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyChannelsByIDPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyChannelsByIDPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyChannelsByIDPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(channelUpdate)));
     ...
     * @return ByProjectKeyChannelsByIDPost
     */
    public <TValue> ByProjectKeyChannelsByIDPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyChannelsByIDPost
     */
    public <TValue> ByProjectKeyChannelsByIDPost addExpand(final Collection<TValue> expand) {
