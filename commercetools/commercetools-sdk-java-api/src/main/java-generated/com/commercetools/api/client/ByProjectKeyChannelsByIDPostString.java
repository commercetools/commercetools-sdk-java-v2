...
public class ByProjectKeyChannelsByIDPostString extends StringBodyApiMethod<ByProjectKeyChannelsByIDPostString, com.commercetools.api.models.channel.Channel> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyChannelsByIDPostString>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyChannelsByIDPostString>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyChannelsByIDPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyChannelsByIDPostString> {
    ...
    public ByProjectKeyChannelsByIDPostString(final ApiHttpClient apiHttpClient, String projectKey, String ID, String channelUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), channelUpdate.getBytes(StandardCharsets.UTF_8));
     ...
     * @return ByProjectKeyChannelsByIDPostString
     */
