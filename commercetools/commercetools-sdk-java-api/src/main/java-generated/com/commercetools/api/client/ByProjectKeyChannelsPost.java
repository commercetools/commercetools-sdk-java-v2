...
public class ByProjectKeyChannelsPost extends BodyApiMethod<ByProjectKeyChannelsPost, com.commercetools.api.models.channel.Channel, com.commercetools.api.models.channel.ChannelDraft> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyChannelsPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyChannelsPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyChannelsPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(channelDraft)));
