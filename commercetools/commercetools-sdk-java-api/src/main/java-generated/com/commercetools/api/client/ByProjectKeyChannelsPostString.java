...
public class ByProjectKeyChannelsPostString extends StringBodyApiMethod<ByProjectKeyChannelsPostString, com.commercetools.api.models.channel.Channel> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyChannelsPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyChannelsPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyChannelsPostString> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), channelDraft.getBytes(StandardCharsets.UTF_8));
