...
public class ByProjectKeyCustomObjectsByContainerByKeyDelete extends ApiMethod<ByProjectKeyCustomObjectsByContainerByKeyDelete, com.commercetools.api.models.custom_object.CustomObject> implements com.commercetools.api.client.DataerasureTrait<ByProjectKeyCustomObjectsByContainerByKeyDelete>, com.commercetools.api.client.VersionedTrait<ByProjectKeyCustomObjectsByContainerByKeyDelete>, com.commercetools.api.client.ConflictingTrait<ByProjectKeyCustomObjectsByContainerByKeyDelete>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyCustomObjectsByContainerByKeyDelete>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyCustomObjectsByContainerByKeyDelete> {
    ...
    @Override
    public ApiHttpResponse<com.commercetools.api.models.custom_object.CustomObject> executeBlocking(final ApiHttpClient client, final Duration timeout) {
     ...
     * @return ByProjectKeyCustomObjectsByContainerByKeyDelete
     */
    public ByProjectKeyCustomObjectsByContainerByKeyDelete withVersion(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyCustomObjectsByContainerByKeyDelete
     */
    public ByProjectKeyCustomObjectsByContainerByKeyDelete withDataErasure(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyCustomObjectsByContainerByKeyDelete
     */
    public ByProjectKeyCustomObjectsByContainerByKeyDelete addDataErasure(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyCustomObjectsByContainerByKeyDelete
     */
    public <TValue> ByProjectKeyCustomObjectsByContainerByKeyDelete withDataErasure(final Collection<TValue> dataErasure) {
     ...
     * @return ByProjectKeyCustomObjectsByContainerByKeyDelete
     */
    public <TValue> ByProjectKeyCustomObjectsByContainerByKeyDelete addDataErasure(final Collection<TValue> dataErasure) {
