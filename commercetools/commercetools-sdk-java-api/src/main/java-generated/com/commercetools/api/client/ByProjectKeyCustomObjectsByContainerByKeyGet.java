...
public class ByProjectKeyCustomObjectsByContainerByKeyGet extends
        TypeApiMethod<ByProjectKeyCustomObjectsByContainerByKeyGet, com.commercetools.api.models.custom_object.CustomObject>
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        String httpRequestPath = String.format("%s/custom-objects/%s/%s", encodePathParam(this.projectKey),
            encodePathParam(this.container), encodePathParam(this.key));
        if (!params.isEmpty()) {
