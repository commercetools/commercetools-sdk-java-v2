...
public class ByProjectKeyCustomObjectsPostString extends StringBodyApiMethod<ByProjectKeyCustomObjectsPostString, com.commercetools.api.models.custom_object.CustomObject> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyCustomObjectsPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyCustomObjectsPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyCustomObjectsPostString> {
    ...
    public ByProjectKeyCustomObjectsPostString(final ApiHttpClient apiHttpClient, String projectKey, String customObjectDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), customObjectDraft.getBytes(StandardCharsets.UTF_8));
