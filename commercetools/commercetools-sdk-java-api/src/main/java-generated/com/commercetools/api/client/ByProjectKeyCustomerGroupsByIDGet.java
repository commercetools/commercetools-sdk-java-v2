...
public class ByProjectKeyCustomerGroupsByIDGet extends ApiMethod<ByProjectKeyCustomerGroupsByIDGet, com.commercetools.api.models.customer_group.CustomerGroup> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyCustomerGroupsByIDGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyCustomerGroupsByIDGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyCustomerGroupsByIDGet> {
     ...
     */
    public <TValue> ByProjectKeyCustomerGroupsByIDGet withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyCustomerGroupsByIDGet
     */
    public <TValue> ByProjectKeyCustomerGroupsByIDGet addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyCustomerGroupsByIDGet
     */
    public ByProjectKeyCustomerGroupsByIDGet withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyCustomerGroupsByIDGet
     */
    public ByProjectKeyCustomerGroupsByIDGet addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyCustomerGroupsByIDGet
     */
    public ByProjectKeyCustomerGroupsByIDGet withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyCustomerGroupsByIDGet
     */
    public ByProjectKeyCustomerGroupsByIDGet addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyCustomerGroupsByIDGet
     */
    public <TValue> ByProjectKeyCustomerGroupsByIDGet withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyCustomerGroupsByIDGet
     */
    public <TValue> ByProjectKeyCustomerGroupsByIDGet addExpand(final Collection<TValue> expand) {
    ...
    public boolean equals(Object o) {
        ...
        ByProjectKeyCustomerGroupsByIDGet that = (ByProjectKeyCustomerGroupsByIDGet) o;
