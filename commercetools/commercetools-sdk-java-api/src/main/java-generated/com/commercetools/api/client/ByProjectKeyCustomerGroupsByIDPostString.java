...
public class ByProjectKeyCustomerGroupsByIDPostString extends StringBodyApiMethod<ByProjectKeyCustomerGroupsByIDPostString, com.commercetools.api.models.customer_group.CustomerGroup> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyCustomerGroupsByIDPostString>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyCustomerGroupsByIDPostString>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyCustomerGroupsByIDPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyCustomerGroupsByIDPostString> {
    ...
    public ByProjectKeyCustomerGroupsByIDPostString(final ApiHttpClient apiHttpClient, String projectKey, String ID, String customerGroupUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), customerGroupUpdate.getBytes(StandardCharsets.UTF_8));
