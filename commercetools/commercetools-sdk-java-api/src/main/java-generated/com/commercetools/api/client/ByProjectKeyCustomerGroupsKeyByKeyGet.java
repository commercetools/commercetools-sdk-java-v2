...
public class ByProjectKeyCustomerGroupsKeyByKeyGet extends
        TypeApiMethod<ByProjectKeyCustomerGroupsKeyByKeyGet, com.commercetools.api.models.customer_group.CustomerGroup>
        ...
        com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyCustomerGroupsKeyByKeyGet> {
     ...
     */
    public <TValue> ByProjectKeyCustomerGroupsKeyByKeyGet withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyCustomerGroupsKeyByKeyGet
     */
    public <TValue> ByProjectKeyCustomerGroupsKeyByKeyGet addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyCustomerGroupsKeyByKeyGet
     */
    public ByProjectKeyCustomerGroupsKeyByKeyGet withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyCustomerGroupsKeyByKeyGet
     */
    public ByProjectKeyCustomerGroupsKeyByKeyGet addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyCustomerGroupsKeyByKeyGet
     */
    public ByProjectKeyCustomerGroupsKeyByKeyGet withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyCustomerGroupsKeyByKeyGet
     */
    public ByProjectKeyCustomerGroupsKeyByKeyGet addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyCustomerGroupsKeyByKeyGet
     */
    public <TValue> ByProjectKeyCustomerGroupsKeyByKeyGet withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyCustomerGroupsKeyByKeyGet
     */
    public <TValue> ByProjectKeyCustomerGroupsKeyByKeyGet addExpand(final Collection<TValue> expand) {
    ...
    public boolean equals(Object o) {
        ...
        ByProjectKeyCustomerGroupsKeyByKeyGet that = (ByProjectKeyCustomerGroupsKeyByKeyGet) o;
