...
public class ByProjectKeyCustomerGroupsPost extends BodyApiMethod<ByProjectKeyCustomerGroupsPost, com.commercetools.api.models.customer_group.CustomerGroup, com.commercetools.api.models.customer_group.CustomerGroupDraft> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyCustomerGroupsPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyCustomerGroupsPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyCustomerGroupsPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(customerGroupDraft)));
     ...
     */
    public <TValue> ByProjectKeyCustomerGroupsPost withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyCustomerGroupsPost
     */
    public <TValue> ByProjectKeyCustomerGroupsPost addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyCustomerGroupsPost
     */
    public ByProjectKeyCustomerGroupsPost withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyCustomerGroupsPost
     */
    public ByProjectKeyCustomerGroupsPost addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyCustomerGroupsPost
     */
    public ByProjectKeyCustomerGroupsPost withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyCustomerGroupsPost
     */
    public ByProjectKeyCustomerGroupsPost addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyCustomerGroupsPost
     */
    public <TValue> ByProjectKeyCustomerGroupsPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyCustomerGroupsPost
     */
    public <TValue> ByProjectKeyCustomerGroupsPost addExpand(final Collection<TValue> expand) {
    ...
    public ByProjectKeyCustomerGroupsPost withBody(com.commercetools.api.models.customer_group.CustomerGroupDraft customerGroupDraft) {
