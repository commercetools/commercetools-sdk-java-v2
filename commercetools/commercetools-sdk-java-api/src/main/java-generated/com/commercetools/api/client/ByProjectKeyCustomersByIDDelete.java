...
public class ByProjectKeyCustomersByIDDelete extends ApiMethod<ByProjectKeyCustomersByIDDelete, com.commercetools.api.models.customer.Customer> implements com.commercetools.api.client.ApiDeleteMethod<ByProjectKeyCustomersByIDDelete, com.commercetools.api.models.customer.Customer>, com.commercetools.api.client.DataerasureTrait<ByProjectKeyCustomersByIDDelete>, com.commercetools.api.client.VersionedTrait<ByProjectKeyCustomersByIDDelete>, com.commercetools.api.client.ConflictingTrait<ByProjectKeyCustomersByIDDelete>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyCustomersByIDDelete>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyCustomersByIDDelete>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyCustomersByIDDelete> {
     ...
     * @return ByProjectKeyCustomersByIDDelete
     */
    public <TValue> ByProjectKeyCustomersByIDDelete withDataErasure(final Collection<TValue> dataErasure) {
     ...
     * @return ByProjectKeyCustomersByIDDelete
     */
    public <TValue> ByProjectKeyCustomersByIDDelete addDataErasure(final Collection<TValue> dataErasure) {
     ...
     * @return ByProjectKeyCustomersByIDDelete
     */
    public <TValue> ByProjectKeyCustomersByIDDelete withVersion(final Collection<TValue> version) {
     ...
     * @return ByProjectKeyCustomersByIDDelete
     */
    public <TValue> ByProjectKeyCustomersByIDDelete addVersion(final Collection<TValue> version) {
     ...
     * @return ByProjectKeyCustomersByIDDelete
     */
    public <TValue> ByProjectKeyCustomersByIDDelete withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyCustomersByIDDelete
     */
    public <TValue> ByProjectKeyCustomersByIDDelete addExpand(final Collection<TValue> expand) {
