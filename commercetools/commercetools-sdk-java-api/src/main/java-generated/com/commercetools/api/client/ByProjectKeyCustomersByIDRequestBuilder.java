...
public class ByProjectKeyCustomersByIDRequestBuilder  {
    ...
    public ByProjectKeyCustomersByIDPostString post(final String customerUpdate) {
        return new ByProjectKeyCustomersByIDPostString(apiHttpClient, projectKey, ID, customerUpdate);
    }
    public ByProjectKeyCustomersByIDPost post(UnaryOperator<com.commercetools.api.models.customer.CustomerUpdateBuilder> op) {
