...
public class ByProjectKeyCustomersPasswordRequestBuilder  {
    ...
    public ByProjectKeyCustomersPasswordPostString post(final String customerChangePassword) {
        return new ByProjectKeyCustomersPasswordPostString(apiHttpClient, projectKey, customerChangePassword);
    }
    public ByProjectKeyCustomersPasswordPost post(UnaryOperator<com.commercetools.api.models.customer.CustomerChangePasswordBuilder> op) {
