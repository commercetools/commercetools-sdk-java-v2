...
public class ByProjectKeyCustomersPasswordTokenByPasswordTokenRequestBuilder {
    ...
    public ByProjectKeyCustomersPasswordTokenByPasswordTokenRequestBuilder(final ApiHttpClient apiHttpClient,
            final String projectKey, final String passwordToken) {
