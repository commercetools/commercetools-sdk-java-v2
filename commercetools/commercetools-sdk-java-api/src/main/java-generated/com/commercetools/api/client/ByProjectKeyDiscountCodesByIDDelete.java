...
public class ByProjectKeyDiscountCodesByIDDelete extends ApiMethod<ByProjectKeyDiscountCodesByIDDelete, com.commercetools.api.models.discount_code.DiscountCode> implements com.commercetools.api.client.ApiDeleteMethod<ByProjectKeyDiscountCodesByIDDelete, com.commercetools.api.models.discount_code.DiscountCode>, com.commercetools.api.client.DataerasureTrait<ByProjectKeyDiscountCodesByIDDelete>, com.commercetools.api.client.VersionedTrait<ByProjectKeyDiscountCodesByIDDelete>, com.commercetools.api.client.ConflictingTrait<ByProjectKeyDiscountCodesByIDDelete>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyDiscountCodesByIDDelete>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyDiscountCodesByIDDelete>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyDiscountCodesByIDDelete> {
     ...
     * @return ByProjectKeyDiscountCodesByIDDelete
     */
    public <TValue> ByProjectKeyDiscountCodesByIDDelete withDataErasure(final Collection<TValue> dataErasure) {
     ...
     * @return ByProjectKeyDiscountCodesByIDDelete
     */
    public <TValue> ByProjectKeyDiscountCodesByIDDelete addDataErasure(final Collection<TValue> dataErasure) {
     ...
     * @return ByProjectKeyDiscountCodesByIDDelete
     */
    public <TValue> ByProjectKeyDiscountCodesByIDDelete withVersion(final Collection<TValue> version) {
     ...
     * @return ByProjectKeyDiscountCodesByIDDelete
     */
    public <TValue> ByProjectKeyDiscountCodesByIDDelete addVersion(final Collection<TValue> version) {
     ...
     * @return ByProjectKeyDiscountCodesByIDDelete
     */
    public <TValue> ByProjectKeyDiscountCodesByIDDelete withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyDiscountCodesByIDDelete
     */
    public <TValue> ByProjectKeyDiscountCodesByIDDelete addExpand(final Collection<TValue> expand) {
