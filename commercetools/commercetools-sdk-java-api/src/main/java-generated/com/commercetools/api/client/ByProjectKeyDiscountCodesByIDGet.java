...
public class ByProjectKeyDiscountCodesByIDGet extends ApiMethod<ByProjectKeyDiscountCodesByIDGet, com.commercetools.api.models.discount_code.DiscountCode> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyDiscountCodesByIDGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyDiscountCodesByIDGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyDiscountCodesByIDGet> {
     ...
     */
    public <TValue> ByProjectKeyDiscountCodesByIDGet withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyDiscountCodesByIDGet
     */
    public <TValue> ByProjectKeyDiscountCodesByIDGet addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyDiscountCodesByIDGet
     */
    public ByProjectKeyDiscountCodesByIDGet withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyDiscountCodesByIDGet
     */
    public ByProjectKeyDiscountCodesByIDGet addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyDiscountCodesByIDGet
     */
    public ByProjectKeyDiscountCodesByIDGet withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyDiscountCodesByIDGet
     */
    public ByProjectKeyDiscountCodesByIDGet addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyDiscountCodesByIDGet
     */
    public <TValue> ByProjectKeyDiscountCodesByIDGet withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyDiscountCodesByIDGet
     */
    public <TValue> ByProjectKeyDiscountCodesByIDGet addExpand(final Collection<TValue> expand) {
    ...
    public boolean equals(Object o) {
        ...
        ByProjectKeyDiscountCodesByIDGet that = (ByProjectKeyDiscountCodesByIDGet) o;
