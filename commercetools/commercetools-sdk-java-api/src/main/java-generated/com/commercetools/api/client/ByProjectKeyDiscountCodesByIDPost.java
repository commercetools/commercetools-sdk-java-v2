...
public class ByProjectKeyDiscountCodesByIDPost extends BodyApiMethod<ByProjectKeyDiscountCodesByIDPost, com.commercetools.api.models.discount_code.DiscountCode, com.commercetools.api.models.discount_code.DiscountCodeUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyDiscountCodesByIDPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyDiscountCodesByIDPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyDiscountCodesByIDPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyDiscountCodesByIDPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(discountCodeUpdate)));
     ...
     * @return ByProjectKeyDiscountCodesByIDPost
     */
    public <TValue> ByProjectKeyDiscountCodesByIDPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyDiscountCodesByIDPost
     */
    public <TValue> ByProjectKeyDiscountCodesByIDPost addExpand(final Collection<TValue> expand) {
    ...
    public ByProjectKeyDiscountCodesByIDPost withBody(com.commercetools.api.models.discount_code.DiscountCodeUpdate discountCodeUpdate) {
