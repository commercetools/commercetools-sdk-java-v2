...
public class ByProjectKeyDiscountCodesPostString extends StringBodyApiMethod<ByProjectKeyDiscountCodesPostString, com.commercetools.api.models.discount_code.DiscountCode> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyDiscountCodesPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyDiscountCodesPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyDiscountCodesPostString> {
    ...
    public ByProjectKeyDiscountCodesPostString(final ApiHttpClient apiHttpClient, String projectKey, String discountCodeDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), discountCodeDraft.getBytes(StandardCharsets.UTF_8));
