...
public class ByProjectKeyExtensionsByIDDelete extends ApiMethod<ByProjectKeyExtensionsByIDDelete, com.commercetools.api.models.extension.Extension> implements com.commercetools.api.client.ApiDeleteMethod<ByProjectKeyExtensionsByIDDelete, com.commercetools.api.models.extension.Extension>, com.commercetools.api.client.VersionedTrait<ByProjectKeyExtensionsByIDDelete>, com.commercetools.api.client.ConflictingTrait<ByProjectKeyExtensionsByIDDelete>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyExtensionsByIDDelete>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyExtensionsByIDDelete>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyExtensionsByIDDelete> {
     ...
     * @return ByProjectKeyExtensionsByIDDelete
     */
    public <TValue> ByProjectKeyExtensionsByIDDelete withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyExtensionsByIDDelete
     */
    public <TValue> ByProjectKeyExtensionsByIDDelete addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyExtensionsByIDDelete
     */
    public ByProjectKeyExtensionsByIDDelete withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyExtensionsByIDDelete
     */
    public ByProjectKeyExtensionsByIDDelete addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyExtensionsByIDDelete
     */
    public ByProjectKeyExtensionsByIDDelete withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyExtensionsByIDDelete
     */
    public ByProjectKeyExtensionsByIDDelete addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyExtensionsByIDDelete
     */
    public <TValue> ByProjectKeyExtensionsByIDDelete withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyExtensionsByIDDelete
     */
    public <TValue> ByProjectKeyExtensionsByIDDelete addExpand(final Collection<TValue> expand) {
