...
public class ByProjectKeyExtensionsKeyByKeyGet extends ApiMethod<ByProjectKeyExtensionsKeyByKeyGet, com.commercetools.api.models.extension.Extension> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyExtensionsKeyByKeyGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyExtensionsKeyByKeyGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyExtensionsKeyByKeyGet> {
     ...
     */
    public <TValue> ByProjectKeyExtensionsKeyByKeyGet withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyExtensionsKeyByKeyGet
     */
    public <TValue> ByProjectKeyExtensionsKeyByKeyGet addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyExtensionsKeyByKeyGet
     */
    public ByProjectKeyExtensionsKeyByKeyGet withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyExtensionsKeyByKeyGet
     */
    public ByProjectKeyExtensionsKeyByKeyGet addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyExtensionsKeyByKeyGet
     */
    public ByProjectKeyExtensionsKeyByKeyGet withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyExtensionsKeyByKeyGet
     */
    public ByProjectKeyExtensionsKeyByKeyGet addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyExtensionsKeyByKeyGet
     */
    public <TValue> ByProjectKeyExtensionsKeyByKeyGet withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyExtensionsKeyByKeyGet
     */
    public <TValue> ByProjectKeyExtensionsKeyByKeyGet addExpand(final Collection<TValue> expand) {
