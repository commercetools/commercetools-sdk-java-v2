...
public class ByProjectKeyExtensionsPost extends BodyApiMethod<ByProjectKeyExtensionsPost, com.commercetools.api.models.extension.Extension, com.commercetools.api.models.extension.ExtensionDraft> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyExtensionsPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyExtensionsPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyExtensionsPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(extensionDraft)));
