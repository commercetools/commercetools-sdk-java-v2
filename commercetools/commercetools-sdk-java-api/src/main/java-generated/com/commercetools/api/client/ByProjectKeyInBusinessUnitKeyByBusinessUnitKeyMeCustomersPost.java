...
public class ByProjectKeyInBusinessUnitKeyByBusinessUnitKeyMeCustomersPost extends BodyApiMethod<ByProjectKeyInBusinessUnitKeyByBusinessUnitKeyMeCustomersPost, com.commercetools.api.models.customer.CustomerSignInResult, com.commercetools.api.models.me.MyBusinessUnitAssociateDraft> {
    ...
    public ByProjectKeyInBusinessUnitKeyByBusinessUnitKeyMeCustomersPost(final ApiHttpClient apiHttpClient, String projectKey, String businessUnitKey, com.commercetools.api.models.me.MyBusinessUnitAssociateDraft myBusinessUnitAssociateDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(myBusinessUnitAssociateDraft)));
    ...
    public ByProjectKeyInBusinessUnitKeyByBusinessUnitKeyMeCustomersPost withBody(com.commercetools.api.models.me.MyBusinessUnitAssociateDraft myBusinessUnitAssociateDraft) {
