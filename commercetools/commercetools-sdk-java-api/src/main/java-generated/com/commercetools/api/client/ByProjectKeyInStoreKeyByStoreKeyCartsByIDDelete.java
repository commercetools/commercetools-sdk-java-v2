...
public class ByProjectKeyInStoreKeyByStoreKeyCartsByIDDelete extends ApiMethod<ByProjectKeyInStoreKeyByStoreKeyCartsByIDDelete, com.commercetools.api.models.cart.Cart> implements com.commercetools.api.client.DataerasureTrait<ByProjectKeyInStoreKeyByStoreKeyCartsByIDDelete>, com.commercetools.api.client.VersionedTrait<ByProjectKeyInStoreKeyByStoreKeyCartsByIDDelete>, com.commercetools.api.client.ConflictingTrait<ByProjectKeyInStoreKeyByStoreKeyCartsByIDDelete>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyInStoreKeyByStoreKeyCartsByIDDelete>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyInStoreKeyByStoreKeyCartsByIDDelete>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyInStoreKeyByStoreKeyCartsByIDDelete> {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyCartsByIDDelete
     */
    public ByProjectKeyInStoreKeyByStoreKeyCartsByIDDelete withDataErasure(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyCartsByIDDelete
     */
    public ByProjectKeyInStoreKeyByStoreKeyCartsByIDDelete addDataErasure(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyCartsByIDDelete
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyCartsByIDDelete withDataErasure(final Collection<TValue> dataErasure) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyCartsByIDDelete
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyCartsByIDDelete addDataErasure(final Collection<TValue> dataErasure) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyCartsByIDDelete
     */
    public ByProjectKeyInStoreKeyByStoreKeyCartsByIDDelete withVersion(final Function<StringBuilder, StringBuilder> op) {
    ...
    public boolean equals(Object o) {
        ...
        ByProjectKeyInStoreKeyByStoreKeyCartsByIDDelete that = (ByProjectKeyInStoreKeyByStoreKeyCartsByIDDelete) o;
