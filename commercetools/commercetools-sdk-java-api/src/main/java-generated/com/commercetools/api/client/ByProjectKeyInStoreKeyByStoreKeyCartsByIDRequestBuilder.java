...
public class ByProjectKeyInStoreKeyByStoreKeyCartsByIDRequestBuilder  {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyCartsByIDPostString post(final String cartUpdate) {
        return new ByProjectKeyInStoreKeyByStoreKeyCartsByIDPostString(apiHttpClient, projectKey, storeKey, ID, cartUpdate);
    }
    public ByProjectKeyInStoreKeyByStoreKeyCartsByIDPost post(UnaryOperator<com.commercetools.api.models.cart.CartUpdateBuilder> op) {
