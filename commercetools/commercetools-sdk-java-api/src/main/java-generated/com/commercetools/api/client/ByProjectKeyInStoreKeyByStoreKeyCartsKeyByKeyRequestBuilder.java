...
public class ByProjectKeyInStoreKeyByStoreKeyCartsKeyByKeyRequestBuilder  {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyCartsKeyByKeyPost post(com.commercetools.api.models.cart.CartUpdate cartUpdate) {
        return new ByProjectKeyInStoreKeyByStoreKeyCartsKeyByKeyPost(apiHttpClient, projectKey, storeKey, key, cartUpdate);
    }
    
    
    public ByProjectKeyInStoreKeyByStoreKeyCartsKeyByKeyPostString post(final String cartUpdate) {
        return new ByProjectKeyInStoreKeyByStoreKeyCartsKeyByKeyPostString(apiHttpClient, projectKey, storeKey, key, cartUpdate);
    }
    public ByProjectKeyInStoreKeyByStoreKeyCartsKeyByKeyPost post(UnaryOperator<com.commercetools.api.models.cart.CartUpdateBuilder> op) {
