...
public class ByProjectKeyInStoreKeyByStoreKeyCartsReplicateRequestBuilder  {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyCartsReplicatePostString post(final String replicaCartDraft) {
        return new ByProjectKeyInStoreKeyByStoreKeyCartsReplicatePostString(apiHttpClient, projectKey, storeKey, replicaCartDraft);
    }
    public ByProjectKeyInStoreKeyByStoreKeyCartsReplicatePost post(UnaryOperator<com.commercetools.api.models.cart.ReplicaCartDraftBuilder> op) {
