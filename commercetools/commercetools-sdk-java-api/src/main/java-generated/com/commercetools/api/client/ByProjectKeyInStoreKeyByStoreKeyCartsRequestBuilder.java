...
public class ByProjectKeyInStoreKeyByStoreKeyCartsRequestBuilder implements ByProjectKeyInStoreKeyByStoreKeyCartsRequestMixin {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyCartsPost post(UnaryOperator<com.commercetools.api.models.cart.CartDraftBuilder> op) {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyCartsKeyByKeyRequestBuilder withKey(String key) {
        return new ByProjectKeyInStoreKeyByStoreKeyCartsKeyByKeyRequestBuilder(apiHttpClient, projectKey, storeKey, key);
    }
