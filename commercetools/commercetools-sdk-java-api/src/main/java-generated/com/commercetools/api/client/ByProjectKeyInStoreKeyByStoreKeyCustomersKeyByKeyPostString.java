...
public class ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyPostString extends StringBodyApiMethod<ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyPostString, com.commercetools.api.models.customer.Customer> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyPostString>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyPostString>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyPostString> {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyPostString(final ApiHttpClient apiHttpClient, String projectKey, String storeKey, String key, String customerUpdate) {
        super(apiHttpClient);
    ...
    public ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyPostString(ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyPostString t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), customerUpdate.getBytes(StandardCharsets.UTF_8));
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyPostString
     */
    public ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyPostString withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyPostString
     */
    public ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyPostString addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyPostString
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyPostString withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyPostString
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyPostString addExpand(final Collection<TValue> expand) {
