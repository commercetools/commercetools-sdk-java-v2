...
public class ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordResetPostString extends StringBodyApiMethod<ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordResetPostString, com.commercetools.api.models.customer.Customer> implements com.commercetools.api.client.ErrorableTrait<ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordResetPostString> {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordResetPostString(final ApiHttpClient apiHttpClient, String projectKey, String storeKey, String customerResetPassword) {
        super(apiHttpClient);
    ...
    public ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordResetPostString(ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordResetPostString t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), customerResetPassword.getBytes(StandardCharsets.UTF_8));
