...
public class ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordTokenPostString extends StringBodyApiMethod<ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordTokenPostString, com.commercetools.api.models.customer.CustomerToken> implements com.commercetools.api.client.ErrorableTrait<ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordTokenPostString> {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordTokenPostString(final ApiHttpClient apiHttpClient, String projectKey, String storeKey, String customerCreatePasswordResetToken) {
        super(apiHttpClient);
    ...
    public ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordTokenPostString(ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordTokenPostString t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), customerCreatePasswordResetToken.getBytes(StandardCharsets.UTF_8));
    ...
    public ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordTokenPostString withBody(String customerCreatePasswordResetToken) {
