...
public class ByProjectKeyInStoreKeyByStoreKeyCustomersPostString extends StringBodyApiMethod<ByProjectKeyInStoreKeyByStoreKeyCustomersPostString, com.commercetools.api.models.customer.CustomerSignInResult> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyInStoreKeyByStoreKeyCustomersPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyInStoreKeyByStoreKeyCustomersPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyInStoreKeyByStoreKeyCustomersPostString> {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyCustomersPostString(final ApiHttpClient apiHttpClient, String projectKey, String storeKey, String customerDraft) {
        super(apiHttpClient);
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyCustomersPostString
     */
    public ByProjectKeyInStoreKeyByStoreKeyCustomersPostString withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyCustomersPostString
     */
    public ByProjectKeyInStoreKeyByStoreKeyCustomersPostString addExpand(final Function<StringBuilder, StringBuilder> op) {
