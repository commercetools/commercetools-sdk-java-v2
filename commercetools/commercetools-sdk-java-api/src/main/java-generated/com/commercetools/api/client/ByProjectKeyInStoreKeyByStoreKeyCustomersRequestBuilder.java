...
public class ByProjectKeyInStoreKeyByStoreKeyCustomersRequestBuilder implements ByProjectKeyInStoreKeyByStoreKeyCustomersRequestMixin {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyCustomersRequestBuilder (final ApiHttpClient apiHttpClient,final String projectKey,final String storeKey) {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyCustomersPost post(com.commercetools.api.models.customer.CustomerDraft customerDraft) {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyCustomersPostString post(final String customerDraft) {
        return new ByProjectKeyInStoreKeyByStoreKeyCustomersPostString(apiHttpClient, projectKey, storeKey, customerDraft);
    }
    public ByProjectKeyInStoreKeyByStoreKeyCustomersPost post(UnaryOperator<com.commercetools.api.models.customer.CustomerDraftBuilder> op) {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordTokenByPasswordTokenRequestBuilder withPasswordToken(String passwordToken) {
        return new ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordTokenByPasswordTokenRequestBuilder(apiHttpClient, projectKey, storeKey, passwordToken);
    }
    
    public ByProjectKeyInStoreKeyByStoreKeyCustomersEmailTokenByEmailTokenRequestBuilder withEmailToken(String emailToken) {
        return new ByProjectKeyInStoreKeyByStoreKeyCustomersEmailTokenByEmailTokenRequestBuilder(apiHttpClient, projectKey, storeKey, emailToken);
    }
    ...
    public ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyRequestBuilder withKey(String key) {
        return new ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyRequestBuilder(apiHttpClient, projectKey, storeKey, key);
    }
