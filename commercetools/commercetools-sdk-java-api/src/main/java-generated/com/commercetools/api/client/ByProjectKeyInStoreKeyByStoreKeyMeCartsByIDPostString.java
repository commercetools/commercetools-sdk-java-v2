...
public class ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDPostString extends StringBodyApiMethod<ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDPostString, com.commercetools.api.models.cart.Cart> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDPostString>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDPostString>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDPostString> {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDPostString(final ApiHttpClient apiHttpClient, String projectKey, String storeKey, String ID, String myCartUpdate) {
        super(apiHttpClient);
    ...
    public ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDPostString(ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDPostString t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), myCartUpdate.getBytes(StandardCharsets.UTF_8));
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDPostString
     */
    public ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDPostString withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDPostString
     */
    public ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDPostString addExpand(final Function<StringBuilder, StringBuilder> op) {
