...
public class ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDRequestBuilder  {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDPost post(com.commercetools.api.models.me.MyCartUpdate myCartUpdate) {
        return new ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDPost(apiHttpClient, projectKey, storeKey, ID, myCartUpdate);
    }
    
    
    public ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDPostString post(final String myCartUpdate) {
        return new ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDPostString(apiHttpClient, projectKey, storeKey, ID, myCartUpdate);
    }
    public ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDPost post(UnaryOperator<com.commercetools.api.models.me.MyCartUpdateBuilder> op) {
