...
public class ByProjectKeyInStoreKeyByStoreKeyMeEmailConfirmPostString extends StringBodyApiMethod<ByProjectKeyInStoreKeyByStoreKeyMeEmailConfirmPostString, com.commercetools.api.models.customer.Customer> implements com.commercetools.api.client.ErrorableTrait<ByProjectKeyInStoreKeyByStoreKeyMeEmailConfirmPostString> {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyMeEmailConfirmPostString(final ApiHttpClient apiHttpClient, String projectKey, String storeKey, String myCustomerEmailVerify) {
        super(apiHttpClient);
    ...
    public ByProjectKeyInStoreKeyByStoreKeyMeEmailConfirmPostString(ByProjectKeyInStoreKeyByStoreKeyMeEmailConfirmPostString t) {
        super(t);
