...
/**
 *  <p>Returns a Customer for a given Query Predicate in a <a href="https://docs.commercetools.com/apis/ctp:api:type:Store" rel="nofollow">Store</a>. Returns a <code>200</code> status if successful.</p>
 ...
 *   <li>If a Customer exists in the Store for the given Query Predicate, but does not have an <code>id</code> value that matches the <span>customer:{id}</span> scope.</li>
