...
public class ByProjectKeyInStoreKeyByStoreKeyMePasswordPostString extends StringBodyApiMethod<ByProjectKeyInStoreKeyByStoreKeyMePasswordPostString, com.commercetools.api.models.customer.Customer> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyInStoreKeyByStoreKeyMePasswordPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyInStoreKeyByStoreKeyMePasswordPostString> {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyMePasswordPostString(final ApiHttpClient apiHttpClient, String projectKey, String storeKey, String myCustomerChangePassword) {
        super(apiHttpClient);
    ...
    public ByProjectKeyInStoreKeyByStoreKeyMePasswordPostString(ByProjectKeyInStoreKeyByStoreKeyMePasswordPostString t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), myCustomerChangePassword.getBytes(StandardCharsets.UTF_8));
