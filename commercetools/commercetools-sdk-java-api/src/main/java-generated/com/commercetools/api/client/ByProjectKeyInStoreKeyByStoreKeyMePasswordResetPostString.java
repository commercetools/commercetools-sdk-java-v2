...
public class ByProjectKeyInStoreKeyByStoreKeyMePasswordResetPostString extends StringBodyApiMethod<ByProjectKeyInStoreKeyByStoreKeyMePasswordResetPostString, com.commercetools.api.models.customer.Customer> implements com.commercetools.api.client.ErrorableTrait<ByProjectKeyInStoreKeyByStoreKeyMePasswordResetPostString> {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyMePasswordResetPostString(final ApiHttpClient apiHttpClient, String projectKey, String storeKey, String myCustomerResetPassword) {
        super(apiHttpClient);
    ...
    public ByProjectKeyInStoreKeyByStoreKeyMePasswordResetPostString(ByProjectKeyInStoreKeyByStoreKeyMePasswordResetPostString t) {
        super(t);
