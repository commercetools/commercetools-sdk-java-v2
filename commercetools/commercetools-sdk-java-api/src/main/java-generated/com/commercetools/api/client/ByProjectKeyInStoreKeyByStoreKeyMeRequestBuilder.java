...
public class ByProjectKeyInStoreKeyByStoreKeyMeRequestBuilder  {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyMePost post(com.commercetools.api.models.me.MyCustomerUpdate myCustomerUpdate) {
        return new ByProjectKeyInStoreKeyByStoreKeyMePost(apiHttpClient, projectKey, storeKey, myCustomerUpdate);
    }
    
    
    public ByProjectKeyInStoreKeyByStoreKeyMePostString post(final String myCustomerUpdate) {
        return new ByProjectKeyInStoreKeyByStoreKeyMePostString(apiHttpClient, projectKey, storeKey, myCustomerUpdate);
    }
    public ByProjectKeyInStoreKeyByStoreKeyMePost post(UnaryOperator<com.commercetools.api.models.me.MyCustomerUpdateBuilder> op) {
    ...
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyMeDelete delete(TValue version) {
