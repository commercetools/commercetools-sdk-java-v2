...
public class ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyPost extends BodyApiMethod<ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyPost, com.commercetools.api.models.shopping_list.ShoppingList, com.commercetools.api.models.me.MyShoppingListUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyPost> {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyPost(final ApiHttpClient apiHttpClient, String projectKey, String storeKey, String key, com.commercetools.api.models.me.MyShoppingListUpdate myShoppingListUpdate) {
        super(apiHttpClient);
    ...
    public ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyPost(ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyPost t) {
        super(t);
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyPost
     */
    public ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyPost withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyPost
     */
    public ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyPost addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyPost
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyPost
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyPost addExpand(final Collection<TValue> expand) {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyPost withBody(com.commercetools.api.models.me.MyShoppingListUpdate myShoppingListUpdate) {
