...
public class ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyRequestBuilder {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyHead head() {
        return new ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyHead(apiHttpClient, projectKey, storeKey,
            key);
    }
    ...
    public ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyPostString post(final String myShoppingListUpdate) {
        return new ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyPostString(apiHttpClient, projectKey,
            storeKey, key, myShoppingListUpdate);
    }
