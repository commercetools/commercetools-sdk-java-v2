...
public class ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsPost extends BodyApiMethod<ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsPost, com.commercetools.api.models.shopping_list.ShoppingList, com.commercetools.api.models.me.MyShoppingListDraft> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsPost> {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsPost(final ApiHttpClient apiHttpClient, String projectKey, String storeKey, com.commercetools.api.models.me.MyShoppingListDraft myShoppingListDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(myShoppingListDraft)));
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsPost
     */
    public ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsPost withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsPost
     */
    public ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsPost addExpand(final Function<StringBuilder, StringBuilder> op) {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsPost withBody(com.commercetools.api.models.me.MyShoppingListDraft myShoppingListDraft) {
