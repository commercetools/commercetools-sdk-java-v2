...
public class ByProjectKeyInStoreKeyByStoreKeyMeSignupPostString extends StringBodyApiMethod<ByProjectKeyInStoreKeyByStoreKeyMeSignupPostString, com.commercetools.api.models.customer.CustomerSignInResult> implements com.commercetools.api.client.ErrorableTrait<ByProjectKeyInStoreKeyByStoreKeyMeSignupPostString> {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyMeSignupPostString(final ApiHttpClient apiHttpClient, String projectKey, String storeKey, String myCustomerDraft) {
        super(apiHttpClient);
