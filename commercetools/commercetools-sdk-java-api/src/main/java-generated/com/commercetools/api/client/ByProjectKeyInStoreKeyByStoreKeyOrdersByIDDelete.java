...
public class ByProjectKeyInStoreKeyByStoreKeyOrdersByIDDelete extends
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        String httpRequestPath = String.format("%s/in-store/key=%s/orders/%s", encodePathParam(this.projectKey),
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyOrdersByIDDelete
     */
    public ByProjectKeyInStoreKeyByStoreKeyOrdersByIDDelete withDataErasure(
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyOrdersByIDDelete
     */
    public ByProjectKeyInStoreKeyByStoreKeyOrdersByIDDelete addDataErasure(
            final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyOrdersByIDDelete
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyOrdersByIDDelete withDataErasure(
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyOrdersByIDDelete
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyOrdersByIDDelete addDataErasure(
            final Collection<TValue> dataErasure) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyOrdersByIDDelete
     */
    public ByProjectKeyInStoreKeyByStoreKeyOrdersByIDDelete withVersion(
            final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyOrdersByIDDelete
     */
    public ByProjectKeyInStoreKeyByStoreKeyOrdersByIDDelete addVersion(
            final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyOrdersByIDDelete
     */
    public ByProjectKeyInStoreKeyByStoreKeyOrdersByIDDelete withExpand(
            final Function<StringBuilder, StringBuilder> op) {
