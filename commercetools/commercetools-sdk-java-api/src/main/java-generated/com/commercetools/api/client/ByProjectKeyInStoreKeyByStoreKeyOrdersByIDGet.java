...
public class ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet extends ApiMethod<ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet, com.commercetools.api.models.order.Order> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet> {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet
     */
    public ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet
     */
    public ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet
     */
    public ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet
     */
    public ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet addExpand(final Collection<TValue> expand) {
    ...
    public boolean equals(Object o) {
        ...
        ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet that = (ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet) o;
