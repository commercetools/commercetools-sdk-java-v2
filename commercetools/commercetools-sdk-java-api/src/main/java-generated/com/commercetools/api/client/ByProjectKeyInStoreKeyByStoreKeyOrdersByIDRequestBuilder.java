...
public class ByProjectKeyInStoreKeyByStoreKeyOrdersByIDRequestBuilder  {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyOrdersByIDPostString post(final String orderUpdate) {
        return new ByProjectKeyInStoreKeyByStoreKeyOrdersByIDPostString(apiHttpClient, projectKey, storeKey, ID, orderUpdate);
    }
    public ByProjectKeyInStoreKeyByStoreKeyOrdersByIDPost post(UnaryOperator<com.commercetools.api.models.order.OrderUpdateBuilder> op) {
