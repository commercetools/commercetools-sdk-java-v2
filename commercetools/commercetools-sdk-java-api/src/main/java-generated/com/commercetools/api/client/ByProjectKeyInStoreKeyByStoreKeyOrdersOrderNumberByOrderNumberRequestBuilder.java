...
public class ByProjectKeyInStoreKeyByStoreKeyOrdersOrderNumberByOrderNumberRequestBuilder  {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyOrdersOrderNumberByOrderNumberPost post(com.commercetools.api.models.order.OrderUpdate orderUpdate) {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyOrdersOrderNumberByOrderNumberPostString post(final String orderUpdate) {
        return new ByProjectKeyInStoreKeyByStoreKeyOrdersOrderNumberByOrderNumberPostString(apiHttpClient, projectKey, storeKey, orderNumber, orderUpdate);
    }
    public ByProjectKeyInStoreKeyByStoreKeyOrdersOrderNumberByOrderNumberPost post(UnaryOperator<com.commercetools.api.models.order.OrderUpdateBuilder> op) {
