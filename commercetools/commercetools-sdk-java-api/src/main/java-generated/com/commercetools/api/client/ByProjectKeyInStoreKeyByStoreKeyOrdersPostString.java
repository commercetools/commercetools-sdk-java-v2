...
public class ByProjectKeyInStoreKeyByStoreKeyOrdersPostString extends StringBodyApiMethod<ByProjectKeyInStoreKeyByStoreKeyOrdersPostString, com.commercetools.api.models.order.Order> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyInStoreKeyByStoreKeyOrdersPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyInStoreKeyByStoreKeyOrdersPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyInStoreKeyByStoreKeyOrdersPostString> {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyOrdersPostString(final ApiHttpClient apiHttpClient, String projectKey, String storeKey, String orderFromCartDraft) {
        super(apiHttpClient);
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyOrdersPostString
     */
    public ByProjectKeyInStoreKeyByStoreKeyOrdersPostString withExpand(final Function<StringBuilder, StringBuilder> op) {
