...
public class ByProjectKeyInStoreKeyByStoreKeyProductProjectionsByIDGet extends
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyProductProjectionsByIDGet
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyProductProjectionsByIDGet withPriceRecurrencePolicy(
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyProductProjectionsByIDGet
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyProductProjectionsByIDGet addPriceRecurrencePolicy(
            final TValue priceRecurrencePolicy) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyProductProjectionsByIDGet
     */
    public ByProjectKeyInStoreKeyByStoreKeyProductProjectionsByIDGet withPriceRecurrencePolicy(
            final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyProductProjectionsByIDGet
     */
    public ByProjectKeyInStoreKeyByStoreKeyProductProjectionsByIDGet addPriceRecurrencePolicy(
            final Supplier<String> supplier) {
