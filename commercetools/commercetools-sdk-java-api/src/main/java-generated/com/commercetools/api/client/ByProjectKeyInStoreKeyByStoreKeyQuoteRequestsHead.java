...
/**
 *  <p>Checks if one or more QuoteRequests exist for the provided query predicate. Returns a <code>200 OK</code> status if any QuoteRequests match the query predicate, or Not Found otherwise.</p>
 *
 * <hr>
