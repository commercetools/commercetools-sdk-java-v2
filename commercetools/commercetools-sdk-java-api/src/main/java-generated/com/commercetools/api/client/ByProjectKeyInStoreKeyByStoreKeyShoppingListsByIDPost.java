...
public class ByProjectKeyInStoreKeyByStoreKeyShoppingListsByIDPost extends BodyApiMethod<ByProjectKeyInStoreKeyByStoreKeyShoppingListsByIDPost, com.commercetools.api.models.shopping_list.ShoppingList, com.commercetools.api.models.shopping_list.ShoppingListUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyInStoreKeyByStoreKeyShoppingListsByIDPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyInStoreKeyByStoreKeyShoppingListsByIDPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyInStoreKeyByStoreKeyShoppingListsByIDPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyInStoreKeyByStoreKeyShoppingListsByIDPost> {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsByIDPost(final ApiHttpClient apiHttpClient, String projectKey, String storeKey, String ID, com.commercetools.api.models.shopping_list.ShoppingListUpdate shoppingListUpdate) {
        super(apiHttpClient);
    ...
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsByIDPost(ByProjectKeyInStoreKeyByStoreKeyShoppingListsByIDPost t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(shoppingListUpdate)));
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyShoppingListsByIDPost
     */
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsByIDPost withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyShoppingListsByIDPost
     */
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsByIDPost addExpand(final Function<StringBuilder, StringBuilder> op) {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsByIDPost withBody(com.commercetools.api.models.shopping_list.ShoppingListUpdate shoppingListUpdate) {
