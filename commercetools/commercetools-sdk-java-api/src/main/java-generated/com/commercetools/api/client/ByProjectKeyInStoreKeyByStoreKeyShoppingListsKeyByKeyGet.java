...
/**
 *  <p>Retrieves a ShoppingList with the provided <code>key</code> in a Store. If a ShoppingList exists in a Project but does <em>not</em> have the <code>store</code> field, or the <code>store</code> field references a different Store, the ResourceNotFound error is returned.</p>
 *
 * <hr>
...
public class ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyGet extends
        TypeApiMethod<ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyGet, com.commercetools.api.models.shopping_list.ShoppingList>
        implements
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyGet
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyGet withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyGet
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyGet addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyGet
     */
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyGet withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyGet
     */
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyGet addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyGet
     */
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyGet withExpand(
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyGet
     */
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyGet addExpand(
            final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyGet
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyGet withExpand(
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyGet
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyGet addExpand(
            final Collection<TValue> expand) {
