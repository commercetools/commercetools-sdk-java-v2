...
public class ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPostString extends StringBodyApiMethod<ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPostString, com.commercetools.api.models.shopping_list.ShoppingList> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPostString>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPostString>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPostString> {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPostString(final ApiHttpClient apiHttpClient, String projectKey, String storeKey, String key, String shoppingListUpdate) {
        super(apiHttpClient);
    ...
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPostString(ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPostString t) {
        super(t);
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPostString
     */
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPostString withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPostString
     */
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPostString addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPostString
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPostString withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPostString
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPostString addExpand(final Collection<TValue> expand) {
