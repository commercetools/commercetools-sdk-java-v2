...
public class ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyRequestBuilder  {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPostString post(final String shoppingListUpdate) {
        return new ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPostString(apiHttpClient, projectKey, storeKey, key, shoppingListUpdate);
    }
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPost post(UnaryOperator<com.commercetools.api.models.shopping_list.ShoppingListUpdateBuilder> op) {
