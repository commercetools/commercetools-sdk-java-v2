...
public class ByProjectKeyInStoreKeyByStoreKeyShoppingListsPost extends BodyApiMethod<ByProjectKeyInStoreKeyByStoreKeyShoppingListsPost, com.commercetools.api.models.shopping_list.ShoppingList, com.commercetools.api.models.shopping_list.ShoppingListDraft> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyInStoreKeyByStoreKeyShoppingListsPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyInStoreKeyByStoreKeyShoppingListsPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyInStoreKeyByStoreKeyShoppingListsPost> {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsPost(final ApiHttpClient apiHttpClient, String projectKey, String storeKey, com.commercetools.api.models.shopping_list.ShoppingListDraft shoppingListDraft) {
        super(apiHttpClient);
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyShoppingListsPost
     */
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsPost withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyShoppingListsPost
     */
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsPost addExpand(final Function<StringBuilder, StringBuilder> op) {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsPost withBody(com.commercetools.api.models.shopping_list.ShoppingListDraft shoppingListDraft) {
