...
public class ByProjectKeyInStoreKeyByStoreKeyShoppingListsPostString extends StringBodyApiMethod<ByProjectKeyInStoreKeyByStoreKeyShoppingListsPostString, com.commercetools.api.models.shopping_list.ShoppingList> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyInStoreKeyByStoreKeyShoppingListsPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyInStoreKeyByStoreKeyShoppingListsPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyInStoreKeyByStoreKeyShoppingListsPostString> {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsPostString(final ApiHttpClient apiHttpClient, String projectKey, String storeKey, String shoppingListDraft) {
        super(apiHttpClient);
    ...
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsPostString(ByProjectKeyInStoreKeyByStoreKeyShoppingListsPostString t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), shoppingListDraft.getBytes(StandardCharsets.UTF_8));
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyShoppingListsPostString
     */
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyShoppingListsPostString
     */
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsPostString withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyShoppingListsPostString
     */
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsPostString addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyInStoreKeyByStoreKeyShoppingListsPostString
     */
    public <TValue> ByProjectKeyInStoreKeyByStoreKeyShoppingListsPostString withExpand(final Collection<TValue> expand) {
