...
public class ByProjectKeyInventoryGet extends ApiMethod<ByProjectKeyInventoryGet, com.commercetools.api.models.inventory.InventoryPagedQueryResponse> implements ByProjectKeyInventoryGetMixin, com.commercetools.api.client.ExpandableTrait<ByProjectKeyInventoryGet>, com.commercetools.api.client.SortableTrait<ByProjectKeyInventoryGet>, com.commercetools.api.client.PagingTrait<ByProjectKeyInventoryGet>, com.commercetools.api.client.QueryTrait<ByProjectKeyInventoryGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyInventoryGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyInventoryGet> {
    ...
    @Override
    public ApiHttpResponse<com.commercetools.api.models.inventory.InventoryPagedQueryResponse> executeBlocking(final ApiHttpClient client, final Duration timeout) {
        return executeBlocking(client, timeout, com.commercetools.api.models.inventory.InventoryPagedQueryResponse.class);
    }

    @Override
    public CompletableFuture<ApiHttpResponse<com.commercetools.api.models.inventory.InventoryPagedQueryResponse>> execute(final ApiHttpClient client) {
     ...
     * @return ByProjectKeyInventoryGet
     */
    public <TValue> ByProjectKeyInventoryGet withPredicateVar(final String varName, final Collection<TValue> predicateVar) {
     ...
     * @return ByProjectKeyInventoryGet
     */
    public <TValue> ByProjectKeyInventoryGet addPredicateVar(final String varName, final Collection<TValue> predicateVar) {
        final String placeholderName = String.format("var.%s", varName);
