...
public class ByProjectKeyInventoryPost extends BodyApiMethod<ByProjectKeyInventoryPost, com.commercetools.api.models.inventory.InventoryEntry, com.commercetools.api.models.inventory.InventoryEntryDraft> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyInventoryPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyInventoryPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyInventoryPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(inventoryEntryDraft)));
    ...
    public ByProjectKeyInventoryPost withBody(com.commercetools.api.models.inventory.InventoryEntryDraft inventoryEntryDraft) {
