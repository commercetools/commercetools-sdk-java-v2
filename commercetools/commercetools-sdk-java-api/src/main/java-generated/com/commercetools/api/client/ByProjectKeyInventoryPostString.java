...
public class ByProjectKeyInventoryPostString extends
        StringBodyApiMethod<ByProjectKeyInventoryPostString, com.commercetools.api.models.inventory.InventoryEntry>
        implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyInventoryPostString>,
        com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyInventoryPostString>,
        com.commercetools.api.client.ErrorableTrait<ByProjectKeyInventoryPostString> {
    ...
    public ByProjectKeyInventoryPostString(final ApiHttpClient apiHttpClient, String projectKey,
            String inventoryEntryDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(),
            inventoryEntryDraft.getBytes(StandardCharsets.UTF_8));
