...
/**
 *  <p>Updates a Business Unit for a given <code>id</code>. Returns a <code>200</code> status if the Business Unit exists and the Customer has access to it, or a <a href="https://docs.commercetools.com/apis/ctp:api:type:ResourceNotFoundError" rel="nofollow">ResourceNotFound</a> error otherwise.</p>
 *
 * <hr>
...
public class ByProjectKeyMeBusinessUnitsByIDPost extends
        TypeBodyApiMethod<ByProjectKeyMeBusinessUnitsByIDPost, com.commercetools.api.models.business_unit.BusinessUnit, com.commercetools.api.models.me.MyBusinessUnitUpdate>
