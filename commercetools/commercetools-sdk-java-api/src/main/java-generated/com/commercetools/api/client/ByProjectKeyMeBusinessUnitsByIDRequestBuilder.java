...
public class ByProjectKeyMeBusinessUnitsByIDRequestBuilder  {
    ...
    public ByProjectKeyMeBusinessUnitsByIDRequestBuilder (final ApiHttpClient apiHttpClient,final String projectKey,final String ID) {
    ...
    public ByProjectKeyMeBusinessUnitsByIDPost post(com.commercetools.api.models.me.MyBusinessUnitUpdate myBusinessUnitUpdate) {
    ...
    public ByProjectKeyMeBusinessUnitsByIDPost post(UnaryOperator<com.commercetools.api.models.me.MyBusinessUnitUpdateBuilder> op) {
