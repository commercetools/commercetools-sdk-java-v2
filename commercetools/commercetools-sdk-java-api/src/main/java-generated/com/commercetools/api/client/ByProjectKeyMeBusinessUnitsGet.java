...
public class ByProjectKeyMeBusinessUnitsGet extends ApiMethod<ByProjectKeyMeBusinessUnitsGet, com.commercetools.api.models.business_unit.BusinessUnitPagedQueryResponse> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyMeBusinessUnitsGet>, com.commercetools.api.client.SortableTrait<ByProjectKeyMeBusinessUnitsGet>, com.commercetools.api.client.PagingTrait<ByProjectKeyMeBusinessUnitsGet>, com.commercetools.api.client.QueryTrait<ByProjectKeyMeBusinessUnitsGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyMeBusinessUnitsGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyMeBusinessUnitsGet> {
     ...
     * @return ByProjectKeyMeBusinessUnitsGet
     */
    public <TValue> ByProjectKeyMeBusinessUnitsGet withPredicateVar(final String varName, final Collection<TValue> predicateVar) {
     ...
     * @return ByProjectKeyMeBusinessUnitsGet
     */
    public <TValue> ByProjectKeyMeBusinessUnitsGet addPredicateVar(final String varName, final Collection<TValue> predicateVar) {
        final String placeholderName = String.format("var.%s", varName);
