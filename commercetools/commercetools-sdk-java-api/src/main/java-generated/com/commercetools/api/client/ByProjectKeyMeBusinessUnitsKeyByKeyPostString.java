...
/**
 *  <p>Updates a Business Unit for a given <code>key</code>. Returns a <code>200 OK</code> status if the Business Unit exists and the Customer has access to it, or a ResourceNotFound error otherwise.</p>
 *
 * <hr>
