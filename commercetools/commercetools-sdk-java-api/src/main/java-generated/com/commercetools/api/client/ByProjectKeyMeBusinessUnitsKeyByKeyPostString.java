...
/**
 *  <p>Updates a Business Unit for a given <code>key</code>. Returns a <code>200</code> status if the Business Unit exists and the Customer has access to it, or a <a href="https://docs.commercetools.com/apis/ctp:api:type:ResourceNotFoundError" rel="nofollow">ResourceNotFound</a> error otherwise.</p>
 *
 * <hr>
...
public class ByProjectKeyMeBusinessUnitsKeyByKeyPostString extends
        StringBodyApiMethod<ByProjectKeyMeBusinessUnitsKeyByKeyPostString, com.commercetools.api.models.business_unit.BusinessUnit>
        implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyMeBusinessUnitsKeyByKeyPostString>,
        com.commercetools.api.client.ExpandableTrait<ByProjectKeyMeBusinessUnitsKeyByKeyPostString>,
    ...
    public ByProjectKeyMeBusinessUnitsKeyByKeyPostString(final ApiHttpClient apiHttpClient, String projectKey,
            String key, String myBusinessUnitUpdate) {
        super(apiHttpClient);
