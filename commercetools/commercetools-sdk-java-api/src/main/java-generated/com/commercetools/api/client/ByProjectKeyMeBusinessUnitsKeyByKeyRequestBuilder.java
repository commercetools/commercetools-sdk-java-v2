...
public class ByProjectKeyMeBusinessUnitsKeyByKeyRequestBuilder  {
    ...
    public ByProjectKeyMeBusinessUnitsKeyByKeyRequestBuilder (final ApiHttpClient apiHttpClient,final String projectKey,final String key) {
    ...
    public ByProjectKeyMeBusinessUnitsKeyByKeyPost post(com.commercetools.api.models.me.MyBusinessUnitUpdate myBusinessUnitUpdate) {
        return new ByProjectKeyMeBusinessUnitsKeyByKeyPost(apiHttpClient, projectKey, key, myBusinessUnitUpdate);
    }
    
    
    public ByProjectKeyMeBusinessUnitsKeyByKeyPostString post(final String myBusinessUnitUpdate) {
        return new ByProjectKeyMeBusinessUnitsKeyByKeyPostString(apiHttpClient, projectKey, key, myBusinessUnitUpdate);
    }
    public ByProjectKeyMeBusinessUnitsKeyByKeyPost post(UnaryOperator<com.commercetools.api.models.me.MyBusinessUnitUpdateBuilder> op) {
