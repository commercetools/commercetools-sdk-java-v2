...
public class ByProjectKeyMeBusinessUnitsPostString extends StringBodyApiMethod<ByProjectKeyMeBusinessUnitsPostString, com.commercetools.api.models.business_unit.BusinessUnit> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyMeBusinessUnitsPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyMeBusinessUnitsPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyMeBusinessUnitsPostString> {
    ...
    public ByProjectKeyMeBusinessUnitsPostString(final ApiHttpClient apiHttpClient, String projectKey, String myBusinessUnitDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), myBusinessUnitDraft.getBytes(StandardCharsets.UTF_8));
