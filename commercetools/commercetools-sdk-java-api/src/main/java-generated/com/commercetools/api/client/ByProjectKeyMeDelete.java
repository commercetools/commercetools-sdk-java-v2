...
/**
 *  <p>Deletes the Customer specified in the <span>customer:{id}</span> scope. Returns a <code>200</code> status if successful.</p>
 *
 * <hr>
...
public class ByProjectKeyMeDelete
        extends TypeApiMethod<ByProjectKeyMeDelete, com.commercetools.api.models.customer.Customer>
