...
public class ByProjectKeyMePasswordResetRequestBuilder  {
    ...
    public ByProjectKeyMePasswordResetPost post(com.commercetools.api.models.customer.MyCustomerResetPassword myCustomerResetPassword) {
    ...
    public ByProjectKeyMePasswordResetPost post(UnaryOperator<com.commercetools.api.models.customer.MyCustomerResetPasswordBuilder> op) {
