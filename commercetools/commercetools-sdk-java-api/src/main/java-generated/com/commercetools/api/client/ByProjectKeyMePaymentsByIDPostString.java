...
public class ByProjectKeyMePaymentsByIDPostString extends StringBodyApiMethod<ByProjectKeyMePaymentsByIDPostString, com.commercetools.api.models.me.MyPayment> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyMePaymentsByIDPostString>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyMePaymentsByIDPostString>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyMePaymentsByIDPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyMePaymentsByIDPostString> {
    ...
    public ByProjectKeyMePaymentsByIDPostString(final ApiHttpClient apiHttpClient, String projectKey, String ID, String myPaymentUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), myPaymentUpdate.getBytes(StandardCharsets.UTF_8));
