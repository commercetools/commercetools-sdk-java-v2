...
/**
 *  <p>Retrieves <span>Payments</span> for the authenticated Customer or anonymous user.</p>
 *
 * <hr>
...
public class ByProjectKeyMePaymentsGet
     ...
     * @return ByProjectKeyMePaymentsGet
     */
    public <TValue> ByProjectKeyMePaymentsGet withPredicateVar(final String varName,
     ...
     * @return ByProjectKeyMePaymentsGet
     */
    public <TValue> ByProjectKeyMePaymentsGet addPredicateVar(final String varName,
            final Collection<TValue> predicateVar) {
        final String placeholderName = String.format("var.%s", varName);
