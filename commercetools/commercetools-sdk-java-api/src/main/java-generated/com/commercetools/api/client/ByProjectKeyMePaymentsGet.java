...
public class ByProjectKeyMePaymentsGet extends ApiMethod<ByProjectKeyMePaymentsGet, com.commercetools.api.models.me.MyPaymentPagedQueryResponse> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyMePaymentsGet>, com.commercetools.api.client.SortableTrait<ByProjectKeyMePaymentsGet>, com.commercetools.api.client.PagingTrait<ByProjectKeyMePaymentsGet>, com.commercetools.api.client.QueryTrait<ByProjectKeyMePaymentsGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyMePaymentsGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyMePaymentsGet> {
    ...
    @Override
    public ApiHttpResponse<com.commercetools.api.models.me.MyPaymentPagedQueryResponse> executeBlocking(final ApiHttpClient client, final Duration timeout) {
        return executeBlocking(client, timeout, com.commercetools.api.models.me.MyPaymentPagedQueryResponse.class);
    }

    @Override
    public CompletableFuture<ApiHttpResponse<com.commercetools.api.models.me.MyPaymentPagedQueryResponse>> execute(final ApiHttpClient client) {
     ...
     * @return ByProjectKeyMePaymentsGet
     */
     ...
     * @return ByProjectKeyMePaymentsGet
     */
    public <TValue> ByProjectKeyMePaymentsGet withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyMePaymentsGet
     */
    public <TValue> ByProjectKeyMePaymentsGet addExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyMePaymentsGet
     */
    public <TValue> ByProjectKeyMePaymentsGet withSort(final Collection<TValue> sort) {
     ...
     * @return ByProjectKeyMePaymentsGet
     */
    public <TValue> ByProjectKeyMePaymentsGet addSort(final Collection<TValue> sort) {
     ...
     * @return ByProjectKeyMePaymentsGet
     */
    public <TValue> ByProjectKeyMePaymentsGet withLimit(final Collection<TValue> limit) {
     ...
     * @return ByProjectKeyMePaymentsGet
     */
    public <TValue> ByProjectKeyMePaymentsGet addLimit(final Collection<TValue> limit) {
     ...
     * @return ByProjectKeyMePaymentsGet
     */
    public <TValue> ByProjectKeyMePaymentsGet withOffset(final Collection<TValue> offset) {
     ...
     * @return ByProjectKeyMePaymentsGet
     */
    public <TValue> ByProjectKeyMePaymentsGet addOffset(final Collection<TValue> offset) {
     ...
     * @return ByProjectKeyMePaymentsGet
     */
    public <TValue> ByProjectKeyMePaymentsGet withWithTotal(final Collection<TValue> withTotal) {
     ...
     * @return ByProjectKeyMePaymentsGet
     */
    public <TValue> ByProjectKeyMePaymentsGet addWithTotal(final Collection<TValue> withTotal) {
     ...
     * @return ByProjectKeyMePaymentsGet
     */
    public <TValue> ByProjectKeyMePaymentsGet withWhere(final Collection<TValue> where) {
     ...
     * @return ByProjectKeyMePaymentsGet
     */
    public <TValue> ByProjectKeyMePaymentsGet addWhere(final Collection<TValue> where) {
     ...
     * @return ByProjectKeyMePaymentsGet
     */
    public <TValue> ByProjectKeyMePaymentsGet withPredicateVar(final String varName, final Collection<TValue> predicateVar) {
     ...
     * @return ByProjectKeyMePaymentsGet
     */
    public <TValue> ByProjectKeyMePaymentsGet addPredicateVar(final String varName, final Collection<TValue> predicateVar) {
        final String placeholderName = String.format("var.%s", varName);
