...
public class ByProjectKeyMePaymentsPost extends BodyApiMethod<ByProjectKeyMePaymentsPost, com.commercetools.api.models.me.MyPayment, com.commercetools.api.models.me.MyPaymentDraft> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyMePaymentsPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyMePaymentsPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyMePaymentsPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(myPaymentDraft)));
     ...
     * @return ByProjectKeyMePaymentsPost
     */
     ...
     * @return ByProjectKeyMePaymentsPost
     */
    public <TValue> ByProjectKeyMePaymentsPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyMePaymentsPost
     */
    public <TValue> ByProjectKeyMePaymentsPost addExpand(final Collection<TValue> expand) {
