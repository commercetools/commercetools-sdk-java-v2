...
public class ByProjectKeyMeQuoteRequestsByIDPost extends BodyApiMethod<ByProjectKeyMeQuoteRequestsByIDPost, com.commercetools.api.models.quote_request.QuoteRequest, com.commercetools.api.models.me.MyQuoteRequestUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyMeQuoteRequestsByIDPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyMeQuoteRequestsByIDPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyMeQuoteRequestsByIDPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyMeQuoteRequestsByIDPost> {
    ...
    public ByProjectKeyMeQuoteRequestsByIDPost(final ApiHttpClient apiHttpClient, String projectKey, String ID, com.commercetools.api.models.me.MyQuoteRequestUpdate myQuoteRequestUpdate) {
        super(apiHttpClient);
     ...
     * @return ByProjectKeyMeQuoteRequestsByIDPost
     */
     ...
     * @return ByProjectKeyMeQuoteRequestsByIDPost
     */
    public <TValue> ByProjectKeyMeQuoteRequestsByIDPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyMeQuoteRequestsByIDPost
     */
    public <TValue> ByProjectKeyMeQuoteRequestsByIDPost addExpand(final Collection<TValue> expand) {
    ...
    public ByProjectKeyMeQuoteRequestsByIDPost withBody(com.commercetools.api.models.me.MyQuoteRequestUpdate myQuoteRequestUpdate) {
