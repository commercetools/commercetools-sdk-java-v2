...
public class ByProjectKeyMeQuoteRequestsByIDPostString extends StringBodyApiMethod<ByProjectKeyMeQuoteRequestsByIDPostString, com.commercetools.api.models.quote_request.QuoteRequest> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyMeQuoteRequestsByIDPostString>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyMeQuoteRequestsByIDPostString>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyMeQuoteRequestsByIDPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyMeQuoteRequestsByIDPostString> {
    ...
    public ByProjectKeyMeQuoteRequestsByIDPostString(final ApiHttpClient apiHttpClient, String projectKey, String ID, String myQuoteRequestUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), myQuoteRequestUpdate.getBytes(StandardCharsets.UTF_8));
     ...
     * @return ByProjectKeyMeQuoteRequestsByIDPostString
     */
