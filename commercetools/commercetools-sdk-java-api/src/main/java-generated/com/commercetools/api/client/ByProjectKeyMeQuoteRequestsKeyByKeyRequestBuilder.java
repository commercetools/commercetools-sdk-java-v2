...
public class ByProjectKeyMeQuoteRequestsKeyByKeyRequestBuilder  {
    ...
    public ByProjectKeyMeQuoteRequestsKeyByKeyRequestBuilder (final ApiHttpClient apiHttpClient,final String projectKey,final String key) {
        this.apiHttpClient = apiHttpClient;
        this.projectKey = projectKey;
        this.key = key;
    }

    public ByProjectKeyMeQuoteRequestsKeyByKeyPost post(com.commercetools.api.models.me.MyQuoteRequestUpdate myQuoteRequestUpdate) {
    ...
    public ByProjectKeyMeQuoteRequestsKeyByKeyPost post(UnaryOperator<com.commercetools.api.models.me.MyQuoteRequestUpdateBuilder> op) {
