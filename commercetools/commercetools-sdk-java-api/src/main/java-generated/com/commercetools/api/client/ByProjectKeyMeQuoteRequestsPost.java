...
public class ByProjectKeyMeQuoteRequestsPost extends BodyApiMethod<ByProjectKeyMeQuoteRequestsPost, com.commercetools.api.models.quote_request.QuoteRequest, com.commercetools.api.models.me.MyQuoteRequestDraft> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyMeQuoteRequestsPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyMeQuoteRequestsPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyMeQuoteRequestsPost> {
    ...
    public ByProjectKeyMeQuoteRequestsPost(final ApiHttpClient apiHttpClient, String projectKey, com.commercetools.api.models.me.MyQuoteRequestDraft myQuoteRequestDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(myQuoteRequestDraft)));
     ...
     * @return ByProjectKeyMeQuoteRequestsPost
     */
     ...
     * @return ByProjectKeyMeQuoteRequestsPost
     */
    public <TValue> ByProjectKeyMeQuoteRequestsPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyMeQuoteRequestsPost
     */
    public <TValue> ByProjectKeyMeQuoteRequestsPost addExpand(final Collection<TValue> expand) {
    ...
    public ByProjectKeyMeQuoteRequestsPost withBody(com.commercetools.api.models.me.MyQuoteRequestDraft myQuoteRequestDraft) {
