...
public class ByProjectKeyMeQuoteRequestsPostString extends StringBodyApiMethod<ByProjectKeyMeQuoteRequestsPostString, com.commercetools.api.models.quote_request.QuoteRequest> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyMeQuoteRequestsPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyMeQuoteRequestsPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyMeQuoteRequestsPostString> {
    ...
    public ByProjectKeyMeQuoteRequestsPostString(final ApiHttpClient apiHttpClient, String projectKey, String myQuoteRequestDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), myQuoteRequestDraft.getBytes(StandardCharsets.UTF_8));
