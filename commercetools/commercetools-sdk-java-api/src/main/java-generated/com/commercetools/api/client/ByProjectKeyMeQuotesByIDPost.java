...
public class ByProjectKeyMeQuotesByIDPost extends BodyApiMethod<ByProjectKeyMeQuotesByIDPost, com.commercetools.api.models.quote.Quote, com.commercetools.api.models.me.MyQuoteUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyMeQuotesByIDPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyMeQuotesByIDPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyMeQuotesByIDPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyMeQuotesByIDPost> {
    ...
    public ByProjectKeyMeQuotesByIDPost(final ApiHttpClient apiHttpClient, String projectKey, String ID, com.commercetools.api.models.me.MyQuoteUpdate myQuoteUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(myQuoteUpdate)));
     ...
     * @return ByProjectKeyMeQuotesByIDPost
     */
