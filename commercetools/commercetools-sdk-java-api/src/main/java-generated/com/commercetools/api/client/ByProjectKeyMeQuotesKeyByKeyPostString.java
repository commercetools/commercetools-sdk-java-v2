...
public class ByProjectKeyMeQuotesKeyByKeyPostString extends StringBodyApiMethod<ByProjectKeyMeQuotesKeyByKeyPostString, com.commercetools.api.models.quote.Quote> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyMeQuotesKeyByKeyPostString>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyMeQuotesKeyByKeyPostString>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyMeQuotesKeyByKeyPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyMeQuotesKeyByKeyPostString> {
    ...
    public ByProjectKeyMeQuotesKeyByKeyPostString(final ApiHttpClient apiHttpClient, String projectKey, String key, String myQuoteUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), myQuoteUpdate.getBytes(StandardCharsets.UTF_8));
