...
public class ByProjectKeyMeQuotesKeyByKeyRequestBuilder  {
    ...
    public ByProjectKeyMeQuotesKeyByKeyRequestBuilder (final ApiHttpClient apiHttpClient,final String projectKey,final String key) {
    ...
    public ByProjectKeyMeQuotesKeyByKeyPostString post(final String myQuoteUpdate) {
        return new ByProjectKeyMeQuotesKeyByKeyPostString(apiHttpClient, projectKey, key, myQuoteUpdate);
    }
    public ByProjectKeyMeQuotesKeyByKeyPost post(UnaryOperator<com.commercetools.api.models.me.MyQuoteUpdateBuilder> op) {
