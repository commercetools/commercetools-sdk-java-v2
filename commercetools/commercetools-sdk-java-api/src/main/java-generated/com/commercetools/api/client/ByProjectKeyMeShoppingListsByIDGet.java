...
public class ByProjectKeyMeShoppingListsByIDGet extends ApiMethod<ByProjectKeyMeShoppingListsByIDGet, com.commercetools.api.models.shopping_list.ShoppingList> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyMeShoppingListsByIDGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyMeShoppingListsByIDGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyMeShoppingListsByIDGet> {
     ...
     * @return ByProjectKeyMeShoppingListsByIDGet
     */
    public <TValue> ByProjectKeyMeShoppingListsByIDGet withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyMeShoppingListsByIDGet
     */
    public <TValue> ByProjectKeyMeShoppingListsByIDGet addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyMeShoppingListsByIDGet
     */
    public ByProjectKeyMeShoppingListsByIDGet withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyMeShoppingListsByIDGet
     */
    public ByProjectKeyMeShoppingListsByIDGet addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyMeShoppingListsByIDGet
     */
    public ByProjectKeyMeShoppingListsByIDGet withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyMeShoppingListsByIDGet
     */
    public ByProjectKeyMeShoppingListsByIDGet addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyMeShoppingListsByIDGet
     */
    public <TValue> ByProjectKeyMeShoppingListsByIDGet withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyMeShoppingListsByIDGet
     */
    public <TValue> ByProjectKeyMeShoppingListsByIDGet addExpand(final Collection<TValue> expand) {
