...
public class ByProjectKeyMeShoppingListsGet extends ApiMethod<ByProjectKeyMeShoppingListsGet, com.commercetools.api.models.shopping_list.ShoppingListPagedQueryResponse> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyMeShoppingListsGet>, com.commercetools.api.client.SortableTrait<ByProjectKeyMeShoppingListsGet>, com.commercetools.api.client.PagingTrait<ByProjectKeyMeShoppingListsGet>, com.commercetools.api.client.QueryTrait<ByProjectKeyMeShoppingListsGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyMeShoppingListsGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyMeShoppingListsGet> {
     ...
     * @return ByProjectKeyMeShoppingListsGet
     */
    public <TValue> ByProjectKeyMeShoppingListsGet withPredicateVar(final String varName, final Collection<TValue> predicateVar) {
     ...
     * @return ByProjectKeyMeShoppingListsGet
     */
    public <TValue> ByProjectKeyMeShoppingListsGet addPredicateVar(final String varName, final Collection<TValue> predicateVar) {
        final String placeholderName = String.format("var.%s", varName);
