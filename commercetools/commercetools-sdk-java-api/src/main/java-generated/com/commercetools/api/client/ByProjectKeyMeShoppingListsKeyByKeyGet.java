...
public class ByProjectKeyMeShoppingListsKeyByKeyGet extends ApiMethod<ByProjectKeyMeShoppingListsKeyByKeyGet, com.commercetools.api.models.shopping_list.ShoppingList> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyMeShoppingListsKeyByKeyGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyMeShoppingListsKeyByKeyGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyMeShoppingListsKeyByKeyGet> {
     ...
     * @return ByProjectKeyMeShoppingListsKeyByKeyGet
     */
    public <TValue> ByProjectKeyMeShoppingListsKeyByKeyGet withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyMeShoppingListsKeyByKeyGet
     */
    public <TValue> ByProjectKeyMeShoppingListsKeyByKeyGet addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyMeShoppingListsKeyByKeyGet
     */
    public ByProjectKeyMeShoppingListsKeyByKeyGet withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyMeShoppingListsKeyByKeyGet
     */
    public ByProjectKeyMeShoppingListsKeyByKeyGet addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyMeShoppingListsKeyByKeyGet
     */
    public ByProjectKeyMeShoppingListsKeyByKeyGet withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyMeShoppingListsKeyByKeyGet
     */
    public ByProjectKeyMeShoppingListsKeyByKeyGet addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyMeShoppingListsKeyByKeyGet
     */
    public <TValue> ByProjectKeyMeShoppingListsKeyByKeyGet withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyMeShoppingListsKeyByKeyGet
     */
    public <TValue> ByProjectKeyMeShoppingListsKeyByKeyGet addExpand(final Collection<TValue> expand) {
