...
public class ByProjectKeyMessagesGet extends ApiMethod<ByProjectKeyMessagesGet, com.commercetools.api.models.message.MessagePagedQueryResponse> implements ByProjectKeyMessagesGetMixin, com.commercetools.api.client.ExpandableTrait<ByProjectKeyMessagesGet>, com.commercetools.api.client.SortableTrait<ByProjectKeyMessagesGet>, com.commercetools.api.client.PagingTrait<ByProjectKeyMessagesGet>, com.commercetools.api.client.QueryTrait<ByProjectKeyMessagesGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyMessagesGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyMessagesGet> {
    ...
    @Override
    public ApiHttpResponse<com.commercetools.api.models.message.MessagePagedQueryResponse> executeBlocking(final ApiHttpClient client, final Duration timeout) {
     ...
     * @return ByProjectKeyMessagesGet
     */
    public <TValue> ByProjectKeyMessagesGet withPredicateVar(final String varName, final Collection<TValue> predicateVar) {
     ...
     * @return ByProjectKeyMessagesGet
     */
    public <TValue> ByProjectKeyMessagesGet addPredicateVar(final String varName, final Collection<TValue> predicateVar) {
        final String placeholderName = String.format("var.%s", varName);
