...
public class ByProjectKeyOrdersEditsByIDPost extends BodyApiMethod<ByProjectKeyOrdersEditsByIDPost, com.commercetools.api.models.order_edit.OrderEdit, com.commercetools.api.models.order_edit.OrderEditUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyOrdersEditsByIDPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyOrdersEditsByIDPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyOrdersEditsByIDPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyOrdersEditsByIDPost> {
    ...
    public ByProjectKeyOrdersEditsByIDPost(final ApiHttpClient apiHttpClient, String projectKey, String ID, com.commercetools.api.models.order_edit.OrderEditUpdate orderEditUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(orderEditUpdate)));
     ...
     * @return ByProjectKeyOrdersEditsByIDPost
     */
     ...
     * @return ByProjectKeyOrdersEditsByIDPost
     */
    public <TValue> ByProjectKeyOrdersEditsByIDPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyOrdersEditsByIDPost
     */
    public <TValue> ByProjectKeyOrdersEditsByIDPost addExpand(final Collection<TValue> expand) {
    ...
    public ByProjectKeyOrdersEditsByIDPost withBody(com.commercetools.api.models.order_edit.OrderEditUpdate orderEditUpdate) {
