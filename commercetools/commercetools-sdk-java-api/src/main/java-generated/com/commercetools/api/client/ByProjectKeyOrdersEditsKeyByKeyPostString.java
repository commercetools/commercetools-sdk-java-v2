...
public class ByProjectKeyOrdersEditsKeyByKeyPostString extends StringBodyApiMethod<ByProjectKeyOrdersEditsKeyByKeyPostString, com.commercetools.api.models.order_edit.OrderEdit> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyOrdersEditsKeyByKeyPostString>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyOrdersEditsKeyByKeyPostString>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyOrdersEditsKeyByKeyPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyOrdersEditsKeyByKeyPostString> {
    ...
    public ByProjectKeyOrdersEditsKeyByKeyPostString(final ApiHttpClient apiHttpClient, String projectKey, String key, String orderEditUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), orderEditUpdate.getBytes(StandardCharsets.UTF_8));
