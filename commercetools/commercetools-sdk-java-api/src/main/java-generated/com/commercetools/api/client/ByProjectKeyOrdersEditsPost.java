...
public class ByProjectKeyOrdersEditsPost extends BodyApiMethod<ByProjectKeyOrdersEditsPost, com.commercetools.api.models.order_edit.OrderEdit, com.commercetools.api.models.order_edit.OrderEditDraft> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyOrdersEditsPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyOrdersEditsPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyOrdersEditsPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(orderEditDraft)));
     ...
     * @return ByProjectKeyOrdersEditsPost
     */
    public <TValue> ByProjectKeyOrdersEditsPost withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyOrdersEditsPost
     */
    public <TValue> ByProjectKeyOrdersEditsPost addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyOrdersEditsPost
     */
    public ByProjectKeyOrdersEditsPost withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyOrdersEditsPost
     */
    public ByProjectKeyOrdersEditsPost addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyOrdersEditsPost
     */
    public ByProjectKeyOrdersEditsPost withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyOrdersEditsPost
     */
    public ByProjectKeyOrdersEditsPost addExpand(final Function<StringBuilder, StringBuilder> op) {
