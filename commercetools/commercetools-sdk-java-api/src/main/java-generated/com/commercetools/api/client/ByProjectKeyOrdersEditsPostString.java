...
public class ByProjectKeyOrdersEditsPostString extends StringBodyApiMethod<ByProjectKeyOrdersEditsPostString, com.commercetools.api.models.order_edit.OrderEdit> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyOrdersEditsPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyOrdersEditsPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyOrdersEditsPostString> {
    ...
    public ByProjectKeyOrdersEditsPostString(final ApiHttpClient apiHttpClient, String projectKey, String orderEditDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), orderEditDraft.getBytes(StandardCharsets.UTF_8));
