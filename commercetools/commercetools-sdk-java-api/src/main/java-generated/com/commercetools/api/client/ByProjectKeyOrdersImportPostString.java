...
public class ByProjectKeyOrdersImportPostString extends StringBodyApiMethod<ByProjectKeyOrdersImportPostString, com.commercetools.api.models.order.Order> implements com.commercetools.api.client.ErrorableTrait<ByProjectKeyOrdersImportPostString> {
    ...
    public ByProjectKeyOrdersImportPostString(final ApiHttpClient apiHttpClient, String projectKey, String orderImportDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), orderImportDraft.getBytes(StandardCharsets.UTF_8));
