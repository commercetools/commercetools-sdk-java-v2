...
public class ByProjectKeyOrdersOrderNumberByOrderNumberRequestBuilder  {
    ...
    public ByProjectKeyOrdersOrderNumberByOrderNumberPostString post(final String orderUpdate) {
        return new ByProjectKeyOrdersOrderNumberByOrderNumberPostString(apiHttpClient, projectKey, orderNumber, orderUpdate);
    }
    public ByProjectKeyOrdersOrderNumberByOrderNumberPost post(UnaryOperator<com.commercetools.api.models.order.OrderUpdateBuilder> op) {
