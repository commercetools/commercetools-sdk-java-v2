...
public class ByProjectKeyOrdersQuotesRequestBuilder  {
    ...
    public ByProjectKeyOrdersQuotesPost post(com.commercetools.api.models.order.OrderFromQuoteDraft orderFromQuoteDraft) {
    ...
    public ByProjectKeyOrdersQuotesPost post(UnaryOperator<com.commercetools.api.models.order.OrderFromQuoteDraftBuilder> op) {
