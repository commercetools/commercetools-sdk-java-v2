...
public class ByProjectKeyPaymentsByIDPostString extends StringBodyApiMethod<ByProjectKeyPaymentsByIDPostString, com.commercetools.api.models.payment.Payment> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyPaymentsByIDPostString>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyPaymentsByIDPostString>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyPaymentsByIDPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyPaymentsByIDPostString> {
    ...
    public ByProjectKeyPaymentsByIDPostString(final ApiHttpClient apiHttpClient, String projectKey, String ID, String paymentUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), paymentUpdate.getBytes(StandardCharsets.UTF_8));
