...
public class ByProjectKeyPaymentsKeyByKeyGet extends ApiMethod<ByProjectKeyPaymentsKeyByKeyGet, com.commercetools.api.models.payment.Payment> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyPaymentsKeyByKeyGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyPaymentsKeyByKeyGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyPaymentsKeyByKeyGet> {
     ...
     */
    public <TValue> ByProjectKeyPaymentsKeyByKeyGet withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyPaymentsKeyByKeyGet
     */
    public <TValue> ByProjectKeyPaymentsKeyByKeyGet addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyPaymentsKeyByKeyGet
     */
    public ByProjectKeyPaymentsKeyByKeyGet withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyPaymentsKeyByKeyGet
     */
    public ByProjectKeyPaymentsKeyByKeyGet addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyPaymentsKeyByKeyGet
     */
    public ByProjectKeyPaymentsKeyByKeyGet withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyPaymentsKeyByKeyGet
     */
    public ByProjectKeyPaymentsKeyByKeyGet addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyPaymentsKeyByKeyGet
     */
    public <TValue> ByProjectKeyPaymentsKeyByKeyGet withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyPaymentsKeyByKeyGet
     */
    public <TValue> ByProjectKeyPaymentsKeyByKeyGet addExpand(final Collection<TValue> expand) {
    ...
    public boolean equals(Object o) {
        ...
        ByProjectKeyPaymentsKeyByKeyGet that = (ByProjectKeyPaymentsKeyByKeyGet) o;
