...
public class ByProjectKeyPaymentsPostString extends StringBodyApiMethod<ByProjectKeyPaymentsPostString, com.commercetools.api.models.payment.Payment> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyPaymentsPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyPaymentsPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyPaymentsPostString> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), paymentDraft.getBytes(StandardCharsets.UTF_8));
