...
public class ByProjectKeyPost extends BodyApiMethod<ByProjectKeyPost, com.commercetools.api.models.project.Project, com.commercetools.api.models.project.ProjectUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(projectUpdate)));
