...
public class ByProjectKeyPostString extends StringBodyApiMethod<ByProjectKeyPostString, com.commercetools.api.models.project.Project> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyPostString> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), projectUpdate.getBytes(StandardCharsets.UTF_8));
