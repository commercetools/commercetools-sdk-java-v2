...
public class ByProjectKeyProductDiscountsByIDPostString extends StringBodyApiMethod<ByProjectKeyProductDiscountsByIDPostString, com.commercetools.api.models.product_discount.ProductDiscount> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyProductDiscountsByIDPostString>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyProductDiscountsByIDPostString>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyProductDiscountsByIDPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyProductDiscountsByIDPostString> {
    ...
    public ByProjectKeyProductDiscountsByIDPostString(final ApiHttpClient apiHttpClient, String projectKey, String ID, String productDiscountUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), productDiscountUpdate.getBytes(StandardCharsets.UTF_8));
