...
public class ByProjectKeyProductDiscountsByIDRequestBuilder  {
    ...
    public ByProjectKeyProductDiscountsByIDPostString post(final String productDiscountUpdate) {
        return new ByProjectKeyProductDiscountsByIDPostString(apiHttpClient, projectKey, ID, productDiscountUpdate);
    }
    public ByProjectKeyProductDiscountsByIDPost post(UnaryOperator<com.commercetools.api.models.product_discount.ProductDiscountUpdateBuilder> op) {
