...
public class ByProjectKeyProductDiscountsKeyByKeyGet extends
        TypeApiMethod<ByProjectKeyProductDiscountsKeyByKeyGet, com.commercetools.api.models.product_discount.ProductDiscount>
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        String httpRequestPath = String.format("%s/product-discounts/key=%s", encodePathParam(this.projectKey),
