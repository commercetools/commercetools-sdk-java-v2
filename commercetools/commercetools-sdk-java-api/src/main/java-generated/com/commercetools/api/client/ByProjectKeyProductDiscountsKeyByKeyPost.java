...
public class ByProjectKeyProductDiscountsKeyByKeyPost extends BodyApiMethod<ByProjectKeyProductDiscountsKeyByKeyPost, com.commercetools.api.models.product_discount.ProductDiscount, com.commercetools.api.models.product_discount.ProductDiscountUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyProductDiscountsKeyByKeyPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyProductDiscountsKeyByKeyPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyProductDiscountsKeyByKeyPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyProductDiscountsKeyByKeyPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(productDiscountUpdate)));
     ...
     * @return ByProjectKeyProductDiscountsKeyByKeyPost
     */
     ...
     * @return ByProjectKeyProductDiscountsKeyByKeyPost
     */
    public <TValue> ByProjectKeyProductDiscountsKeyByKeyPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyProductDiscountsKeyByKeyPost
     */
    public <TValue> ByProjectKeyProductDiscountsKeyByKeyPost addExpand(final Collection<TValue> expand) {
    ...
    public ByProjectKeyProductDiscountsKeyByKeyPost withBody(com.commercetools.api.models.product_discount.ProductDiscountUpdate productDiscountUpdate) {
