...
public class ByProjectKeyProductDiscountsPostString extends StringBodyApiMethod<ByProjectKeyProductDiscountsPostString, com.commercetools.api.models.product_discount.ProductDiscount> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyProductDiscountsPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyProductDiscountsPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyProductDiscountsPostString> {
    ...
    public ByProjectKeyProductDiscountsPostString(final ApiHttpClient apiHttpClient, String projectKey, String productDiscountDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), productDiscountDraft.getBytes(StandardCharsets.UTF_8));
