...
public class ByProjectKeyProductProjectionsByIDVariantAttributesRequestBuilder {

    private final ApiHttpClient apiHttpClient;
    private final String projectKey;
    private final String ID;

    public ByProjectKeyProductProjectionsByIDVariantAttributesRequestBuilder(final ApiHttpClient apiHttpClient,
