...
public class ByProjectKeyProductProjectionsGet extends ApiMethod<ByProjectKeyProductProjectionsGet, com.commercetools.api.models.product.ProductProjectionPagedQueryResponse> implements ByProjectKeyProductProjectionsGetMixin, com.commercetools.api.client.ProjectionselectingTrait<ByProjectKeyProductProjectionsGet>, com.commercetools.api.client.PriceselectingTrait<ByProjectKeyProductProjectionsGet>, com.commercetools.api.client.LocaleprojectingTrait<ByProjectKeyProductProjectionsGet>, com.commercetools.api.client.StoreprojectingTrait<ByProjectKeyProductProjectionsGet>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyProductProjectionsGet>, com.commercetools.api.client.SortableTrait<ByProjectKeyProductProjectionsGet>, com.commercetools.api.client.PagingTrait<ByProjectKeyProductProjectionsGet>, com.commercetools.api.client.QueryTrait<ByProjectKeyProductProjectionsGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyProductProjectionsGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyProductProjectionsGet> {
    ...
    @Override
    public ApiHttpResponse<com.commercetools.api.models.product.ProductProjectionPagedQueryResponse> executeBlocking(final ApiHttpClient client, final Duration timeout) {
        return executeBlocking(client, timeout, com.commercetools.api.models.product.ProductProjectionPagedQueryResponse.class);
    }

    @Override
    public CompletableFuture<ApiHttpResponse<com.commercetools.api.models.product.ProductProjectionPagedQueryResponse>> execute(final ApiHttpClient client) {
     ...
     * @return ByProjectKeyProductProjectionsGet
     */
    public <TValue> ByProjectKeyProductProjectionsGet withPriceCustomerGroup(final Collection<TValue> priceCustomerGroup) {
     ...
     * @return ByProjectKeyProductProjectionsGet
     */
    public <TValue> ByProjectKeyProductProjectionsGet addPriceCustomerGroup(final Collection<TValue> priceCustomerGroup) {
     ...
     * @return ByProjectKeyProductProjectionsGet
     */
    public <TValue> ByProjectKeyProductProjectionsGet withPredicateVar(final String varName, final TValue predicateVar) {
     ...
     * @return ByProjectKeyProductProjectionsGet
     */
    public <TValue> ByProjectKeyProductProjectionsGet withPredicateVar(final String varName, final Collection<TValue> predicateVar) {
     ...
     * @return ByProjectKeyProductProjectionsGet
     */
    public <TValue> ByProjectKeyProductProjectionsGet addPredicateVar(final String varName, final Collection<TValue> predicateVar) {
        final String placeholderName = String.format("var.%s", varName);
