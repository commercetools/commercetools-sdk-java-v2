...
public class ByProjectKeyProductProjectionsKeyByKeyGet extends
        TypeApiMethod<ByProjectKeyProductProjectionsKeyByKeyGet, com.commercetools.api.models.product.ProductProjection>
        implements ProductProjectionExpansionMixin<ByProjectKeyProductProjectionsKeyByKeyGet>,
        ...
        com.commercetools.api.client.AttributefilteringTrait<ByProjectKeyProductProjectionsKeyByKeyGet>,
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        String httpRequestPath = String.format("%s/product-projections/key=%s", encodePathParam(this.projectKey),
     ...
     * @return ByProjectKeyProductProjectionsKeyByKeyGet
     */
    public <TValue> ByProjectKeyProductProjectionsKeyByKeyGet withPriceCustomerGroupAssignments(
     ...
     * @return ByProjectKeyProductProjectionsKeyByKeyGet
     */
    public <TValue> ByProjectKeyProductProjectionsKeyByKeyGet addPriceCustomerGroupAssignments(
            final TValue priceCustomerGroupAssignments) {
     ...
     * @return ByProjectKeyProductProjectionsKeyByKeyGet
     */
    public ByProjectKeyProductProjectionsKeyByKeyGet addPriceCustomerGroupAssignments(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyProductProjectionsKeyByKeyGet
     */
    public <TValue> ByProjectKeyProductProjectionsKeyByKeyGet withPriceRecurrencePolicy(
     ...
     * @return ByProjectKeyProductProjectionsKeyByKeyGet
     */
    public <TValue> ByProjectKeyProductProjectionsKeyByKeyGet addPriceRecurrencePolicy(
            final TValue priceRecurrencePolicy) {
     ...
     * @return ByProjectKeyProductProjectionsKeyByKeyGet
     */
    public ByProjectKeyProductProjectionsKeyByKeyGet withPriceRecurrencePolicy(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyProductProjectionsKeyByKeyGet
     */
    public ByProjectKeyProductProjectionsKeyByKeyGet addPriceRecurrencePolicy(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyProductProjectionsKeyByKeyGet
     */
    public <TValue> ByProjectKeyProductProjectionsKeyByKeyGet withFilterAttributes(final TValue filterAttributes) {
     ...
     * @return ByProjectKeyProductProjectionsKeyByKeyGet
     */
    public <TValue> ByProjectKeyProductProjectionsKeyByKeyGet addFilterAttributes(final TValue filterAttributes) {
     ...
     * @return ByProjectKeyProductProjectionsKeyByKeyGet
     */
    public ByProjectKeyProductProjectionsKeyByKeyGet withFilterAttributes(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyProductProjectionsKeyByKeyGet
     */
    public ByProjectKeyProductProjectionsKeyByKeyGet addFilterAttributes(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyProductProjectionsKeyByKeyGet
     */
    public <TValue> ByProjectKeyProductProjectionsKeyByKeyGet withFilterAttributes(
     ...
     * @return ByProjectKeyProductProjectionsKeyByKeyGet
     */
    public <TValue> ByProjectKeyProductProjectionsKeyByKeyGet addFilterAttributes(
            final Collection<TValue> filterAttributes) {
