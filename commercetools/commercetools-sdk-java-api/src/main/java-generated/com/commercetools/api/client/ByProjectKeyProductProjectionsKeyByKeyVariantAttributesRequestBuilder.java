...
public class ByProjectKeyProductProjectionsKeyByKeyVariantAttributesRequestBuilder {

    private final ApiHttpClient apiHttpClient;
    private final String projectKey;
    private final String key;

    public ByProjectKeyProductProjectionsKeyByKeyVariantAttributesRequestBuilder(final ApiHttpClient apiHttpClient,
