...
public class ByProjectKeyProductSelectionsByIDGet extends
        TypeApiMethod<ByProjectKeyProductSelectionsByIDGet, com.commercetools.api.models.product_selection.ProductSelection>
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        String httpRequestPath = String.format("%s/product-selections/%s", encodePathParam(this.projectKey),
