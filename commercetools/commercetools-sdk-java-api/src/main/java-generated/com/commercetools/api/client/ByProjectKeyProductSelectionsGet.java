...
public class ByProjectKeyProductSelectionsGet extends ApiMethod<ByProjectKeyProductSelectionsGet, com.commercetools.api.models.product_selection.ProductSelectionPagedQueryResponse> implements ByProjectKeyProductSelectionsGetMixin, com.commercetools.api.client.ExpandableTrait<ByProjectKeyProductSelectionsGet>, com.commercetools.api.client.SortableTrait<ByProjectKeyProductSelectionsGet>, com.commercetools.api.client.PagingTrait<ByProjectKeyProductSelectionsGet>, com.commercetools.api.client.QueryTrait<ByProjectKeyProductSelectionsGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyProductSelectionsGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyProductSelectionsGet> {
    ...
    @Override
    public ApiHttpResponse<com.commercetools.api.models.product_selection.ProductSelectionPagedQueryResponse> executeBlocking(final ApiHttpClient client, final Duration timeout) {
        return executeBlocking(client, timeout, com.commercetools.api.models.product_selection.ProductSelectionPagedQueryResponse.class);
    }

    @Override
    public CompletableFuture<ApiHttpResponse<com.commercetools.api.models.product_selection.ProductSelectionPagedQueryResponse>> execute(final ApiHttpClient client) {
     ...
     * @return ByProjectKeyProductSelectionsGet
     */
    public <TValue> ByProjectKeyProductSelectionsGet withPredicateVar(final String varName, final Collection<TValue> predicateVar) {
     ...
     * @return ByProjectKeyProductSelectionsGet
     */
    public <TValue> ByProjectKeyProductSelectionsGet addPredicateVar(final String varName, final Collection<TValue> predicateVar) {
        final String placeholderName = String.format("var.%s", varName);
