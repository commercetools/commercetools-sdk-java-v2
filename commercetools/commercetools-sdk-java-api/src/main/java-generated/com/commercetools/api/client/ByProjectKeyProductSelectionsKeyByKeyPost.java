...
public class ByProjectKeyProductSelectionsKeyByKeyPost extends BodyApiMethod<ByProjectKeyProductSelectionsKeyByKeyPost, com.commercetools.api.models.product_selection.ProductSelection, com.commercetools.api.models.product_selection.ProductSelectionUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyProductSelectionsKeyByKeyPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyProductSelectionsKeyByKeyPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyProductSelectionsKeyByKeyPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyProductSelectionsKeyByKeyPost> {
    ...
    public ByProjectKeyProductSelectionsKeyByKeyPost(final ApiHttpClient apiHttpClient, String projectKey, String key, com.commercetools.api.models.product_selection.ProductSelectionUpdate productSelectionUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(productSelectionUpdate)));
     ...
     * @return ByProjectKeyProductSelectionsKeyByKeyPost
     */
     ...
     * @return ByProjectKeyProductSelectionsKeyByKeyPost
     */
    public <TValue> ByProjectKeyProductSelectionsKeyByKeyPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyProductSelectionsKeyByKeyPost
     */
    public <TValue> ByProjectKeyProductSelectionsKeyByKeyPost addExpand(final Collection<TValue> expand) {
    ...
    public ByProjectKeyProductSelectionsKeyByKeyPost withBody(com.commercetools.api.models.product_selection.ProductSelectionUpdate productSelectionUpdate) {
