...
public class ByProjectKeyProductSelectionsKeyByKeyPostString extends StringBodyApiMethod<ByProjectKeyProductSelectionsKeyByKeyPostString, com.commercetools.api.models.product_selection.ProductSelection> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyProductSelectionsKeyByKeyPostString>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyProductSelectionsKeyByKeyPostString>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyProductSelectionsKeyByKeyPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyProductSelectionsKeyByKeyPostString> {
    ...
    public ByProjectKeyProductSelectionsKeyByKeyPostString(final ApiHttpClient apiHttpClient, String projectKey, String key, String productSelectionUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), productSelectionUpdate.getBytes(StandardCharsets.UTF_8));
