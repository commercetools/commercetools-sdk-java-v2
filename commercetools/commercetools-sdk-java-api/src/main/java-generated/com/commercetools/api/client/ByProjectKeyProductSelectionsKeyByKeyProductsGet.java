...
public class ByProjectKeyProductSelectionsKeyByKeyProductsGet extends ApiMethod<ByProjectKeyProductSelectionsKeyByKeyProductsGet, com.commercetools.api.models.product_selection.ProductSelectionProductPagedQueryResponse> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyProductSelectionsKeyByKeyProductsGet>, com.commercetools.api.client.PagingTrait<ByProjectKeyProductSelectionsKeyByKeyProductsGet>, com.commercetools.api.client.SortableTrait<ByProjectKeyProductSelectionsKeyByKeyProductsGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyProductSelectionsKeyByKeyProductsGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyProductSelectionsKeyByKeyProductsGet> {
    ...
    public ByProjectKeyProductSelectionsKeyByKeyProductsGet(final ApiHttpClient apiHttpClient, String projectKey, String key) {
        super(apiHttpClient);
    ...
    @Override
    public ApiHttpResponse<com.commercetools.api.models.product_selection.ProductSelectionProductPagedQueryResponse> executeBlocking(final ApiHttpClient client, final Duration timeout) {
        return executeBlocking(client, timeout, com.commercetools.api.models.product_selection.ProductSelectionProductPagedQueryResponse.class);
    }

    @Override
    public CompletableFuture<ApiHttpResponse<com.commercetools.api.models.product_selection.ProductSelectionProductPagedQueryResponse>> execute(final ApiHttpClient client) {
        return execute(client, com.commercetools.api.models.product_selection.ProductSelectionProductPagedQueryResponse.class);
    }
     ...
     * @return ByProjectKeyProductSelectionsKeyByKeyProductsGet
     */
    public ByProjectKeyProductSelectionsKeyByKeyProductsGet withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyProductSelectionsKeyByKeyProductsGet
     */
    public ByProjectKeyProductSelectionsKeyByKeyProductsGet withOffset(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyProductSelectionsKeyByKeyProductsGet
     */
    public ByProjectKeyProductSelectionsKeyByKeyProductsGet withWithTotal(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyProductSelectionsKeyByKeyProductsGet
     */
    public ByProjectKeyProductSelectionsKeyByKeyProductsGet addWithTotal(final Function<StringBuilder, StringBuilder> op) {
