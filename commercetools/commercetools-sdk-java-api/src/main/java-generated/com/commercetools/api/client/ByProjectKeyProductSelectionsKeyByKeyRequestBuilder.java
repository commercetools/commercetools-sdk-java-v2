...
public class ByProjectKeyProductSelectionsKeyByKeyRequestBuilder  {
    ...
    public ByProjectKeyProductSelectionsKeyByKeyRequestBuilder (final ApiHttpClient apiHttpClient,final String projectKey,final String key) {
    ...
    public ByProjectKeyProductSelectionsKeyByKeyPost post(com.commercetools.api.models.product_selection.ProductSelectionUpdate productSelectionUpdate) {
    ...
    public ByProjectKeyProductSelectionsKeyByKeyPostString post(final String productSelectionUpdate) {
        return new ByProjectKeyProductSelectionsKeyByKeyPostString(apiHttpClient, projectKey, key, productSelectionUpdate);
    }
    public ByProjectKeyProductSelectionsKeyByKeyPost post(UnaryOperator<com.commercetools.api.models.product_selection.ProductSelectionUpdateBuilder> op) {
