...
/**
 *  <p>Checks if one or more ProductTailorings exist for the provided query predicate. Returns a <code>200</code> status if any ProductTailoring match the query predicate, or a <code>404</code> status otherwise.</p>
 *
 * <hr>
...
public class ByProjectKeyProductTailoringHead
        extends TypeApiMethod<ByProjectKeyProductTailoringHead, tools.jackson.databind.JsonNode>
