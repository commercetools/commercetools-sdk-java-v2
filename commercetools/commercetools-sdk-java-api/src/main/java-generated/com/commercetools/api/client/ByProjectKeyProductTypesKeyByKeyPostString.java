...
public class ByProjectKeyProductTypesKeyByKeyPostString extends StringBodyApiMethod<ByProjectKeyProductTypesKeyByKeyPostString, com.commercetools.api.models.product_type.ProductType> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyProductTypesKeyByKeyPostString>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyProductTypesKeyByKeyPostString>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyProductTypesKeyByKeyPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyProductTypesKeyByKeyPostString> {
    ...
    public ByProjectKeyProductTypesKeyByKeyPostString(final ApiHttpClient apiHttpClient, String projectKey, String key, String productTypeUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), productTypeUpdate.getBytes(StandardCharsets.UTF_8));
