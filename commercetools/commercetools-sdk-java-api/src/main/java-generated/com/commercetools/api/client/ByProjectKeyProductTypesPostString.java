...
public class ByProjectKeyProductTypesPostString extends StringBodyApiMethod<ByProjectKeyProductTypesPostString, com.commercetools.api.models.product_type.ProductType> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyProductTypesPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyProductTypesPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyProductTypesPostString> {
    ...
    public ByProjectKeyProductTypesPostString(final ApiHttpClient apiHttpClient, String projectKey, String productTypeDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), productTypeDraft.getBytes(StandardCharsets.UTF_8));
     ...
     * @return ByProjectKeyProductTypesPostString
     */
