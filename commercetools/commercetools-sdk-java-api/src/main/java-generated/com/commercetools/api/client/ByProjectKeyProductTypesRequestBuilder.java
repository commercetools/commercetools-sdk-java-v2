...
public class ByProjectKeyProductTypesRequestBuilder implements ByProjectKeyProductTypesRequestBuilderMixin {
    ...
    public ByProjectKeyProductTypesPost post(com.commercetools.api.models.product_type.ProductTypeDraft productTypeDraft) {
    ...
    public ByProjectKeyProductTypesPost post(UnaryOperator<com.commercetools.api.models.product_type.ProductTypeDraftBuilder> op) {
