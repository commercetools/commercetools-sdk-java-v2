...
public class ByProjectKeyProductsByIDPostString extends StringBodyApiMethod<ByProjectKeyProductsByIDPostString, com.commercetools.api.models.product.Product> implements com.commercetools.api.client.PriceselectingTrait<ByProjectKeyProductsByIDPostString>, com.commercetools.api.client.ConflictingTrait<ByProjectKeyProductsByIDPostString>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyProductsByIDPostString>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyProductsByIDPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyProductsByIDPostString> {
    ...
    public ByProjectKeyProductsByIDPostString(final ApiHttpClient apiHttpClient, String projectKey, String ID, String productUpdate) {
        super(apiHttpClient);
     ...
     * @return ByProjectKeyProductsByIDPostString
     */
    public <TValue> ByProjectKeyProductsByIDPostString withPriceCustomerGroup(final Collection<TValue> priceCustomerGroup) {
     ...
     * @return ByProjectKeyProductsByIDPostString
     */
    public <TValue> ByProjectKeyProductsByIDPostString addPriceCustomerGroup(final Collection<TValue> priceCustomerGroup) {
