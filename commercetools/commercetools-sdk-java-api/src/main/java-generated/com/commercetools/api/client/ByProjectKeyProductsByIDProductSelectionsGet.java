...
public class ByProjectKeyProductsByIDProductSelectionsGet extends ApiMethod<ByProjectKeyProductsByIDProductSelectionsGet, com.commercetools.api.models.product_selection.AssignedProductSelectionPagedQueryResponse> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyProductsByIDProductSelectionsGet>, com.commercetools.api.client.SortableTrait<ByProjectKeyProductsByIDProductSelectionsGet>, com.commercetools.api.client.PagingTrait<ByProjectKeyProductsByIDProductSelectionsGet>, com.commercetools.api.client.QueryTrait<ByProjectKeyProductsByIDProductSelectionsGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyProductsByIDProductSelectionsGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyProductsByIDProductSelectionsGet> {
    ...
    public ByProjectKeyProductsByIDProductSelectionsGet(final ApiHttpClient apiHttpClient, String projectKey, String ID) {
        super(apiHttpClient);
     ...
     * @return ByProjectKeyProductsByIDProductSelectionsGet
     */
    public <TValue> ByProjectKeyProductsByIDProductSelectionsGet withPredicateVar(final String varName, final TValue predicateVar) {
     ...
     * @return ByProjectKeyProductsByIDProductSelectionsGet
     */
    public <TValue> ByProjectKeyProductsByIDProductSelectionsGet addPredicateVar(final String varName, final TValue predicateVar) {
     ...
     * @return ByProjectKeyProductsByIDProductSelectionsGet
     */
    public <TValue> ByProjectKeyProductsByIDProductSelectionsGet withPredicateVar(final String varName, final Collection<TValue> predicateVar) {
     ...
     * @return ByProjectKeyProductsByIDProductSelectionsGet
     */
    public <TValue> ByProjectKeyProductsByIDProductSelectionsGet addPredicateVar(final String varName, final Collection<TValue> predicateVar) {
        final String placeholderName = String.format("var.%s", varName);
