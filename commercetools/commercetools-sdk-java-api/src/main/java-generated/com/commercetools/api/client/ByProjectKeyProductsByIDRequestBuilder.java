...
public class ByProjectKeyProductsByIDRequestBuilder  {
    ...
    public ByProjectKeyProductsByIDPostString post(final String productUpdate) {
        return new ByProjectKeyProductsByIDPostString(apiHttpClient, projectKey, ID, productUpdate);
    }
    public ByProjectKeyProductsByIDPost post(UnaryOperator<com.commercetools.api.models.product.ProductUpdateBuilder> op) {
