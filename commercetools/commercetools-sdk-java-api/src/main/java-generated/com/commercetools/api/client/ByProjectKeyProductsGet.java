...
public class ByProjectKeyProductsGet extends ApiMethod<ByProjectKeyProductsGet, com.commercetools.api.models.product.ProductPagedQueryResponse> implements ByProjectKeyProductsGetMixin, com.commercetools.api.client.PriceselectingTrait<ByProjectKeyProductsGet>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyProductsGet>, com.commercetools.api.client.SortableTrait<ByProjectKeyProductsGet>, com.commercetools.api.client.PagingTrait<ByProjectKeyProductsGet>, com.commercetools.api.client.QueryTrait<ByProjectKeyProductsGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyProductsGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyProductsGet> {
    ...
    @Override
    public ApiHttpResponse<com.commercetools.api.models.product.ProductPagedQueryResponse> executeBlocking(final ApiHttpClient client, final Duration timeout) {
     ...
     * @return ByProjectKeyProductsGet
     */
    public <TValue> ByProjectKeyProductsGet withPredicateVar(final String varName, final Collection<TValue> predicateVar) {
     ...
     * @return ByProjectKeyProductsGet
     */
    public <TValue> ByProjectKeyProductsGet addPredicateVar(final String varName, final Collection<TValue> predicateVar) {
        final String placeholderName = String.format("var.%s", varName);
