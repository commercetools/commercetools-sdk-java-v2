...
/**
 *  <p>Checks if one or more Products exist for the provided query predicate. Returns a <code>200 OK</code> status if any Products match the query predicate, or a <code>404 Not Found</code> otherwise.</p>
 *
 * <hr>
