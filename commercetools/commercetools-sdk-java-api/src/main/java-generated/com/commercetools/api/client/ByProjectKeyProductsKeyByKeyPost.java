...
public class ByProjectKeyProductsKeyByKeyPost extends BodyApiMethod<ByProjectKeyProductsKeyByKeyPost, com.commercetools.api.models.product.Product, com.commercetools.api.models.product.ProductUpdate> implements com.commercetools.api.client.PriceselectingTrait<ByProjectKeyProductsKeyByKeyPost>, com.commercetools.api.client.ConflictingTrait<ByProjectKeyProductsKeyByKeyPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyProductsKeyByKeyPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyProductsKeyByKeyPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyProductsKeyByKeyPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(productUpdate)));
     ...
     * @return ByProjectKeyProductsKeyByKeyPost
     */
    public <TValue> ByProjectKeyProductsKeyByKeyPost withPriceCustomerGroup(final Collection<TValue> priceCustomerGroup) {
     ...
     * @return ByProjectKeyProductsKeyByKeyPost
     */
    public <TValue> ByProjectKeyProductsKeyByKeyPost addPriceCustomerGroup(final Collection<TValue> priceCustomerGroup) {
