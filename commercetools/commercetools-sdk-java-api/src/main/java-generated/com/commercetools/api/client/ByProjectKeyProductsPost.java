...
public class ByProjectKeyProductsPost extends BodyApiMethod<ByProjectKeyProductsPost, com.commercetools.api.models.product.Product, com.commercetools.api.models.product.ProductDraft> implements com.commercetools.api.client.PriceselectingTrait<ByProjectKeyProductsPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyProductsPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyProductsPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyProductsPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(productDraft)));
