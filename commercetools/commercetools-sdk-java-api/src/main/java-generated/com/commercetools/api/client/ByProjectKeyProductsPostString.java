...
public class ByProjectKeyProductsPostString extends StringBodyApiMethod<ByProjectKeyProductsPostString, com.commercetools.api.models.product.Product> implements com.commercetools.api.client.PriceselectingTrait<ByProjectKeyProductsPostString>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyProductsPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyProductsPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyProductsPostString> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), productDraft.getBytes(StandardCharsets.UTF_8));
