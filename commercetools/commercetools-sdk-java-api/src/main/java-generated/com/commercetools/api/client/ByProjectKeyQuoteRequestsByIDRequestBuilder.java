...
public class ByProjectKeyQuoteRequestsByIDRequestBuilder  {
    ...
    public ByProjectKeyQuoteRequestsByIDRequestBuilder (final ApiHttpClient apiHttpClient,final String projectKey,final String ID) {
    ...
    public ByProjectKeyQuoteRequestsByIDPost post(com.commercetools.api.models.quote_request.QuoteRequestUpdate quoteRequestUpdate) {
    ...
    public ByProjectKeyQuoteRequestsByIDPost post(UnaryOperator<com.commercetools.api.models.quote_request.QuoteRequestUpdateBuilder> op) {
