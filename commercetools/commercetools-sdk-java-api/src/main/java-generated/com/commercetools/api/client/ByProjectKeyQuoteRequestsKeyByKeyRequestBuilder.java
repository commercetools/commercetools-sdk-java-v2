...
public class ByProjectKeyQuoteRequestsKeyByKeyRequestBuilder  {
    ...
    public ByProjectKeyQuoteRequestsKeyByKeyRequestBuilder (final ApiHttpClient apiHttpClient,final String projectKey,final String key) {
    ...
    public ByProjectKeyQuoteRequestsKeyByKeyPost post(com.commercetools.api.models.quote_request.QuoteRequestUpdate quoteRequestUpdate) {
    ...
    public ByProjectKeyQuoteRequestsKeyByKeyPost post(UnaryOperator<com.commercetools.api.models.quote_request.QuoteRequestUpdateBuilder> op) {
