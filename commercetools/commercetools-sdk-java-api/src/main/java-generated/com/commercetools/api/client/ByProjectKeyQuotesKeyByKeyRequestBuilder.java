...
public class ByProjectKeyQuotesKeyByKeyRequestBuilder  {
    ...
    public ByProjectKeyQuotesKeyByKeyRequestBuilder (final ApiHttpClient apiHttpClient,final String projectKey,final String key) {
    ...
    public ByProjectKeyQuotesKeyByKeyPostString post(final String quoteUpdate) {
        return new ByProjectKeyQuotesKeyByKeyPostString(apiHttpClient, projectKey, key, quoteUpdate);
    }
    public ByProjectKeyQuotesKeyByKeyPost post(UnaryOperator<com.commercetools.api.models.quote.QuoteUpdateBuilder> op) {
