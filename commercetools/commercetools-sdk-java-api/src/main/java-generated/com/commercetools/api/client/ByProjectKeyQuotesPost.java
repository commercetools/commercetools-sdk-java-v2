...
public class ByProjectKeyQuotesPost extends BodyApiMethod<ByProjectKeyQuotesPost, com.commercetools.api.models.quote.Quote, com.commercetools.api.models.quote.QuoteDraft> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyQuotesPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyQuotesPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyQuotesPost> {
    ...
    public ByProjectKeyQuotesPost(final ApiHttpClient apiHttpClient, String projectKey, com.commercetools.api.models.quote.QuoteDraft quoteDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(quoteDraft)));
     ...
     * @return ByProjectKeyQuotesPost
     */
    public <TValue> ByProjectKeyQuotesPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyQuotesPost
     */
    public <TValue> ByProjectKeyQuotesPost addExpand(final Collection<TValue> expand) {
