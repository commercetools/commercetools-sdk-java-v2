...
public class ByProjectKeyQuotesPostString extends StringBodyApiMethod<ByProjectKeyQuotesPostString, com.commercetools.api.models.quote.Quote> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyQuotesPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyQuotesPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyQuotesPostString> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), quoteDraft.getBytes(StandardCharsets.UTF_8));
