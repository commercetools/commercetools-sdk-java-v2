...
/**
 *  <p>Creates a Recurring Order in the Project. Produces the <a href="https://docs.commercetools.com/apis/ctp:api:type:RecurringOrderCreatedMessage" rel="nofollow">RecurringOrderCreated</a> message.</p>
 *  <p>The Cart is validated to ensure that it is convertible to an <a href="https://docs.commercetools.com/apis/ctp:api:type:Order" rel="nofollow">Order</a>. If the validation fails, an error is returned. If the expiration date has been reached when the <a href="https://docs.commercetools.com/apis/ctp:api:type:RecurringOrder" rel="nofollow">Recurring Order</a> is processed, its <a href="https://docs.commercetools.com/apis/ctp:api:type:RecurringOrderState" rel="nofollow">RecurringOrderState</a> will be updated to <code>Expired</code>, and no Order will be created.</p>
