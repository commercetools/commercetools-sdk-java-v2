...
public class ByProjectKeyReviewsByIDGet extends ApiMethod<ByProjectKeyReviewsByIDGet, com.commercetools.api.models.review.Review> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyReviewsByIDGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyReviewsByIDGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyReviewsByIDGet> {
     ...
     */
    public <TValue> ByProjectKeyReviewsByIDGet withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyReviewsByIDGet
     */
    public <TValue> ByProjectKeyReviewsByIDGet addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyReviewsByIDGet
     */
    public ByProjectKeyReviewsByIDGet withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyReviewsByIDGet
     */
    public ByProjectKeyReviewsByIDGet addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyReviewsByIDGet
     */
    public ByProjectKeyReviewsByIDGet withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyReviewsByIDGet
     */
    public ByProjectKeyReviewsByIDGet addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyReviewsByIDGet
     */
    public <TValue> ByProjectKeyReviewsByIDGet withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyReviewsByIDGet
     */
    public <TValue> ByProjectKeyReviewsByIDGet addExpand(final Collection<TValue> expand) {
