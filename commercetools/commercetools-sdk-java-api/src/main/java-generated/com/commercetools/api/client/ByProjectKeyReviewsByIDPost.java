...
public class ByProjectKeyReviewsByIDPost extends BodyApiMethod<ByProjectKeyReviewsByIDPost, com.commercetools.api.models.review.Review, com.commercetools.api.models.review.ReviewUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyReviewsByIDPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyReviewsByIDPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyReviewsByIDPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyReviewsByIDPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(reviewUpdate)));
     ...
     * @return ByProjectKeyReviewsByIDPost
     */
    public <TValue> ByProjectKeyReviewsByIDPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyReviewsByIDPost
     */
    public <TValue> ByProjectKeyReviewsByIDPost addExpand(final Collection<TValue> expand) {
