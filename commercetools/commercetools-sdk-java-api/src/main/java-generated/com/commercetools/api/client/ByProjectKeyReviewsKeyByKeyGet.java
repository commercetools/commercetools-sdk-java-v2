...
public class ByProjectKeyReviewsKeyByKeyGet extends ApiMethod<ByProjectKeyReviewsKeyByKeyGet, com.commercetools.api.models.review.Review> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyReviewsKeyByKeyGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyReviewsKeyByKeyGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyReviewsKeyByKeyGet> {
     ...
     */
    public <TValue> ByProjectKeyReviewsKeyByKeyGet withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyReviewsKeyByKeyGet
     */
    public <TValue> ByProjectKeyReviewsKeyByKeyGet addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyReviewsKeyByKeyGet
     */
    public ByProjectKeyReviewsKeyByKeyGet withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyReviewsKeyByKeyGet
     */
    public ByProjectKeyReviewsKeyByKeyGet addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyReviewsKeyByKeyGet
     */
    public ByProjectKeyReviewsKeyByKeyGet withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyReviewsKeyByKeyGet
     */
    public ByProjectKeyReviewsKeyByKeyGet addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyReviewsKeyByKeyGet
     */
    public <TValue> ByProjectKeyReviewsKeyByKeyGet withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyReviewsKeyByKeyGet
     */
    public <TValue> ByProjectKeyReviewsKeyByKeyGet addExpand(final Collection<TValue> expand) {
