...
public class ByProjectKeyReviewsKeyByKeyPostString
        extends StringBodyApiMethod<ByProjectKeyReviewsKeyByKeyPostString, com.commercetools.api.models.review.Review>
        implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyReviewsKeyByKeyPostString>,
        com.commercetools.api.client.ExpandableTrait<ByProjectKeyReviewsKeyByKeyPostString>,
        com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyReviewsKeyByKeyPostString>,
        com.commercetools.api.client.ErrorableTrait<ByProjectKeyReviewsKeyByKeyPostString> {
    ...
    public ByProjectKeyReviewsKeyByKeyPostString(final ApiHttpClient apiHttpClient, String projectKey, String key,
            String reviewUpdate) {
        super(apiHttpClient);
