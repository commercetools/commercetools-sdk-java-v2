...
public class ByProjectKeyReviewsPost extends BodyApiMethod<ByProjectKeyReviewsPost, com.commercetools.api.models.review.Review, com.commercetools.api.models.review.ReviewDraft> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyReviewsPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyReviewsPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyReviewsPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(reviewDraft)));
