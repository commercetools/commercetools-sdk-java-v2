...
public class ByProjectKeyShippingMethodsByIDPostString extends StringBodyApiMethod<ByProjectKeyShippingMethodsByIDPostString, com.commercetools.api.models.shipping_method.ShippingMethod> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyShippingMethodsByIDPostString>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyShippingMethodsByIDPostString>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyShippingMethodsByIDPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyShippingMethodsByIDPostString> {
    ...
    public ByProjectKeyShippingMethodsByIDPostString(final ApiHttpClient apiHttpClient, String projectKey, String ID, String shippingMethodUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), shippingMethodUpdate.getBytes(StandardCharsets.UTF_8));
