...
public class ByProjectKeyShippingMethodsKeyByKeyGet extends ApiMethod<ByProjectKeyShippingMethodsKeyByKeyGet, com.commercetools.api.models.shipping_method.ShippingMethod> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyShippingMethodsKeyByKeyGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyShippingMethodsKeyByKeyGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyShippingMethodsKeyByKeyGet> {
     ...
     */
    public <TValue> ByProjectKeyShippingMethodsKeyByKeyGet withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyShippingMethodsKeyByKeyGet
     */
    public <TValue> ByProjectKeyShippingMethodsKeyByKeyGet addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyShippingMethodsKeyByKeyGet
     */
    public ByProjectKeyShippingMethodsKeyByKeyGet withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyShippingMethodsKeyByKeyGet
     */
    public ByProjectKeyShippingMethodsKeyByKeyGet addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyShippingMethodsKeyByKeyGet
     */
    public ByProjectKeyShippingMethodsKeyByKeyGet withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyShippingMethodsKeyByKeyGet
     */
    public ByProjectKeyShippingMethodsKeyByKeyGet addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyShippingMethodsKeyByKeyGet
     */
    public <TValue> ByProjectKeyShippingMethodsKeyByKeyGet withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyShippingMethodsKeyByKeyGet
     */
    public <TValue> ByProjectKeyShippingMethodsKeyByKeyGet addExpand(final Collection<TValue> expand) {
