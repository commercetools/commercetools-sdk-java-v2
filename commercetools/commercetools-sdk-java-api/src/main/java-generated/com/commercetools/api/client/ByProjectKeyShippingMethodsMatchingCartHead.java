...
/**
 *  <p>Checks if an active ShippingMethod exists for the provided Cart. Returns a <code>200 OK</code> status if the ShippingMethod exists or a <span>Not Found</span> error otherwise.</p>
 *
 * <hr>
...
public class ByProjectKeyShippingMethodsMatchingCartHead
        extends TypeApiMethod<ByProjectKeyShippingMethodsMatchingCartHead, tools.jackson.databind.JsonNode>
