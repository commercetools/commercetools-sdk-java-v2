...
public class ByProjectKeyShippingMethodsMatchingCartLocationGet extends ApiMethod<ByProjectKeyShippingMethodsMatchingCartLocationGet, com.commercetools.api.models.shipping_method.ShippingMethodPagedQueryResponse> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyShippingMethodsMatchingCartLocationGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyShippingMethodsMatchingCartLocationGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyShippingMethodsMatchingCartLocationGet> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        String httpRequestPath = String.format("%s/shipping-methods/matching-cart-location", this.projectKey);
        if (!params.isEmpty()) {
     ...
     * @return ByProjectKeyShippingMethodsMatchingCartLocationGet
     */
    public ByProjectKeyShippingMethodsMatchingCartLocationGet withCountry(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyShippingMethodsMatchingCartLocationGet
     */
    public ByProjectKeyShippingMethodsMatchingCartLocationGet addCountry(final Function<StringBuilder, StringBuilder> op) {
    ...
    public <TValue> ByProjectKeyShippingMethodsMatchingCartLocationGet withCountry(final Collection<TValue> country) {
        return copy().withoutQueryParam("country").addQueryParams(country.stream().map(s -> new ParamEntry<>("country", s.toString())).collect(Collectors.toList())); 
    }
    ...
    public <TValue> ByProjectKeyShippingMethodsMatchingCartLocationGet addCountry(final Collection<TValue> country) {
        return copy().addQueryParams(country.stream().map(s -> new ParamEntry<>("country", s.toString())).collect(Collectors.toList())); 
    }
     ...
     * @return ByProjectKeyShippingMethodsMatchingCartLocationGet
     */
    public ByProjectKeyShippingMethodsMatchingCartLocationGet withState(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyShippingMethodsMatchingCartLocationGet
     */
    public ByProjectKeyShippingMethodsMatchingCartLocationGet addState(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyShippingMethodsMatchingCartLocationGet
     */
    public ByProjectKeyShippingMethodsMatchingCartLocationGet withCartId(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyShippingMethodsMatchingCartLocationGet
     */
    public ByProjectKeyShippingMethodsMatchingCartLocationGet addCartId(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyShippingMethodsMatchingCartLocationGet
     */
    public ByProjectKeyShippingMethodsMatchingCartLocationGet withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyShippingMethodsMatchingCartLocationGet
     */
    public ByProjectKeyShippingMethodsMatchingCartLocationGet addExpand(final Function<StringBuilder, StringBuilder> op) {
