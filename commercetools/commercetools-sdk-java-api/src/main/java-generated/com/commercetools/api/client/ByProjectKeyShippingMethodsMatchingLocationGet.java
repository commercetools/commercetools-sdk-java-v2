...
public class ByProjectKeyShippingMethodsMatchingLocationGet extends ApiMethod<ByProjectKeyShippingMethodsMatchingLocationGet, com.commercetools.api.models.shipping_method.ShippingMethodPagedQueryResponse> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyShippingMethodsMatchingLocationGet>, com.commercetools.api.client.SortableTrait<ByProjectKeyShippingMethodsMatchingLocationGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyShippingMethodsMatchingLocationGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyShippingMethodsMatchingLocationGet> {
     ...
     * @return ByProjectKeyShippingMethodsMatchingLocationGet
     */
    public ByProjectKeyShippingMethodsMatchingLocationGet withCurrency(final Function<StringBuilder, StringBuilder> op) {
    ...
    public <TValue> ByProjectKeyShippingMethodsMatchingLocationGet withCurrency(final Collection<TValue> currency) {
        return copy().withoutQueryParam("currency").addQueryParams(currency.stream().map(s -> new ParamEntry<>("currency", s.toString())).collect(Collectors.toList())); 
    }
    ...
    public <TValue> ByProjectKeyShippingMethodsMatchingLocationGet addCurrency(final Collection<TValue> currency) {
        return copy().addQueryParams(currency.stream().map(s -> new ParamEntry<>("currency", s.toString())).collect(Collectors.toList())); 
    }
