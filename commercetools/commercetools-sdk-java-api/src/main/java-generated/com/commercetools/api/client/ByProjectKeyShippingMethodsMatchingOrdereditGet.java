...
public class ByProjectKeyShippingMethodsMatchingOrdereditGet extends ApiMethod<ByProjectKeyShippingMethodsMatchingOrdereditGet, com.commercetools.api.models.shipping_method.ShippingMethodPagedQueryResponse> implements com.commercetools.api.client.ErrorableTrait<ByProjectKeyShippingMethodsMatchingOrdereditGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyShippingMethodsMatchingOrdereditGet> {
     ...
     * @return ByProjectKeyShippingMethodsMatchingOrdereditGet
     */
    public ByProjectKeyShippingMethodsMatchingOrdereditGet withOrderEditId(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyShippingMethodsMatchingOrdereditGet
     */
    public ByProjectKeyShippingMethodsMatchingOrdereditGet addOrderEditId(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyShippingMethodsMatchingOrdereditGet
     */
    public <TValue> ByProjectKeyShippingMethodsMatchingOrdereditGet withOrderEditId(final Collection<TValue> orderEditId) {
        return copy().withoutQueryParam("orderEditId").addQueryParams(orderEditId.stream().map(s -> new ParamEntry<>("orderEditId", s.toString())).collect(Collectors.toList())); 
    }
     ...
     * @return ByProjectKeyShippingMethodsMatchingOrdereditGet
     */
    public <TValue> ByProjectKeyShippingMethodsMatchingOrdereditGet addOrderEditId(final Collection<TValue> orderEditId) {
        return copy().addQueryParams(orderEditId.stream().map(s -> new ParamEntry<>("orderEditId", s.toString())).collect(Collectors.toList())); 
    }
     ...
     * @return ByProjectKeyShippingMethodsMatchingOrdereditGet
     */
    public ByProjectKeyShippingMethodsMatchingOrdereditGet withCountry(final Function<StringBuilder, StringBuilder> op) {
