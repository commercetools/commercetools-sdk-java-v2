...
public class ByProjectKeyShippingMethodsPostString extends StringBodyApiMethod<ByProjectKeyShippingMethodsPostString, com.commercetools.api.models.shipping_method.ShippingMethod> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyShippingMethodsPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyShippingMethodsPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyShippingMethodsPostString> {
    ...
    public ByProjectKeyShippingMethodsPostString(final ApiHttpClient apiHttpClient, String projectKey, String shippingMethodDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), shippingMethodDraft.getBytes(StandardCharsets.UTF_8));
