...
public class ByProjectKeyShoppingListsByIDGet extends ApiMethod<ByProjectKeyShoppingListsByIDGet, com.commercetools.api.models.shopping_list.ShoppingList> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyShoppingListsByIDGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyShoppingListsByIDGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyShoppingListsByIDGet> {
     ...
     */
    public <TValue> ByProjectKeyShoppingListsByIDGet withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyShoppingListsByIDGet
     */
    public <TValue> ByProjectKeyShoppingListsByIDGet addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyShoppingListsByIDGet
     */
    public ByProjectKeyShoppingListsByIDGet withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyShoppingListsByIDGet
     */
    public ByProjectKeyShoppingListsByIDGet addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyShoppingListsByIDGet
     */
    public ByProjectKeyShoppingListsByIDGet withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyShoppingListsByIDGet
     */
    public ByProjectKeyShoppingListsByIDGet addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyShoppingListsByIDGet
     */
    public <TValue> ByProjectKeyShoppingListsByIDGet withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyShoppingListsByIDGet
     */
    public <TValue> ByProjectKeyShoppingListsByIDGet addExpand(final Collection<TValue> expand) {
