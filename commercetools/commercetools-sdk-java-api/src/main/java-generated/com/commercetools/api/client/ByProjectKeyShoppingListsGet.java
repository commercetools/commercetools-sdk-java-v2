...
/**
 *  <p>Retrieves all ShoppingLists in the Project.</p>
 *
 * <hr>
...
public class ByProjectKeyShoppingListsGet extends
        TypeApiMethod<ByProjectKeyShoppingListsGet, com.commercetools.api.models.shopping_list.ShoppingListPagedQueryResponse>
        implements ByProjectKeyShoppingListsGetMixin,
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        String httpRequestPath = String.format("%s/shopping-lists", encodePathParam(this.projectKey));
        if (!params.isEmpty()) {
     ...
     * @return ByProjectKeyShoppingListsGet
     */
    public <TValue> ByProjectKeyShoppingListsGet withPredicateVar(final String varName,
     ...
     * @return ByProjectKeyShoppingListsGet
     */
    public <TValue> ByProjectKeyShoppingListsGet addPredicateVar(final String varName,
            final Collection<TValue> predicateVar) {
        final String placeholderName = String.format("var.%s", varName);
