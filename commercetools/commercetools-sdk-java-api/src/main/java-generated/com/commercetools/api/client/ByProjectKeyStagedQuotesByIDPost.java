...
public class ByProjectKeyStagedQuotesByIDPost extends BodyApiMethod<ByProjectKeyStagedQuotesByIDPost, com.commercetools.api.models.staged_quote.StagedQuote, com.commercetools.api.models.staged_quote.StagedQuoteUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyStagedQuotesByIDPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyStagedQuotesByIDPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyStagedQuotesByIDPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyStagedQuotesByIDPost> {
    ...
    public ByProjectKeyStagedQuotesByIDPost(final ApiHttpClient apiHttpClient, String projectKey, String ID, com.commercetools.api.models.staged_quote.StagedQuoteUpdate stagedQuoteUpdate) {
        super(apiHttpClient);
     ...
     * @return ByProjectKeyStagedQuotesByIDPost
     */
     ...
     * @return ByProjectKeyStagedQuotesByIDPost
     */
    public <TValue> ByProjectKeyStagedQuotesByIDPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyStagedQuotesByIDPost
     */
    public <TValue> ByProjectKeyStagedQuotesByIDPost addExpand(final Collection<TValue> expand) {
    ...
    public ByProjectKeyStagedQuotesByIDPost withBody(com.commercetools.api.models.staged_quote.StagedQuoteUpdate stagedQuoteUpdate) {
