...
public class ByProjectKeyStagedQuotesKeyByKeyPost extends BodyApiMethod<ByProjectKeyStagedQuotesKeyByKeyPost, com.commercetools.api.models.staged_quote.StagedQuote, com.commercetools.api.models.staged_quote.StagedQuoteUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyStagedQuotesKeyByKeyPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyStagedQuotesKeyByKeyPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyStagedQuotesKeyByKeyPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyStagedQuotesKeyByKeyPost> {
    ...
    public ByProjectKeyStagedQuotesKeyByKeyPost(final ApiHttpClient apiHttpClient, String projectKey, String key, com.commercetools.api.models.staged_quote.StagedQuoteUpdate stagedQuoteUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(stagedQuoteUpdate)));
     ...
     * @return ByProjectKeyStagedQuotesKeyByKeyPost
     */
     ...
     * @return ByProjectKeyStagedQuotesKeyByKeyPost
     */
    public <TValue> ByProjectKeyStagedQuotesKeyByKeyPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyStagedQuotesKeyByKeyPost
     */
    public <TValue> ByProjectKeyStagedQuotesKeyByKeyPost addExpand(final Collection<TValue> expand) {
    ...
    public ByProjectKeyStagedQuotesKeyByKeyPost withBody(com.commercetools.api.models.staged_quote.StagedQuoteUpdate stagedQuoteUpdate) {
