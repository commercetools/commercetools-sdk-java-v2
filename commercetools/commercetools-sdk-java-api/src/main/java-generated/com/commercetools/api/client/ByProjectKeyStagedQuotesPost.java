...
public class ByProjectKeyStagedQuotesPost extends BodyApiMethod<ByProjectKeyStagedQuotesPost, com.commercetools.api.models.staged_quote.StagedQuote, com.commercetools.api.models.staged_quote.StagedQuoteDraft> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyStagedQuotesPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyStagedQuotesPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyStagedQuotesPost> {
    ...
    public ByProjectKeyStagedQuotesPost(final ApiHttpClient apiHttpClient, String projectKey, com.commercetools.api.models.staged_quote.StagedQuoteDraft stagedQuoteDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(stagedQuoteDraft)));
     ...
     * @return ByProjectKeyStagedQuotesPost
     */
     ...
     * @return ByProjectKeyStagedQuotesPost
     */
    public <TValue> ByProjectKeyStagedQuotesPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyStagedQuotesPost
     */
    public <TValue> ByProjectKeyStagedQuotesPost addExpand(final Collection<TValue> expand) {
    ...
    public ByProjectKeyStagedQuotesPost withBody(com.commercetools.api.models.staged_quote.StagedQuoteDraft stagedQuoteDraft) {
