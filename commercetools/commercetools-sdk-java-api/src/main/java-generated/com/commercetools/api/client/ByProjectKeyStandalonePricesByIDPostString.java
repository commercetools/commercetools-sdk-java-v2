...
public class ByProjectKeyStandalonePricesByIDPostString extends StringBodyApiMethod<ByProjectKeyStandalonePricesByIDPostString, com.commercetools.api.models.standalone_price.StandalonePrice> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyStandalonePricesByIDPostString>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyStandalonePricesByIDPostString>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyStandalonePricesByIDPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyStandalonePricesByIDPostString> {
    ...
    public ByProjectKeyStandalonePricesByIDPostString(final ApiHttpClient apiHttpClient, String projectKey, String ID, String standalonePriceUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), standalonePriceUpdate.getBytes(StandardCharsets.UTF_8));
