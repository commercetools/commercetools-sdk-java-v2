...
public class ByProjectKeyStandalonePricesKeyByKeyPost extends BodyApiMethod<ByProjectKeyStandalonePricesKeyByKeyPost, com.commercetools.api.models.standalone_price.StandalonePrice, com.commercetools.api.models.standalone_price.StandalonePriceUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyStandalonePricesKeyByKeyPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyStandalonePricesKeyByKeyPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyStandalonePricesKeyByKeyPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyStandalonePricesKeyByKeyPost> {
    ...
    public ByProjectKeyStandalonePricesKeyByKeyPost(final ApiHttpClient apiHttpClient, String projectKey, String key, com.commercetools.api.models.standalone_price.StandalonePriceUpdate standalonePriceUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(standalonePriceUpdate)));
    ...
    public ByProjectKeyStandalonePricesKeyByKeyPost withBody(com.commercetools.api.models.standalone_price.StandalonePriceUpdate standalonePriceUpdate) {
