...
public class ByProjectKeyStandalonePricesPost extends BodyApiMethod<ByProjectKeyStandalonePricesPost, com.commercetools.api.models.standalone_price.StandalonePrice, com.commercetools.api.models.standalone_price.StandalonePriceDraft> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyStandalonePricesPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyStandalonePricesPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyStandalonePricesPost> {
    ...
    public ByProjectKeyStandalonePricesPost(final ApiHttpClient apiHttpClient, String projectKey, com.commercetools.api.models.standalone_price.StandalonePriceDraft standalonePriceDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(standalonePriceDraft)));
    ...
    public ByProjectKeyStandalonePricesPost withBody(com.commercetools.api.models.standalone_price.StandalonePriceDraft standalonePriceDraft) {
