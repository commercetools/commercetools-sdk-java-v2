...
public class ByProjectKeyStandalonePricesPostString extends StringBodyApiMethod<ByProjectKeyStandalonePricesPostString, com.commercetools.api.models.standalone_price.StandalonePrice> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyStandalonePricesPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyStandalonePricesPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyStandalonePricesPostString> {
    ...
    public ByProjectKeyStandalonePricesPostString(final ApiHttpClient apiHttpClient, String projectKey, String standalonePriceDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), standalonePriceDraft.getBytes(StandardCharsets.UTF_8));
