...
public class ByProjectKeyStatesByIDGet extends ApiMethod<ByProjectKeyStatesByIDGet, com.commercetools.api.models.state.State> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyStatesByIDGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyStatesByIDGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyStatesByIDGet> {
     ...
     */
    public <TValue> ByProjectKeyStatesByIDGet withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyStatesByIDGet
     */
    public <TValue> ByProjectKeyStatesByIDGet addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyStatesByIDGet
     */
    public ByProjectKeyStatesByIDGet withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyStatesByIDGet
     */
    public ByProjectKeyStatesByIDGet addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyStatesByIDGet
     */
    public ByProjectKeyStatesByIDGet withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyStatesByIDGet
     */
    public ByProjectKeyStatesByIDGet addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyStatesByIDGet
     */
    public <TValue> ByProjectKeyStatesByIDGet withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyStatesByIDGet
     */
    public <TValue> ByProjectKeyStatesByIDGet addExpand(final Collection<TValue> expand) {
