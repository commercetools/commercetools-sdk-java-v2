...
public class ByProjectKeyStatesByIDPost extends BodyApiMethod<ByProjectKeyStatesByIDPost, com.commercetools.api.models.state.State, com.commercetools.api.models.state.StateUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyStatesByIDPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyStatesByIDPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyStatesByIDPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyStatesByIDPost> {
    ...
    public ByProjectKeyStatesByIDPost(final ApiHttpClient apiHttpClient, String projectKey, String ID, com.commercetools.api.models.state.StateUpdate stateUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(stateUpdate)));
     ...
     * @return ByProjectKeyStatesByIDPost
     */
    public <TValue> ByProjectKeyStatesByIDPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyStatesByIDPost
     */
    public <TValue> ByProjectKeyStatesByIDPost addExpand(final Collection<TValue> expand) {
