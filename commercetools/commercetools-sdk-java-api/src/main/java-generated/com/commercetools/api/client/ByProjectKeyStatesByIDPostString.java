...
public class ByProjectKeyStatesByIDPostString
        extends StringBodyApiMethod<ByProjectKeyStatesByIDPostString, com.commercetools.api.models.state.State>
        implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyStatesByIDPostString>,
        com.commercetools.api.client.ExpandableTrait<ByProjectKeyStatesByIDPostString>,
        com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyStatesByIDPostString>,
        com.commercetools.api.client.ErrorableTrait<ByProjectKeyStatesByIDPostString> {
    ...
    public ByProjectKeyStatesByIDPostString(final ApiHttpClient apiHttpClient, String projectKey, String ID,
            String stateUpdate) {
        super(apiHttpClient);
