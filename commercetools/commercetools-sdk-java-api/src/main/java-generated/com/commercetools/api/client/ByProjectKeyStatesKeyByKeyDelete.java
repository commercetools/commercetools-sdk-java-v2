...
public class ByProjectKeyStatesKeyByKeyDelete extends ApiMethod<ByProjectKeyStatesKeyByKeyDelete> {
    ...
    public ByProjectKeyStatesKeyByKeyDelete withVersion(final Long version){
        return new ByProjectKeyStatesKeyByKeyDelete(this).addQueryParam("version", version);
    }
    
    public ByProjectKeyStatesKeyByKeyDelete withExpand(final String expand){
        return new ByProjectKeyStatesKeyByKeyDelete(this).addQueryParam("expand", expand);
    }
}
