...
public class ByProjectKeyStatesKeyByKeyGet extends ApiMethod<ByProjectKeyStatesKeyByKeyGet, com.commercetools.api.models.state.State> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyStatesKeyByKeyGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyStatesKeyByKeyGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyStatesKeyByKeyGet> {
     ...
     * @return ByProjectKeyStatesKeyByKeyGet
     */
    public <TValue> ByProjectKeyStatesKeyByKeyGet withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyStatesKeyByKeyGet
     */
    public <TValue> ByProjectKeyStatesKeyByKeyGet addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyStatesKeyByKeyGet
     */
    public ByProjectKeyStatesKeyByKeyGet withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyStatesKeyByKeyGet
     */
    public ByProjectKeyStatesKeyByKeyGet addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyStatesKeyByKeyGet
     */
    public ByProjectKeyStatesKeyByKeyGet withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyStatesKeyByKeyGet
     */
    public ByProjectKeyStatesKeyByKeyGet addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyStatesKeyByKeyGet
     */
    public <TValue> ByProjectKeyStatesKeyByKeyGet withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyStatesKeyByKeyGet
     */
    public <TValue> ByProjectKeyStatesKeyByKeyGet addExpand(final Collection<TValue> expand) {
    ...
    public boolean equals(Object o) {
        ...
        ByProjectKeyStatesKeyByKeyGet that = (ByProjectKeyStatesKeyByKeyGet) o;
