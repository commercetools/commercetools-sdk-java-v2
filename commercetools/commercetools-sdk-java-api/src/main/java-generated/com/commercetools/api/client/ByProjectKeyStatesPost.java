...
public class ByProjectKeyStatesPost extends BodyApiMethod<ByProjectKeyStatesPost, com.commercetools.api.models.state.State, com.commercetools.api.models.state.StateDraft> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyStatesPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyStatesPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyStatesPost> {
    ...
    public ByProjectKeyStatesPost(final ApiHttpClient apiHttpClient, String projectKey, com.commercetools.api.models.state.StateDraft stateDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(stateDraft)));
     ...
     */
    public <TValue> ByProjectKeyStatesPost withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyStatesPost
     */
    public <TValue> ByProjectKeyStatesPost addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyStatesPost
     */
    public ByProjectKeyStatesPost withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyStatesPost
     */
    public ByProjectKeyStatesPost addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyStatesPost
     */
    public ByProjectKeyStatesPost withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyStatesPost
     */
    public ByProjectKeyStatesPost addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyStatesPost
     */
    public <TValue> ByProjectKeyStatesPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyStatesPost
     */
    public <TValue> ByProjectKeyStatesPost addExpand(final Collection<TValue> expand) {
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder()
                ...
                .append(stateDraft, that.stateDraft)
                .isEquals();
    }
