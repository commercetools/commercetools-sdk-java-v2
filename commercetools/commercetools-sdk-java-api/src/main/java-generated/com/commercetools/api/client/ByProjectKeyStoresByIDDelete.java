...
public class ByProjectKeyStoresByIDDelete extends ApiMethod<ByProjectKeyStoresByIDDelete, com.commercetools.api.models.store.Store> implements com.commercetools.api.client.ApiDeleteMethod<ByProjectKeyStoresByIDDelete, com.commercetools.api.models.store.Store>, com.commercetools.api.client.VersionedTrait<ByProjectKeyStoresByIDDelete>, com.commercetools.api.client.ConflictingTrait<ByProjectKeyStoresByIDDelete>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyStoresByIDDelete>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyStoresByIDDelete>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyStoresByIDDelete> {
     ...
     * @return ByProjectKeyStoresByIDDelete
     */
     ...
     * @return ByProjectKeyStoresByIDDelete
     */
    public <TValue> ByProjectKeyStoresByIDDelete withVersion(final Collection<TValue> version) {
     ...
     * @return ByProjectKeyStoresByIDDelete
     */
    public <TValue> ByProjectKeyStoresByIDDelete addVersion(final Collection<TValue> version) {
     ...
     * @return ByProjectKeyStoresByIDDelete
     */
    public <TValue> ByProjectKeyStoresByIDDelete withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyStoresByIDDelete
     */
    public <TValue> ByProjectKeyStoresByIDDelete addExpand(final Collection<TValue> expand) {
