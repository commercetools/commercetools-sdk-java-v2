...
public class ByProjectKeyStoresKeyByKeyPost extends BodyApiMethod<ByProjectKeyStoresKeyByKeyPost, com.commercetools.api.models.store.Store, com.commercetools.api.models.store.StoreUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyStoresKeyByKeyPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyStoresKeyByKeyPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyStoresKeyByKeyPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyStoresKeyByKeyPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(storeUpdate)));
     ...
     * @return ByProjectKeyStoresKeyByKeyPost
     */
     ...
     * @return ByProjectKeyStoresKeyByKeyPost
     */
    public <TValue> ByProjectKeyStoresKeyByKeyPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyStoresKeyByKeyPost
     */
    public <TValue> ByProjectKeyStoresKeyByKeyPost addExpand(final Collection<TValue> expand) {
