...
public class ByProjectKeyStoresPost extends BodyApiMethod<ByProjectKeyStoresPost, com.commercetools.api.models.store.Store, com.commercetools.api.models.store.StoreDraft> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyStoresPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyStoresPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyStoresPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(storeDraft)));
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder()
                ...
                .append(storeDraft, that.storeDraft)
                .isEquals();
    }
