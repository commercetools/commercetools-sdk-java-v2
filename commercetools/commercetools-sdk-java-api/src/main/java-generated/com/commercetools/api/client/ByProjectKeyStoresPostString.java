...
public class ByProjectKeyStoresPostString extends StringBodyApiMethod<ByProjectKeyStoresPostString, com.commercetools.api.models.store.Store> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyStoresPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyStoresPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyStoresPostString> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), storeDraft.getBytes(StandardCharsets.UTF_8));
     ...
     * @return ByProjectKeyStoresPostString
     */
