...
public class ByProjectKeySubscriptionsByIDDelete extends
        TypeApiMethod<ByProjectKeySubscriptionsByIDDelete, com.commercetools.api.models.subscription.Subscription>
        implements
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        String httpRequestPath = String.format("%s/subscriptions/%s", encodePathParam(this.projectKey),
