...
public class ByProjectKeySubscriptionsKeyByKeyDelete extends ApiMethod<ByProjectKeySubscriptionsKeyByKeyDelete, com.commercetools.api.models.subscription.Subscription> implements com.commercetools.api.client.ApiDeleteMethod<ByProjectKeySubscriptionsKeyByKeyDelete, com.commercetools.api.models.subscription.Subscription>, com.commercetools.api.client.VersionedTrait<ByProjectKeySubscriptionsKeyByKeyDelete>, com.commercetools.api.client.ConflictingTrait<ByProjectKeySubscriptionsKeyByKeyDelete>, com.commercetools.api.client.ExpandableTrait<ByProjectKeySubscriptionsKeyByKeyDelete>, com.commercetools.api.client.ErrorableTrait<ByProjectKeySubscriptionsKeyByKeyDelete>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeySubscriptionsKeyByKeyDelete> {
     ...
     */
    public <TValue> ByProjectKeySubscriptionsKeyByKeyDelete withVersion(final TValue version) {
     ...
     * @return ByProjectKeySubscriptionsKeyByKeyDelete
     */
    public <TValue> ByProjectKeySubscriptionsKeyByKeyDelete addVersion(final TValue version) {
     ...
     * @return ByProjectKeySubscriptionsKeyByKeyDelete
     */
    public ByProjectKeySubscriptionsKeyByKeyDelete withVersion(final Supplier<Long> supplier) {
     ...
     * @return ByProjectKeySubscriptionsKeyByKeyDelete
     */
    public ByProjectKeySubscriptionsKeyByKeyDelete addVersion(final Supplier<Long> supplier) {
     ...
     * @return ByProjectKeySubscriptionsKeyByKeyDelete
     */
    public ByProjectKeySubscriptionsKeyByKeyDelete withVersion(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeySubscriptionsKeyByKeyDelete
     */
    public ByProjectKeySubscriptionsKeyByKeyDelete addVersion(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeySubscriptionsKeyByKeyDelete
     */
    public <TValue> ByProjectKeySubscriptionsKeyByKeyDelete withVersion(final Collection<TValue> version) {
    ...
    public boolean equals(Object o) {
        ...
        ByProjectKeySubscriptionsKeyByKeyDelete that = (ByProjectKeySubscriptionsKeyByKeyDelete) o;
