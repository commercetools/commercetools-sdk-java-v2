...
public class ByProjectKeySubscriptionsKeyByKeyPost extends BodyApiMethod<ByProjectKeySubscriptionsKeyByKeyPost, com.commercetools.api.models.subscription.Subscription, com.commercetools.api.models.subscription.SubscriptionUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeySubscriptionsKeyByKeyPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeySubscriptionsKeyByKeyPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeySubscriptionsKeyByKeyPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeySubscriptionsKeyByKeyPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(subscriptionUpdate)));
     ...
     * @return ByProjectKeySubscriptionsKeyByKeyPost
     */
    public ByProjectKeySubscriptionsKeyByKeyPost withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeySubscriptionsKeyByKeyPost
     */
    public ByProjectKeySubscriptionsKeyByKeyPost addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeySubscriptionsKeyByKeyPost
     */
    public ByProjectKeySubscriptionsKeyByKeyPost withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeySubscriptionsKeyByKeyPost
     */
    public ByProjectKeySubscriptionsKeyByKeyPost addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeySubscriptionsKeyByKeyPost
     */
    public <TValue> ByProjectKeySubscriptionsKeyByKeyPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeySubscriptionsKeyByKeyPost
     */
    public <TValue> ByProjectKeySubscriptionsKeyByKeyPost addExpand(final Collection<TValue> expand) {
    ...
    public ByProjectKeySubscriptionsKeyByKeyPost withBody(com.commercetools.api.models.subscription.SubscriptionUpdate subscriptionUpdate) {
