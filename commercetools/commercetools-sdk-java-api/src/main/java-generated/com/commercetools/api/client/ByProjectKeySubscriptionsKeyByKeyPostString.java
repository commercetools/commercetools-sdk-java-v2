...
public class ByProjectKeySubscriptionsKeyByKeyPostString extends StringBodyApiMethod<ByProjectKeySubscriptionsKeyByKeyPostString, com.commercetools.api.models.subscription.Subscription> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeySubscriptionsKeyByKeyPostString>, com.commercetools.api.client.ExpandableTrait<ByProjectKeySubscriptionsKeyByKeyPostString>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeySubscriptionsKeyByKeyPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeySubscriptionsKeyByKeyPostString> {
    ...
    public ByProjectKeySubscriptionsKeyByKeyPostString(final ApiHttpClient apiHttpClient, String projectKey, String key, String subscriptionUpdate) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), subscriptionUpdate.getBytes(StandardCharsets.UTF_8));
