...
public class ByProjectKeySubscriptionsPostString extends StringBodyApiMethod<ByProjectKeySubscriptionsPostString, com.commercetools.api.models.subscription.Subscription> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeySubscriptionsPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeySubscriptionsPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeySubscriptionsPostString> {
    ...
    public ByProjectKeySubscriptionsPostString(final ApiHttpClient apiHttpClient, String projectKey, String subscriptionDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), subscriptionDraft.getBytes(StandardCharsets.UTF_8));
     ...
     * @return ByProjectKeySubscriptionsPostString
     */
