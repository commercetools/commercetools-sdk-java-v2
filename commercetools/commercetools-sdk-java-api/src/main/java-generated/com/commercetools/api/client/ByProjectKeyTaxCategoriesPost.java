...
public class ByProjectKeyTaxCategoriesPost extends BodyApiMethod<ByProjectKeyTaxCategoriesPost, com.commercetools.api.models.tax_category.TaxCategory, com.commercetools.api.models.tax_category.TaxCategoryDraft> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyTaxCategoriesPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyTaxCategoriesPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyTaxCategoriesPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(taxCategoryDraft)));
     ...
     * @return ByProjectKeyTaxCategoriesPost
     */
    public <TValue> ByProjectKeyTaxCategoriesPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyTaxCategoriesPost
     */
    public <TValue> ByProjectKeyTaxCategoriesPost addExpand(final Collection<TValue> expand) {
    ...
    public ByProjectKeyTaxCategoriesPost withBody(com.commercetools.api.models.tax_category.TaxCategoryDraft taxCategoryDraft) {
