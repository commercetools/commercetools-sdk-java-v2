...
public class ByProjectKeyTaxCategoriesPostString extends StringBodyApiMethod<ByProjectKeyTaxCategoriesPostString, com.commercetools.api.models.tax_category.TaxCategory> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyTaxCategoriesPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyTaxCategoriesPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyTaxCategoriesPostString> {
    ...
    public ByProjectKeyTaxCategoriesPostString(final ApiHttpClient apiHttpClient, String projectKey, String taxCategoryDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), taxCategoryDraft.getBytes(StandardCharsets.UTF_8));
