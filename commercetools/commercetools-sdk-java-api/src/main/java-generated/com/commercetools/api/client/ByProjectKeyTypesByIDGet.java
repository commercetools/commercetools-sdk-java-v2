...
public class ByProjectKeyTypesByIDGet extends ApiMethod<ByProjectKeyTypesByIDGet, com.commercetools.api.models.type.Type> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyTypesByIDGet>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyTypesByIDGet>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyTypesByIDGet> {
     ...
     */
    public <TValue> ByProjectKeyTypesByIDGet withExpand(final TValue expand) {
     ...
     * @return ByProjectKeyTypesByIDGet
     */
    public <TValue> ByProjectKeyTypesByIDGet addExpand(final TValue expand) {
     ...
     * @return ByProjectKeyTypesByIDGet
     */
    public ByProjectKeyTypesByIDGet withExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyTypesByIDGet
     */
    public ByProjectKeyTypesByIDGet addExpand(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyTypesByIDGet
     */
    public ByProjectKeyTypesByIDGet withExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyTypesByIDGet
     */
    public ByProjectKeyTypesByIDGet addExpand(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyTypesByIDGet
     */
    public <TValue> ByProjectKeyTypesByIDGet withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyTypesByIDGet
     */
    public <TValue> ByProjectKeyTypesByIDGet addExpand(final Collection<TValue> expand) {
