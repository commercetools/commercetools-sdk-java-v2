...
public class ByProjectKeyTypesKeyByKeyPost extends BodyApiMethod<ByProjectKeyTypesKeyByKeyPost, com.commercetools.api.models.type.Type, com.commercetools.api.models.type.TypeUpdate> implements com.commercetools.api.client.ConflictingTrait<ByProjectKeyTypesKeyByKeyPost>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyTypesKeyByKeyPost>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyTypesKeyByKeyPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyTypesKeyByKeyPost> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(typeUpdate)));
     ...
     * @return ByProjectKeyTypesKeyByKeyPost
     */
    public <TValue> ByProjectKeyTypesKeyByKeyPost withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyTypesKeyByKeyPost
     */
    public <TValue> ByProjectKeyTypesKeyByKeyPost addExpand(final Collection<TValue> expand) {
