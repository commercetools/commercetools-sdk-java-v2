...
public class ByProjectKeyTypesPostString extends StringBodyApiMethod<ByProjectKeyTypesPostString, com.commercetools.api.models.type.Type> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyTypesPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyTypesPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyTypesPostString> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), typeDraft.getBytes(StandardCharsets.UTF_8));
