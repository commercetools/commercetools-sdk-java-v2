...
public class ByProjectKeyVariantProjectionsKeyByKeyRequestBuilder {

    private final ApiHttpClient apiHttpClient;
    private final String projectKey;
    private final String key;

    public ByProjectKeyVariantProjectionsKeyByKeyRequestBuilder(final ApiHttpClient apiHttpClient,
