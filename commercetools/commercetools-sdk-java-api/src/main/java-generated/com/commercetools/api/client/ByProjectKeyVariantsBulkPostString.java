...
public class ByProjectKeyVariantsBulkPostString extends
        StringBodyApiMethod<ByProjectKeyVariantsBulkPostString, com.commercetools.api.models.variant.VariantBulkUpdateResponse> {
    ...
    private String variantBulkUpdate;

    public ByProjectKeyVariantsBulkPostString(final ApiHttpClient apiHttpClient, String projectKey,
            String variantBulkUpdate) {
        super(apiHttpClient);
        this.projectKey = projectKey;
        this.variantBulkUpdate = variantBulkUpdate;
    }

    public ByProjectKeyVariantsBulkPostString(ByProjectKeyVariantsBulkPostString t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        String httpRequestPath = String.format("%s/variants/bulk", this.projectKey);
        if (!params.isEmpty()) {
            httpRequestPath += "?" + String.join("&", params);
        }
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(),
            variantBulkUpdate.getBytes(StandardCharsets.UTF_8));
     ...
     * @return ByProjectKeyVariantsBulkPostString
     */
    public <TValue> ByProjectKeyVariantsBulkPostString withVersionControl(final TValue versionControl) {
     ...
     * @return ByProjectKeyVariantsBulkPostString
     */
    public <TValue> ByProjectKeyVariantsBulkPostString addVersionControl(final TValue versionControl) {
     ...
     * @return ByProjectKeyVariantsBulkPostString
     */
    public ByProjectKeyVariantsBulkPostString withVersionControl(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyVariantsBulkPostString
     */
    public ByProjectKeyVariantsBulkPostString addVersionControl(final Supplier<String> supplier) {
     ...
     * @return ByProjectKeyVariantsBulkPostString
     */
    public ByProjectKeyVariantsBulkPostString withVersionControl(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyVariantsBulkPostString
     */
    public ByProjectKeyVariantsBulkPostString addVersionControl(final Function<StringBuilder, StringBuilder> op) {
     ...
     * @return ByProjectKeyVariantsBulkPostString
     */
    public <TValue> ByProjectKeyVariantsBulkPostString withVersionControl(final Collection<TValue> versionControl) {
     ...
     * @return ByProjectKeyVariantsBulkPostString
     */
    public <TValue> ByProjectKeyVariantsBulkPostString addVersionControl(final Collection<TValue> versionControl) {
    ...
    public ByProjectKeyVariantsBulkPostString withBody(String variantBulkUpdate) {
        ByProjectKeyVariantsBulkPostString t = copy();
    ...
    public boolean equals(Object o) {
        ...
        ByProjectKeyVariantsBulkPostString that = (ByProjectKeyVariantsBulkPostString) o;
    ...
    @Override
    protected ByProjectKeyVariantsBulkPostString copy() {
        return new ByProjectKeyVariantsBulkPostString(this);
    }
}
