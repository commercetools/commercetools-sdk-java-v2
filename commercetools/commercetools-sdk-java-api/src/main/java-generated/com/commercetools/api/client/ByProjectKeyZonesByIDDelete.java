...
public class ByProjectKeyZonesByIDDelete extends ApiMethod<ByProjectKeyZonesByIDDelete, com.commercetools.api.models.zone.Zone> implements com.commercetools.api.client.ApiDeleteMethod<ByProjectKeyZonesByIDDelete, com.commercetools.api.models.zone.Zone>, com.commercetools.api.client.VersionedTrait<ByProjectKeyZonesByIDDelete>, com.commercetools.api.client.ConflictingTrait<ByProjectKeyZonesByIDDelete>, com.commercetools.api.client.ExpandableTrait<ByProjectKeyZonesByIDDelete>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyZonesByIDDelete>, com.commercetools.api.client.Deprecatable200Trait<ByProjectKeyZonesByIDDelete> {
     ...
     * @return ByProjectKeyZonesByIDDelete
     */
    public <TValue> ByProjectKeyZonesByIDDelete withVersion(final Collection<TValue> version) {
     ...
     * @return ByProjectKeyZonesByIDDelete
     */
    public <TValue> ByProjectKeyZonesByIDDelete addVersion(final Collection<TValue> version) {
     ...
     * @return ByProjectKeyZonesByIDDelete
     */
    public <TValue> ByProjectKeyZonesByIDDelete withExpand(final Collection<TValue> expand) {
     ...
     * @return ByProjectKeyZonesByIDDelete
     */
    public <TValue> ByProjectKeyZonesByIDDelete addExpand(final Collection<TValue> expand) {
