...
public class ByProjectKeyZonesPost extends BodyApiMethod<ByProjectKeyZonesPost, com.commercetools.api.models.zone.Zone, com.commercetools.api.models.zone.ZoneDraft> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyZonesPost>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyZonesPost>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyZonesPost> {
    ...
    public ByProjectKeyZonesPost(final ApiHttpClient apiHttpClient, String projectKey, com.commercetools.api.models.zone.ZoneDraft zoneDraft) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(zoneDraft)));
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder()
                ...
                .append(zoneDraft, that.zoneDraft)
                .isEquals();
    }
