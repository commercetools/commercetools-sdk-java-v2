...
public class ByProjectKeyZonesPostString extends StringBodyApiMethod<ByProjectKeyZonesPostString, com.commercetools.api.models.zone.Zone> implements com.commercetools.api.client.ExpandableTrait<ByProjectKeyZonesPostString>, com.commercetools.api.client.Deprecatable201Trait<ByProjectKeyZonesPostString>, com.commercetools.api.client.ErrorableTrait<ByProjectKeyZonesPostString> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), zoneDraft.getBytes(StandardCharsets.UTF_8));
