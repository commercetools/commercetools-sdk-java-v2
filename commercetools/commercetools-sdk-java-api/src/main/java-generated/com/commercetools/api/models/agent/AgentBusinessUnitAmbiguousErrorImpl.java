...
public class AgentBusinessUnitAmbiguousErrorImpl implements AgentBusinessUnitAmbiguousError, ModelBase {
     ...
     */
    @JsonCreator
    AgentBusinessUnitAmbiguousErrorImpl(@JsonProperty("message") final String message,
     ...
     */
    public AgentBusinessUnitAmbiguousErrorImpl() {
        this.code = BUSINESS_UNIT_AMBIGUOUS;
    }
    ...
    public boolean equals(Object o) {
        ...
        AgentBusinessUnitAmbiguousErrorImpl that = (AgentBusinessUnitAmbiguousErrorImpl) o;
    ...
    public AgentBusinessUnitAmbiguousError copyDeep() {
        return AgentBusinessUnitAmbiguousError.deepCopy(this);
    }
}
