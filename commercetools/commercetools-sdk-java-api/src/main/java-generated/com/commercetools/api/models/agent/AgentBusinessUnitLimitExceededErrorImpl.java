...
public class AgentBusinessUnitLimitExceededErrorImpl implements AgentBusinessUnitLimitExceededError, ModelBase {
     ...
     */
    @JsonCreator
    AgentBusinessUnitLimitExceededErrorImpl(@JsonProperty("message") final String message,
     ...
     */
    public AgentBusinessUnitLimitExceededErrorImpl() {
        this.code = BUSINESS_UNIT_LIMIT_EXCEEDED;
    }
    ...
    public boolean equals(Object o) {
        ...
        AgentBusinessUnitLimitExceededErrorImpl that = (AgentBusinessUnitLimitExceededErrorImpl) o;
    ...
    public AgentBusinessUnitLimitExceededError copyDeep() {
        return AgentBusinessUnitLimitExceededError.deepCopy(this);
    }
}
