...
public class AgentBusinessUnitUnresolvedErrorImpl implements AgentBusinessUnitUnresolvedError, ModelBase {
     ...
     */
    @JsonCreator
    AgentBusinessUnitUnresolvedErrorImpl(@JsonProperty("message") final String message,
     ...
     */
    public AgentBusinessUnitUnresolvedErrorImpl() {
        this.code = BUSINESS_UNIT_UNRESOLVED;
    }
    ...
    public boolean equals(Object o) {
        ...
        AgentBusinessUnitUnresolvedErrorImpl that = (AgentBusinessUnitUnresolvedErrorImpl) o;
    ...
    public AgentBusinessUnitUnresolvedError copyDeep() {
        return AgentBusinessUnitUnresolvedError.deepCopy(this);
    }
}
