...
public class AgentMissingCountryErrorImpl implements AgentMissingCountryError, ModelBase {
     ...
     */
    @JsonCreator
    AgentMissingCountryErrorImpl(@JsonProperty("message") final String message,
     ...
     */
    public AgentMissingCountryErrorImpl() {
        this.code = MISSING_COUNTRY;
    }
    ...
    public boolean equals(Object o) {
        ...
        AgentMissingCountryErrorImpl that = (AgentMissingCountryErrorImpl) o;
    ...
    public AgentMissingCountryError copyDeep() {
        return AgentMissingCountryError.deepCopy(this);
    }
}
