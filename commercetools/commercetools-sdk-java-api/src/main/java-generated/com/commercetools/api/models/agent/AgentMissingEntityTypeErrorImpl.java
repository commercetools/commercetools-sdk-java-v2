...
public class AgentMissingEntityTypeErrorImpl implements AgentMissingEntityTypeError, ModelBase {
     ...
     */
    @JsonCreator
    AgentMissingEntityTypeErrorImpl(@JsonProperty("message") final String message,
     ...
     */
    public AgentMissingEntityTypeErrorImpl() {
        this.code = MISSING_ENTITY_TYPE;
    }
    ...
    public boolean equals(Object o) {
        ...
        AgentMissingEntityTypeErrorImpl that = (AgentMissingEntityTypeErrorImpl) o;
    ...
    public AgentMissingEntityTypeError copyDeep() {
        return AgentMissingEntityTypeError.deepCopy(this);
    }
}
