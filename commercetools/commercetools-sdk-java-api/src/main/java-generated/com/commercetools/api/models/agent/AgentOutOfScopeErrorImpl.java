...
public class AgentOutOfScopeErrorImpl implements AgentOutOfScopeError, ModelBase {
     ...
     */
    @JsonCreator
    AgentOutOfScopeErrorImpl(@JsonProperty("message") final String message,
     ...
     */
    public AgentOutOfScopeErrorImpl() {
        this.code = OUT_OF_SCOPE;
    }
    ...
    public boolean equals(Object o) {
        ...
        AgentOutOfScopeErrorImpl that = (AgentOutOfScopeErrorImpl) o;
    ...
    public AgentOutOfScopeError copyDeep() {
        return AgentOutOfScopeError.deepCopy(this);
    }
}
