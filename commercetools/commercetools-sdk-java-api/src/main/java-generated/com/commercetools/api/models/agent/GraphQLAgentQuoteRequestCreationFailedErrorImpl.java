...
public class GraphQLAgentQuoteRequestCreationFailedErrorImpl
        implements GraphQLAgentQuoteRequestCreationFailedError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLAgentQuoteRequestCreationFailedErrorImpl(
     ...
     */
    public GraphQLAgentQuoteRequestCreationFailedErrorImpl() {
        this.code = QUOTE_REQUEST_CREATION_FAILED;
    }
    ...
    public boolean equals(Object o) {
        ...
        GraphQLAgentQuoteRequestCreationFailedErrorImpl that = (GraphQLAgentQuoteRequestCreationFailedErrorImpl) o;
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder(17, 37).append(code).append(values).append(cartId).toHashCode();
    }
    ...
    public GraphQLAgentQuoteRequestCreationFailedError copyDeep() {
        return GraphQLAgentQuoteRequestCreationFailedError.deepCopy(this);
    }
}
