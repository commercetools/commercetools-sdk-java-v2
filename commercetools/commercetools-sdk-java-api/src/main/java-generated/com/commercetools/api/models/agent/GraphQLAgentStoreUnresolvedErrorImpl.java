...
public class GraphQLAgentStoreUnresolvedErrorImpl implements GraphQLAgentStoreUnresolvedError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLAgentStoreUnresolvedErrorImpl(
            @JsonAnySetter @JsonProperty("values") final Map<String, java.lang.Object> values) {
        this.values = values;
        this.code = STORE_UNRESOLVED;
    }

    /**
     * create empty instance
     */
    public GraphQLAgentStoreUnresolvedErrorImpl() {
        this.code = STORE_UNRESOLVED;
    }
    ...
    public boolean equals(Object o) {
        ...
        GraphQLAgentStoreUnresolvedErrorImpl that = (GraphQLAgentStoreUnresolvedErrorImpl) o;
    ...
    public GraphQLAgentStoreUnresolvedError copyDeep() {
        return GraphQLAgentStoreUnresolvedError.deepCopy(this);
    }
}
