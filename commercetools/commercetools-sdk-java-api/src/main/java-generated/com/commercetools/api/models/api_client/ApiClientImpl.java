...
public class ApiClientImpl implements ApiClient, ModelBase {
     ...
     */
    @JsonCreator
    ApiClientImpl(@JsonProperty("id") final String id, @JsonProperty("name") final String name, @JsonProperty("scope") final String scope, @JsonProperty("secret") final String secret, @JsonProperty("lastUsedAt") final java.time.LocalDate lastUsedAt, @JsonProperty("deleteAt") final java.time.ZonedDateTime deleteAt, @JsonProperty("createdAt") final java.time.ZonedDateTime createdAt, @JsonProperty("accessTokenValiditySeconds") final Integer accessTokenValiditySeconds, @JsonProperty("refreshTokenValiditySeconds") final Integer refreshTokenValiditySeconds) {
        this.id = id;
        this.name = name;
        this.scope = scope;
        this.secret = secret;
