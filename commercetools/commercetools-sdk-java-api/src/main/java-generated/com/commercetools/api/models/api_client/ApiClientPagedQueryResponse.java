...
public interface ApiClientPagedQueryResponse extends com.commercetools.api.models.ResourcePagedQueryResponse<ApiClient> {
    ...
    public static ApiClientPagedQueryResponse deepCopy(@Nullable final ApiClientPagedQueryResponse template) {
        ...
        instance.setResults(Optional.ofNullable(template.getResults())
                .map(t -> t.stream().map(com.commercetools.api.models.api_client.ApiClient::deepCopy).collect(Collectors.toList()))
                .orElse(null));
        return instance;
    }
