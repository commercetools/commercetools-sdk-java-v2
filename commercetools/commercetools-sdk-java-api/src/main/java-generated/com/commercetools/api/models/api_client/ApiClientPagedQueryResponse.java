...
public interface ApiClientPagedQueryResponse
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApiClientPagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApiClientPagedQueryResponse>() {
            @Override
