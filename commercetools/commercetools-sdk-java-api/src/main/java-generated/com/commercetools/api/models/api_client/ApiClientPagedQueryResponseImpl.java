...
public class ApiClientPagedQueryResponseImpl implements ApiClientPagedQueryResponse, ModelBase {
     ...
     */
    @JsonCreator
    ApiClientPagedQueryResponseImpl(@JsonProperty("limit") final Long limit, @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count, @JsonProperty("total") final Long total, @JsonProperty("results") final java.util.List<com.commercetools.api.models.api_client.ApiClient> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
