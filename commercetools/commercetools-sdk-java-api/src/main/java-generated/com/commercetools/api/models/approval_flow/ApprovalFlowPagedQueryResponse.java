...
public interface ApprovalFlowPagedQueryResponse {
    ...
    @JsonIgnore
    public void setResults(final ApprovalFlow... results);
    ...
    public void setResults(final List<ApprovalFlow> results);

    /**
     * factory method
     * @return instance of ApprovalFlowPagedQueryResponse
     */
    public static ApprovalFlowPagedQueryResponse of() {
     ...
     */
    public static ApprovalFlowPagedQueryResponse of(final ApprovalFlowPagedQueryResponse template) {
        ApprovalFlowPagedQueryResponseImpl instance = new ApprovalFlowPagedQueryResponseImpl();
    ...
    public ApprovalFlowPagedQueryResponse copyDeep();
     ...
     */
    @Nullable
    public static ApprovalFlowPagedQueryResponse deepCopy(@Nullable final ApprovalFlowPagedQueryResponse template) {
        if (template == null) {
            return null;
        }
        ApprovalFlowPagedQueryResponseImpl instance = new ApprovalFlowPagedQueryResponseImpl();
        ...
        instance.setResults(Optional.ofNullable(template.getResults())
                .map(t -> t.stream()
                        .map(com.commercetools.api.models.approval_flow.ApprovalFlow::deepCopy)
     ...
     * @return builder
     */
    public static ApprovalFlowPagedQueryResponseBuilder builder() {
     ...
     * @return builder
     */
    public static ApprovalFlowPagedQueryResponseBuilder builder(final ApprovalFlowPagedQueryResponse template) {
        return ApprovalFlowPagedQueryResponseBuilder.of(template);
    }
     ...
     */
    public static com.fasterxml.jackson.core.type.TypeReference<ApprovalFlowPagedQueryResponse> typeReference() {
        return new com.fasterxml.jackson.core.type.TypeReference<ApprovalFlowPagedQueryResponse>() {
            @Override
