...
public class ApprovalFlowPagedQueryResponseImpl implements ApprovalFlowPagedQueryResponse, ModelBase {
     ...
     */
    @JsonCreator
    ApprovalFlowPagedQueryResponseImpl(@JsonProperty("limit") final Long limit,
            @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count,
            @JsonProperty("total") final Long total,
            @JsonProperty("results") final java.util.List<com.commercetools.api.models.approval_flow.ApprovalFlow> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
    ...
    public void setResults(final com.commercetools.api.models.approval_flow.ApprovalFlow... results) {
        this.results = new ArrayList<>(Arrays.asList(results));
    }

    public void setResults(final java.util.List<com.commercetools.api.models.approval_flow.ApprovalFlow> results) {
        this.results = results;
    }
    ...
    public boolean equals(Object o) {
        ...
        ApprovalFlowPagedQueryResponseImpl that = (ApprovalFlowPagedQueryResponseImpl) o;
    ...
    public ApprovalFlowPagedQueryResponse copyDeep() {
        return ApprovalFlowPagedQueryResponse.deepCopy(this);
    }
}
