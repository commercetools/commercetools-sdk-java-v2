...
public interface ApprovalFlowSetCustomFieldAction extends ApprovalFlowUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApprovalFlowSetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApprovalFlowSetCustomFieldAction>() {
            @Override
