...
public class ApprovalFlowSetCustomFieldActionImpl implements ApprovalFlowSetCustomFieldAction, ModelBase {
     ...
     */
    @JsonCreator
    ApprovalFlowSetCustomFieldActionImpl(@JsonProperty("name") final String name,
     ...
     */
    public ApprovalFlowSetCustomFieldActionImpl() {
        this.action = SET_CUSTOM_FIELD;
    }
    ...
    public boolean equals(Object o) {
        ...
        ApprovalFlowSetCustomFieldActionImpl that = (ApprovalFlowSetCustomFieldActionImpl) o;
    ...
    @Override
    public ApprovalFlowSetCustomFieldAction copyDeep() {
        return ApprovalFlowSetCustomFieldAction.deepCopy(this);
    }
}
