...
public interface ApprovalFlowSetCustomTypeAction extends ApprovalFlowUpdateAction {
    ...
    /**
     *  <p>Object containing the <a href="https://docs.commercetools.com/apis/ctp:api:type:CustomFields" rel="nofollow">Custom Fields</a> fields for the ApprovalFlow.</p>
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApprovalFlowSetCustomTypeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApprovalFlowSetCustomTypeAction>() {
            @Override
