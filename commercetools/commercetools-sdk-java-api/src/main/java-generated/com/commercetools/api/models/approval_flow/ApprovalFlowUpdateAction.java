...
public interface ApprovalFlowUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApprovalFlowUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApprovalFlowUpdateAction>() {
            @Override
