...
public class ApprovalRulePagedQueryResponseImpl implements ApprovalRulePagedQueryResponse, ModelBase {
     ...
     */
    @JsonCreator
    ApprovalRulePagedQueryResponseImpl(@JsonProperty("limit") final Long limit,
            @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count,
            @JsonProperty("total") final Long total,
            @JsonProperty("results") final java.util.List<com.commercetools.api.models.approval_rule.ApprovalRule> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
     ...
     */
    public ApprovalRulePagedQueryResponseImpl() {
    }
    ...
    public void setResults(final com.commercetools.api.models.approval_rule.ApprovalRule... results) {
        this.results = new ArrayList<>(Arrays.asList(results));
    }

    public void setResults(final java.util.List<com.commercetools.api.models.approval_rule.ApprovalRule> results) {
        this.results = results;
    }
    ...
    public boolean equals(Object o) {
        ...
        ApprovalRulePagedQueryResponseImpl that = (ApprovalRulePagedQueryResponseImpl) o;
