...
public interface ApprovalRuleSetApproversAction extends ApprovalRuleUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApprovalRuleSetApproversAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApprovalRuleSetApproversAction>() {
            @Override
