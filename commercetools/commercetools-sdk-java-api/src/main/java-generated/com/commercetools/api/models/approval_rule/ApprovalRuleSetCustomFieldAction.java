...
public interface ApprovalRuleSetCustomFieldAction extends ApprovalRuleUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApprovalRuleSetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApprovalRuleSetCustomFieldAction>() {
            @Override
