...
public interface ApprovalRuleSetDescriptionAction extends ApprovalRuleUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApprovalRuleSetDescriptionAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApprovalRuleSetDescriptionAction>() {
            @Override
