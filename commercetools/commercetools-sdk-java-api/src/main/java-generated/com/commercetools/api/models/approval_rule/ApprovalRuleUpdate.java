...
public interface ApprovalRuleUpdate {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApprovalRuleUpdate> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApprovalRuleUpdate>() {
            @Override
