...
public interface ApprovalRuleUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApprovalRuleUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApprovalRuleUpdateAction>() {
            @Override
