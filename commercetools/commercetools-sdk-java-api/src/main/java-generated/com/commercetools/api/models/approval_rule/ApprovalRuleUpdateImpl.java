...
public class ApprovalRuleUpdateImpl implements ApprovalRuleUpdate, ModelBase {
     ...
     */
    @JsonCreator
    ApprovalRuleUpdateImpl(@JsonProperty("version") final Long version,
            @JsonProperty("actions") final java.util.List<com.commercetools.api.models.approval_rule.ApprovalRuleUpdateAction> actions) {
    ...
    public void setActions(final com.commercetools.api.models.approval_rule.ApprovalRuleUpdateAction... actions) {
    ...
    public boolean equals(Object o) {
        ...
        ApprovalRuleUpdateImpl that = (ApprovalRuleUpdateImpl) o;
