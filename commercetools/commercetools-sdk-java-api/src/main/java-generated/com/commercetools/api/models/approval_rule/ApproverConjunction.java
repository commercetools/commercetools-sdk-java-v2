...
public interface ApproverConjunction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApproverConjunction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApproverConjunction>() {
            @Override
