...
public class ApproverConjunctionImpl implements ApproverConjunction, ModelBase {
    ...
    ApproverConjunctionImpl(
            @JsonProperty("and") final java.util.List<com.commercetools.api.models.approval_rule.ApproverDisjunction> and) {
        this.and = and;
    }
    ...
    public void setAnd(final com.commercetools.api.models.approval_rule.ApproverDisjunction... and) {
        this.and = new ArrayList<>(Arrays.asList(and));
    }

    public void setAnd(final java.util.List<com.commercetools.api.models.approval_rule.ApproverDisjunction> and) {
        this.and = and;
    }
    ...
    public boolean equals(Object o) {
        ...
        ApproverConjunctionImpl that = (ApproverConjunctionImpl) o;
