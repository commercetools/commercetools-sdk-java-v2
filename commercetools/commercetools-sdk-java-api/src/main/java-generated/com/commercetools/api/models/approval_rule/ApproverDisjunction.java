...
public interface ApproverDisjunction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApproverDisjunction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApproverDisjunction>() {
            @Override
