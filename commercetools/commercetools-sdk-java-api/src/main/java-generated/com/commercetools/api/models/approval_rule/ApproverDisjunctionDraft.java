...
public interface ApproverDisjunctionDraft extends io.vrap.rmf.base.client.Draft<ApproverDisjunctionDraft> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApproverDisjunctionDraft> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApproverDisjunctionDraft>() {
            @Override
