...
/**
 *  <p>Describes the sequence in which <a href="https://docs.commercetools.com/apis/ctp:api:type:Associate" rel="nofollow">Associates</a> can approve an <a href="https://docs.commercetools.com/apis/ctp:api:type:Order" rel="nofollow">Order</a>.</p>
 *
 * <hr>
...
public interface ApproverHierarchyDraft extends io.vrap.rmf.base.client.Draft<ApproverHierarchyDraft> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApproverHierarchyDraft> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApproverHierarchyDraft>() {
            @Override
