 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("changeBuyerAssignable")
...
public interface AssociateRoleChangeBuyerAssignableAction extends AssociateRoleUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AssociateRoleChangeBuyerAssignableAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<AssociateRoleChangeBuyerAssignableAction>() {
            @Override
