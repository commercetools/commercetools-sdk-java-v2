...
public class AssociateRoleDraftBuilder implements Builder<AssociateRoleDraft> {
    ...
    public AssociateRoleDraftBuilder permissions(@Nullable final com.commercetools.api.models.associate_role.Permission ...permissions) {
    ...
    public AssociateRoleDraftBuilder permissions(@Nullable final java.util.List<com.commercetools.api.models.associate_role.Permission> permissions) {
    ...
    public AssociateRoleDraftBuilder plusPermissions(@Nullable final com.commercetools.api.models.associate_role.Permission ...permissions) {
    ...
    public AssociateRoleDraftBuilder custom(Function<com.commercetools.api.models.type.CustomFieldsDraftBuilder, com.commercetools.api.models.type.CustomFieldsDraftBuilder> builder) {
    ...
    public AssociateRoleDraftBuilder withCustom(Function<com.commercetools.api.models.type.CustomFieldsDraftBuilder, com.commercetools.api.models.type.CustomFieldsDraft> builder) {
    ...
    public AssociateRoleDraftBuilder custom(@Nullable final com.commercetools.api.models.type.CustomFieldsDraft custom) {
        this.custom = custom;
        return this;
    }
