...
public class AssociateRoleDraftImpl implements AssociateRoleDraft, ModelBase {
     ...
     */
    @JsonCreator
    AssociateRoleDraftImpl(@JsonProperty("key") final String key, @JsonProperty("name") final String name, @JsonProperty("buyerAssignable") final Boolean buyerAssignable, @JsonProperty("permissions") final java.util.List<com.commercetools.api.models.associate_role.Permission> permissions, @JsonProperty("custom") final com.commercetools.api.models.type.CustomFieldsDraft custom) {
        this.key = key;
        this.name = name;
