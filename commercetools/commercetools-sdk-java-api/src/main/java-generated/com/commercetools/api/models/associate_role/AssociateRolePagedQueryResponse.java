...
public interface AssociateRolePagedQueryResponse
     ...
     */
    public static tools.jackson.core.type.TypeReference<AssociateRolePagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<AssociateRolePagedQueryResponse>() {
            @Override
