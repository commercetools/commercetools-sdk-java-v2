...
public class AssociateRoleReferenceImpl implements AssociateRoleReference, ModelBase {
     ...
     */
    @JsonCreator
    AssociateRoleReferenceImpl(@JsonProperty("id") final String id, @JsonProperty("obj") final com.commercetools.api.models.associate_role.AssociateRole obj) {
        this.id = id;
        this.obj = obj;
     ...
     */
    public AssociateRoleReferenceImpl() {
        this.typeId = ReferenceTypeId.findEnum("associate-role");
    }
    ...
    public void setObj(final com.commercetools.api.models.associate_role.AssociateRole obj){
        this.obj = obj;
    }
    ...
    public boolean equals(Object o) {
        ...
        AssociateRoleReferenceImpl that = (AssociateRoleReferenceImpl) o;
