...
public class AssociateRoleResourceIdentifierImpl implements AssociateRoleResourceIdentifier, ModelBase {
     ...
     */
    @JsonCreator
    AssociateRoleResourceIdentifierImpl(@JsonProperty("id") final String id, @JsonProperty("key") final String key) {
        this.id = id;
        this.key = key;
     ...
     */
    public AssociateRoleResourceIdentifierImpl() {
        this.typeId = ReferenceTypeId.findEnum("associate-role");
    }
    ...
    public boolean equals(Object o) {
        ...
        AssociateRoleResourceIdentifierImpl that = (AssociateRoleResourceIdentifierImpl) o;
