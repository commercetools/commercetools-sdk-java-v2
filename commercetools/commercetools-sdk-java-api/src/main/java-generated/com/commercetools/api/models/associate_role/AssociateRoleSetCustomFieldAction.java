...
import com.commercetools.api.models.associate_role.AssociateRoleSetCustomFieldActionImpl;
...
public interface AssociateRoleSetCustomFieldAction extends AssociateRoleUpdateAction {
     ...
     */
    @Nullable
    public static AssociateRoleSetCustomFieldAction deepCopy(@Nullable final AssociateRoleSetCustomFieldAction template) {
        if (template == null) {
            return null;
        }
        AssociateRoleSetCustomFieldActionImpl instance = new AssociateRoleSetCustomFieldActionImpl();
