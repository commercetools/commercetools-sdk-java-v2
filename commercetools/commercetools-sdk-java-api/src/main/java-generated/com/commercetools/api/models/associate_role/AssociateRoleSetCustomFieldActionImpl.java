...
public class AssociateRoleSetCustomFieldActionImpl implements AssociateRoleSetCustomFieldAction, ModelBase {
     ...
     */
    @JsonCreator
    AssociateRoleSetCustomFieldActionImpl(@JsonProperty("name") final String name,
     ...
     */
    public AssociateRoleSetCustomFieldActionImpl() {
        this.action = SET_CUSTOM_FIELD;
    }
    ...
    public boolean equals(Object o) {
        ...
        AssociateRoleSetCustomFieldActionImpl that = (AssociateRoleSetCustomFieldActionImpl) o;
    ...
    public AssociateRoleSetCustomFieldAction copyDeep() {
        return AssociateRoleSetCustomFieldAction.deepCopy(this);
    }
}
