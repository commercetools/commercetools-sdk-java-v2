...
public interface AssociateRoleSetCustomTypeAction extends AssociateRoleUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AssociateRoleSetCustomTypeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<AssociateRoleSetCustomTypeAction>() {
            @Override
