...
import com.commercetools.api.models.associate_role.AssociateRoleUpdateImpl;
...
public interface AssociateRoleUpdate  {
    ...
    public static AssociateRoleUpdate deepCopy(@Nullable final AssociateRoleUpdate template) {
        ...
        instance.setActions(Optional.ofNullable(template.getActions())
                .map(t -> t.stream().map(com.commercetools.api.models.associate_role.AssociateRoleUpdateAction::deepCopy).collect(Collectors.toList()))
                .orElse(null));
        return instance;
    }
