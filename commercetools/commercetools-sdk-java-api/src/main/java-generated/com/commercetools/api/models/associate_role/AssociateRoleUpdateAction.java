...
public interface AssociateRoleUpdateAction
     ...
     */
    public static tools.jackson.core.type.TypeReference<AssociateRoleUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<AssociateRoleUpdateAction>() {
            @Override
