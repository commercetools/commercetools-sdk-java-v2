...
public class AssociateRoleUpdateImpl implements AssociateRoleUpdate, ModelBase {
     ...
     */
    @JsonCreator
    AssociateRoleUpdateImpl(@JsonProperty("version") final Long version, @JsonProperty("actions") final java.util.List<com.commercetools.api.models.associate_role.AssociateRoleUpdateAction> actions) {
    ...
    public void setActions(final java.util.List<com.commercetools.api.models.associate_role.AssociateRoleUpdateAction> actions){
       this.actions = actions;
    }
