 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("addAttribute")
...
public interface AttributeGroupAddAttributeAction extends AttributeGroupUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AttributeGroupAddAttributeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<AttributeGroupAddAttributeAction>() {
            @Override
