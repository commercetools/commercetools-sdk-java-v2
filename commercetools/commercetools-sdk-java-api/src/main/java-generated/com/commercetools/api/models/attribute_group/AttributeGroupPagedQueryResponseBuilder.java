...
public class AttributeGroupPagedQueryResponseBuilder implements Builder<AttributeGroupPagedQueryResponse> {
    ...
    public AttributeGroupPagedQueryResponseBuilder results( final com.commercetools.api.models.attribute_group.AttributeGroup ...results) {
    ...
    public AttributeGroupPagedQueryResponseBuilder results( final java.util.List<com.commercetools.api.models.attribute_group.AttributeGroup> results) {
    ...
    public AttributeGroupPagedQueryResponseBuilder plusResults( final com.commercetools.api.models.attribute_group.AttributeGroup ...results) {
    ...
    public AttributeGroupPagedQueryResponseBuilder plusResults(Function<com.commercetools.api.models.attribute_group.AttributeGroupBuilder, com.commercetools.api.models.attribute_group.AttributeGroupBuilder> builder) {
        if (this.results == null) {
            this.results = new ArrayList<>();
        }
        this.results.add(builder.apply(com.commercetools.api.models.attribute_group.AttributeGroupBuilder.of()).build());
        return this;
    }
    ...
    public AttributeGroupPagedQueryResponseBuilder withResults(Function<com.commercetools.api.models.attribute_group.AttributeGroupBuilder, com.commercetools.api.models.attribute_group.AttributeGroupBuilder> builder) {
        this.results = new ArrayList<>();
        this.results.add(builder.apply(com.commercetools.api.models.attribute_group.AttributeGroupBuilder.of()).build());
        return this;
    }
    ...
    public AttributeGroupPagedQueryResponseBuilder addResults(Function<com.commercetools.api.models.attribute_group.AttributeGroupBuilder, com.commercetools.api.models.attribute_group.AttributeGroup> builder) {
    ...
    public AttributeGroupPagedQueryResponseBuilder setResults(Function<com.commercetools.api.models.attribute_group.AttributeGroupBuilder, com.commercetools.api.models.attribute_group.AttributeGroup> builder) {
