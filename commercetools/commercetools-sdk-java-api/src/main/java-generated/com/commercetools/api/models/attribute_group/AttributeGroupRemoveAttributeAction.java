...
public interface AttributeGroupRemoveAttributeAction extends AttributeGroupUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AttributeGroupRemoveAttributeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<AttributeGroupRemoveAttributeAction>() {
            @Override
