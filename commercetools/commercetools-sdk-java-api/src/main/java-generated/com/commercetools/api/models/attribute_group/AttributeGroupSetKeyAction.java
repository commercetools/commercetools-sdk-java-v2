...
public interface AttributeGroupSetKeyAction extends AttributeGroupUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AttributeGroupSetKeyAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<AttributeGroupSetKeyAction>() {
            @Override
