...
public class AttributeGroupUpdateImpl implements AttributeGroupUpdate, ModelBase {
     ...
     */
    @JsonCreator
    AttributeGroupUpdateImpl(@JsonProperty("version") final Long version, @JsonProperty("actions") final java.util.List<com.commercetools.api.models.attribute_group.AttributeGroupUpdateAction> actions) {
    ...
    public void setActions(final java.util.List<com.commercetools.api.models.attribute_group.AttributeGroupUpdateAction> actions){
       this.actions = actions;
    }
