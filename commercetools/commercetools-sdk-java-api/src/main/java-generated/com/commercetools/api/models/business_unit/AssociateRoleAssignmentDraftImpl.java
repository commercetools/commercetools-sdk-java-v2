...
public class AssociateRoleAssignmentDraftImpl implements AssociateRoleAssignmentDraft, ModelBase {
     ...
     */
    @JsonCreator
    AssociateRoleAssignmentDraftImpl(@JsonProperty("associateRole") final com.commercetools.api.models.associate_role.AssociateRoleResourceIdentifier associateRole, @JsonProperty("inheritance") final com.commercetools.api.models.business_unit.AssociateRoleInheritanceMode inheritance) {
