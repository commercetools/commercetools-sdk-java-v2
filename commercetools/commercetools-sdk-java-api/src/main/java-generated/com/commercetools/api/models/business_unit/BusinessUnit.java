...
@JsonTypeInfo(
    ...
    property = "unitType",
    defaultImpl = BusinessUnitImpl.class,
    visible = true
)
...
public interface BusinessUnit extends BaseResource, com.commercetools.api.models.WithKey {
    ...
    public static BusinessUnit deepCopy(@Nullable final BusinessUnit template) {
        ...
        if (template instanceof com.commercetools.api.models.business_unit.Company) {
            return com.commercetools.api.models.business_unit.Company.deepCopy((com.commercetools.api.models.business_unit.Company)template);
        }
        if (template instanceof com.commercetools.api.models.business_unit.Division) {
            return com.commercetools.api.models.business_unit.Division.deepCopy((com.commercetools.api.models.business_unit.Division)template);
        }
