...
public class BusinessUnitAddAddressActionImpl implements BusinessUnitAddAddressAction, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitAddAddressActionImpl(@JsonProperty("address") final com.commercetools.api.models.common.BaseAddress address) {
     ...
     */
    public BusinessUnitAddAddressActionImpl() {
        this.action =  ADD_ADDRESS;
    }
