...
public interface BusinessUnitAddCustomerGroupAssignmentAction extends BusinessUnitUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitAddCustomerGroupAssignmentAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitAddCustomerGroupAssignmentAction>() {
            @Override
