...
public interface BusinessUnitAddShippingAddressIdAction extends BusinessUnitUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitAddShippingAddressIdAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitAddShippingAddressIdAction>() {
            @Override
