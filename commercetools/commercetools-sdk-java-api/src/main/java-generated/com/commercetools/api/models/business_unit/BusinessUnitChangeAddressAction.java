...
public interface BusinessUnitChangeAddressAction extends BusinessUnitUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitChangeAddressAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitChangeAddressAction>() {
            @Override
