...
public class BusinessUnitChangeAddressActionImpl implements BusinessUnitChangeAddressAction, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitChangeAddressActionImpl(@JsonProperty("addressId") final String addressId, @JsonProperty("addressKey") final String addressKey, @JsonProperty("address") final com.commercetools.api.models.common.BaseAddress address) {
