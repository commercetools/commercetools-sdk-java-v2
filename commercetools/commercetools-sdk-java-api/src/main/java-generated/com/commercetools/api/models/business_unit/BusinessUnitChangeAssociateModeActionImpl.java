...
public class BusinessUnitChangeAssociateModeActionImpl implements BusinessUnitChangeAssociateModeAction, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitChangeAssociateModeActionImpl(@JsonProperty("associateMode") final com.commercetools.api.models.business_unit.BusinessUnitAssociateMode associateMode) {
