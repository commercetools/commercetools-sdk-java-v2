...
public interface BusinessUnitChangeNameAction extends BusinessUnitUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitChangeNameAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitChangeNameAction>() {
            @Override
