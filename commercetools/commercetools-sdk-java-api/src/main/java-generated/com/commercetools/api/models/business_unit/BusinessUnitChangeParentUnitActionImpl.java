...
public class BusinessUnitChangeParentUnitActionImpl implements BusinessUnitChangeParentUnitAction, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitChangeParentUnitActionImpl(@JsonProperty("parentUnit") final com.commercetools.api.models.business_unit.BusinessUnitResourceIdentifier parentUnit) {
