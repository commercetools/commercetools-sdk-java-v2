...
@JsonTypeInfo(
    ...
    property = "unitType",
    defaultImpl = BusinessUnitDraftImpl.class,
    visible = true
)
...
public interface BusinessUnitDraft extends com.commercetools.api.models.WithKey {
    ...
    public static BusinessUnitDraft deepCopy(@Nullable final BusinessUnitDraft template) {
        ...
        if (template instanceof com.commercetools.api.models.business_unit.CompanyDraft) {
            return com.commercetools.api.models.business_unit.CompanyDraft.deepCopy((com.commercetools.api.models.business_unit.CompanyDraft)template);
        }
        if (template instanceof com.commercetools.api.models.business_unit.DivisionDraft) {
            return com.commercetools.api.models.business_unit.DivisionDraft.deepCopy((com.commercetools.api.models.business_unit.DivisionDraft)template);
        }
