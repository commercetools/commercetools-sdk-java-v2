...
public class BusinessUnitPagedQueryResponseBuilder implements Builder<BusinessUnitPagedQueryResponse> {
    ...
    public BusinessUnitPagedQueryResponseBuilder results( final com.commercetools.api.models.business_unit.BusinessUnit ...results) {
    ...
    public BusinessUnitPagedQueryResponseBuilder results( final java.util.List<com.commercetools.api.models.business_unit.BusinessUnit> results) {
    ...
    public BusinessUnitPagedQueryResponseBuilder plusResults( final com.commercetools.api.models.business_unit.BusinessUnit ...results) {
    ...
    public BusinessUnitPagedQueryResponseBuilder plusResults(Function<com.commercetools.api.models.business_unit.BusinessUnitBuilder, Builder<? extends com.commercetools.api.models.business_unit.BusinessUnit>> builder) {
        if (this.results == null) {
            this.results = new ArrayList<>();
        }
    ...
    public BusinessUnitPagedQueryResponseBuilder withResults(Function<com.commercetools.api.models.business_unit.BusinessUnitBuilder, Builder<? extends com.commercetools.api.models.business_unit.BusinessUnit>> builder) {
        this.results = new ArrayList<>();
        this.results.add(builder.apply(com.commercetools.api.models.business_unit.BusinessUnitBuilder.of()).build());
        return this;
    }
