...
public class BusinessUnitPagedQueryResponseImpl implements BusinessUnitPagedQueryResponse, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitPagedQueryResponseImpl(@JsonProperty("limit") final Long limit, @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count, @JsonProperty("total") final Long total, @JsonProperty("results") final java.util.List<com.commercetools.api.models.business_unit.BusinessUnit> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
