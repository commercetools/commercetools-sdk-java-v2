...
public interface BusinessUnitRemoveAddressAction extends BusinessUnitUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitRemoveAddressAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitRemoveAddressAction>() {
            @Override
