...
public class BusinessUnitRemoveBillingAddressIdActionBuilder implements Builder<BusinessUnitRemoveBillingAddressIdAction> {
     ...
     * @return builder
     */
    public static BusinessUnitRemoveBillingAddressIdActionBuilder of(final BusinessUnitRemoveBillingAddressIdAction template) {
