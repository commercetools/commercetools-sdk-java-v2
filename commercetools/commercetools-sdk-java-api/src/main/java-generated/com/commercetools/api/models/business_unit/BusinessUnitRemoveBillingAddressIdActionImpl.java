...
public class BusinessUnitRemoveBillingAddressIdActionImpl implements BusinessUnitRemoveBillingAddressIdAction, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitRemoveBillingAddressIdActionImpl(@JsonProperty("addressId") final String addressId, @JsonProperty("addressKey") final String addressKey) {
