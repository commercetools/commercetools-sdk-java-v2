...
public interface BusinessUnitRemoveCustomerGroupAssignmentAction extends BusinessUnitUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitRemoveCustomerGroupAssignmentAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitRemoveCustomerGroupAssignmentAction>() {
            @Override
