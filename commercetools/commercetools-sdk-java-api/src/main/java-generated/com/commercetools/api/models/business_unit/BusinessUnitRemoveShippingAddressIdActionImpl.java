...
public class BusinessUnitRemoveShippingAddressIdActionImpl
        implements BusinessUnitRemoveShippingAddressIdAction, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitRemoveShippingAddressIdActionImpl(@JsonProperty("addressId") final String addressId,
