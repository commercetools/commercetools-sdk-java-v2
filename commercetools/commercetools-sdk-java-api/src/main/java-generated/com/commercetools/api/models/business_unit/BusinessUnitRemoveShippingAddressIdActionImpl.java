...
public class BusinessUnitRemoveShippingAddressIdActionImpl implements BusinessUnitRemoveShippingAddressIdAction, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitRemoveShippingAddressIdActionImpl(@JsonProperty("addressId") final String addressId, @JsonProperty("addressKey") final String addressKey) {
     ...
     */
    public BusinessUnitRemoveShippingAddressIdActionImpl() {
        this.action =  REMOVE_SHIPPING_ADDRESS_ID;
    }
    ...
    public boolean equals(Object o) {
        ...
        BusinessUnitRemoveShippingAddressIdActionImpl that = (BusinessUnitRemoveShippingAddressIdActionImpl) o;
