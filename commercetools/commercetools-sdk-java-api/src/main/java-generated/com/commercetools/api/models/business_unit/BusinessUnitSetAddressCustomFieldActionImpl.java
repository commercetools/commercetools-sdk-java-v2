...
public class BusinessUnitSetAddressCustomFieldActionImpl implements BusinessUnitSetAddressCustomFieldAction, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitSetAddressCustomFieldActionImpl(@JsonProperty("addressId") final String addressId, @JsonProperty("name") final String name, @JsonProperty("value") final java.lang.Object value) {
