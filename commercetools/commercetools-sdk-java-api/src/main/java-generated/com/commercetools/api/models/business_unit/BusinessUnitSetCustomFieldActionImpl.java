...
public class BusinessUnitSetCustomFieldActionImpl implements BusinessUnitSetCustomFieldAction, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitSetCustomFieldActionImpl(@JsonProperty("name") final String name, @JsonProperty("value") final java.lang.Object value) {
        this.name = name;
        this.value = value;
     ...
     */
    public BusinessUnitSetCustomFieldActionImpl() {
        this.action =  SET_CUSTOM_FIELD;
    }
