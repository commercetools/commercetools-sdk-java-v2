...
public interface BusinessUnitSetDefaultBillingAddressAction extends BusinessUnitUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitSetDefaultBillingAddressAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitSetDefaultBillingAddressAction>() {
            @Override
