...
public class BusinessUnitSetDefaultBillingAddressActionImpl
        implements BusinessUnitSetDefaultBillingAddressAction, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitSetDefaultBillingAddressActionImpl(@JsonProperty("addressId") final String addressId,
     ...
     */
    public BusinessUnitSetDefaultBillingAddressActionImpl() {
        this.action = SET_DEFAULT_BILLING_ADDRESS;
    }
    ...
    public boolean equals(Object o) {
        ...
        BusinessUnitSetDefaultBillingAddressActionImpl that = (BusinessUnitSetDefaultBillingAddressActionImpl) o;
    ...
    public BusinessUnitSetDefaultBillingAddressAction copyDeep() {
        return BusinessUnitSetDefaultBillingAddressAction.deepCopy(this);
    }
}
