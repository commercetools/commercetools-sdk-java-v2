...
public class BusinessUnitSetDefaultBillingAddressActionImpl implements BusinessUnitSetDefaultBillingAddressAction, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitSetDefaultBillingAddressActionImpl(@JsonProperty("addressId") final String addressId, @JsonProperty("addressKey") final String addressKey) {
