...
public class BusinessUnitSetDefaultShippingAddressActionImpl
        implements BusinessUnitSetDefaultShippingAddressAction, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitSetDefaultShippingAddressActionImpl(@JsonProperty("addressId") final String addressId,
     ...
     */
    public BusinessUnitSetDefaultShippingAddressActionImpl() {
        this.action = SET_DEFAULT_SHIPPING_ADDRESS;
    }
    ...
    public boolean equals(Object o) {
        ...
        BusinessUnitSetDefaultShippingAddressActionImpl that = (BusinessUnitSetDefaultShippingAddressActionImpl) o;
    ...
    public BusinessUnitSetDefaultShippingAddressAction copyDeep() {
        return BusinessUnitSetDefaultShippingAddressAction.deepCopy(this);
    }
}
