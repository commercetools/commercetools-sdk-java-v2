...
public class BusinessUnitSetDefaultShippingAddressActionImpl implements BusinessUnitSetDefaultShippingAddressAction, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitSetDefaultShippingAddressActionImpl(@JsonProperty("addressId") final String addressId, @JsonProperty("addressKey") final String addressKey) {
