...
public interface BusinessUnitUpdate extends
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitUpdate> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitUpdate>() {
            @Override
