...
public class BusinessUnitUpdateImpl implements BusinessUnitUpdate, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitUpdateImpl(@JsonProperty("version") final Long version, @JsonProperty("actions") final java.util.List<com.commercetools.api.models.business_unit.BusinessUnitUpdateAction> actions) {
    ...
    public void setActions(final java.util.List<com.commercetools.api.models.business_unit.BusinessUnitUpdateAction> actions){
       this.actions = actions;
    }
    ...
    public boolean equals(Object o) {
        ...
        BusinessUnitUpdateImpl that = (BusinessUnitUpdateImpl) o;
