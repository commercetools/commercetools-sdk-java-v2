...
public class MyBusinessUnitSetDefaultShippingAddressActionImpl
        implements MyBusinessUnitSetDefaultShippingAddressAction, ModelBase {
    ...
    @JsonCreator
    MyBusinessUnitSetDefaultShippingAddressActionImpl(@JsonProperty("addressId") final String addressId,
