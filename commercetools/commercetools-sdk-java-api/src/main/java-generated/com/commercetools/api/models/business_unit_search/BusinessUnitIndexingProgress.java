...
public interface BusinessUnitIndexingProgress {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitIndexingProgress> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitIndexingProgress>() {
            @Override
