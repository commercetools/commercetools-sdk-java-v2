...
public interface BusinessUnitSearchIndexingStatusResponse {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitSearchIndexingStatusResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitSearchIndexingStatusResponse>() {
            @Override
