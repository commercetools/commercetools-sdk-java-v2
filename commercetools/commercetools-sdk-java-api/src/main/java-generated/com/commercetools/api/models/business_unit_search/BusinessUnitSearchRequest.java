...
public interface BusinessUnitSearchRequest {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitSearchRequest> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitSearchRequest>() {
            @Override
