...
public interface BusinessUnitSearchResult {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitSearchResult> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitSearchResult>() {
            @Override
