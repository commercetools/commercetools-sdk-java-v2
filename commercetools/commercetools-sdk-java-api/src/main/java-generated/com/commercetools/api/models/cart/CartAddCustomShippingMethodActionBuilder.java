...
public class CartAddCustomShippingMethodActionBuilder implements Builder<CartAddCustomShippingMethodAction> {
    ...
    public CartAddCustomShippingMethodActionBuilder withShippingAddress(
    ...
    public CartAddCustomShippingMethodActionBuilder withShippingRate(
    ...
    public CartAddCustomShippingMethodActionBuilder withTaxCategory(
    ...
    public CartAddCustomShippingMethodActionBuilder withExternalTaxRate(
    ...
    public CartAddCustomShippingMethodActionBuilder addDeliveries(
    ...
    public CartAddCustomShippingMethodActionBuilder setDeliveries(
            Function<com.commercetools.api.models.order.DeliveryDraftBuilder, com.commercetools.api.models.order.DeliveryDraft> builder) {
    ...
    public CartAddCustomShippingMethodActionBuilder withCustom(
