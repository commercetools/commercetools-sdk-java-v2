...
public class CartChangeCustomLineItemPriceModeActionImpl implements CartChangeCustomLineItemPriceModeAction, ModelBase {
     ...
     */
    @JsonCreator
    CartChangeCustomLineItemPriceModeActionImpl(@JsonProperty("customLineItemId") final String customLineItemId, @JsonProperty("mode") final com.commercetools.api.models.cart.CustomLineItemPriceMode mode) {
