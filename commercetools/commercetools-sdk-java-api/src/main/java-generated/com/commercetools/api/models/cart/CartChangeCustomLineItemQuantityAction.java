...
public interface CartChangeCustomLineItemQuantityAction extends CartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartChangeCustomLineItemQuantityAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartChangeCustomLineItemQuantityAction>() {
            @Override
