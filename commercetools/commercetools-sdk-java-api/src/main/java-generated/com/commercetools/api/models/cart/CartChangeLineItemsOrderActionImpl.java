...
public class CartChangeLineItemsOrderActionImpl implements CartChangeLineItemsOrderAction, ModelBase {
     ...
     */
    @JsonCreator
    CartChangeLineItemsOrderActionImpl(@JsonProperty("lineItemOrder") final java.util.List<String> lineItemOrder) {
     ...
     */
    public CartChangeLineItemsOrderActionImpl() {
        this.action = CHANGE_LINE_ITEMS_ORDER;
    }
    ...
    public boolean equals(Object o) {
        ...
        CartChangeLineItemsOrderActionImpl that = (CartChangeLineItemsOrderActionImpl) o;
    ...
    public CartChangeLineItemsOrderAction copyDeep() {
        return CartChangeLineItemsOrderAction.deepCopy(this);
    }
}
