...
public interface CartChangeTaxCalculationModeAction extends CartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartChangeTaxCalculationModeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartChangeTaxCalculationModeAction>() {
            @Override
