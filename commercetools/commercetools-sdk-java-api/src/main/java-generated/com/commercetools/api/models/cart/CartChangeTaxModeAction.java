...
public interface CartChangeTaxModeAction extends CartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartChangeTaxModeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartChangeTaxModeAction>() {
            @Override
