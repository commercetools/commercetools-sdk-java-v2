...
public interface CartChangeTaxRoundingModeAction extends CartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartChangeTaxRoundingModeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartChangeTaxRoundingModeAction>() {
            @Override
