...
public interface CartDraft extends com.commercetools.api.models.CustomizableDraft<CartDraft>, com.commercetools.api.models.WithKey, io.vrap.rmf.base.client.Draft<CartDraft> {
    ...
    public static CartDraft deepCopy(@Nullable final CartDraft template) {
        ...
        instance.setLineItems(Optional.ofNullable(template.getLineItems())
                .map(t -> t.stream().map(com.commercetools.api.models.cart.LineItemDraft::deepCopy).collect(Collectors.toList()))
                .orElse(null));
        instance.setCustomLineItems(Optional.ofNullable(template.getCustomLineItems())
                .map(t -> t.stream().map(com.commercetools.api.models.cart.CustomLineItemDraft::deepCopy).collect(Collectors.toList()))
                .orElse(null));
        instance.setTaxMode(template.getTaxMode());
        instance.setExternalTaxRateForShippingMethod(com.commercetools.api.models.cart.ExternalTaxRateDraft.deepCopy(template.getExternalTaxRateForShippingMethod()));
        instance.setTaxRoundingMode(template.getTaxRoundingMode());
        instance.setTaxCalculationMode(template.getTaxCalculationMode());
        instance.setInventoryMode(template.getInventoryMode());
        ...
        instance.setCustomShipping(Optional.ofNullable(template.getCustomShipping())
                .map(t -> t.stream().map(com.commercetools.api.models.cart.CustomShippingDraft::deepCopy).collect(Collectors.toList()))
                .orElse(null));
        instance.setShipping(Optional.ofNullable(template.getShipping())
                .map(t -> t.stream().map(com.commercetools.api.models.cart.ShippingDraft::deepCopy).collect(Collectors.toList()))
                .orElse(null));
