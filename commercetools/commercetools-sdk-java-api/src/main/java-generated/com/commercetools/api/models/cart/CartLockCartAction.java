 ...
 *  <p>Produces the <a href="https://docs.commercetools.com/apis/ctp:api:type:CartLockedMessage" rel="nofollow">CartLocked</a> Message.</p>
 *
 * <hr>
...
public interface CartLockCartAction extends CartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartLockCartAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartLockCartAction>() {
            @Override
