...
public class CartPagedQueryResponseBuilder implements Builder<CartPagedQueryResponse> {
    ...
    public CartPagedQueryResponseBuilder plusResults(Function<com.commercetools.api.models.cart.CartBuilder, com.commercetools.api.models.cart.CartBuilder> builder) {
        if (this.results == null) {
            this.results = new ArrayList<>();
        }
    ...
    public CartPagedQueryResponseBuilder withResults(Function<com.commercetools.api.models.cart.CartBuilder, com.commercetools.api.models.cart.CartBuilder> builder) {
        this.results = new ArrayList<>();
        this.results.add(builder.apply(com.commercetools.api.models.cart.CartBuilder.of()).build());
        return this;
    }
    ...
    public CartPagedQueryResponseBuilder addResults(Function<com.commercetools.api.models.cart.CartBuilder, com.commercetools.api.models.cart.Cart> builder) {
    ...
    public CartPagedQueryResponseBuilder setResults(Function<com.commercetools.api.models.cart.CartBuilder, com.commercetools.api.models.cart.Cart> builder) {
