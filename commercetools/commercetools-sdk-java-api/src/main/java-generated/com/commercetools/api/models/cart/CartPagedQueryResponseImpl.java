...
public final class CartPagedQueryResponseImpl implements CartPagedQueryResponse {
    ...
    @JsonCreator
    CartPagedQueryResponseImpl(@JsonProperty("limit") final Long limit, @JsonProperty("count") final Long count, @JsonProperty("total") final Long total, @JsonProperty("offset") final Long offset, @JsonProperty("results") final java.util.List<com.commercetools.api.models.cart.Cart> results) {
        this.limit = limit;
        this.count = count;
        this.total = total;
        this.offset = offset;
