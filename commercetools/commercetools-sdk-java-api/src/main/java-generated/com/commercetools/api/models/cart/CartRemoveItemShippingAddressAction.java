...
public interface CartRemoveItemShippingAddressAction extends CartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartRemoveItemShippingAddressAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartRemoveItemShippingAddressAction>() {
            @Override
