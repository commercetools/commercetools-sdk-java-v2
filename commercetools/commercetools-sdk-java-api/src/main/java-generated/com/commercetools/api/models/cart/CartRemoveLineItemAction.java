...
public interface CartRemoveLineItemAction extends CartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartRemoveLineItemAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartRemoveLineItemAction>() {
            @Override
