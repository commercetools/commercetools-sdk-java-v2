...
public interface CartSetAnonymousIdAction extends CartUpdateAction {
    ...
    /**
     * factory method to create a shallow copy CartSetAnonymousIdAction
     ...
     */
    @Nullable
    public static CartSetAnonymousIdAction deepCopy(@Nullable final CartSetAnonymousIdAction template) {
        if (template == null) {
            return null;
        }
        CartSetAnonymousIdActionImpl instance = new CartSetAnonymousIdActionImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartSetAnonymousIdAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartSetAnonymousIdAction>() {
            @Override
