...
public interface CartSetBillingAddressCustomFieldAction extends CartUpdateAction {
     ...
     */
    @Nullable
    public static CartSetBillingAddressCustomFieldAction deepCopy(
            @Nullable final CartSetBillingAddressCustomFieldAction template) {
        if (template == null) {
            return null;
        }
        CartSetBillingAddressCustomFieldActionImpl instance = new CartSetBillingAddressCustomFieldActionImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartSetBillingAddressCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartSetBillingAddressCustomFieldAction>() {
            @Override
