...
public interface CartSetBillingAddressCustomTypeAction extends CartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartSetBillingAddressCustomTypeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartSetBillingAddressCustomTypeAction>() {
            @Override
