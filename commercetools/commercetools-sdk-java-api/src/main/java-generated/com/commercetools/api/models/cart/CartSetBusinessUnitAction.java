...
public interface CartSetBusinessUnitAction extends CartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartSetBusinessUnitAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartSetBusinessUnitAction>() {
            @Override
