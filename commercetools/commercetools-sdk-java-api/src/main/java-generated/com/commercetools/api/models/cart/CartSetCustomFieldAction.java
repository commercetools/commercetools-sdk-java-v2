...
public interface CartSetCustomFieldAction extends CartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartSetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartSetCustomFieldAction>() {
            @Override
