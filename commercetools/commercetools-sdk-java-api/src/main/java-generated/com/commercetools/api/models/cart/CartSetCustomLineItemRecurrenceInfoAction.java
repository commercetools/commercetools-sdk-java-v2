...
public interface CartSetCustomLineItemRecurrenceInfoAction extends CartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartSetCustomLineItemRecurrenceInfoAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartSetCustomLineItemRecurrenceInfoAction>() {
            @Override
