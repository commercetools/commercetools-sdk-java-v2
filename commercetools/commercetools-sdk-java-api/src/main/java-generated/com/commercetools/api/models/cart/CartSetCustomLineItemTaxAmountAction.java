...
public interface CartSetCustomLineItemTaxAmountAction extends CartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartSetCustomLineItemTaxAmountAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartSetCustomLineItemTaxAmountAction>() {
            @Override
