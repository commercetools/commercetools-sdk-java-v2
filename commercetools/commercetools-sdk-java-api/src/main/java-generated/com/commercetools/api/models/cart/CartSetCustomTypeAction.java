...
public interface CartSetCustomTypeAction extends CartUpdateAction {
    ...
    /**
     *  <p>Defines the <a href="https://docs.commercetools.com/apis/ctp:api:type:Type" rel="nofollow">Type</a> that extends the Cart with <a href="https://docs.commercetools.com/apis/ctp:api:type:CustomFields" rel="nofollow">Custom Fields</a>. If absent, any existing Type and Custom Fields are removed from the Cart.</p>
     * @return type
     */
    @Valid
    @JsonProperty("type")
    ...
    /**
     *  <p>Object containing the <a href="https://docs.commercetools.com/apis/ctp:api:type:CustomFields" rel="nofollow">Custom Fields</a> fields for the Cart.</p>
     ...
     */
    @Nullable
    public static CartSetCustomTypeAction deepCopy(@Nullable final CartSetCustomTypeAction template) {
        if (template == null) {
            return null;
        }
        CartSetCustomTypeActionImpl instance = new CartSetCustomTypeActionImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartSetCustomTypeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartSetCustomTypeAction>() {
            @Override
