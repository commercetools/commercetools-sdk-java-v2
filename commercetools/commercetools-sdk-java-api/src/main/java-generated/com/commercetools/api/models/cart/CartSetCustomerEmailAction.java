...
public interface CartSetCustomerEmailAction extends CartUpdateAction {
    ...
    public CartSetCustomerEmailAction copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartSetCustomerEmailAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartSetCustomerEmailAction>() {
            @Override
