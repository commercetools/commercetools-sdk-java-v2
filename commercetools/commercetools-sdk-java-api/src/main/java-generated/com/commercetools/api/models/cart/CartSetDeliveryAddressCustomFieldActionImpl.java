...
public final class CartSetDeliveryAddressCustomFieldActionImpl implements CartSetDeliveryAddressCustomFieldAction {
    ...
    @JsonCreator
    CartSetDeliveryAddressCustomFieldActionImpl(@JsonProperty("deliveryId") final String deliveryId, @JsonProperty("type") final com.commercetools.api.models.type.TypeResourceIdentifier type, @JsonProperty("fields") final com.commercetools.api.models.type.FieldContainer fields) {
