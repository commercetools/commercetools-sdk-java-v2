...
public class CartSetEstimatedDeliveryActionImpl implements CartSetEstimatedDeliveryAction, ModelBase {
     ...
     */
    @JsonCreator
    CartSetEstimatedDeliveryActionImpl(@JsonProperty("shippingKey") final String shippingKey,
     ...
     */
    public CartSetEstimatedDeliveryActionImpl() {
        this.action = SET_ESTIMATED_DELIVERY;
    }
    ...
    public boolean equals(Object o) {
        ...
        CartSetEstimatedDeliveryActionImpl that = (CartSetEstimatedDeliveryActionImpl) o;
    ...
    public CartSetEstimatedDeliveryAction copyDeep() {
        return CartSetEstimatedDeliveryAction.deepCopy(this);
    }
}
