...
public class CartSetItemShippingAddressCustomFieldActionImpl implements CartSetItemShippingAddressCustomFieldAction, ModelBase {
     ...
     */
    @JsonCreator
    CartSetItemShippingAddressCustomFieldActionImpl(@JsonProperty("addressKey") final String addressKey, @JsonProperty("name") final String name, @JsonProperty("value") final java.lang.Object value) {
