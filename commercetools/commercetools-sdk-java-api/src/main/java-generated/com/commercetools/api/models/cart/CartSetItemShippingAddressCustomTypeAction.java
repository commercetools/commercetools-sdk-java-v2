...
public interface CartSetItemShippingAddressCustomTypeAction extends CartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartSetItemShippingAddressCustomTypeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartSetItemShippingAddressCustomTypeAction>() {
            @Override
