...
public interface CartSetLineItemCustomFieldAction extends CartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartSetLineItemCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartSetLineItemCustomFieldAction>() {
            @Override
