...
public class CartSetLineItemCustomTypeActionBuilder implements Builder<CartSetLineItemCustomTypeAction> {
    ...
    public CartSetLineItemCustomTypeActionBuilder lineItemId(@Nullable final String lineItemId) {
    ...
    public CartSetLineItemCustomTypeActionBuilder lineItemKey(@Nullable final String lineItemKey) {
        this.lineItemKey = lineItemKey;
        return this;
    }

    /**
     *  <p>Defines the <a href="https://docs.commercetools.com/apis/ctp:api:type:Type" rel="nofollow">Type</a> that extends the Line Item with <a href="https://docs.commercetools.com/apis/ctp:api:type:CustomFields" rel="nofollow">Custom Fields</a>. If absent, any existing Type and Custom Fields are removed from the Line Item.</p>
    ...
    public CartSetLineItemCustomTypeActionBuilder withType(
    ...
    /**
     *  <p>Object containing the <a href="https://docs.commercetools.com/apis/ctp:api:type:CustomFields" rel="nofollow">Custom Fields</a> fields for the Line Item.</p>
    ...
    public CartSetLineItemCustomTypeActionBuilder withFields(
    ...
    public CartSetLineItemCustomTypeAction build() {
        return new CartSetLineItemCustomTypeActionImpl(lineItemId, lineItemKey, type, fields);
    }
