...
public interface CartSetLineItemShippingDetailsAction extends CartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartSetLineItemShippingDetailsAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartSetLineItemShippingDetailsAction>() {
            @Override
