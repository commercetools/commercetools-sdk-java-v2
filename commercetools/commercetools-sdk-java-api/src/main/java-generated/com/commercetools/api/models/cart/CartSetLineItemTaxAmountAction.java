...
public interface CartSetLineItemTaxAmountAction extends CartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartSetLineItemTaxAmountAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartSetLineItemTaxAmountAction>() {
            @Override
