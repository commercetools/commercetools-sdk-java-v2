...
public interface CartSetPurchaseOrderNumberAction extends CartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartSetPurchaseOrderNumberAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartSetPurchaseOrderNumberAction>() {
            @Override
