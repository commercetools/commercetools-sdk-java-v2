...
public interface CartSetShippingAddressCustomFieldAction extends CartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartSetShippingAddressCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartSetShippingAddressCustomFieldAction>() {
            @Override
