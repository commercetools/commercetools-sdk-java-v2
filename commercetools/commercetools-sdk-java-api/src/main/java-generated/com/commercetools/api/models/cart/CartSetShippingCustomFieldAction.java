...
public interface CartSetShippingCustomFieldAction extends CartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartSetShippingCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartSetShippingCustomFieldAction>() {
            @Override
