 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("Classification")
...
public interface ClassificationShippingRateInputDraft
     ...
     */
    public static tools.jackson.core.type.TypeReference<ClassificationShippingRateInputDraft> typeReference() {
        return new tools.jackson.core.type.TypeReference<ClassificationShippingRateInputDraft>() {
            @Override
