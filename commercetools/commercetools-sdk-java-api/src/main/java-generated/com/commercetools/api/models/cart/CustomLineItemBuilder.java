...
public final class CustomLineItemBuilder {
    ...
    public CustomLineItem build() {
        return new CustomLineItemImpl(id, name, money, taxedPrice, totalPrice, slug, quantity, state, taxCategory, taxRate, discountedPricePerQuantity, custom, shippingDetails);
    }
