...
public interface DiscountTypeCombination {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountTypeCombination> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountTypeCombination>() {
            @Override
