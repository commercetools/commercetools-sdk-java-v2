...
public class ItemShippingTargetImpl implements ItemShippingTarget, ModelBase {
     ...
     */
    @JsonCreator
    ItemShippingTargetImpl(@JsonProperty("addressKey") final String addressKey, @JsonProperty("quantity") final Long quantity, @JsonProperty("shippingMethodKey") final String shippingMethodKey) {
