...
public class MethodTaxedPriceImpl implements MethodTaxedPrice, ModelBase {
     ...
     */
    @JsonCreator
    MethodTaxedPriceImpl(@JsonProperty("shippingMethodKey") final String shippingMethodKey, @JsonProperty("taxedPrice") final com.commercetools.api.models.cart.TaxedItemPrice taxedPrice) {
