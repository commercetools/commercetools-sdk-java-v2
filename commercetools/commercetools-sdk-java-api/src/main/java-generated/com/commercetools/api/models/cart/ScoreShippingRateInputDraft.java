...
public interface ScoreShippingRateInputDraft
     ...
     */
    public static tools.jackson.core.type.TypeReference<ScoreShippingRateInputDraft> typeReference() {
        return new tools.jackson.core.type.TypeReference<ScoreShippingRateInputDraft>() {
            @Override
