...
public interface ShippingRateInputDraft {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingRateInputDraft> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingRateInputDraft>() {
            @Override
