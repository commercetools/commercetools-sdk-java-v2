...
public interface ShippingRateInputDraft  {
    ...
    public static ShippingRateInputDraft deepCopy(@Nullable final ShippingRateInputDraft template) {
        ...
        if (template instanceof com.commercetools.api.models.cart.ClassificationShippingRateInputDraft) {
            return com.commercetools.api.models.cart.ClassificationShippingRateInputDraft.deepCopy((com.commercetools.api.models.cart.ClassificationShippingRateInputDraft)template);
        }
        if (template instanceof com.commercetools.api.models.cart.ScoreShippingRateInputDraft) {
            return com.commercetools.api.models.cart.ScoreShippingRateInputDraft.deepCopy((com.commercetools.api.models.cart.ScoreShippingRateInputDraft)template);
        }
