...
public interface CartDiscountChangeNameAction extends CartDiscountUpdateAction {
    ...
    /**
     * factory method to create a shallow copy CartDiscountChangeNameAction
    ...
    public CartDiscountChangeNameAction copyDeep();
     ...
     */
    @Nullable
    public static CartDiscountChangeNameAction deepCopy(@Nullable final CartDiscountChangeNameAction template) {
        if (template == null) {
            return null;
        }
        CartDiscountChangeNameActionImpl instance = new CartDiscountChangeNameActionImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartDiscountChangeNameAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartDiscountChangeNameAction>() {
            @Override
