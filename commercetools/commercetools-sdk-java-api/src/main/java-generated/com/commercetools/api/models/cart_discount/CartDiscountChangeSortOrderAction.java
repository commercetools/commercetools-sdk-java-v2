...
public interface CartDiscountChangeSortOrderAction extends CartDiscountUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartDiscountChangeSortOrderAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartDiscountChangeSortOrderAction>() {
            @Override
