...
public interface CartDiscountChangeStackingModeAction extends CartDiscountUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartDiscountChangeStackingModeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartDiscountChangeStackingModeAction>() {
            @Override
