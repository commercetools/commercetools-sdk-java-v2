...
public interface CartDiscountPagedQueryResponse extends com.commercetools.api.models.ResourcePagedQueryResponse<CartDiscount> {
    ...
    public static CartDiscountPagedQueryResponse deepCopy(@Nullable final CartDiscountPagedQueryResponse template) {
        ...
        instance.setResults(Optional.ofNullable(template.getResults())
                .map(t -> t.stream().map(com.commercetools.api.models.cart_discount.CartDiscount::deepCopy).collect(Collectors.toList()))
                .orElse(null));
        return instance;
    }
