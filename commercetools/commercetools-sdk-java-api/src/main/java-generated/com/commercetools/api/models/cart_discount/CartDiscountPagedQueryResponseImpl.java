...
/**
 *  <p><span>PagedQueryResult</span> with <code>results</code> containing an array of <a href="https://docs.commercetools.com/apis/ctp:api:type:CartDiscount" rel="nofollow">CartDiscount</a>.</p>
 */
...
public class CartDiscountPagedQueryResponseImpl implements CartDiscountPagedQueryResponse, ModelBase {
    ...
    CartDiscountPagedQueryResponseImpl(@JsonProperty("limit") final Long limit,
            ...
            @JsonProperty("results") final java.util.List<com.commercetools.api.models.cart_discount.CartDiscount> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
