...
public class CartDiscountPagedQueryResponseImpl implements CartDiscountPagedQueryResponse, ModelBase {
     ...
     */
    @JsonCreator
    CartDiscountPagedQueryResponseImpl(@JsonProperty("limit") final Long limit, @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count, @JsonProperty("total") final Long total, @JsonProperty("results") final java.util.List<com.commercetools.api.models.cart_discount.CartDiscount> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
    ...
    public boolean equals(Object o) {
        ...
        CartDiscountPagedQueryResponseImpl that = (CartDiscountPagedQueryResponseImpl) o;
