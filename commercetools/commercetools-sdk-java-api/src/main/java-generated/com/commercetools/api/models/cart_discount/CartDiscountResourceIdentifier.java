...
/**
 *  <p>ResourceIdentifier to a CartDiscount. Either <code>id</code> or <code>key</code> is required. If both are set, an InvalidJsonInput error is returned.</p>
 *
 * <hr>
...
public interface CartDiscountResourceIdentifier
    ...
    /**
     *  <p>Unique identifier of the referenced CartDiscount. Required if <code>key</code> is absent.</p>
     * @return id
     */
    ...
    /**
     *  <p>User-defined unique identifier of the referenced CartDiscount. Required if <code>id</code> is absent.</p>
     * @return key
     */
