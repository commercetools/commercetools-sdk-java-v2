...
public interface CartDiscountResourceIdentifier
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartDiscountResourceIdentifier> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartDiscountResourceIdentifier>() {
            @Override
