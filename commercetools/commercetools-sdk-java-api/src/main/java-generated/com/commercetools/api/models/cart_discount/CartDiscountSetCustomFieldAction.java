...
public interface CartDiscountSetCustomFieldAction extends CartDiscountUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartDiscountSetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartDiscountSetCustomFieldAction>() {
            @Override
