...
public interface CartDiscountSetDiscountGroupAction extends CartDiscountUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartDiscountSetDiscountGroupAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartDiscountSetDiscountGroupAction>() {
            @Override
