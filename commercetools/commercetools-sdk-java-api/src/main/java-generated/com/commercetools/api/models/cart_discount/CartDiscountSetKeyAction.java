...
public interface CartDiscountSetKeyAction extends CartDiscountUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartDiscountSetKeyAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartDiscountSetKeyAction>() {
            @Override
