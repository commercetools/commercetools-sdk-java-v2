...
public interface CartDiscountSetRecurringOrderScopeAction extends CartDiscountUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartDiscountSetRecurringOrderScopeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartDiscountSetRecurringOrderScopeAction>() {
            @Override
