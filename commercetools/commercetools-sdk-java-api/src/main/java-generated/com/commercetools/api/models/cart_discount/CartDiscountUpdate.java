...
public interface CartDiscountUpdate extends com.commercetools.api.models.ResourceUpdate<CartDiscountUpdate, CartDiscountUpdateAction, CartDiscountUpdateBuilder> {
    ...
    /**
     * factory method to create a shallow copy CartDiscountUpdate
     ...
     */
    @Nullable
    public static CartDiscountUpdate deepCopy(@Nullable final CartDiscountUpdate template) {
        if (template == null) {
            return null;
        }
        CartDiscountUpdateImpl instance = new CartDiscountUpdateImpl();
        ...
        instance.setActions(Optional.ofNullable(template.getActions())
                .map(t -> t.stream().map(com.commercetools.api.models.cart_discount.CartDiscountUpdateAction::deepCopy).collect(Collectors.toList()))
                .orElse(null));
        return instance;
    }
