...
public interface CartDiscountUpdate extends
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartDiscountUpdate> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartDiscountUpdate>() {
            @Override
