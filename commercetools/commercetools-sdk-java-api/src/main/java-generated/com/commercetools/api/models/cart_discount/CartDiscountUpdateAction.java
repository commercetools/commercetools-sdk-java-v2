...
public interface CartDiscountUpdateAction
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartDiscountUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartDiscountUpdateAction>() {
            @Override
