...
public class CartDiscountUpdateImpl implements CartDiscountUpdate, ModelBase {
     ...
     */
    @JsonCreator
    CartDiscountUpdateImpl(@JsonProperty("version") final Long version,
            @JsonProperty("actions") final java.util.List<com.commercetools.api.models.cart_discount.CartDiscountUpdateAction> actions) {
