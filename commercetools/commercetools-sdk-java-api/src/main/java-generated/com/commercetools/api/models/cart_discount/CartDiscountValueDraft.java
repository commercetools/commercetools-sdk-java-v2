...
public interface CartDiscountValueDraft {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartDiscountValueDraft> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartDiscountValueDraft>() {
            @Override
