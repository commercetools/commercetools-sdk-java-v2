...
public interface CartDiscountValueFixed extends CartDiscountValue, CartDiscountValueFixedMixin {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartDiscountValueFixed> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartDiscountValueFixed>() {
            @Override
