...
public final class CartDiscountValueFixedDraftImpl implements CartDiscountValueFixedDraft {
    ...
    @JsonCreator
    CartDiscountValueFixedDraftImpl(@JsonProperty("money") final java.util.List<com.commercetools.api.models.common.Money> money) {
        this.money = money;
        this.type =  FIXED;
    }
