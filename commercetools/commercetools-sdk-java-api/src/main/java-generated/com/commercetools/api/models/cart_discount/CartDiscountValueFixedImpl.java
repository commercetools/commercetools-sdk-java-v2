...
public final class CartDiscountValueFixedImpl implements CartDiscountValueFixed {
    ...
    @JsonCreator
    CartDiscountValueFixedImpl(@JsonProperty("money") final java.util.List<com.commercetools.api.models.common.TypedMoney> money) {
        this.money = money;
        this.type =  FIXED;
    }
