...
public interface CountOnLineItemUnits extends PatternComponent {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CountOnLineItemUnits> typeReference() {
        return new tools.jackson.core.type.TypeReference<CountOnLineItemUnits>() {
            @Override
