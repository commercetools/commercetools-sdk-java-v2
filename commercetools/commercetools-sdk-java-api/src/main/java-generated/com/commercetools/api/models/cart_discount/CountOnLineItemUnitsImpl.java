...
public class CountOnLineItemUnitsImpl implements CountOnLineItemUnits, ModelBase {
     ...
     */
    @JsonCreator
    CountOnLineItemUnitsImpl(@JsonProperty("predicate") final String predicate,
        ...
        this.type = COUNT_ON_LINE_ITEM_UNITS;
    }
    ...
    public boolean equals(Object o) {
        ...
        CountOnLineItemUnitsImpl that = (CountOnLineItemUnitsImpl) o;
