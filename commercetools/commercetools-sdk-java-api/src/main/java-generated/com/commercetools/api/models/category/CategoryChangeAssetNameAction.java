...
public interface CategoryChangeAssetNameAction extends CategoryUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CategoryChangeAssetNameAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CategoryChangeAssetNameAction>() {
            @Override
