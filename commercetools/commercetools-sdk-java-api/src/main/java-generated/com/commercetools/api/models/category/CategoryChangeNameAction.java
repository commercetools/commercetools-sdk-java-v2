...
public interface CategoryChangeNameAction extends CategoryUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CategoryChangeNameAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CategoryChangeNameAction>() {
            @Override
