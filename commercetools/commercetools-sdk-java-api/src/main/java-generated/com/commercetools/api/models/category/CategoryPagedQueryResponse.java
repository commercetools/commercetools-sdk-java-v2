...
public interface CategoryPagedQueryResponse extends com.commercetools.api.models.ResourcePagedQueryResponse<Category> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CategoryPagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<CategoryPagedQueryResponse>() {
            @Override
