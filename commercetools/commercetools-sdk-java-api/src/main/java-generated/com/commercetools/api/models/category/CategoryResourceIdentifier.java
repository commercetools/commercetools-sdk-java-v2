...
public interface CategoryResourceIdentifier
     ...
     */
    public static tools.jackson.core.type.TypeReference<CategoryResourceIdentifier> typeReference() {
        return new tools.jackson.core.type.TypeReference<CategoryResourceIdentifier>() {
            @Override
