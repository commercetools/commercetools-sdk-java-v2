...
public interface CategorySetAssetCustomFieldAction extends CategoryUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CategorySetAssetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CategorySetAssetCustomFieldAction>() {
            @Override
