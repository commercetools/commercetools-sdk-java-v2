...
public interface CategorySetAssetCustomTypeAction extends CategoryUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CategorySetAssetCustomTypeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CategorySetAssetCustomTypeAction>() {
            @Override
