...
public interface CategorySetAssetSourcesAction extends CategoryUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CategorySetAssetSourcesAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CategorySetAssetSourcesAction>() {
            @Override
