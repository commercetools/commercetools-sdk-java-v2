...
public interface CategorySetCustomFieldAction extends CategoryUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CategorySetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CategorySetCustomFieldAction>() {
            @Override
