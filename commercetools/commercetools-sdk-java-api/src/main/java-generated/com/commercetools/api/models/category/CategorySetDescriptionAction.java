...
public interface CategorySetDescriptionAction extends CategoryUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CategorySetDescriptionAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CategorySetDescriptionAction>() {
            @Override
