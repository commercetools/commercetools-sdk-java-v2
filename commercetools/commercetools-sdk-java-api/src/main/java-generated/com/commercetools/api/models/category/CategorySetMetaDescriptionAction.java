...
public interface CategorySetMetaDescriptionAction extends CategoryUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CategorySetMetaDescriptionAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CategorySetMetaDescriptionAction>() {
            @Override
