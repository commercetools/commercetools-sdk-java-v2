...
public interface ChannelPagedQueryResponse extends com.commercetools.api.models.ResourcePagedQueryResponse<Channel> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChannelPagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChannelPagedQueryResponse>() {
            @Override
