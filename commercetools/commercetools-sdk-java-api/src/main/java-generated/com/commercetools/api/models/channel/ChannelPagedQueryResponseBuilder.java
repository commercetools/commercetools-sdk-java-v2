...
public class ChannelPagedQueryResponseBuilder implements Builder<ChannelPagedQueryResponse> {
    ...
    public ChannelPagedQueryResponseBuilder plusResults(Function<com.commercetools.api.models.channel.ChannelBuilder, com.commercetools.api.models.channel.ChannelBuilder> builder) {
        if (this.results == null) {
            this.results = new ArrayList<>();
        }
    ...
    public ChannelPagedQueryResponseBuilder withResults(Function<com.commercetools.api.models.channel.ChannelBuilder, com.commercetools.api.models.channel.ChannelBuilder> builder) {
        this.results = new ArrayList<>();
        this.results.add(builder.apply(com.commercetools.api.models.channel.ChannelBuilder.of()).build());
        return this;
    }
    ...
    public ChannelPagedQueryResponseBuilder addResults(Function<com.commercetools.api.models.channel.ChannelBuilder, com.commercetools.api.models.channel.Channel> builder) {
    ...
    public ChannelPagedQueryResponseBuilder setResults(Function<com.commercetools.api.models.channel.ChannelBuilder, com.commercetools.api.models.channel.Channel> builder) {
