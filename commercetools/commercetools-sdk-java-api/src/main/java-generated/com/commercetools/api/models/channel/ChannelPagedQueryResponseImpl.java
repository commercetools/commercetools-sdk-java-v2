...
public class ChannelPagedQueryResponseImpl implements ChannelPagedQueryResponse, ModelBase {
     ...
     */
    @JsonCreator
    ChannelPagedQueryResponseImpl(@JsonProperty("limit") final Long limit, @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count, @JsonProperty("total") final Long total, @JsonProperty("results") final java.util.List<com.commercetools.api.models.channel.Channel> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
    ...
    public void setResults(final com.commercetools.api.models.channel.Channel ...results){
