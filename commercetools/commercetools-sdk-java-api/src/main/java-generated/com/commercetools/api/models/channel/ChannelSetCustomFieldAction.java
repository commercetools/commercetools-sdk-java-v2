...
public interface ChannelSetCustomFieldAction extends ChannelUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChannelSetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChannelSetCustomFieldAction>() {
            @Override
