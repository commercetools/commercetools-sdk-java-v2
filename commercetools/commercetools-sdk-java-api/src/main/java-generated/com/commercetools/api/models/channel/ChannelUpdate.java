...
public interface ChannelUpdate
    ...
    /**
     *  <p>Expected version of the Channel on which the changes should be applied. If the expected version does not match the actual version, a <a href="https://docs.commercetools.com/apis/ctp:api:type:ConcurrentModificationError" rel="nofollow">ConcurrentModification</a> error will be returned.</p>
     * @return version
     */
    @NotNull
    ...
    public static ChannelUpdate deepCopy(@Nullable final ChannelUpdate template) {
        ...
        instance.setActions(Optional.ofNullable(template.getActions())
                .map(t -> t.stream()
                        .map(com.commercetools.api.models.channel.ChannelUpdateAction::deepCopy)
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChannelUpdate> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChannelUpdate>() {
            @Override
