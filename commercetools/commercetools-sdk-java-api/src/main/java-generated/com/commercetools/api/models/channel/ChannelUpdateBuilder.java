...
public class ChannelUpdateBuilder implements Builder<ChannelUpdate> {
    ...
    public ChannelUpdateBuilder plusActions(Function<com.commercetools.api.models.channel.ChannelUpdateActionBuilder, Builder<? extends com.commercetools.api.models.channel.ChannelUpdateAction>> builder) {
        if (this.actions == null) {
            this.actions = new ArrayList<>();
        }
    ...
    public ChannelUpdateBuilder withActions(Function<com.commercetools.api.models.channel.ChannelUpdateActionBuilder, Builder<? extends com.commercetools.api.models.channel.ChannelUpdateAction>> builder) {
        this.actions = new ArrayList<>();
        this.actions.add(builder.apply(com.commercetools.api.models.channel.ChannelUpdateActionBuilder.of()).build());
        return this;
    }
