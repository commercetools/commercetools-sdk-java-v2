...
public class BaseAddressBuilder implements Builder<BaseAddress> {
    ...
    public BaseAddress build() {
        ...
        return new BaseAddressImpl(id, key, country, title, salutation, firstName, lastName, streetName, streetNumber, additionalStreetInfo, postalCode, city, region, state, company, department, building, apartment, pOBox, phone, mobile, email, fax, additionalAddressInfo, externalId);
    }
