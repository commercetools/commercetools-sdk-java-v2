...
public interface CentPrecisionMoney extends TypedMoney {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CentPrecisionMoney> typeReference() {
        return new tools.jackson.core.type.TypeReference<CentPrecisionMoney>() {
            @Override
