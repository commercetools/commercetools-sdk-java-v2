...
public interface PagedQueryResponse extends com.commercetools.api.models.ResourcePagedQueryResponse<BaseResource> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<PagedQueryResponse>() {
            @Override
