...
public class PagedQueryResponseImpl implements PagedQueryResponse, ModelBase {
     ...
     */
    @JsonCreator
    PagedQueryResponseImpl(@JsonProperty("limit") final Long limit, @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count, @JsonProperty("total") final Long total, @JsonProperty("results") final java.util.List<com.commercetools.api.models.common.BaseResource> results, @JsonProperty("meta") final java.lang.Object meta) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
