...
public interface CustomObjectPagedQueryResponse
     ...
     */
    @Nullable
    public static CustomObjectPagedQueryResponse deepCopy(@Nullable final CustomObjectPagedQueryResponse template) {
        if (template == null) {
            return null;
        }
        CustomObjectPagedQueryResponseImpl instance = new CustomObjectPagedQueryResponseImpl();
    ...
    /**
     * builder factory method for CustomObjectPagedQueryResponse
     * @return builder
     */
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomObjectPagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomObjectPagedQueryResponse>() {
            @Override
