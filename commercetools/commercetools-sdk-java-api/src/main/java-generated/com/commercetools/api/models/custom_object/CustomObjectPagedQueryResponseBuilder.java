...
public class CustomObjectPagedQueryResponseBuilder implements Builder<CustomObjectPagedQueryResponse> {
    ...
    public CustomObjectPagedQueryResponseBuilder results( final java.util.List<com.commercetools.api.models.custom_object.CustomObject> results) {
    ...
    public CustomObjectPagedQueryResponseBuilder plusResults( final com.commercetools.api.models.custom_object.CustomObject ...results) {
    ...
    public CustomObjectPagedQueryResponseBuilder plusResults(Function<com.commercetools.api.models.custom_object.CustomObjectBuilder, com.commercetools.api.models.custom_object.CustomObjectBuilder> builder) {
        if (this.results == null) {
            this.results = new ArrayList<>();
        }
    ...
    public CustomObjectPagedQueryResponseBuilder withResults(Function<com.commercetools.api.models.custom_object.CustomObjectBuilder, com.commercetools.api.models.custom_object.CustomObjectBuilder> builder) {
        this.results = new ArrayList<>();
        this.results.add(builder.apply(com.commercetools.api.models.custom_object.CustomObjectBuilder.of()).build());
        return this;
    }
    ...
    public CustomObjectPagedQueryResponseBuilder addResults(Function<com.commercetools.api.models.custom_object.CustomObjectBuilder, com.commercetools.api.models.custom_object.CustomObject> builder) {
    ...
    public CustomObjectPagedQueryResponseBuilder setResults(Function<com.commercetools.api.models.custom_object.CustomObjectBuilder, com.commercetools.api.models.custom_object.CustomObject> builder) {
