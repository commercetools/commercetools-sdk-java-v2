...
public interface CustomerAddStoreAction extends CustomerUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerAddStoreAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerAddStoreAction>() {
            @Override
