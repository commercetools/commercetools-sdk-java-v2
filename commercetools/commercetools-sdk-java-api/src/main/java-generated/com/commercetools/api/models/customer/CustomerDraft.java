...
public interface CustomerDraft extends com.commercetools.api.models.CustomizableDraft<CustomerDraft>, com.commercetools.api.models.WithKey, io.vrap.rmf.base.client.Draft<CustomerDraft> {
     ...
     */
    @Nullable
    public static CustomerDraft deepCopy(@Nullable final CustomerDraft template) {
        if (template == null) {
            return null;
        }
        CustomerDraftImpl instance = new CustomerDraftImpl();
