...
public interface CustomerEmailVerify {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerEmailVerify> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerEmailVerify>() {
            @Override
