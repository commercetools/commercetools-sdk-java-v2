...
public interface CustomerGroupAssignmentDraft extends io.vrap.rmf.base.client.Draft<CustomerGroupAssignmentDraft> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerGroupAssignmentDraft> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerGroupAssignmentDraft>() {
            @Override
