...
public interface CustomerPagedQueryResponse extends com.commercetools.api.models.ResourcePagedQueryResponse<Customer> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerPagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerPagedQueryResponse>() {
            @Override
