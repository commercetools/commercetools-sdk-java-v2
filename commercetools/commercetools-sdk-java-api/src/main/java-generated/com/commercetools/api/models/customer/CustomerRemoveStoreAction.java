...
public interface CustomerRemoveStoreAction extends CustomerUpdateAction {
     ...
     */
    @Nullable
    public static CustomerRemoveStoreAction deepCopy(@Nullable final CustomerRemoveStoreAction template) {
        if (template == null) {
            return null;
        }
        CustomerRemoveStoreActionImpl instance = new CustomerRemoveStoreActionImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerRemoveStoreAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerRemoveStoreAction>() {
            @Override
