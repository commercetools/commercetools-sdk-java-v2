...
public interface CustomerResetPassword {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerResetPassword> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerResetPassword>() {
            @Override
