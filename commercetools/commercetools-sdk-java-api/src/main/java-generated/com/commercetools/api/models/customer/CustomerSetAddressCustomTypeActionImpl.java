...
public class CustomerSetAddressCustomTypeActionImpl implements CustomerSetAddressCustomTypeAction, ModelBase {
     ...
     */
    @JsonCreator
    CustomerSetAddressCustomTypeActionImpl(@JsonProperty("addressId") final String addressId, @JsonProperty("type") final com.commercetools.api.models.type.TypeResourceIdentifier type, @JsonProperty("fields") final com.commercetools.api.models.type.FieldContainer fields) {
