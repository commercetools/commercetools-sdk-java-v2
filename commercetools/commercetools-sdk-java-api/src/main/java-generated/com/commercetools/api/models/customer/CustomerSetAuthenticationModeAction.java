...
public interface CustomerSetAuthenticationModeAction extends CustomerUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerSetAuthenticationModeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerSetAuthenticationModeAction>() {
            @Override
