...
public class CustomerSetCustomFieldActionImpl implements CustomerSetCustomFieldAction {
    ...
    @JsonCreator
    CustomerSetCustomFieldActionImpl(@JsonProperty("name") final String name,
