...
public interface CustomerSetCustomerGroupAssignmentsAction extends CustomerUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerSetCustomerGroupAssignmentsAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerSetCustomerGroupAssignmentsAction>() {
            @Override
