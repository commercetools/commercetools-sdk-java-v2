...
public interface CustomerSetCustomerNumberAction extends CustomerUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerSetCustomerNumberAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerSetCustomerNumberAction>() {
            @Override
