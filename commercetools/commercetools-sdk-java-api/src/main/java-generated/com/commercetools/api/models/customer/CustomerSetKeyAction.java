...
public interface CustomerSetKeyAction extends CustomerUpdateAction {
     ...
     */
    @Nullable
    public static CustomerSetKeyAction deepCopy(@Nullable final CustomerSetKeyAction template) {
        if (template == null) {
            return null;
        }
        CustomerSetKeyActionImpl instance = new CustomerSetKeyActionImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerSetKeyAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerSetKeyAction>() {
            @Override
