...
public interface CustomerSetLastNameAction extends CustomerUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerSetLastNameAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerSetLastNameAction>() {
            @Override
