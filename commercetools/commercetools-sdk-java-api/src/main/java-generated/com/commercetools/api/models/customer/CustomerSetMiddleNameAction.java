...
public interface CustomerSetMiddleNameAction extends CustomerUpdateAction {
    ...
    public CustomerSetMiddleNameAction copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerSetMiddleNameAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerSetMiddleNameAction>() {
            @Override
