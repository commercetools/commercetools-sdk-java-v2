...
/**
 *  <p>Setting the title of the Customer produces the <a href="https://docs.commercetools.com/apis/ctp:api:type:CustomerTitleSetMessage" rel="nofollow">CustomerTitleSet</a> Message.</p>
 *
 * <hr>
...
public interface CustomerSetTitleAction extends CustomerUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerSetTitleAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerSetTitleAction>() {
            @Override
