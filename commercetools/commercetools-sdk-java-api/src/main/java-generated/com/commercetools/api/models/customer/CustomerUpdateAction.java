...
public interface CustomerUpdateAction extends com.commercetools.api.models.ResourceUpdateAction<CustomerUpdateAction> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerUpdateAction>() {
            @Override
