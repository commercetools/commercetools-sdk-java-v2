...
public class CustomerUpdateImpl implements CustomerUpdate, ModelBase {
     ...
     */
    @JsonCreator
    CustomerUpdateImpl(@JsonProperty("version") final Long version,
            @JsonProperty("actions") final java.util.List<com.commercetools.api.models.customer.CustomerUpdateAction> actions) {
    ...
    /**
     *  <p>Expected version of the Customer on which the changes should be applied. If the expected version does not match the actual version, a <a href="https://docs.commercetools.com/apis/ctp:api:type:ConcurrentModificationError" rel="nofollow">ConcurrentModification</a> error will be returned.</p>
     */
    ...
    public boolean equals(Object o) {
        ...
        CustomerUpdateImpl that = (CustomerUpdateImpl) o;
