...
public interface MyCustomerEmailVerify {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyCustomerEmailVerify> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyCustomerEmailVerify>() {
            @Override
