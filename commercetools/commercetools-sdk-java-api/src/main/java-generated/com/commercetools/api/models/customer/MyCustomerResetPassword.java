...
public interface MyCustomerResetPassword {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyCustomerResetPassword> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyCustomerResetPassword>() {
            @Override
