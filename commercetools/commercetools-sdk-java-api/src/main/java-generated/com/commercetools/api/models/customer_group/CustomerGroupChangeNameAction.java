...
public interface CustomerGroupChangeNameAction extends CustomerGroupUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerGroupChangeNameAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerGroupChangeNameAction>() {
            @Override
