...
/**
 *  <p><span>PagedQueryResult</span> with <code>results</code> containing an array of <a href="https://docs.commercetools.com/apis/ctp:api:type:CustomerGroup" rel="nofollow">CustomerGroup</a>.</p>
 *
 * <hr>
...
public interface CustomerGroupPagedQueryResponse
    ...
    /**
     *  <p><a href="https://docs.commercetools.com/apis/ctp:api:type:CustomerGroup" rel="nofollow">CustomerGroups</a> matching the query.</p>
     * @return results
     */
    @NotNull
    @Valid
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerGroupPagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerGroupPagedQueryResponse>() {
            @Override
