...
public class CustomerGroupPagedQueryResponseImpl implements CustomerGroupPagedQueryResponse, ModelBase {
     ...
     */
    @JsonCreator
    CustomerGroupPagedQueryResponseImpl(@JsonProperty("limit") final Long limit, @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count, @JsonProperty("total") final Long total, @JsonProperty("results") final java.util.List<com.commercetools.api.models.customer_group.CustomerGroup> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
