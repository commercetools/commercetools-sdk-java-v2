...
public interface CustomerGroupReference extends Reference, com.commercetools.api.models.Identifiable<CustomerGroup>,
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerGroupReference> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerGroupReference>() {
            @Override
