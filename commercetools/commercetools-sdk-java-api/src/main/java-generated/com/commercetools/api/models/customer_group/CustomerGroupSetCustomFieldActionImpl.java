...
public class CustomerGroupSetCustomFieldActionImpl implements CustomerGroupSetCustomFieldAction, ModelBase {
     ...
     */
    @JsonCreator
    CustomerGroupSetCustomFieldActionImpl(@JsonProperty("name") final String name, @JsonProperty("value") final java.lang.Object value) {
        this.name = name;
        this.value = value;
