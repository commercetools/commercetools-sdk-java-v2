...
public interface CustomerGroupSetKeyAction extends CustomerGroupUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerGroupSetKeyAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerGroupSetKeyAction>() {
            @Override
