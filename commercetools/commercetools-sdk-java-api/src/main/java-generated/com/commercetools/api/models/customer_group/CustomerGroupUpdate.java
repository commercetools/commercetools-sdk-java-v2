...
public interface CustomerGroupUpdate extends
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerGroupUpdate> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerGroupUpdate>() {
            @Override
