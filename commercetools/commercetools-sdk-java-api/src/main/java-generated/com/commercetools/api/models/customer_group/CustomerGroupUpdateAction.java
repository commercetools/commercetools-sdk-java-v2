...
public interface CustomerGroupUpdateAction extends com.commercetools.api.models.ResourceUpdateAction<CustomerGroupUpdateAction> {
    ...
    public static CustomerGroupUpdateAction deepCopy(@Nullable final CustomerGroupUpdateAction template) {
        ...
        if (template instanceof com.commercetools.api.models.customer_group.CustomerGroupChangeNameAction) {
            return com.commercetools.api.models.customer_group.CustomerGroupChangeNameAction.deepCopy((com.commercetools.api.models.customer_group.CustomerGroupChangeNameAction)template);
        }
        if (template instanceof com.commercetools.api.models.customer_group.CustomerGroupSetCustomFieldAction) {
            return com.commercetools.api.models.customer_group.CustomerGroupSetCustomFieldAction.deepCopy((com.commercetools.api.models.customer_group.CustomerGroupSetCustomFieldAction)template);
        }
        if (template instanceof com.commercetools.api.models.customer_group.CustomerGroupSetCustomTypeAction) {
            return com.commercetools.api.models.customer_group.CustomerGroupSetCustomTypeAction.deepCopy((com.commercetools.api.models.customer_group.CustomerGroupSetCustomTypeAction)template);
        }
        if (template instanceof com.commercetools.api.models.customer_group.CustomerGroupSetKeyAction) {
            return com.commercetools.api.models.customer_group.CustomerGroupSetKeyAction.deepCopy((com.commercetools.api.models.customer_group.CustomerGroupSetKeyAction)template);
        }
