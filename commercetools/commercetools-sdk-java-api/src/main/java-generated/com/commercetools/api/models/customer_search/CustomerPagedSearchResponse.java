...
public interface CustomerPagedSearchResponse {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerPagedSearchResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerPagedSearchResponse>() {
            @Override
