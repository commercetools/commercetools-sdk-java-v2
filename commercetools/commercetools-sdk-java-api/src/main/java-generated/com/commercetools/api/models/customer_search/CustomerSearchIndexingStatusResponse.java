...
public interface CustomerSearchIndexingStatusResponse {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerSearchIndexingStatusResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerSearchIndexingStatusResponse>() {
            @Override
