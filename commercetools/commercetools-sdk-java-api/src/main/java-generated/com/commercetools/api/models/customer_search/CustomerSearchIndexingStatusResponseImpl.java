...
public class CustomerSearchIndexingStatusResponseImpl implements CustomerSearchIndexingStatusResponse, ModelBase {
     ...
     */
    @JsonCreator
    CustomerSearchIndexingStatusResponseImpl(
            @JsonProperty("status") final com.commercetools.api.models.project.CustomerIndexingStatus status,
            @JsonProperty("states") final com.commercetools.api.models.customer_search.CustomerIndexingProgress states,
    ...
    public void setStatus(final com.commercetools.api.models.project.CustomerIndexingStatus status) {
        this.status = status;
    }

    public void setStates(final com.commercetools.api.models.customer_search.CustomerIndexingProgress states) {
        this.states = states;
    }
    ...
    public boolean equals(Object o) {
        ...
        CustomerSearchIndexingStatusResponseImpl that = (CustomerSearchIndexingStatusResponseImpl) o;
