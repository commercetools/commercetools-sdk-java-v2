...
public interface CustomerSearchRequest {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerSearchRequest> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerSearchRequest>() {
            @Override
