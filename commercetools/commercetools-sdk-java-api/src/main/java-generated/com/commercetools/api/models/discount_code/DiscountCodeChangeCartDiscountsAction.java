 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("changeCartDiscounts")
...
public interface DiscountCodeChangeCartDiscountsAction extends DiscountCodeUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountCodeChangeCartDiscountsAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountCodeChangeCartDiscountsAction>() {
            @Override
