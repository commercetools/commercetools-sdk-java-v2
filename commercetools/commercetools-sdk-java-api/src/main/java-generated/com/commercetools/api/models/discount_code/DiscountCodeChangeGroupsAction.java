...
public interface DiscountCodeChangeGroupsAction extends DiscountCodeUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountCodeChangeGroupsAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountCodeChangeGroupsAction>() {
            @Override
