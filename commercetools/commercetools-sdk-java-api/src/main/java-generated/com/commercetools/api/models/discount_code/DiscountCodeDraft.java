...
public interface DiscountCodeDraft extends com.commercetools.api.models.CustomizableDraft<DiscountCodeDraft>, io.vrap.rmf.base.client.Draft<DiscountCodeDraft> {
    ...
    public static DiscountCodeDraft deepCopy(@Nullable final DiscountCodeDraft template) {
        ...
        instance.setCartDiscounts(Optional.ofNullable(template.getCartDiscounts())
                .map(t -> t.stream().map(com.commercetools.api.models.cart_discount.CartDiscountResourceIdentifier::deepCopy).collect(Collectors.toList()))
                .orElse(null));
        instance.setCartPredicate(template.getCartPredicate());
        instance.setIsActive(template.getIsActive());
        instance.setMaxApplications(template.getMaxApplications());
