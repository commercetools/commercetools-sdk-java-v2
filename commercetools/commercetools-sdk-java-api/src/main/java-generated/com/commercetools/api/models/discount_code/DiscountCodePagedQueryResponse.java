...
public interface DiscountCodePagedQueryResponse
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountCodePagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountCodePagedQueryResponse>() {
            @Override
