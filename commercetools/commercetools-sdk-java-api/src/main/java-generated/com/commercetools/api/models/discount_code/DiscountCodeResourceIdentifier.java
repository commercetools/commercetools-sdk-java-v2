...
public interface DiscountCodeResourceIdentifier
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountCodeResourceIdentifier> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountCodeResourceIdentifier>() {
            @Override
