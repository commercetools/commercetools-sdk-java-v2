...
public interface DiscountCodeSetCustomFieldAction extends DiscountCodeUpdateAction {
    ...
    public DiscountCodeSetCustomFieldAction copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountCodeSetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountCodeSetCustomFieldAction>() {
            @Override
