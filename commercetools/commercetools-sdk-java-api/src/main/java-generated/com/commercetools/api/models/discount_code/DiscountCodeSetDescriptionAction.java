...
public interface DiscountCodeSetDescriptionAction extends DiscountCodeUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountCodeSetDescriptionAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountCodeSetDescriptionAction>() {
            @Override
