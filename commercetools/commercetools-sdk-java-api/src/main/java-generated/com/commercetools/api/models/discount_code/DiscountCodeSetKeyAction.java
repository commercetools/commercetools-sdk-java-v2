...
public interface DiscountCodeSetKeyAction extends DiscountCodeUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountCodeSetKeyAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountCodeSetKeyAction>() {
            @Override
