...
public interface DiscountCodeUpdateAction
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountCodeUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountCodeUpdateAction>() {
            @Override
