...
public class DiscountGroupPagedQueryResponseImpl implements DiscountGroupPagedQueryResponse, ModelBase {
     ...
     */
    @JsonCreator
    DiscountGroupPagedQueryResponseImpl(@JsonProperty("limit") final Long limit,
            @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count,
            @JsonProperty("total") final Long total,
            @JsonProperty("results") final java.util.List<com.commercetools.api.models.discount_group.DiscountGroup> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
     ...
     */
    public DiscountGroupPagedQueryResponseImpl() {
    }
    ...
    public void setResults(final com.commercetools.api.models.discount_group.DiscountGroup... results) {
        this.results = new ArrayList<>(Arrays.asList(results));
    }

    public void setResults(final java.util.List<com.commercetools.api.models.discount_group.DiscountGroup> results) {
        this.results = results;
    }
    ...
    public boolean equals(Object o) {
        ...
        DiscountGroupPagedQueryResponseImpl that = (DiscountGroupPagedQueryResponseImpl) o;
    ...
    public DiscountGroupPagedQueryResponse copyDeep() {
        return DiscountGroupPagedQueryResponse.deepCopy(this);
    }
}
