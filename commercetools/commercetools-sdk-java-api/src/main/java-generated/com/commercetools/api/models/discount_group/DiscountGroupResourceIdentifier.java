...
public interface DiscountGroupResourceIdentifier extends ResourceIdentifier {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountGroupResourceIdentifier> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountGroupResourceIdentifier>() {
            @Override
