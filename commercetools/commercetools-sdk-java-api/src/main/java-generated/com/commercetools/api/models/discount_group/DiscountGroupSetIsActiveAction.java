...
public interface DiscountGroupSetIsActiveAction extends DiscountGroupUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountGroupSetIsActiveAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountGroupSetIsActiveAction>() {
            @Override
