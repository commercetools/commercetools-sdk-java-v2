...
public interface DiscountGroupSetKeyAction extends DiscountGroupUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountGroupSetKeyAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountGroupSetKeyAction>() {
            @Override
