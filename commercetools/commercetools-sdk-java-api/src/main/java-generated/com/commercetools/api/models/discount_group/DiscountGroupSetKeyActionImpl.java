...
public class DiscountGroupSetKeyActionImpl implements DiscountGroupSetKeyAction, ModelBase {
     ...
     */
    @JsonCreator
    DiscountGroupSetKeyActionImpl(@JsonProperty("key") final String key) {
        this.key = key;
        this.action = SET_KEY;
    }
     ...
     */
    public DiscountGroupSetKeyActionImpl() {
        this.action = SET_KEY;
    }
    ...
    public boolean equals(Object o) {
        ...
        DiscountGroupSetKeyActionImpl that = (DiscountGroupSetKeyActionImpl) o;
    ...
    public DiscountGroupSetKeyAction copyDeep() {
        return DiscountGroupSetKeyAction.deepCopy(this);
    }
}
