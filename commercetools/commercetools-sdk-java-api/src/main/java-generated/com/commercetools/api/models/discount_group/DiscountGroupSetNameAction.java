...
public interface DiscountGroupSetNameAction extends DiscountGroupUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountGroupSetNameAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountGroupSetNameAction>() {
            @Override
