...
public interface DiscountGroupSetSortOrderAction extends DiscountGroupUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountGroupSetSortOrderAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountGroupSetSortOrderAction>() {
            @Override
