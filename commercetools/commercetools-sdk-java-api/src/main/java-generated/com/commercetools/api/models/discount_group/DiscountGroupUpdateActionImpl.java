...
public class DiscountGroupUpdateActionImpl implements DiscountGroupUpdateAction, ModelBase {
     ...
     */
    @JsonCreator
    DiscountGroupUpdateActionImpl(@JsonProperty("action") final String action) {
        this.action = action;
    }
     ...
     */
    public DiscountGroupUpdateActionImpl() {
    }
    ...
    public boolean equals(Object o) {
        ...
        DiscountGroupUpdateActionImpl that = (DiscountGroupUpdateActionImpl) o;
    ...
    public DiscountGroupUpdateAction copyDeep() {
        return DiscountGroupUpdateAction.deepCopy(this);
    }
}
