...
public interface AnonymousIdAlreadyInUseError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AnonymousIdAlreadyInUseError> typeReference() {
        return new tools.jackson.core.type.TypeReference<AnonymousIdAlreadyInUseError>() {
            @Override
