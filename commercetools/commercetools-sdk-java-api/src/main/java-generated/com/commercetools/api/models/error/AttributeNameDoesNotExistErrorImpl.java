...
public class AttributeNameDoesNotExistErrorImpl implements AttributeNameDoesNotExistError, ModelBase {
     ...
     */
    @JsonCreator
    AttributeNameDoesNotExistErrorImpl(@JsonProperty("message") final String message, @JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("invalidAttributeName") final String invalidAttributeName) {
