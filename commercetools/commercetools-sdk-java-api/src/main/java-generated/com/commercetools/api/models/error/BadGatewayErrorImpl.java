...
public class BadGatewayErrorImpl implements BadGatewayError, ModelBase {
     ...
     */
    @JsonCreator
    BadGatewayErrorImpl(@JsonProperty("message") final String message, @JsonProperty("values") final Map<String, java.lang.Object> values) {
    ...
    public boolean equals(Object o) {
        ...
        BadGatewayErrorImpl that = (BadGatewayErrorImpl) o;
