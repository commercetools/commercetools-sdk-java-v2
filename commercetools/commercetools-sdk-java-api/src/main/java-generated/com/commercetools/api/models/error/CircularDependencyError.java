...
public interface CircularDependencyError extends ErrorObject {
     ...
     */
    public static com.fasterxml.jackson.core.type.TypeReference<CircularDependencyError> typeReference() {
        return new com.fasterxml.jackson.core.type.TypeReference<CircularDependencyError>() {
            @Override
