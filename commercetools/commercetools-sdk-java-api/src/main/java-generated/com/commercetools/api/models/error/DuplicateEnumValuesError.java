...
public interface DuplicateEnumValuesError extends ErrorObject {
    ...
    public DuplicateEnumValuesError copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<DuplicateEnumValuesError> typeReference() {
        return new tools.jackson.core.type.TypeReference<DuplicateEnumValuesError>() {
            @Override
