...
public class DuplicateEnumValuesErrorImpl implements DuplicateEnumValuesError, ModelBase {
     ...
     */
    @JsonCreator
    DuplicateEnumValuesErrorImpl(@JsonProperty("message") final String message, @JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("duplicates") final java.util.List<String> duplicates) {
