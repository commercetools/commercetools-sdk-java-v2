...
public interface DuplicateFieldWithConflictingResourceError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DuplicateFieldWithConflictingResourceError> typeReference() {
        return new tools.jackson.core.type.TypeReference<DuplicateFieldWithConflictingResourceError>() {
            @Override
