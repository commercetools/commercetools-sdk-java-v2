...
public interface DuplicatePriceKeyError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DuplicatePriceKeyError> typeReference() {
        return new tools.jackson.core.type.TypeReference<DuplicatePriceKeyError>() {
            @Override
