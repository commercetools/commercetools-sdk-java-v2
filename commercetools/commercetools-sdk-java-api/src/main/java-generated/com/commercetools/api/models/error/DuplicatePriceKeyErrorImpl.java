...
public class DuplicatePriceKeyErrorImpl implements DuplicatePriceKeyError, ModelBase {
     ...
     */
    @JsonCreator
    DuplicatePriceKeyErrorImpl(@JsonProperty("message") final String message, @JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("conflictingPrice") final com.commercetools.api.models.common.Price conflictingPrice) {
