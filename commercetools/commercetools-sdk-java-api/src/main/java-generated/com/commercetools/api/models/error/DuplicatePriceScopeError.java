...
public interface DuplicatePriceScopeError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DuplicatePriceScopeError> typeReference() {
        return new tools.jackson.core.type.TypeReference<DuplicatePriceScopeError>() {
            @Override
