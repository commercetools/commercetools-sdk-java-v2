...
public interface DuplicateStandalonePriceScopeError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DuplicateStandalonePriceScopeError> typeReference() {
        return new tools.jackson.core.type.TypeReference<DuplicateStandalonePriceScopeError>() {
            @Override
