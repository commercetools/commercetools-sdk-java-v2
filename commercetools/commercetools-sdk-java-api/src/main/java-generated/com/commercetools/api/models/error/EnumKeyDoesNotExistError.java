...
public interface EnumKeyDoesNotExistError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<EnumKeyDoesNotExistError> typeReference() {
        return new tools.jackson.core.type.TypeReference<EnumKeyDoesNotExistError>() {
            @Override
