...
public class ExactLockConflictErrorImpl implements ExactLockConflictError, ModelBase {
     ...
     */
    @JsonCreator
    ExactLockConflictErrorImpl(@JsonProperty("message") final String message,
     ...
     */
    public ExactLockConflictErrorImpl() {
        this.code = EXACT_LOCK_CONFLICT;
    }
    ...
    public boolean equals(Object o) {
        ...
        ExactLockConflictErrorImpl that = (ExactLockConflictErrorImpl) o;
    ...
    public ExactLockConflictError copyDeep() {
        return ExactLockConflictError.deepCopy(this);
    }
}
