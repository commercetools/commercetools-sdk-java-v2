...
public class ExtensionBadResponseErrorBuilder implements Builder<ExtensionBadResponseError> {
    ...
    public ExtensionBadResponseErrorBuilder localizedMessage(Function<com.commercetools.api.models.common.LocalizedStringBuilder, com.commercetools.api.models.common.LocalizedStringBuilder> builder) {
    ...
    public ExtensionBadResponseErrorBuilder withLocalizedMessage(Function<com.commercetools.api.models.common.LocalizedStringBuilder, com.commercetools.api.models.common.LocalizedString> builder) {
    ...
    public ExtensionBadResponseErrorBuilder extensionErrors( final com.commercetools.api.models.error.ExtensionError ...extensionErrors) {
    ...
    public ExtensionBadResponseErrorBuilder extensionErrors( final java.util.List<com.commercetools.api.models.error.ExtensionError> extensionErrors) {
    ...
    public ExtensionBadResponseErrorBuilder plusExtensionErrors( final com.commercetools.api.models.error.ExtensionError ...extensionErrors) {
    ...
    public ExtensionBadResponseErrorBuilder plusExtensionErrors(Function<com.commercetools.api.models.error.ExtensionErrorBuilder, com.commercetools.api.models.error.ExtensionErrorBuilder> builder) {
        if (this.extensionErrors == null) {
            this.extensionErrors = new ArrayList<>();
        }
    ...
    public ExtensionBadResponseErrorBuilder withExtensionErrors(Function<com.commercetools.api.models.error.ExtensionErrorBuilder, com.commercetools.api.models.error.ExtensionErrorBuilder> builder) {
        this.extensionErrors = new ArrayList<>();
        this.extensionErrors.add(builder.apply(com.commercetools.api.models.error.ExtensionErrorBuilder.of()).build());
        return this;
    }
    ...
    public ExtensionBadResponseErrorBuilder addExtensionErrors(Function<com.commercetools.api.models.error.ExtensionErrorBuilder, com.commercetools.api.models.error.ExtensionError> builder) {
    ...
    public ExtensionBadResponseErrorBuilder setExtensionErrors(Function<com.commercetools.api.models.error.ExtensionErrorBuilder, com.commercetools.api.models.error.ExtensionError> builder) {
    ...
    public ExtensionBadResponseError build() {
        ...
        return new ExtensionBadResponseErrorImpl(message, values, localizedMessage, extensionExtraInfo, extensionErrors, extensionBody, extensionStatusCode, extensionId, extensionKey);
    }
