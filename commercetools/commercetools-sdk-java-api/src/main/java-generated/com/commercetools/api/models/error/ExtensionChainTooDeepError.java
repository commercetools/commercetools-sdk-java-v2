...
public interface ExtensionChainTooDeepError extends ErrorObject {
     ...
     */
    public static com.fasterxml.jackson.core.type.TypeReference<ExtensionChainTooDeepError> typeReference() {
        return new com.fasterxml.jackson.core.type.TypeReference<ExtensionChainTooDeepError>() {
            @Override
