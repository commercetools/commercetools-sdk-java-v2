...
public interface ExtensionDependencyExistsError extends ErrorObject {
     ...
     */
    public static com.fasterxml.jackson.core.type.TypeReference<ExtensionDependencyExistsError> typeReference() {
        return new com.fasterxml.jackson.core.type.TypeReference<ExtensionDependencyExistsError>() {
            @Override
