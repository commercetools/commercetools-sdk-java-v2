...
public class ExtensionErrorImpl implements ExtensionError, ModelBase {
     ...
     */
    @JsonCreator
    ExtensionErrorImpl(@JsonProperty("code") final String code, @JsonProperty("message") final String message, @JsonProperty("extensionId") final String extensionId, @JsonProperty("extensionKey") final String extensionKey, @JsonProperty("values") final Map<String, java.lang.Object> values) {
        this.code = code;
