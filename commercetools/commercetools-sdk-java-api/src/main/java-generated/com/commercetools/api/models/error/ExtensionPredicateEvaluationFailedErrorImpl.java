...
public class ExtensionPredicateEvaluationFailedErrorImpl implements ExtensionPredicateEvaluationFailedError, ModelBase {
     ...
     */
    @JsonCreator
    ExtensionPredicateEvaluationFailedErrorImpl(@JsonProperty("message") final String message, @JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("errorByExtension") final com.commercetools.api.models.error.ErrorByExtension errorByExtension) {
