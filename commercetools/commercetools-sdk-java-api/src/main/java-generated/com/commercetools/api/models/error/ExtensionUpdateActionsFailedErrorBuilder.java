...
public class ExtensionUpdateActionsFailedErrorBuilder implements Builder<ExtensionUpdateActionsFailedError> {
    ...
    public ExtensionUpdateActionsFailedErrorBuilder localizedMessage(Function<com.commercetools.api.models.common.LocalizedStringBuilder, com.commercetools.api.models.common.LocalizedStringBuilder> builder) {
    ...
    public ExtensionUpdateActionsFailedErrorBuilder withLocalizedMessage(Function<com.commercetools.api.models.common.LocalizedStringBuilder, com.commercetools.api.models.common.LocalizedString> builder) {
    ...
    public ExtensionUpdateActionsFailedErrorBuilder extensionErrors( final com.commercetools.api.models.error.ExtensionError ...extensionErrors) {
    ...
    public ExtensionUpdateActionsFailedErrorBuilder extensionErrors( final java.util.List<com.commercetools.api.models.error.ExtensionError> extensionErrors) {
    ...
    public ExtensionUpdateActionsFailedErrorBuilder plusExtensionErrors( final com.commercetools.api.models.error.ExtensionError ...extensionErrors) {
    ...
    public ExtensionUpdateActionsFailedErrorBuilder plusExtensionErrors(Function<com.commercetools.api.models.error.ExtensionErrorBuilder, com.commercetools.api.models.error.ExtensionErrorBuilder> builder) {
        if (this.extensionErrors == null) {
            this.extensionErrors = new ArrayList<>();
        }
    ...
    public ExtensionUpdateActionsFailedErrorBuilder withExtensionErrors(Function<com.commercetools.api.models.error.ExtensionErrorBuilder, com.commercetools.api.models.error.ExtensionErrorBuilder> builder) {
        this.extensionErrors = new ArrayList<>();
        this.extensionErrors.add(builder.apply(com.commercetools.api.models.error.ExtensionErrorBuilder.of()).build());
        return this;
    }
    ...
    public ExtensionUpdateActionsFailedErrorBuilder addExtensionErrors(Function<com.commercetools.api.models.error.ExtensionErrorBuilder, com.commercetools.api.models.error.ExtensionError> builder) {
    ...
    public ExtensionUpdateActionsFailedErrorBuilder setExtensionErrors(Function<com.commercetools.api.models.error.ExtensionErrorBuilder, com.commercetools.api.models.error.ExtensionError> builder) {
    ...
    public ExtensionUpdateActionsFailedError build() {
        ...
        Objects.requireNonNull(extensionErrors, ExtensionUpdateActionsFailedError.class + ": extensionErrors is missing");
        return new ExtensionUpdateActionsFailedErrorImpl(message, values, localizedMessage, extensionExtraInfo, extensionErrors);
    }
