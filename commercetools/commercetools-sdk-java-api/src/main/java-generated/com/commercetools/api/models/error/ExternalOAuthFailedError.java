 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ExternalOAuthFailed")
...
public interface ExternalOAuthFailedError extends ErrorObject {
     ...
     */
    @Nullable
    public static ExternalOAuthFailedError deepCopy(@Nullable final ExternalOAuthFailedError template) {
        if (template == null) {
            return null;
        }
        ExternalOAuthFailedErrorImpl instance = new ExternalOAuthFailedErrorImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<ExternalOAuthFailedError> typeReference() {
        return new tools.jackson.core.type.TypeReference<ExternalOAuthFailedError>() {
            @Override
