...
public interface FeatureRemovedError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<FeatureRemovedError> typeReference() {
        return new tools.jackson.core.type.TypeReference<FeatureRemovedError>() {
            @Override
