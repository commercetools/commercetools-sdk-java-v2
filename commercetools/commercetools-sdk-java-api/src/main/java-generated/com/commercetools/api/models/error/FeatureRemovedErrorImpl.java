...
public class FeatureRemovedErrorImpl implements FeatureRemovedError, ModelBase {
     ...
     */
    @JsonCreator
    FeatureRemovedErrorImpl(@JsonProperty("message") final String message, @JsonProperty("values") final Map<String, java.lang.Object> values) {
    ...
    public boolean equals(Object o) {
        ...
        FeatureRemovedErrorImpl that = (FeatureRemovedErrorImpl) o;
