 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("AnonymousIdAlreadyInUse")
...
public interface GraphQLAnonymousIdAlreadyInUseError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLAnonymousIdAlreadyInUseError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLAnonymousIdAlreadyInUseError>() {
            @Override
