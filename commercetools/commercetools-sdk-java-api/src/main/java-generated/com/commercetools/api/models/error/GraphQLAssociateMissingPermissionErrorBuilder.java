...
public class GraphQLAssociateMissingPermissionErrorBuilder implements Builder<GraphQLAssociateMissingPermissionError> {
    ...
    public GraphQLAssociateMissingPermissionErrorBuilder associate(
    ...
    public GraphQLAssociateMissingPermissionErrorBuilder withAssociate(
    ...
    public GraphQLAssociateMissingPermissionErrorBuilder businessUnit(
    ...
    public GraphQLAssociateMissingPermissionErrorBuilder withBusinessUnit(
    ...
    public GraphQLAssociateMissingPermissionErrorBuilder associateOnBehalf(
            Function<com.commercetools.api.models.customer.CustomerResourceIdentifierBuilder, com.commercetools.api.models.customer.CustomerResourceIdentifierBuilder> builder) {
    ...
    public GraphQLAssociateMissingPermissionErrorBuilder withAssociateOnBehalf(
            Function<com.commercetools.api.models.customer.CustomerResourceIdentifierBuilder, com.commercetools.api.models.customer.CustomerResourceIdentifier> builder) {
        this.associateOnBehalf = builder
                .apply(com.commercetools.api.models.customer.CustomerResourceIdentifierBuilder.of());
        return this;
    ...
    public GraphQLAssociateMissingPermissionErrorBuilder permissions(
    ...
    public GraphQLAssociateMissingPermissionErrorBuilder plusPermissions(
            final com.commercetools.api.models.associate_role.Permission... permissions) {
    ...
    public GraphQLAssociateMissingPermissionError build() {
        ...
        Objects.requireNonNull(businessUnit,
            GraphQLAssociateMissingPermissionError.class + ": businessUnit is missing");
        Objects.requireNonNull(permissions, GraphQLAssociateMissingPermissionError.class + ": permissions is missing");
        return new GraphQLAssociateMissingPermissionErrorImpl(values, associate, businessUnit, associateOnBehalf,
            permissions);
    }
