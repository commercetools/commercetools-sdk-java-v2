...
public class GraphQLAssociateMissingPermissionErrorImpl implements GraphQLAssociateMissingPermissionError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLAssociateMissingPermissionErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("associate") final com.commercetools.api.models.customer.CustomerResourceIdentifier associate, @JsonProperty("businessUnit") final com.commercetools.api.models.business_unit.BusinessUnitResourceIdentifier businessUnit, @JsonProperty("associateOnBehalf") final com.commercetools.api.models.customer.CustomerResourceIdentifier associateOnBehalf, @JsonProperty("permissions") final java.util.List<com.commercetools.api.models.associate_role.Permission> permissions) {
        this.values = values;
