...
public class GraphQLAttributeDefinitionAlreadyExistsErrorBuilder
    ...
    public GraphQLAttributeDefinitionAlreadyExistsErrorBuilder addValue(final String key,
    ...
    public GraphQLAttributeDefinitionAlreadyExistsErrorBuilder conflictingProductTypeId(
    ...
    public GraphQLAttributeDefinitionAlreadyExistsErrorBuilder conflictingProductTypeName(
    ...
    public GraphQLAttributeDefinitionAlreadyExistsErrorBuilder conflictingAttributeName(
    ...
    public GraphQLAttributeDefinitionAlreadyExistsError build() {
        Objects.requireNonNull(conflictingProductTypeId,
            GraphQLAttributeDefinitionAlreadyExistsError.class + ": conflictingProductTypeId is missing");
        Objects.requireNonNull(conflictingProductTypeName,
            GraphQLAttributeDefinitionAlreadyExistsError.class + ": conflictingProductTypeName is missing");
        Objects.requireNonNull(conflictingAttributeName,
            GraphQLAttributeDefinitionAlreadyExistsError.class + ": conflictingAttributeName is missing");
        return new GraphQLAttributeDefinitionAlreadyExistsErrorImpl(values, conflictingProductTypeId,
