...
public class GraphQLAttributeDefinitionTypeConflictErrorBuilder
    ...
    public GraphQLAttributeDefinitionTypeConflictErrorBuilder conflictingProductTypeId(
    ...
    public GraphQLAttributeDefinitionTypeConflictErrorBuilder conflictingProductTypeName(
    ...
    public GraphQLAttributeDefinitionTypeConflictErrorBuilder conflictingAttributeName(
    ...
    public GraphQLAttributeDefinitionTypeConflictError build() {
        Objects.requireNonNull(conflictingProductTypeId,
            GraphQLAttributeDefinitionTypeConflictError.class + ": conflictingProductTypeId is missing");
        Objects.requireNonNull(conflictingProductTypeName,
            GraphQLAttributeDefinitionTypeConflictError.class + ": conflictingProductTypeName is missing");
        Objects.requireNonNull(conflictingAttributeName,
            GraphQLAttributeDefinitionTypeConflictError.class + ": conflictingAttributeName is missing");
        return new GraphQLAttributeDefinitionTypeConflictErrorImpl(values, conflictingProductTypeId,
