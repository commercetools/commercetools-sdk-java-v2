...
public class GraphQLAttributeDefinitionTypeConflictErrorImpl implements GraphQLAttributeDefinitionTypeConflictError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLAttributeDefinitionTypeConflictErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("conflictingProductTypeId") final String conflictingProductTypeId, @JsonProperty("conflictingProductTypeName") final String conflictingProductTypeName, @JsonProperty("conflictingAttributeName") final String conflictingAttributeName) {
        this.values = values;
