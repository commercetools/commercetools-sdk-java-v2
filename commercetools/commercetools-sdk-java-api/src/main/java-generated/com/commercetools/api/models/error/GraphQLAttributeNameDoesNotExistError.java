...
public interface GraphQLAttributeNameDoesNotExistError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLAttributeNameDoesNotExistError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLAttributeNameDoesNotExistError>() {
            @Override
