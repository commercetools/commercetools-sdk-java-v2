...
public class GraphQLBadGatewayErrorImpl implements GraphQLBadGatewayError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLBadGatewayErrorImpl(@JsonAnySetter @JsonProperty("values") final Map<String, java.lang.Object> values) {
        this.values = values;
     ...
     */
    public GraphQLBadGatewayErrorImpl() {
        this.code = BAD_GATEWAY;
    }
