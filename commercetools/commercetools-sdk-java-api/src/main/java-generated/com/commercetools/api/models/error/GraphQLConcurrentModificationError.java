...
public interface GraphQLConcurrentModificationError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLConcurrentModificationError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLConcurrentModificationError>() {
            @Override
