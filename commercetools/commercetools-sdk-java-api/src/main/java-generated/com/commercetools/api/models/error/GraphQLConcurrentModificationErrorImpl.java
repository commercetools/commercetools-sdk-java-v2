...
public class GraphQLConcurrentModificationErrorImpl implements GraphQLConcurrentModificationError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLConcurrentModificationErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("currentVersion") final Long currentVersion) {
        this.values = values;
