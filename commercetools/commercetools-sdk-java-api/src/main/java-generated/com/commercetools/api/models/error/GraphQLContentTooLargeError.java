...
public interface GraphQLContentTooLargeError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLContentTooLargeError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLContentTooLargeError>() {
            @Override
