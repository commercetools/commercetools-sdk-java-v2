...
public interface GraphQLCountryNotConfiguredInStoreError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLCountryNotConfiguredInStoreError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLCountryNotConfiguredInStoreError>() {
            @Override
