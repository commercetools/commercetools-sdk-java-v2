...
public class GraphQLDiscountCodeNonApplicableErrorBuilder implements Builder<GraphQLDiscountCodeNonApplicableError> {
    ...
    public GraphQLDiscountCodeNonApplicableErrorBuilder validityCheckTime(@Nullable final java.time.ZonedDateTime validityCheckTime) {
    ...
    public GraphQLDiscountCodeNonApplicableError build() {
        return new GraphQLDiscountCodeNonApplicableErrorImpl(values, discountCode, reason, discountCodeId, validFrom, validUntil, validityCheckTime);
    }
     ...
     * @return builder
     */
    public static GraphQLDiscountCodeNonApplicableErrorBuilder of(final GraphQLDiscountCodeNonApplicableError template) {
