...
public class GraphQLDuplicateAttributeValueErrorImpl implements GraphQLDuplicateAttributeValueError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLDuplicateAttributeValueErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("attribute") final com.commercetools.api.models.product.Attribute attribute) {
        this.values = values;
