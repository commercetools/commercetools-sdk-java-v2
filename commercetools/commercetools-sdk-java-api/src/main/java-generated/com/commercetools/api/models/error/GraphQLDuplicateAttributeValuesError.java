...
public interface GraphQLDuplicateAttributeValuesError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLDuplicateAttributeValuesError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLDuplicateAttributeValuesError>() {
            @Override
