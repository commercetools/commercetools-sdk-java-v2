...
public class GraphQLDuplicateAttributeValuesErrorImpl implements GraphQLDuplicateAttributeValuesError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLDuplicateAttributeValuesErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("attributes") final java.util.List<com.commercetools.api.models.product.Attribute> attributes) {
        this.values = values;
