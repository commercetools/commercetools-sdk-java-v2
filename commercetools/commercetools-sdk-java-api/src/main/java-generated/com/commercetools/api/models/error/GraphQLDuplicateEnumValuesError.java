...
public interface GraphQLDuplicateEnumValuesError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLDuplicateEnumValuesError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLDuplicateEnumValuesError>() {
            @Override
