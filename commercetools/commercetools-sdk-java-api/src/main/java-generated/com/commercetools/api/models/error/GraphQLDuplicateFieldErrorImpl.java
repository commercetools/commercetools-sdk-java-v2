...
public class GraphQLDuplicateFieldErrorImpl implements GraphQLDuplicateFieldError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLDuplicateFieldErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("field") final String field, @JsonProperty("duplicateValue") final java.lang.Object duplicateValue) {
        this.values = values;
        this.field = field;
