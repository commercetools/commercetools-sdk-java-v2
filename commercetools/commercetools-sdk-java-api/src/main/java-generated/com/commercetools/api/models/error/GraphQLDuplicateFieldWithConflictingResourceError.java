...
public interface GraphQLDuplicateFieldWithConflictingResourceError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLDuplicateFieldWithConflictingResourceError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLDuplicateFieldWithConflictingResourceError>() {
            @Override
