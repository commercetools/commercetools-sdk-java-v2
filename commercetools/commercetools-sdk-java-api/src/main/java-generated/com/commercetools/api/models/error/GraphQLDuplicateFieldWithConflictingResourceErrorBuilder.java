...
public class GraphQLDuplicateFieldWithConflictingResourceErrorBuilder implements Builder<GraphQLDuplicateFieldWithConflictingResourceError> {
    ...
    public GraphQLDuplicateFieldWithConflictingResourceErrorBuilder addValue(final String key, final java.lang.Object value) {
        if (this.values == null) {
            values = new HashMap<>();
        }
    ...
    public GraphQLDuplicateFieldWithConflictingResourceErrorBuilder duplicateValue( final java.lang.Object duplicateValue) {
    ...
    public GraphQLDuplicateFieldWithConflictingResourceErrorBuilder conflictingResource( final com.commercetools.api.models.common.Reference conflictingResource) {
    ...
    public GraphQLDuplicateFieldWithConflictingResourceErrorBuilder conflictingResource(Function<com.commercetools.api.models.common.ReferenceBuilder, Builder<? extends com.commercetools.api.models.common.Reference>> builder) {
    ...
    public GraphQLDuplicateFieldWithConflictingResourceError build() {
        ...
        Objects.requireNonNull(duplicateValue, GraphQLDuplicateFieldWithConflictingResourceError.class + ": duplicateValue is missing");
        Objects.requireNonNull(conflictingResource, GraphQLDuplicateFieldWithConflictingResourceError.class + ": conflictingResource is missing");
        return new GraphQLDuplicateFieldWithConflictingResourceErrorImpl(values, field, duplicateValue, conflictingResource);
    }
     ...
     * @return builder
     */
    public static GraphQLDuplicateFieldWithConflictingResourceErrorBuilder of(final GraphQLDuplicateFieldWithConflictingResourceError template) {
