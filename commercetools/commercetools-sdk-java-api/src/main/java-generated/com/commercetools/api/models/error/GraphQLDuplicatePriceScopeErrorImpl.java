...
public class GraphQLDuplicatePriceScopeErrorImpl implements GraphQLDuplicatePriceScopeError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLDuplicatePriceScopeErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("conflictingPrice") final com.commercetools.api.models.common.Price conflictingPrice) {
        this.values = values;
