...
/**
 *  <p>Returned when a <a href="https://docs.commercetools.com/apis/ctp:api:type:ProductVariant" rel="nofollow">Product Variant</a> value conflicts with an existing one during an <span>Update Product</span> request.</p>
 *
 * <hr>
...
public interface GraphQLDuplicateVariantValuesError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLDuplicateVariantValuesError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLDuplicateVariantValuesError>() {
            @Override
