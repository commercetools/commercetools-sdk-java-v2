...
public class GraphQLDuplicateVariantValuesErrorImpl implements GraphQLDuplicateVariantValuesError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLDuplicateVariantValuesErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("variantValues") final com.commercetools.api.models.error.VariantValues variantValues) {
        this.values = values;
