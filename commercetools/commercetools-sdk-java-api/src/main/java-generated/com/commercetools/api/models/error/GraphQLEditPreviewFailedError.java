...
public interface GraphQLEditPreviewFailedError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLEditPreviewFailedError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLEditPreviewFailedError>() {
            @Override
