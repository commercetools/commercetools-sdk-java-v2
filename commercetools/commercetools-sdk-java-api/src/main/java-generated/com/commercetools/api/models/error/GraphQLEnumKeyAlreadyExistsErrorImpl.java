...
public class GraphQLEnumKeyAlreadyExistsErrorImpl implements GraphQLEnumKeyAlreadyExistsError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLEnumKeyAlreadyExistsErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("conflictingEnumKey") final String conflictingEnumKey, @JsonProperty("conflictingAttributeName") final String conflictingAttributeName) {
        this.values = values;
