...
public class GraphQLEnumKeyDoesNotExistErrorImpl implements GraphQLEnumKeyDoesNotExistError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLEnumKeyDoesNotExistErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("conflictingEnumKey") final String conflictingEnumKey, @JsonProperty("conflictingAttributeName") final String conflictingAttributeName) {
        this.values = values;
