...
public interface GraphQLEnumValuesMustMatchError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLEnumValuesMustMatchError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLEnumValuesMustMatchError>() {
            @Override
