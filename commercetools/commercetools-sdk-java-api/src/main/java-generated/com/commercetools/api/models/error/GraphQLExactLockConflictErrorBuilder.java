...
public class GraphQLExactLockConflictErrorBuilder implements Builder<GraphQLExactLockConflictError> {
    ...
    public GraphQLExactLockConflictErrorBuilder values(final Map<String, java.lang.Object> values) {
        this.values = values;
        return this;
    }
    ...
    public GraphQLExactLockConflictErrorBuilder addValue(final String key, final java.lang.Object value) {
        if (this.values == null) {
            values = new HashMap<>();
        }
    ...
    public GraphQLExactLockConflictErrorBuilder sku(final String sku) {
        this.sku = sku;
        return this;
    }
    ...
    public GraphQLExactLockConflictErrorBuilder currency(final String currency) {
    ...
    public GraphQLExactLockConflictErrorBuilder country(@Nullable final String country) {
    ...
    public GraphQLExactLockConflictErrorBuilder customerGroup(
    ...
    public GraphQLExactLockConflictErrorBuilder withCustomerGroup(
    ...
    public GraphQLExactLockConflictErrorBuilder channel(
    ...
    public GraphQLExactLockConflictErrorBuilder withChannel(
    ...
    public GraphQLExactLockConflictErrorBuilder validFrom(@Nullable final java.time.ZonedDateTime validFrom) {
    ...
    public GraphQLExactLockConflictErrorBuilder validUntil(@Nullable final java.time.ZonedDateTime validUntil) {
    ...
    public GraphQLExactLockConflictErrorBuilder recurrencePolicy(
    ...
    public GraphQLExactLockConflictErrorBuilder withRecurrencePolicy(
    ...
    /**
     * builds GraphQLExactLockConflictError with checking for non-null required values
     * @return GraphQLExactLockConflictError
     */
    public GraphQLExactLockConflictError build() {
        Objects.requireNonNull(sku, GraphQLExactLockConflictError.class + ": sku is missing");
        Objects.requireNonNull(currency, GraphQLExactLockConflictError.class + ": currency is missing");
        return new GraphQLExactLockConflictErrorImpl(values, sku, currency, country, customerGroup, channel, validFrom,
            validUntil, recurrencePolicy);
    }

    /**
     * builds GraphQLExactLockConflictError without checking for non-null required values
     * @return GraphQLExactLockConflictError
     */
    public GraphQLExactLockConflictError buildUnchecked() {
        return new GraphQLExactLockConflictErrorImpl(values, sku, currency, country, customerGroup, channel, validFrom,
            validUntil, recurrencePolicy);
    }

    /**
     * factory method for an instance of GraphQLExactLockConflictErrorBuilder
     * @return builder
     */
    public static GraphQLExactLockConflictErrorBuilder of() {
        return new GraphQLExactLockConflictErrorBuilder();
    }
     ...
     * @return builder
     */
    public static GraphQLExactLockConflictErrorBuilder of(final GraphQLExactLockConflictError template) {
        GraphQLExactLockConflictErrorBuilder builder = new GraphQLExactLockConflictErrorBuilder();
