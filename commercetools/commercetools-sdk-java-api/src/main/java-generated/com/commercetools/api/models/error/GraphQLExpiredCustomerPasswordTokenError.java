...
public interface GraphQLExpiredCustomerPasswordTokenError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLExpiredCustomerPasswordTokenError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLExpiredCustomerPasswordTokenError>() {
            @Override
