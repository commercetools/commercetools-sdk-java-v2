...
public class GraphQLExtensionBadResponseErrorBuilder implements Builder<GraphQLExtensionBadResponseError> {
    ...
    public GraphQLExtensionBadResponseErrorBuilder localizedMessage(Function<com.commercetools.api.models.common.LocalizedStringBuilder, com.commercetools.api.models.common.LocalizedStringBuilder> builder) {
    ...
    public GraphQLExtensionBadResponseErrorBuilder withLocalizedMessage(Function<com.commercetools.api.models.common.LocalizedStringBuilder, com.commercetools.api.models.common.LocalizedString> builder) {
    ...
    public GraphQLExtensionBadResponseErrorBuilder localizedMessage(@Nullable final com.commercetools.api.models.common.LocalizedString localizedMessage) {
    ...
    public GraphQLExtensionBadResponseErrorBuilder extensionExtraInfo(@Nullable final java.lang.Object extensionExtraInfo) {
    ...
    public GraphQLExtensionBadResponseErrorBuilder extensionErrors( final com.commercetools.api.models.error.ExtensionError ...extensionErrors) {
    ...
    public GraphQLExtensionBadResponseErrorBuilder extensionErrors( final java.util.List<com.commercetools.api.models.error.ExtensionError> extensionErrors) {
    ...
    public GraphQLExtensionBadResponseErrorBuilder plusExtensionErrors( final com.commercetools.api.models.error.ExtensionError ...extensionErrors) {
    ...
    public GraphQLExtensionBadResponseErrorBuilder plusExtensionErrors(Function<com.commercetools.api.models.error.ExtensionErrorBuilder, com.commercetools.api.models.error.ExtensionErrorBuilder> builder) {
        if (this.extensionErrors == null) {
            this.extensionErrors = new ArrayList<>();
        }
    ...
    public GraphQLExtensionBadResponseErrorBuilder withExtensionErrors(Function<com.commercetools.api.models.error.ExtensionErrorBuilder, com.commercetools.api.models.error.ExtensionErrorBuilder> builder) {
        this.extensionErrors = new ArrayList<>();
        this.extensionErrors.add(builder.apply(com.commercetools.api.models.error.ExtensionErrorBuilder.of()).build());
        return this;
    }
    ...
    public GraphQLExtensionBadResponseErrorBuilder addExtensionErrors(Function<com.commercetools.api.models.error.ExtensionErrorBuilder, com.commercetools.api.models.error.ExtensionError> builder) {
    ...
    public GraphQLExtensionBadResponseErrorBuilder setExtensionErrors(Function<com.commercetools.api.models.error.ExtensionErrorBuilder, com.commercetools.api.models.error.ExtensionError> builder) {
    ...
    public GraphQLExtensionBadResponseError build() {
        Objects.requireNonNull(extensionErrors, GraphQLExtensionBadResponseError.class + ": extensionErrors is missing");
        Objects.requireNonNull(extensionId, GraphQLExtensionBadResponseError.class + ": extensionId is missing");
        return new GraphQLExtensionBadResponseErrorImpl(values, localizedMessage, extensionExtraInfo, extensionErrors, extensionBody, extensionStatusCode, extensionId, extensionKey);
    }
