...
public interface GraphQLExtensionChainTooDeepError extends GraphQLErrorObject {
     ...
     */
    public static com.fasterxml.jackson.core.type.TypeReference<GraphQLExtensionChainTooDeepError> typeReference() {
        return new com.fasterxml.jackson.core.type.TypeReference<GraphQLExtensionChainTooDeepError>() {
            @Override
