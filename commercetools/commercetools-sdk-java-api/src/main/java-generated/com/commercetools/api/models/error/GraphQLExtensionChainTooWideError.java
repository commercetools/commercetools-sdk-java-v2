...
public interface GraphQLExtensionChainTooWideError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLExtensionChainTooWideError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLExtensionChainTooWideError>() {
            @Override
