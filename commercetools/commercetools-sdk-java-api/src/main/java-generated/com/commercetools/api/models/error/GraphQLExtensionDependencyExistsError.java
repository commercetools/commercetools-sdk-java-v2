...
public interface GraphQLExtensionDependencyExistsError extends GraphQLErrorObject {
     ...
     */
    public static com.fasterxml.jackson.core.type.TypeReference<GraphQLExtensionDependencyExistsError> typeReference() {
        return new com.fasterxml.jackson.core.type.TypeReference<GraphQLExtensionDependencyExistsError>() {
            @Override
