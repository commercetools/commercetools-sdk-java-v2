...
public interface GraphQLExtensionPredicateEvaluationFailedError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLExtensionPredicateEvaluationFailedError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLExtensionPredicateEvaluationFailedError>() {
            @Override
