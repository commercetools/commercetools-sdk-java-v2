...
import com.commercetools.api.models.error.GraphQLExtensionPredicateEvaluationFailedErrorImpl;
...
public interface GraphQLExtensionPredicateEvaluationFailedError extends GraphQLErrorObject {
     ...
     */
    public static GraphQLExtensionPredicateEvaluationFailedError of(final GraphQLExtensionPredicateEvaluationFailedError template) {
     ...
     */
    @Nullable
    public static GraphQLExtensionPredicateEvaluationFailedError deepCopy(@Nullable final GraphQLExtensionPredicateEvaluationFailedError template) {
        if (template == null) {
            return null;
        }
        GraphQLExtensionPredicateEvaluationFailedErrorImpl instance = new GraphQLExtensionPredicateEvaluationFailedErrorImpl();
     ...
     * @return builder
     */
    public static GraphQLExtensionPredicateEvaluationFailedErrorBuilder builder(final GraphQLExtensionPredicateEvaluationFailedError template) {
     ...
     * @return mapped value
     */
    default <T> T withGraphQLExtensionPredicateEvaluationFailedError(Function<GraphQLExtensionPredicateEvaluationFailedError, T> helper) {
