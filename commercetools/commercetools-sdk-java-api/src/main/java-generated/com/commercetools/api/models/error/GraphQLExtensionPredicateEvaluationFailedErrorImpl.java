...
public class GraphQLExtensionPredicateEvaluationFailedErrorImpl implements GraphQLExtensionPredicateEvaluationFailedError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLExtensionPredicateEvaluationFailedErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("errorByExtension") final com.commercetools.api.models.error.ErrorByExtension errorByExtension) {
        this.values = values;
