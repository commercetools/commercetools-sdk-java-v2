...
public interface GraphQLExtensionUpdateActionsFailedError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLExtensionUpdateActionsFailedError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLExtensionUpdateActionsFailedError>() {
            @Override
