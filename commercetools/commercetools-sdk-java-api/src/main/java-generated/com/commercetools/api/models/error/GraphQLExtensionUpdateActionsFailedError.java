...
import com.commercetools.api.models.error.GraphQLExtensionUpdateActionsFailedErrorImpl;
...
public interface GraphQLExtensionUpdateActionsFailedError extends GraphQLErrorObject {
     ...
     */
    @Nullable
    public static GraphQLExtensionUpdateActionsFailedError deepCopy(@Nullable final GraphQLExtensionUpdateActionsFailedError template) {
        if (template == null) {
            return null;
        }
        GraphQLExtensionUpdateActionsFailedErrorImpl instance = new GraphQLExtensionUpdateActionsFailedErrorImpl();
     ...
     * @return builder
     */
    public static GraphQLExtensionUpdateActionsFailedErrorBuilder builder(final GraphQLExtensionUpdateActionsFailedError template) {
     ...
     * @return mapped value
     */
    default <T> T withGraphQLExtensionUpdateActionsFailedError(Function<GraphQLExtensionUpdateActionsFailedError, T> helper) {
