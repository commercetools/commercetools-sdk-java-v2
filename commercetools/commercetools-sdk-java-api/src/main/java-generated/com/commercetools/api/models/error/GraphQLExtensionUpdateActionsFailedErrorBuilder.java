...
public class GraphQLExtensionUpdateActionsFailedErrorBuilder
    ...
    public GraphQLExtensionUpdateActionsFailedErrorBuilder localizedMessage(
    ...
    public GraphQLExtensionUpdateActionsFailedErrorBuilder withLocalizedMessage(
    ...
    public GraphQLExtensionUpdateActionsFailedErrorBuilder extensionExtraInfo(
    ...
    public GraphQLExtensionUpdateActionsFailedErrorBuilder extensionErrors(
    ...
    public GraphQLExtensionUpdateActionsFailedErrorBuilder plusExtensionErrors(
            final com.commercetools.api.models.error.ExtensionError... extensionErrors) {
    ...
    public GraphQLExtensionUpdateActionsFailedErrorBuilder withExtensionErrors(
            Function<com.commercetools.api.models.error.ExtensionErrorBuilder, com.commercetools.api.models.error.ExtensionErrorBuilder> builder) {
        this.extensionErrors = new ArrayList<>();
        this.extensionErrors.add(builder.apply(com.commercetools.api.models.error.ExtensionErrorBuilder.of()).build());
        return this;
    ...
    public GraphQLExtensionUpdateActionsFailedErrorBuilder addExtensionErrors(
    ...
    public GraphQLExtensionUpdateActionsFailedErrorBuilder setExtensionErrors(
            Function<com.commercetools.api.models.error.ExtensionErrorBuilder, com.commercetools.api.models.error.ExtensionError> builder) {
    ...
    public GraphQLExtensionUpdateActionsFailedError build() {
        Objects.requireNonNull(extensionErrors,
            GraphQLExtensionUpdateActionsFailedError.class + ": extensionErrors is missing");
        return new GraphQLExtensionUpdateActionsFailedErrorImpl(values, localizedMessage, extensionExtraInfo,
            extensionErrors);
    }
