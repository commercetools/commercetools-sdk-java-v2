...
public interface GraphQLFeatureRemovedError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLFeatureRemovedError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLFeatureRemovedError>() {
            @Override
