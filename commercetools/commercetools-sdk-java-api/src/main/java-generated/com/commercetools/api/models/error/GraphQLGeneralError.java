 ...
 *  <p>If you encounter this error, report it to the <span>Composable Commerce support team</span>.</p>
 *
 * <hr>
...
public interface GraphQLGeneralError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLGeneralError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLGeneralError>() {
            @Override
