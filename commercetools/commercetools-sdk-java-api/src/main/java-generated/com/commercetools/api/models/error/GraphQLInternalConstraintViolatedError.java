...
public interface GraphQLInternalConstraintViolatedError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLInternalConstraintViolatedError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLInternalConstraintViolatedError>() {
            @Override
