...
public class GraphQLInvalidCurrentPasswordErrorImpl implements GraphQLInvalidCurrentPasswordError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLInvalidCurrentPasswordErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values) {
        this.values = values;
     ...
     */
    public GraphQLInvalidCurrentPasswordErrorImpl() {
        this.code = INVALID_CURRENT_PASSWORD;
    }
