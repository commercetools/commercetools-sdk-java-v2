...
public interface GraphQLInvalidFieldError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLInvalidFieldError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLInvalidFieldError>() {
            @Override
