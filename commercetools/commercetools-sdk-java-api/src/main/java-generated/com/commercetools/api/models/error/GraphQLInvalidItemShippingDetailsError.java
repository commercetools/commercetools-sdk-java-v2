...
public interface GraphQLInvalidItemShippingDetailsError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLInvalidItemShippingDetailsError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLInvalidItemShippingDetailsError>() {
            @Override
