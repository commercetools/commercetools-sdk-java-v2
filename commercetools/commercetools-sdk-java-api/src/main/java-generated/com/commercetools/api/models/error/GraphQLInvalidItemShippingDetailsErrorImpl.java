...
public class GraphQLInvalidItemShippingDetailsErrorImpl implements GraphQLInvalidItemShippingDetailsError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLInvalidItemShippingDetailsErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("subject") final String subject, @JsonProperty("itemId") final String itemId) {
        this.values = values;
