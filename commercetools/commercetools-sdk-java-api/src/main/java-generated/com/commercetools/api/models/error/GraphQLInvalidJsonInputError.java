...
public interface GraphQLInvalidJsonInputError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLInvalidJsonInputError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLInvalidJsonInputError>() {
            @Override
