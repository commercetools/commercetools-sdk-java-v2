...
public class GraphQLInvalidJsonInputErrorImpl implements GraphQLInvalidJsonInputError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLInvalidJsonInputErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("detailedErrorMessage") final String detailedErrorMessage) {
        this.values = values;
