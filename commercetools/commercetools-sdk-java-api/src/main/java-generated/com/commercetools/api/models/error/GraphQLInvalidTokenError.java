...
public interface GraphQLInvalidTokenError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLInvalidTokenError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLInvalidTokenError>() {
            @Override
