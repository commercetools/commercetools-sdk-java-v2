...
public interface GraphQLLanguageUsedInStoresError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLLanguageUsedInStoresError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLLanguageUsedInStoresError>() {
            @Override
