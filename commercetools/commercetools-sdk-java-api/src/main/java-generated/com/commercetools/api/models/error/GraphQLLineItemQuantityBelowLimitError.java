...
public interface GraphQLLineItemQuantityBelowLimitError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLLineItemQuantityBelowLimitError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLLineItemQuantityBelowLimitError>() {
            @Override
