...
public class GraphQLMatchingPriceNotFoundErrorBuilder implements Builder<GraphQLMatchingPriceNotFoundError> {
    ...
    public GraphQLMatchingPriceNotFoundErrorBuilder customerGroup(Function<com.commercetools.api.models.customer_group.CustomerGroupReferenceBuilder, com.commercetools.api.models.customer_group.CustomerGroupReferenceBuilder> builder) {
    ...
    public GraphQLMatchingPriceNotFoundErrorBuilder withCustomerGroup(Function<com.commercetools.api.models.customer_group.CustomerGroupReferenceBuilder, com.commercetools.api.models.customer_group.CustomerGroupReference> builder) {
    ...
    public GraphQLMatchingPriceNotFoundErrorBuilder customerGroup(@Nullable final com.commercetools.api.models.customer_group.CustomerGroupReference customerGroup) {
    ...
    public GraphQLMatchingPriceNotFoundErrorBuilder channel(Function<com.commercetools.api.models.channel.ChannelReferenceBuilder, com.commercetools.api.models.channel.ChannelReferenceBuilder> builder) {
    ...
    public GraphQLMatchingPriceNotFoundErrorBuilder withChannel(Function<com.commercetools.api.models.channel.ChannelReferenceBuilder, com.commercetools.api.models.channel.ChannelReference> builder) {
    ...
    public GraphQLMatchingPriceNotFoundErrorBuilder channel(@Nullable final com.commercetools.api.models.channel.ChannelReference channel) {
    ...
    public GraphQLMatchingPriceNotFoundError build() {
        ...
        return new GraphQLMatchingPriceNotFoundErrorImpl(values, productId, variantId, currency, country, customerGroup, channel);
    }
