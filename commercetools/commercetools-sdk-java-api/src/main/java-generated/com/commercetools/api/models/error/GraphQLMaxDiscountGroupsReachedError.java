...
public interface GraphQLMaxDiscountGroupsReachedError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLMaxDiscountGroupsReachedError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLMaxDiscountGroupsReachedError>() {
            @Override
