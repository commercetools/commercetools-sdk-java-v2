...
public class GraphQLMaxDiscountGroupsReachedErrorImpl implements GraphQLMaxDiscountGroupsReachedError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLMaxDiscountGroupsReachedErrorImpl(
            @JsonAnySetter @JsonProperty("values") final Map<String, java.lang.Object> values) {
        this.values = values;
        this.code = MAX_DISCOUNT_GROUPS_REACHED;
    }

    /**
     * create empty instance
     */
    public GraphQLMaxDiscountGroupsReachedErrorImpl() {
        this.code = MAX_DISCOUNT_GROUPS_REACHED;
    }
    ...
    public boolean equals(Object o) {
        ...
        GraphQLMaxDiscountGroupsReachedErrorImpl that = (GraphQLMaxDiscountGroupsReachedErrorImpl) o;
    ...
    public GraphQLMaxDiscountGroupsReachedError copyDeep() {
        return GraphQLMaxDiscountGroupsReachedError.deepCopy(this);
    }
}
