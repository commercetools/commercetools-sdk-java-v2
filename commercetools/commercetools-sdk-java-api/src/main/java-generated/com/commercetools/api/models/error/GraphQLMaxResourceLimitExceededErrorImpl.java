...
public class GraphQLMaxResourceLimitExceededErrorImpl implements GraphQLMaxResourceLimitExceededError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLMaxResourceLimitExceededErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("exceededResource") final com.commercetools.api.models.common.ReferenceTypeId exceededResource) {
        this.values = values;
