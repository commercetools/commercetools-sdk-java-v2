...
public interface GraphQLMissingDependencyError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLMissingDependencyError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLMissingDependencyError>() {
            @Override
