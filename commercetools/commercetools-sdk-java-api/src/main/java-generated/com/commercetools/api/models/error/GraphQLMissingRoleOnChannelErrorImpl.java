...
public class GraphQLMissingRoleOnChannelErrorImpl implements GraphQLMissingRoleOnChannelError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLMissingRoleOnChannelErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("channel") final com.commercetools.api.models.channel.ChannelResourceIdentifier channel, @JsonProperty("missingRole") final com.commercetools.api.models.channel.ChannelRoleEnum missingRole) {
        this.values = values;
