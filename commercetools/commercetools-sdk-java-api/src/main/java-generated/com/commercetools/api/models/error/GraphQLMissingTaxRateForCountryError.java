...
public interface GraphQLMissingTaxRateForCountryError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLMissingTaxRateForCountryError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLMissingTaxRateForCountryError>() {
            @Override
