...
public interface GraphQLNoMatchingProductDiscountFoundError extends GraphQLErrorObject {
     ...
     */
    @Nullable
    public static GraphQLNoMatchingProductDiscountFoundError deepCopy(
            @Nullable final GraphQLNoMatchingProductDiscountFoundError template) {
        if (template == null) {
            return null;
        }
        GraphQLNoMatchingProductDiscountFoundErrorImpl instance = new GraphQLNoMatchingProductDiscountFoundErrorImpl();
     ...
     * @return mapped value
     */
    default <T> T withGraphQLNoMatchingProductDiscountFoundError(
            Function<GraphQLNoMatchingProductDiscountFoundError, T> helper) {
