...
public class GraphQLOutOfStockErrorImpl implements GraphQLOutOfStockError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLOutOfStockErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("lineItems") final java.util.List<String> lineItems, @JsonProperty("skus") final java.util.List<String> skus) {
        this.values = values;
