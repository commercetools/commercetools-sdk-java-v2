...
public interface GraphQLOverCapacityError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLOverCapacityError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLOverCapacityError>() {
            @Override
