...
public class GraphQLOverCapacityErrorImpl implements GraphQLOverCapacityError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLOverCapacityErrorImpl(@JsonAnySetter @JsonProperty("values") final Map<String, java.lang.Object> values) {
        this.values = values;
     ...
     */
    public GraphQLOverCapacityErrorImpl() {
        this.code = OVER_CAPACITY;
    }
    ...
    public boolean equals(Object o) {
        ...
        GraphQLOverCapacityErrorImpl that = (GraphQLOverCapacityErrorImpl) o;
