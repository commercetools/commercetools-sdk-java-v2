...
@JsonDeserialize(as = GraphQLOverlappingPriceValidityErrorImpl.class)
public interface GraphQLOverlappingPriceValidityError extends GraphQLErrorObject {
    ...
    /**
     * factory method
     * @return instance of GraphQLOverlappingPriceValidityError
     */
    public static GraphQLOverlappingPriceValidityError of() {
        return new GraphQLOverlappingPriceValidityErrorImpl();
    }
     ...
     */
    public static GraphQLOverlappingPriceValidityError of(final GraphQLOverlappingPriceValidityError template) {
        GraphQLOverlappingPriceValidityErrorImpl instance = new GraphQLOverlappingPriceValidityErrorImpl();
    ...
    public GraphQLOverlappingPriceValidityError copyDeep();
     ...
     */
    @Nullable
    public static GraphQLOverlappingPriceValidityError deepCopy(
            @Nullable final GraphQLOverlappingPriceValidityError template) {
        if (template == null) {
            return null;
        }
        GraphQLOverlappingPriceValidityErrorImpl instance = new GraphQLOverlappingPriceValidityErrorImpl();
     ...
     * @return builder
     */
    public static GraphQLOverlappingPriceValidityErrorBuilder builder() {
        return GraphQLOverlappingPriceValidityErrorBuilder.of();
    }
     ...
     */
    public static GraphQLOverlappingPriceValidityErrorBuilder builder(
            final GraphQLOverlappingPriceValidityError template) {
        return GraphQLOverlappingPriceValidityErrorBuilder.of(template);
    }
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLOverlappingPriceValidityError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLOverlappingPriceValidityError>() {
            @Override
            public String toString() {
                return "TypeReference<GraphQLOverlappingPriceValidityError>";
            }
        };
    }
}
