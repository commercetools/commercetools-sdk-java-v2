...
public class GraphQLOverlappingPriceValidityErrorBuilder implements Builder<GraphQLOverlappingPriceValidityError> {
    ...
    public GraphQLOverlappingPriceValidityErrorBuilder values(final Map<String, java.lang.Object> values) {
        this.values = values;
        return this;
    }
    ...
    public GraphQLOverlappingPriceValidityErrorBuilder addValue(final String key, final java.lang.Object value) {
        if (this.values == null) {
            values = new HashMap<>();
        }
    ...
    public GraphQLOverlappingPriceValidityErrorBuilder conflictingPrice(final String conflictingPrice) {
    ...
    public GraphQLOverlappingPriceValidityErrorBuilder currency(final String currency) {
    ...
    public GraphQLOverlappingPriceValidityErrorBuilder country(@Nullable final String country) {
    ...
    public GraphQLOverlappingPriceValidityErrorBuilder customerGroup(
    ...
    public GraphQLOverlappingPriceValidityErrorBuilder withCustomerGroup(
    ...
    public GraphQLOverlappingPriceValidityErrorBuilder channel(
    ...
    public GraphQLOverlappingPriceValidityErrorBuilder withChannel(
    ...
    public GraphQLOverlappingPriceValidityErrorBuilder validFrom(@Nullable final java.time.ZonedDateTime validFrom) {
    ...
    public GraphQLOverlappingPriceValidityErrorBuilder validUntil(@Nullable final java.time.ZonedDateTime validUntil) {
    ...
    public GraphQLOverlappingPriceValidityErrorBuilder conflictingValidFrom(
    ...
    public GraphQLOverlappingPriceValidityErrorBuilder conflictingValidUntil(
    ...
    /**
     * builds GraphQLOverlappingPriceValidityError with checking for non-null required values
     * @return GraphQLOverlappingPriceValidityError
     */
    public GraphQLOverlappingPriceValidityError build() {
        Objects.requireNonNull(conflictingPrice,
            GraphQLOverlappingPriceValidityError.class + ": conflictingPrice is missing");
        Objects.requireNonNull(currency, GraphQLOverlappingPriceValidityError.class + ": currency is missing");
        return new GraphQLOverlappingPriceValidityErrorImpl(values, conflictingPrice, currency, country, customerGroup,
            channel, validFrom, validUntil, conflictingValidFrom, conflictingValidUntil);
    }

    /**
     * builds GraphQLOverlappingPriceValidityError without checking for non-null required values
     * @return GraphQLOverlappingPriceValidityError
     */
    public GraphQLOverlappingPriceValidityError buildUnchecked() {
        return new GraphQLOverlappingPriceValidityErrorImpl(values, conflictingPrice, currency, country, customerGroup,
            channel, validFrom, validUntil, conflictingValidFrom, conflictingValidUntil);
    }

    /**
     * factory method for an instance of GraphQLOverlappingPriceValidityErrorBuilder
     * @return builder
     */
    public static GraphQLOverlappingPriceValidityErrorBuilder of() {
        return new GraphQLOverlappingPriceValidityErrorBuilder();
    }
     ...
     * @return builder
     */
    public static GraphQLOverlappingPriceValidityErrorBuilder of(final GraphQLOverlappingPriceValidityError template) {
        GraphQLOverlappingPriceValidityErrorBuilder builder = new GraphQLOverlappingPriceValidityErrorBuilder();
