...
public class GraphQLOverlappingStandalonePriceValidityErrorBuilder implements Builder<GraphQLOverlappingStandalonePriceValidityError> {
    ...
    public GraphQLOverlappingStandalonePriceValidityErrorBuilder addValue(final String key, final java.lang.Object value) {
        if (this.values == null) {
            values = new HashMap<>();
        }
    ...
    public GraphQLOverlappingStandalonePriceValidityErrorBuilder conflictingStandalonePrice(Function<com.commercetools.api.models.standalone_price.StandalonePriceReferenceBuilder, com.commercetools.api.models.standalone_price.StandalonePriceReferenceBuilder> builder) {
        this.conflictingStandalonePrice = builder.apply(com.commercetools.api.models.standalone_price.StandalonePriceReferenceBuilder.of()).build();
        return this;
    }
    ...
    public GraphQLOverlappingStandalonePriceValidityErrorBuilder withConflictingStandalonePrice(Function<com.commercetools.api.models.standalone_price.StandalonePriceReferenceBuilder, com.commercetools.api.models.standalone_price.StandalonePriceReference> builder) {
        this.conflictingStandalonePrice = builder.apply(com.commercetools.api.models.standalone_price.StandalonePriceReferenceBuilder.of());
        return this;
    }
    ...
    public GraphQLOverlappingStandalonePriceValidityErrorBuilder conflictingStandalonePrice( final com.commercetools.api.models.standalone_price.StandalonePriceReference conflictingStandalonePrice) {
    ...
    public GraphQLOverlappingStandalonePriceValidityErrorBuilder customerGroup(Function<com.commercetools.api.models.customer_group.CustomerGroupResourceIdentifierBuilder, com.commercetools.api.models.customer_group.CustomerGroupResourceIdentifierBuilder> builder) {
    ...
    public GraphQLOverlappingStandalonePriceValidityErrorBuilder withCustomerGroup(Function<com.commercetools.api.models.customer_group.CustomerGroupResourceIdentifierBuilder, com.commercetools.api.models.customer_group.CustomerGroupResourceIdentifier> builder) {
    ...
    public GraphQLOverlappingStandalonePriceValidityErrorBuilder customerGroup(@Nullable final com.commercetools.api.models.customer_group.CustomerGroupResourceIdentifier customerGroup) {
    ...
    public GraphQLOverlappingStandalonePriceValidityErrorBuilder channel(Function<com.commercetools.api.models.channel.ChannelResourceIdentifierBuilder, com.commercetools.api.models.channel.ChannelResourceIdentifierBuilder> builder) {
    ...
    public GraphQLOverlappingStandalonePriceValidityErrorBuilder withChannel(Function<com.commercetools.api.models.channel.ChannelResourceIdentifierBuilder, com.commercetools.api.models.channel.ChannelResourceIdentifier> builder) {
    ...
    public GraphQLOverlappingStandalonePriceValidityErrorBuilder channel(@Nullable final com.commercetools.api.models.channel.ChannelResourceIdentifier channel) {
    ...
    public GraphQLOverlappingStandalonePriceValidityErrorBuilder validFrom(@Nullable final java.time.ZonedDateTime validFrom) {
    ...
    public GraphQLOverlappingStandalonePriceValidityErrorBuilder validUntil(@Nullable final java.time.ZonedDateTime validUntil) {
    ...
    public GraphQLOverlappingStandalonePriceValidityErrorBuilder conflictingValidFrom(@Nullable final java.time.ZonedDateTime conflictingValidFrom) {
    ...
    public GraphQLOverlappingStandalonePriceValidityErrorBuilder conflictingValidUntil(@Nullable final java.time.ZonedDateTime conflictingValidUntil) {
    ...
    public GraphQLOverlappingStandalonePriceValidityError build() {
        Objects.requireNonNull(conflictingStandalonePrice, GraphQLOverlappingStandalonePriceValidityError.class + ": conflictingStandalonePrice is missing");
        Objects.requireNonNull(sku, GraphQLOverlappingStandalonePriceValidityError.class + ": sku is missing");
        Objects.requireNonNull(currency, GraphQLOverlappingStandalonePriceValidityError.class + ": currency is missing");
        return new GraphQLOverlappingStandalonePriceValidityErrorImpl(values, conflictingStandalonePrice, sku, currency, country, customerGroup, channel, validFrom, validUntil, conflictingValidFrom, conflictingValidUntil);
    }
     ...
     * @return builder
     */
    public static GraphQLOverlappingStandalonePriceValidityErrorBuilder of(final GraphQLOverlappingStandalonePriceValidityError template) {
