...
public class GraphQLProductPresentWithDifferentVariantSelectionErrorImpl implements GraphQLProductPresentWithDifferentVariantSelectionError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLProductPresentWithDifferentVariantSelectionErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("product") final com.commercetools.api.models.product.ProductReference product, @JsonProperty("existingVariantSelection") final com.commercetools.api.models.product_selection.ProductVariantSelection existingVariantSelection) {
        this.values = values;
