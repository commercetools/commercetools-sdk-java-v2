...
public interface GraphQLProjectNotConfiguredForLanguagesError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLProjectNotConfiguredForLanguagesError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLProjectNotConfiguredForLanguagesError>() {
            @Override
