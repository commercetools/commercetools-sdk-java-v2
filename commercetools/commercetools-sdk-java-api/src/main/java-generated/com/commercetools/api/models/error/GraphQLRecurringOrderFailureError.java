...
public interface GraphQLRecurringOrderFailureError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLRecurringOrderFailureError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLRecurringOrderFailureError>() {
            @Override
