...
public class GraphQLReferenceExistsErrorImpl implements GraphQLReferenceExistsError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLReferenceExistsErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("referencedBy") final com.commercetools.api.models.common.ReferenceTypeId referencedBy) {
        this.values = values;
