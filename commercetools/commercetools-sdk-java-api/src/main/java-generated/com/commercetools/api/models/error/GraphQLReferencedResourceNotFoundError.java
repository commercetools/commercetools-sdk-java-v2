...
public interface GraphQLReferencedResourceNotFoundError extends GraphQLErrorObject {
     ...
     */
    @Nullable
    public static GraphQLReferencedResourceNotFoundError deepCopy(
            @Nullable final GraphQLReferencedResourceNotFoundError template) {
        if (template == null) {
            return null;
        }
        GraphQLReferencedResourceNotFoundErrorImpl instance = new GraphQLReferencedResourceNotFoundErrorImpl();
     ...
     * @return mapped value
     */
    default <T> T withGraphQLReferencedResourceNotFoundError(
            Function<GraphQLReferencedResourceNotFoundError, T> helper) {
