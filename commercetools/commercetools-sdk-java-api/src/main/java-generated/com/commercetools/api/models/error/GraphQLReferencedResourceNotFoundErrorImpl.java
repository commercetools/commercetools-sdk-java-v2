...
public class GraphQLReferencedResourceNotFoundErrorImpl implements GraphQLReferencedResourceNotFoundError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLReferencedResourceNotFoundErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("typeId") final com.commercetools.api.models.common.ReferenceTypeId typeId, @JsonProperty("id") final String id, @JsonProperty("key") final String key) {
        this.values = values;
        this.typeId = typeId;
        this.id = id;
        this.key = key;
