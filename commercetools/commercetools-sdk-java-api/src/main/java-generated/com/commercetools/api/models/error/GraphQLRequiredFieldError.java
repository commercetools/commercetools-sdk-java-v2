...
public interface GraphQLRequiredFieldError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLRequiredFieldError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLRequiredFieldError>() {
            @Override
