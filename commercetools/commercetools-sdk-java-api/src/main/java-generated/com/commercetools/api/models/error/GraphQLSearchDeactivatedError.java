...
public interface GraphQLSearchDeactivatedError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLSearchDeactivatedError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLSearchDeactivatedError>() {
            @Override
