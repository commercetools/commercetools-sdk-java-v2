...
public class GraphQLSearchDeactivatedErrorImpl implements GraphQLSearchDeactivatedError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLSearchDeactivatedErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values) {
        this.values = values;
     ...
     */
    public GraphQLSearchDeactivatedErrorImpl() {
        this.code = SEARCH_DEACTIVATED;
    }
    ...
    public boolean equals(Object o) {
        ...
        GraphQLSearchDeactivatedErrorImpl that = (GraphQLSearchDeactivatedErrorImpl) o;
