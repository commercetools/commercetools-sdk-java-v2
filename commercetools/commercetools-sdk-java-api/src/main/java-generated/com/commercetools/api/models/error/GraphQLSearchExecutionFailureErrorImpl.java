...
public class GraphQLSearchExecutionFailureErrorImpl implements GraphQLSearchExecutionFailureError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLSearchExecutionFailureErrorImpl(@JsonProperty("values") final Map<String, java.lang.Object> values) {
        this.values = values;
     ...
     */
    public GraphQLSearchExecutionFailureErrorImpl() {
        this.code = SEARCH_EXECUTION_FAILURE;
    }
