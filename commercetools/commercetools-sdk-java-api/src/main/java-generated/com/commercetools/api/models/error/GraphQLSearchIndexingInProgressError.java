...
public interface GraphQLSearchIndexingInProgressError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLSearchIndexingInProgressError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLSearchIndexingInProgressError>() {
            @Override
