...
public interface GraphQLSearchNotReadyError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLSearchNotReadyError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLSearchNotReadyError>() {
            @Override
