...
public class GraphQLSearchNotReadyErrorImpl implements GraphQLSearchNotReadyError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLSearchNotReadyErrorImpl(@JsonAnySetter @JsonProperty("values") final Map<String, java.lang.Object> values) {
        this.values = values;
     ...
     */
    public GraphQLSearchNotReadyErrorImpl() {
        this.code = SEARCH_NOT_READY;
    }
    ...
    public boolean equals(Object o) {
        ...
        GraphQLSearchNotReadyErrorImpl that = (GraphQLSearchNotReadyErrorImpl) o;
