...
public interface GraphQLSyntaxErrorError extends GraphQLErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLSyntaxErrorError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLSyntaxErrorError>() {
            @Override
