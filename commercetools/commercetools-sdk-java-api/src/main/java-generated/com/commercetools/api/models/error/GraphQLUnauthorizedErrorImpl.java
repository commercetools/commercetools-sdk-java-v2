...
public class GraphQLUnauthorizedErrorImpl implements GraphQLUnauthorizedError, ModelBase {
     ...
     */
    @JsonCreator
    GraphQLUnauthorizedErrorImpl(@JsonAnySetter @JsonProperty("values") final Map<String, java.lang.Object> values,
     ...
     */
    public GraphQLUnauthorizedErrorImpl() {
        this.code = UNAUTHORIZED;
    }
    ...
    public boolean equals(Object o) {
        ...
        GraphQLUnauthorizedErrorImpl that = (GraphQLUnauthorizedErrorImpl) o;
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder(17, 37).append(code).append(values).append(storesWithoutPermission).toHashCode();
    }
    ...
    public GraphQLUnauthorizedError copyDeep() {
        return GraphQLUnauthorizedError.deepCopy(this);
    }
}
