...
public class InvalidJsonInputErrorImpl implements InvalidJsonInputError, ModelBase {
     ...
     */
    @JsonCreator
    InvalidJsonInputErrorImpl(@JsonProperty("message") final String message, @JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("detailedErrorMessage") final String detailedErrorMessage) {
