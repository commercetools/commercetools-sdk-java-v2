...
public interface InvalidSubjectError extends ErrorObject {
     ...
     */
    @Nullable
    public static InvalidSubjectError deepCopy(@Nullable final InvalidSubjectError template) {
        if (template == null) {
            return null;
        }
        InvalidSubjectErrorImpl instance = new InvalidSubjectErrorImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<InvalidSubjectError> typeReference() {
        return new tools.jackson.core.type.TypeReference<InvalidSubjectError>() {
            @Override
