...
public interface LineItemQuantityAboveLimitError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<LineItemQuantityAboveLimitError> typeReference() {
        return new tools.jackson.core.type.TypeReference<LineItemQuantityAboveLimitError>() {
            @Override
