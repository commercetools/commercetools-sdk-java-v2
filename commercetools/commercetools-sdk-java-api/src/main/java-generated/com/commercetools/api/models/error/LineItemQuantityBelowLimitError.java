...
public interface LineItemQuantityBelowLimitError extends ErrorObject {
     ...
     */
    public static com.fasterxml.jackson.core.type.TypeReference<LineItemQuantityBelowLimitError> typeReference() {
        return new com.fasterxml.jackson.core.type.TypeReference<LineItemQuantityBelowLimitError>() {
            @Override
