...
public class MaxCartDiscountsReachedErrorImpl implements MaxCartDiscountsReachedError, ModelBase {
     ...
     */
    @JsonCreator
    MaxCartDiscountsReachedErrorImpl(@JsonProperty("message") final String message,
     ...
     */
    public MaxCartDiscountsReachedErrorImpl() {
        this.code = MAX_CART_DISCOUNTS_REACHED;
    }
    ...
    public boolean equals(Object o) {
        ...
        MaxCartDiscountsReachedErrorImpl that = (MaxCartDiscountsReachedErrorImpl) o;
