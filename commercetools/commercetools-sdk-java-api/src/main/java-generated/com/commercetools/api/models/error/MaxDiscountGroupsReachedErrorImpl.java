...
public class MaxDiscountGroupsReachedErrorImpl implements MaxDiscountGroupsReachedError, ModelBase {
     ...
     */
    @JsonCreator
    MaxDiscountGroupsReachedErrorImpl(@JsonProperty("message") final String message,
     ...
     */
    public MaxDiscountGroupsReachedErrorImpl() {
        this.code = MAX_DISCOUNT_GROUPS_REACHED;
    }
    ...
    public boolean equals(Object o) {
        ...
        MaxDiscountGroupsReachedErrorImpl that = (MaxDiscountGroupsReachedErrorImpl) o;
    ...
    public MaxDiscountGroupsReachedError copyDeep() {
        return MaxDiscountGroupsReachedError.deepCopy(this);
    }
}
