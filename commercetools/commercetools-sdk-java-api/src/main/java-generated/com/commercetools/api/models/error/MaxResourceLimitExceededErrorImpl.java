...
public final class MaxResourceLimitExceededErrorImpl implements MaxResourceLimitExceededError {
    ...
    @JsonCreator
    MaxResourceLimitExceededErrorImpl(@JsonProperty("message") final String message, @JsonProperty("exceededResource") final com.commercetools.api.models.common.ReferenceTypeId exceededResource) {
