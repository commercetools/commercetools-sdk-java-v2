...
public interface MissingDependencyError extends ErrorObject {
     ...
     */
    public static com.fasterxml.jackson.core.type.TypeReference<MissingDependencyError> typeReference() {
        return new com.fasterxml.jackson.core.type.TypeReference<MissingDependencyError>() {
            @Override
