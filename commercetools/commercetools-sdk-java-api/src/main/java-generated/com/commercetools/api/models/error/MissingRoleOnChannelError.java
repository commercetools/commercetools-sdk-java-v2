...
public interface MissingRoleOnChannelError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MissingRoleOnChannelError> typeReference() {
        return new tools.jackson.core.type.TypeReference<MissingRoleOnChannelError>() {
            @Override
