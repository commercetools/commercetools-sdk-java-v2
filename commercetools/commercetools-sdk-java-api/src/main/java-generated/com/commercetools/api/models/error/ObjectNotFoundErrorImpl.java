...
public class ObjectNotFoundErrorImpl implements ObjectNotFoundError, ModelBase {
     ...
     */
    @JsonCreator
    ObjectNotFoundErrorImpl(@JsonProperty("message") final String message, @JsonProperty("values") final Map<String, java.lang.Object> values) {
    ...
    public boolean equals(Object o) {
        ...
        ObjectNotFoundErrorImpl that = (ObjectNotFoundErrorImpl) o;
