...
public interface OverCapacityError extends ErrorObject {
    ...
    /**
     * factory method to create a shallow copy OverCapacityError
     ...
     */
    @Nullable
    public static OverCapacityError deepCopy(@Nullable final OverCapacityError template) {
        if (template == null) {
            return null;
        }
        OverCapacityErrorImpl instance = new OverCapacityErrorImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<OverCapacityError> typeReference() {
        return new tools.jackson.core.type.TypeReference<OverCapacityError>() {
            @Override
