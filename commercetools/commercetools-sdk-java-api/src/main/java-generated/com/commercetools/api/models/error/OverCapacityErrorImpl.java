...
public class OverCapacityErrorImpl implements OverCapacityError, ModelBase {
     ...
     */
    @JsonCreator
    OverCapacityErrorImpl(@JsonProperty("message") final String message, @JsonProperty("values") final Map<String, java.lang.Object> values) {
    ...
    public boolean equals(Object o) {
        ...
        OverCapacityErrorImpl that = (OverCapacityErrorImpl) o;
