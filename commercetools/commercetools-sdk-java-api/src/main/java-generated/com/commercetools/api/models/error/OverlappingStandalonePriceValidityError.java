...
import com.commercetools.api.models.error.OverlappingStandalonePriceValidityErrorImpl;
...
public interface OverlappingStandalonePriceValidityError extends ErrorObject {
     ...
     */
    @Nullable
    public static OverlappingStandalonePriceValidityError deepCopy(@Nullable final OverlappingStandalonePriceValidityError template) {
        if (template == null) {
            return null;
        }
        OverlappingStandalonePriceValidityErrorImpl instance = new OverlappingStandalonePriceValidityErrorImpl();
     ...
     * @return builder
     */
    public static OverlappingStandalonePriceValidityErrorBuilder builder(final OverlappingStandalonePriceValidityError template) {
     ...
     * @return mapped value
     */
    default <T> T withOverlappingStandalonePriceValidityError(Function<OverlappingStandalonePriceValidityError, T> helper) {
