...
public interface RecurringOrderFailureError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrderFailureError> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrderFailureError>() {
            @Override
