...
public class RecurringOrderFailureErrorImpl implements RecurringOrderFailureError, ModelBase {
     ...
     */
    @JsonCreator
    RecurringOrderFailureErrorImpl(@JsonProperty("message") final String message,
     ...
     */
    public RecurringOrderFailureErrorImpl() {
        this.code = RECURRING_ORDER_FAILURE;
    }
    ...
    public boolean equals(Object o) {
        ...
        RecurringOrderFailureErrorImpl that = (RecurringOrderFailureErrorImpl) o;
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder(17, 37).append(code).append(message).append(values).append(details).toHashCode();
    }
    ...
    public RecurringOrderFailureError copyDeep() {
        return RecurringOrderFailureError.deepCopy(this);
    }
}
