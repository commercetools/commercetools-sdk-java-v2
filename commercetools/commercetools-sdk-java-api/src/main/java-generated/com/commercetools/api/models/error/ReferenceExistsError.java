...
public interface ReferenceExistsError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ReferenceExistsError> typeReference() {
        return new tools.jackson.core.type.TypeReference<ReferenceExistsError>() {
            @Override
