...
public class RequiredFieldErrorImpl implements RequiredFieldError, ModelBase {
     ...
     */
    @JsonCreator
    RequiredFieldErrorImpl(@JsonProperty("message") final String message, @JsonProperty("values") final Map<String, java.lang.Object> values, @JsonProperty("field") final String field) {
