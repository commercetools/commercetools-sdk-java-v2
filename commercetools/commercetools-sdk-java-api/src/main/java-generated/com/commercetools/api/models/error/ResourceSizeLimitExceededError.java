...
public interface ResourceSizeLimitExceededError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ResourceSizeLimitExceededError> typeReference() {
        return new tools.jackson.core.type.TypeReference<ResourceSizeLimitExceededError>() {
            @Override
