...
public interface SearchExecutionFailureError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchExecutionFailureError> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchExecutionFailureError>() {
            @Override
