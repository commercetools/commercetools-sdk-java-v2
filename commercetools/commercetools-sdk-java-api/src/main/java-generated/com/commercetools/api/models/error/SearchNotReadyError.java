...
public interface SearchNotReadyError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchNotReadyError> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchNotReadyError>() {
            @Override
