 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SemanticError")
...
public interface SemanticErrorError extends ErrorObject {
     ...
     */
    @Nullable
    public static SemanticErrorError deepCopy(@Nullable final SemanticErrorError template) {
        if (template == null) {
            return null;
        }
        SemanticErrorErrorImpl instance = new SemanticErrorErrorImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<SemanticErrorError> typeReference() {
        return new tools.jackson.core.type.TypeReference<SemanticErrorError>() {
            @Override
