...
public interface ShippingMethodDoesNotMatchCartError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodDoesNotMatchCartError> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodDoesNotMatchCartError>() {
            @Override
