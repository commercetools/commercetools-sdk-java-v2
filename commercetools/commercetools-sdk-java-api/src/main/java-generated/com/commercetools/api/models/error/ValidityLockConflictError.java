...
public interface ValidityLockConflictError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ValidityLockConflictError> typeReference() {
        return new tools.jackson.core.type.TypeReference<ValidityLockConflictError>() {
            @Override
