...
public class ValidityLockConflictErrorImpl implements ValidityLockConflictError, ModelBase {
     ...
     */
    @JsonCreator
    ValidityLockConflictErrorImpl(@JsonProperty("message") final String message,
     ...
     */
    public ValidityLockConflictErrorImpl() {
        this.code = VALIDITY_LOCK_CONFLICT;
    }
    ...
    public boolean equals(Object o) {
        ...
        ValidityLockConflictErrorImpl that = (ValidityLockConflictErrorImpl) o;
    ...
    public ValidityLockConflictError copyDeep() {
        return ValidityLockConflictError.deepCopy(this);
    }
}
