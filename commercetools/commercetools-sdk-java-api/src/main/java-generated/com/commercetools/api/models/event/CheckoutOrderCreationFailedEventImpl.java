...
public class CheckoutOrderCreationFailedEventImpl implements CheckoutOrderCreationFailedEvent, ModelBase {
     ...
     */
    @JsonCreator
    CheckoutOrderCreationFailedEventImpl(@JsonProperty("id") final String id,
            ...
            @JsonProperty("data") final com.commercetools.api.models.event.CheckoutMessageOrderPayloadBaseData data) {
        this.id = id;
        this.notificationType = notificationType;
        this.resourceType = resourceType;
        this.createdAt = createdAt;
        this.data = data;
        this.type = EventType.findEnum("CheckoutOrderCreationFailed");
    }

    /**
     * create empty instance
     */
    public CheckoutOrderCreationFailedEventImpl() {
        this.type = EventType.findEnum("CheckoutOrderCreationFailed");
    }
    ...
    public void setData(final com.commercetools.api.models.event.CheckoutMessageOrderPayloadBaseData data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        CheckoutOrderCreationFailedEventImpl that = (CheckoutOrderCreationFailedEventImpl) o;
    ...
    public CheckoutOrderCreationFailedEvent copyDeep() {
        return CheckoutOrderCreationFailedEvent.deepCopy(this);
    }
}
