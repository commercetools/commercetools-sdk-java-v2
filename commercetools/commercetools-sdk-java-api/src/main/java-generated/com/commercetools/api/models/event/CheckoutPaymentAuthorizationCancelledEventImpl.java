...
public class CheckoutPaymentAuthorizationCancelledEventImpl
        implements CheckoutPaymentAuthorizationCancelledEvent, ModelBase {
     ...
     */
    @JsonCreator
    CheckoutPaymentAuthorizationCancelledEventImpl(@JsonProperty("id") final String id,
        ...
        this.data = data;
        this.type = EventType.findEnum("CheckoutPaymentAuthorizationCancelled");
    }

    /**
     * create empty instance
     */
    public CheckoutPaymentAuthorizationCancelledEventImpl() {
        this.type = EventType.findEnum("CheckoutPaymentAuthorizationCancelled");
    }
    ...
    public boolean equals(Object o) {
        ...
        CheckoutPaymentAuthorizationCancelledEventImpl that = (CheckoutPaymentAuthorizationCancelledEventImpl) o;
    ...
    public CheckoutPaymentAuthorizationCancelledEvent copyDeep() {
        return CheckoutPaymentAuthorizationCancelledEvent.deepCopy(this);
    }
}
