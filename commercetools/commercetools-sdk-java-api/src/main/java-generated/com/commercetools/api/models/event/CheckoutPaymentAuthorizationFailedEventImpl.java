...
public class CheckoutPaymentAuthorizationFailedEventImpl implements CheckoutPaymentAuthorizationFailedEvent, ModelBase {
     ...
     */
    @JsonCreator
    CheckoutPaymentAuthorizationFailedEventImpl(@JsonProperty("id") final String id,
        ...
        this.data = data;
        this.type = EventType.findEnum("CheckoutPaymentAuthorizationFailed");
    }

    /**
     * create empty instance
     */
    public CheckoutPaymentAuthorizationFailedEventImpl() {
        this.type = EventType.findEnum("CheckoutPaymentAuthorizationFailed");
    }
    ...
    public boolean equals(Object o) {
        ...
        CheckoutPaymentAuthorizationFailedEventImpl that = (CheckoutPaymentAuthorizationFailedEventImpl) o;
    ...
    public CheckoutPaymentAuthorizationFailedEvent copyDeep() {
        return CheckoutPaymentAuthorizationFailedEvent.deepCopy(this);
    }
}
