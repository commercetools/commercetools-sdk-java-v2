...
public class CheckoutPaymentAuthorizedEventImpl implements CheckoutPaymentAuthorizedEvent, ModelBase {
     ...
     */
    @JsonCreator
    CheckoutPaymentAuthorizedEventImpl(@JsonProperty("id") final String id,
        ...
        this.data = data;
        this.type = EventType.findEnum("CheckoutPaymentAuthorized");
    }

    /**
     * create empty instance
     */
    public CheckoutPaymentAuthorizedEventImpl() {
        this.type = EventType.findEnum("CheckoutPaymentAuthorized");
    }
    ...
    public boolean equals(Object o) {
        ...
        CheckoutPaymentAuthorizedEventImpl that = (CheckoutPaymentAuthorizedEventImpl) o;
    ...
    public CheckoutPaymentAuthorizedEvent copyDeep() {
        return CheckoutPaymentAuthorizedEvent.deepCopy(this);
    }
}
