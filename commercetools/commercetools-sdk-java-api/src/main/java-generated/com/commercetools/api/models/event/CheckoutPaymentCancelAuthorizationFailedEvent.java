...
public interface CheckoutPaymentCancelAuthorizationFailedEvent extends Event {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CheckoutPaymentCancelAuthorizationFailedEvent> typeReference() {
        return new tools.jackson.core.type.TypeReference<CheckoutPaymentCancelAuthorizationFailedEvent>() {
            @Override
