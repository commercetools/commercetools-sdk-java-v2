...
public class CheckoutPaymentCancelAuthorizationFailedEventImpl
        implements CheckoutPaymentCancelAuthorizationFailedEvent, ModelBase {
     ...
     */
    @JsonCreator
    CheckoutPaymentCancelAuthorizationFailedEventImpl(@JsonProperty("id") final String id,
        ...
        this.data = data;
        this.type = EventType.findEnum("CheckoutPaymentCancelAuthorizationFailed");
    }

    /**
     * create empty instance
     */
    public CheckoutPaymentCancelAuthorizationFailedEventImpl() {
        this.type = EventType.findEnum("CheckoutPaymentCancelAuthorizationFailed");
    }
    ...
    public boolean equals(Object o) {
        ...
        CheckoutPaymentCancelAuthorizationFailedEventImpl that = (CheckoutPaymentCancelAuthorizationFailedEventImpl) o;
    ...
    public CheckoutPaymentCancelAuthorizationFailedEvent copyDeep() {
        return CheckoutPaymentCancelAuthorizationFailedEvent.deepCopy(this);
    }
}
