...
public interface CheckoutPaymentChargeFailedEvent extends Event {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CheckoutPaymentChargeFailedEvent> typeReference() {
        return new tools.jackson.core.type.TypeReference<CheckoutPaymentChargeFailedEvent>() {
            @Override
