...
public class CheckoutPaymentChargeFailedEventImpl implements CheckoutPaymentChargeFailedEvent, ModelBase {
     ...
     */
    @JsonCreator
    CheckoutPaymentChargeFailedEventImpl(@JsonProperty("id") final String id,
        ...
        this.data = data;
        this.type = EventType.findEnum("CheckoutPaymentChargeFailed");
    }

    /**
     * create empty instance
     */
    public CheckoutPaymentChargeFailedEventImpl() {
        this.type = EventType.findEnum("CheckoutPaymentChargeFailed");
    }
    ...
    public boolean equals(Object o) {
        ...
        CheckoutPaymentChargeFailedEventImpl that = (CheckoutPaymentChargeFailedEventImpl) o;
    ...
    public CheckoutPaymentChargeFailedEvent copyDeep() {
        return CheckoutPaymentChargeFailedEvent.deepCopy(this);
    }
}
