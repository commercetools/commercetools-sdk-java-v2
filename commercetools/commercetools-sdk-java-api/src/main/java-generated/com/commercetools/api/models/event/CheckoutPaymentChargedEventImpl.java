...
public class CheckoutPaymentChargedEventImpl implements CheckoutPaymentChargedEvent, ModelBase {
     ...
     */
    @JsonCreator
    CheckoutPaymentChargedEventImpl(@JsonProperty("id") final String id,
        ...
        this.data = data;
        this.type = EventType.findEnum("CheckoutPaymentCharged");
    }

    /**
     * create empty instance
     */
    public CheckoutPaymentChargedEventImpl() {
        this.type = EventType.findEnum("CheckoutPaymentCharged");
    }
    ...
    public boolean equals(Object o) {
        ...
        CheckoutPaymentChargedEventImpl that = (CheckoutPaymentChargedEventImpl) o;
    ...
    public CheckoutPaymentChargedEvent copyDeep() {
        return CheckoutPaymentChargedEvent.deepCopy(this);
    }
}
