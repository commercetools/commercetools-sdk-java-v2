...
public interface CheckoutPaymentRefundFailedEvent extends Event {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CheckoutPaymentRefundFailedEvent> typeReference() {
        return new tools.jackson.core.type.TypeReference<CheckoutPaymentRefundFailedEvent>() {
            @Override
