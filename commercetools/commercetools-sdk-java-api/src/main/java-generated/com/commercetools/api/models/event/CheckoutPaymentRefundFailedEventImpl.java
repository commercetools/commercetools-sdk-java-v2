...
public class CheckoutPaymentRefundFailedEventImpl implements CheckoutPaymentRefundFailedEvent, ModelBase {
     ...
     */
    @JsonCreator
    CheckoutPaymentRefundFailedEventImpl(@JsonProperty("id") final String id,
        ...
        this.data = data;
        this.type = EventType.findEnum("CheckoutPaymentRefundFailed");
    }

    /**
     * create empty instance
     */
    public CheckoutPaymentRefundFailedEventImpl() {
        this.type = EventType.findEnum("CheckoutPaymentRefundFailed");
    }
    ...
    public boolean equals(Object o) {
        ...
        CheckoutPaymentRefundFailedEventImpl that = (CheckoutPaymentRefundFailedEventImpl) o;
    ...
    public CheckoutPaymentRefundFailedEvent copyDeep() {
        return CheckoutPaymentRefundFailedEvent.deepCopy(this);
    }
}
