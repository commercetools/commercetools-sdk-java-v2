...
public interface ImportContainerCreatedEventData {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ImportContainerCreatedEventData> typeReference() {
        return new tools.jackson.core.type.TypeReference<ImportContainerCreatedEventData>() {
            @Override
