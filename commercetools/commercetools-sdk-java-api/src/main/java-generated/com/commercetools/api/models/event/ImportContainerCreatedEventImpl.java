...
public class ImportContainerCreatedEventImpl implements ImportContainerCreatedEvent, ModelBase {
     ...
     */
    @JsonCreator
    ImportContainerCreatedEventImpl(@JsonProperty("id") final String id,
            ...
            @JsonProperty("data") final com.commercetools.api.models.event.ImportContainerCreatedEventData data) {
        this.id = id;
        this.notificationType = notificationType;
        this.resourceType = resourceType;
        this.createdAt = createdAt;
        this.data = data;
        this.type = EventType.findEnum("ImportContainerCreated");
    }

    /**
     * create empty instance
     */
    public ImportContainerCreatedEventImpl() {
        this.type = EventType.findEnum("ImportContainerCreated");
    }
    ...
    public void setData(final com.commercetools.api.models.event.ImportContainerCreatedEventData data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        ImportContainerCreatedEventImpl that = (ImportContainerCreatedEventImpl) o;
    ...
    public ImportContainerCreatedEvent copyDeep() {
        return ImportContainerCreatedEvent.deepCopy(this);
    }
}
