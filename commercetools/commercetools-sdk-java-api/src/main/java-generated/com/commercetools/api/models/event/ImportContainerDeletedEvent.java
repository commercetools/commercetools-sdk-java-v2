...
public interface ImportContainerDeletedEvent extends Event {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ImportContainerDeletedEvent> typeReference() {
        return new tools.jackson.core.type.TypeReference<ImportContainerDeletedEvent>() {
            @Override
