...
public class ImportContainerDeletedEventImpl implements ImportContainerDeletedEvent, ModelBase {
     ...
     */
    @JsonCreator
    ImportContainerDeletedEventImpl(@JsonProperty("id") final String id,
            ...
            @JsonProperty("data") final com.commercetools.api.models.event.ImportContainerDeletedEventData data) {
        this.id = id;
        this.notificationType = notificationType;
        this.resourceType = resourceType;
        this.createdAt = createdAt;
        this.data = data;
        this.type = EventType.findEnum("ImportContainerDeleted");
    }

    /**
     * create empty instance
     */
    public ImportContainerDeletedEventImpl() {
        this.type = EventType.findEnum("ImportContainerDeleted");
    }
    ...
    public void setData(final com.commercetools.api.models.event.ImportContainerDeletedEventData data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        ImportContainerDeletedEventImpl that = (ImportContainerDeletedEventImpl) o;
    ...
    public ImportContainerDeletedEvent copyDeep() {
        return ImportContainerDeletedEvent.deepCopy(this);
    }
}
