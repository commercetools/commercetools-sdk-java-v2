...
public interface ImportOperationRejectedEvent extends Event {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ImportOperationRejectedEvent> typeReference() {
        return new tools.jackson.core.type.TypeReference<ImportOperationRejectedEvent>() {
            @Override
