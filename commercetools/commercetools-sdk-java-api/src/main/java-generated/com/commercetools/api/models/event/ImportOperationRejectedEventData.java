...
public interface ImportOperationRejectedEventData {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ImportOperationRejectedEventData> typeReference() {
        return new tools.jackson.core.type.TypeReference<ImportOperationRejectedEventData>() {
            @Override
