...
public class ImportUnresolvedEventImpl implements ImportUnresolvedEvent, ModelBase {
     ...
     */
    @JsonCreator
    ImportUnresolvedEventImpl(@JsonProperty("id") final String id,
            ...
            @JsonProperty("data") final com.commercetools.api.models.event.ImportUnresolvedEventData data) {
        this.id = id;
        this.notificationType = notificationType;
        this.resourceType = resourceType;
        this.createdAt = createdAt;
        this.data = data;
        this.type = EventType.findEnum("ImportUnresolved");
    }

    /**
     * create empty instance
     */
    public ImportUnresolvedEventImpl() {
        this.type = EventType.findEnum("ImportUnresolved");
    }
    ...
    public void setData(final com.commercetools.api.models.event.ImportUnresolvedEventData data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        ImportUnresolvedEventImpl that = (ImportUnresolvedEventImpl) o;
