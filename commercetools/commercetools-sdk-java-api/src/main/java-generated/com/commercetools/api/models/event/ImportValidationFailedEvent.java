 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ImportValidationFailed")
...
public interface ImportValidationFailedEvent extends Event {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ImportValidationFailedEvent> typeReference() {
        return new tools.jackson.core.type.TypeReference<ImportValidationFailedEvent>() {
            @Override
