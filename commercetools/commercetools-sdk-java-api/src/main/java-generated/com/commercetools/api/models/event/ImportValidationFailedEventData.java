...
/**
 *  <p>The <code>data</code> of the <a href="https://docs.commercetools.com/apis/ctp:api:type:ImportValidationFailedEvent" rel="nofollow">Import Validation Failed Event</a>.</p>
 *
 * <hr>
...
public interface ImportValidationFailedEventData {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ImportValidationFailedEventData> typeReference() {
        return new tools.jackson.core.type.TypeReference<ImportValidationFailedEventData>() {
            @Override
