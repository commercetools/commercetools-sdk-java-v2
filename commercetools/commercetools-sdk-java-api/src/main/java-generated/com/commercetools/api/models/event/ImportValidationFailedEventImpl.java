...
/**
 *  <p>Generated when an <a href="https://docs.commercetools.com/apis/ctp:import:type:ImportOperation" rel="nofollow">Import Operation</a> has the <code>validationFailed</code> <a href="https://docs.commercetools.com/apis/ctp:import:type:ProcessingState" rel="nofollow">ProcessingState</a>.</p>
 */
@Generated(value = "io.vrap.rmf.codegen.rendering.CoreCodeGenerator", comments = "https://github.com/commercetools/rmf-codegen")
public class ImportValidationFailedEventImpl implements ImportValidationFailedEvent, ModelBase {
     ...
     */
    @JsonCreator
    ImportValidationFailedEventImpl(@JsonProperty("id") final String id,
            ...
            @JsonProperty("data") final com.commercetools.api.models.event.ImportValidationFailedEventData data) {
        this.id = id;
        this.notificationType = notificationType;
        this.resourceType = resourceType;
        this.createdAt = createdAt;
        this.data = data;
        this.type = EventType.findEnum("ImportValidationFailed");
    }

    /**
     * create empty instance
     */
    public ImportValidationFailedEventImpl() {
        this.type = EventType.findEnum("ImportValidationFailed");
    }
    ...
    public void setData(final com.commercetools.api.models.event.ImportValidationFailedEventData data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        ImportValidationFailedEventImpl that = (ImportValidationFailedEventImpl) o;
