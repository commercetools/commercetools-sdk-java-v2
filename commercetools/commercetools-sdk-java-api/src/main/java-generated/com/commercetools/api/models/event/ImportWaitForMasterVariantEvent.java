...
public interface ImportWaitForMasterVariantEvent extends Event {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ImportWaitForMasterVariantEvent> typeReference() {
        return new tools.jackson.core.type.TypeReference<ImportWaitForMasterVariantEvent>() {
            @Override
