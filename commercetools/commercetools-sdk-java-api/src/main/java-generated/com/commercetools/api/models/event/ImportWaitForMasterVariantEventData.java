...
public interface ImportWaitForMasterVariantEventData {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ImportWaitForMasterVariantEventData> typeReference() {
        return new tools.jackson.core.type.TypeReference<ImportWaitForMasterVariantEventData>() {
            @Override
