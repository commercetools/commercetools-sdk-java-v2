...
public class AWSLambdaDestinationImpl implements AWSLambdaDestination, ModelBase {
     ...
     */
    @JsonCreator
    AWSLambdaDestinationImpl(@JsonProperty("arn") final String arn, @JsonProperty("accessKey") final String accessKey, @JsonProperty("accessSecret") final String accessSecret) {
        this.arn = arn;
