...
public interface ExtensionAdditionalContext {
     ...
     */
    public static com.fasterxml.jackson.core.type.TypeReference<ExtensionAdditionalContext> typeReference() {
        return new com.fasterxml.jackson.core.type.TypeReference<ExtensionAdditionalContext>() {
            @Override
