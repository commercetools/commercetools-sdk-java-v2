...
public interface ExtensionChangeTriggersAction extends ExtensionUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ExtensionChangeTriggersAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ExtensionChangeTriggersAction>() {
            @Override
