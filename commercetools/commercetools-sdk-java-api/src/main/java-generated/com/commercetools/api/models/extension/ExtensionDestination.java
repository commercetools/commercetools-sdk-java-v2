...
public interface ExtensionDestination {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ExtensionDestination> typeReference() {
        return new tools.jackson.core.type.TypeReference<ExtensionDestination>() {
            @Override
