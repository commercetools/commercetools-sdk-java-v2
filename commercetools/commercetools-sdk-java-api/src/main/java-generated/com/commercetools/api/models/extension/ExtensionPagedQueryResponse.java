...
/**
 *  <p><span>PagedQueryResult</span> with <code>results</code> containing an array of <a href="https://docs.commercetools.com/apis/ctp:api:type:Extension" rel="nofollow">Extension</a>.</p>
 *
 * <hr>
...
public interface ExtensionPagedQueryResponse
    ...
    /**
     * factory method
     * @return instance of ExtensionPagedQueryResponse
     */
    ...
    /**
     * factory method to create a shallow copy ExtensionPagedQueryResponse
     ...
     */
    @Nullable
    public static ExtensionPagedQueryResponse deepCopy(@Nullable final ExtensionPagedQueryResponse template) {
        if (template == null) {
            return null;
        }
        ExtensionPagedQueryResponseImpl instance = new ExtensionPagedQueryResponseImpl();
        ...
        instance.setResults(Optional.ofNullable(template.getResults())
                .map(t -> t.stream()
                        .map(com.commercetools.api.models.extension.Extension::deepCopy)
    ...
    /**
     * builder factory method for ExtensionPagedQueryResponse
     * @return builder
     */
     ...
     */
    public static tools.jackson.core.type.TypeReference<ExtensionPagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<ExtensionPagedQueryResponse>() {
            @Override
