...
public class ExtensionPagedQueryResponseBuilder implements Builder<ExtensionPagedQueryResponse> {
    ...
    public ExtensionPagedQueryResponseBuilder plusResults( final com.commercetools.api.models.extension.Extension ...results) {
    ...
    public ExtensionPagedQueryResponseBuilder plusResults(Function<com.commercetools.api.models.extension.ExtensionBuilder, com.commercetools.api.models.extension.ExtensionBuilder> builder) {
        if (this.results == null) {
            this.results = new ArrayList<>();
        }
    ...
    public ExtensionPagedQueryResponseBuilder withResults(Function<com.commercetools.api.models.extension.ExtensionBuilder, com.commercetools.api.models.extension.ExtensionBuilder> builder) {
        this.results = new ArrayList<>();
        this.results.add(builder.apply(com.commercetools.api.models.extension.ExtensionBuilder.of()).build());
        return this;
    }
    ...
    public ExtensionPagedQueryResponseBuilder addResults(Function<com.commercetools.api.models.extension.ExtensionBuilder, com.commercetools.api.models.extension.Extension> builder) {
    ...
    public ExtensionPagedQueryResponseBuilder setResults(Function<com.commercetools.api.models.extension.ExtensionBuilder, com.commercetools.api.models.extension.Extension> builder) {
