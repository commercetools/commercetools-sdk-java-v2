...
public final class ExtensionPagedQueryResponseImpl implements ExtensionPagedQueryResponse {
    ...
    @JsonCreator
    ExtensionPagedQueryResponseImpl(@JsonProperty("limit") final Long limit, @JsonProperty("count") final Long count, @JsonProperty("total") final Long total, @JsonProperty("offset") final Long offset, @JsonProperty("results") final java.util.List<com.commercetools.api.models.extension.Extension> results) {
        this.limit = limit;
        this.count = count;
        this.total = total;
        this.offset = offset;
