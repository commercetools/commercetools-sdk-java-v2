...
public interface ExtensionReference extends Reference {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ExtensionReference> typeReference() {
        return new tools.jackson.core.type.TypeReference<ExtensionReference>() {
            @Override
