...
public class ExtensionResourceIdentifierImpl implements ExtensionResourceIdentifier, ModelBase {
     ...
     */
    @JsonCreator
    ExtensionResourceIdentifierImpl(@JsonProperty("id") final String id, @JsonProperty("key") final String key) {
        this.id = id;
        this.key = key;
     ...
     */
    public ExtensionResourceIdentifierImpl() {
        this.typeId = ReferenceTypeId.findEnum("extension");
    }
    ...
    public boolean equals(Object o) {
        ...
        ExtensionResourceIdentifierImpl that = (ExtensionResourceIdentifierImpl) o;
    ...
    public ExtensionResourceIdentifier copyDeep() {
        return ExtensionResourceIdentifier.deepCopy(this);
    }
}
