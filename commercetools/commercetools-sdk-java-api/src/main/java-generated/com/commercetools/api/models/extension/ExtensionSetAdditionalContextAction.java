...
public interface ExtensionSetAdditionalContextAction extends ExtensionUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ExtensionSetAdditionalContextAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ExtensionSetAdditionalContextAction>() {
            @Override
