...
public interface ExtensionSetDependenciesAction extends ExtensionUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ExtensionSetDependenciesAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ExtensionSetDependenciesAction>() {
            @Override
