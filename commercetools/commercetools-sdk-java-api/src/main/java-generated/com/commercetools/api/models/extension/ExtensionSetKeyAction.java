...
public interface ExtensionSetKeyAction extends ExtensionUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ExtensionSetKeyAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ExtensionSetKeyAction>() {
            @Override
