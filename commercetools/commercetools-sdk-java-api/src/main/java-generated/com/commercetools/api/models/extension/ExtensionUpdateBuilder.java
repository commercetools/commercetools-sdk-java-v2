...
public class ExtensionUpdateBuilder implements Builder<ExtensionUpdate> {
    ...
    public ExtensionUpdateBuilder actions( final java.util.List<com.commercetools.api.models.extension.ExtensionUpdateAction> actions) {
    ...
    public ExtensionUpdateBuilder plusActions( final com.commercetools.api.models.extension.ExtensionUpdateAction ...actions) {
    ...
    public ExtensionUpdateBuilder plusActions(Function<com.commercetools.api.models.extension.ExtensionUpdateActionBuilder, Builder<? extends com.commercetools.api.models.extension.ExtensionUpdateAction>> builder) {
        if (this.actions == null) {
            this.actions = new ArrayList<>();
        }
        this.actions.add(builder.apply(com.commercetools.api.models.extension.ExtensionUpdateActionBuilder.of()).build());
        return this;
    }
    ...
    public ExtensionUpdateBuilder withActions(Function<com.commercetools.api.models.extension.ExtensionUpdateActionBuilder, Builder<? extends com.commercetools.api.models.extension.ExtensionUpdateAction>> builder) {
        this.actions = new ArrayList<>();
        this.actions.add(builder.apply(com.commercetools.api.models.extension.ExtensionUpdateActionBuilder.of()).build());
        return this;
    }
