...
public class ExtensionUpdateImpl implements ExtensionUpdate, ModelBase {
    ...
    @JsonCreator
    ExtensionUpdateImpl(@JsonProperty("version") final Long version,
            @JsonProperty("actions") final java.util.List<com.commercetools.api.models.extension.ExtensionUpdateAction> actions) {
    ...
    */
    ...
    public void setActions(final com.commercetools.api.models.extension.ExtensionUpdateAction... actions) {
    ...
    public boolean equals(Object o) {
        ...
        ExtensionUpdateImpl that = (ExtensionUpdateImpl) o;
