...
public final class GraphQLErrorImpl implements GraphQLError {
    ...
    @JsonCreator
    GraphQLErrorImpl(@JsonProperty("message") final String message, @JsonProperty("locations") final java.util.List<com.commercetools.api.models.graph_ql.GraphQLErrorLocation> locations, @JsonProperty("path") final java.util.List<java.lang.Object> path) {
