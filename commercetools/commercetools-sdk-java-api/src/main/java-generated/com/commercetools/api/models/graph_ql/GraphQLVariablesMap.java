...
public interface GraphQLVariablesMap {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLVariablesMap> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLVariablesMap>() {
            @Override
