...
public interface InventoryEntrySetCustomFieldAction extends InventoryEntryUpdateAction {
    ...
    /**
     * discriminator value for InventoryEntrySetCustomFieldAction
     */
    ...
    /**
     * factory method
     * @return instance of InventoryEntrySetCustomFieldAction
     */
    ...
    /**
     * factory method to create a shallow copy InventoryEntrySetCustomFieldAction
     ...
     */
    @Nullable
    public static InventoryEntrySetCustomFieldAction deepCopy(
            @Nullable final InventoryEntrySetCustomFieldAction template) {
        if (template == null) {
            return null;
        }
        InventoryEntrySetCustomFieldActionImpl instance = new InventoryEntrySetCustomFieldActionImpl();
    ...
    /**
     * builder factory method for InventoryEntrySetCustomFieldAction
     * @return builder
     */
     ...
     */
    public static tools.jackson.core.type.TypeReference<InventoryEntrySetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<InventoryEntrySetCustomFieldAction>() {
            @Override
