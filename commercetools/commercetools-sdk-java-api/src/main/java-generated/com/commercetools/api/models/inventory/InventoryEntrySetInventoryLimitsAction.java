...
public interface InventoryEntrySetInventoryLimitsAction extends InventoryEntryUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<InventoryEntrySetInventoryLimitsAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<InventoryEntrySetInventoryLimitsAction>() {
            @Override
