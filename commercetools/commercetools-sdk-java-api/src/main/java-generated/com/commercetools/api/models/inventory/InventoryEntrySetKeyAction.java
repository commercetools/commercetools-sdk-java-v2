...
public interface InventoryEntrySetKeyAction extends InventoryEntryUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<InventoryEntrySetKeyAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<InventoryEntrySetKeyAction>() {
            @Override
