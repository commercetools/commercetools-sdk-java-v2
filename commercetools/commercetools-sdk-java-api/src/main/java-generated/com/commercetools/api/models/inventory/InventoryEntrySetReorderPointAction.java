...
public interface InventoryEntrySetReorderPointAction extends InventoryEntryUpdateAction {
     ...
     */
    public static com.fasterxml.jackson.core.type.TypeReference<InventoryEntrySetReorderPointAction> typeReference() {
        return new com.fasterxml.jackson.core.type.TypeReference<InventoryEntrySetReorderPointAction>() {
            @Override
