...
public class InventoryEntrySetReorderPointActionImpl implements InventoryEntrySetReorderPointAction, ModelBase {
     ...
     */
    @JsonCreator
    InventoryEntrySetReorderPointActionImpl(@JsonProperty("quantity") final Integer quantity) {
        this.quantity = quantity;
        this.action = SET_REORDER_POINT;
    }

    /**
     * create empty instance
     */
    public InventoryEntrySetReorderPointActionImpl() {
        this.action = SET_REORDER_POINT;
    }
    ...
    public boolean equals(Object o) {
        ...
        InventoryEntrySetReorderPointActionImpl that = (InventoryEntrySetReorderPointActionImpl) o;
    ...
    public InventoryEntrySetReorderPointAction copyDeep() {
        return InventoryEntrySetReorderPointAction.deepCopy(this);
    }
}
