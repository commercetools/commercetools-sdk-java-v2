...
public interface InventoryEntrySetRestockableInDaysAction extends InventoryEntryUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<InventoryEntrySetRestockableInDaysAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<InventoryEntrySetRestockableInDaysAction>() {
            @Override
