...
public interface InventoryEntryUpdate extends com.commercetools.api.models.ResourceUpdate<InventoryEntryUpdate, InventoryEntryUpdateAction, InventoryEntryUpdateBuilder> {
    ...
    public static InventoryEntryUpdate deepCopy(@Nullable final InventoryEntryUpdate template) {
        ...
        instance.setActions(Optional.ofNullable(template.getActions())
                .map(t -> t.stream().map(com.commercetools.api.models.inventory.InventoryEntryUpdateAction::deepCopy).collect(Collectors.toList()))
                .orElse(null));
        return instance;
    }
