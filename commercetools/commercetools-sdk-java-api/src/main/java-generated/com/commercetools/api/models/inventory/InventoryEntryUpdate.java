...
public interface InventoryEntryUpdate extends
    ...
    /**
     *  <p>Expected version of the InventoryEntry on which the changes should be applied. If the expected version does not match the actual version, a <a href="https://docs.commercetools.com/apis/ctp:api:type:ConcurrentModificationError" rel="nofollow">ConcurrentModification</a> error will be returned.</p>
     * @return version
     */
    @NotNull
    ...
    /**
     * factory method to create a shallow copy InventoryEntryUpdate
     ...
     */
    @Nullable
    public static InventoryEntryUpdate deepCopy(@Nullable final InventoryEntryUpdate template) {
        if (template == null) {
            return null;
        }
        InventoryEntryUpdateImpl instance = new InventoryEntryUpdateImpl();
        ...
        instance.setActions(Optional.ofNullable(template.getActions())
                .map(t -> t.stream()
                        .map(com.commercetools.api.models.inventory.InventoryEntryUpdateAction::deepCopy)
     ...
     */
    public static tools.jackson.core.type.TypeReference<InventoryEntryUpdate> typeReference() {
        return new tools.jackson.core.type.TypeReference<InventoryEntryUpdate>() {
            @Override
