...
public interface InventoryPagedQueryResponse extends com.commercetools.api.models.ResourcePagedQueryResponse<InventoryEntry> {
    ...
    /**
     * factory method to create a shallow copy InventoryPagedQueryResponse
     ...
     */
    @Nullable
    public static InventoryPagedQueryResponse deepCopy(@Nullable final InventoryPagedQueryResponse template) {
        if (template == null) {
            return null;
        }
        InventoryPagedQueryResponseImpl instance = new InventoryPagedQueryResponseImpl();
        ...
        instance.setResults(Optional.ofNullable(template.getResults())
                .map(t -> t.stream().map(com.commercetools.api.models.inventory.InventoryEntry::deepCopy).collect(Collectors.toList()))
                .orElse(null));
        return instance;
    }
