...
public interface InventoryPagedQueryResponse
     ...
     */
    public static tools.jackson.core.type.TypeReference<InventoryPagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<InventoryPagedQueryResponse>() {
            @Override
