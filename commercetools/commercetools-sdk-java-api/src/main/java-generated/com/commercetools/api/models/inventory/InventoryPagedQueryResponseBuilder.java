...
public class InventoryPagedQueryResponseBuilder implements Builder<InventoryPagedQueryResponse> {
    ...
    public InventoryPagedQueryResponseBuilder results( final com.commercetools.api.models.inventory.InventoryEntry ...results) {
    ...
    public InventoryPagedQueryResponseBuilder results( final java.util.List<com.commercetools.api.models.inventory.InventoryEntry> results) {
    ...
    public InventoryPagedQueryResponseBuilder plusResults( final com.commercetools.api.models.inventory.InventoryEntry ...results) {
    ...
    public InventoryPagedQueryResponseBuilder plusResults(Function<com.commercetools.api.models.inventory.InventoryEntryBuilder, com.commercetools.api.models.inventory.InventoryEntryBuilder> builder) {
        if (this.results == null) {
            this.results = new ArrayList<>();
        }
    ...
    public InventoryPagedQueryResponseBuilder withResults(Function<com.commercetools.api.models.inventory.InventoryEntryBuilder, com.commercetools.api.models.inventory.InventoryEntryBuilder> builder) {
        this.results = new ArrayList<>();
        this.results.add(builder.apply(com.commercetools.api.models.inventory.InventoryEntryBuilder.of()).build());
        return this;
    }
    ...
    public InventoryPagedQueryResponseBuilder addResults(Function<com.commercetools.api.models.inventory.InventoryEntryBuilder, com.commercetools.api.models.inventory.InventoryEntry> builder) {
    ...
    public InventoryPagedQueryResponseBuilder setResults(Function<com.commercetools.api.models.inventory.InventoryEntryBuilder, com.commercetools.api.models.inventory.InventoryEntry> builder) {
