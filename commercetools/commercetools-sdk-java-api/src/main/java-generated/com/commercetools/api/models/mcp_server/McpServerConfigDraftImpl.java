...
public class McpServerConfigDraftImpl implements McpServerConfigDraft, ModelBase {
     ...
     */
    @JsonCreator
    McpServerConfigDraftImpl(@JsonProperty("type") final String type) {
        this.type = type;
    }
     ...
     */
    public McpServerConfigDraftImpl() {
    }
    ...
    public boolean equals(Object o) {
        ...
        McpServerConfigDraftImpl that = (McpServerConfigDraftImpl) o;
    ...
    public McpServerConfigDraft copyDeep() {
        return McpServerConfigDraft.deepCopy(this);
    }
}
