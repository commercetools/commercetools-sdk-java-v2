...
public class McpServerSetNameActionImpl implements McpServerSetNameAction, ModelBase {
     ...
     */
    @JsonCreator
    McpServerSetNameActionImpl(@JsonProperty("name") final com.commercetools.api.models.common.LocalizedString name) {
        this.name = name;
     ...
     */
    public McpServerSetNameActionImpl() {
        this.action = SET_NAME;
    }
    ...
    public boolean equals(Object o) {
        ...
        McpServerSetNameActionImpl that = (McpServerSetNameActionImpl) o;
    ...
    public McpServerSetNameAction copyDeep() {
        return McpServerSetNameAction.deepCopy(this);
    }
}
