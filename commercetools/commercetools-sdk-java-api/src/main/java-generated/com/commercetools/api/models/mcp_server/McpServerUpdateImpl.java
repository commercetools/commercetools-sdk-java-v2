...
public class McpServerUpdateImpl implements McpServerUpdate, ModelBase {
     ...
     */
    @JsonCreator
    McpServerUpdateImpl(@JsonProperty("version") final Long version,
            @JsonProperty("actions") final java.util.List<com.commercetools.api.models.mcp_server.McpServerUpdateAction> actions) {
    ...
    public void setActions(final com.commercetools.api.models.mcp_server.McpServerUpdateAction... actions) {
    ...
    public boolean equals(Object o) {
        ...
        McpServerUpdateImpl that = (McpServerUpdateImpl) o;
    ...
    public McpServerUpdate copyDeep() {
        return McpServerUpdate.deepCopy(this);
    }
}
