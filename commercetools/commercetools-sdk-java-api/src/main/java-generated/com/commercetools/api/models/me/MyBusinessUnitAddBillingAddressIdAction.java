...
public interface MyBusinessUnitAddBillingAddressIdAction extends MyBusinessUnitUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyBusinessUnitAddBillingAddressIdAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyBusinessUnitAddBillingAddressIdAction>() {
            @Override
