...
public class MyBusinessUnitAddBillingAddressIdActionImpl implements MyBusinessUnitAddBillingAddressIdAction, ModelBase {
     ...
     */
    @JsonCreator
    MyBusinessUnitAddBillingAddressIdActionImpl(@JsonProperty("addressId") final String addressId,
     ...
     */
    public MyBusinessUnitAddBillingAddressIdActionImpl() {
        this.action = ADD_BILLING_ADDRESS_ID;
    }
    ...
    public boolean equals(Object o) {
        ...
        MyBusinessUnitAddBillingAddressIdActionImpl that = (MyBusinessUnitAddBillingAddressIdActionImpl) o;
    ...
    public MyBusinessUnitAddBillingAddressIdAction copyDeep() {
        return MyBusinessUnitAddBillingAddressIdAction.deepCopy(this);
    }
}
