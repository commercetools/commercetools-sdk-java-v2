...
public class MyBusinessUnitAddShippingAddressIdActionImpl implements MyBusinessUnitAddShippingAddressIdAction, ModelBase {
     ...
     */
    @JsonCreator
    MyBusinessUnitAddShippingAddressIdActionImpl(@JsonProperty("addressId") final String addressId, @JsonProperty("addressKey") final String addressKey) {
