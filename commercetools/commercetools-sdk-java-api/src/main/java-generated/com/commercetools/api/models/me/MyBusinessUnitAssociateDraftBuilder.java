...
public class MyBusinessUnitAssociateDraftBuilder implements Builder<MyBusinessUnitAssociateDraft> {
    ...
    public MyBusinessUnitAssociateDraftBuilder customer(Function<com.commercetools.api.models.me.MyCustomerDraftBuilder, com.commercetools.api.models.me.MyCustomerDraftBuilder> builder) {
    ...
    public MyBusinessUnitAssociateDraftBuilder withCustomer(Function<com.commercetools.api.models.me.MyCustomerDraftBuilder, com.commercetools.api.models.me.MyCustomerDraft> builder) {
    ...
    public MyBusinessUnitAssociateDraftBuilder customer( final com.commercetools.api.models.me.MyCustomerDraft customer) {
    ...
    public MyBusinessUnitAssociateDraftBuilder associateRoleAssignments( final com.commercetools.api.models.business_unit.AssociateRoleAssignmentDraft ...associateRoleAssignments) {
    ...
    public MyBusinessUnitAssociateDraftBuilder associateRoleAssignments( final java.util.List<com.commercetools.api.models.business_unit.AssociateRoleAssignmentDraft> associateRoleAssignments) {
    ...
    public MyBusinessUnitAssociateDraftBuilder plusAssociateRoleAssignments( final com.commercetools.api.models.business_unit.AssociateRoleAssignmentDraft ...associateRoleAssignments) {
    ...
    public MyBusinessUnitAssociateDraftBuilder plusAssociateRoleAssignments(Function<com.commercetools.api.models.business_unit.AssociateRoleAssignmentDraftBuilder, com.commercetools.api.models.business_unit.AssociateRoleAssignmentDraftBuilder> builder) {
        if (this.associateRoleAssignments == null) {
            this.associateRoleAssignments = new ArrayList<>();
        }
    ...
    public MyBusinessUnitAssociateDraftBuilder withAssociateRoleAssignments(Function<com.commercetools.api.models.business_unit.AssociateRoleAssignmentDraftBuilder, com.commercetools.api.models.business_unit.AssociateRoleAssignmentDraftBuilder> builder) {
        this.associateRoleAssignments = new ArrayList<>();
        this.associateRoleAssignments.add(builder.apply(com.commercetools.api.models.business_unit.AssociateRoleAssignmentDraftBuilder.of()).build());
        return this;
    }
    ...
    public MyBusinessUnitAssociateDraftBuilder addAssociateRoleAssignments(Function<com.commercetools.api.models.business_unit.AssociateRoleAssignmentDraftBuilder, com.commercetools.api.models.business_unit.AssociateRoleAssignmentDraft> builder) {
    ...
    public MyBusinessUnitAssociateDraftBuilder setAssociateRoleAssignments(Function<com.commercetools.api.models.business_unit.AssociateRoleAssignmentDraftBuilder, com.commercetools.api.models.business_unit.AssociateRoleAssignmentDraft> builder) {
    ...
    public MyBusinessUnitAssociateDraft build() {
        ...
        Objects.requireNonNull(associateRoleAssignments, MyBusinessUnitAssociateDraft.class + ": associateRoleAssignments is missing");
