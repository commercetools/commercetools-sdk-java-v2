...
public interface MyBusinessUnitChangeAddressAction extends MyBusinessUnitUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyBusinessUnitChangeAddressAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyBusinessUnitChangeAddressAction>() {
            @Override
