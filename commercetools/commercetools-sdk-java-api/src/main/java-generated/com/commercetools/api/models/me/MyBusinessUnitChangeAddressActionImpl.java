...
public class MyBusinessUnitChangeAddressActionImpl implements MyBusinessUnitChangeAddressAction, ModelBase {
     ...
     */
    @JsonCreator
    MyBusinessUnitChangeAddressActionImpl(@JsonProperty("addressId") final String addressId, @JsonProperty("addressKey") final String addressKey, @JsonProperty("address") final com.commercetools.api.models.common.BaseAddress address) {
    ...
    public boolean equals(Object o) {
        ...
        MyBusinessUnitChangeAddressActionImpl that = (MyBusinessUnitChangeAddressActionImpl) o;
