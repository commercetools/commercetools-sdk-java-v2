...
public interface MyBusinessUnitChangeNameAction extends MyBusinessUnitUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyBusinessUnitChangeNameAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyBusinessUnitChangeNameAction>() {
            @Override
