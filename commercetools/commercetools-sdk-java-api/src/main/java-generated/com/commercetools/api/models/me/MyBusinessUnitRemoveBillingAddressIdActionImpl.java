...
public class MyBusinessUnitRemoveBillingAddressIdActionImpl implements MyBusinessUnitRemoveBillingAddressIdAction, ModelBase {
     ...
     */
    @JsonCreator
    MyBusinessUnitRemoveBillingAddressIdActionImpl(@JsonProperty("addressId") final String addressId, @JsonProperty("addressKey") final String addressKey) {
