...
public interface MyBusinessUnitRemoveShippingAddressIdAction extends MyBusinessUnitUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyBusinessUnitRemoveShippingAddressIdAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyBusinessUnitRemoveShippingAddressIdAction>() {
            @Override
