...
public class MyBusinessUnitRemoveShippingAddressIdActionImpl implements MyBusinessUnitRemoveShippingAddressIdAction, ModelBase {
     ...
     */
    @JsonCreator
    MyBusinessUnitRemoveShippingAddressIdActionImpl(@JsonProperty("addressId") final String addressId, @JsonProperty("addressKey") final String addressKey) {
