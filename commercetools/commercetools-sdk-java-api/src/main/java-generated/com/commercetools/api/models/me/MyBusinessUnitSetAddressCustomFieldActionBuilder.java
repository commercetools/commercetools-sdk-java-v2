...
public class MyBusinessUnitSetAddressCustomFieldActionBuilder implements Builder<MyBusinessUnitSetAddressCustomFieldAction> {
     ...
     * @return builder
     */
    public static MyBusinessUnitSetAddressCustomFieldActionBuilder of(final MyBusinessUnitSetAddressCustomFieldAction template) {
