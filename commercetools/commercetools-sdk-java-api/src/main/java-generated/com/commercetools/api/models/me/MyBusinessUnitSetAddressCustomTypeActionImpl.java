...
public class MyBusinessUnitSetAddressCustomTypeActionImpl implements MyBusinessUnitSetAddressCustomTypeAction, ModelBase {
     ...
     */
    @JsonCreator
    MyBusinessUnitSetAddressCustomTypeActionImpl(@JsonProperty("type") final com.commercetools.api.models.type.TypeResourceIdentifier type, @JsonProperty("fields") final com.commercetools.api.models.type.FieldContainer fields, @JsonProperty("addressId") final String addressId) {
        this.type = type;
        this.fields = fields;
