...
public interface MyBusinessUnitSetContactEmailAction extends MyBusinessUnitUpdateAction {
    ...
    public MyBusinessUnitSetContactEmailAction copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyBusinessUnitSetContactEmailAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyBusinessUnitSetContactEmailAction>() {
            @Override
