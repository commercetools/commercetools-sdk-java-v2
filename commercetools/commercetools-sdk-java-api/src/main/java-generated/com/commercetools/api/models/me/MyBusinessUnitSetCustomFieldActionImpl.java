...
public class MyBusinessUnitSetCustomFieldActionImpl implements MyBusinessUnitSetCustomFieldAction, ModelBase {
     ...
     */
    @JsonCreator
    MyBusinessUnitSetCustomFieldActionImpl(@JsonProperty("name") final String name,
     ...
     */
    public MyBusinessUnitSetCustomFieldActionImpl() {
        this.action = SET_CUSTOM_FIELD;
    }
    ...
    public boolean equals(Object o) {
        ...
        MyBusinessUnitSetCustomFieldActionImpl that = (MyBusinessUnitSetCustomFieldActionImpl) o;
    ...
    public MyBusinessUnitSetCustomFieldAction copyDeep() {
        return MyBusinessUnitSetCustomFieldAction.deepCopy(this);
    }
}
