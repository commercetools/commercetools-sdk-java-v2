...
public interface MyBusinessUnitSetDefaultBillingAddressAction extends MyBusinessUnitUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyBusinessUnitSetDefaultBillingAddressAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyBusinessUnitSetDefaultBillingAddressAction>() {
            @Override
