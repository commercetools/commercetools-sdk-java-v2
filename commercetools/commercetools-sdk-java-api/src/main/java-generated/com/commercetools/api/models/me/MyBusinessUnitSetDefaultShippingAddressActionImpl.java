...
public class MyBusinessUnitSetDefaultShippingAddressActionImpl implements MyBusinessUnitSetDefaultShippingAddressAction, ModelBase {
     ...
     */
    @JsonCreator
    MyBusinessUnitSetDefaultShippingAddressActionImpl(@JsonProperty("addressId") final String addressId, @JsonProperty("addressKey") final String addressKey) {
     ...
     */
    public MyBusinessUnitSetDefaultShippingAddressActionImpl() {
        this.action =  SET_DEFAULT_SHIPPING_ADDRESS;
    }
    ...
    public boolean equals(Object o) {
        ...
        MyBusinessUnitSetDefaultShippingAddressActionImpl that = (MyBusinessUnitSetDefaultShippingAddressActionImpl) o;
