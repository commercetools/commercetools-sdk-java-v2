...
public interface MyBusinessUnitUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyBusinessUnitUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyBusinessUnitUpdateAction>() {
            @Override
