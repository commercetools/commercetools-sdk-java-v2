...
public class MyBusinessUnitUpdateImpl implements MyBusinessUnitUpdate, ModelBase {
     ...
     */
    @JsonCreator
    MyBusinessUnitUpdateImpl(@JsonProperty("version") final Long version, @JsonProperty("actions") final java.util.List<com.commercetools.api.models.business_unit.BusinessUnitUpdateAction> actions) {
