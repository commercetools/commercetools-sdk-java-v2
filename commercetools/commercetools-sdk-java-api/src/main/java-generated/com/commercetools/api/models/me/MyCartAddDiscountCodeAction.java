...
public interface MyCartAddDiscountCodeAction extends MyCartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyCartAddDiscountCodeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyCartAddDiscountCodeAction>() {
            @Override
