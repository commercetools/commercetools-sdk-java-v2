...
public interface MyCartChangeTaxModeAction extends MyCartUpdateAction {
    ...
    /**
     * factory method to create a shallow copy MyCartChangeTaxModeAction
     ...
     */
    @Nullable
    public static MyCartChangeTaxModeAction deepCopy(@Nullable final MyCartChangeTaxModeAction template) {
        if (template == null) {
            return null;
        }
        MyCartChangeTaxModeActionImpl instance = new MyCartChangeTaxModeActionImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyCartChangeTaxModeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyCartChangeTaxModeAction>() {
            @Override
