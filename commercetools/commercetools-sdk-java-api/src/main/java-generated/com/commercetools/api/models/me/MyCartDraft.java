...
public interface MyCartDraft extends com.commercetools.api.models.CustomizableDraft<MyCartDraft>, io.vrap.rmf.base.client.Draft<MyCartDraft> {
    ...
    public static MyCartDraft deepCopy(@Nullable final MyCartDraft template) {
        ...
        instance.setLineItems(Optional.ofNullable(template.getLineItems())
                .map(t -> t.stream().map(com.commercetools.api.models.me.MyLineItemDraft::deepCopy).collect(Collectors.toList()))
                .orElse(null));
        instance.setTaxMode(template.getTaxMode());
        instance.setInventoryMode(template.getInventoryMode());
