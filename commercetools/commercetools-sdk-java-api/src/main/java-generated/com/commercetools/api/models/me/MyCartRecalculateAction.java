...
public interface MyCartRecalculateAction extends MyCartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyCartRecalculateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyCartRecalculateAction>() {
            @Override
