...
public interface MyCartRemoveDiscountCodeAction extends MyCartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyCartRemoveDiscountCodeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyCartRemoveDiscountCodeAction>() {
            @Override
