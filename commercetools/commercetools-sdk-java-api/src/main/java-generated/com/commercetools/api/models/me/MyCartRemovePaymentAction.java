...
public interface MyCartRemovePaymentAction extends MyCartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyCartRemovePaymentAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyCartRemovePaymentAction>() {
            @Override
