...
public class MyCartSetBusinessUnitActionImpl implements MyCartSetBusinessUnitAction, ModelBase {
     ...
     */
    @JsonCreator
    MyCartSetBusinessUnitActionImpl(@JsonProperty("businessUnit") final com.commercetools.api.models.business_unit.BusinessUnitResourceIdentifier businessUnit) {
