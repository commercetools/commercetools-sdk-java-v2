...
public interface MyCartSetCustomFieldAction extends MyCartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyCartSetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyCartSetCustomFieldAction>() {
            @Override
