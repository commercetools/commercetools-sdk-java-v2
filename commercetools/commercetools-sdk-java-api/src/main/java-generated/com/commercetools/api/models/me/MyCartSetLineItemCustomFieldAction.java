...
public interface MyCartSetLineItemCustomFieldAction extends MyCartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyCartSetLineItemCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyCartSetLineItemCustomFieldAction>() {
            @Override
