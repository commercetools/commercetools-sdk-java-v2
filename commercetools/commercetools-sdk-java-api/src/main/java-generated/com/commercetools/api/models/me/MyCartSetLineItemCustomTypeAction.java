...
public interface MyCartSetLineItemCustomTypeAction extends MyCartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyCartSetLineItemCustomTypeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyCartSetLineItemCustomTypeAction>() {
            @Override
