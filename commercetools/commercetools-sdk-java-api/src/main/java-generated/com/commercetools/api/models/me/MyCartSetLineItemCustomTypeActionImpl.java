...
public class MyCartSetLineItemCustomTypeActionImpl implements MyCartSetLineItemCustomTypeAction, ModelBase {
     ...
     */
    @JsonCreator
    MyCartSetLineItemCustomTypeActionImpl(@JsonProperty("lineItemId") final String lineItemId,
    ...
    /**
     *  <p>Defines the <a href="https://docs.commercetools.com/apis/ctp:api:type:Type" rel="nofollow">Type</a> that extends the LineItem with <a href="https://docs.commercetools.com/apis/ctp:api:type:CustomFields" rel="nofollow">Custom Fields</a>. If absent, any existing Type and Custom Fields are removed from the Line Item.</p>
     */
    ...
    public boolean equals(Object o) {
        ...
        MyCartSetLineItemCustomTypeActionImpl that = (MyCartSetLineItemCustomTypeActionImpl) o;
