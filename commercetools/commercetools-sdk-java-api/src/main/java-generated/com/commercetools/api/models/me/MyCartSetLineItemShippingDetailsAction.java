...
public interface MyCartSetLineItemShippingDetailsAction extends MyCartUpdateAction {
    ...
    public MyCartSetLineItemShippingDetailsAction copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyCartSetLineItemShippingDetailsAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyCartSetLineItemShippingDetailsAction>() {
            @Override
