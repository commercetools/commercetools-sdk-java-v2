...
public interface MyCartSetLineItemSupplyChannelAction extends MyCartUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyCartSetLineItemSupplyChannelAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyCartSetLineItemSupplyChannelAction>() {
            @Override
