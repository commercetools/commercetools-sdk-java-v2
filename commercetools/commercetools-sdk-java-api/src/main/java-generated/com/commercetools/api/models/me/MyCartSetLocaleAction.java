...
public interface MyCartSetLocaleAction extends MyCartUpdateAction {
    ...
    /**
     *  <p>Value to set. Must be one of the <a href="https://docs.commercetools.com/apis/ctp:api:type:Project" rel="nofollow">Project</a>'s <code>languages</code>. If omitted, any existing value is removed.</p>
     * @return locale
     */
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyCartSetLocaleAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyCartSetLocaleAction>() {
            @Override
