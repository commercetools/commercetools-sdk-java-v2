...
public class MyCartUpdateImpl implements MyCartUpdate, ModelBase {
     ...
     */
    @JsonCreator
    MyCartUpdateImpl(@JsonProperty("version") final Long version, @JsonProperty("actions") final java.util.List<com.commercetools.api.models.me.MyCartUpdateAction> actions) {
