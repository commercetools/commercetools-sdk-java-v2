...
public class MyCustomerAddBillingAddressIdActionImpl implements MyCustomerAddBillingAddressIdAction, ModelBase {
     ...
     */
    @JsonCreator
    MyCustomerAddBillingAddressIdActionImpl(@JsonProperty("addressId") final String addressId, @JsonProperty("addressKey") final String addressKey) {
    ...
    public boolean equals(Object o) {
        ...
        MyCustomerAddBillingAddressIdActionImpl that = (MyCustomerAddBillingAddressIdActionImpl) o;
