...
public class MyCustomerSetCustomFieldActionImpl implements MyCustomerSetCustomFieldAction {
    ...
    @JsonCreator
    MyCustomerSetCustomFieldActionImpl(@JsonProperty("name") final String name,
