...
public class MyCustomerSetDefaultShippingAddressActionImpl implements MyCustomerSetDefaultShippingAddressAction {
    ...
    @JsonCreator
    MyCustomerSetDefaultShippingAddressActionImpl(@JsonProperty("addressId") final String addressId,
