...
public interface MyCustomerUpdate extends
    ...
    public static MyCustomerUpdate deepCopy(@Nullable final MyCustomerUpdate template) {
        ...
        instance.setActions(Optional.ofNullable(template.getActions())
                .map(t -> t.stream()
                        .map(com.commercetools.api.models.me.MyCustomerUpdateAction::deepCopy)
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyCustomerUpdate> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyCustomerUpdate>() {
            @Override
