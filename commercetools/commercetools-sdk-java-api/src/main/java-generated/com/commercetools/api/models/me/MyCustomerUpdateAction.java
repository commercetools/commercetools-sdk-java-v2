...
public interface MyCustomerUpdateAction
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyCustomerUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyCustomerUpdateAction>() {
            @Override
