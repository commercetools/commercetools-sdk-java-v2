...
public class MyCustomerUpdateBuilder implements Builder<MyCustomerUpdate> {
    ...
    public MyCustomerUpdateBuilder actions( final java.util.List<com.commercetools.api.models.me.MyCustomerUpdateAction> actions) {
    ...
    public MyCustomerUpdateBuilder plusActions( final com.commercetools.api.models.me.MyCustomerUpdateAction ...actions) {
    ...
    public MyCustomerUpdateBuilder plusActions(Function<com.commercetools.api.models.me.MyCustomerUpdateActionBuilder, Builder<? extends com.commercetools.api.models.me.MyCustomerUpdateAction>> builder) {
        if (this.actions == null) {
            this.actions = new ArrayList<>();
        }
    ...
    public MyCustomerUpdateBuilder withActions(Function<com.commercetools.api.models.me.MyCustomerUpdateActionBuilder, Builder<? extends com.commercetools.api.models.me.MyCustomerUpdateAction>> builder) {
        this.actions = new ArrayList<>();
        this.actions.add(builder.apply(com.commercetools.api.models.me.MyCustomerUpdateActionBuilder.of()).build());
        return this;
    }
