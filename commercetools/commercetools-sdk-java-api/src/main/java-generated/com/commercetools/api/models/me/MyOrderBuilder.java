...
public final class MyOrderBuilder {
    ...
    public MyOrderBuilder lastModifiedBy(
    ...
    public MyOrderBuilder customLineItems(
    ...
    public MyOrderBuilder shipmentState(
    ...
    public MyOrderBuilder refusedGifts(
    ...
    public MyOrder build() {
        return new MyOrderImpl(id, version, createdAt, lastModifiedAt, lastModifiedBy, createdBy, completedAt,
