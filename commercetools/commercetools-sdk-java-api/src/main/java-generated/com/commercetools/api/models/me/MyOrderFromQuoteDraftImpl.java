...
public class MyOrderFromQuoteDraftImpl implements MyOrderFromQuoteDraft, ModelBase {
     ...
     */
    @JsonCreator
    MyOrderFromQuoteDraftImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version, @JsonProperty("quoteStateToAccepted") final Boolean quoteStateToAccepted) {
        this.id = id;
