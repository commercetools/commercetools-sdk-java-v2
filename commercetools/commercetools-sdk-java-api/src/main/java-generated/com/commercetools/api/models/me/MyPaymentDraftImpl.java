...
public class MyPaymentDraftImpl implements MyPaymentDraft, ModelBase {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).append("amountPlanned", amountPlanned)
    ...
    @Override
    public MyPaymentDraft copyDeep() {
        return MyPaymentDraft.deepCopy(this);
    }
}
