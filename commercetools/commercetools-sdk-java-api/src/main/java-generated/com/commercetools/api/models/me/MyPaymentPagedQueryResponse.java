...
/**
 *  <p><span>PagedQueryResult</span> with <code>results</code> containing an array of <a href="https://docs.commercetools.com/apis/ctp:api:type:MyPayment" rel="nofollow">MyPayment</a>.</p>
 *
 * <hr>
...
public interface MyPaymentPagedQueryResponse
    ...
    /**
     *  <p><a href="https://docs.commercetools.com/apis/ctp:api:type:MyPayment" rel="nofollow">MyPayments</a> matching the query.</p>
     * @return results
     */
    @NotNull
    @Valid
    ...
    /**
     * factory method to create a shallow copy MyPaymentPagedQueryResponse
     ...
     */
    @Nullable
    public static MyPaymentPagedQueryResponse deepCopy(@Nullable final MyPaymentPagedQueryResponse template) {
        if (template == null) {
            return null;
        }
        MyPaymentPagedQueryResponseImpl instance = new MyPaymentPagedQueryResponseImpl();
        ...
        instance.setResults(Optional.ofNullable(template.getResults())
                .map(t -> t.stream()
                        .map(com.commercetools.api.models.me.MyPayment::deepCopy)
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyPaymentPagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyPaymentPagedQueryResponse>() {
            @Override
