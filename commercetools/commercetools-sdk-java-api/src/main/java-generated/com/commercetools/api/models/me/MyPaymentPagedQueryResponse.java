...
import com.commercetools.api.models.me.MyPaymentPagedQueryResponseImpl;
...
public interface MyPaymentPagedQueryResponse extends com.commercetools.api.models.ResourcePagedQueryResponse<MyPayment> {
    ...
    public static MyPaymentPagedQueryResponse deepCopy(@Nullable final MyPaymentPagedQueryResponse template) {
        ...
        instance.setResults(Optional.ofNullable(template.getResults())
                .map(t -> t.stream().map(com.commercetools.api.models.me.MyPayment::deepCopy).collect(Collectors.toList()))
                .orElse(null));
        return instance;
    }
