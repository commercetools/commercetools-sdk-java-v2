...
public class MyPaymentPagedQueryResponseBuilder implements Builder<MyPaymentPagedQueryResponse> {
    ...
    public MyPaymentPagedQueryResponseBuilder results( final java.util.List<com.commercetools.api.models.me.MyPayment> results) {
    ...
    public MyPaymentPagedQueryResponseBuilder plusResults(Function<com.commercetools.api.models.me.MyPaymentBuilder, com.commercetools.api.models.me.MyPaymentBuilder> builder) {
        if (this.results == null) {
            this.results = new ArrayList<>();
        }
    ...
    public MyPaymentPagedQueryResponseBuilder withResults(Function<com.commercetools.api.models.me.MyPaymentBuilder, com.commercetools.api.models.me.MyPaymentBuilder> builder) {
        this.results = new ArrayList<>();
        this.results.add(builder.apply(com.commercetools.api.models.me.MyPaymentBuilder.of()).build());
        return this;
    }
    ...
    public MyPaymentPagedQueryResponseBuilder addResults(Function<com.commercetools.api.models.me.MyPaymentBuilder, com.commercetools.api.models.me.MyPayment> builder) {
        return plusResults(builder.apply(com.commercetools.api.models.me.MyPaymentBuilder.of()));
    }
    ...
    public MyPaymentPagedQueryResponseBuilder setResults(Function<com.commercetools.api.models.me.MyPaymentBuilder, com.commercetools.api.models.me.MyPayment> builder) {
        return results(builder.apply(com.commercetools.api.models.me.MyPaymentBuilder.of()));
    }
