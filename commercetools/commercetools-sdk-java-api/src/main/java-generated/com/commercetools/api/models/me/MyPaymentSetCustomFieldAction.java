...
public interface MyPaymentSetCustomFieldAction extends MyPaymentUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyPaymentSetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyPaymentSetCustomFieldAction>() {
            @Override
