...
public interface MyPaymentSetMethodInfoInterfaceAccountAction extends MyPaymentUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyPaymentSetMethodInfoInterfaceAccountAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyPaymentSetMethodInfoInterfaceAccountAction>() {
            @Override
