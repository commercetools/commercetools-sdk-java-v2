...
public interface MyPaymentSetMethodInfoInterfaceAction extends MyPaymentUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyPaymentSetMethodInfoInterfaceAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyPaymentSetMethodInfoInterfaceAction>() {
            @Override
