...
public interface MyPaymentUpdate extends com.commercetools.api.models.ResourceUpdate<MyPaymentUpdate, MyPaymentUpdateAction, MyPaymentUpdateBuilder> {
    ...
    public static MyPaymentUpdate deepCopy(@Nullable final MyPaymentUpdate template) {
        ...
        instance.setActions(Optional.ofNullable(template.getActions())
                .map(t -> t.stream().map(com.commercetools.api.models.me.MyPaymentUpdateAction::deepCopy).collect(Collectors.toList()))
                .orElse(null));
        return instance;
    }
