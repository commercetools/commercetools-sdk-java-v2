...
public interface MyPaymentUpdateAction
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyPaymentUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyPaymentUpdateAction>() {
            @Override
