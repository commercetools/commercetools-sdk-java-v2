...
public class MyPaymentUpdateImpl implements MyPaymentUpdate, ModelBase {
     ...
     */
    @JsonCreator
    MyPaymentUpdateImpl(@JsonProperty("version") final Long version,
            @JsonProperty("actions") final java.util.List<com.commercetools.api.models.me.MyPaymentUpdateAction> actions) {
    ...
    public boolean equals(Object o) {
        ...
        MyPaymentUpdateImpl that = (MyPaymentUpdateImpl) o;
    ...
    public MyPaymentUpdate copyDeep() {
        return MyPaymentUpdate.deepCopy(this);
    }
}
