...
public class MyQuoteRequestUpdateImpl implements MyQuoteRequestUpdate, ModelBase {
     ...
     */
    @JsonCreator
    MyQuoteRequestUpdateImpl(@JsonProperty("version") final Long version, @JsonProperty("actions") final java.util.List<com.commercetools.api.models.me.MyQuoteRequestUpdateAction> actions) {
