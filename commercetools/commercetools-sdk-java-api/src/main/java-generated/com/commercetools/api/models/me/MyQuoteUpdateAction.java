...
public interface MyQuoteUpdateAction extends com.commercetools.api.models.ResourceUpdateAction<MyQuoteUpdateAction> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyQuoteUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyQuoteUpdateAction>() {
            @Override
