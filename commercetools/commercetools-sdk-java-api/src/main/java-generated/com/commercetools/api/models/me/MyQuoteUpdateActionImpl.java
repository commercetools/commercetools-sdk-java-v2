...
public class MyQuoteUpdateActionImpl implements MyQuoteUpdateAction, ModelBase {
     ...
     */
    @JsonCreator
    MyQuoteUpdateActionImpl(@JsonProperty("action") final String action) {
        this.action = action;
    }
     ...
     */
    public MyQuoteUpdateActionImpl() {
    }
    ...
    public boolean equals(Object o) {
        ...
        MyQuoteUpdateActionImpl that = (MyQuoteUpdateActionImpl) o;
    ...
    public MyQuoteUpdateAction copyDeep() {
        return MyQuoteUpdateAction.deepCopy(this);
    }
}
