...
public class MyQuoteUpdateBuilder implements Builder<MyQuoteUpdate> {
    ...
    public MyQuoteUpdateBuilder actions( final java.util.List<com.commercetools.api.models.me.MyQuoteUpdateAction> actions) {
    ...
    public MyQuoteUpdateBuilder plusActions(Function<com.commercetools.api.models.me.MyQuoteUpdateActionBuilder, Builder<? extends com.commercetools.api.models.me.MyQuoteUpdateAction>> builder) {
        if (this.actions == null) {
            this.actions = new ArrayList<>();
        }
    ...
    public MyQuoteUpdateBuilder withActions(Function<com.commercetools.api.models.me.MyQuoteUpdateActionBuilder, Builder<? extends com.commercetools.api.models.me.MyQuoteUpdateAction>> builder) {
        this.actions = new ArrayList<>();
        this.actions.add(builder.apply(com.commercetools.api.models.me.MyQuoteUpdateActionBuilder.of()).build());
        return this;
    }
