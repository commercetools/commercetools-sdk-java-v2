...
public class MyShoppingListAddLineItemActionImpl implements MyShoppingListAddLineItemAction, ModelBase {
     ...
     */
    @JsonCreator
    MyShoppingListAddLineItemActionImpl(@JsonProperty("key") final String key, @JsonProperty("sku") final String sku,
    ...
    public MyShoppingListAddLineItemAction copyDeep() {
        return MyShoppingListAddLineItemAction.deepCopy(this);
    }
}
