...
public interface MyShoppingListAddTextLineItemAction extends MyShoppingListUpdateAction,
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyShoppingListAddTextLineItemAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyShoppingListAddTextLineItemAction>() {
            @Override
