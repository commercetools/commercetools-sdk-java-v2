...
public interface MyShoppingListChangeLineItemQuantityAction extends MyShoppingListUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyShoppingListChangeLineItemQuantityAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyShoppingListChangeLineItemQuantityAction>() {
            @Override
