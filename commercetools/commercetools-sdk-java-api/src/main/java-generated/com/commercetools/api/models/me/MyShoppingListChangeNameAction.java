...
public interface MyShoppingListChangeNameAction extends MyShoppingListUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyShoppingListChangeNameAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyShoppingListChangeNameAction>() {
            @Override
