 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("changeTextLineItemsOrder")
...
public interface MyShoppingListChangeTextLineItemsOrderAction extends MyShoppingListUpdateAction {
    ...
    /**
     * factory method to create a shallow copy MyShoppingListChangeTextLineItemsOrderAction
     ...
     */
    @Nullable
    public static MyShoppingListChangeTextLineItemsOrderAction deepCopy(
            @Nullable final MyShoppingListChangeTextLineItemsOrderAction template) {
        if (template == null) {
            return null;
        }
        MyShoppingListChangeTextLineItemsOrderActionImpl instance = new MyShoppingListChangeTextLineItemsOrderActionImpl();
        instance.setTextLineItemOrder(
            Optional.ofNullable(template.getTextLineItemOrder()).map(ArrayList::new).orElse(null));
        return instance;
    }
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyShoppingListChangeTextLineItemsOrderAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyShoppingListChangeTextLineItemsOrderAction>() {
            @Override
