...
public interface MyShoppingListSetCustomTypeAction extends MyShoppingListUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyShoppingListSetCustomTypeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyShoppingListSetCustomTypeAction>() {
            @Override
