...
public interface MyShoppingListSetTextLineItemCustomFieldAction extends MyShoppingListUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyShoppingListSetTextLineItemCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyShoppingListSetTextLineItemCustomFieldAction>() {
            @Override
