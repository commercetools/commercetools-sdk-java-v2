...
public interface MyShoppingListUpdateAction
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyShoppingListUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyShoppingListUpdateAction>() {
            @Override
