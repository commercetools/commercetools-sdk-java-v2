...
public interface MyTransactionDraft extends com.commercetools.api.models.CustomizableDraft<MyTransactionDraft>,
     ...
     */
    public static tools.jackson.core.type.TypeReference<MyTransactionDraft> typeReference() {
        return new tools.jackson.core.type.TypeReference<MyTransactionDraft>() {
            @Override
