...
public class ApprovalFlowApprovedMessageImpl implements ApprovalFlowApprovedMessage, ModelBase {
     ...
     */
    @JsonCreator
    ApprovalFlowApprovedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public ApprovalFlowApprovedMessageImpl() {
        this.type = APPROVAL_FLOW_APPROVED;
    }
    ...
    public boolean equals(Object o) {
        ...
        ApprovalFlowApprovedMessageImpl that = (ApprovalFlowApprovedMessageImpl) o;
