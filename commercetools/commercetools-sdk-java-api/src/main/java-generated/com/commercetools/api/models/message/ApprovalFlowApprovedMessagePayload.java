...
public interface ApprovalFlowApprovedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApprovalFlowApprovedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApprovalFlowApprovedMessagePayload>() {
            @Override
