...
public class ApprovalFlowCompletedMessageImpl implements ApprovalFlowCompletedMessage, ModelBase {
     ...
     */
    @JsonCreator
    ApprovalFlowCompletedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public ApprovalFlowCompletedMessageImpl() {
        this.type = APPROVAL_FLOW_COMPLETED;
    }
    ...
    public boolean equals(Object o) {
        ...
        ApprovalFlowCompletedMessageImpl that = (ApprovalFlowCompletedMessageImpl) o;
    ...
    public ApprovalFlowCompletedMessage copyDeep() {
        return ApprovalFlowCompletedMessage.deepCopy(this);
    }
}
