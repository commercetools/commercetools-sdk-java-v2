...
public interface ApprovalFlowCreatedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApprovalFlowCreatedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApprovalFlowCreatedMessage>() {
            @Override
