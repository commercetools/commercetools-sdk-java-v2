...
public class ApprovalFlowCreatedMessageImpl implements ApprovalFlowCreatedMessage, ModelBase {
     ...
     */
    @JsonCreator
    ApprovalFlowCreatedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public ApprovalFlowCreatedMessageImpl() {
        this.type = APPROVAL_FLOW_CREATED;
    }
    ...
    public boolean equals(Object o) {
        ...
        ApprovalFlowCreatedMessageImpl that = (ApprovalFlowCreatedMessageImpl) o;
    ...
    public ApprovalFlowCreatedMessage copyDeep() {
        return ApprovalFlowCreatedMessage.deepCopy(this);
    }
}
