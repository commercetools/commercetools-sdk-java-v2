...
public interface ApprovalFlowRejectedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApprovalFlowRejectedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApprovalFlowRejectedMessage>() {
            @Override
