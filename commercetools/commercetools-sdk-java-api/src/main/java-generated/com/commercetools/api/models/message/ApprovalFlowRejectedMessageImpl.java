...
public class ApprovalFlowRejectedMessageImpl implements ApprovalFlowRejectedMessage, ModelBase {
     ...
     */
    @JsonCreator
    ApprovalFlowRejectedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public ApprovalFlowRejectedMessageImpl() {
        this.type = APPROVAL_FLOW_REJECTED;
    }
    ...
    public boolean equals(Object o) {
        ...
        ApprovalFlowRejectedMessageImpl that = (ApprovalFlowRejectedMessageImpl) o;
