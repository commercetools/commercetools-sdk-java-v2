...
public class ApprovalRuleCreatedMessageImpl implements ApprovalRuleCreatedMessage, ModelBase {
     ...
     */
    @JsonCreator
    ApprovalRuleCreatedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public ApprovalRuleCreatedMessageImpl() {
        this.type = APPROVAL_RULE_CREATED;
    }
    ...
    public boolean equals(Object o) {
        ...
        ApprovalRuleCreatedMessageImpl that = (ApprovalRuleCreatedMessageImpl) o;
