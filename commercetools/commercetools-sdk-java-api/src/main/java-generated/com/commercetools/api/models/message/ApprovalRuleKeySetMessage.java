...
public interface ApprovalRuleKeySetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApprovalRuleKeySetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApprovalRuleKeySetMessage>() {
            @Override
