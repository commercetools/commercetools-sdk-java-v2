...
public class ApprovalRuleKeySetMessageImpl implements ApprovalRuleKeySetMessage, ModelBase {
     ...
     */
    @JsonCreator
    ApprovalRuleKeySetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public ApprovalRuleKeySetMessageImpl() {
        this.type = APPROVAL_RULE_KEY_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        ApprovalRuleKeySetMessageImpl that = (ApprovalRuleKeySetMessageImpl) o;
