...
public class ApprovalRuleNameSetMessageImpl implements ApprovalRuleNameSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    ApprovalRuleNameSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
            ...
            @JsonProperty("name") final String name, @JsonProperty("oldName") final String oldName) {
        this.id = id;
     ...
     */
    public ApprovalRuleNameSetMessageImpl() {
        this.type = APPROVAL_RULE_NAME_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        ApprovalRuleNameSetMessageImpl that = (ApprovalRuleNameSetMessageImpl) o;
