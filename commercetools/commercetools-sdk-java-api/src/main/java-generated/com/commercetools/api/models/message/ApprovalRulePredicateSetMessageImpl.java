...
public class ApprovalRulePredicateSetMessageImpl implements ApprovalRulePredicateSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    ApprovalRulePredicateSetMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public ApprovalRulePredicateSetMessageImpl() {
        this.type = APPROVAL_RULE_PREDICATE_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        ApprovalRulePredicateSetMessageImpl that = (ApprovalRulePredicateSetMessageImpl) o;
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).append("id", id)
                ...
                .append("oldPredicate", oldPredicate)
                .build();
    }
