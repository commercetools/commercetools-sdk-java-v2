...
public class ApprovalRuleStatusSetMessageImpl implements ApprovalRuleStatusSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    ApprovalRuleStatusSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public ApprovalRuleStatusSetMessageImpl() {
        this.type = APPROVAL_RULE_STATUS_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        ApprovalRuleStatusSetMessageImpl that = (ApprovalRuleStatusSetMessageImpl) o;
