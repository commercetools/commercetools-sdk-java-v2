...
public class AssociateRoleBuyerAssignableChangedMessageImpl
        implements AssociateRoleBuyerAssignableChangedMessage, ModelBase {
     ...
     */
    @JsonCreator
    AssociateRoleBuyerAssignableChangedMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public AssociateRoleBuyerAssignableChangedMessageImpl() {
        this.type = ASSOCIATE_ROLE_BUYER_ASSIGNABLE_CHANGED;
    }
    ...
    public boolean equals(Object o) {
        ...
        AssociateRoleBuyerAssignableChangedMessageImpl that = (AssociateRoleBuyerAssignableChangedMessageImpl) o;
