...
public interface AssociateRoleBuyerAssignableChangedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AssociateRoleBuyerAssignableChangedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<AssociateRoleBuyerAssignableChangedMessagePayload>() {
            @Override
