...
public class AssociateRoleBuyerAssignableChangedMessagePayloadImpl implements AssociateRoleBuyerAssignableChangedMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    AssociateRoleBuyerAssignableChangedMessagePayloadImpl(@JsonProperty("buyerAssignable") final Boolean buyerAssignable) {
