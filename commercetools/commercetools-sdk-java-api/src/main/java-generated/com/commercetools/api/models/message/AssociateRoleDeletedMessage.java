...
public interface AssociateRoleDeletedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AssociateRoleDeletedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<AssociateRoleDeletedMessage>() {
            @Override
