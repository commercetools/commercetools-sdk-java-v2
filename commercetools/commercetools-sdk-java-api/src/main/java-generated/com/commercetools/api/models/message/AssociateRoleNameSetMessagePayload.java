...
public interface AssociateRoleNameSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AssociateRoleNameSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<AssociateRoleNameSetMessagePayload>() {
            @Override
