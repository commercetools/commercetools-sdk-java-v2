...
public interface AssociateRolePermissionAddedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AssociateRolePermissionAddedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<AssociateRolePermissionAddedMessage>() {
            @Override
