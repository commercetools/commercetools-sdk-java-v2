 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("AssociateRolePermissionAdded")
...
public interface AssociateRolePermissionAddedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AssociateRolePermissionAddedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<AssociateRolePermissionAddedMessagePayload>() {
            @Override
