...
import com.commercetools.api.models.message.AssociateRolePermissionRemovedMessageImpl;
...
public interface AssociateRolePermissionRemovedMessage extends Message {
     ...
     */
    @Nullable
    public static AssociateRolePermissionRemovedMessage deepCopy(@Nullable final AssociateRolePermissionRemovedMessage template) {
        if (template == null) {
            return null;
        }
        AssociateRolePermissionRemovedMessageImpl instance = new AssociateRolePermissionRemovedMessageImpl();
     ...
     * @return builder
     */
    public static AssociateRolePermissionRemovedMessageBuilder builder(final AssociateRolePermissionRemovedMessage template) {
