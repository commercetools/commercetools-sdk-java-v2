...
public interface AssociateRolePermissionRemovedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AssociateRolePermissionRemovedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<AssociateRolePermissionRemovedMessagePayload>() {
            @Override
