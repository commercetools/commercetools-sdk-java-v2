...
public interface AssociateRolePermissionsSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AssociateRolePermissionsSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<AssociateRolePermissionsSetMessagePayload>() {
            @Override
