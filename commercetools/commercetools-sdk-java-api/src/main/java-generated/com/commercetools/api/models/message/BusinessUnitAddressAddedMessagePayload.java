...
/**
 *  <p>Generated after a successful <a href="https://docs.commercetools.com/apis/ctp:api:type:BusinessUnitAddAddressAction" rel="nofollow">Add Address</a> update action.</p>
 *
 * <hr>
...
public interface BusinessUnitAddressAddedMessagePayload extends MessagePayload {
    ...
    /**
     * factory method to create a shallow copy BusinessUnitAddressAddedMessagePayload
     ...
     */
    @Nullable
    public static BusinessUnitAddressAddedMessagePayload deepCopy(
            @Nullable final BusinessUnitAddressAddedMessagePayload template) {
        if (template == null) {
            return null;
        }
        BusinessUnitAddressAddedMessagePayloadImpl instance = new BusinessUnitAddressAddedMessagePayloadImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitAddressAddedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitAddressAddedMessagePayload>() {
            @Override
