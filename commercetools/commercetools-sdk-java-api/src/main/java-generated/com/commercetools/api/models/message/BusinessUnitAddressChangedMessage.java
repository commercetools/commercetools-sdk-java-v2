...
import com.commercetools.api.models.message.BusinessUnitAddressChangedMessageImpl;
...
public interface BusinessUnitAddressChangedMessage extends Message {
     ...
     */
    @Nullable
    public static BusinessUnitAddressChangedMessage deepCopy(@Nullable final BusinessUnitAddressChangedMessage template) {
        if (template == null) {
            return null;
        }
        BusinessUnitAddressChangedMessageImpl instance = new BusinessUnitAddressChangedMessageImpl();
