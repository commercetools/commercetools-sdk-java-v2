...
public interface BusinessUnitAddressChangedMessage extends Message {
    ...
    /**
     * factory method to create a shallow copy BusinessUnitAddressChangedMessage
    ...
    public BusinessUnitAddressChangedMessage copyDeep();
     ...
     */
    @Nullable
    public static BusinessUnitAddressChangedMessage deepCopy(
            @Nullable final BusinessUnitAddressChangedMessage template) {
        if (template == null) {
            return null;
        }
        BusinessUnitAddressChangedMessageImpl instance = new BusinessUnitAddressChangedMessageImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitAddressChangedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitAddressChangedMessage>() {
            @Override
