...
public class BusinessUnitAddressChangedMessageBuilder implements Builder<BusinessUnitAddressChangedMessage> {
    ...
    public BusinessUnitAddressChangedMessageBuilder lastModifiedBy(
    ...
    public BusinessUnitAddressChangedMessageBuilder withLastModifiedBy(
    ...
    public BusinessUnitAddressChangedMessageBuilder createdBy(
    ...
    public BusinessUnitAddressChangedMessageBuilder withCreatedBy(
    ...
    public BusinessUnitAddressChangedMessageBuilder resource(
    ...
    public BusinessUnitAddressChangedMessageBuilder resourceUserProvidedIdentifiers(
    ...
    public BusinessUnitAddressChangedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public BusinessUnitAddressChangedMessageBuilder address(
    ...
    public BusinessUnitAddressChangedMessageBuilder withAddress(
