...
public interface BusinessUnitAddressChangedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitAddressChangedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitAddressChangedMessagePayload>() {
            @Override
