...
public interface BusinessUnitAddressCustomFieldAddedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitAddressCustomFieldAddedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitAddressCustomFieldAddedMessage>() {
            @Override
