...
public class BusinessUnitAddressCustomFieldChangedMessageImpl
        implements BusinessUnitAddressCustomFieldChangedMessage, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitAddressCustomFieldChangedMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public BusinessUnitAddressCustomFieldChangedMessageImpl() {
        this.type = BUSINESS_UNIT_ADDRESS_CUSTOM_FIELD_CHANGED;
    }
    ...
    public boolean equals(Object o) {
        ...
        BusinessUnitAddressCustomFieldChangedMessageImpl that = (BusinessUnitAddressCustomFieldChangedMessageImpl) o;
    ...
    @Override
    public BusinessUnitAddressCustomFieldChangedMessage copyDeep() {
        return BusinessUnitAddressCustomFieldChangedMessage.deepCopy(this);
    }
}
