...
public class BusinessUnitAddressCustomTypeSetMessageImpl implements BusinessUnitAddressCustomTypeSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitAddressCustomTypeSetMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public BusinessUnitAddressCustomTypeSetMessageImpl() {
        this.type = BUSINESS_UNIT_ADDRESS_CUSTOM_TYPE_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        BusinessUnitAddressCustomTypeSetMessageImpl that = (BusinessUnitAddressCustomTypeSetMessageImpl) o;
