 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("BusinessUnitAddressCustomTypeSet")
...
public interface BusinessUnitAddressCustomTypeSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitAddressCustomTypeSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitAddressCustomTypeSetMessagePayload>() {
            @Override
