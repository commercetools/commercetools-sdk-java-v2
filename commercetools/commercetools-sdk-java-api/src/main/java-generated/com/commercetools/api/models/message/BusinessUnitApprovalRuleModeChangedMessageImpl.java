...
public class BusinessUnitApprovalRuleModeChangedMessageImpl
        implements BusinessUnitApprovalRuleModeChangedMessage, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitApprovalRuleModeChangedMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public BusinessUnitApprovalRuleModeChangedMessageImpl() {
        this.type = BUSINESS_UNIT_APPROVAL_RULE_MODE_CHANGED;
    }
    ...
    public boolean equals(Object o) {
        ...
        BusinessUnitApprovalRuleModeChangedMessageImpl that = (BusinessUnitApprovalRuleModeChangedMessageImpl) o;
