...
public interface BusinessUnitAssociateAddedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitAssociateAddedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitAssociateAddedMessagePayload>() {
            @Override
