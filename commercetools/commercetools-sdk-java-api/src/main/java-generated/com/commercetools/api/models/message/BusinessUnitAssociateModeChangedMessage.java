...
public interface BusinessUnitAssociateModeChangedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitAssociateModeChangedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitAssociateModeChangedMessage>() {
            @Override
