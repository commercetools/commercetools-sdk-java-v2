...
public interface BusinessUnitAssociateModeChangedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitAssociateModeChangedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitAssociateModeChangedMessagePayload>() {
            @Override
