...
public interface BusinessUnitAssociateRemovedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitAssociateRemovedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitAssociateRemovedMessage>() {
            @Override
