...
public class BusinessUnitAssociateRemovedMessageBuilder implements Builder<BusinessUnitAssociateRemovedMessage> {
    ...
    /**
     * builds BusinessUnitAssociateRemovedMessage with checking for non-null required values
     * @return BusinessUnitAssociateRemovedMessage
     */
    public BusinessUnitAssociateRemovedMessage build() {
     ...
     * @return builder
     */
    public static BusinessUnitAssociateRemovedMessageBuilder of(final BusinessUnitAssociateRemovedMessage template) {
        BusinessUnitAssociateRemovedMessageBuilder builder = new BusinessUnitAssociateRemovedMessageBuilder();
