 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("BusinessUnitBillingAddressAdded")
...
public interface BusinessUnitBillingAddressAddedMessage extends Message {
    ...
    public BusinessUnitBillingAddressAddedMessage copyDeep();
     ...
     */
    @Nullable
    public static BusinessUnitBillingAddressAddedMessage deepCopy(
            @Nullable final BusinessUnitBillingAddressAddedMessage template) {
        if (template == null) {
            return null;
        }
        BusinessUnitBillingAddressAddedMessageImpl instance = new BusinessUnitBillingAddressAddedMessageImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitBillingAddressAddedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitBillingAddressAddedMessage>() {
            @Override
