...
public class BusinessUnitBillingAddressAddedMessageBuilder implements Builder<BusinessUnitBillingAddressAddedMessage> {
    ...
    public BusinessUnitBillingAddressAddedMessageBuilder withLastModifiedBy(
    ...
    public BusinessUnitBillingAddressAddedMessageBuilder withCreatedBy(
    ...
    public BusinessUnitBillingAddressAddedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public BusinessUnitBillingAddressAddedMessageBuilder withAddress(
