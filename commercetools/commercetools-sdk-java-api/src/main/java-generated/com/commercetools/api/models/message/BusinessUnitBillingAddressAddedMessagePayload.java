...
import com.commercetools.api.models.message.BusinessUnitBillingAddressAddedMessagePayloadImpl;
...
public interface BusinessUnitBillingAddressAddedMessagePayload extends MessagePayload {
     ...
     */
    public static BusinessUnitBillingAddressAddedMessagePayload of(final BusinessUnitBillingAddressAddedMessagePayload template) {
     ...
     */
    @Nullable
    public static BusinessUnitBillingAddressAddedMessagePayload deepCopy(@Nullable final BusinessUnitBillingAddressAddedMessagePayload template) {
        if (template == null) {
            return null;
        }
        BusinessUnitBillingAddressAddedMessagePayloadImpl instance = new BusinessUnitBillingAddressAddedMessagePayloadImpl();
     ...
     * @return builder
     */
    public static BusinessUnitBillingAddressAddedMessagePayloadBuilder builder(final BusinessUnitBillingAddressAddedMessagePayload template) {
     ...
     * @return mapped value
     */
    default <T> T withBusinessUnitBillingAddressAddedMessagePayload(Function<BusinessUnitBillingAddressAddedMessagePayload, T> helper) {
