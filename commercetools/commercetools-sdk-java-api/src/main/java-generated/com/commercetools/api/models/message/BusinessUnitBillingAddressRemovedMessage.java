...
import com.commercetools.api.models.message.BusinessUnitBillingAddressRemovedMessageImpl;
...
public interface BusinessUnitBillingAddressRemovedMessage extends Message {
     ...
     */
    @Nullable
    public static BusinessUnitBillingAddressRemovedMessage deepCopy(@Nullable final BusinessUnitBillingAddressRemovedMessage template) {
        if (template == null) {
            return null;
        }
        BusinessUnitBillingAddressRemovedMessageImpl instance = new BusinessUnitBillingAddressRemovedMessageImpl();
     ...
     * @return builder
     */
    public static BusinessUnitBillingAddressRemovedMessageBuilder builder(final BusinessUnitBillingAddressRemovedMessage template) {
     ...
     * @return mapped value
     */
    default <T> T withBusinessUnitBillingAddressRemovedMessage(Function<BusinessUnitBillingAddressRemovedMessage, T> helper) {
