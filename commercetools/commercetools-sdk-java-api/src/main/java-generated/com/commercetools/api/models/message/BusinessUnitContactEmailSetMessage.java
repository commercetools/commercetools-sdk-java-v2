...
public interface BusinessUnitContactEmailSetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitContactEmailSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitContactEmailSetMessage>() {
            @Override
