...
public class BusinessUnitCreatedMessageImpl implements BusinessUnitCreatedMessage, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitCreatedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public BusinessUnitCreatedMessageImpl() {
        this.type = BUSINESS_UNIT_CREATED;
    }
    ...
    public boolean equals(Object o) {
        ...
        BusinessUnitCreatedMessageImpl that = (BusinessUnitCreatedMessageImpl) o;
    ...
    @Override
    public BusinessUnitCreatedMessage copyDeep() {
        return BusinessUnitCreatedMessage.deepCopy(this);
    }
}
