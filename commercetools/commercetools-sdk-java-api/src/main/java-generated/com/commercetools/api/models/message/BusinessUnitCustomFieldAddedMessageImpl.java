...
public class BusinessUnitCustomFieldAddedMessageImpl implements BusinessUnitCustomFieldAddedMessage, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitCustomFieldAddedMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public BusinessUnitCustomFieldAddedMessageImpl() {
        this.type = BUSINESS_UNIT_CUSTOM_FIELD_ADDED;
    }
    ...
    public boolean equals(Object o) {
        ...
        BusinessUnitCustomFieldAddedMessageImpl that = (BusinessUnitCustomFieldAddedMessageImpl) o;
