 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("BusinessUnitCustomFieldAdded")
...
public interface BusinessUnitCustomFieldAddedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitCustomFieldAddedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitCustomFieldAddedMessagePayload>() {
            @Override
