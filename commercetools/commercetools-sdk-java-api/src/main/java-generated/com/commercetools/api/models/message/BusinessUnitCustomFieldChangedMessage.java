...
public interface BusinessUnitCustomFieldChangedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitCustomFieldChangedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitCustomFieldChangedMessage>() {
            @Override
