...
public interface BusinessUnitCustomFieldChangedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitCustomFieldChangedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitCustomFieldChangedMessagePayload>() {
            @Override
