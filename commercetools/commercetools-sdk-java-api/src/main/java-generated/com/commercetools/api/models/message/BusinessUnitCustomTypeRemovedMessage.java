...
public interface BusinessUnitCustomTypeRemovedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitCustomTypeRemovedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitCustomTypeRemovedMessage>() {
            @Override
