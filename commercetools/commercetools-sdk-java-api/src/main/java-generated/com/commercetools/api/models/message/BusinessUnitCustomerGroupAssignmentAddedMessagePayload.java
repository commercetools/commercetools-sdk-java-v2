...
public interface BusinessUnitCustomerGroupAssignmentAddedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitCustomerGroupAssignmentAddedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitCustomerGroupAssignmentAddedMessagePayload>() {
            @Override
