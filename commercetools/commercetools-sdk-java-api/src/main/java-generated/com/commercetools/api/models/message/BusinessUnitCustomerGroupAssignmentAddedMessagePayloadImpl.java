...
public class BusinessUnitCustomerGroupAssignmentAddedMessagePayloadImpl
        implements BusinessUnitCustomerGroupAssignmentAddedMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitCustomerGroupAssignmentAddedMessagePayloadImpl(
     ...
     */
    public BusinessUnitCustomerGroupAssignmentAddedMessagePayloadImpl() {
        this.type = BUSINESS_UNIT_CUSTOMER_GROUP_ASSIGNMENT_ADDED;
    }
    ...
    public boolean equals(Object o) {
        ...
        BusinessUnitCustomerGroupAssignmentAddedMessagePayloadImpl that = (BusinessUnitCustomerGroupAssignmentAddedMessagePayloadImpl) o;
    ...
    public BusinessUnitCustomerGroupAssignmentAddedMessagePayload copyDeep() {
        return BusinessUnitCustomerGroupAssignmentAddedMessagePayload.deepCopy(this);
    }
}
