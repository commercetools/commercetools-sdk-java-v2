...
public interface BusinessUnitCustomerGroupAssignmentRemovedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitCustomerGroupAssignmentRemovedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitCustomerGroupAssignmentRemovedMessagePayload>() {
            @Override
