...
@JsonDeserialize(as = BusinessUnitCustomerGroupAssignmentsSetMessageImpl.class)
public interface BusinessUnitCustomerGroupAssignmentsSetMessage extends Message {

    /**
     * discriminator value for BusinessUnitCustomerGroupAssignmentsSetMessage
     */
    ...
    /**
     * factory method
     * @return instance of BusinessUnitCustomerGroupAssignmentsSetMessage
     */
    public static BusinessUnitCustomerGroupAssignmentsSetMessage of() {
        return new BusinessUnitCustomerGroupAssignmentsSetMessageImpl();
    }

    /**
     * factory method to create a shallow copy BusinessUnitCustomerGroupAssignmentsSetMessage
     * @param template instance to be copied
     * @return copy instance
     */
    public static BusinessUnitCustomerGroupAssignmentsSetMessage of(
            final BusinessUnitCustomerGroupAssignmentsSetMessage template) {
        BusinessUnitCustomerGroupAssignmentsSetMessageImpl instance = new BusinessUnitCustomerGroupAssignmentsSetMessageImpl();
    ...
    public BusinessUnitCustomerGroupAssignmentsSetMessage copyDeep();

    /**
     * factory method to create a deep copy of BusinessUnitCustomerGroupAssignmentsSetMessage
     * @param template instance to be copied
     * @return copy instance
     */
    @Nullable
    public static BusinessUnitCustomerGroupAssignmentsSetMessage deepCopy(
            @Nullable final BusinessUnitCustomerGroupAssignmentsSetMessage template) {
        if (template == null) {
            return null;
        }
        BusinessUnitCustomerGroupAssignmentsSetMessageImpl instance = new BusinessUnitCustomerGroupAssignmentsSetMessageImpl();
    ...
    /**
     * builder factory method for BusinessUnitCustomerGroupAssignmentsSetMessage
     * @return builder
     */
    public static BusinessUnitCustomerGroupAssignmentsSetMessageBuilder builder() {
        return BusinessUnitCustomerGroupAssignmentsSetMessageBuilder.of();
    }
    ...
    public static BusinessUnitCustomerGroupAssignmentsSetMessageBuilder builder(
            final BusinessUnitCustomerGroupAssignmentsSetMessage template) {
        return BusinessUnitCustomerGroupAssignmentsSetMessageBuilder.of(template);
    }
     ...
     * @return mapped value
     */
    default <T> T withBusinessUnitCustomerGroupAssignmentsSetMessage(
            Function<BusinessUnitCustomerGroupAssignmentsSetMessage, T> helper) {
     ...
     */
    public static com.fasterxml.jackson.core.type.TypeReference<BusinessUnitCustomerGroupAssignmentsSetMessage> typeReference() {
        return new com.fasterxml.jackson.core.type.TypeReference<BusinessUnitCustomerGroupAssignmentsSetMessage>() {
            @Override
            public String toString() {
                return "TypeReference<BusinessUnitCustomerGroupAssignmentsSetMessage>";
            }
        };
    }
}
