...
public interface BusinessUnitDefaultBillingAddressSetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitDefaultBillingAddressSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitDefaultBillingAddressSetMessage>() {
            @Override
