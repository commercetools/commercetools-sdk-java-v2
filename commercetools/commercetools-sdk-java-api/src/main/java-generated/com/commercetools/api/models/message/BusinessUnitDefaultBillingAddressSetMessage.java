...
import com.commercetools.api.models.message.BusinessUnitDefaultBillingAddressSetMessageImpl;
...
public interface BusinessUnitDefaultBillingAddressSetMessage extends Message {
     ...
     */
    public static BusinessUnitDefaultBillingAddressSetMessage of(final BusinessUnitDefaultBillingAddressSetMessage template) {
     ...
     */
    @Nullable
    public static BusinessUnitDefaultBillingAddressSetMessage deepCopy(@Nullable final BusinessUnitDefaultBillingAddressSetMessage template) {
        if (template == null) {
            return null;
        }
        BusinessUnitDefaultBillingAddressSetMessageImpl instance = new BusinessUnitDefaultBillingAddressSetMessageImpl();
     ...
     * @return builder
     */
    public static BusinessUnitDefaultBillingAddressSetMessageBuilder builder(final BusinessUnitDefaultBillingAddressSetMessage template) {
     ...
     * @return mapped value
     */
    default <T> T withBusinessUnitDefaultBillingAddressSetMessage(Function<BusinessUnitDefaultBillingAddressSetMessage, T> helper) {
