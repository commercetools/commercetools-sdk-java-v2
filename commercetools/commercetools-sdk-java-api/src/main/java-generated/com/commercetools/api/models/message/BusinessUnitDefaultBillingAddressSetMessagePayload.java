 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("BusinessUnitDefaultBillingAddressSet")
...
public interface BusinessUnitDefaultBillingAddressSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitDefaultBillingAddressSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitDefaultBillingAddressSetMessagePayload>() {
            @Override
