...
public interface BusinessUnitDefaultShippingAddressSetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitDefaultShippingAddressSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitDefaultShippingAddressSetMessage>() {
            @Override
