...
public class BusinessUnitDefaultShippingAddressSetMessageImpl
        implements BusinessUnitDefaultShippingAddressSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitDefaultShippingAddressSetMessageImpl(@JsonProperty("id") final String id,
