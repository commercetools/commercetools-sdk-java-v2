...
public interface BusinessUnitDeletedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitDeletedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitDeletedMessage>() {
            @Override
