...
public class BusinessUnitNameChangedMessageImpl implements BusinessUnitNameChangedMessage, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitNameChangedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public BusinessUnitNameChangedMessageImpl() {
        this.type = BUSINESS_UNIT_NAME_CHANGED;
    }
    ...
    public boolean equals(Object o) {
        ...
        BusinessUnitNameChangedMessageImpl that = (BusinessUnitNameChangedMessageImpl) o;
