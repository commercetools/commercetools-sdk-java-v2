...
public interface BusinessUnitNameChangedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitNameChangedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitNameChangedMessagePayload>() {
            @Override
