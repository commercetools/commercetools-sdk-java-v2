...
public interface BusinessUnitParentChangedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitParentChangedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitParentChangedMessage>() {
            @Override
