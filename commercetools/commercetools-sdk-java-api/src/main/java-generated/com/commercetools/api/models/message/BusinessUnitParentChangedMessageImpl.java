...
public class BusinessUnitParentChangedMessageImpl implements BusinessUnitParentChangedMessage, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitParentChangedMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public BusinessUnitParentChangedMessageImpl() {
        this.type = BUSINESS_UNIT_PARENT_CHANGED;
    }
    ...
    public boolean equals(Object o) {
        ...
        BusinessUnitParentChangedMessageImpl that = (BusinessUnitParentChangedMessageImpl) o;
