...
import com.commercetools.api.models.message.BusinessUnitParentUnitChangedMessageImpl;
...
public interface BusinessUnitParentUnitChangedMessage extends Message {
     ...
     */
    @Nullable
    public static BusinessUnitParentUnitChangedMessage deepCopy(@Nullable final BusinessUnitParentUnitChangedMessage template) {
        if (template == null) {
            return null;
        }
        BusinessUnitParentUnitChangedMessageImpl instance = new BusinessUnitParentUnitChangedMessageImpl();
     ...
     * @return builder
     */
    public static BusinessUnitParentUnitChangedMessageBuilder builder(final BusinessUnitParentUnitChangedMessage template) {
