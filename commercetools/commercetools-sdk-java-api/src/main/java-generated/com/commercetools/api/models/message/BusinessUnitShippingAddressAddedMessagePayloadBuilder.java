...
public class BusinessUnitShippingAddressAddedMessagePayloadBuilder implements Builder<BusinessUnitShippingAddressAddedMessagePayload> {
    ...
    public BusinessUnitShippingAddressAddedMessagePayloadBuilder address(Function<com.commercetools.api.models.common.AddressBuilder, com.commercetools.api.models.common.AddressBuilder> builder) {
    ...
    public BusinessUnitShippingAddressAddedMessagePayloadBuilder withAddress(Function<com.commercetools.api.models.common.AddressBuilder, com.commercetools.api.models.common.Address> builder) {
    ...
    public BusinessUnitShippingAddressAddedMessagePayloadBuilder address( final com.commercetools.api.models.common.Address address) {
     ...
     * @return builder
     */
    public static BusinessUnitShippingAddressAddedMessagePayloadBuilder of(final BusinessUnitShippingAddressAddedMessagePayload template) {
