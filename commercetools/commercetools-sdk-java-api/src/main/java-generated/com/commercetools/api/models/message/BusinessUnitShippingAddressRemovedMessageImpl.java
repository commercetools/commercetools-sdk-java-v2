...
public class BusinessUnitShippingAddressRemovedMessageImpl
        implements BusinessUnitShippingAddressRemovedMessage, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitShippingAddressRemovedMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public BusinessUnitShippingAddressRemovedMessageImpl() {
        this.type = BUSINESS_UNIT_SHIPPING_ADDRESS_REMOVED;
    }
    ...
    public boolean equals(Object o) {
        ...
        BusinessUnitShippingAddressRemovedMessageImpl that = (BusinessUnitShippingAddressRemovedMessageImpl) o;
    ...
    @Override
    public BusinessUnitShippingAddressRemovedMessage copyDeep() {
        return BusinessUnitShippingAddressRemovedMessage.deepCopy(this);
    }
}
