...
public class BusinessUnitStatusChangedMessageBuilder implements Builder<BusinessUnitStatusChangedMessage> {
    ...
    public BusinessUnitStatusChangedMessageBuilder lastModifiedBy(Function<com.commercetools.api.models.common.LastModifiedByBuilder, com.commercetools.api.models.common.LastModifiedByBuilder> builder) {
    ...
    public BusinessUnitStatusChangedMessageBuilder withLastModifiedBy(Function<com.commercetools.api.models.common.LastModifiedByBuilder, com.commercetools.api.models.common.LastModifiedBy> builder) {
    ...
    public BusinessUnitStatusChangedMessageBuilder lastModifiedBy(@Nullable final com.commercetools.api.models.common.LastModifiedBy lastModifiedBy) {
    ...
    public BusinessUnitStatusChangedMessageBuilder createdBy(Function<com.commercetools.api.models.common.CreatedByBuilder, com.commercetools.api.models.common.CreatedByBuilder> builder) {
    ...
    public BusinessUnitStatusChangedMessageBuilder withCreatedBy(Function<com.commercetools.api.models.common.CreatedByBuilder, com.commercetools.api.models.common.CreatedBy> builder) {
    ...
    public BusinessUnitStatusChangedMessageBuilder createdBy(@Nullable final com.commercetools.api.models.common.CreatedBy createdBy) {
    ...
    public BusinessUnitStatusChangedMessageBuilder resource( final com.commercetools.api.models.common.Reference resource) {
    ...
    public BusinessUnitStatusChangedMessageBuilder resource(Function<com.commercetools.api.models.common.ReferenceBuilder, Builder<? extends com.commercetools.api.models.common.Reference>> builder) {
    ...
    public BusinessUnitStatusChangedMessageBuilder resourceUserProvidedIdentifiers(Function<com.commercetools.api.models.message.UserProvidedIdentifiersBuilder, com.commercetools.api.models.message.UserProvidedIdentifiersBuilder> builder) {
    ...
    public BusinessUnitStatusChangedMessageBuilder withResourceUserProvidedIdentifiers(Function<com.commercetools.api.models.message.UserProvidedIdentifiersBuilder, com.commercetools.api.models.message.UserProvidedIdentifiers> builder) {
    ...
    public BusinessUnitStatusChangedMessageBuilder resourceUserProvidedIdentifiers(@Nullable final com.commercetools.api.models.message.UserProvidedIdentifiers resourceUserProvidedIdentifiers) {
    ...
    public BusinessUnitStatusChangedMessageBuilder active( final com.commercetools.api.models.business_unit.BusinessUnitStatus active) {
        this.active = active;
        return this;
    }
    ...
    public BusinessUnitStatusChangedMessage build() {
        ...
        Objects.requireNonNull(resourceVersion, BusinessUnitStatusChangedMessage.class + ": resourceVersion is missing");
        Objects.requireNonNull(active, BusinessUnitStatusChangedMessage.class + ": active is missing");
        return new BusinessUnitStatusChangedMessageImpl(id, version, createdAt, lastModifiedAt, lastModifiedBy, createdBy, sequenceNumber, resource, resourceVersion, resourceUserProvidedIdentifiers, active);
    }
