...
/**
 *  <p>Generated after a successful <a href="https://docs.commercetools.com/apis/ctp:api:type:BusinessUnitAddStoreAction" rel="nofollow">Add Store</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("BusinessUnitStoreAdded")
...
public interface BusinessUnitStoreAddedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitStoreAddedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitStoreAddedMessagePayload>() {
            @Override
