...
public interface BusinessUnitStoreModeChangedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitStoreModeChangedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitStoreModeChangedMessage>() {
            @Override
