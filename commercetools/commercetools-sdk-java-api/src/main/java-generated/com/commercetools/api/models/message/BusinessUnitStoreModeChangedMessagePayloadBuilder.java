...
public class BusinessUnitStoreModeChangedMessagePayloadBuilder implements Builder<BusinessUnitStoreModeChangedMessagePayload> {
    ...
    public BusinessUnitStoreModeChangedMessagePayloadBuilder stores( final com.commercetools.api.models.store.StoreKeyReference ...stores) {
    ...
    public BusinessUnitStoreModeChangedMessagePayloadBuilder stores( final java.util.List<com.commercetools.api.models.store.StoreKeyReference> stores) {
        this.stores = stores;
        return this;
    }
    ...
    public BusinessUnitStoreModeChangedMessagePayloadBuilder plusStores( final com.commercetools.api.models.store.StoreKeyReference ...stores) {
        if (this.stores == null) {
    ...
    public BusinessUnitStoreModeChangedMessagePayloadBuilder plusStores(Function<com.commercetools.api.models.store.StoreKeyReferenceBuilder, com.commercetools.api.models.store.StoreKeyReferenceBuilder> builder) {
        if (this.stores == null) {
            this.stores = new ArrayList<>();
        }
    ...
    public BusinessUnitStoreModeChangedMessagePayloadBuilder withStores(Function<com.commercetools.api.models.store.StoreKeyReferenceBuilder, com.commercetools.api.models.store.StoreKeyReferenceBuilder> builder) {
        this.stores = new ArrayList<>();
        this.stores.add(builder.apply(com.commercetools.api.models.store.StoreKeyReferenceBuilder.of()).build());
        return this;
    }
    ...
    public BusinessUnitStoreModeChangedMessagePayloadBuilder addStores(Function<com.commercetools.api.models.store.StoreKeyReferenceBuilder, com.commercetools.api.models.store.StoreKeyReference> builder) {
    ...
    public BusinessUnitStoreModeChangedMessagePayloadBuilder setStores(Function<com.commercetools.api.models.store.StoreKeyReferenceBuilder, com.commercetools.api.models.store.StoreKeyReference> builder) {
    ...
    public BusinessUnitStoreModeChangedMessagePayloadBuilder storeMode( final com.commercetools.api.models.business_unit.BusinessUnitStoreMode storeMode) {
    ...
    public BusinessUnitStoreModeChangedMessagePayloadBuilder oldStores( final com.commercetools.api.models.store.StoreKeyReference ...oldStores) {
    ...
    public BusinessUnitStoreModeChangedMessagePayloadBuilder oldStores( final java.util.List<com.commercetools.api.models.store.StoreKeyReference> oldStores) {
    ...
    public BusinessUnitStoreModeChangedMessagePayloadBuilder plusOldStores( final com.commercetools.api.models.store.StoreKeyReference ...oldStores) {
    ...
    public BusinessUnitStoreModeChangedMessagePayloadBuilder plusOldStores(Function<com.commercetools.api.models.store.StoreKeyReferenceBuilder, com.commercetools.api.models.store.StoreKeyReferenceBuilder> builder) {
        if (this.oldStores == null) {
            this.oldStores = new ArrayList<>();
        }
    ...
    public BusinessUnitStoreModeChangedMessagePayloadBuilder withOldStores(Function<com.commercetools.api.models.store.StoreKeyReferenceBuilder, com.commercetools.api.models.store.StoreKeyReferenceBuilder> builder) {
        this.oldStores = new ArrayList<>();
        this.oldStores.add(builder.apply(com.commercetools.api.models.store.StoreKeyReferenceBuilder.of()).build());
        return this;
    }
    ...
    public BusinessUnitStoreModeChangedMessagePayloadBuilder addOldStores(Function<com.commercetools.api.models.store.StoreKeyReferenceBuilder, com.commercetools.api.models.store.StoreKeyReference> builder) {
    ...
    public BusinessUnitStoreModeChangedMessagePayloadBuilder setOldStores(Function<com.commercetools.api.models.store.StoreKeyReferenceBuilder, com.commercetools.api.models.store.StoreKeyReference> builder) {
    ...
    public BusinessUnitStoreModeChangedMessagePayloadBuilder oldStoreMode( final com.commercetools.api.models.business_unit.BusinessUnitStoreMode oldStoreMode) {
    ...
    public BusinessUnitStoreModeChangedMessagePayload build() {
        ...
        Objects.requireNonNull(oldStoreMode, BusinessUnitStoreModeChangedMessagePayload.class + ": oldStoreMode is missing");
     ...
     * @return builder
     */
    public static BusinessUnitStoreModeChangedMessagePayloadBuilder of(final BusinessUnitStoreModeChangedMessagePayload template) {
