...
public class BusinessUnitTopLevelUnitSetMessageImpl implements BusinessUnitTopLevelUnitSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitTopLevelUnitSetMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public BusinessUnitTopLevelUnitSetMessageImpl() {
        this.type = BUSINESS_UNIT_TOP_LEVEL_UNIT_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        BusinessUnitTopLevelUnitSetMessageImpl that = (BusinessUnitTopLevelUnitSetMessageImpl) o;
