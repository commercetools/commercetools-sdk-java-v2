...
public class BusinessUnitTypeSetMessageImpl implements BusinessUnitTypeSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    BusinessUnitTypeSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public BusinessUnitTypeSetMessageImpl() {
        this.type = BUSINESS_UNIT_TYPE_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        BusinessUnitTypeSetMessageImpl that = (BusinessUnitTypeSetMessageImpl) o;
