...
public class CartDiscountCreatedMessageImpl implements CartDiscountCreatedMessage, ModelBase {
     ...
     */
    @JsonCreator
    CartDiscountCreatedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public CartDiscountCreatedMessageImpl() {
        this.type = CART_DISCOUNT_CREATED;
    }
    ...
    public boolean equals(Object o) {
        ...
        CartDiscountCreatedMessageImpl that = (CartDiscountCreatedMessageImpl) o;
    ...
    @Override
    public CartDiscountCreatedMessage copyDeep() {
        return CartDiscountCreatedMessage.deepCopy(this);
    }
}
