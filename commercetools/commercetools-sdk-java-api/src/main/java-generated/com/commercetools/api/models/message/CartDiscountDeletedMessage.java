...
public interface CartDiscountDeletedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartDiscountDeletedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartDiscountDeletedMessage>() {
            @Override
