...
public class CartDiscountDeletedMessageImpl implements CartDiscountDeletedMessage, ModelBase {
     ...
     */
    @JsonCreator
    CartDiscountDeletedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public CartDiscountDeletedMessageImpl() {
        this.type = CART_DISCOUNT_DELETED;
    }
    ...
    public boolean equals(Object o) {
        ...
        CartDiscountDeletedMessageImpl that = (CartDiscountDeletedMessageImpl) o;
    ...
    public CartDiscountDeletedMessage copyDeep() {
        return CartDiscountDeletedMessage.deepCopy(this);
    }
}
