...
public class CartDiscountStoreAddedMessageImpl implements CartDiscountStoreAddedMessage, ModelBase {
     ...
     */
    @JsonCreator
    CartDiscountStoreAddedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
        ...
        this.store = store;
        this.type = CART_DISCOUNT_STORE_ADDED;
    }

    /**
     * create empty instance
     */
    public CartDiscountStoreAddedMessageImpl() {
        this.type = CART_DISCOUNT_STORE_ADDED;
    }
    ...
    public boolean equals(Object o) {
        ...
        CartDiscountStoreAddedMessageImpl that = (CartDiscountStoreAddedMessageImpl) o;
    ...
    public CartDiscountStoreAddedMessage copyDeep() {
        return CartDiscountStoreAddedMessage.deepCopy(this);
    }
}
