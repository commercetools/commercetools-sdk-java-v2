...
public interface CartDiscountStoreAddedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartDiscountStoreAddedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartDiscountStoreAddedMessagePayload>() {
            @Override
