...
public interface CartDiscountStoreRemovedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartDiscountStoreRemovedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartDiscountStoreRemovedMessage>() {
            @Override
