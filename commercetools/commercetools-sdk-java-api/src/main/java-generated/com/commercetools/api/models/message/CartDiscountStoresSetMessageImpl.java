...
public class CartDiscountStoresSetMessageImpl implements CartDiscountStoresSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    CartDiscountStoresSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public CartDiscountStoresSetMessageImpl() {
        this.type = CART_DISCOUNT_STORES_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        CartDiscountStoresSetMessageImpl that = (CartDiscountStoresSetMessageImpl) o;
