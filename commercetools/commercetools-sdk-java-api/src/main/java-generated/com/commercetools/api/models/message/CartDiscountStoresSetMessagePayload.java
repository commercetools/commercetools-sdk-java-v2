...
public interface CartDiscountStoresSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartDiscountStoresSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartDiscountStoresSetMessagePayload>() {
            @Override
