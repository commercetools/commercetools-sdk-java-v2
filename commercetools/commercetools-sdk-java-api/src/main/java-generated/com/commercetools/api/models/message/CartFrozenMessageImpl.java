...
public class CartFrozenMessageImpl implements CartFrozenMessage, ModelBase {
     ...
     */
    @JsonCreator
    CartFrozenMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
    ...
    public boolean equals(Object o) {
        ...
        CartFrozenMessageImpl that = (CartFrozenMessageImpl) o;
    ...
    public CartFrozenMessage copyDeep() {
        return CartFrozenMessage.deepCopy(this);
    }
}
