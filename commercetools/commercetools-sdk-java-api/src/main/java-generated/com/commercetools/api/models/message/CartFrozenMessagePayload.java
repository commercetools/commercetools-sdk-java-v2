...
public interface CartFrozenMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartFrozenMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartFrozenMessagePayload>() {
            @Override
