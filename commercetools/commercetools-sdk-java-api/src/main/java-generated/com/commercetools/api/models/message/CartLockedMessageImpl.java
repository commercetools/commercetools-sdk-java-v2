...
public class CartLockedMessageImpl implements CartLockedMessage, ModelBase {
     ...
     */
    @JsonCreator
    CartLockedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
        ...
        this.type = CART_LOCKED;
    }

    /**
     * create empty instance
     */
    public CartLockedMessageImpl() {
        this.type = CART_LOCKED;
    }
    ...
    public boolean equals(Object o) {
        ...
        CartLockedMessageImpl that = (CartLockedMessageImpl) o;
    ...
    public CartLockedMessage copyDeep() {
        return CartLockedMessage.deepCopy(this);
    }
}
