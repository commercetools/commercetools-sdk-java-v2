...
public interface CartPurchaseOrderNumberSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartPurchaseOrderNumberSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartPurchaseOrderNumberSetMessagePayload>() {
            @Override
