...
public interface CartUnfrozenMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartUnfrozenMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartUnfrozenMessage>() {
            @Override
