...
public class CartUnfrozenMessageImpl implements CartUnfrozenMessage, ModelBase {
     ...
     */
    @JsonCreator
    CartUnfrozenMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public CartUnfrozenMessageImpl() {
        this.type = CART_UNFROZEN;
    }
    ...
    public boolean equals(Object o) {
        ...
        CartUnfrozenMessageImpl that = (CartUnfrozenMessageImpl) o;
    ...
    public CartUnfrozenMessage copyDeep() {
        return CartUnfrozenMessage.deepCopy(this);
    }
}
