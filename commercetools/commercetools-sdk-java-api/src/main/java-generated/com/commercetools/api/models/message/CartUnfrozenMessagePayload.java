...
public interface CartUnfrozenMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartUnfrozenMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartUnfrozenMessagePayload>() {
            @Override
