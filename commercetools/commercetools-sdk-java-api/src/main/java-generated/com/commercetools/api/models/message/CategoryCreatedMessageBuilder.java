...
public class CategoryCreatedMessageBuilder implements Builder<CategoryCreatedMessage> {
    ...
    public CategoryCreatedMessageBuilder withLastModifiedBy(
    ...
    public CategoryCreatedMessageBuilder withCreatedBy(
    ...
    public CategoryCreatedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public CategoryCreatedMessageBuilder withCategory(
