...
public interface CategorySlugChangedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CategorySlugChangedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<CategorySlugChangedMessage>() {
            @Override
