...
public class CustomLineItemStateTransitionMessageBuilder implements Builder<CustomLineItemStateTransitionMessage> {
    ...
    public CustomLineItemStateTransitionMessageBuilder withLastModifiedBy(
    ...
    public CustomLineItemStateTransitionMessageBuilder withCreatedBy(
    ...
    public CustomLineItemStateTransitionMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public CustomLineItemStateTransitionMessageBuilder withFromState(
    ...
    public CustomLineItemStateTransitionMessageBuilder withToState(
            Function<com.commercetools.api.models.state.StateReferenceBuilder, com.commercetools.api.models.state.StateReference> builder) {
