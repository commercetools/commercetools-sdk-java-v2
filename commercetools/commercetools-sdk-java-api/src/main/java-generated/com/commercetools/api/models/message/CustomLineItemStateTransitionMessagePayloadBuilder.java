...
public class CustomLineItemStateTransitionMessagePayloadBuilder implements Builder<CustomLineItemStateTransitionMessagePayload> {
    ...
    public CustomLineItemStateTransitionMessagePayloadBuilder fromState(Function<com.commercetools.api.models.state.StateReferenceBuilder, com.commercetools.api.models.state.StateReferenceBuilder> builder) {
    ...
    public CustomLineItemStateTransitionMessagePayloadBuilder withFromState(Function<com.commercetools.api.models.state.StateReferenceBuilder, com.commercetools.api.models.state.StateReference> builder) {
    ...
    public CustomLineItemStateTransitionMessagePayloadBuilder toState(Function<com.commercetools.api.models.state.StateReferenceBuilder, com.commercetools.api.models.state.StateReferenceBuilder> builder) {
    ...
    public CustomLineItemStateTransitionMessagePayloadBuilder withToState(Function<com.commercetools.api.models.state.StateReferenceBuilder, com.commercetools.api.models.state.StateReference> builder) {
    ...
    public CustomLineItemStateTransitionMessagePayload build() {
        Objects.requireNonNull(customLineItemId, CustomLineItemStateTransitionMessagePayload.class + ": customLineItemId is missing");
        Objects.requireNonNull(transitionDate, CustomLineItemStateTransitionMessagePayload.class + ": transitionDate is missing");
