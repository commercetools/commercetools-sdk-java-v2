...
public interface CustomerAddressAddedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerAddressAddedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerAddressAddedMessage>() {
            @Override
