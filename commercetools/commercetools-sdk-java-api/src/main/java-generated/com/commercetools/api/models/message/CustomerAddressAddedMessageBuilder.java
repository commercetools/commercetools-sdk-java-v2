...
public class CustomerAddressAddedMessageBuilder implements Builder<CustomerAddressAddedMessage> {
    ...
    public CustomerAddressAddedMessageBuilder withLastModifiedBy(
    ...
    public CustomerAddressAddedMessageBuilder withCreatedBy(
    ...
    public CustomerAddressAddedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public CustomerAddressAddedMessageBuilder withAddress(
