...
public interface CustomerAddressChangedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerAddressChangedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerAddressChangedMessage>() {
            @Override
