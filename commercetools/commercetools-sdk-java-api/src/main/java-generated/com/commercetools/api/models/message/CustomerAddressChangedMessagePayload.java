...
public interface CustomerAddressChangedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerAddressChangedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerAddressChangedMessagePayload>() {
            @Override
