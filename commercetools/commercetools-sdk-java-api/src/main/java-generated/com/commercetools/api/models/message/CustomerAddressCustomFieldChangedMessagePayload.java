...
public interface CustomerAddressCustomFieldChangedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerAddressCustomFieldChangedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerAddressCustomFieldChangedMessagePayload>() {
            @Override
