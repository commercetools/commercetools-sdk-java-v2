...
public class CustomerAddressRemovedMessageBuilder implements Builder<CustomerAddressRemovedMessage> {
    ...
    public CustomerAddressRemovedMessageBuilder withLastModifiedBy(
    ...
    public CustomerAddressRemovedMessageBuilder withCreatedBy(
    ...
    public CustomerAddressRemovedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public CustomerAddressRemovedMessageBuilder withAddress(
