...
public interface CustomerBillingAddressAddedMessage extends Message {
     ...
     * @return mapped value
     */
    default <T> T withCustomerBillingAddressAddedMessage(Function<CustomerBillingAddressAddedMessage, T> helper) {
     ...
     */
    public static com.fasterxml.jackson.core.type.TypeReference<CustomerBillingAddressAddedMessage> typeReference() {
        return new com.fasterxml.jackson.core.type.TypeReference<CustomerBillingAddressAddedMessage>() {
            @Override
            public String toString() {
                return "TypeReference<CustomerBillingAddressAddedMessage>";
            }
        };
    }
}
