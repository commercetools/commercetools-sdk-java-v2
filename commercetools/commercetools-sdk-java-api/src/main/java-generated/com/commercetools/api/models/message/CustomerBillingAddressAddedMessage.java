...
public interface CustomerBillingAddressAddedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerBillingAddressAddedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerBillingAddressAddedMessage>() {
            @Override
