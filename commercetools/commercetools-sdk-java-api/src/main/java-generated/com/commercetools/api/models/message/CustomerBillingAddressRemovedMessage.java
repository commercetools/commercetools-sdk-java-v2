...
public interface CustomerBillingAddressRemovedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerBillingAddressRemovedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerBillingAddressRemovedMessage>() {
            @Override
