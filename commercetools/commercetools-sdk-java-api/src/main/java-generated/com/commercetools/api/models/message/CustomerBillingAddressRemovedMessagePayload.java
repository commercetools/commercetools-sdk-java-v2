...
public interface CustomerBillingAddressRemovedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerBillingAddressRemovedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerBillingAddressRemovedMessagePayload>() {
            @Override
