...
public interface CustomerCompanyNameSetMessage extends Message {
     ...
     */
    @Nullable
    public static CustomerCompanyNameSetMessage deepCopy(@Nullable final CustomerCompanyNameSetMessage template) {
        if (template == null) {
            return null;
        }
        CustomerCompanyNameSetMessageImpl instance = new CustomerCompanyNameSetMessageImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerCompanyNameSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerCompanyNameSetMessage>() {
            @Override
