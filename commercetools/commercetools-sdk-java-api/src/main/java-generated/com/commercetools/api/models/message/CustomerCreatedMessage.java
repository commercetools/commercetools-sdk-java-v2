 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("CustomerCreated")
...
public interface CustomerCreatedMessage extends Message {
    ...
    public CustomerCreatedMessage copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerCreatedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerCreatedMessage>() {
            @Override
