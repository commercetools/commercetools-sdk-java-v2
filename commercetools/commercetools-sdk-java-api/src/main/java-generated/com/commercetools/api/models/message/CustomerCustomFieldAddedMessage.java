...
public interface CustomerCustomFieldAddedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerCustomFieldAddedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerCustomFieldAddedMessage>() {
            @Override
