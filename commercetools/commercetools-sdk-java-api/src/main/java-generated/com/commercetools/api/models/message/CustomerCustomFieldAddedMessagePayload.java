 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("CustomerCustomFieldAdded")
...
public interface CustomerCustomFieldAddedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerCustomFieldAddedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerCustomFieldAddedMessagePayload>() {
            @Override
