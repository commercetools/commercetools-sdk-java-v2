...
public class CustomerCustomFieldAddedMessagePayloadImpl implements CustomerCustomFieldAddedMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    CustomerCustomFieldAddedMessagePayloadImpl(@JsonProperty("name") final String name,
            @JsonProperty("value") final java.lang.Object value) {
        this.name = name;
        this.value = value;
        this.type = CUSTOMER_CUSTOM_FIELD_ADDED;
    }

    /**
     * create empty instance
     */
    public CustomerCustomFieldAddedMessagePayloadImpl() {
        this.type = CUSTOMER_CUSTOM_FIELD_ADDED;
    }
    ...
    public boolean equals(Object o) {
        ...
        CustomerCustomFieldAddedMessagePayloadImpl that = (CustomerCustomFieldAddedMessagePayloadImpl) o;
