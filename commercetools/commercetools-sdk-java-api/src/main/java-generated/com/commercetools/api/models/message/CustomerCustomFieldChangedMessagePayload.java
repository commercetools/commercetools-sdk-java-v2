...
public interface CustomerCustomFieldChangedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerCustomFieldChangedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerCustomFieldChangedMessagePayload>() {
            @Override
