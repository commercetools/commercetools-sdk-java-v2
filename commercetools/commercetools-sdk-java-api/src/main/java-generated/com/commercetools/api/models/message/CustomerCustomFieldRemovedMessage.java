...
public interface CustomerCustomFieldRemovedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerCustomFieldRemovedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerCustomFieldRemovedMessage>() {
            @Override
