...
public class CustomerCustomTypeSetMessageImpl implements CustomerCustomTypeSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    CustomerCustomTypeSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
        ...
        this.type = CUSTOMER_CUSTOM_TYPE_SET;
    }

    /**
     * create empty instance
     */
    public CustomerCustomTypeSetMessageImpl() {
        this.type = CUSTOMER_CUSTOM_TYPE_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        CustomerCustomTypeSetMessageImpl that = (CustomerCustomTypeSetMessageImpl) o;
