...
public interface CustomerDefaultBillingAddressSetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerDefaultBillingAddressSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerDefaultBillingAddressSetMessage>() {
            @Override
