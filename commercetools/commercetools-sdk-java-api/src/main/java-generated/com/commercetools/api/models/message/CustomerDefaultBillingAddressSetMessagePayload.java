...
public interface CustomerDefaultBillingAddressSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerDefaultBillingAddressSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerDefaultBillingAddressSetMessagePayload>() {
            @Override
