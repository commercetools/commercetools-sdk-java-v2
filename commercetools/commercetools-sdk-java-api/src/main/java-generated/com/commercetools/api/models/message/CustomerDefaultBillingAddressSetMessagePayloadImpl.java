...
public class CustomerDefaultBillingAddressSetMessagePayloadImpl
        implements CustomerDefaultBillingAddressSetMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    CustomerDefaultBillingAddressSetMessagePayloadImpl(
     ...
     */
    public CustomerDefaultBillingAddressSetMessagePayloadImpl() {
        this.type = CUSTOMER_DEFAULT_BILLING_ADDRESS_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        CustomerDefaultBillingAddressSetMessagePayloadImpl that = (CustomerDefaultBillingAddressSetMessagePayloadImpl) o;
    ...
    public CustomerDefaultBillingAddressSetMessagePayload copyDeep() {
        return CustomerDefaultBillingAddressSetMessagePayload.deepCopy(this);
    }
}
