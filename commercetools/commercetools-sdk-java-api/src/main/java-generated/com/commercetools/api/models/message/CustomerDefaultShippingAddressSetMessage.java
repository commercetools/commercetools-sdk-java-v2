...
public interface CustomerDefaultShippingAddressSetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerDefaultShippingAddressSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerDefaultShippingAddressSetMessage>() {
            @Override
