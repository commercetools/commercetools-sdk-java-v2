...
public interface CustomerDefaultShippingAddressSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerDefaultShippingAddressSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerDefaultShippingAddressSetMessagePayload>() {
            @Override
