...
public interface CustomerEmailTokenCreatedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerEmailTokenCreatedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerEmailTokenCreatedMessagePayload>() {
            @Override
