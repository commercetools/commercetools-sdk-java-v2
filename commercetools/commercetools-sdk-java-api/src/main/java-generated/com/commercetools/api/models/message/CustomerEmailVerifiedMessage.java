...
public interface CustomerEmailVerifiedMessage extends Message {
    ...
    /**
     * factory method to create a shallow copy CustomerEmailVerifiedMessage
     ...
     */
    @Nullable
    public static CustomerEmailVerifiedMessage deepCopy(@Nullable final CustomerEmailVerifiedMessage template) {
        if (template == null) {
            return null;
        }
        CustomerEmailVerifiedMessageImpl instance = new CustomerEmailVerifiedMessageImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerEmailVerifiedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerEmailVerifiedMessage>() {
            @Override
