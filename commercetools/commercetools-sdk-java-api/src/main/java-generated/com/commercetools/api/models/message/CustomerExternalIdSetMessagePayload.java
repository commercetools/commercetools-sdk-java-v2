...
public interface CustomerExternalIdSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerExternalIdSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerExternalIdSetMessagePayload>() {
            @Override
