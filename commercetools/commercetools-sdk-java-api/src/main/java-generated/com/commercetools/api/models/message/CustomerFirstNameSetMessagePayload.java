...
/**
 *  <p>Generated after a successful <a href="https://docs.commercetools.com/apis/ctp:api:type:CustomerSetFirstNameAction" rel="nofollow">Set First Name</a> update action.</p>
 *
 * <hr>
...
public interface CustomerFirstNameSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerFirstNameSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerFirstNameSetMessagePayload>() {
            @Override
