...
public class CustomerGroupAssignmentRemovedMessageImpl implements CustomerGroupAssignmentRemovedMessage, ModelBase {
     ...
     */
    @JsonCreator
    CustomerGroupAssignmentRemovedMessageImpl(@JsonProperty("id") final String id,
            ...
            @JsonProperty("customerGroupAssignment") final com.commercetools.api.models.customer_group.CustomerGroupReference customerGroupAssignment) {
        this.id = id;
     ...
     */
    public CustomerGroupAssignmentRemovedMessageImpl() {
        this.type = CUSTOMER_GROUP_ASSIGNMENT_REMOVED;
    }
    ...
    public boolean equals(Object o) {
        ...
        CustomerGroupAssignmentRemovedMessageImpl that = (CustomerGroupAssignmentRemovedMessageImpl) o;
