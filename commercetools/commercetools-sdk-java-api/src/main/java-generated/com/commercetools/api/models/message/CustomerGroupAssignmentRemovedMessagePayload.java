...
public interface CustomerGroupAssignmentRemovedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerGroupAssignmentRemovedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerGroupAssignmentRemovedMessagePayload>() {
            @Override
