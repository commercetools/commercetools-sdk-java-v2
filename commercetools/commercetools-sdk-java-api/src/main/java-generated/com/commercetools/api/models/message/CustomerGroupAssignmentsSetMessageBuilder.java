...
/**
 * CustomerGroupAssignmentsSetMessageBuilder
 * <hr>
...
public class CustomerGroupAssignmentsSetMessageBuilder implements Builder<CustomerGroupAssignmentsSetMessage> {
    ...
    public CustomerGroupAssignmentsSetMessageBuilder id(final String id) {
        this.id = id;
        return this;
    }
    ...
    public CustomerGroupAssignmentsSetMessageBuilder version(final Long version) {
    ...
    public CustomerGroupAssignmentsSetMessageBuilder createdAt(final java.time.ZonedDateTime createdAt) {
    ...
    public CustomerGroupAssignmentsSetMessageBuilder lastModifiedAt(final java.time.ZonedDateTime lastModifiedAt) {
    ...
    public CustomerGroupAssignmentsSetMessageBuilder lastModifiedBy(
    ...
    public CustomerGroupAssignmentsSetMessageBuilder withLastModifiedBy(
    ...
    public CustomerGroupAssignmentsSetMessageBuilder createdBy(
    ...
    public CustomerGroupAssignmentsSetMessageBuilder withCreatedBy(
    ...
    public CustomerGroupAssignmentsSetMessageBuilder sequenceNumber(final Long sequenceNumber) {
    ...
    public CustomerGroupAssignmentsSetMessageBuilder resource(
    ...
    public CustomerGroupAssignmentsSetMessageBuilder resourceVersion(final Long resourceVersion) {
    ...
    public CustomerGroupAssignmentsSetMessageBuilder resourceUserProvidedIdentifiers(
    ...
    public CustomerGroupAssignmentsSetMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public CustomerGroupAssignmentsSetMessageBuilder withCustomerGroupAssignments(
            Function<com.commercetools.api.models.customer.CustomerGroupAssignmentBuilder, com.commercetools.api.models.customer.CustomerGroupAssignmentBuilder> builder) {
        this.customerGroupAssignments = new ArrayList<>();
        this.customerGroupAssignments
                .add(builder.apply(com.commercetools.api.models.customer.CustomerGroupAssignmentBuilder.of()).build());
    ...
    public CustomerGroupAssignmentsSetMessageBuilder addCustomerGroupAssignments(
     ...
     */
    public CustomerGroupAssignmentsSetMessage build() {
        Objects.requireNonNull(id, CustomerGroupAssignmentsSetMessage.class + ": id is missing");
        Objects.requireNonNull(version, CustomerGroupAssignmentsSetMessage.class + ": version is missing");
        Objects.requireNonNull(createdAt, CustomerGroupAssignmentsSetMessage.class + ": createdAt is missing");
        Objects.requireNonNull(lastModifiedAt,
            CustomerGroupAssignmentsSetMessage.class + ": lastModifiedAt is missing");
        Objects.requireNonNull(sequenceNumber,
            CustomerGroupAssignmentsSetMessage.class + ": sequenceNumber is missing");
    ...
    /**
     * builds CustomerGroupAssignmentsSetMessage without checking for non-null required values
     * @return CustomerGroupAssignmentsSetMessage
     */
    ...
    /**
     * factory method for an instance of CustomerGroupAssignmentsSetMessageBuilder
     * @return builder
     */
     ...
     * @return builder
     */
    public static CustomerGroupAssignmentsSetMessageBuilder of(final CustomerGroupAssignmentsSetMessage template) {
        CustomerGroupAssignmentsSetMessageBuilder builder = new CustomerGroupAssignmentsSetMessageBuilder();
