...
public class CustomerGroupAssignmentsSetMessageImpl implements CustomerGroupAssignmentsSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    CustomerGroupAssignmentsSetMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public CustomerGroupAssignmentsSetMessageImpl() {
        this.type = CUSTOMER_GROUP_ASSIGNMENTS_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        CustomerGroupAssignmentsSetMessageImpl that = (CustomerGroupAssignmentsSetMessageImpl) o;
