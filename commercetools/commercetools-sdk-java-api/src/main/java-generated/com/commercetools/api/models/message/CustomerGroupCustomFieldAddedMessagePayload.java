...
public interface CustomerGroupCustomFieldAddedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerGroupCustomFieldAddedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerGroupCustomFieldAddedMessagePayload>() {
            @Override
