...
public class CustomerGroupCustomFieldAddedMessagePayloadImpl
        implements CustomerGroupCustomFieldAddedMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    CustomerGroupCustomFieldAddedMessagePayloadImpl(@JsonProperty("name") final String name,
            @JsonProperty("value") final java.lang.Object value) {
        this.name = name;
        this.value = value;
        this.type = CUSTOMER_GROUP_CUSTOM_FIELD_ADDED;
    }

    /**
     * create empty instance
     */
    public CustomerGroupCustomFieldAddedMessagePayloadImpl() {
        this.type = CUSTOMER_GROUP_CUSTOM_FIELD_ADDED;
    }
    ...
    public boolean equals(Object o) {
        ...
        CustomerGroupCustomFieldAddedMessagePayloadImpl that = (CustomerGroupCustomFieldAddedMessagePayloadImpl) o;
