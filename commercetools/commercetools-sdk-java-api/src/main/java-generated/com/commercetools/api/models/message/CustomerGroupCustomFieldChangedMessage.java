...
public interface CustomerGroupCustomFieldChangedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerGroupCustomFieldChangedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerGroupCustomFieldChangedMessage>() {
            @Override
