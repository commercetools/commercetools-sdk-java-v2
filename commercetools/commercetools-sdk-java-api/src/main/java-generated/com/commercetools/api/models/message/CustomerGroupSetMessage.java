...
public interface CustomerGroupSetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerGroupSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerGroupSetMessage>() {
            @Override
