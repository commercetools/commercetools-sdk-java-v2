...
public interface CustomerPasswordTokenCreatedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerPasswordTokenCreatedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerPasswordTokenCreatedMessage>() {
            @Override
