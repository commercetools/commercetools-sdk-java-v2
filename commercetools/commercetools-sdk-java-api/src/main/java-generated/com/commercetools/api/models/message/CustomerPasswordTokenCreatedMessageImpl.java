...
public class CustomerPasswordTokenCreatedMessageImpl implements CustomerPasswordTokenCreatedMessage, ModelBase {
     ...
     */
    @JsonCreator
    CustomerPasswordTokenCreatedMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public CustomerPasswordTokenCreatedMessageImpl() {
        this.type = CUSTOMER_PASSWORD_TOKEN_CREATED;
    }
    ...
    public boolean equals(Object o) {
        ...
        CustomerPasswordTokenCreatedMessageImpl that = (CustomerPasswordTokenCreatedMessageImpl) o;
