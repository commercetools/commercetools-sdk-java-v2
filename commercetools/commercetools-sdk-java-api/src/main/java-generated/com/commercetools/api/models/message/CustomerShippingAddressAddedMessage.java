...
public interface CustomerShippingAddressAddedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerShippingAddressAddedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerShippingAddressAddedMessage>() {
            @Override
