...
public interface CustomerShippingAddressAddedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerShippingAddressAddedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerShippingAddressAddedMessagePayload>() {
            @Override
