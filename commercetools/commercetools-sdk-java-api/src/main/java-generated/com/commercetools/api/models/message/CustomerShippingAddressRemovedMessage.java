...
public interface CustomerShippingAddressRemovedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerShippingAddressRemovedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerShippingAddressRemovedMessage>() {
            @Override
