...
public interface CustomerShippingAddressRemovedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerShippingAddressRemovedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerShippingAddressRemovedMessagePayload>() {
            @Override
