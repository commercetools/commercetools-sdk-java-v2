...
public class CustomerStoresSetMessageImpl implements CustomerStoresSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    CustomerStoresSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public CustomerStoresSetMessageImpl() {
        this.type = CUSTOMER_STORES_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        CustomerStoresSetMessageImpl that = (CustomerStoresSetMessageImpl) o;
    ...
    public CustomerStoresSetMessage copyDeep() {
        return CustomerStoresSetMessage.deepCopy(this);
    }
}
