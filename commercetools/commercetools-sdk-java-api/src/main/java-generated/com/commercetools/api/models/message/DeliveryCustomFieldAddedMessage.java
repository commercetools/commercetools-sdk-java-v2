...
public interface DeliveryCustomFieldAddedMessage extends OrderMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DeliveryCustomFieldAddedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<DeliveryCustomFieldAddedMessage>() {
            @Override
