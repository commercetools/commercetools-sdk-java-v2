...
public interface DeliveryCustomFieldChangedMessage extends OrderMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DeliveryCustomFieldChangedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<DeliveryCustomFieldChangedMessage>() {
            @Override
