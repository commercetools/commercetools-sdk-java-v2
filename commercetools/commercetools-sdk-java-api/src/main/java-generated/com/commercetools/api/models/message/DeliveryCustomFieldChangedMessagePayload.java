...
public interface DeliveryCustomFieldChangedMessagePayload extends OrderMessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DeliveryCustomFieldChangedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<DeliveryCustomFieldChangedMessagePayload>() {
            @Override
