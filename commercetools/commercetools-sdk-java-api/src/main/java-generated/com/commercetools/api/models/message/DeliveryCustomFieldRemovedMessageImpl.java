...
public class DeliveryCustomFieldRemovedMessageImpl implements DeliveryCustomFieldRemovedMessage, ModelBase {
     ...
     */
    @JsonCreator
    DeliveryCustomFieldRemovedMessageImpl(@JsonProperty("id") final String id,
            ...
            @JsonProperty("name") final String name, @JsonProperty("deliveryId") final String deliveryId) {
        this.id = id;
     ...
     */
    public DeliveryCustomFieldRemovedMessageImpl() {
        this.type = DELIVERY_CUSTOM_FIELD_REMOVED;
    }
    ...
    public boolean equals(Object o) {
        ...
        DeliveryCustomFieldRemovedMessageImpl that = (DeliveryCustomFieldRemovedMessageImpl) o;
    ...
    public DeliveryCustomFieldRemovedMessage copyDeep() {
        return DeliveryCustomFieldRemovedMessage.deepCopy(this);
    }
}
