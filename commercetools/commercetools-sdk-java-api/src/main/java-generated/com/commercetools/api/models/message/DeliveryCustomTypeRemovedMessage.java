...
public interface DeliveryCustomTypeRemovedMessage extends OrderMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DeliveryCustomTypeRemovedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<DeliveryCustomTypeRemovedMessage>() {
            @Override
