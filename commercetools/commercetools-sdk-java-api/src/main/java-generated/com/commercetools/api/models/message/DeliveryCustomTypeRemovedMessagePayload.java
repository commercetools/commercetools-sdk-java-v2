...
public interface DeliveryCustomTypeRemovedMessagePayload extends OrderMessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DeliveryCustomTypeRemovedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<DeliveryCustomTypeRemovedMessagePayload>() {
            @Override
