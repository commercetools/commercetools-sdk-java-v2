...
public interface DeliveryCustomTypeSetMessage extends OrderMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DeliveryCustomTypeSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<DeliveryCustomTypeSetMessage>() {
            @Override
