...
public final class DeliveryItemsUpdatedMessageBuilder {
    ...
    public DeliveryItemsUpdatedMessage build() {
        return new DeliveryItemsUpdatedMessageImpl(id, version, createdAt, lastModifiedAt, lastModifiedBy, createdBy, sequenceNumber, resource, resourceVersion, resourceUserProvidedIdentifiers, deliveryId, items, oldItems);
    }
