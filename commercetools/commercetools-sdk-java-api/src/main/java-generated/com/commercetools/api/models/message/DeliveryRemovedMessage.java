...
public interface DeliveryRemovedMessage extends OrderMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DeliveryRemovedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<DeliveryRemovedMessage>() {
            @Override
