...
public final class DeliveryRemovedMessageBuilder {
    ...
    public DeliveryRemovedMessage build() {
        return new DeliveryRemovedMessageImpl(id, version, createdAt, lastModifiedAt, lastModifiedBy, createdBy, sequenceNumber, resource, resourceVersion, resourceUserProvidedIdentifiers, delivery);
    }
