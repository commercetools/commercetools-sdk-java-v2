...
/**
 *  <p>Generated after a successful <a href="https://docs.commercetools.com/apis/ctp:api:type:OrderRemoveDeliveryAction" rel="nofollow">Remove Delivery</a> update action.</p>
 *
 * <hr>
...
public interface DeliveryRemovedMessagePayload extends OrderMessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DeliveryRemovedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<DeliveryRemovedMessagePayload>() {
            @Override
