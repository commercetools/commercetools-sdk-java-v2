...
public class DiscountCodeCreatedMessageImpl implements DiscountCodeCreatedMessage, ModelBase {
     ...
     */
    @JsonCreator
    DiscountCodeCreatedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public DiscountCodeCreatedMessageImpl() {
        this.type = DISCOUNT_CODE_CREATED;
    }
    ...
    public boolean equals(Object o) {
        ...
        DiscountCodeCreatedMessageImpl that = (DiscountCodeCreatedMessageImpl) o;
    ...
    @Override
    public DiscountCodeCreatedMessage copyDeep() {
        return DiscountCodeCreatedMessage.deepCopy(this);
    }
}
