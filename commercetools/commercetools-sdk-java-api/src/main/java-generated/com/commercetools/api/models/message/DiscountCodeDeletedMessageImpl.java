...
public class DiscountCodeDeletedMessageImpl implements DiscountCodeDeletedMessage, ModelBase {
     ...
     */
    @JsonCreator
    DiscountCodeDeletedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public DiscountCodeDeletedMessageImpl() {
        this.type = DISCOUNT_CODE_DELETED;
    }
    ...
    public boolean equals(Object o) {
        ...
        DiscountCodeDeletedMessageImpl that = (DiscountCodeDeletedMessageImpl) o;
