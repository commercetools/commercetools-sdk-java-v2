...
public interface DiscountCodeKeySetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountCodeKeySetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountCodeKeySetMessage>() {
            @Override
