...
public class DiscountCodeKeySetMessageImpl implements DiscountCodeKeySetMessage, ModelBase {
     ...
     */
    @JsonCreator
    DiscountCodeKeySetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
        ...
        this.key = key;
        this.oldKey = oldKey;
        this.type = DISCOUNT_CODE_KEY_SET;
    }

    /**
     * create empty instance
     */
    public DiscountCodeKeySetMessageImpl() {
        this.type = DISCOUNT_CODE_KEY_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        DiscountCodeKeySetMessageImpl that = (DiscountCodeKeySetMessageImpl) o;
