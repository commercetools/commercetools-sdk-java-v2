...
public interface DiscountGroupCreatedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountGroupCreatedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountGroupCreatedMessage>() {
            @Override
