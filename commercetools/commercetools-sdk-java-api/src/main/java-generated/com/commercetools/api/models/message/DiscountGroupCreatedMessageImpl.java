...
public class DiscountGroupCreatedMessageImpl implements DiscountGroupCreatedMessage, ModelBase {
     ...
     */
    @JsonCreator
    DiscountGroupCreatedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public DiscountGroupCreatedMessageImpl() {
        this.type = DISCOUNT_GROUP_CREATED;
    }
    ...
    public boolean equals(Object o) {
        ...
        DiscountGroupCreatedMessageImpl that = (DiscountGroupCreatedMessageImpl) o;
    ...
    public DiscountGroupCreatedMessage copyDeep() {
        return DiscountGroupCreatedMessage.deepCopy(this);
    }
}
