...
public interface DiscountGroupDeletedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountGroupDeletedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountGroupDeletedMessage>() {
            @Override
