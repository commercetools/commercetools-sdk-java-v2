...
public class DiscountGroupDeletedMessageImpl implements DiscountGroupDeletedMessage, ModelBase {
     ...
     */
    @JsonCreator
    DiscountGroupDeletedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public DiscountGroupDeletedMessageImpl() {
        this.type = DISCOUNT_GROUP_DELETED;
    }
    ...
    public boolean equals(Object o) {
        ...
        DiscountGroupDeletedMessageImpl that = (DiscountGroupDeletedMessageImpl) o;
    ...
    public DiscountGroupDeletedMessage copyDeep() {
        return DiscountGroupDeletedMessage.deepCopy(this);
    }
}
