...
public interface DiscountGroupDeletedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountGroupDeletedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountGroupDeletedMessagePayload>() {
            @Override
