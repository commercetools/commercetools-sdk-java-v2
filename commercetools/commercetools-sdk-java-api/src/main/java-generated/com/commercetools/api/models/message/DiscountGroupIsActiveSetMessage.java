...
public interface DiscountGroupIsActiveSetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountGroupIsActiveSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountGroupIsActiveSetMessage>() {
            @Override
