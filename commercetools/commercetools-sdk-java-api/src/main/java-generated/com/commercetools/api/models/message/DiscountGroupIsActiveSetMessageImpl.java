...
public class DiscountGroupIsActiveSetMessageImpl implements DiscountGroupIsActiveSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    DiscountGroupIsActiveSetMessageImpl(@JsonProperty("id") final String id,
            ...
            @JsonProperty("isActive") final Boolean isActive, @JsonProperty("oldIsActive") final Boolean oldIsActive) {
        this.id = id;
     ...
     */
    public DiscountGroupIsActiveSetMessageImpl() {
        this.type = DISCOUNT_GROUP_IS_ACTIVE_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        DiscountGroupIsActiveSetMessageImpl that = (DiscountGroupIsActiveSetMessageImpl) o;
    ...
    public DiscountGroupIsActiveSetMessage copyDeep() {
        return DiscountGroupIsActiveSetMessage.deepCopy(this);
    }
}
