...
public interface DiscountGroupIsActiveSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountGroupIsActiveSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountGroupIsActiveSetMessagePayload>() {
            @Override
