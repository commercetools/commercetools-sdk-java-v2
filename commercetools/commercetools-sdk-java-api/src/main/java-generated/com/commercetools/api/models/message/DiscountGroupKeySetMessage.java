...
public interface DiscountGroupKeySetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountGroupKeySetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountGroupKeySetMessage>() {
            @Override
