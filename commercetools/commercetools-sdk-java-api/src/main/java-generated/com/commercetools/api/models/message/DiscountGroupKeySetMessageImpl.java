...
public class DiscountGroupKeySetMessageImpl implements DiscountGroupKeySetMessage, ModelBase {
     ...
     */
    @JsonCreator
    DiscountGroupKeySetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public DiscountGroupKeySetMessageImpl() {
        this.type = DISCOUNT_GROUP_KEY_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        DiscountGroupKeySetMessageImpl that = (DiscountGroupKeySetMessageImpl) o;
    ...
    public DiscountGroupKeySetMessage copyDeep() {
        return DiscountGroupKeySetMessage.deepCopy(this);
    }
}
