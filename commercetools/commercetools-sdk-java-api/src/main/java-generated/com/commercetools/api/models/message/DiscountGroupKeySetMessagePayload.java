...
public interface DiscountGroupKeySetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountGroupKeySetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountGroupKeySetMessagePayload>() {
            @Override
