...
public interface DiscountGroupSortOrderSetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountGroupSortOrderSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountGroupSortOrderSetMessage>() {
            @Override
