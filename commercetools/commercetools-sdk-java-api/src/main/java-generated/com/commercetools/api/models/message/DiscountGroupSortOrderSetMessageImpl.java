...
public class DiscountGroupSortOrderSetMessageImpl implements DiscountGroupSortOrderSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    DiscountGroupSortOrderSetMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public DiscountGroupSortOrderSetMessageImpl() {
        this.type = DISCOUNT_GROUP_SORT_ORDER_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        DiscountGroupSortOrderSetMessageImpl that = (DiscountGroupSortOrderSetMessageImpl) o;
    ...
    public DiscountGroupSortOrderSetMessage copyDeep() {
        return DiscountGroupSortOrderSetMessage.deepCopy(this);
    }
}
