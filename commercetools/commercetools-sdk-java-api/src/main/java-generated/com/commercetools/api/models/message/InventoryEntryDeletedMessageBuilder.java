...
public class InventoryEntryDeletedMessageBuilder implements Builder<InventoryEntryDeletedMessage> {
    ...
    public InventoryEntryDeletedMessageBuilder withLastModifiedBy(
    ...
    public InventoryEntryDeletedMessageBuilder withCreatedBy(
    ...
    public InventoryEntryDeletedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public InventoryEntryDeletedMessageBuilder withSupplyChannel(
