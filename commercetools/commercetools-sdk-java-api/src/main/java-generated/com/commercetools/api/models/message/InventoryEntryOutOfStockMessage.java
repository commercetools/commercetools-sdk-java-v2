...
public interface InventoryEntryOutOfStockMessage extends Message {
     ...
     */
    public static com.fasterxml.jackson.core.type.TypeReference<InventoryEntryOutOfStockMessage> typeReference() {
        return new com.fasterxml.jackson.core.type.TypeReference<InventoryEntryOutOfStockMessage>() {
            @Override
