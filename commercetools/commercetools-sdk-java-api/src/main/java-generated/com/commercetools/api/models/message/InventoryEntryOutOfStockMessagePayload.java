...
public interface InventoryEntryOutOfStockMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<InventoryEntryOutOfStockMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<InventoryEntryOutOfStockMessagePayload>() {
            @Override
