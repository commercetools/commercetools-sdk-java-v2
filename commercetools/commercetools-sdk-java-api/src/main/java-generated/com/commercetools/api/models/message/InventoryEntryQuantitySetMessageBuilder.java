...
public final class InventoryEntryQuantitySetMessageBuilder {
    ...
    public InventoryEntryQuantitySetMessage build() {
        return new InventoryEntryQuantitySetMessageImpl(id, version, createdAt, lastModifiedAt, lastModifiedBy, createdBy, sequenceNumber, resource, resourceVersion, resourceUserProvidedIdentifiers, oldQuantityOnStock, newQuantityOnStock, oldAvailableQuantity, newAvailableQuantity);
    }
