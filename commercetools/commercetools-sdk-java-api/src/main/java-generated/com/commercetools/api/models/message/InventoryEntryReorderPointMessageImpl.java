...
public class InventoryEntryReorderPointMessageImpl implements InventoryEntryReorderPointMessage, ModelBase {
     ...
     */
    @JsonCreator
    InventoryEntryReorderPointMessageImpl(@JsonProperty("id") final String id,
            ...
            @JsonProperty("sku") final String sku, @JsonProperty("quantityOnStock") final Integer quantityOnStock,
        ...
        this.type = INVENTORY_ENTRY_REORDER_POINT;
    }

    /**
     * create empty instance
     */
    public InventoryEntryReorderPointMessageImpl() {
        this.type = INVENTORY_ENTRY_REORDER_POINT;
    }
    ...
    public boolean equals(Object o) {
        ...
        InventoryEntryReorderPointMessageImpl that = (InventoryEntryReorderPointMessageImpl) o;
    ...
    public InventoryEntryReorderPointMessage copyDeep() {
        return InventoryEntryReorderPointMessage.deepCopy(this);
    }
}
