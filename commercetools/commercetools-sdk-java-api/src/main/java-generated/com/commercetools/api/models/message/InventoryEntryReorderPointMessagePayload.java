...
public interface InventoryEntryReorderPointMessagePayload extends MessagePayload {
     ...
     */
    public static com.fasterxml.jackson.core.type.TypeReference<InventoryEntryReorderPointMessagePayload> typeReference() {
        return new com.fasterxml.jackson.core.type.TypeReference<InventoryEntryReorderPointMessagePayload>() {
            @Override
