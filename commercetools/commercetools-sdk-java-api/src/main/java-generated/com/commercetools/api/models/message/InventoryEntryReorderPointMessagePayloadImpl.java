...
public class InventoryEntryReorderPointMessagePayloadImpl
        implements InventoryEntryReorderPointMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    InventoryEntryReorderPointMessagePayloadImpl(@JsonProperty("sku") final String sku,
     ...
     */
    public InventoryEntryReorderPointMessagePayloadImpl() {
        this.type = INVENTORY_ENTRY_REORDER_POINT;
    }
    ...
    public boolean equals(Object o) {
        ...
        InventoryEntryReorderPointMessagePayloadImpl that = (InventoryEntryReorderPointMessagePayloadImpl) o;
    ...
    public InventoryEntryReorderPointMessagePayload copyDeep() {
        return InventoryEntryReorderPointMessagePayload.deepCopy(this);
    }
}
