...
public interface InventoryEntryReservationExpirationInMinutesSetMessage extends Message {
     ...
     */
    public static com.fasterxml.jackson.core.type.TypeReference<InventoryEntryReservationExpirationInMinutesSetMessage> typeReference() {
        return new com.fasterxml.jackson.core.type.TypeReference<InventoryEntryReservationExpirationInMinutesSetMessage>() {
            @Override
