...
public interface InventoryEntryReservationExpirationInMinutesSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<InventoryEntryReservationExpirationInMinutesSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<InventoryEntryReservationExpirationInMinutesSetMessagePayload>() {
            @Override
