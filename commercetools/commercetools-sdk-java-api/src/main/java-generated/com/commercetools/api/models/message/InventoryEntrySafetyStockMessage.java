...
public interface InventoryEntrySafetyStockMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<InventoryEntrySafetyStockMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<InventoryEntrySafetyStockMessage>() {
            @Override
