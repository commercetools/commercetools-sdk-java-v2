...
public interface InventoryEntrySafetyStockMessagePayload extends MessagePayload {
     ...
     */
    public static com.fasterxml.jackson.core.type.TypeReference<InventoryEntrySafetyStockMessagePayload> typeReference() {
        return new com.fasterxml.jackson.core.type.TypeReference<InventoryEntrySafetyStockMessagePayload>() {
            @Override
