...
@JsonSubTypes({
   ...
   @JsonSubTypes.Type(value = com.commercetools.api.models.message.ShoppingListStoreSetMessageImpl.class, name = ShoppingListStoreSetMessage.SHOPPING_LIST_STORE_SET)
})
@JsonTypeInfo(
