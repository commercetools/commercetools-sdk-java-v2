...
public interface MessagePagedQueryResponse extends com.commercetools.api.models.ResourcePagedQueryResponse<Message> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MessagePagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<MessagePagedQueryResponse>() {
            @Override
