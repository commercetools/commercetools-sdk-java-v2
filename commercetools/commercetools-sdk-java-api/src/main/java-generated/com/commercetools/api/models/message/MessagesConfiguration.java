...
public interface MessagesConfiguration {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MessagesConfiguration> typeReference() {
        return new tools.jackson.core.type.TypeReference<MessagesConfiguration>() {
            @Override
