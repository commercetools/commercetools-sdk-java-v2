...
public class OrderBusinessUnitSetMessageImpl implements OrderBusinessUnitSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    OrderBusinessUnitSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public OrderBusinessUnitSetMessageImpl() {
        this.type = ORDER_BUSINESS_UNIT_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        OrderBusinessUnitSetMessageImpl that = (OrderBusinessUnitSetMessageImpl) o;
