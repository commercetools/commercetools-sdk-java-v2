...
public class OrderCreatedFromRecurringOrderMessageImpl implements OrderCreatedFromRecurringOrderMessage, ModelBase {
     ...
     */
    @JsonCreator
    OrderCreatedFromRecurringOrderMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public OrderCreatedFromRecurringOrderMessageImpl() {
        this.type = ORDER_CREATED_FROM_RECURRING_ORDER;
    }
    ...
    public boolean equals(Object o) {
        ...
        OrderCreatedFromRecurringOrderMessageImpl that = (OrderCreatedFromRecurringOrderMessageImpl) o;
    ...
    public OrderCreatedFromRecurringOrderMessage copyDeep() {
        return OrderCreatedFromRecurringOrderMessage.deepCopy(this);
    }
}
