...
public interface OrderCreatedMessage extends OrderMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderCreatedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderCreatedMessage>() {
            @Override
