...
public class OrderCreatedMessageBuilder implements Builder<OrderCreatedMessage> {
    ...
    public OrderCreatedMessageBuilder withLastModifiedBy(
    ...
    public OrderCreatedMessageBuilder withCreatedBy(
    ...
    public OrderCreatedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public OrderCreatedMessageBuilder withOrder(
