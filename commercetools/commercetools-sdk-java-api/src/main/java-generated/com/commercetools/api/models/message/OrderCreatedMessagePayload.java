 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("OrderCreated")
...
public interface OrderCreatedMessagePayload extends OrderMessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderCreatedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderCreatedMessagePayload>() {
            @Override
