...
public class OrderCustomFieldAddedMessageImpl implements OrderCustomFieldAddedMessage, ModelBase {
     ...
     */
    @JsonCreator
    OrderCustomFieldAddedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public OrderCustomFieldAddedMessageImpl() {
        this.type = ORDER_CUSTOM_FIELD_ADDED;
    }
    ...
    public boolean equals(Object o) {
        ...
        OrderCustomFieldAddedMessageImpl that = (OrderCustomFieldAddedMessageImpl) o;
