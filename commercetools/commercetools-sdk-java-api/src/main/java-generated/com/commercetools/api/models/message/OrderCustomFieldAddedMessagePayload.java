 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("OrderCustomFieldAdded")
...
public interface OrderCustomFieldAddedMessagePayload extends OrderMessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderCustomFieldAddedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderCustomFieldAddedMessagePayload>() {
            @Override
