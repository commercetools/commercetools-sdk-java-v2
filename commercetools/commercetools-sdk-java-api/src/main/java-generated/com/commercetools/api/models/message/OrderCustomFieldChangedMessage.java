 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("OrderCustomFieldChanged")
...
public interface OrderCustomFieldChangedMessage extends OrderMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderCustomFieldChangedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderCustomFieldChangedMessage>() {
            @Override
