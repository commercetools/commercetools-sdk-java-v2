...
public interface OrderCustomFieldRemovedMessage extends OrderMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderCustomFieldRemovedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderCustomFieldRemovedMessage>() {
            @Override
