...
public class OrderCustomFieldRemovedMessageImpl implements OrderCustomFieldRemovedMessage, ModelBase {
     ...
     */
    @JsonCreator
    OrderCustomFieldRemovedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public OrderCustomFieldRemovedMessageImpl() {
        this.type = ORDER_CUSTOM_FIELD_REMOVED;
    }
    ...
    public boolean equals(Object o) {
        ...
        OrderCustomFieldRemovedMessageImpl that = (OrderCustomFieldRemovedMessageImpl) o;
