...
public class OrderCustomLineItemQuantityChangedMessagePayloadImpl implements OrderCustomLineItemQuantityChangedMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    OrderCustomLineItemQuantityChangedMessagePayloadImpl(@JsonProperty("customLineItemId") final String customLineItemId, @JsonProperty("quantity") final Long quantity, @JsonProperty("oldQuantity") final Long oldQuantity) {
