...
public class OrderCustomLineItemRemovedMessagePayloadBuilder implements Builder<OrderCustomLineItemRemovedMessagePayload> {
    ...
    public OrderCustomLineItemRemovedMessagePayloadBuilder customLineItem(Function<com.commercetools.api.models.cart.CustomLineItemBuilder, com.commercetools.api.models.cart.CustomLineItemBuilder> builder) {
    ...
    public OrderCustomLineItemRemovedMessagePayloadBuilder withCustomLineItem(Function<com.commercetools.api.models.cart.CustomLineItemBuilder, com.commercetools.api.models.cart.CustomLineItem> builder) {
    ...
    public OrderCustomLineItemRemovedMessagePayloadBuilder customLineItem( final com.commercetools.api.models.cart.CustomLineItem customLineItem) {
    ...
    public OrderCustomLineItemRemovedMessagePayload build() {
        Objects.requireNonNull(customLineItemId, OrderCustomLineItemRemovedMessagePayload.class + ": customLineItemId is missing");
        Objects.requireNonNull(customLineItem, OrderCustomLineItemRemovedMessagePayload.class + ": customLineItem is missing");
     ...
     * @return builder
     */
    public static OrderCustomLineItemRemovedMessagePayloadBuilder of(final OrderCustomLineItemRemovedMessagePayload template) {
