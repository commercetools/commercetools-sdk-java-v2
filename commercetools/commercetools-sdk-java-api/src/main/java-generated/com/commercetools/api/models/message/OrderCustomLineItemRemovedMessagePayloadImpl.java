...
public class OrderCustomLineItemRemovedMessagePayloadImpl implements OrderCustomLineItemRemovedMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    OrderCustomLineItemRemovedMessagePayloadImpl(@JsonProperty("customLineItemId") final String customLineItemId, @JsonProperty("customLineItem") final com.commercetools.api.models.cart.CustomLineItem customLineItem) {
