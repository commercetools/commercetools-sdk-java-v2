...
public interface OrderCustomTypeRemovedMessage extends OrderMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderCustomTypeRemovedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderCustomTypeRemovedMessage>() {
            @Override
