...
public class OrderCustomTypeRemovedMessageImpl implements OrderCustomTypeRemovedMessage, ModelBase {
     ...
     */
    @JsonCreator
    OrderCustomTypeRemovedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public OrderCustomTypeRemovedMessageImpl() {
        this.type = ORDER_CUSTOM_TYPE_REMOVED;
    }
    ...
    public boolean equals(Object o) {
        ...
        OrderCustomTypeRemovedMessageImpl that = (OrderCustomTypeRemovedMessageImpl) o;
