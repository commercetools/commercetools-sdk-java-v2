...
public interface OrderCustomTypeRemovedMessagePayload extends OrderMessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderCustomTypeRemovedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderCustomTypeRemovedMessagePayload>() {
            @Override
