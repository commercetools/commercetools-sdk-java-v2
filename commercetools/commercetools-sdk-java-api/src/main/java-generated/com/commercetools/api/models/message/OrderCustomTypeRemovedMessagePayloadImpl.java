...
public class OrderCustomTypeRemovedMessagePayloadImpl implements OrderCustomTypeRemovedMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    OrderCustomTypeRemovedMessagePayloadImpl(@JsonProperty("previousTypeId") final String previousTypeId) {
        this.previousTypeId = previousTypeId;
        this.type = ORDER_CUSTOM_TYPE_REMOVED;
    }

    /**
     * create empty instance
     */
    public OrderCustomTypeRemovedMessagePayloadImpl() {
        this.type = ORDER_CUSTOM_TYPE_REMOVED;
    }
    ...
    public boolean equals(Object o) {
        ...
        OrderCustomTypeRemovedMessagePayloadImpl that = (OrderCustomTypeRemovedMessagePayloadImpl) o;
