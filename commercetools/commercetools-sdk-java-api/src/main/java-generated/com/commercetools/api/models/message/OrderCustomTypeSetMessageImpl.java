...
public class OrderCustomTypeSetMessageImpl implements OrderCustomTypeSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    OrderCustomTypeSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
        ...
        this.type = ORDER_CUSTOM_TYPE_SET;
    }

    /**
     * create empty instance
     */
    public OrderCustomTypeSetMessageImpl() {
        this.type = ORDER_CUSTOM_TYPE_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        OrderCustomTypeSetMessageImpl that = (OrderCustomTypeSetMessageImpl) o;
