...
public interface OrderCustomerEmailSetMessage extends OrderMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderCustomerEmailSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderCustomerEmailSetMessage>() {
            @Override
