 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("OrderCustomerGroupSet")
...
public interface OrderCustomerGroupSetMessage extends OrderMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderCustomerGroupSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderCustomerGroupSetMessage>() {
            @Override
