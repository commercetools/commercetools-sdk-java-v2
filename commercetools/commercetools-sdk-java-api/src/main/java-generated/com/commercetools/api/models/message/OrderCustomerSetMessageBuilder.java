...
public class OrderCustomerSetMessageBuilder implements Builder<OrderCustomerSetMessage> {
    ...
    public OrderCustomerSetMessageBuilder withLastModifiedBy(
    ...
    public OrderCustomerSetMessageBuilder withCreatedBy(
    ...
    public OrderCustomerSetMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public OrderCustomerSetMessageBuilder withCustomer(
    ...
    public OrderCustomerSetMessageBuilder withCustomerGroup(
    ...
    public OrderCustomerSetMessageBuilder withOldCustomer(
            Function<com.commercetools.api.models.customer.CustomerReferenceBuilder, com.commercetools.api.models.customer.CustomerReference> builder) {
    ...
    public OrderCustomerSetMessageBuilder withOldCustomerGroup(
            Function<com.commercetools.api.models.customer_group.CustomerGroupReferenceBuilder, com.commercetools.api.models.customer_group.CustomerGroupReference> builder) {
        this.oldCustomerGroup = builder
                .apply(com.commercetools.api.models.customer_group.CustomerGroupReferenceBuilder.of());
        return this;
