...
public interface OrderDeletedMessage extends OrderMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderDeletedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderDeletedMessage>() {
            @Override
