...
public class OrderDeletedMessageBuilder implements Builder<OrderDeletedMessage> {
    ...
    public OrderDeletedMessageBuilder withLastModifiedBy(
    ...
    public OrderDeletedMessageBuilder withCreatedBy(
    ...
    public OrderDeletedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public OrderDeletedMessageBuilder withOrder(
    ...
    /**
     * builds OrderDeletedMessage with checking for non-null required values
    ...
    /**
     * factory method for an instance of OrderDeletedMessageBuilder
     * @return builder
     */
