...
public class OrderDiscountCodeAddedMessageBuilder implements Builder<OrderDiscountCodeAddedMessage> {
    ...
    public OrderDiscountCodeAddedMessageBuilder withLastModifiedBy(
    ...
    public OrderDiscountCodeAddedMessageBuilder withCreatedBy(
    ...
    public OrderDiscountCodeAddedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public OrderDiscountCodeAddedMessageBuilder withDiscountCode(
