...
public class OrderDiscountCodeRemovedMessageBuilder implements Builder<OrderDiscountCodeRemovedMessage> {
    ...
    public OrderDiscountCodeRemovedMessageBuilder withLastModifiedBy(
    ...
    public OrderDiscountCodeRemovedMessageBuilder withCreatedBy(
    ...
    public OrderDiscountCodeRemovedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public OrderDiscountCodeRemovedMessageBuilder withDiscountCode(
