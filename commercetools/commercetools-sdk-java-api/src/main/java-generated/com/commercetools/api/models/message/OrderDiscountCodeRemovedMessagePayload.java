 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("OrderDiscountCodeRemoved")
...
public interface OrderDiscountCodeRemovedMessagePayload extends OrderMessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderDiscountCodeRemovedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderDiscountCodeRemovedMessagePayload>() {
            @Override
