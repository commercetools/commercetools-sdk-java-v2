...
/**
 *  <p>Generated after the <a href="https://docs.commercetools.com/apis/ctp:api:type:DiscountCodeState" rel="nofollow">DiscountCodeState</a> changes due to a <a href="https://docs.commercetools.com/apis/ctp:api:type:CartRecalculateAction" rel="nofollow">recalculation</a>.</p>
 *
 * <hr>
...
public interface OrderDiscountCodeStateSetMessage extends OrderMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderDiscountCodeStateSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderDiscountCodeStateSetMessage>() {
            @Override
