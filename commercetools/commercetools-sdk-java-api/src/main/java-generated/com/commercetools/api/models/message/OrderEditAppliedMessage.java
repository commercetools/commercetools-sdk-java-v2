...
public interface OrderEditAppliedMessage extends OrderMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderEditAppliedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderEditAppliedMessage>() {
            @Override
