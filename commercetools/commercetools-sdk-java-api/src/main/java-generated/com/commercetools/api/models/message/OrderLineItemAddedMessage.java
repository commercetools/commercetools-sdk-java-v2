...
public interface OrderLineItemAddedMessage extends OrderMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderLineItemAddedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderLineItemAddedMessage>() {
            @Override
