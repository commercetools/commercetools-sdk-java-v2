...
public class OrderLineItemAddedMessageBuilder implements Builder<OrderLineItemAddedMessage> {
    ...
    public OrderLineItemAddedMessageBuilder withLastModifiedBy(
    ...
    public OrderLineItemAddedMessageBuilder withCreatedBy(
    ...
    public OrderLineItemAddedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public OrderLineItemAddedMessageBuilder withLineItem(
