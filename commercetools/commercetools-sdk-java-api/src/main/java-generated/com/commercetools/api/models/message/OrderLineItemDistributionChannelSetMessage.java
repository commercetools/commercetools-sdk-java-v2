...
import com.commercetools.api.models.message.OrderLineItemDistributionChannelSetMessageImpl;
...
public interface OrderLineItemDistributionChannelSetMessage extends OrderMessage {
     ...
     */
    public static OrderLineItemDistributionChannelSetMessage of(final OrderLineItemDistributionChannelSetMessage template) {
     ...
     */
    @Nullable
    public static OrderLineItemDistributionChannelSetMessage deepCopy(@Nullable final OrderLineItemDistributionChannelSetMessage template) {
        if (template == null) {
            return null;
        }
        OrderLineItemDistributionChannelSetMessageImpl instance = new OrderLineItemDistributionChannelSetMessageImpl();
     ...
     * @return builder
     */
    public static OrderLineItemDistributionChannelSetMessageBuilder builder(final OrderLineItemDistributionChannelSetMessage template) {
     ...
     * @return mapped value
     */
    default <T> T withOrderLineItemDistributionChannelSetMessage(Function<OrderLineItemDistributionChannelSetMessage, T> helper) {
