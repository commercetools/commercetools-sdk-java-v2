...
public interface OrderMessage extends Message {
    ...
    public static OrderMessage deepCopy(@Nullable final OrderMessage template) {
        ...
        if (!(template instanceof OrderMessageImpl)) {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderMessage>() {
            @Override
