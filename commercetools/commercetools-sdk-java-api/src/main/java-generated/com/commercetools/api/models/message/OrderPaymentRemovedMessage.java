...
public interface OrderPaymentRemovedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderPaymentRemovedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderPaymentRemovedMessage>() {
            @Override
