...
public interface OrderPaymentRemovedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderPaymentRemovedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderPaymentRemovedMessagePayload>() {
            @Override
