...
public interface OrderPaymentStateChangedMessagePayload extends OrderMessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderPaymentStateChangedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderPaymentStateChangedMessagePayload>() {
            @Override
