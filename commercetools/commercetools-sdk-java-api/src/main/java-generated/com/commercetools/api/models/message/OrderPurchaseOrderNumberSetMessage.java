...
import com.commercetools.api.models.message.OrderPurchaseOrderNumberSetMessageImpl;
...
public interface OrderPurchaseOrderNumberSetMessage extends OrderMessage {
     ...
     */
    @Nullable
    public static OrderPurchaseOrderNumberSetMessage deepCopy(@Nullable final OrderPurchaseOrderNumberSetMessage template) {
        if (template == null) {
            return null;
        }
        OrderPurchaseOrderNumberSetMessageImpl instance = new OrderPurchaseOrderNumberSetMessageImpl();
