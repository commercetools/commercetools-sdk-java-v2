...
public class OrderPurchaseOrderNumberSetMessageBuilder implements Builder<OrderPurchaseOrderNumberSetMessage> {
    ...
    public OrderPurchaseOrderNumberSetMessageBuilder lastModifiedBy(Function<com.commercetools.api.models.common.LastModifiedByBuilder, com.commercetools.api.models.common.LastModifiedByBuilder> builder) {
    ...
    public OrderPurchaseOrderNumberSetMessageBuilder withLastModifiedBy(Function<com.commercetools.api.models.common.LastModifiedByBuilder, com.commercetools.api.models.common.LastModifiedBy> builder) {
    ...
    public OrderPurchaseOrderNumberSetMessageBuilder lastModifiedBy(@Nullable final com.commercetools.api.models.common.LastModifiedBy lastModifiedBy) {
    ...
    public OrderPurchaseOrderNumberSetMessageBuilder createdBy(Function<com.commercetools.api.models.common.CreatedByBuilder, com.commercetools.api.models.common.CreatedByBuilder> builder) {
    ...
    public OrderPurchaseOrderNumberSetMessageBuilder withCreatedBy(Function<com.commercetools.api.models.common.CreatedByBuilder, com.commercetools.api.models.common.CreatedBy> builder) {
    ...
    public OrderPurchaseOrderNumberSetMessageBuilder createdBy(@Nullable final com.commercetools.api.models.common.CreatedBy createdBy) {
    ...
    public OrderPurchaseOrderNumberSetMessageBuilder resource( final com.commercetools.api.models.common.Reference resource) {
    ...
    public OrderPurchaseOrderNumberSetMessageBuilder resource(Function<com.commercetools.api.models.common.ReferenceBuilder, Builder<? extends com.commercetools.api.models.common.Reference>> builder) {
    ...
    public OrderPurchaseOrderNumberSetMessageBuilder resourceUserProvidedIdentifiers(Function<com.commercetools.api.models.message.UserProvidedIdentifiersBuilder, com.commercetools.api.models.message.UserProvidedIdentifiersBuilder> builder) {
    ...
    public OrderPurchaseOrderNumberSetMessageBuilder withResourceUserProvidedIdentifiers(Function<com.commercetools.api.models.message.UserProvidedIdentifiersBuilder, com.commercetools.api.models.message.UserProvidedIdentifiers> builder) {
    ...
    public OrderPurchaseOrderNumberSetMessageBuilder resourceUserProvidedIdentifiers(@Nullable final com.commercetools.api.models.message.UserProvidedIdentifiers resourceUserProvidedIdentifiers) {
    ...
    public OrderPurchaseOrderNumberSetMessageBuilder oldPurchaseOrderNumber(@Nullable final String oldPurchaseOrderNumber) {
     ...
     * @return OrderPurchaseOrderNumberSetMessage
     */
    public OrderPurchaseOrderNumberSetMessage build() {
        ...
        Objects.requireNonNull(lastModifiedAt, OrderPurchaseOrderNumberSetMessage.class + ": lastModifiedAt is missing");
        Objects.requireNonNull(sequenceNumber, OrderPurchaseOrderNumberSetMessage.class + ": sequenceNumber is missing");
        Objects.requireNonNull(resource, OrderPurchaseOrderNumberSetMessage.class + ": resource is missing");
        Objects.requireNonNull(resourceVersion, OrderPurchaseOrderNumberSetMessage.class + ": resourceVersion is missing");
        return new OrderPurchaseOrderNumberSetMessageImpl(id, version, createdAt, lastModifiedAt, lastModifiedBy, createdBy, sequenceNumber, resource, resourceVersion, resourceUserProvidedIdentifiers, purchaseOrderNumber, oldPurchaseOrderNumber);
    }
