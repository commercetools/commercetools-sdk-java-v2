...
public interface OrderPurchaseOrderNumberSetMessagePayload extends OrderMessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderPurchaseOrderNumberSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderPurchaseOrderNumberSetMessagePayload>() {
            @Override
