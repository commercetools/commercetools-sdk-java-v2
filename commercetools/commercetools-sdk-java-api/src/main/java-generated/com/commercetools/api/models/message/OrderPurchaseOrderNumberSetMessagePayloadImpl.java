...
public class OrderPurchaseOrderNumberSetMessagePayloadImpl implements OrderPurchaseOrderNumberSetMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    OrderPurchaseOrderNumberSetMessagePayloadImpl(@JsonProperty("purchaseOrderNumber") final String purchaseOrderNumber, @JsonProperty("oldPurchaseOrderNumber") final String oldPurchaseOrderNumber) {
