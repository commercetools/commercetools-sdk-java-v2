...
public class OrderShipmentStateChangedMessageBuilder implements Builder<OrderShipmentStateChangedMessage> {
    ...
    public OrderShipmentStateChangedMessageBuilder lastModifiedBy(Function<com.commercetools.api.models.common.LastModifiedByBuilder, com.commercetools.api.models.common.LastModifiedByBuilder> builder) {
    ...
    public OrderShipmentStateChangedMessageBuilder withLastModifiedBy(Function<com.commercetools.api.models.common.LastModifiedByBuilder, com.commercetools.api.models.common.LastModifiedBy> builder) {
    ...
    public OrderShipmentStateChangedMessageBuilder lastModifiedBy(@Nullable final com.commercetools.api.models.common.LastModifiedBy lastModifiedBy) {
    ...
    public OrderShipmentStateChangedMessageBuilder createdBy(Function<com.commercetools.api.models.common.CreatedByBuilder, com.commercetools.api.models.common.CreatedByBuilder> builder) {
    ...
    public OrderShipmentStateChangedMessageBuilder withCreatedBy(Function<com.commercetools.api.models.common.CreatedByBuilder, com.commercetools.api.models.common.CreatedBy> builder) {
    ...
    public OrderShipmentStateChangedMessageBuilder createdBy(@Nullable final com.commercetools.api.models.common.CreatedBy createdBy) {
    ...
    public OrderShipmentStateChangedMessageBuilder resource( final com.commercetools.api.models.common.Reference resource) {
    ...
    public OrderShipmentStateChangedMessageBuilder resource(Function<com.commercetools.api.models.common.ReferenceBuilder, Builder<? extends com.commercetools.api.models.common.Reference>> builder) {
    ...
    public OrderShipmentStateChangedMessageBuilder resourceUserProvidedIdentifiers(Function<com.commercetools.api.models.message.UserProvidedIdentifiersBuilder, com.commercetools.api.models.message.UserProvidedIdentifiersBuilder> builder) {
    ...
    public OrderShipmentStateChangedMessageBuilder withResourceUserProvidedIdentifiers(Function<com.commercetools.api.models.message.UserProvidedIdentifiersBuilder, com.commercetools.api.models.message.UserProvidedIdentifiers> builder) {
    ...
    public OrderShipmentStateChangedMessageBuilder resourceUserProvidedIdentifiers(@Nullable final com.commercetools.api.models.message.UserProvidedIdentifiers resourceUserProvidedIdentifiers) {
    ...
    public OrderShipmentStateChangedMessageBuilder shipmentState( final com.commercetools.api.models.order.ShipmentState shipmentState) {
    ...
    public OrderShipmentStateChangedMessageBuilder oldShipmentState( final com.commercetools.api.models.order.ShipmentState oldShipmentState) {
    ...
    /**
     * builds OrderShipmentStateChangedMessage with checking for non-null required values
    ...
    public OrderShipmentStateChangedMessage build() {
        ...
        Objects.requireNonNull(resourceVersion, OrderShipmentStateChangedMessage.class + ": resourceVersion is missing");
        Objects.requireNonNull(shipmentState, OrderShipmentStateChangedMessage.class + ": shipmentState is missing");
        Objects.requireNonNull(oldShipmentState, OrderShipmentStateChangedMessage.class + ": oldShipmentState is missing");
        return new OrderShipmentStateChangedMessageImpl(id, version, createdAt, lastModifiedAt, lastModifiedBy, createdBy, sequenceNumber, resource, resourceVersion, resourceUserProvidedIdentifiers, shipmentState, oldShipmentState);
    }
    ...
    /**
     * factory method for an instance of OrderShipmentStateChangedMessageBuilder
     * @return builder 
     */
