...
public final class OrderShipmentStateChangedMessagePayloadImpl implements OrderShipmentStateChangedMessagePayload {
    ...
    OrderShipmentStateChangedMessagePayloadImpl(
        ...
        this.type = OrderShipmentStateChangedMessagePayload.ORDER_SHIPMENT_STATE_CHANGED;
    }
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder().append(type, that.type).append(shipmentState, that.shipmentState).append(
