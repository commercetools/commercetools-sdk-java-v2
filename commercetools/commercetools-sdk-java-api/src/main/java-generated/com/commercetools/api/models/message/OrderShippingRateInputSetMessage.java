...
public interface OrderShippingRateInputSetMessage extends OrderMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderShippingRateInputSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderShippingRateInputSetMessage>() {
            @Override
