...
public class OrderStateChangedMessageBuilder implements Builder<OrderStateChangedMessage> {
    ...
    public OrderStateChangedMessageBuilder withLastModifiedBy(
    ...
    public OrderStateChangedMessageBuilder withCreatedBy(
    ...
    public OrderStateChangedMessageBuilder withResourceUserProvidedIdentifiers(
