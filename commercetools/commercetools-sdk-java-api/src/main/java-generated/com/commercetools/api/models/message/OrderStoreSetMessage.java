...
public interface OrderStoreSetMessage extends OrderMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderStoreSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderStoreSetMessage>() {
            @Override
