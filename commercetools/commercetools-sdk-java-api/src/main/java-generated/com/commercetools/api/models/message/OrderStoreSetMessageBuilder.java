...
public class OrderStoreSetMessageBuilder implements Builder<OrderStoreSetMessage> {
    ...
    public OrderStoreSetMessageBuilder withLastModifiedBy(
    ...
    public OrderStoreSetMessageBuilder withCreatedBy(
    ...
    public OrderStoreSetMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public OrderStoreSetMessageBuilder withStore(
