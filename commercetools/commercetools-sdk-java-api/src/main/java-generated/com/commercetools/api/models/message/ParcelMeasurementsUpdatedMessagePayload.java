...
public interface ParcelMeasurementsUpdatedMessagePayload extends OrderMessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ParcelMeasurementsUpdatedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<ParcelMeasurementsUpdatedMessagePayload>() {
            @Override
