...
public interface ParcelRemovedFromDeliveryMessagePayload extends OrderMessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ParcelRemovedFromDeliveryMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<ParcelRemovedFromDeliveryMessagePayload>() {
            @Override
