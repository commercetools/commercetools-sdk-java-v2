...
public class ParcelRemovedFromDeliveryMessagePayloadImpl implements ParcelRemovedFromDeliveryMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    ParcelRemovedFromDeliveryMessagePayloadImpl(@JsonProperty("deliveryId") final String deliveryId, @JsonProperty("parcel") final com.commercetools.api.models.order.Parcel parcel, @JsonProperty("shippingKey") final String shippingKey) {
