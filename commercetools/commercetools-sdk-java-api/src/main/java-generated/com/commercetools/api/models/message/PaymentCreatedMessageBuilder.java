...
public class PaymentCreatedMessageBuilder implements Builder<PaymentCreatedMessage> {
    ...
    public PaymentCreatedMessageBuilder withLastModifiedBy(
    ...
    public PaymentCreatedMessageBuilder withCreatedBy(
    ...
    public PaymentCreatedMessageBuilder resource(
    ...
    public PaymentCreatedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public PaymentCreatedMessageBuilder withPayment(
    ...
    /**
     * builds PaymentCreatedMessage with checking for non-null required values
    ...
    /**
     * factory method for an instance of PaymentCreatedMessageBuilder
     * @return builder
     */
