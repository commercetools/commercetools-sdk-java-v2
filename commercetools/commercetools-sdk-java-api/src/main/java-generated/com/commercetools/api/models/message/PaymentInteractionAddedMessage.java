 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("PaymentInteractionAdded")
...
public interface PaymentInteractionAddedMessage extends Message {
    ...
    public PaymentInteractionAddedMessage copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentInteractionAddedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentInteractionAddedMessage>() {
            @Override
