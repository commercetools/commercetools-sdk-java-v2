...
public interface PaymentInterfaceIdSetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentInterfaceIdSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentInterfaceIdSetMessage>() {
            @Override
