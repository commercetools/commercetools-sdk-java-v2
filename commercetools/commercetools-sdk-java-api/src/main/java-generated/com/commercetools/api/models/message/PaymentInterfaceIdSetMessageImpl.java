...
public class PaymentInterfaceIdSetMessageImpl implements PaymentInterfaceIdSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    PaymentInterfaceIdSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public PaymentInterfaceIdSetMessageImpl() {
        this.type = PAYMENT_INTERFACE_ID_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        PaymentInterfaceIdSetMessageImpl that = (PaymentInterfaceIdSetMessageImpl) o;
    ...
    public PaymentInterfaceIdSetMessage copyDeep() {
        return PaymentInterfaceIdSetMessage.deepCopy(this);
    }
}
