...
public class PaymentMethodCreatedMessageImpl implements PaymentMethodCreatedMessage, ModelBase {
     ...
     */
    @JsonCreator
    PaymentMethodCreatedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public PaymentMethodCreatedMessageImpl() {
        this.type = PAYMENT_METHOD_CREATED;
    }
    ...
    public boolean equals(Object o) {
        ...
        PaymentMethodCreatedMessageImpl that = (PaymentMethodCreatedMessageImpl) o;
    ...
    public PaymentMethodCreatedMessage copyDeep() {
        return PaymentMethodCreatedMessage.deepCopy(this);
    }
}
