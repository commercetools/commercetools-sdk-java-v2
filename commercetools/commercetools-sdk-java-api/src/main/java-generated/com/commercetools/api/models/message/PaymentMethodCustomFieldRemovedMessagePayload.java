...
public interface PaymentMethodCustomFieldRemovedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodCustomFieldRemovedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodCustomFieldRemovedMessagePayload>() {
            @Override
