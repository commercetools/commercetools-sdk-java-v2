...
public interface PaymentMethodCustomTypeRemovedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodCustomTypeRemovedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodCustomTypeRemovedMessage>() {
            @Override
