...
public interface PaymentMethodCustomTypeRemovedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodCustomTypeRemovedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodCustomTypeRemovedMessagePayload>() {
            @Override
