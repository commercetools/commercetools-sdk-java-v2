...
public interface PaymentMethodCustomTypeSetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodCustomTypeSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodCustomTypeSetMessage>() {
            @Override
