...
public class PaymentMethodDefaultSetMessageImpl implements PaymentMethodDefaultSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    PaymentMethodDefaultSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
            ...
            @JsonProperty("default") final Boolean _default, @JsonProperty("oldDefault") final Boolean oldDefault) {
        this.id = id;
     ...
     */
    public PaymentMethodDefaultSetMessageImpl() {
        this.type = PAYMENT_METHOD_DEFAULT_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        PaymentMethodDefaultSetMessageImpl that = (PaymentMethodDefaultSetMessageImpl) o;
    ...
    public PaymentMethodDefaultSetMessage copyDeep() {
        return PaymentMethodDefaultSetMessage.deepCopy(this);
    }
}
