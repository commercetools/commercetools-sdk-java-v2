...
public class PaymentMethodDeletedMessageImpl implements PaymentMethodDeletedMessage, ModelBase {
     ...
     */
    @JsonCreator
    PaymentMethodDeletedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public PaymentMethodDeletedMessageImpl() {
        this.type = PAYMENT_METHOD_DELETED;
    }
    ...
    public boolean equals(Object o) {
        ...
        PaymentMethodDeletedMessageImpl that = (PaymentMethodDeletedMessageImpl) o;
    ...
    public PaymentMethodDeletedMessage copyDeep() {
        return PaymentMethodDeletedMessage.deepCopy(this);
    }
}
