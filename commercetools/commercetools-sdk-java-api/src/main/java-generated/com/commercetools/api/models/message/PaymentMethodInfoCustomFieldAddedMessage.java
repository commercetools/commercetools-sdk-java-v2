...
public interface PaymentMethodInfoCustomFieldAddedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodInfoCustomFieldAddedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodInfoCustomFieldAddedMessage>() {
            @Override
