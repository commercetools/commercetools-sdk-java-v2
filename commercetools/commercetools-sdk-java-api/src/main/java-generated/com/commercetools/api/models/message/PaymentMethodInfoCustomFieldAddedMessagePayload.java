...
public interface PaymentMethodInfoCustomFieldAddedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodInfoCustomFieldAddedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodInfoCustomFieldAddedMessagePayload>() {
            @Override
