...
public interface PaymentMethodInfoCustomFieldChangedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodInfoCustomFieldChangedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodInfoCustomFieldChangedMessage>() {
            @Override
