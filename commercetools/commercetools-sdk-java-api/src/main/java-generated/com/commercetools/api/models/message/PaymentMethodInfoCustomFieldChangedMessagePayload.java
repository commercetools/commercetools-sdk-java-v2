...
public interface PaymentMethodInfoCustomFieldChangedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodInfoCustomFieldChangedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodInfoCustomFieldChangedMessagePayload>() {
            @Override
