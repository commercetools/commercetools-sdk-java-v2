...
public interface PaymentMethodInfoCustomFieldRemovedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodInfoCustomFieldRemovedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodInfoCustomFieldRemovedMessage>() {
            @Override
