...
public interface PaymentMethodInfoCustomTypeSetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodInfoCustomTypeSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodInfoCustomTypeSetMessage>() {
            @Override
