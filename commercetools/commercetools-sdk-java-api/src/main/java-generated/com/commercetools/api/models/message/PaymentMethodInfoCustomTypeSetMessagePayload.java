...
public interface PaymentMethodInfoCustomTypeSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodInfoCustomTypeSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodInfoCustomTypeSetMessagePayload>() {
            @Override
