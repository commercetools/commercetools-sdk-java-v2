...
public interface PaymentMethodInfoInterfaceAccountSetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodInfoInterfaceAccountSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodInfoInterfaceAccountSetMessage>() {
            @Override
