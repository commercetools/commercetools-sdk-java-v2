...
public class PaymentMethodInfoInterfaceSetMessageImpl implements PaymentMethodInfoInterfaceSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    PaymentMethodInfoInterfaceSetMessageImpl(@JsonProperty("id") final String id,
            ...
            @JsonProperty("interface") final String _interface,
     ...
     */
    public PaymentMethodInfoInterfaceSetMessageImpl() {
        this.type = PAYMENT_METHOD_INFO_INTERFACE_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        PaymentMethodInfoInterfaceSetMessageImpl that = (PaymentMethodInfoInterfaceSetMessageImpl) o;
    ...
    public PaymentMethodInfoInterfaceSetMessage copyDeep() {
        return PaymentMethodInfoInterfaceSetMessage.deepCopy(this);
    }
}
