...
public interface PaymentMethodInfoInterfaceSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodInfoInterfaceSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodInfoInterfaceSetMessagePayload>() {
            @Override
