...
public interface PaymentMethodInterfaceAccountSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodInterfaceAccountSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodInterfaceAccountSetMessagePayload>() {
            @Override
