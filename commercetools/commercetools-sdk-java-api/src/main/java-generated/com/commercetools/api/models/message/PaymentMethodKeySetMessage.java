...
public interface PaymentMethodKeySetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodKeySetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodKeySetMessage>() {
            @Override
