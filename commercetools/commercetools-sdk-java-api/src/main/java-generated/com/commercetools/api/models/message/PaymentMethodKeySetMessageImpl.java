...
public class PaymentMethodKeySetMessageImpl implements PaymentMethodKeySetMessage, ModelBase {
     ...
     */
    @JsonCreator
    PaymentMethodKeySetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public PaymentMethodKeySetMessageImpl() {
        this.type = PAYMENT_METHOD_KEY_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        PaymentMethodKeySetMessageImpl that = (PaymentMethodKeySetMessageImpl) o;
    ...
    public PaymentMethodKeySetMessage copyDeep() {
        return PaymentMethodKeySetMessage.deepCopy(this);
    }
}
