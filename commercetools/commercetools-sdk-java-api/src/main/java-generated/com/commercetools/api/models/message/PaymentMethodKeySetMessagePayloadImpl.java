...
public class PaymentMethodKeySetMessagePayloadImpl implements PaymentMethodKeySetMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    PaymentMethodKeySetMessagePayloadImpl(@JsonProperty("key") final String key,
            @JsonProperty("oldKey") final String oldKey) {
        this.key = key;
        this.oldKey = oldKey;
        this.type = PAYMENT_METHOD_KEY_SET;
    }

    /**
     * create empty instance
     */
    public PaymentMethodKeySetMessagePayloadImpl() {
        this.type = PAYMENT_METHOD_KEY_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        PaymentMethodKeySetMessagePayloadImpl that = (PaymentMethodKeySetMessagePayloadImpl) o;
    ...
    public PaymentMethodKeySetMessagePayload copyDeep() {
        return PaymentMethodKeySetMessagePayload.deepCopy(this);
    }
}
