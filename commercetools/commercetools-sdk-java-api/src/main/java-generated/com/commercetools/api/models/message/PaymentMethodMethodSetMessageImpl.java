...
public class PaymentMethodMethodSetMessageImpl implements PaymentMethodMethodSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    PaymentMethodMethodSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
            ...
            @JsonProperty("method") final String method, @JsonProperty("oldMethod") final String oldMethod) {
        this.id = id;
     ...
     */
    public PaymentMethodMethodSetMessageImpl() {
        this.type = PAYMENT_METHOD_METHOD_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        PaymentMethodMethodSetMessageImpl that = (PaymentMethodMethodSetMessageImpl) o;
    ...
    public PaymentMethodMethodSetMessage copyDeep() {
        return PaymentMethodMethodSetMessage.deepCopy(this);
    }
}
