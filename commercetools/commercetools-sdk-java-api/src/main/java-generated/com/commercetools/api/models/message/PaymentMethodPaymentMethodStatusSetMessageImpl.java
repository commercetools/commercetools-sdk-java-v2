...
public class PaymentMethodPaymentMethodStatusSetMessageImpl
        implements PaymentMethodPaymentMethodStatusSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    PaymentMethodPaymentMethodStatusSetMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public PaymentMethodPaymentMethodStatusSetMessageImpl() {
        this.type = PAYMENT_METHOD_PAYMENT_METHOD_STATUS_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        PaymentMethodPaymentMethodStatusSetMessageImpl that = (PaymentMethodPaymentMethodStatusSetMessageImpl) o;
    ...
    public PaymentMethodPaymentMethodStatusSetMessage copyDeep() {
        return PaymentMethodPaymentMethodStatusSetMessage.deepCopy(this);
    }
}
