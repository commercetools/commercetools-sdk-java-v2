...
public interface PaymentMethodPaymentMethodStatusSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodPaymentMethodStatusSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodPaymentMethodStatusSetMessagePayload>() {
            @Override
