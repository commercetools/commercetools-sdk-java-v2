...
public class PaymentStatusInterfaceCodeSetMessageBuilder implements Builder<PaymentStatusInterfaceCodeSetMessage> {
    ...
    public PaymentStatusInterfaceCodeSetMessageBuilder lastModifiedBy(Function<com.commercetools.api.models.common.LastModifiedByBuilder, com.commercetools.api.models.common.LastModifiedByBuilder> builder) {
    ...
    public PaymentStatusInterfaceCodeSetMessageBuilder withLastModifiedBy(Function<com.commercetools.api.models.common.LastModifiedByBuilder, com.commercetools.api.models.common.LastModifiedBy> builder) {
    ...
    public PaymentStatusInterfaceCodeSetMessageBuilder lastModifiedBy(@Nullable final com.commercetools.api.models.common.LastModifiedBy lastModifiedBy) {
    ...
    public PaymentStatusInterfaceCodeSetMessageBuilder createdBy(Function<com.commercetools.api.models.common.CreatedByBuilder, com.commercetools.api.models.common.CreatedByBuilder> builder) {
    ...
    public PaymentStatusInterfaceCodeSetMessageBuilder withCreatedBy(Function<com.commercetools.api.models.common.CreatedByBuilder, com.commercetools.api.models.common.CreatedBy> builder) {
    ...
    public PaymentStatusInterfaceCodeSetMessageBuilder createdBy(@Nullable final com.commercetools.api.models.common.CreatedBy createdBy) {
    ...
    public PaymentStatusInterfaceCodeSetMessageBuilder resource( final com.commercetools.api.models.common.Reference resource) {
    ...
    public PaymentStatusInterfaceCodeSetMessageBuilder resource(Function<com.commercetools.api.models.common.ReferenceBuilder, Builder<? extends com.commercetools.api.models.common.Reference>> builder) {
    ...
    public PaymentStatusInterfaceCodeSetMessageBuilder resourceUserProvidedIdentifiers(Function<com.commercetools.api.models.message.UserProvidedIdentifiersBuilder, com.commercetools.api.models.message.UserProvidedIdentifiersBuilder> builder) {
    ...
    public PaymentStatusInterfaceCodeSetMessageBuilder withResourceUserProvidedIdentifiers(Function<com.commercetools.api.models.message.UserProvidedIdentifiersBuilder, com.commercetools.api.models.message.UserProvidedIdentifiers> builder) {
    ...
    public PaymentStatusInterfaceCodeSetMessageBuilder resourceUserProvidedIdentifiers(@Nullable final com.commercetools.api.models.message.UserProvidedIdentifiers resourceUserProvidedIdentifiers) {
    ...
    /**
     * builds PaymentStatusInterfaceCodeSetMessage with checking for non-null required values
    ...
    public PaymentStatusInterfaceCodeSetMessage build() {
        ...
        Objects.requireNonNull(lastModifiedAt, PaymentStatusInterfaceCodeSetMessage.class + ": lastModifiedAt is missing");
        Objects.requireNonNull(sequenceNumber, PaymentStatusInterfaceCodeSetMessage.class + ": sequenceNumber is missing");
        Objects.requireNonNull(resource, PaymentStatusInterfaceCodeSetMessage.class + ": resource is missing");
        Objects.requireNonNull(resourceVersion, PaymentStatusInterfaceCodeSetMessage.class + ": resourceVersion is missing");
        Objects.requireNonNull(paymentId, PaymentStatusInterfaceCodeSetMessage.class + ": paymentId is missing");
        return new PaymentStatusInterfaceCodeSetMessageImpl(id, version, createdAt, lastModifiedAt, lastModifiedBy, createdBy, sequenceNumber, resource, resourceVersion, resourceUserProvidedIdentifiers, paymentId, interfaceCode);
    }
    ...
    /**
     * factory method for an instance of PaymentStatusInterfaceCodeSetMessageBuilder
     * @return builder 
     */
