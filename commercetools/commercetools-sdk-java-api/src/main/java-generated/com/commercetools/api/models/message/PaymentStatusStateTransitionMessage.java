...
public interface PaymentStatusStateTransitionMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentStatusStateTransitionMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentStatusStateTransitionMessage>() {
            @Override
