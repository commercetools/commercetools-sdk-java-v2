...
public class PaymentStatusStateTransitionMessageBuilder implements Builder<PaymentStatusStateTransitionMessage> {
    ...
    public PaymentStatusStateTransitionMessageBuilder lastModifiedBy(Function<com.commercetools.api.models.common.LastModifiedByBuilder, com.commercetools.api.models.common.LastModifiedByBuilder> builder) {
    ...
    public PaymentStatusStateTransitionMessageBuilder withLastModifiedBy(Function<com.commercetools.api.models.common.LastModifiedByBuilder, com.commercetools.api.models.common.LastModifiedBy> builder) {
    ...
    public PaymentStatusStateTransitionMessageBuilder createdBy(Function<com.commercetools.api.models.common.CreatedByBuilder, com.commercetools.api.models.common.CreatedByBuilder> builder) {
    ...
    public PaymentStatusStateTransitionMessageBuilder withCreatedBy(Function<com.commercetools.api.models.common.CreatedByBuilder, com.commercetools.api.models.common.CreatedBy> builder) {
    ...
    public PaymentStatusStateTransitionMessageBuilder resource(Function<com.commercetools.api.models.common.ReferenceBuilder, Builder<? extends com.commercetools.api.models.common.Reference>> builder) {
    ...
    public PaymentStatusStateTransitionMessageBuilder resourceUserProvidedIdentifiers(Function<com.commercetools.api.models.message.UserProvidedIdentifiersBuilder, com.commercetools.api.models.message.UserProvidedIdentifiersBuilder> builder) {
    ...
    public PaymentStatusStateTransitionMessageBuilder withResourceUserProvidedIdentifiers(Function<com.commercetools.api.models.message.UserProvidedIdentifiersBuilder, com.commercetools.api.models.message.UserProvidedIdentifiers> builder) {
    ...
    public PaymentStatusStateTransitionMessageBuilder state(Function<com.commercetools.api.models.state.StateReferenceBuilder, com.commercetools.api.models.state.StateReferenceBuilder> builder) {
    ...
    public PaymentStatusStateTransitionMessageBuilder withState(Function<com.commercetools.api.models.state.StateReferenceBuilder, com.commercetools.api.models.state.StateReference> builder) {
    ...
    /**
     * builds PaymentStatusStateTransitionMessage with checking for non-null required values
    ...
    public PaymentStatusStateTransitionMessage build() {
        ...
        Objects.requireNonNull(lastModifiedAt, PaymentStatusStateTransitionMessage.class + ": lastModifiedAt is missing");
        Objects.requireNonNull(sequenceNumber, PaymentStatusStateTransitionMessage.class + ": sequenceNumber is missing");
        Objects.requireNonNull(resource, PaymentStatusStateTransitionMessage.class + ": resource is missing");
        Objects.requireNonNull(resourceVersion, PaymentStatusStateTransitionMessage.class + ": resourceVersion is missing");
        ...
        return new PaymentStatusStateTransitionMessageImpl(id, version, createdAt, lastModifiedAt, lastModifiedBy, createdBy, sequenceNumber, resource, resourceVersion, resourceUserProvidedIdentifiers, state, force);
    }
    ...
    /**
     * factory method for an instance of PaymentStatusStateTransitionMessageBuilder
     * @return builder 
     */
