 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("PaymentStatusStateTransition")
...
public interface PaymentStatusStateTransitionMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentStatusStateTransitionMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentStatusStateTransitionMessagePayload>() {
            @Override
