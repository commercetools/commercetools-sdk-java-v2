...
public interface PaymentTransactionAddedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentTransactionAddedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentTransactionAddedMessage>() {
            @Override
