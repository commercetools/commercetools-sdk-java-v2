...
public class PaymentTransactionAddedMessageBuilder implements Builder<PaymentTransactionAddedMessage> {
    ...
    public PaymentTransactionAddedMessageBuilder withLastModifiedBy(
    ...
    public PaymentTransactionAddedMessageBuilder withCreatedBy(
    ...
    public PaymentTransactionAddedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public PaymentTransactionAddedMessageBuilder withTransaction(
