...
public interface PaymentTransactionInterfaceIdSetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentTransactionInterfaceIdSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentTransactionInterfaceIdSetMessage>() {
            @Override
