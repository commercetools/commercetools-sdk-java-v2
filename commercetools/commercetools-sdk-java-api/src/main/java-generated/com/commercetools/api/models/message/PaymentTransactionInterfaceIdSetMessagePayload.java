...
public interface PaymentTransactionInterfaceIdSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentTransactionInterfaceIdSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentTransactionInterfaceIdSetMessagePayload>() {
            @Override
