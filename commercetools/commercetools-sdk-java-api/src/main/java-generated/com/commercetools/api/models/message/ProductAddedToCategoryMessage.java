...
public interface ProductAddedToCategoryMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductAddedToCategoryMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductAddedToCategoryMessage>() {
            @Override
