...
public interface ProductAddedToCategoryMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductAddedToCategoryMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductAddedToCategoryMessagePayload>() {
            @Override
