...
public class ProductCreatedMessageBuilder implements Builder<ProductCreatedMessage> {
    ...
    public ProductCreatedMessageBuilder withLastModifiedBy(
    ...
    public ProductCreatedMessageBuilder withCreatedBy(
    ...
    public ProductCreatedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public ProductCreatedMessageBuilder withProductProjection(
