 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ProductDeleted")
...
public interface ProductDeletedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductDeletedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductDeletedMessagePayload>() {
            @Override
