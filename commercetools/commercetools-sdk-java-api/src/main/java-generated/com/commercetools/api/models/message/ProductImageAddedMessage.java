...
public interface ProductImageAddedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductImageAddedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductImageAddedMessage>() {
            @Override
