 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ProductImageAdded")
...
public interface ProductImageAddedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductImageAddedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductImageAddedMessagePayload>() {
            @Override
