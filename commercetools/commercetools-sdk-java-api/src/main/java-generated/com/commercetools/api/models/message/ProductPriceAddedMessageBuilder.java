...
public class ProductPriceAddedMessageBuilder implements Builder<ProductPriceAddedMessage> {
    ...
    public ProductPriceAddedMessageBuilder withLastModifiedBy(
    ...
    public ProductPriceAddedMessageBuilder withCreatedBy(
    ...
    public ProductPriceAddedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public ProductPriceAddedMessageBuilder withPrice(
