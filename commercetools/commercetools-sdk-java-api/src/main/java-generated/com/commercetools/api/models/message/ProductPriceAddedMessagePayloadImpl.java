...
public class ProductPriceAddedMessagePayloadImpl implements ProductPriceAddedMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    ProductPriceAddedMessagePayloadImpl(@JsonProperty("variantId") final Long variantId, @JsonProperty("price") final com.commercetools.api.models.common.Price price, @JsonProperty("staged") final Boolean staged) {
