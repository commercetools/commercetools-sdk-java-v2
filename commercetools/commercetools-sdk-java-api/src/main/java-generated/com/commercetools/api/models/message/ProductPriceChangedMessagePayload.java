 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ProductPriceChanged")
...
public interface ProductPriceChangedMessagePayload extends MessagePayload {
     ...
     */
    @Nullable
    public static ProductPriceChangedMessagePayload deepCopy(
            @Nullable final ProductPriceChangedMessagePayload template) {
        if (template == null) {
            return null;
        }
        ProductPriceChangedMessagePayloadImpl instance = new ProductPriceChangedMessagePayloadImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductPriceChangedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductPriceChangedMessagePayload>() {
            @Override
