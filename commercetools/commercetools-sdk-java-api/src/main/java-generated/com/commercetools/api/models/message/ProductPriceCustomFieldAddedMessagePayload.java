...
public interface ProductPriceCustomFieldAddedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductPriceCustomFieldAddedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductPriceCustomFieldAddedMessagePayload>() {
            @Override
