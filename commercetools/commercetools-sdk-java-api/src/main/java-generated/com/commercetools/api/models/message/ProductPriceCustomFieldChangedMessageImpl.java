...
public class ProductPriceCustomFieldChangedMessageImpl implements ProductPriceCustomFieldChangedMessage, ModelBase {
     ...
     */
    @JsonCreator
    ProductPriceCustomFieldChangedMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public ProductPriceCustomFieldChangedMessageImpl() {
        this.type = PRODUCT_PRICE_CUSTOM_FIELD_CHANGED;
    }
    ...
    public boolean equals(Object o) {
        ...
        ProductPriceCustomFieldChangedMessageImpl that = (ProductPriceCustomFieldChangedMessageImpl) o;
