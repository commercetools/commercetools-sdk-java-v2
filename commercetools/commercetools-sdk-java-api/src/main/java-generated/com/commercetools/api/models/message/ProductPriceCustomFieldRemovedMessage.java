...
public interface ProductPriceCustomFieldRemovedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductPriceCustomFieldRemovedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductPriceCustomFieldRemovedMessage>() {
            @Override
