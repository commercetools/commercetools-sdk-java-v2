...
public interface ProductPriceCustomFieldsRemovedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductPriceCustomFieldsRemovedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductPriceCustomFieldsRemovedMessage>() {
            @Override
