...
public interface ProductPriceCustomFieldsSetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductPriceCustomFieldsSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductPriceCustomFieldsSetMessage>() {
            @Override
