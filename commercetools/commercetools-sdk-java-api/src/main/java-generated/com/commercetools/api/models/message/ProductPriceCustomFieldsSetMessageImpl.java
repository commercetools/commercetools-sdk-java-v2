...
public class ProductPriceCustomFieldsSetMessageImpl implements ProductPriceCustomFieldsSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    ProductPriceCustomFieldsSetMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public ProductPriceCustomFieldsSetMessageImpl() {
        this.type = PRODUCT_PRICE_CUSTOM_FIELDS_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        ProductPriceCustomFieldsSetMessageImpl that = (ProductPriceCustomFieldsSetMessageImpl) o;
