 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ProductPriceExternalDiscountSet")
...
public interface ProductPriceExternalDiscountSetMessage extends Message {
     ...
     */
    @Nullable
    public static ProductPriceExternalDiscountSetMessage deepCopy(
            @Nullable final ProductPriceExternalDiscountSetMessage template) {
        if (template == null) {
            return null;
        }
        ProductPriceExternalDiscountSetMessageImpl instance = new ProductPriceExternalDiscountSetMessageImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductPriceExternalDiscountSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductPriceExternalDiscountSetMessage>() {
            @Override
