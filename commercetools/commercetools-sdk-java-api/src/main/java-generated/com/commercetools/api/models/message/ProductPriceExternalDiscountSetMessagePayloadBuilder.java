...
public class ProductPriceExternalDiscountSetMessagePayloadBuilder implements Builder<ProductPriceExternalDiscountSetMessagePayload> {
    ...
    public ProductPriceExternalDiscountSetMessagePayloadBuilder discounted(Function<com.commercetools.api.models.common.DiscountedPriceBuilder, com.commercetools.api.models.common.DiscountedPriceBuilder> builder) {
    ...
    public ProductPriceExternalDiscountSetMessagePayloadBuilder withDiscounted(Function<com.commercetools.api.models.common.DiscountedPriceBuilder, com.commercetools.api.models.common.DiscountedPrice> builder) {
    ...
    public ProductPriceExternalDiscountSetMessagePayload build() {
        Objects.requireNonNull(variantId, ProductPriceExternalDiscountSetMessagePayload.class + ": variantId is missing");
