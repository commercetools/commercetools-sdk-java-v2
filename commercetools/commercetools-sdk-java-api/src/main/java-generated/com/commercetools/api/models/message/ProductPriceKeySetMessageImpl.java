...
public class ProductPriceKeySetMessageImpl implements ProductPriceKeySetMessage, ModelBase {
    ...
    ProductPriceKeySetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
            ...
            @JsonProperty("variantId") final Long variantId, @JsonProperty("priceId") final String priceId,
            @JsonProperty("oldKey") final String oldKey, @JsonProperty("key") final String key,
    ...
    public boolean equals(Object o) {
        ...
        ProductPriceKeySetMessageImpl that = (ProductPriceKeySetMessageImpl) o;
    ...
    @Override
    public ProductPriceKeySetMessage copyDeep() {
        return ProductPriceKeySetMessage.deepCopy(this);
    }
}
