 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ProductPricesSet")
...
public interface ProductPricesSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductPricesSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductPricesSetMessagePayload>() {
            @Override
