...
public interface ProductRemovedFromCategoryMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductRemovedFromCategoryMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductRemovedFromCategoryMessage>() {
            @Override
