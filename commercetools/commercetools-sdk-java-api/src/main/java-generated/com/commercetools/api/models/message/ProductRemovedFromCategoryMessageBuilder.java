...
public class ProductRemovedFromCategoryMessageBuilder implements Builder<ProductRemovedFromCategoryMessage> {
    ...
    public ProductRemovedFromCategoryMessageBuilder withLastModifiedBy(
    ...
    public ProductRemovedFromCategoryMessageBuilder withCreatedBy(
    ...
    public ProductRemovedFromCategoryMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public ProductRemovedFromCategoryMessageBuilder withCategory(
