...
/**
 *  <p>Generated after a successful <a href="https://docs.commercetools.com/apis/ctp:api:type:ProductRemoveFromCategoryAction" rel="nofollow">Remove from Category</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ProductRemovedFromCategory")
...
public interface ProductRemovedFromCategoryMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductRemovedFromCategoryMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductRemovedFromCategoryMessagePayload>() {
            @Override
