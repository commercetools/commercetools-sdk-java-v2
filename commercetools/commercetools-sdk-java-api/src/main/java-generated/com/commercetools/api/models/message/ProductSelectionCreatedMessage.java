...
public interface ProductSelectionCreatedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductSelectionCreatedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductSelectionCreatedMessage>() {
            @Override
