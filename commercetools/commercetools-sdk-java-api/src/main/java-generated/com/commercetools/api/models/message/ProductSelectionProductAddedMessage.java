...
public interface ProductSelectionProductAddedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductSelectionProductAddedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductSelectionProductAddedMessage>() {
            @Override
