...
public interface ProductSelectionProductExcludedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductSelectionProductExcludedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductSelectionProductExcludedMessage>() {
            @Override
