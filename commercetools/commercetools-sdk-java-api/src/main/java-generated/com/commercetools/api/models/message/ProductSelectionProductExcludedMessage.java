...
import com.commercetools.api.models.message.ProductSelectionProductExcludedMessageImpl;
...
public interface ProductSelectionProductExcludedMessage extends Message {
     ...
     */
    @Nullable
    public static ProductSelectionProductExcludedMessage deepCopy(@Nullable final ProductSelectionProductExcludedMessage template) {
        if (template == null) {
            return null;
        }
        ProductSelectionProductExcludedMessageImpl instance = new ProductSelectionProductExcludedMessageImpl();
     ...
     * @return builder
     */
    public static ProductSelectionProductExcludedMessageBuilder builder(final ProductSelectionProductExcludedMessage template) {
     ...
     * @return mapped value
     */
    default <T> T withProductSelectionProductExcludedMessage(Function<ProductSelectionProductExcludedMessage, T> helper) {
