...
public interface ProductSelectionProductExcludedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductSelectionProductExcludedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductSelectionProductExcludedMessagePayload>() {
            @Override
