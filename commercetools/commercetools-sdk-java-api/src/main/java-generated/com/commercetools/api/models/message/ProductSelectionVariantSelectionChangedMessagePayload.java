...
public interface ProductSelectionVariantSelectionChangedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductSelectionVariantSelectionChangedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductSelectionVariantSelectionChangedMessagePayload>() {
            @Override
