...
public class ProductSelectionVariantSelectionChangedMessagePayloadBuilder implements Builder<ProductSelectionVariantSelectionChangedMessagePayload> {
    ...
    public ProductSelectionVariantSelectionChangedMessagePayloadBuilder product(Function<com.commercetools.api.models.product.ProductReferenceBuilder, com.commercetools.api.models.product.ProductReferenceBuilder> builder) {
    ...
    public ProductSelectionVariantSelectionChangedMessagePayloadBuilder withProduct(Function<com.commercetools.api.models.product.ProductReferenceBuilder, com.commercetools.api.models.product.ProductReference> builder) {
    ...
    public ProductSelectionVariantSelectionChangedMessagePayloadBuilder product( final com.commercetools.api.models.product.ProductReference product) {
    ...
    public ProductSelectionVariantSelectionChangedMessagePayloadBuilder oldVariantSelection( final com.commercetools.api.models.product_selection.ProductVariantSelection oldVariantSelection) {
    ...
    public ProductSelectionVariantSelectionChangedMessagePayloadBuilder oldVariantSelection(Function<com.commercetools.api.models.product_selection.ProductVariantSelectionBuilder, Builder<? extends com.commercetools.api.models.product_selection.ProductVariantSelection>> builder) {
    ...
    public ProductSelectionVariantSelectionChangedMessagePayloadBuilder newVariantSelection( final com.commercetools.api.models.product_selection.ProductVariantSelection newVariantSelection) {
    ...
    public ProductSelectionVariantSelectionChangedMessagePayloadBuilder newVariantSelection(Function<com.commercetools.api.models.product_selection.ProductVariantSelectionBuilder, Builder<? extends com.commercetools.api.models.product_selection.ProductVariantSelection>> builder) {
    ...
    public ProductSelectionVariantSelectionChangedMessagePayload build() {
        Objects.requireNonNull(product, ProductSelectionVariantSelectionChangedMessagePayload.class + ": product is missing");
        Objects.requireNonNull(oldVariantSelection, ProductSelectionVariantSelectionChangedMessagePayload.class + ": oldVariantSelection is missing");
        Objects.requireNonNull(newVariantSelection, ProductSelectionVariantSelectionChangedMessagePayload.class + ": newVariantSelection is missing");
        return new ProductSelectionVariantSelectionChangedMessagePayloadImpl(product, oldVariantSelection, newVariantSelection);
    }
     ...
     * @return builder
     */
    public static ProductSelectionVariantSelectionChangedMessagePayloadBuilder of(final ProductSelectionVariantSelectionChangedMessagePayload template) {
