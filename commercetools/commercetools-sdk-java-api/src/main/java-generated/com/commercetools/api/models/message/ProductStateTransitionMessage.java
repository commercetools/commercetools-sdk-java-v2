 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ProductStateTransition")
...
public interface ProductStateTransitionMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductStateTransitionMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductStateTransitionMessage>() {
            @Override
