...
public class ProductStateTransitionMessageBuilder implements Builder<ProductStateTransitionMessage> {
    ...
    public ProductStateTransitionMessageBuilder withLastModifiedBy(
    ...
    public ProductStateTransitionMessageBuilder withCreatedBy(
    ...
    public ProductStateTransitionMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public ProductStateTransitionMessageBuilder withState(
