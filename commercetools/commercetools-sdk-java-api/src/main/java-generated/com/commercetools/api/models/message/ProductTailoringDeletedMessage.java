...
public interface ProductTailoringDeletedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTailoringDeletedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTailoringDeletedMessage>() {
            @Override
