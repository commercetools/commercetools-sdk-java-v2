...
public class ProductTailoringDeletedMessageImpl implements ProductTailoringDeletedMessage, ModelBase {
     ...
     */
    @JsonCreator
    ProductTailoringDeletedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public ProductTailoringDeletedMessageImpl() {
        this.type = PRODUCT_TAILORING_DELETED;
    }
    ...
    public boolean equals(Object o) {
        ...
        ProductTailoringDeletedMessageImpl that = (ProductTailoringDeletedMessageImpl) o;
