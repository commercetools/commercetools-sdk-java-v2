...
public class ProductTailoringKeySetMessageImpl implements ProductTailoringKeySetMessage, ModelBase {
     ...
     */
    @JsonCreator
    ProductTailoringKeySetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public ProductTailoringKeySetMessageImpl() {
        this.type = PRODUCT_TAILORING_KEY_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        ProductTailoringKeySetMessageImpl that = (ProductTailoringKeySetMessageImpl) o;
    ...
    public ProductTailoringKeySetMessage copyDeep() {
        return ProductTailoringKeySetMessage.deepCopy(this);
    }
}
