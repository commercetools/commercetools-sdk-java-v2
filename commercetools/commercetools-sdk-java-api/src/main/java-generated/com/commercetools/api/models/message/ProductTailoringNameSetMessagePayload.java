...
public interface ProductTailoringNameSetMessagePayload extends MessagePayload {
    ...
    public ProductTailoringNameSetMessagePayload copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTailoringNameSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTailoringNameSetMessagePayload>() {
            @Override
