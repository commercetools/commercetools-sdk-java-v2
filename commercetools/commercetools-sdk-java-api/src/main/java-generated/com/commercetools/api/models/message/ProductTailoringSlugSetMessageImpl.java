...
public class ProductTailoringSlugSetMessageImpl implements ProductTailoringSlugSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    ProductTailoringSlugSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public ProductTailoringSlugSetMessageImpl() {
        this.type = PRODUCT_TAILORING_SLUG_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        ProductTailoringSlugSetMessageImpl that = (ProductTailoringSlugSetMessageImpl) o;
