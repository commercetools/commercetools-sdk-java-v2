...
public interface ProductUnpublishedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductUnpublishedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductUnpublishedMessage>() {
            @Override
