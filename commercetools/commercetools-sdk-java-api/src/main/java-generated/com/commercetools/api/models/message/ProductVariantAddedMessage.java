 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ProductVariantAdded")
...
public interface ProductVariantAddedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductVariantAddedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductVariantAddedMessage>() {
            @Override
