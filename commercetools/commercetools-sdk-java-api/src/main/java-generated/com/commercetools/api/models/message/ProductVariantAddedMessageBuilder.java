...
public class ProductVariantAddedMessageBuilder implements Builder<ProductVariantAddedMessage> {
    ...
    public ProductVariantAddedMessageBuilder withLastModifiedBy(
    ...
    public ProductVariantAddedMessageBuilder withCreatedBy(
    ...
    public ProductVariantAddedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public ProductVariantAddedMessageBuilder withVariant(
