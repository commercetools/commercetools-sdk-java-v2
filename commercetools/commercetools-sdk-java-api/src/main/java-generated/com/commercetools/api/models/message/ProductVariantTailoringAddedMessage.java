...
public interface ProductVariantTailoringAddedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductVariantTailoringAddedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductVariantTailoringAddedMessage>() {
            @Override
