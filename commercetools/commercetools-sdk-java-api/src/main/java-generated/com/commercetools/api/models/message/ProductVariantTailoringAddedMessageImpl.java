...
public class ProductVariantTailoringAddedMessageImpl implements ProductVariantTailoringAddedMessage, ModelBase {
     ...
     */
    @JsonCreator
    ProductVariantTailoringAddedMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public ProductVariantTailoringAddedMessageImpl() {
        this.type = PRODUCT_VARIANT_TAILORING_ADDED;
    }
    ...
    public boolean equals(Object o) {
        ...
        ProductVariantTailoringAddedMessageImpl that = (ProductVariantTailoringAddedMessageImpl) o;
