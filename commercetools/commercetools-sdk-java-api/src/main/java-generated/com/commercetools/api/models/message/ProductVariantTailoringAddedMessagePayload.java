...
public interface ProductVariantTailoringAddedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductVariantTailoringAddedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductVariantTailoringAddedMessagePayload>() {
            @Override
