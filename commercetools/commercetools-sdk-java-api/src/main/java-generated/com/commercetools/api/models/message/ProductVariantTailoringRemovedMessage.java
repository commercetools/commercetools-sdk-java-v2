...
public interface ProductVariantTailoringRemovedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductVariantTailoringRemovedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductVariantTailoringRemovedMessage>() {
            @Override
