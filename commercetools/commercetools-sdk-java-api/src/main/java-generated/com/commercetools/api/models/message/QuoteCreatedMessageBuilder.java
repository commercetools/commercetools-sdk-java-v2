...
public class QuoteCreatedMessageBuilder implements Builder<QuoteCreatedMessage> {
    ...
    public QuoteCreatedMessageBuilder withLastModifiedBy(
    ...
    public QuoteCreatedMessageBuilder withCreatedBy(
    ...
    public QuoteCreatedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public QuoteCreatedMessageBuilder withQuote(
