...
public interface QuoteCustomerChangedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<QuoteCustomerChangedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<QuoteCustomerChangedMessage>() {
            @Override
