...
import com.commercetools.api.models.message.QuoteCustomerChangedMessagePayloadImpl;
...
public interface QuoteCustomerChangedMessagePayload extends MessagePayload {
     ...
     */
    @Nullable
    public static QuoteCustomerChangedMessagePayload deepCopy(@Nullable final QuoteCustomerChangedMessagePayload template) {
        if (template == null) {
            return null;
        }
        QuoteCustomerChangedMessagePayloadImpl instance = new QuoteCustomerChangedMessagePayloadImpl();
