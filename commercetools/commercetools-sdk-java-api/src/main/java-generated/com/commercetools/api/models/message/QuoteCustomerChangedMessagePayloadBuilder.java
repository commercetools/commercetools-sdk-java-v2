...
public class QuoteCustomerChangedMessagePayloadBuilder implements Builder<QuoteCustomerChangedMessagePayload> {
    ...
    public QuoteCustomerChangedMessagePayloadBuilder customer(
    ...
    public QuoteCustomerChangedMessagePayloadBuilder withCustomer(
    ...
    public QuoteCustomerChangedMessagePayloadBuilder previousCustomer(
            Function<com.commercetools.api.models.customer.CustomerReferenceBuilder, com.commercetools.api.models.customer.CustomerReferenceBuilder> builder) {
    ...
    public QuoteCustomerChangedMessagePayloadBuilder withPreviousCustomer(
            Function<com.commercetools.api.models.customer.CustomerReferenceBuilder, com.commercetools.api.models.customer.CustomerReference> builder) {
        this.previousCustomer = builder.apply(com.commercetools.api.models.customer.CustomerReferenceBuilder.of());
        return this;
    }
    ...
    public QuoteCustomerChangedMessagePayload build() {
        ...
        Objects.requireNonNull(previousCustomer,
            QuoteCustomerChangedMessagePayload.class + ": previousCustomer is missing");
