...
public class QuoteCustomerChangedMessagePayloadImpl implements QuoteCustomerChangedMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    QuoteCustomerChangedMessagePayloadImpl(@JsonProperty("customer") final com.commercetools.api.models.customer.CustomerReference customer, @JsonProperty("previousCustomer") final com.commercetools.api.models.customer.CustomerReference previousCustomer) {
