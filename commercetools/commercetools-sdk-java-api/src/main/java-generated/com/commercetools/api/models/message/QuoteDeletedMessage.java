...
public interface QuoteDeletedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<QuoteDeletedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<QuoteDeletedMessage>() {
            @Override
