...
/**
 *  <p>Generated after a successful <span>Delete Quote</span> request.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("QuoteDeleted")
...
public interface QuoteDeletedMessagePayload extends MessagePayload {
    ...
    public QuoteDeletedMessagePayload copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<QuoteDeletedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<QuoteDeletedMessagePayload>() {
            @Override
