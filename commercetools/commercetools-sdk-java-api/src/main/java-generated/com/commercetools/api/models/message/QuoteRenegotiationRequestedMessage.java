...
public interface QuoteRenegotiationRequestedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<QuoteRenegotiationRequestedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<QuoteRenegotiationRequestedMessage>() {
            @Override
