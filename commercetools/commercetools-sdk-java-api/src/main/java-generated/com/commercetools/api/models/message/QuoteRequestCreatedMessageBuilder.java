...
public class QuoteRequestCreatedMessageBuilder implements Builder<QuoteRequestCreatedMessage> {
    ...
    public QuoteRequestCreatedMessageBuilder withLastModifiedBy(
    ...
    public QuoteRequestCreatedMessageBuilder createdBy(
    ...
    public QuoteRequestCreatedMessageBuilder withCreatedBy(
    ...
    public QuoteRequestCreatedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public QuoteRequestCreatedMessageBuilder withQuoteRequest(
