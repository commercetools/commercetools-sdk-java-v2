 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("QuoteRequestCreated")
...
public interface QuoteRequestCreatedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<QuoteRequestCreatedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<QuoteRequestCreatedMessagePayload>() {
            @Override
