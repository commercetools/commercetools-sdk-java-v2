...
import com.commercetools.api.models.message.QuoteRequestCustomerChangedMessageImpl;
...
public interface QuoteRequestCustomerChangedMessage extends Message {
     ...
     */
    @Nullable
    public static QuoteRequestCustomerChangedMessage deepCopy(@Nullable final QuoteRequestCustomerChangedMessage template) {
        if (template == null) {
            return null;
        }
        QuoteRequestCustomerChangedMessageImpl instance = new QuoteRequestCustomerChangedMessageImpl();
