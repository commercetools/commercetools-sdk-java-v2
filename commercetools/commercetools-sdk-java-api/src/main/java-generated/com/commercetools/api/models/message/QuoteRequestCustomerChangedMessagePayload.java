...
public interface QuoteRequestCustomerChangedMessagePayload extends MessagePayload {
     ...
     */
    @Nullable
    public static QuoteRequestCustomerChangedMessagePayload deepCopy(
            @Nullable final QuoteRequestCustomerChangedMessagePayload template) {
        if (template == null) {
            return null;
        }
        QuoteRequestCustomerChangedMessagePayloadImpl instance = new QuoteRequestCustomerChangedMessagePayloadImpl();
     ...
     * @return mapped value
     */
    default <T> T withQuoteRequestCustomerChangedMessagePayload(
            Function<QuoteRequestCustomerChangedMessagePayload, T> helper) {
