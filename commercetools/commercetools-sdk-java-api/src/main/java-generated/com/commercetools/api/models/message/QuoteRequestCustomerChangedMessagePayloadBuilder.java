...
public class QuoteRequestCustomerChangedMessagePayloadBuilder implements Builder<QuoteRequestCustomerChangedMessagePayload> {
    ...
    public QuoteRequestCustomerChangedMessagePayloadBuilder customer(Function<com.commercetools.api.models.customer.CustomerReferenceBuilder, com.commercetools.api.models.customer.CustomerReferenceBuilder> builder) {
    ...
    public QuoteRequestCustomerChangedMessagePayloadBuilder withCustomer(Function<com.commercetools.api.models.customer.CustomerReferenceBuilder, com.commercetools.api.models.customer.CustomerReference> builder) {
    ...
    public QuoteRequestCustomerChangedMessagePayloadBuilder customer( final com.commercetools.api.models.customer.CustomerReference customer) {
    ...
    public QuoteRequestCustomerChangedMessagePayloadBuilder previousCustomer(Function<com.commercetools.api.models.customer.CustomerReferenceBuilder, com.commercetools.api.models.customer.CustomerReferenceBuilder> builder) {
    ...
    public QuoteRequestCustomerChangedMessagePayloadBuilder withPreviousCustomer(Function<com.commercetools.api.models.customer.CustomerReferenceBuilder, com.commercetools.api.models.customer.CustomerReference> builder) {
    ...
    public QuoteRequestCustomerChangedMessagePayloadBuilder previousCustomer( final com.commercetools.api.models.customer.CustomerReference previousCustomer) {
    ...
    public QuoteRequestCustomerChangedMessagePayload build() {
        ...
        Objects.requireNonNull(previousCustomer, QuoteRequestCustomerChangedMessagePayload.class + ": previousCustomer is missing");
     ...
     * @return builder
     */
    public static QuoteRequestCustomerChangedMessagePayloadBuilder of(final QuoteRequestCustomerChangedMessagePayload template) {
