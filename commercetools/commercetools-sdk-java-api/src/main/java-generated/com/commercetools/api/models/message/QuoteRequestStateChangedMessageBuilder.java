...
public class QuoteRequestStateChangedMessageBuilder implements Builder<QuoteRequestStateChangedMessage> {
    ...
    public QuoteRequestStateChangedMessageBuilder lastModifiedBy(Function<com.commercetools.api.models.common.LastModifiedByBuilder, com.commercetools.api.models.common.LastModifiedByBuilder> builder) {
    ...
    public QuoteRequestStateChangedMessageBuilder withLastModifiedBy(Function<com.commercetools.api.models.common.LastModifiedByBuilder, com.commercetools.api.models.common.LastModifiedBy> builder) {
    ...
    public QuoteRequestStateChangedMessageBuilder lastModifiedBy(@Nullable final com.commercetools.api.models.common.LastModifiedBy lastModifiedBy) {
    ...
    public QuoteRequestStateChangedMessageBuilder createdBy(Function<com.commercetools.api.models.common.CreatedByBuilder, com.commercetools.api.models.common.CreatedByBuilder> builder) {
    ...
    public QuoteRequestStateChangedMessageBuilder withCreatedBy(Function<com.commercetools.api.models.common.CreatedByBuilder, com.commercetools.api.models.common.CreatedBy> builder) {
    ...
    public QuoteRequestStateChangedMessageBuilder createdBy(@Nullable final com.commercetools.api.models.common.CreatedBy createdBy) {
    ...
    public QuoteRequestStateChangedMessageBuilder resource( final com.commercetools.api.models.common.Reference resource) {
    ...
    public QuoteRequestStateChangedMessageBuilder resource(Function<com.commercetools.api.models.common.ReferenceBuilder, Builder<? extends com.commercetools.api.models.common.Reference>> builder) {
    ...
    public QuoteRequestStateChangedMessageBuilder resourceUserProvidedIdentifiers(Function<com.commercetools.api.models.message.UserProvidedIdentifiersBuilder, com.commercetools.api.models.message.UserProvidedIdentifiersBuilder> builder) {
    ...
    public QuoteRequestStateChangedMessageBuilder withResourceUserProvidedIdentifiers(Function<com.commercetools.api.models.message.UserProvidedIdentifiersBuilder, com.commercetools.api.models.message.UserProvidedIdentifiers> builder) {
    ...
    public QuoteRequestStateChangedMessageBuilder resourceUserProvidedIdentifiers(@Nullable final com.commercetools.api.models.message.UserProvidedIdentifiers resourceUserProvidedIdentifiers) {
    ...
    public QuoteRequestStateChangedMessageBuilder quoteRequestState( final com.commercetools.api.models.quote_request.QuoteRequestState quoteRequestState) {
    ...
    public QuoteRequestStateChangedMessageBuilder oldQuoteRequestState( final com.commercetools.api.models.quote_request.QuoteRequestState oldQuoteRequestState) {
    ...
    /**
     * builds QuoteRequestStateChangedMessage with checking for non-null required values
     * @return QuoteRequestStateChangedMessage
     */
    public QuoteRequestStateChangedMessage build() {
        ...
        Objects.requireNonNull(quoteRequestState, QuoteRequestStateChangedMessage.class + ": quoteRequestState is missing");
        Objects.requireNonNull(oldQuoteRequestState, QuoteRequestStateChangedMessage.class + ": oldQuoteRequestState is missing");
        return new QuoteRequestStateChangedMessageImpl(id, version, createdAt, lastModifiedAt, lastModifiedBy, createdBy, sequenceNumber, resource, resourceVersion, resourceUserProvidedIdentifiers, quoteRequestState, oldQuoteRequestState);
    }
    ...
    /**
     * factory method for an instance of QuoteRequestStateChangedMessageBuilder
     * @return builder 
     */
