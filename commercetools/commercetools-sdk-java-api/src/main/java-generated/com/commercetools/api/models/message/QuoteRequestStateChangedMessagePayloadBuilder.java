...
public class QuoteRequestStateChangedMessagePayloadBuilder implements Builder<QuoteRequestStateChangedMessagePayload> {
    ...
    public QuoteRequestStateChangedMessagePayloadBuilder quoteRequestState( final com.commercetools.api.models.quote_request.QuoteRequestState quoteRequestState) {
    ...
    public QuoteRequestStateChangedMessagePayloadBuilder oldQuoteRequestState( final com.commercetools.api.models.quote_request.QuoteRequestState oldQuoteRequestState) {
    ...
    public QuoteRequestStateChangedMessagePayload build() {
        Objects.requireNonNull(quoteRequestState, QuoteRequestStateChangedMessagePayload.class + ": quoteRequestState is missing");
        Objects.requireNonNull(oldQuoteRequestState, QuoteRequestStateChangedMessagePayload.class + ": oldQuoteRequestState is missing");
     ...
     * @return builder
     */
    public static QuoteRequestStateChangedMessagePayloadBuilder of(final QuoteRequestStateChangedMessagePayload template) {
