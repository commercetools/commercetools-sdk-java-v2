...
public class QuoteRequestStateTransitionMessagePayloadBuilder implements Builder<QuoteRequestStateTransitionMessagePayload> {
    ...
    public QuoteRequestStateTransitionMessagePayloadBuilder state(Function<com.commercetools.api.models.state.StateReferenceBuilder, com.commercetools.api.models.state.StateReferenceBuilder> builder) {
    ...
    public QuoteRequestStateTransitionMessagePayloadBuilder withState(Function<com.commercetools.api.models.state.StateReferenceBuilder, com.commercetools.api.models.state.StateReference> builder) {
    ...
    public QuoteRequestStateTransitionMessagePayloadBuilder state( final com.commercetools.api.models.state.StateReference state) {
        this.state = state;
        return this;
    }
    ...
    public QuoteRequestStateTransitionMessagePayloadBuilder oldState(Function<com.commercetools.api.models.state.StateReferenceBuilder, com.commercetools.api.models.state.StateReferenceBuilder> builder) {
    ...
    public QuoteRequestStateTransitionMessagePayloadBuilder withOldState(Function<com.commercetools.api.models.state.StateReferenceBuilder, com.commercetools.api.models.state.StateReference> builder) {
    ...
    public QuoteRequestStateTransitionMessagePayloadBuilder oldState(@Nullable final com.commercetools.api.models.state.StateReference oldState) {
     ...
     * @return builder
     */
    public static QuoteRequestStateTransitionMessagePayloadBuilder of(final QuoteRequestStateTransitionMessagePayload template) {
