...
public class QuoteRequestStateTransitionMessagePayloadImpl implements QuoteRequestStateTransitionMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    QuoteRequestStateTransitionMessagePayloadImpl(@JsonProperty("state") final com.commercetools.api.models.state.StateReference state, @JsonProperty("oldState") final com.commercetools.api.models.state.StateReference oldState, @JsonProperty("force") final Boolean force) {
        this.state = state;
