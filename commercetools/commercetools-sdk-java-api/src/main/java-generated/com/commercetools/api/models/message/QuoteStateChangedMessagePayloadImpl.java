...
public class QuoteStateChangedMessagePayloadImpl implements QuoteStateChangedMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    QuoteStateChangedMessagePayloadImpl(@JsonProperty("quoteState") final com.commercetools.api.models.quote.QuoteState quoteState, @JsonProperty("oldQuoteState") final com.commercetools.api.models.quote.QuoteState oldQuoteState) {
