...
public class QuoteStateTransitionMessagePayloadImpl implements QuoteStateTransitionMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    QuoteStateTransitionMessagePayloadImpl(@JsonProperty("state") final com.commercetools.api.models.state.StateReference state, @JsonProperty("oldState") final com.commercetools.api.models.state.StateReference oldState, @JsonProperty("force") final Boolean force) {
        this.state = state;
     ...
     */
    public QuoteStateTransitionMessagePayloadImpl() {
        this.type =  QUOTE_STATE_TRANSITION;
    }
    ...
    public boolean equals(Object o) {
        ...
        QuoteStateTransitionMessagePayloadImpl that = (QuoteStateTransitionMessagePayloadImpl) o;
