...
public class RecurringOrderCreatedMessageImpl implements RecurringOrderCreatedMessage, ModelBase {
     ...
     */
    @JsonCreator
    RecurringOrderCreatedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public RecurringOrderCreatedMessageImpl() {
        this.type = RECURRING_ORDER_CREATED;
    }
    ...
    public boolean equals(Object o) {
        ...
        RecurringOrderCreatedMessageImpl that = (RecurringOrderCreatedMessageImpl) o;
    ...
    public RecurringOrderCreatedMessage copyDeep() {
        return RecurringOrderCreatedMessage.deepCopy(this);
    }
}
