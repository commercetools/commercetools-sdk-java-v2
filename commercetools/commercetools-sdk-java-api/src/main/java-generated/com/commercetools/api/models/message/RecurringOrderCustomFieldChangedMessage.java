...
public interface RecurringOrderCustomFieldChangedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrderCustomFieldChangedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrderCustomFieldChangedMessage>() {
            @Override
