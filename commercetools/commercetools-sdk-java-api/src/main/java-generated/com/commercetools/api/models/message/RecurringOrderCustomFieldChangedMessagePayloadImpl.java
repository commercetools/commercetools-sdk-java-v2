...
public class RecurringOrderCustomFieldChangedMessagePayloadImpl
        implements RecurringOrderCustomFieldChangedMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    RecurringOrderCustomFieldChangedMessagePayloadImpl(@JsonProperty("name") final String name,
     ...
     */
    public RecurringOrderCustomFieldChangedMessagePayloadImpl() {
        this.type = RECURRING_ORDER_CUSTOM_FIELD_CHANGED;
    }
    ...
    public boolean equals(Object o) {
        ...
        RecurringOrderCustomFieldChangedMessagePayloadImpl that = (RecurringOrderCustomFieldChangedMessagePayloadImpl) o;
    ...
    public RecurringOrderCustomFieldChangedMessagePayload copyDeep() {
        return RecurringOrderCustomFieldChangedMessagePayload.deepCopy(this);
    }
}
