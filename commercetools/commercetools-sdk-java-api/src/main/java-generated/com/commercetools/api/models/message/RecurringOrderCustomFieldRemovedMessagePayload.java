...
public interface RecurringOrderCustomFieldRemovedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrderCustomFieldRemovedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrderCustomFieldRemovedMessagePayload>() {
            @Override
