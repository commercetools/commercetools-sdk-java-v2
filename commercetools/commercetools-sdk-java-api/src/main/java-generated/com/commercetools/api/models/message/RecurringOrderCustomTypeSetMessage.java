...
public interface RecurringOrderCustomTypeSetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrderCustomTypeSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrderCustomTypeSetMessage>() {
            @Override
