...
public class RecurringOrderCustomTypeSetMessageImpl implements RecurringOrderCustomTypeSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    RecurringOrderCustomTypeSetMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public RecurringOrderCustomTypeSetMessageImpl() {
        this.type = RECURRING_ORDER_CUSTOM_TYPE_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        RecurringOrderCustomTypeSetMessageImpl that = (RecurringOrderCustomTypeSetMessageImpl) o;
    ...
    public RecurringOrderCustomTypeSetMessage copyDeep() {
        return RecurringOrderCustomTypeSetMessage.deepCopy(this);
    }
}
