...
public class RecurringOrderDeletedMessageImpl implements RecurringOrderDeletedMessage, ModelBase {
     ...
     */
    @JsonCreator
    RecurringOrderDeletedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public RecurringOrderDeletedMessageImpl() {
        this.type = RECURRING_ORDER_DELETED;
    }
    ...
    public boolean equals(Object o) {
        ...
        RecurringOrderDeletedMessageImpl that = (RecurringOrderDeletedMessageImpl) o;
    ...
    public RecurringOrderDeletedMessage copyDeep() {
        return RecurringOrderDeletedMessage.deepCopy(this);
    }
}
