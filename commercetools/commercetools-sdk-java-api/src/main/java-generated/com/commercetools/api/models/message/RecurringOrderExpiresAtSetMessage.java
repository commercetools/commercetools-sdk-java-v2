...
public interface RecurringOrderExpiresAtSetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrderExpiresAtSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrderExpiresAtSetMessage>() {
            @Override
