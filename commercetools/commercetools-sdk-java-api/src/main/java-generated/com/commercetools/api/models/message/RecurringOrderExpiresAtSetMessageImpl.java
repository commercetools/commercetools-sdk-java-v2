...
public class RecurringOrderExpiresAtSetMessageImpl implements RecurringOrderExpiresAtSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    RecurringOrderExpiresAtSetMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public RecurringOrderExpiresAtSetMessageImpl() {
        this.type = RECURRING_ORDER_EXPIRES_AT_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        RecurringOrderExpiresAtSetMessageImpl that = (RecurringOrderExpiresAtSetMessageImpl) o;
    ...
    public RecurringOrderExpiresAtSetMessage copyDeep() {
        return RecurringOrderExpiresAtSetMessage.deepCopy(this);
    }
}
