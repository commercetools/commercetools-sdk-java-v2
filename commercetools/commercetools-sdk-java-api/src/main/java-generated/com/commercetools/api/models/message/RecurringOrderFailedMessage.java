...
public interface RecurringOrderFailedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrderFailedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrderFailedMessage>() {
            @Override
