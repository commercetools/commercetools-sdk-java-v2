...
@JsonDeserialize(as = RecurringOrderFailedMessageImpl.class)
public interface RecurringOrderFailedMessage extends Message {
    ...
    /**
     * factory method
     * @return instance of RecurringOrderFailedMessage
     */
    public static RecurringOrderFailedMessage of() {
        return new RecurringOrderFailedMessageImpl();
    }
     ...
     */
    public static RecurringOrderFailedMessage of(final RecurringOrderFailedMessage template) {
        RecurringOrderFailedMessageImpl instance = new RecurringOrderFailedMessageImpl();
     ...
     */
    @Nullable
    public static RecurringOrderFailedMessage deepCopy(@Nullable final RecurringOrderFailedMessage template) {
        if (template == null) {
            return null;
        }
        RecurringOrderFailedMessageImpl instance = new RecurringOrderFailedMessageImpl();
     ...
     * @return builder
     */
    public static RecurringOrderFailedMessageBuilder builder() {
        return RecurringOrderFailedMessageBuilder.of();
    }
     ...
     * @return builder
     */
    public static RecurringOrderFailedMessageBuilder builder(final RecurringOrderFailedMessage template) {
        return RecurringOrderFailedMessageBuilder.of(template);
    }
     ...
     */
    public static com.fasterxml.jackson.core.type.TypeReference<RecurringOrderFailedMessage> typeReference() {
        return new com.fasterxml.jackson.core.type.TypeReference<RecurringOrderFailedMessage>() {
            @Override
            public String toString() {
                return "TypeReference<RecurringOrderFailedMessage>";
            }
        };
    }
}
