...
public interface RecurringOrderKeySetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrderKeySetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrderKeySetMessage>() {
            @Override
