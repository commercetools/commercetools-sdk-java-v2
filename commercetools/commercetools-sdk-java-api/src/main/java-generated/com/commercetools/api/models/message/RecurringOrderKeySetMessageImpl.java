...
public class RecurringOrderKeySetMessageImpl implements RecurringOrderKeySetMessage, ModelBase {
     ...
     */
    @JsonCreator
    RecurringOrderKeySetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public RecurringOrderKeySetMessageImpl() {
        this.type = RECURRING_ORDER_KEY_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        RecurringOrderKeySetMessageImpl that = (RecurringOrderKeySetMessageImpl) o;
    ...
    public RecurringOrderKeySetMessage copyDeep() {
        return RecurringOrderKeySetMessage.deepCopy(this);
    }
}
