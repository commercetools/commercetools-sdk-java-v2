...
public class RecurringOrderKeySetMessagePayloadImpl implements RecurringOrderKeySetMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    RecurringOrderKeySetMessagePayloadImpl(@JsonProperty("key") final String key,
            @JsonProperty("oldKey") final String oldKey) {
        this.key = key;
        this.oldKey = oldKey;
        this.type = RECURRING_ORDER_KEY_SET;
    }

    /**
     * create empty instance
     */
    public RecurringOrderKeySetMessagePayloadImpl() {
        this.type = RECURRING_ORDER_KEY_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        RecurringOrderKeySetMessagePayloadImpl that = (RecurringOrderKeySetMessagePayloadImpl) o;
    ...
    public RecurringOrderKeySetMessagePayload copyDeep() {
        return RecurringOrderKeySetMessagePayload.deepCopy(this);
    }
}
