...
public class RecurringOrderScheduleSetMessageImpl implements RecurringOrderScheduleSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    RecurringOrderScheduleSetMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public RecurringOrderScheduleSetMessageImpl() {
        this.type = RECURRING_ORDER_SCHEDULE_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        RecurringOrderScheduleSetMessageImpl that = (RecurringOrderScheduleSetMessageImpl) o;
    ...
    public RecurringOrderScheduleSetMessage copyDeep() {
        return RecurringOrderScheduleSetMessage.deepCopy(this);
    }
}
