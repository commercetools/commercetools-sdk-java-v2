...
public interface RecurringOrderStateTransitionMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrderStateTransitionMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrderStateTransitionMessage>() {
            @Override
