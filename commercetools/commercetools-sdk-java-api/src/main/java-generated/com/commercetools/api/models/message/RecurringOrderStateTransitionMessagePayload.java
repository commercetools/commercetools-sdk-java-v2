...
public interface RecurringOrderStateTransitionMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrderStateTransitionMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrderStateTransitionMessagePayload>() {
            @Override
