...
public class ReturnInfoSetMessageBuilder implements Builder<ReturnInfoSetMessage> {
    ...
    public ReturnInfoSetMessageBuilder withLastModifiedBy(
    ...
    public ReturnInfoSetMessageBuilder withCreatedBy(
    ...
    public ReturnInfoSetMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public ReturnInfoSetMessageBuilder addReturnInfo(
    ...
    public ReturnInfoSetMessageBuilder setReturnInfo(
            Function<com.commercetools.api.models.order.ReturnInfoBuilder, com.commercetools.api.models.order.ReturnInfo> builder) {
