...
public class ReviewCreatedMessageBuilder implements Builder<ReviewCreatedMessage> {
    ...
    public ReviewCreatedMessageBuilder withLastModifiedBy(
    ...
    public ReviewCreatedMessageBuilder withCreatedBy(
    ...
    public ReviewCreatedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public ReviewCreatedMessageBuilder withReview(
