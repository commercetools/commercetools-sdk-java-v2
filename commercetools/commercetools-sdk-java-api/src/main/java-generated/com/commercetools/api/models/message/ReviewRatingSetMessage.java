...
public interface ReviewRatingSetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ReviewRatingSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ReviewRatingSetMessage>() {
            @Override
