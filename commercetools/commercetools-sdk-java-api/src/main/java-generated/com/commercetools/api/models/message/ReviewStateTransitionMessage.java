...
public interface ReviewStateTransitionMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ReviewStateTransitionMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ReviewStateTransitionMessage>() {
            @Override
