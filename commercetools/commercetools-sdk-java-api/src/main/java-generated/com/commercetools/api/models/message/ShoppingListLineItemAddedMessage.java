...
public interface ShoppingListLineItemAddedMessage extends ShoppingListMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShoppingListLineItemAddedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShoppingListLineItemAddedMessage>() {
            @Override
