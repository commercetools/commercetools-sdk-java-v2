...
public interface ShoppingListLineItemAddedMessagePayload extends ShoppingListMessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShoppingListLineItemAddedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShoppingListLineItemAddedMessagePayload>() {
            @Override
