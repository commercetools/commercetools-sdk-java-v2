...
public class ShoppingListLineItemRemovedMessageImpl implements ShoppingListLineItemRemovedMessage, ModelBase {
     ...
     */
    @JsonCreator
    ShoppingListLineItemRemovedMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public ShoppingListLineItemRemovedMessageImpl() {
        this.type = SHOPPING_LIST_LINE_ITEM_REMOVED;
    }
    ...
    public boolean equals(Object o) {
        ...
        ShoppingListLineItemRemovedMessageImpl that = (ShoppingListLineItemRemovedMessageImpl) o;
