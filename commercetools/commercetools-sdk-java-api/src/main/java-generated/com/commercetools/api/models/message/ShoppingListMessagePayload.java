...
public interface ShoppingListMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShoppingListMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShoppingListMessagePayload>() {
            @Override
