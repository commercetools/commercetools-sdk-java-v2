...
public interface StagedQuoteCreatedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedQuoteCreatedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedQuoteCreatedMessage>() {
            @Override
