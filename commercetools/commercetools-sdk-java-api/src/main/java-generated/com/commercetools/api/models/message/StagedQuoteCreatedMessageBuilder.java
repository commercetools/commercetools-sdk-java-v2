...
public class StagedQuoteCreatedMessageBuilder implements Builder<StagedQuoteCreatedMessage> {
    ...
    public StagedQuoteCreatedMessageBuilder withLastModifiedBy(
    ...
    public StagedQuoteCreatedMessageBuilder createdBy(
    ...
    public StagedQuoteCreatedMessageBuilder withCreatedBy(
    ...
    public StagedQuoteCreatedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public StagedQuoteCreatedMessageBuilder withStagedQuote(
