...
public interface StagedQuoteDeletedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedQuoteDeletedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedQuoteDeletedMessage>() {
            @Override
