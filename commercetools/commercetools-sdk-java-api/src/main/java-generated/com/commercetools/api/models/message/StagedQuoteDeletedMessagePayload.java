...
public interface StagedQuoteDeletedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedQuoteDeletedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedQuoteDeletedMessagePayload>() {
            @Override
