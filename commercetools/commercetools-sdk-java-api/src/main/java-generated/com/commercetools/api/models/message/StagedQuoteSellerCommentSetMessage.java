...
public interface StagedQuoteSellerCommentSetMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedQuoteSellerCommentSetMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedQuoteSellerCommentSetMessage>() {
            @Override
