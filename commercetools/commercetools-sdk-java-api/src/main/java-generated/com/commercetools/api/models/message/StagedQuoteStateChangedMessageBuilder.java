...
public class StagedQuoteStateChangedMessageBuilder implements Builder<StagedQuoteStateChangedMessage> {
    ...
    public StagedQuoteStateChangedMessageBuilder lastModifiedBy(Function<com.commercetools.api.models.common.LastModifiedByBuilder, com.commercetools.api.models.common.LastModifiedByBuilder> builder) {
    ...
    public StagedQuoteStateChangedMessageBuilder withLastModifiedBy(Function<com.commercetools.api.models.common.LastModifiedByBuilder, com.commercetools.api.models.common.LastModifiedBy> builder) {
    ...
    public StagedQuoteStateChangedMessageBuilder lastModifiedBy(@Nullable final com.commercetools.api.models.common.LastModifiedBy lastModifiedBy) {
    ...
    public StagedQuoteStateChangedMessageBuilder createdBy(Function<com.commercetools.api.models.common.CreatedByBuilder, com.commercetools.api.models.common.CreatedByBuilder> builder) {
    ...
    public StagedQuoteStateChangedMessageBuilder withCreatedBy(Function<com.commercetools.api.models.common.CreatedByBuilder, com.commercetools.api.models.common.CreatedBy> builder) {
    ...
    public StagedQuoteStateChangedMessageBuilder createdBy(@Nullable final com.commercetools.api.models.common.CreatedBy createdBy) {
    ...
    public StagedQuoteStateChangedMessageBuilder resource( final com.commercetools.api.models.common.Reference resource) {
    ...
    public StagedQuoteStateChangedMessageBuilder resource(Function<com.commercetools.api.models.common.ReferenceBuilder, Builder<? extends com.commercetools.api.models.common.Reference>> builder) {
    ...
    public StagedQuoteStateChangedMessageBuilder resourceUserProvidedIdentifiers(Function<com.commercetools.api.models.message.UserProvidedIdentifiersBuilder, com.commercetools.api.models.message.UserProvidedIdentifiersBuilder> builder) {
    ...
    public StagedQuoteStateChangedMessageBuilder withResourceUserProvidedIdentifiers(Function<com.commercetools.api.models.message.UserProvidedIdentifiersBuilder, com.commercetools.api.models.message.UserProvidedIdentifiers> builder) {
    ...
    public StagedQuoteStateChangedMessageBuilder resourceUserProvidedIdentifiers(@Nullable final com.commercetools.api.models.message.UserProvidedIdentifiers resourceUserProvidedIdentifiers) {
    ...
    public StagedQuoteStateChangedMessageBuilder stagedQuoteState( final com.commercetools.api.models.staged_quote.StagedQuoteState stagedQuoteState) {
    ...
    public StagedQuoteStateChangedMessageBuilder oldStagedQuoteState( final com.commercetools.api.models.staged_quote.StagedQuoteState oldStagedQuoteState) {
    ...
    /**
     * builds StagedQuoteStateChangedMessage with checking for non-null required values
     * @return StagedQuoteStateChangedMessage
     */
    public StagedQuoteStateChangedMessage build() {
        ...
        Objects.requireNonNull(stagedQuoteState, StagedQuoteStateChangedMessage.class + ": stagedQuoteState is missing");
        Objects.requireNonNull(oldStagedQuoteState, StagedQuoteStateChangedMessage.class + ": oldStagedQuoteState is missing");
        return new StagedQuoteStateChangedMessageImpl(id, version, createdAt, lastModifiedAt, lastModifiedBy, createdBy, sequenceNumber, resource, resourceVersion, resourceUserProvidedIdentifiers, stagedQuoteState, oldStagedQuoteState);
    }
    ...
    /**
     * factory method for an instance of StagedQuoteStateChangedMessageBuilder
     * @return builder 
     */
