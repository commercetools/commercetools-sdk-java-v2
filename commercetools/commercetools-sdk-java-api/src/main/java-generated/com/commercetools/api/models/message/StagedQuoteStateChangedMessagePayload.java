...
public interface StagedQuoteStateChangedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedQuoteStateChangedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedQuoteStateChangedMessagePayload>() {
            @Override
