...
public interface StagedQuoteStateTransitionMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedQuoteStateTransitionMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedQuoteStateTransitionMessage>() {
            @Override
