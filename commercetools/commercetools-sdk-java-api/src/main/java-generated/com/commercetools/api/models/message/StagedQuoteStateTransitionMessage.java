...
import com.commercetools.api.models.message.StagedQuoteStateTransitionMessageImpl;
...
public interface StagedQuoteStateTransitionMessage extends Message {
     ...
     */
    @Nullable
    public static StagedQuoteStateTransitionMessage deepCopy(@Nullable final StagedQuoteStateTransitionMessage template) {
        if (template == null) {
            return null;
        }
        StagedQuoteStateTransitionMessageImpl instance = new StagedQuoteStateTransitionMessageImpl();
