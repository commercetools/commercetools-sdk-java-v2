...
public interface StagedQuoteStateTransitionMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedQuoteStateTransitionMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedQuoteStateTransitionMessagePayload>() {
            @Override
