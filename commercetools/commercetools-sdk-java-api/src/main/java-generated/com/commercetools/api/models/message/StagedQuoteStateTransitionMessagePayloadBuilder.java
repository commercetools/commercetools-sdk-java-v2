...
public class StagedQuoteStateTransitionMessagePayloadBuilder implements Builder<StagedQuoteStateTransitionMessagePayload> {
    ...
    public StagedQuoteStateTransitionMessagePayloadBuilder state(Function<com.commercetools.api.models.state.StateReferenceBuilder, com.commercetools.api.models.state.StateReferenceBuilder> builder) {
    ...
    public StagedQuoteStateTransitionMessagePayloadBuilder withState(Function<com.commercetools.api.models.state.StateReferenceBuilder, com.commercetools.api.models.state.StateReference> builder) {
    ...
    public StagedQuoteStateTransitionMessagePayloadBuilder state( final com.commercetools.api.models.state.StateReference state) {
        this.state = state;
        return this;
    }
    ...
    public StagedQuoteStateTransitionMessagePayloadBuilder oldState(Function<com.commercetools.api.models.state.StateReferenceBuilder, com.commercetools.api.models.state.StateReferenceBuilder> builder) {
    ...
    public StagedQuoteStateTransitionMessagePayloadBuilder withOldState(Function<com.commercetools.api.models.state.StateReferenceBuilder, com.commercetools.api.models.state.StateReference> builder) {
    ...
    public StagedQuoteStateTransitionMessagePayloadBuilder oldState(@Nullable final com.commercetools.api.models.state.StateReference oldState) {
     ...
     * @return builder
     */
    public static StagedQuoteStateTransitionMessagePayloadBuilder of(final StagedQuoteStateTransitionMessagePayload template) {
