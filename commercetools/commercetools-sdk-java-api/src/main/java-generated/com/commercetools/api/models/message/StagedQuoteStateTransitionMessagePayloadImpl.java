...
public class StagedQuoteStateTransitionMessagePayloadImpl implements StagedQuoteStateTransitionMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    StagedQuoteStateTransitionMessagePayloadImpl(@JsonProperty("state") final com.commercetools.api.models.state.StateReference state, @JsonProperty("oldState") final com.commercetools.api.models.state.StateReference oldState, @JsonProperty("force") final Boolean force) {
        this.state = state;
    ...
    public boolean equals(Object o) {
        ...
        StagedQuoteStateTransitionMessagePayloadImpl that = (StagedQuoteStateTransitionMessagePayloadImpl) o;
