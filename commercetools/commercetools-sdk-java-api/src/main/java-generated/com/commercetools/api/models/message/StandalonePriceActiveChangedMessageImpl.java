...
public class StandalonePriceActiveChangedMessageImpl implements StandalonePriceActiveChangedMessage, ModelBase {
    ...
    StandalonePriceActiveChangedMessageImpl(@JsonProperty("id") final String id,
            ...
            @JsonProperty("active") final Boolean active, @JsonProperty("oldActive") final Boolean oldActive) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        StandalonePriceActiveChangedMessageImpl that = (StandalonePriceActiveChangedMessageImpl) o;
