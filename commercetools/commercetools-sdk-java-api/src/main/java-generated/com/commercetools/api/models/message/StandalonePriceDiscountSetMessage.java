...
import com.commercetools.api.models.message.StandalonePriceDiscountSetMessageImpl;
...
public interface StandalonePriceDiscountSetMessage extends Message {
     ...
     */
    @Nullable
    public static StandalonePriceDiscountSetMessage deepCopy(@Nullable final StandalonePriceDiscountSetMessage template) {
        if (template == null) {
            return null;
        }
        StandalonePriceDiscountSetMessageImpl instance = new StandalonePriceDiscountSetMessageImpl();
