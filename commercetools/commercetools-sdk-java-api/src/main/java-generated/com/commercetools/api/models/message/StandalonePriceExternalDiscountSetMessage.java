...
import com.commercetools.api.models.message.StandalonePriceExternalDiscountSetMessageImpl;
...
public interface StandalonePriceExternalDiscountSetMessage extends Message {
     ...
     */
    public static StandalonePriceExternalDiscountSetMessage of(final StandalonePriceExternalDiscountSetMessage template) {
     ...
     */
    @Nullable
    public static StandalonePriceExternalDiscountSetMessage deepCopy(@Nullable final StandalonePriceExternalDiscountSetMessage template) {
        if (template == null) {
            return null;
        }
        StandalonePriceExternalDiscountSetMessageImpl instance = new StandalonePriceExternalDiscountSetMessageImpl();
     ...
     * @return builder
     */
    public static StandalonePriceExternalDiscountSetMessageBuilder builder(final StandalonePriceExternalDiscountSetMessage template) {
     ...
     * @return mapped value
     */
    default <T> T withStandalonePriceExternalDiscountSetMessage(Function<StandalonePriceExternalDiscountSetMessage, T> helper) {
