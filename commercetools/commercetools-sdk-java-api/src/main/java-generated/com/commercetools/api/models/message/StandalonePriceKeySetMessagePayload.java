...
/**
 *  <p>Generated after a successful <a href="https://docs.commercetools.com/apis/ctp:api:type:StandalonePriceSetKeyAction" rel="nofollow">Set Key</a> update action.</p>
 *
 * <hr>
...
public interface StandalonePriceKeySetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StandalonePriceKeySetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<StandalonePriceKeySetMessagePayload>() {
            @Override
