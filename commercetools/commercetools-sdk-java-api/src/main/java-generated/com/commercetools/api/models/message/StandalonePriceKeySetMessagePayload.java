...
import com.commercetools.api.models.message.StandalonePriceKeySetMessagePayloadImpl;
...
public interface StandalonePriceKeySetMessagePayload extends MessagePayload {
     ...
     */
    @Nullable
    public static StandalonePriceKeySetMessagePayload deepCopy(@Nullable final StandalonePriceKeySetMessagePayload template) {
        if (template == null) {
            return null;
        }
        StandalonePriceKeySetMessagePayloadImpl instance = new StandalonePriceKeySetMessagePayloadImpl();
     ...
     * @return builder
     */
    public static StandalonePriceKeySetMessagePayloadBuilder builder(final StandalonePriceKeySetMessagePayload template) {
