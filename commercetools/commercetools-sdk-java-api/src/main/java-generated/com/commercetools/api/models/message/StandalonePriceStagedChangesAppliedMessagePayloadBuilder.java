...
public class StandalonePriceStagedChangesAppliedMessagePayloadBuilder implements Builder<StandalonePriceStagedChangesAppliedMessagePayload> {
    ...
    public StandalonePriceStagedChangesAppliedMessagePayloadBuilder stagedChanges(Function<com.commercetools.api.models.standalone_price.StagedStandalonePriceBuilder, com.commercetools.api.models.standalone_price.StagedStandalonePriceBuilder> builder) {
    ...
    public StandalonePriceStagedChangesAppliedMessagePayloadBuilder withStagedChanges(Function<com.commercetools.api.models.standalone_price.StagedStandalonePriceBuilder, com.commercetools.api.models.standalone_price.StagedStandalonePrice> builder) {
    ...
    public StandalonePriceStagedChangesAppliedMessagePayloadBuilder stagedChanges( final com.commercetools.api.models.standalone_price.StagedStandalonePrice stagedChanges) {
    ...
    public StandalonePriceStagedChangesAppliedMessagePayload build() {
        Objects.requireNonNull(stagedChanges, StandalonePriceStagedChangesAppliedMessagePayload.class + ": stagedChanges is missing");
     ...
     * @return builder
     */
    public static StandalonePriceStagedChangesAppliedMessagePayloadBuilder of(final StandalonePriceStagedChangesAppliedMessagePayload template) {
