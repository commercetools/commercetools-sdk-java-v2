...
public class StandalonePriceTiersSetMessageImpl implements StandalonePriceTiersSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    StandalonePriceTiersSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public StandalonePriceTiersSetMessageImpl() {
        this.type = STANDALONE_PRICE_TIERS_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        StandalonePriceTiersSetMessageImpl that = (StandalonePriceTiersSetMessageImpl) o;
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).append("id", id)
                ...
                .append("tiers", tiers)
                .append("previousTiers", previousTiers)
                .build();
    }
