 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("StandalonePriceValidFromAndUntilSet")
...
public interface StandalonePriceValidFromAndUntilSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StandalonePriceValidFromAndUntilSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<StandalonePriceValidFromAndUntilSetMessagePayload>() {
            @Override
