...
public interface StandalonePriceValidFromSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StandalonePriceValidFromSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<StandalonePriceValidFromSetMessagePayload>() {
            @Override
