...
public interface StandalonePriceValidUntilSetMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StandalonePriceValidUntilSetMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<StandalonePriceValidUntilSetMessagePayload>() {
            @Override
