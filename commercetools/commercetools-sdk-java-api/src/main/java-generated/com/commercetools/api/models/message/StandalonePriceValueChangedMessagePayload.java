...
public interface StandalonePriceValueChangedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StandalonePriceValueChangedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<StandalonePriceValueChangedMessagePayload>() {
            @Override
