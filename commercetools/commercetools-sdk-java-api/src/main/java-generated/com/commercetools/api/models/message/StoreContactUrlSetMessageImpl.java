...
public class StoreContactUrlSetMessageImpl implements StoreContactUrlSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    StoreContactUrlSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public StoreContactUrlSetMessageImpl() {
        this.type = STORE_CONTACT_URL_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        StoreContactUrlSetMessageImpl that = (StoreContactUrlSetMessageImpl) o;
    ...
    public StoreContactUrlSetMessage copyDeep() {
        return StoreContactUrlSetMessage.deepCopy(this);
    }
}
