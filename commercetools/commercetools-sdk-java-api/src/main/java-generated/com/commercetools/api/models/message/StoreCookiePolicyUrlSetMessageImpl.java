...
public class StoreCookiePolicyUrlSetMessageImpl implements StoreCookiePolicyUrlSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    StoreCookiePolicyUrlSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public StoreCookiePolicyUrlSetMessageImpl() {
        this.type = STORE_COOKIE_POLICY_URL_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        StoreCookiePolicyUrlSetMessageImpl that = (StoreCookiePolicyUrlSetMessageImpl) o;
    ...
    public StoreCookiePolicyUrlSetMessage copyDeep() {
        return StoreCookiePolicyUrlSetMessage.deepCopy(this);
    }
}
