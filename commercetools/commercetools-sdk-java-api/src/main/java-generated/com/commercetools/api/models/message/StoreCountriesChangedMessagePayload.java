...
public interface StoreCountriesChangedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StoreCountriesChangedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<StoreCountriesChangedMessagePayload>() {
            @Override
