...
public class StoreCountriesChangedMessagePayloadImpl implements StoreCountriesChangedMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    StoreCountriesChangedMessagePayloadImpl(@JsonProperty("addedCountries") final java.util.List<com.commercetools.api.models.store_country.StoreCountry> addedCountries, @JsonProperty("removedCountries") final java.util.List<com.commercetools.api.models.store_country.StoreCountry> removedCountries) {
