...
public interface StoreCreatedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StoreCreatedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<StoreCreatedMessage>() {
            @Override
