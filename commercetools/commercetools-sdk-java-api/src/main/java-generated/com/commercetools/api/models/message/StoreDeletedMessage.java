...
public interface StoreDeletedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StoreDeletedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<StoreDeletedMessage>() {
            @Override
