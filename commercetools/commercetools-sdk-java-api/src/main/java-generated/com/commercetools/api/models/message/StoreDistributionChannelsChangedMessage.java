...
public interface StoreDistributionChannelsChangedMessage extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StoreDistributionChannelsChangedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<StoreDistributionChannelsChangedMessage>() {
            @Override
