...
public interface StoreDistributionChannelsChangedMessagePayload extends MessagePayload {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StoreDistributionChannelsChangedMessagePayload> typeReference() {
        return new tools.jackson.core.type.TypeReference<StoreDistributionChannelsChangedMessagePayload>() {
            @Override
