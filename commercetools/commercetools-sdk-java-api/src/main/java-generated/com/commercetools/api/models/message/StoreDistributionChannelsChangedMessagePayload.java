...
import com.commercetools.api.models.message.StoreDistributionChannelsChangedMessagePayloadImpl;
...
public interface StoreDistributionChannelsChangedMessagePayload extends MessagePayload {
     ...
     */
    public static StoreDistributionChannelsChangedMessagePayload of(final StoreDistributionChannelsChangedMessagePayload template) {
     ...
     */
    @Nullable
    public static StoreDistributionChannelsChangedMessagePayload deepCopy(@Nullable final StoreDistributionChannelsChangedMessagePayload template) {
        if (template == null) {
            return null;
        }
        StoreDistributionChannelsChangedMessagePayloadImpl instance = new StoreDistributionChannelsChangedMessagePayloadImpl();
     ...
     * @return builder
     */
    public static StoreDistributionChannelsChangedMessagePayloadBuilder builder(final StoreDistributionChannelsChangedMessagePayload template) {
     ...
     * @return mapped value
     */
    default <T> T withStoreDistributionChannelsChangedMessagePayload(Function<StoreDistributionChannelsChangedMessagePayload, T> helper) {
