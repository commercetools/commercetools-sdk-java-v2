...
public class StoreFaqUrlSetMessageImpl implements StoreFaqUrlSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    StoreFaqUrlSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
            ...
            @JsonProperty("faqUrl") final String faqUrl) {
        this.id = id;
     ...
     */
    public StoreFaqUrlSetMessageImpl() {
        this.type = STORE_FAQ_URL_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        StoreFaqUrlSetMessageImpl that = (StoreFaqUrlSetMessageImpl) o;
    ...
    public StoreFaqUrlSetMessage copyDeep() {
        return StoreFaqUrlSetMessage.deepCopy(this);
    }
}
