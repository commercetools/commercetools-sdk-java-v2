...
public class StoreImprintUrlSetMessageImpl implements StoreImprintUrlSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    StoreImprintUrlSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
            ...
            @JsonProperty("imprintUrl") final String imprintUrl) {
        this.id = id;
     ...
     */
    public StoreImprintUrlSetMessageImpl() {
        this.type = STORE_IMPRINT_URL_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        StoreImprintUrlSetMessageImpl that = (StoreImprintUrlSetMessageImpl) o;
    ...
    public StoreImprintUrlSetMessage copyDeep() {
        return StoreImprintUrlSetMessage.deepCopy(this);
    }
}
