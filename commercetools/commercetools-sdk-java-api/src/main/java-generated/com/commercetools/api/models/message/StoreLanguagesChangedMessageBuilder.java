...
public class StoreLanguagesChangedMessageBuilder implements Builder<StoreLanguagesChangedMessage> {
    ...
    public StoreLanguagesChangedMessageBuilder lastModifiedBy(
    ...
    public StoreLanguagesChangedMessageBuilder withLastModifiedBy(
    ...
    public StoreLanguagesChangedMessageBuilder createdBy(
    ...
    public StoreLanguagesChangedMessageBuilder withCreatedBy(
    ...
    public StoreLanguagesChangedMessageBuilder resource(
    ...
    public StoreLanguagesChangedMessageBuilder resourceUserProvidedIdentifiers(
    ...
    public StoreLanguagesChangedMessageBuilder withResourceUserProvidedIdentifiers(
    ...
    public StoreLanguagesChangedMessageBuilder removedLanguages(
    ...
    public StoreLanguagesChangedMessage build() {
        ...
        return new StoreLanguagesChangedMessageImpl(id, version, createdAt, lastModifiedAt, lastModifiedBy, createdBy,
            sequenceNumber, resource, resourceVersion, resourceUserProvidedIdentifiers, addedLanguages,
            removedLanguages);
    }
