...
public class StoreNameSetMessagePayloadImpl implements StoreNameSetMessagePayload, ModelBase {
     ...
     */
    @JsonCreator
    StoreNameSetMessagePayloadImpl(@JsonProperty("name") final com.commercetools.api.models.common.LocalizedString name, @JsonProperty("nameAllLocales") final java.util.List<com.commercetools.api.models.common.LocalizedString> nameAllLocales) {
        this.name = name;
