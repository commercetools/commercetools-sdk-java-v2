...
public class StoreOrderUrlTemplateSetMessageImpl implements StoreOrderUrlTemplateSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    StoreOrderUrlTemplateSetMessageImpl(@JsonProperty("id") final String id,
     ...
     */
    public StoreOrderUrlTemplateSetMessageImpl() {
        this.type = STORE_ORDER_URL_TEMPLATE_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        StoreOrderUrlTemplateSetMessageImpl that = (StoreOrderUrlTemplateSetMessageImpl) o;
    ...
    public StoreOrderUrlTemplateSetMessage copyDeep() {
        return StoreOrderUrlTemplateSetMessage.deepCopy(this);
    }
}
