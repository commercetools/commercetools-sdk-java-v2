...
import com.commercetools.api.models.message.StoreProductSelectionsChangedMessageImpl;
...
public interface StoreProductSelectionsChangedMessage extends Message {
     ...
     */
    @Nullable
    public static StoreProductSelectionsChangedMessage deepCopy(@Nullable final StoreProductSelectionsChangedMessage template) {
        if (template == null) {
            return null;
        }
        StoreProductSelectionsChangedMessageImpl instance = new StoreProductSelectionsChangedMessageImpl();
     ...
     * @return builder
     */
    public static StoreProductSelectionsChangedMessageBuilder builder(final StoreProductSelectionsChangedMessage template) {
