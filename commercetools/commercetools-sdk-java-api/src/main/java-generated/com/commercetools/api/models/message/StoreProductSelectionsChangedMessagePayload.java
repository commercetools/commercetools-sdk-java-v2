...
import com.commercetools.api.models.message.StoreProductSelectionsChangedMessagePayloadImpl;
...
public interface StoreProductSelectionsChangedMessagePayload extends MessagePayload {
     ...
     */
    public static StoreProductSelectionsChangedMessagePayload of(final StoreProductSelectionsChangedMessagePayload template) {
     ...
     */
    @Nullable
    public static StoreProductSelectionsChangedMessagePayload deepCopy(@Nullable final StoreProductSelectionsChangedMessagePayload template) {
        if (template == null) {
            return null;
        }
        StoreProductSelectionsChangedMessagePayloadImpl instance = new StoreProductSelectionsChangedMessagePayloadImpl();
     ...
     * @return builder
     */
    public static StoreProductSelectionsChangedMessagePayloadBuilder builder(final StoreProductSelectionsChangedMessagePayload template) {
     ...
     * @return mapped value
     */
    default <T> T withStoreProductSelectionsChangedMessagePayload(Function<StoreProductSelectionsChangedMessagePayload, T> helper) {
