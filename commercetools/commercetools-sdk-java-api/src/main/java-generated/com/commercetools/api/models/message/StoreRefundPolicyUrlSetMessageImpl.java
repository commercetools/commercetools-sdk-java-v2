...
public class StoreRefundPolicyUrlSetMessageImpl implements StoreRefundPolicyUrlSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    StoreRefundPolicyUrlSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public StoreRefundPolicyUrlSetMessageImpl() {
        this.type = STORE_REFUND_POLICY_URL_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        StoreRefundPolicyUrlSetMessageImpl that = (StoreRefundPolicyUrlSetMessageImpl) o;
    ...
    public StoreRefundPolicyUrlSetMessage copyDeep() {
        return StoreRefundPolicyUrlSetMessage.deepCopy(this);
    }
}
