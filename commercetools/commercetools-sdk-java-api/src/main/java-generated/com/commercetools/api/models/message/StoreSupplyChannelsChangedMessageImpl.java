...
public class StoreSupplyChannelsChangedMessageImpl implements StoreSupplyChannelsChangedMessage, ModelBase {
    ...
    public void setAddedSupplyChannels(final com.commercetools.api.models.channel.ChannelReference ...addedSupplyChannels){
       this.addedSupplyChannels = new ArrayList<>(Arrays.asList(addedSupplyChannels));
    }
    
    
    public void setAddedSupplyChannels(final java.util.List<com.commercetools.api.models.channel.ChannelReference> addedSupplyChannels){
       this.addedSupplyChannels = addedSupplyChannels;
    }
    
    
    public void setRemovedSupplyChannels(final com.commercetools.api.models.channel.ChannelReference ...removedSupplyChannels){
       this.removedSupplyChannels = new ArrayList<>(Arrays.asList(removedSupplyChannels));
    }
    
    
    public void setRemovedSupplyChannels(final java.util.List<com.commercetools.api.models.channel.ChannelReference> removedSupplyChannels){
       this.removedSupplyChannels = removedSupplyChannels;
    }
    ...
    public boolean equals(Object o) {
        ...
        StoreSupplyChannelsChangedMessageImpl that = (StoreSupplyChannelsChangedMessageImpl) o;
