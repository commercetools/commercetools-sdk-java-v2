...
@JsonDeserialize(as = VariantCreatedMessageImpl.class)
public interface VariantCreatedMessage extends Message {

    /**
     * discriminator value for VariantCreatedMessage
     */
    ...
    /**
     * factory method
     * @return instance of VariantCreatedMessage
     */
    public static VariantCreatedMessage of() {
        return new VariantCreatedMessageImpl();
    }
     ...
     */
    public static VariantCreatedMessage of(final VariantCreatedMessage template) {
        VariantCreatedMessageImpl instance = new VariantCreatedMessageImpl();
     ...
     */
    @Nullable
    public static VariantCreatedMessage deepCopy(@Nullable final VariantCreatedMessage template) {
        if (template == null) {
            return null;
        }
        VariantCreatedMessageImpl instance = new VariantCreatedMessageImpl();
     ...
     * @return builder
     */
    public static VariantCreatedMessageBuilder builder() {
        return VariantCreatedMessageBuilder.of();
    }
     ...
     * @return builder
     */
    public static VariantCreatedMessageBuilder builder(final VariantCreatedMessage template) {
        return VariantCreatedMessageBuilder.of(template);
    }
     ...
     */
    public static tools.jackson.core.type.TypeReference<VariantCreatedMessage> typeReference() {
        return new tools.jackson.core.type.TypeReference<VariantCreatedMessage>() {
            @Override
            public String toString() {
                return "TypeReference<VariantCreatedMessage>";
            }
        };
    }
}
