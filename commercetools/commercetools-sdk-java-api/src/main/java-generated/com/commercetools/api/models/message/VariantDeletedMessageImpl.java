...
public class VariantDeletedMessageImpl implements VariantDeletedMessage, ModelBase {
     ...
     */
    @JsonCreator
    VariantDeletedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public VariantDeletedMessageImpl() {
        this.type = VARIANT_DELETED;
    }
    ...
    public boolean equals(Object o) {
        ...
        VariantDeletedMessageImpl that = (VariantDeletedMessageImpl) o;
    ...
    public VariantDeletedMessage copyDeep() {
        return VariantDeletedMessage.deepCopy(this);
    }
}
