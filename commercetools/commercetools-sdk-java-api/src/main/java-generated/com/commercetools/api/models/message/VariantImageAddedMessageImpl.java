...
public class VariantImageAddedMessageImpl implements VariantImageAddedMessage, ModelBase {
     ...
     */
    @JsonCreator
    VariantImageAddedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public VariantImageAddedMessageImpl() {
        this.type = VARIANT_IMAGE_ADDED;
    }
    ...
    public boolean equals(Object o) {
        ...
        VariantImageAddedMessageImpl that = (VariantImageAddedMessageImpl) o;
    ...
    public VariantImageAddedMessage copyDeep() {
        return VariantImageAddedMessage.deepCopy(this);
    }
}
