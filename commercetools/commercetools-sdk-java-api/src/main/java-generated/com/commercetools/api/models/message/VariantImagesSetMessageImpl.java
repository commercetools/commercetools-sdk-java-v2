...
public class VariantImagesSetMessageImpl implements VariantImagesSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    VariantImagesSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public VariantImagesSetMessageImpl() {
        this.type = VARIANT_IMAGES_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        VariantImagesSetMessageImpl that = (VariantImagesSetMessageImpl) o;
    ...
    public VariantImagesSetMessage copyDeep() {
        return VariantImagesSetMessage.deepCopy(this);
    }
}
