...
public class VariantKeySetMessageImpl implements VariantKeySetMessage, ModelBase {
     ...
     */
    @JsonCreator
    VariantKeySetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public VariantKeySetMessageImpl() {
        this.type = VARIANT_KEY_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        VariantKeySetMessageImpl that = (VariantKeySetMessageImpl) o;
    ...
    public VariantKeySetMessage copyDeep() {
        return VariantKeySetMessage.deepCopy(this);
    }
}
