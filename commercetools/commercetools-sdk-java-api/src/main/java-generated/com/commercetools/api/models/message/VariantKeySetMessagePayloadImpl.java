...
public class VariantKeySetMessagePayloadImpl implements VariantKeySetMessagePayload, ModelBase {
     ...
     */
    public VariantKeySetMessagePayloadImpl() {
        this.type = VARIANT_KEY_SET;
    }
    ...
    public VariantKeySetMessagePayload copyDeep() {
        return VariantKeySetMessagePayload.deepCopy(this);
    }
}
