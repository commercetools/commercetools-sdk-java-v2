...
public class VariantPublishedMessageImpl implements VariantPublishedMessage, ModelBase {
     ...
     */
    @JsonCreator
    VariantPublishedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public VariantPublishedMessageImpl() {
        this.type = VARIANT_PUBLISHED;
    }
    ...
    public boolean equals(Object o) {
        ...
        VariantPublishedMessageImpl that = (VariantPublishedMessageImpl) o;
    ...
    public VariantPublishedMessage copyDeep() {
        return VariantPublishedMessage.deepCopy(this);
    }
}
