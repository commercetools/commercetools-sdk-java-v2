...
public class VariantSkuSetMessageImpl implements VariantSkuSetMessage, ModelBase {
     ...
     */
    @JsonCreator
    VariantSkuSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public VariantSkuSetMessageImpl() {
        this.type = VARIANT_SKU_SET;
    }
    ...
    public boolean equals(Object o) {
        ...
        VariantSkuSetMessageImpl that = (VariantSkuSetMessageImpl) o;
    ...
    public VariantSkuSetMessage copyDeep() {
        return VariantSkuSetMessage.deepCopy(this);
    }
}
