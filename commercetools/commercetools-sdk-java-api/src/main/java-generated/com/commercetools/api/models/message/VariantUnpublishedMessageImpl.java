...
public class VariantUnpublishedMessageImpl implements VariantUnpublishedMessage, ModelBase {
     ...
     */
    @JsonCreator
    VariantUnpublishedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
     ...
     */
    public VariantUnpublishedMessageImpl() {
        this.type = VARIANT_UNPUBLISHED;
    }
    ...
    public boolean equals(Object o) {
        ...
        VariantUnpublishedMessageImpl that = (VariantUnpublishedMessageImpl) o;
    ...
    public VariantUnpublishedMessage copyDeep() {
        return VariantUnpublishedMessage.deepCopy(this);
    }
}
