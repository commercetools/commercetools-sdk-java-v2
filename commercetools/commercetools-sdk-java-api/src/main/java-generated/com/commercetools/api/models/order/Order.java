...
public interface Order extends BaseResource, OrderMixin, com.commercetools.api.models.DomainResource<Order>, com.commercetools.api.models.Referencable<Order>, com.commercetools.api.models.ResourceIdentifiable<Order>, com.commercetools.api.models.Customizable<Order>, com.commercetools.api.models.order.OrderLike<Order> {
    ...
    public static Order deepCopy(@Nullable final Order template) {
        ...
        if (template instanceof com.commercetools.api.models.order_edit.StagedOrder) {
            return com.commercetools.api.models.order_edit.StagedOrder.deepCopy((com.commercetools.api.models.order_edit.StagedOrder)template);
        }
        OrderImpl instance = new OrderImpl();
        instance.setId(template.getId());
        instance.setVersion(template.getVersion());
