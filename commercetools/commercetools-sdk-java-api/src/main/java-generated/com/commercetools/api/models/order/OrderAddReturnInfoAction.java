...
public interface OrderAddReturnInfoAction extends OrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderAddReturnInfoAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderAddReturnInfoAction>() {
            @Override
