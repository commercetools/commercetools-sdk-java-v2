...
public interface OrderChangeShipmentStateAction extends OrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderChangeShipmentStateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderChangeShipmentStateAction>() {
            @Override
