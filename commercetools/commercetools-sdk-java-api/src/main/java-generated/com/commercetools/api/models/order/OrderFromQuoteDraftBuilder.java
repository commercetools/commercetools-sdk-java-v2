...
import com.commercetools.api.models.order.OrderFromQuoteDraft;
...
public class OrderFromQuoteDraftBuilder implements Builder<OrderFromQuoteDraft> {
    ...
    public OrderFromQuoteDraftBuilder quote(Function<com.commercetools.api.models.quote.QuoteResourceIdentifierBuilder, com.commercetools.api.models.quote.QuoteResourceIdentifierBuilder> builder) {
    ...
    public OrderFromQuoteDraftBuilder withQuote(Function<com.commercetools.api.models.quote.QuoteResourceIdentifierBuilder, com.commercetools.api.models.quote.QuoteResourceIdentifier> builder) {
    ...
    public OrderFromQuoteDraftBuilder paymentState(@Nullable final com.commercetools.api.models.order.PaymentState paymentState) {
    ...
    public OrderFromQuoteDraftBuilder shipmentState(@Nullable final com.commercetools.api.models.order.ShipmentState shipmentState) {
    ...
    public OrderFromQuoteDraftBuilder orderState(@Nullable final com.commercetools.api.models.order.OrderState orderState) {
    ...
    public OrderFromQuoteDraftBuilder state(Function<com.commercetools.api.models.state.StateResourceIdentifierBuilder, com.commercetools.api.models.state.StateResourceIdentifierBuilder> builder) {
    ...
    public OrderFromQuoteDraftBuilder withState(Function<com.commercetools.api.models.state.StateResourceIdentifierBuilder, com.commercetools.api.models.state.StateResourceIdentifier> builder) {
    ...
    public OrderFromQuoteDraftBuilder state(@Nullable final com.commercetools.api.models.state.StateResourceIdentifier state) {
        this.state = state;
        return this;
    }
    ...
    public OrderFromQuoteDraft build() {
        ...
        return new OrderFromQuoteDraftImpl(quote, version, quoteStateToAccepted, orderNumber, paymentState, shipmentState, orderState, state);
    }
