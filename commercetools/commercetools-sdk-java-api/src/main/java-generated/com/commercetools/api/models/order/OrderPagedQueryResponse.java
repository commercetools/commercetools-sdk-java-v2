...
public interface OrderPagedQueryResponse extends com.commercetools.api.models.ResourcePagedQueryResponse<Order> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderPagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderPagedQueryResponse>() {
            @Override
