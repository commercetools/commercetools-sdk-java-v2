...
public class OrderPagedQueryResponseBuilder implements Builder<OrderPagedQueryResponse> {
    ...
    public OrderPagedQueryResponseBuilder plusResults(Function<com.commercetools.api.models.order.OrderBuilder, com.commercetools.api.models.order.OrderBuilder> builder) {
        if (this.results == null) {
            this.results = new ArrayList<>();
        }
    ...
    public OrderPagedQueryResponseBuilder withResults(Function<com.commercetools.api.models.order.OrderBuilder, com.commercetools.api.models.order.OrderBuilder> builder) {
        this.results = new ArrayList<>();
        this.results.add(builder.apply(com.commercetools.api.models.order.OrderBuilder.of()).build());
        return this;
    }
    ...
    public OrderPagedQueryResponseBuilder addResults(Function<com.commercetools.api.models.order.OrderBuilder, com.commercetools.api.models.order.Order> builder) {
    ...
    public OrderPagedQueryResponseBuilder setResults(Function<com.commercetools.api.models.order.OrderBuilder, com.commercetools.api.models.order.Order> builder) {
