...
public interface OrderRemoveDeliveryAction extends OrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderRemoveDeliveryAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderRemoveDeliveryAction>() {
            @Override
