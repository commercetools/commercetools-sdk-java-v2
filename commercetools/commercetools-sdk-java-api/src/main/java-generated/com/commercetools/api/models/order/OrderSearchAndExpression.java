...
public interface OrderSearchAndExpression extends OrderSearchCompoundExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSearchAndExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSearchAndExpression>() {
            @Override
