...
public interface OrderSearchAnyValue extends OrderSearchQueryExpressionValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSearchAnyValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSearchAnyValue>() {
            @Override
