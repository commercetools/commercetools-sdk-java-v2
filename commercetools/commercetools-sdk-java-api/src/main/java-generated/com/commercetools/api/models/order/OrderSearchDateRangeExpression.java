...
public interface OrderSearchDateRangeExpression extends OrderSearchQueryExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSearchDateRangeExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSearchDateRangeExpression>() {
            @Override
