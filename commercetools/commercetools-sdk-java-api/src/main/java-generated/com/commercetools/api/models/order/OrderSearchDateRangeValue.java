...
public interface OrderSearchDateRangeValue extends OrderSearchQueryExpressionValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSearchDateRangeValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSearchDateRangeValue>() {
            @Override
