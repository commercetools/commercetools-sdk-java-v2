...
public class OrderSearchDateRangeValueImpl implements OrderSearchDateRangeValue, ModelBase {
     ...
     */
    @JsonCreator
    OrderSearchDateRangeValueImpl(@JsonProperty("field") final String field, @JsonProperty("boost") final Integer boost, @JsonProperty("customType") final String customType, @JsonProperty("gte") final java.time.ZonedDateTime gte, @JsonProperty("lte") final java.time.ZonedDateTime lte) {
        this.field = field;
        this.boost = boost;
