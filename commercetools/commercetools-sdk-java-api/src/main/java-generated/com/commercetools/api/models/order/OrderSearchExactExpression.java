...
public interface OrderSearchExactExpression extends OrderSearchQueryExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSearchExactExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSearchExactExpression>() {
            @Override
