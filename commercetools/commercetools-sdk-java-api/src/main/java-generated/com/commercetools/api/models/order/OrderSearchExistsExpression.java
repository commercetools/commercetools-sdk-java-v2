...
public interface OrderSearchExistsExpression extends OrderSearchQueryExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSearchExistsExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSearchExistsExpression>() {
            @Override
