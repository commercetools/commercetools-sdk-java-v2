...
public interface OrderSearchFilterExpression extends OrderSearchCompoundExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSearchFilterExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSearchFilterExpression>() {
            @Override
