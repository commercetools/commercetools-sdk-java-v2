...
public interface OrderSearchFullTextExpression extends OrderSearchQueryExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSearchFullTextExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSearchFullTextExpression>() {
            @Override
