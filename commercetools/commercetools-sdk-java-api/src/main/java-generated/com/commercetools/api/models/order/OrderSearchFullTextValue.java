...
public interface OrderSearchFullTextValue extends OrderSearchQueryExpressionValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSearchFullTextValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSearchFullTextValue>() {
            @Override
