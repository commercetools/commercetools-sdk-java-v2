...
public interface OrderSearchLongRangeExpression extends OrderSearchQueryExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSearchLongRangeExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSearchLongRangeExpression>() {
            @Override
