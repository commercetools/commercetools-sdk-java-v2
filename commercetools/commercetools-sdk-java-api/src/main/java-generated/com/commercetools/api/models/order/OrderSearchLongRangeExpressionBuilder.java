...
public class OrderSearchLongRangeExpressionBuilder implements Builder<OrderSearchLongRangeExpression> {
    ...
    public OrderSearchLongRangeExpressionBuilder range(Function<com.commercetools.api.models.order.OrderSearchLongRangeValueBuilder, com.commercetools.api.models.order.OrderSearchLongRangeValueBuilder> builder) {
    ...
    public OrderSearchLongRangeExpressionBuilder withRange(Function<com.commercetools.api.models.order.OrderSearchLongRangeValueBuilder, com.commercetools.api.models.order.OrderSearchLongRangeValue> builder) {
    ...
    public OrderSearchLongRangeExpressionBuilder range( final com.commercetools.api.models.order.OrderSearchLongRangeValue range) {
        this.range = range;
        return this;
    }
