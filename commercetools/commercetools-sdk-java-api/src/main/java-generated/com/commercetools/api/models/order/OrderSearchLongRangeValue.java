...
public interface OrderSearchLongRangeValue extends OrderSearchQueryExpressionValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSearchLongRangeValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSearchLongRangeValue>() {
            @Override
