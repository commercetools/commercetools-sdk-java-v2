...
public class OrderSearchLongRangeValueImpl implements OrderSearchLongRangeValue, ModelBase {
     ...
     */
    @JsonCreator
    OrderSearchLongRangeValueImpl(@JsonProperty("field") final String field, @JsonProperty("boost") final Integer boost, @JsonProperty("customType") final String customType, @JsonProperty("gte") final Long gte, @JsonProperty("lte") final Long lte) {
        this.field = field;
        this.boost = boost;
