...
public interface OrderSearchNotExpression extends OrderSearchCompoundExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSearchNotExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSearchNotExpression>() {
            @Override
