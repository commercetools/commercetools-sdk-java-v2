...
public class OrderSearchNotExpressionBuilder implements Builder<OrderSearchNotExpression> {
    ...
    public OrderSearchNotExpressionBuilder not(
            final java.util.List<com.commercetools.api.models.order.OrderSearchQuery> not) {
        this.not = not;
        return this;
    }
    ...
    public OrderSearchNotExpressionBuilder plusNot(
    ...
    public OrderSearchNotExpressionBuilder withNot(
            Function<com.commercetools.api.models.order.OrderSearchQueryBuilder, com.commercetools.api.models.order.OrderSearchQueryBuilder> builder) {
        this.not = new ArrayList<>();
        this.not.add(builder.apply(com.commercetools.api.models.order.OrderSearchQueryBuilder.of()).build());
        return this;
    ...
    public OrderSearchNotExpressionBuilder addNot(
    ...
    public OrderSearchNotExpressionBuilder setNot(
            Function<com.commercetools.api.models.order.OrderSearchQueryBuilder, com.commercetools.api.models.order.OrderSearchQuery> builder) {
