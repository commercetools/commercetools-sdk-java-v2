...
public interface OrderSearchNumberRangeExpression extends OrderSearchQueryExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSearchNumberRangeExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSearchNumberRangeExpression>() {
            @Override
