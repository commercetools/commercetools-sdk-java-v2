...
public class OrderSearchNumberRangeExpressionBuilder implements Builder<OrderSearchNumberRangeExpression> {
    ...
    public OrderSearchNumberRangeExpressionBuilder range(Function<com.commercetools.api.models.order.OrderSearchNumberRangeValueBuilder, com.commercetools.api.models.order.OrderSearchNumberRangeValueBuilder> builder) {
    ...
    public OrderSearchNumberRangeExpressionBuilder withRange(Function<com.commercetools.api.models.order.OrderSearchNumberRangeValueBuilder, com.commercetools.api.models.order.OrderSearchNumberRangeValue> builder) {
    ...
    public OrderSearchNumberRangeExpressionBuilder range( final com.commercetools.api.models.order.OrderSearchNumberRangeValue range) {
        this.range = range;
        return this;
    }
