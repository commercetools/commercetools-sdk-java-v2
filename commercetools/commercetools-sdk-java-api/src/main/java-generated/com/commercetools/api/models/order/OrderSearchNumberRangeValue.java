...
public interface OrderSearchNumberRangeValue extends OrderSearchQueryExpressionValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSearchNumberRangeValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSearchNumberRangeValue>() {
            @Override
