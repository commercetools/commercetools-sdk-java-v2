...
public interface OrderSearchOrExpression extends OrderSearchCompoundExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSearchOrExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSearchOrExpression>() {
            @Override
