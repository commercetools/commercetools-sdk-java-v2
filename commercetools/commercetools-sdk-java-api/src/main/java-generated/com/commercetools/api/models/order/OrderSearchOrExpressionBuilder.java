...
public class OrderSearchOrExpressionBuilder implements Builder<OrderSearchOrExpression> {
    ...
    public OrderSearchOrExpressionBuilder or(
            final java.util.List<com.commercetools.api.models.order.OrderSearchQuery> or) {
        this.or = or;
        return this;
    }
    ...
    public OrderSearchOrExpressionBuilder plusOr(
    ...
    public OrderSearchOrExpressionBuilder withOr(
            Function<com.commercetools.api.models.order.OrderSearchQueryBuilder, com.commercetools.api.models.order.OrderSearchQueryBuilder> builder) {
        this.or = new ArrayList<>();
        this.or.add(builder.apply(com.commercetools.api.models.order.OrderSearchQueryBuilder.of()).build());
        return this;
    ...
    public OrderSearchOrExpressionBuilder addOr(
    ...
    public OrderSearchOrExpressionBuilder setOr(
            Function<com.commercetools.api.models.order.OrderSearchQueryBuilder, com.commercetools.api.models.order.OrderSearchQuery> builder) {
