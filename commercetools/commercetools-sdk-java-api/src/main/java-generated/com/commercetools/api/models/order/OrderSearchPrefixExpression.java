...
public interface OrderSearchPrefixExpression extends OrderSearchQueryExpression {
    ...
    public OrderSearchPrefixExpression copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSearchPrefixExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSearchPrefixExpression>() {
            @Override
