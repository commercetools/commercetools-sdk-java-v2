...
public interface OrderSearchRequest {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSearchRequest> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSearchRequest>() {
            @Override
