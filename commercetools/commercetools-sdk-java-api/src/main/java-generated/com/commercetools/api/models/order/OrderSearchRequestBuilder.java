...
public class OrderSearchRequestBuilder implements Builder<OrderSearchRequest> {
    ...
    public OrderSearchRequestBuilder query(Function<com.commercetools.api.models.order.OrderSearchQueryBuilder, com.commercetools.api.models.order.OrderSearchQueryBuilder> builder) {
    ...
    public OrderSearchRequestBuilder withQuery(Function<com.commercetools.api.models.order.OrderSearchQueryBuilder, com.commercetools.api.models.order.OrderSearchQuery> builder) {
    ...
    public OrderSearchRequestBuilder sort(@Nullable final com.commercetools.api.models.order.OrderSearchSorting ...sort) {
    ...
    public OrderSearchRequestBuilder sort(@Nullable final java.util.List<com.commercetools.api.models.order.OrderSearchSorting> sort) {
        this.sort = sort;
        return this;
    }
    ...
    public OrderSearchRequestBuilder plusSort(@Nullable final com.commercetools.api.models.order.OrderSearchSorting ...sort) {
        if (this.sort == null) {
    ...
    public OrderSearchRequestBuilder plusSort(Function<com.commercetools.api.models.order.OrderSearchSortingBuilder, com.commercetools.api.models.order.OrderSearchSortingBuilder> builder) {
        if (this.sort == null) {
            this.sort = new ArrayList<>();
        }
    ...
    public OrderSearchRequestBuilder withSort(Function<com.commercetools.api.models.order.OrderSearchSortingBuilder, com.commercetools.api.models.order.OrderSearchSortingBuilder> builder) {
        this.sort = new ArrayList<>();
        this.sort.add(builder.apply(com.commercetools.api.models.order.OrderSearchSortingBuilder.of()).build());
        return this;
    }
    ...
    public OrderSearchRequestBuilder addSort(Function<com.commercetools.api.models.order.OrderSearchSortingBuilder, com.commercetools.api.models.order.OrderSearchSorting> builder) {
    ...
    public OrderSearchRequestBuilder setSort(Function<com.commercetools.api.models.order.OrderSearchSortingBuilder, com.commercetools.api.models.order.OrderSearchSorting> builder) {
