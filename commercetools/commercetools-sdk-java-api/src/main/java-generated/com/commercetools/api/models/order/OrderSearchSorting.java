...
public interface OrderSearchSorting {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSearchSorting> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSearchSorting>() {
            @Override
