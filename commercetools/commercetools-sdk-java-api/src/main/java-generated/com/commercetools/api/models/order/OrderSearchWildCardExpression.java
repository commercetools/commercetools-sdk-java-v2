...
public interface OrderSearchWildCardExpression extends OrderSearchQueryExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSearchWildCardExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSearchWildCardExpression>() {
            @Override
