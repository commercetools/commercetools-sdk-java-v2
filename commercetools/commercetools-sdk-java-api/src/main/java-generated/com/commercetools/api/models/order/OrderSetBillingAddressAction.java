...
public interface OrderSetBillingAddressAction extends OrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSetBillingAddressAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSetBillingAddressAction>() {
            @Override
