...
public interface OrderSetBillingAddressCustomFieldAction extends OrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSetBillingAddressCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSetBillingAddressCustomFieldAction>() {
            @Override
