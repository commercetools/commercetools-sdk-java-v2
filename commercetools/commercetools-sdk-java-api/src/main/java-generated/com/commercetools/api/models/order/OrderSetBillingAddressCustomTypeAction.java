...
public interface OrderSetBillingAddressCustomTypeAction extends OrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSetBillingAddressCustomTypeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSetBillingAddressCustomTypeAction>() {
            @Override
