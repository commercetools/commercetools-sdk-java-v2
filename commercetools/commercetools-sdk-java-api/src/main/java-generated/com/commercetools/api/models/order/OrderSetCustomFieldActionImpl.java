...
public class OrderSetCustomFieldActionImpl implements OrderSetCustomFieldAction, ModelBase {
    ...
    @JsonCreator
    OrderSetCustomFieldActionImpl(@JsonProperty("name") final String name,
