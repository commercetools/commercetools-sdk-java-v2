...
public interface OrderSetCustomLineItemCustomFieldAction extends OrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSetCustomLineItemCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSetCustomLineItemCustomFieldAction>() {
            @Override
