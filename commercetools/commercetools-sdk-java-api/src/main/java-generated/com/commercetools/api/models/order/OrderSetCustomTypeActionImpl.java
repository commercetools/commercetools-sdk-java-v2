...
public class OrderSetCustomTypeActionImpl implements OrderSetCustomTypeAction, ModelBase {
     ...
     */
    @JsonCreator
    OrderSetCustomTypeActionImpl(@JsonProperty("type") final com.commercetools.api.models.type.TypeResourceIdentifier type, @JsonProperty("fields") final com.commercetools.api.models.type.FieldContainer fields) {
        this.type = type;
        this.fields = fields;
