...
public interface OrderSetLineItemCustomFieldAction extends OrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSetLineItemCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSetLineItemCustomFieldAction>() {
            @Override
