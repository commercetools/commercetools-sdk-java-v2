...
public interface OrderSetLineItemCustomTypeAction extends OrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSetLineItemCustomTypeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSetLineItemCustomTypeAction>() {
            @Override
