...
public class OrderSetParcelCustomFieldActionImpl implements OrderSetParcelCustomFieldAction, ModelBase {
     ...
     */
    @JsonCreator
    OrderSetParcelCustomFieldActionImpl(@JsonProperty("parcelId") final String parcelId, @JsonProperty("name") final String name, @JsonProperty("value") final java.lang.Object value) {
