...
public interface OrderSetReturnItemCustomFieldAction extends OrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSetReturnItemCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSetReturnItemCustomFieldAction>() {
            @Override
