...
import com.commercetools.api.models.order.OrderSetReturnItemCustomFieldActionImpl;
...
public interface OrderSetReturnItemCustomFieldAction extends OrderUpdateAction {
     ...
     */
    @Nullable
    public static OrderSetReturnItemCustomFieldAction deepCopy(@Nullable final OrderSetReturnItemCustomFieldAction template) {
        if (template == null) {
            return null;
        }
        OrderSetReturnItemCustomFieldActionImpl instance = new OrderSetReturnItemCustomFieldActionImpl();
     ...
     * @return builder
     */
    public static OrderSetReturnItemCustomFieldActionBuilder builder(final OrderSetReturnItemCustomFieldAction template) {
