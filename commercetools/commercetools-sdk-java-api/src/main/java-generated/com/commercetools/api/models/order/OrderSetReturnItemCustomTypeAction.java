...
import com.commercetools.api.models.order.OrderSetReturnItemCustomTypeActionImpl;
...
public interface OrderSetReturnItemCustomTypeAction extends OrderUpdateAction {
     ...
     */
    @Nullable
    public static OrderSetReturnItemCustomTypeAction deepCopy(@Nullable final OrderSetReturnItemCustomTypeAction template) {
        if (template == null) {
            return null;
        }
        OrderSetReturnItemCustomTypeActionImpl instance = new OrderSetReturnItemCustomTypeActionImpl();
