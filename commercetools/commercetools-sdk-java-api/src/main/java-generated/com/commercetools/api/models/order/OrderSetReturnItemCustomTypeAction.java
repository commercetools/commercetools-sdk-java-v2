...
public interface OrderSetReturnItemCustomTypeAction extends OrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSetReturnItemCustomTypeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSetReturnItemCustomTypeAction>() {
            @Override
