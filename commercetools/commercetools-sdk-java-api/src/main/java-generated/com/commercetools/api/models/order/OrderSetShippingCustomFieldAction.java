...
public interface OrderSetShippingCustomFieldAction extends OrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderSetShippingCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderSetShippingCustomFieldAction>() {
            @Override
