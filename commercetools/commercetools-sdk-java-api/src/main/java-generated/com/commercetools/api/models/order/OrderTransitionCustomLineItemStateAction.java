...
public interface OrderTransitionCustomLineItemStateAction extends OrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderTransitionCustomLineItemStateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderTransitionCustomLineItemStateAction>() {
            @Override
