...
public class ReturnInfoBuilder implements Builder<ReturnInfo> {
    ...
    public ReturnInfoBuilder plusItems(Function<com.commercetools.api.models.order.ReturnItemBuilder, Builder<? extends com.commercetools.api.models.order.ReturnItem>> builder) {
        if (this.items == null) {
            this.items = new ArrayList<>();
        }
    ...
    public ReturnInfoBuilder withItems(Function<com.commercetools.api.models.order.ReturnItemBuilder, Builder<? extends com.commercetools.api.models.order.ReturnItem>> builder) {
        this.items = new ArrayList<>();
        this.items.add(builder.apply(com.commercetools.api.models.order.ReturnItemBuilder.of()).build());
        return this;
    }
