...
public interface StagedOrderUpdateAction
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedOrderUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedOrderUpdateAction>() {
            @Override
