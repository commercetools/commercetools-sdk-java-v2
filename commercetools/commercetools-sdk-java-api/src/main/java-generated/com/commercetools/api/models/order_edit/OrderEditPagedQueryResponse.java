...
/**
 *  <p><span>PagedQueryResult</span> with <code>results</code> containing an array of <a href="https://docs.commercetools.com/apis/ctp:api:type:OrderEdit" rel="nofollow">OrderEdit</a>.</p>
 *
 * <hr>
...
public interface OrderEditPagedQueryResponse
    ...
    /**
     *  <p><a href="https://docs.commercetools.com/apis/ctp:api:type:OrderEdit" rel="nofollow">OrderEdits</a> matching the query.</p>
     * @return results
     */
    @NotNull
    @Valid
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderEditPagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderEditPagedQueryResponse>() {
            @Override
