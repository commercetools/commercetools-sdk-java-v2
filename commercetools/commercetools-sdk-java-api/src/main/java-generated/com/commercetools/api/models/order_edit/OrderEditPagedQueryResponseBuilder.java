...
public class OrderEditPagedQueryResponseBuilder implements Builder<OrderEditPagedQueryResponse> {
    ...
    public OrderEditPagedQueryResponseBuilder results( final com.commercetools.api.models.order_edit.OrderEdit ...results) {
    ...
    public OrderEditPagedQueryResponseBuilder results( final java.util.List<com.commercetools.api.models.order_edit.OrderEdit> results) {
    ...
    public OrderEditPagedQueryResponseBuilder plusResults( final com.commercetools.api.models.order_edit.OrderEdit ...results) {
    ...
    public OrderEditPagedQueryResponseBuilder plusResults(Function<com.commercetools.api.models.order_edit.OrderEditBuilder, com.commercetools.api.models.order_edit.OrderEditBuilder> builder) {
        if (this.results == null) {
            this.results = new ArrayList<>();
        }
    ...
    public OrderEditPagedQueryResponseBuilder withResults(Function<com.commercetools.api.models.order_edit.OrderEditBuilder, com.commercetools.api.models.order_edit.OrderEditBuilder> builder) {
        this.results = new ArrayList<>();
        this.results.add(builder.apply(com.commercetools.api.models.order_edit.OrderEditBuilder.of()).build());
        return this;
    }
    ...
    public OrderEditPagedQueryResponseBuilder addResults(Function<com.commercetools.api.models.order_edit.OrderEditBuilder, com.commercetools.api.models.order_edit.OrderEdit> builder) {
    ...
    public OrderEditPagedQueryResponseBuilder setResults(Function<com.commercetools.api.models.order_edit.OrderEditBuilder, com.commercetools.api.models.order_edit.OrderEdit> builder) {
