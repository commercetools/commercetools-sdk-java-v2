...
public class OrderEditPagedQueryResponseImpl implements OrderEditPagedQueryResponse, ModelBase {
     ...
     */
    @JsonCreator
    OrderEditPagedQueryResponseImpl(@JsonProperty("limit") final Long limit, @JsonProperty("offset") final Long offset,
    ...
    public OrderEditPagedQueryResponse copyDeep() {
        return OrderEditPagedQueryResponse.deepCopy(this);
    }
}
