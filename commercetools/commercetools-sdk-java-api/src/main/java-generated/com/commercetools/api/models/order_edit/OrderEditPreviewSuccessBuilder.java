...
public class OrderEditPreviewSuccessBuilder implements Builder<OrderEditPreviewSuccess> {
    ...
    public OrderEditPreviewSuccessBuilder preview(Function<com.commercetools.api.models.order_edit.StagedOrderBuilder, com.commercetools.api.models.order_edit.StagedOrderBuilder> builder) {
    ...
    public OrderEditPreviewSuccessBuilder withPreview(Function<com.commercetools.api.models.order_edit.StagedOrderBuilder, com.commercetools.api.models.order_edit.StagedOrder> builder) {
    ...
    public OrderEditPreviewSuccessBuilder plusMessagePayloads( final com.commercetools.api.models.message.MessagePayload ...messagePayloads) {
    ...
    public OrderEditPreviewSuccessBuilder plusMessagePayloads(Function<com.commercetools.api.models.message.MessagePayloadBuilder, Builder<? extends com.commercetools.api.models.message.MessagePayload>> builder) {
        if (this.messagePayloads == null) {
            this.messagePayloads = new ArrayList<>();
        }
        this.messagePayloads.add(builder.apply(com.commercetools.api.models.message.MessagePayloadBuilder.of()).build());
        return this;
    }
    ...
    public OrderEditPreviewSuccessBuilder withMessagePayloads(Function<com.commercetools.api.models.message.MessagePayloadBuilder, Builder<? extends com.commercetools.api.models.message.MessagePayload>> builder) {
        this.messagePayloads = new ArrayList<>();
        this.messagePayloads.add(builder.apply(com.commercetools.api.models.message.MessagePayloadBuilder.of()).build());
        return this;
    }
