...
public interface OrderEditSetCustomFieldAction extends OrderEditUpdateAction {
    ...
    /**
     * factory method to create a shallow copy OrderEditSetCustomFieldAction
    ...
    public OrderEditSetCustomFieldAction copyDeep();
     ...
     */
    @Nullable
    public static OrderEditSetCustomFieldAction deepCopy(@Nullable final OrderEditSetCustomFieldAction template) {
        if (template == null) {
            return null;
        }
        OrderEditSetCustomFieldActionImpl instance = new OrderEditSetCustomFieldActionImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderEditSetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderEditSetCustomFieldAction>() {
            @Override
