...
public interface OrderEditSetCustomTypeAction extends OrderEditUpdateAction {
    ...
    public OrderEditSetCustomTypeAction copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderEditSetCustomTypeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderEditSetCustomTypeAction>() {
            @Override
