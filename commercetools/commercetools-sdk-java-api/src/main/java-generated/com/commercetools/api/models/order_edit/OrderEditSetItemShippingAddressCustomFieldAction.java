...
public interface OrderEditSetItemShippingAddressCustomFieldAction extends OrderEditUpdateAction {
    ...
    public static OrderEditSetItemShippingAddressCustomFieldAction of(
            final OrderEditSetItemShippingAddressCustomFieldAction template) {
    ...
    default <T> T withOrderEditSetItemShippingAddressCustomFieldAction(
            Function<OrderEditSetItemShippingAddressCustomFieldAction, T> helper) {
