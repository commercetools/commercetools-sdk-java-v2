...
public interface OrderEditSetKeyAction extends OrderEditUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderEditSetKeyAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderEditSetKeyAction>() {
            @Override
