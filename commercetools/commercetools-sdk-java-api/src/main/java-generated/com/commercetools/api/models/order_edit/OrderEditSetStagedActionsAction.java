 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("setStagedActions")
...
public interface OrderEditSetStagedActionsAction extends OrderEditUpdateAction {
    ...
    public OrderEditSetStagedActionsAction copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderEditSetStagedActionsAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderEditSetStagedActionsAction>() {
            @Override
