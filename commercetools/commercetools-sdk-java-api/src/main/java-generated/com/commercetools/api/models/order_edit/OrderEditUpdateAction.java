...
public interface OrderEditUpdateAction extends com.commercetools.api.models.ResourceUpdateAction<OrderEditUpdateAction> {
    ...
    public static OrderEditUpdateAction deepCopy(@Nullable final OrderEditUpdateAction template) {
        ...
        if (template instanceof com.commercetools.api.models.order_edit.OrderEditAddStagedActionAction) {
            return com.commercetools.api.models.order_edit.OrderEditAddStagedActionAction.deepCopy((com.commercetools.api.models.order_edit.OrderEditAddStagedActionAction)template);
        }
        if (template instanceof com.commercetools.api.models.order_edit.OrderEditSetCommentAction) {
            return com.commercetools.api.models.order_edit.OrderEditSetCommentAction.deepCopy((com.commercetools.api.models.order_edit.OrderEditSetCommentAction)template);
        }
        if (template instanceof com.commercetools.api.models.order_edit.OrderEditSetCustomFieldAction) {
            return com.commercetools.api.models.order_edit.OrderEditSetCustomFieldAction.deepCopy((com.commercetools.api.models.order_edit.OrderEditSetCustomFieldAction)template);
        }
        if (template instanceof com.commercetools.api.models.order_edit.OrderEditSetCustomTypeAction) {
            return com.commercetools.api.models.order_edit.OrderEditSetCustomTypeAction.deepCopy((com.commercetools.api.models.order_edit.OrderEditSetCustomTypeAction)template);
        }
        if (template instanceof com.commercetools.api.models.order_edit.OrderEditSetKeyAction) {
            return com.commercetools.api.models.order_edit.OrderEditSetKeyAction.deepCopy((com.commercetools.api.models.order_edit.OrderEditSetKeyAction)template);
        }
        if (template instanceof com.commercetools.api.models.order_edit.OrderEditSetStagedActionsAction) {
            return com.commercetools.api.models.order_edit.OrderEditSetStagedActionsAction.deepCopy((com.commercetools.api.models.order_edit.OrderEditSetStagedActionsAction)template);
        }
