...
public interface OrderEditUpdateAction
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderEditUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderEditUpdateAction>() {
            @Override
