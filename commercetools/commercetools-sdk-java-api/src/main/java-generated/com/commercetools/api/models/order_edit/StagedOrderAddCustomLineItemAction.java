...
public interface StagedOrderAddCustomLineItemAction extends StagedOrderUpdateAction, com.commercetools.api.models.CustomizableDraft<StagedOrderAddCustomLineItemAction> {
     ...
     */
    @Nullable
    public static StagedOrderAddCustomLineItemAction deepCopy(@Nullable final StagedOrderAddCustomLineItemAction template) {
        if (template == null) {
            return null;
        }
        StagedOrderAddCustomLineItemActionImpl instance = new StagedOrderAddCustomLineItemActionImpl();
