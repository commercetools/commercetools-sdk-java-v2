...
public class StagedOrderAddDeliveryActionImpl implements StagedOrderAddDeliveryAction, ModelBase {
     ...
     */
    @JsonCreator
    StagedOrderAddDeliveryActionImpl(@JsonProperty("deliveryKey") final String deliveryKey, @JsonProperty("items") final java.util.List<com.commercetools.api.models.order.DeliveryItem> items, @JsonProperty("address") final com.commercetools.api.models.common.BaseAddress address, @JsonProperty("parcels") final java.util.List<com.commercetools.api.models.order.ParcelDraft> parcels, @JsonProperty("custom") final com.commercetools.api.models.type.CustomFieldsDraft custom) {
