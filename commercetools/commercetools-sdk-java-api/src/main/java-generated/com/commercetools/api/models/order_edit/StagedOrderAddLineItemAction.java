...
public interface StagedOrderAddLineItemAction
    ...
    /**
     *  <p><code>id</code> of the <a href="https://docs.commercetools.com/apis/ctp:api:type:ProductVariant" rel="nofollow">ProductVariant</a> in the Product. If omitted, the Master Variant is used.</p>
     *  <p>Either the <code>productId</code> and <code>variantId</code>, or <code>sku</code> must be provided.</p>
     * @return variantId
     */
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedOrderAddLineItemAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedOrderAddLineItemAction>() {
            @Override
