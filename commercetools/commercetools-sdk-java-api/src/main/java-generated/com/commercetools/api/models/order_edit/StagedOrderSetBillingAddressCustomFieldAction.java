...
import com.commercetools.api.models.order_edit.StagedOrderSetBillingAddressCustomFieldActionImpl;
...
public interface StagedOrderSetBillingAddressCustomFieldAction extends StagedOrderUpdateAction {
     ...
     */
    public static StagedOrderSetBillingAddressCustomFieldAction of(final StagedOrderSetBillingAddressCustomFieldAction template) {
     ...
     */
    @Nullable
    public static StagedOrderSetBillingAddressCustomFieldAction deepCopy(@Nullable final StagedOrderSetBillingAddressCustomFieldAction template) {
        if (template == null) {
            return null;
        }
        StagedOrderSetBillingAddressCustomFieldActionImpl instance = new StagedOrderSetBillingAddressCustomFieldActionImpl();
     ...
     * @return builder
     */
    public static StagedOrderSetBillingAddressCustomFieldActionBuilder builder(final StagedOrderSetBillingAddressCustomFieldAction template) {
     ...
     * @return mapped value
     */
    default <T> T withStagedOrderSetBillingAddressCustomFieldAction(Function<StagedOrderSetBillingAddressCustomFieldAction, T> helper) {
