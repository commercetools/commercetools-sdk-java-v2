...
public interface StagedOrderSetCustomFieldAction extends StagedOrderUpdateAction {
    ...
    public StagedOrderSetCustomFieldAction copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedOrderSetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedOrderSetCustomFieldAction>() {
            @Override
