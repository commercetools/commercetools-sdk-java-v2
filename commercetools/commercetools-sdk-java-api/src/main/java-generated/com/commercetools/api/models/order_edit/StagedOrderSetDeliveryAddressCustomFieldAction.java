 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("setDeliveryAddressCustomField")
...
public interface StagedOrderSetDeliveryAddressCustomFieldAction extends StagedOrderUpdateAction {
     ...
     */
    @Nullable
    public static StagedOrderSetDeliveryAddressCustomFieldAction deepCopy(
            @Nullable final StagedOrderSetDeliveryAddressCustomFieldAction template) {
        if (template == null) {
            return null;
        }
        StagedOrderSetDeliveryAddressCustomFieldActionImpl instance = new StagedOrderSetDeliveryAddressCustomFieldActionImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedOrderSetDeliveryAddressCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedOrderSetDeliveryAddressCustomFieldAction>() {
            @Override
