...
import com.commercetools.api.models.order_edit.StagedOrderSetDeliveryCustomFieldActionImpl;
...
public interface StagedOrderSetDeliveryCustomFieldAction extends StagedOrderUpdateAction {
     ...
     */
    @Nullable
    public static StagedOrderSetDeliveryCustomFieldAction deepCopy(@Nullable final StagedOrderSetDeliveryCustomFieldAction template) {
        if (template == null) {
            return null;
        }
        StagedOrderSetDeliveryCustomFieldActionImpl instance = new StagedOrderSetDeliveryCustomFieldActionImpl();
     ...
     * @return builder
     */
    public static StagedOrderSetDeliveryCustomFieldActionBuilder builder(final StagedOrderSetDeliveryCustomFieldAction template) {
     ...
     * @return mapped value
     */
    default <T> T withStagedOrderSetDeliveryCustomFieldAction(Function<StagedOrderSetDeliveryCustomFieldAction, T> helper) {
