...
import com.commercetools.api.models.order_edit.StagedOrderSetDeliveryCustomTypeActionImpl;
...
public interface StagedOrderSetDeliveryCustomTypeAction extends StagedOrderUpdateAction {
     ...
     */
    @Nullable
    public static StagedOrderSetDeliveryCustomTypeAction deepCopy(@Nullable final StagedOrderSetDeliveryCustomTypeAction template) {
        if (template == null) {
            return null;
        }
        StagedOrderSetDeliveryCustomTypeActionImpl instance = new StagedOrderSetDeliveryCustomTypeActionImpl();
     ...
     * @return builder
     */
    public static StagedOrderSetDeliveryCustomTypeActionBuilder builder(final StagedOrderSetDeliveryCustomTypeAction template) {
     ...
     * @return mapped value
     */
    default <T> T withStagedOrderSetDeliveryCustomTypeAction(Function<StagedOrderSetDeliveryCustomTypeAction, T> helper) {
