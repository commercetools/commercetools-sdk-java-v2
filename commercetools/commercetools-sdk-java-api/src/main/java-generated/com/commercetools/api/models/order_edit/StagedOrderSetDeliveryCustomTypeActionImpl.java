...
public class StagedOrderSetDeliveryCustomTypeActionImpl implements StagedOrderSetDeliveryCustomTypeAction, ModelBase {
     ...
     */
    public StagedOrderSetDeliveryCustomTypeActionImpl() {
        this.action = SET_DELIVERY_CUSTOM_TYPE;
    }
    ...
    public StagedOrderSetDeliveryCustomTypeAction copyDeep() {
        return StagedOrderSetDeliveryCustomTypeAction.deepCopy(this);
    }
}
