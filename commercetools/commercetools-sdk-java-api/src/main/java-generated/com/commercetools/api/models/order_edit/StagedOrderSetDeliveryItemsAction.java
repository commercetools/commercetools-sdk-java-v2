 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("setDeliveryItems")
...
public interface StagedOrderSetDeliveryItemsAction extends StagedOrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedOrderSetDeliveryItemsAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedOrderSetDeliveryItemsAction>() {
            @Override
