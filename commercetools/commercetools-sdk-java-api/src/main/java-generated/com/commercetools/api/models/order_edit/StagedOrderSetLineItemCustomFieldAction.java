...
public interface StagedOrderSetLineItemCustomFieldAction extends StagedOrderUpdateAction {
    ...
    public StagedOrderSetLineItemCustomFieldAction copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedOrderSetLineItemCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedOrderSetLineItemCustomFieldAction>() {
            @Override
