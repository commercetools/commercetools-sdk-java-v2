...
public interface StagedOrderSetLineItemPriceAction extends StagedOrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedOrderSetLineItemPriceAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedOrderSetLineItemPriceAction>() {
            @Override
