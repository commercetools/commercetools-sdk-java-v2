...
public final class StagedOrderSetLineItemShippingDetailsActionImpl
        implements StagedOrderSetLineItemShippingDetailsAction {
    ...
    StagedOrderSetLineItemShippingDetailsActionImpl(@JsonProperty("lineItemId") final String lineItemId,
        ...
        this.action = StagedOrderSetLineItemShippingDetailsAction.SET_LINE_ITEM_SHIPPING_DETAILS;
    }
