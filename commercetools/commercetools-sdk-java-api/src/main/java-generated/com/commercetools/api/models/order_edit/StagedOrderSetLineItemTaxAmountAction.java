...
public interface StagedOrderSetLineItemTaxAmountAction extends StagedOrderUpdateAction {
    ...
    public StagedOrderSetLineItemTaxAmountAction copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedOrderSetLineItemTaxAmountAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedOrderSetLineItemTaxAmountAction>() {
            @Override
