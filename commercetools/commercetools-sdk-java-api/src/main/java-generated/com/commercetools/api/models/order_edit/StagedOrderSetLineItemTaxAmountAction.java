...
public interface StagedOrderSetLineItemTaxAmountAction extends StagedOrderUpdateAction {
     ...
     */
    @Nullable
    public static StagedOrderSetLineItemTaxAmountAction deepCopy(@Nullable final StagedOrderSetLineItemTaxAmountAction template) {
        if (template == null) {
            return null;
        }
        StagedOrderSetLineItemTaxAmountActionImpl instance = new StagedOrderSetLineItemTaxAmountActionImpl();
     ...
     * @return builder
     */
    public static StagedOrderSetLineItemTaxAmountActionBuilder builder(final StagedOrderSetLineItemTaxAmountAction template) {
