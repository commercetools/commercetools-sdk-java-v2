...
public class StagedOrderSetParcelCustomTypeActionImpl implements StagedOrderSetParcelCustomTypeAction, ModelBase {
     ...
     */
    @JsonCreator
    StagedOrderSetParcelCustomTypeActionImpl(@JsonProperty("parcelId") final String parcelId, @JsonProperty("type") final com.commercetools.api.models.type.TypeResourceIdentifier type, @JsonProperty("fields") final com.commercetools.api.models.type.FieldContainer fields) {
