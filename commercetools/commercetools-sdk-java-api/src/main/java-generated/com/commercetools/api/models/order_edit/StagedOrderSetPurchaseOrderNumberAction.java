...
/**
 *  <p>Produces the <a href="https://docs.commercetools.com/apis/ctp:api:type:OrderPurchaseOrderNumberSetMessage" rel="nofollow">PurchaseOrderNumberSet</a> Message.</p>
 *
 * <hr>
...
public interface StagedOrderSetPurchaseOrderNumberAction extends StagedOrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedOrderSetPurchaseOrderNumberAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedOrderSetPurchaseOrderNumberAction>() {
            @Override
