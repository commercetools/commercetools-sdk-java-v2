...
public class StagedOrderSetReturnItemCustomTypeActionImpl implements StagedOrderSetReturnItemCustomTypeAction, ModelBase {
     ...
     */
    @JsonCreator
    StagedOrderSetReturnItemCustomTypeActionImpl(@JsonProperty("returnItemId") final String returnItemId, @JsonProperty("type") final com.commercetools.api.models.type.TypeResourceIdentifier type, @JsonProperty("fields") final com.commercetools.api.models.type.FieldContainer fields) {
