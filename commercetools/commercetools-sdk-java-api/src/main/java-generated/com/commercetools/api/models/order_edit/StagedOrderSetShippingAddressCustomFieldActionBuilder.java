...
public class StagedOrderSetShippingAddressCustomFieldActionBuilder implements Builder<StagedOrderSetShippingAddressCustomFieldAction> {
     ...
     * @return builder
     */
    public static StagedOrderSetShippingAddressCustomFieldActionBuilder of(final StagedOrderSetShippingAddressCustomFieldAction template) {
