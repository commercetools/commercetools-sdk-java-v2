...
public interface StagedOrderSetShippingCustomFieldAction extends StagedOrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedOrderSetShippingCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedOrderSetShippingCustomFieldAction>() {
            @Override
