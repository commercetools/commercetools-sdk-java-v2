...
public interface StagedOrderTransitionStateAction extends StagedOrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedOrderTransitionStateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedOrderTransitionStateAction>() {
            @Override
