...
public interface Payment extends BaseResource, PaymentMixin, com.commercetools.api.models.DomainResource<Payment>, com.commercetools.api.models.Referencable<Payment>, com.commercetools.api.models.ResourceIdentifiable<Payment>, com.commercetools.api.models.Customizable<Payment>, com.commercetools.api.models.WithKey {
    ...
    public static Payment deepCopy(@Nullable final Payment template) {
        ...
        instance.setAmountAuthorized(com.commercetools.api.models.common.TypedMoney.deepCopy(template.getAmountAuthorized()));
        instance.setAuthorizedUntil(template.getAuthorizedUntil());
        instance.setAmountPaid(com.commercetools.api.models.common.TypedMoney.deepCopy(template.getAmountPaid()));
        instance.setAmountRefunded(com.commercetools.api.models.common.TypedMoney.deepCopy(template.getAmountRefunded()));
        ...
        instance.setPaymentStatus(com.commercetools.api.models.payment.PaymentStatus.deepCopy(template.getPaymentStatus()));
        ...
        instance.setInterfaceInteractions(Optional.ofNullable(template.getInterfaceInteractions())
                .map(t -> t.stream().map(com.commercetools.api.models.type.CustomFields::deepCopy).collect(Collectors.toList()))
                .orElse(null));
