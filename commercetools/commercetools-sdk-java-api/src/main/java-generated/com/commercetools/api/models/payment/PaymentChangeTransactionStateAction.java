...
public interface PaymentChangeTransactionStateAction extends PaymentUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentChangeTransactionStateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentChangeTransactionStateAction>() {
            @Override
