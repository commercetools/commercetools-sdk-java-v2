...
public interface PaymentMethodInfoDraft extends io.vrap.rmf.base.client.Draft<PaymentMethodInfoDraft> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodInfoDraft> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodInfoDraft>() {
            @Override
