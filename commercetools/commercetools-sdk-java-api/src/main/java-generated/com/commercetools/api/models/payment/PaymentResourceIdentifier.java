...
/**
 *  <p><a href="https://docs.commercetools.com/apis/ctp:api:type:ResourceIdentifier" rel="nofollow">ResourceIdentifier</a> of a <a href="https://docs.commercetools.com/apis/ctp:api:type:Payment" rel="nofollow">Payment</a>. Either <code>id</code> or <code>key</code> is required. If both are set, an <span>InvalidJsonInput</span> error is returned.</p>
 *
 * <hr>
...
public interface PaymentResourceIdentifier
    ...
    /**
     *  <p>Unique identifier of the referenced <a href="https://docs.commercetools.com/apis/ctp:api:type:Payment" rel="nofollow">Payment</a>. Required if <code>key</code> is absent.</p>
     * @return id
     */
    ...
    /**
     *  <p>User-defined unique identifier of the referenced <a href="https://docs.commercetools.com/apis/ctp:api:type:Payment" rel="nofollow">Payment</a>. Required if <code>id</code> is absent.</p>
     * @return key
     */
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentResourceIdentifier> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentResourceIdentifier>() {
            @Override
