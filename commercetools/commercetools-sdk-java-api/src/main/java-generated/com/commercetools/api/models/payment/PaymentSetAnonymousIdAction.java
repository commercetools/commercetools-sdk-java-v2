...
public interface PaymentSetAnonymousIdAction extends PaymentUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentSetAnonymousIdAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentSetAnonymousIdAction>() {
            @Override
