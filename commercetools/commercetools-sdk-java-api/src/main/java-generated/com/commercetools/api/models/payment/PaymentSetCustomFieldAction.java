...
public interface PaymentSetCustomFieldAction extends PaymentUpdateAction {
    ...
    /**
     * factory method to create a shallow copy PaymentSetCustomFieldAction
    ...
    public PaymentSetCustomFieldAction copyDeep();
     ...
     */
    @Nullable
    public static PaymentSetCustomFieldAction deepCopy(@Nullable final PaymentSetCustomFieldAction template) {
        if (template == null) {
            return null;
        }
        PaymentSetCustomFieldActionImpl instance = new PaymentSetCustomFieldActionImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentSetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentSetCustomFieldAction>() {
            @Override
