...
public class PaymentSetCustomFieldActionImpl implements PaymentSetCustomFieldAction, ModelBase {
     ...
     */
    @JsonCreator
    PaymentSetCustomFieldActionImpl(@JsonProperty("name") final String name,
    ...
    public PaymentSetCustomFieldAction copyDeep() {
        return PaymentSetCustomFieldAction.deepCopy(this);
    }
}
