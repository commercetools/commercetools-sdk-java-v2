...
public interface PaymentSetMethodInfoCustomFieldAction extends PaymentUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentSetMethodInfoCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentSetMethodInfoCustomFieldAction>() {
            @Override
