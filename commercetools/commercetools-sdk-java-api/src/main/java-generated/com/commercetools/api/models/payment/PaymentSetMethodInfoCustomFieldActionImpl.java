...
public class PaymentSetMethodInfoCustomFieldActionImpl implements PaymentSetMethodInfoCustomFieldAction, ModelBase {
     ...
     */
    @JsonCreator
    PaymentSetMethodInfoCustomFieldActionImpl(@JsonProperty("name") final String name,
     ...
     */
    public PaymentSetMethodInfoCustomFieldActionImpl() {
        this.action = SET_METHOD_INFO_CUSTOM_FIELD;
    }
    ...
    public boolean equals(Object o) {
        ...
        PaymentSetMethodInfoCustomFieldActionImpl that = (PaymentSetMethodInfoCustomFieldActionImpl) o;
    ...
    public PaymentSetMethodInfoCustomFieldAction copyDeep() {
        return PaymentSetMethodInfoCustomFieldAction.deepCopy(this);
    }
}
