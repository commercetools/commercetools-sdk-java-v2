...
public interface PaymentSetMethodInfoInterfaceAccountAction extends PaymentUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentSetMethodInfoInterfaceAccountAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentSetMethodInfoInterfaceAccountAction>() {
            @Override
