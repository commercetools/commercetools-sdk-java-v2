...
public interface PaymentSetTransactionInterfaceIdAction extends PaymentUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentSetTransactionInterfaceIdAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentSetTransactionInterfaceIdAction>() {
            @Override
