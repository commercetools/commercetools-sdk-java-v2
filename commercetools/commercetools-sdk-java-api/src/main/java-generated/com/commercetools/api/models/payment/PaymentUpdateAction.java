...
public interface PaymentUpdateAction extends com.commercetools.api.models.ResourceUpdateAction<PaymentUpdateAction> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentUpdateAction>() {
            @Override
