...
public class PaymentUpdateBuilder implements Builder<PaymentUpdate> {
    ...
    public PaymentUpdateBuilder plusActions(Function<com.commercetools.api.models.payment.PaymentUpdateActionBuilder, Builder<? extends com.commercetools.api.models.payment.PaymentUpdateAction>> builder) {
        if (this.actions == null) {
            this.actions = new ArrayList<>();
        }
    ...
    public PaymentUpdateBuilder withActions(Function<com.commercetools.api.models.payment.PaymentUpdateActionBuilder, Builder<? extends com.commercetools.api.models.payment.PaymentUpdateAction>> builder) {
        this.actions = new ArrayList<>();
        this.actions.add(builder.apply(com.commercetools.api.models.payment.PaymentUpdateActionBuilder.of()).build());
        return this;
    }
