...
public interface PaymentMethodPagedQueryResponse {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodPagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodPagedQueryResponse>() {
            @Override
