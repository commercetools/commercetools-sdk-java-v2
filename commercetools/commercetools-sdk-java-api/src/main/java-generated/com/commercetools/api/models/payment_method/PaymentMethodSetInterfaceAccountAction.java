...
public interface PaymentMethodSetInterfaceAccountAction extends PaymentMethodUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodSetInterfaceAccountAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodSetInterfaceAccountAction>() {
            @Override
