...
public interface PaymentMethodSetMethodAction extends PaymentMethodUpdateAction {
    ...
    /**
     *  <p>New payment method—for example, a credit card or direct debit. If omitted, any existing value is removed.</p>
     * @return method
     */
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodSetMethodAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodSetMethodAction>() {
            @Override
