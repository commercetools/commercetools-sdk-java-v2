...
public interface PaymentMethodSetNameAction extends PaymentMethodUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodSetNameAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodSetNameAction>() {
            @Override
