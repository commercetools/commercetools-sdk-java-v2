...
public interface PaymentMethodToken {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodToken> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodToken>() {
            @Override
