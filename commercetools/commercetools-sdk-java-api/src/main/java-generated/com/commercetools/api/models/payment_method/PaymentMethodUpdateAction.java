...
public interface PaymentMethodUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentMethodUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentMethodUpdateAction>() {
            @Override
