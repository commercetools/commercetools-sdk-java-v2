...
public interface ProductChangeAssetNameAction extends ProductUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductChangeAssetNameAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductChangeAssetNameAction>() {
            @Override
