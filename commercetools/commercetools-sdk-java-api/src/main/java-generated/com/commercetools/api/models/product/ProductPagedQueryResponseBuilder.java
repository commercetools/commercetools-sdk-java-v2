...
public class ProductPagedQueryResponseBuilder implements Builder<ProductPagedQueryResponse> {
    ...
    public ProductPagedQueryResponseBuilder results( final java.util.List<com.commercetools.api.models.product.Product> results) {
    ...
    public ProductPagedQueryResponseBuilder plusResults(Function<com.commercetools.api.models.product.ProductBuilder, com.commercetools.api.models.product.ProductBuilder> builder) {
        if (this.results == null) {
            this.results = new ArrayList<>();
        }
    ...
    public ProductPagedQueryResponseBuilder withResults(Function<com.commercetools.api.models.product.ProductBuilder, com.commercetools.api.models.product.ProductBuilder> builder) {
        this.results = new ArrayList<>();
        this.results.add(builder.apply(com.commercetools.api.models.product.ProductBuilder.of()).build());
        return this;
    }
    ...
    public ProductPagedQueryResponseBuilder addResults(Function<com.commercetools.api.models.product.ProductBuilder, com.commercetools.api.models.product.Product> builder) {
    ...
    public ProductPagedQueryResponseBuilder setResults(Function<com.commercetools.api.models.product.ProductBuilder, com.commercetools.api.models.product.Product> builder) {
