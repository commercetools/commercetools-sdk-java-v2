...
public class ProductRemovePriceActionImpl implements ProductRemovePriceAction, ModelBase {
     ...
     */
    @JsonCreator
    ProductRemovePriceActionImpl(@JsonProperty("priceId") final String priceId, @JsonProperty("sku") final String sku, @JsonProperty("variantId") final Long variantId, @JsonProperty("price") final com.commercetools.api.models.common.PriceDraft price, @JsonProperty("staged") final Boolean staged) {
