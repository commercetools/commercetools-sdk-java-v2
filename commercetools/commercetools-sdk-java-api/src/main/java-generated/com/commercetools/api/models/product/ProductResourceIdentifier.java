...
public interface ProductResourceIdentifier
    ...
    public ProductResourceIdentifier copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductResourceIdentifier> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductResourceIdentifier>() {
            @Override
