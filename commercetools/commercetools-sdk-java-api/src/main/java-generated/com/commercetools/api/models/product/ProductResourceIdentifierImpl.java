...
/**
 *  <p>ResourceIdentifier to a Product. Either <code>id</code> or <code>key</code> is required. If both are set, an InvalidJsonInput error is returned.</p>
 */
...
public class ProductResourceIdentifierImpl implements ProductResourceIdentifier, ModelBase {
    ...
    public ProductResourceIdentifier copyDeep() {
        return ProductResourceIdentifier.deepCopy(this);
    }
}
