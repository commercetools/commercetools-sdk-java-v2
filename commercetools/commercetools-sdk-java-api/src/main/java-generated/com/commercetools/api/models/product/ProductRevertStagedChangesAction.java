...
public interface ProductRevertStagedChangesAction extends ProductUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductRevertStagedChangesAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductRevertStagedChangesAction>() {
            @Override
