 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("revertStagedVariantChanges")
...
public interface ProductRevertStagedVariantChangesAction extends ProductUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductRevertStagedVariantChangesAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductRevertStagedVariantChangesAction>() {
            @Override
