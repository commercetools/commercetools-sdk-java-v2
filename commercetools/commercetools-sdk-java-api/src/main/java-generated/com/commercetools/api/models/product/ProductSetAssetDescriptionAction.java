...
public interface ProductSetAssetDescriptionAction extends ProductUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductSetAssetDescriptionAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductSetAssetDescriptionAction>() {
            @Override
