...
public interface ProductSetAssetSourcesAction extends ProductUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductSetAssetSourcesAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductSetAssetSourcesAction>() {
            @Override
