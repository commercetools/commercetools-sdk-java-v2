...
public interface ProductSetMetaKeywordsAction extends ProductUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductSetMetaKeywordsAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductSetMetaKeywordsAction>() {
            @Override
