...
public interface ProductSetMetaTitleAction extends ProductUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductSetMetaTitleAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductSetMetaTitleAction>() {
            @Override
