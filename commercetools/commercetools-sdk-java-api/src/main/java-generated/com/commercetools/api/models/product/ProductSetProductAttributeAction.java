...
public interface ProductSetProductAttributeAction extends ProductUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductSetProductAttributeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductSetProductAttributeAction>() {
            @Override
