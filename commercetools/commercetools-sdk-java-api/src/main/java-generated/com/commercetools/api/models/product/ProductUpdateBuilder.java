...
public class ProductUpdateBuilder implements Builder<ProductUpdate> {
    ...
    public ProductUpdateBuilder plusActions(Function<com.commercetools.api.models.product.ProductUpdateActionBuilder, Builder<? extends com.commercetools.api.models.product.ProductUpdateAction>> builder) {
        if (this.actions == null) {
            this.actions = new ArrayList<>();
        }
    ...
    public ProductUpdateBuilder withActions(Function<com.commercetools.api.models.product.ProductUpdateActionBuilder, Builder<? extends com.commercetools.api.models.product.ProductUpdateAction>> builder) {
        this.actions = new ArrayList<>();
        this.actions.add(builder.apply(com.commercetools.api.models.product.ProductUpdateActionBuilder.of()).build());
        return this;
    }
