...
public class ProductVariantAvailabilityImpl implements ProductVariantAvailability, ModelBase {
     ...
     */
    @JsonCreator
    ProductVariantAvailabilityImpl(@JsonProperty("channels") final com.commercetools.api.models.product.ProductVariantChannelAvailabilityMap channels, @JsonProperty("isOnStock") final Boolean isOnStock, @JsonProperty("restockableInDays") final Long restockableInDays, @JsonProperty("availableQuantity") final Long availableQuantity) {
