...
public class SearchKeywordBuilder implements Builder<SearchKeyword> {
    ...
    public SearchKeywordBuilder suggestTokenizer(@Nullable final com.commercetools.api.models.product.SuggestTokenizer suggestTokenizer) {
    ...
    public SearchKeywordBuilder suggestTokenizer(Function<com.commercetools.api.models.product.SuggestTokenizerBuilder, Builder<? extends com.commercetools.api.models.product.SuggestTokenizer>> builder) {
        this.suggestTokenizer = builder.apply(com.commercetools.api.models.product.SuggestTokenizerBuilder.of()).build();
        return this;
    }
