...
public interface ProductDiscountChangeIsActiveAction extends ProductDiscountUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductDiscountChangeIsActiveAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductDiscountChangeIsActiveAction>() {
            @Override
