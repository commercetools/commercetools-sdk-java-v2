...
public interface ProductDiscountChangeValueAction extends ProductDiscountUpdateAction {
    ...
    /**
     * factory method to create a shallow copy ProductDiscountChangeValueAction
     ...
     */
    @Nullable
    public static ProductDiscountChangeValueAction deepCopy(@Nullable final ProductDiscountChangeValueAction template) {
        if (template == null) {
            return null;
        }
        ProductDiscountChangeValueActionImpl instance = new ProductDiscountChangeValueActionImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductDiscountChangeValueAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductDiscountChangeValueAction>() {
            @Override
