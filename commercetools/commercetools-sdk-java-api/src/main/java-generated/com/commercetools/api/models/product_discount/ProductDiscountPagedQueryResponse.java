...
public interface ProductDiscountPagedQueryResponse extends com.commercetools.api.models.ResourcePagedQueryResponse<ProductDiscount> {
     ...
     */
    @Nullable
    public static ProductDiscountPagedQueryResponse deepCopy(@Nullable final ProductDiscountPagedQueryResponse template) {
        if (template == null) {
            return null;
        }
        ProductDiscountPagedQueryResponseImpl instance = new ProductDiscountPagedQueryResponseImpl();
        ...
        instance.setResults(Optional.ofNullable(template.getResults())
                .map(t -> t.stream().map(com.commercetools.api.models.product_discount.ProductDiscount::deepCopy).collect(Collectors.toList()))
                .orElse(null));
        return instance;
    }
