...
public interface ProductDiscountSetValidUntilAction extends ProductDiscountUpdateAction {
    ...
    /**
     *  <p>Value to set. If omitted, any existing value is removed. Take <span>Eventual Consistency</span> into account for calculated undiscounted values.</p>
     * @return validUntil
     */
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductDiscountSetValidUntilAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductDiscountSetValidUntilAction>() {
            @Override
