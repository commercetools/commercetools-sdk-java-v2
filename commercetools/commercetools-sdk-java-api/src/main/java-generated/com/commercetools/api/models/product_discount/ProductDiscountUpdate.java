...
public interface ProductDiscountUpdate extends
    ...
    public static ProductDiscountUpdate deepCopy(@Nullable final ProductDiscountUpdate template) {
        ...
        instance.setActions(Optional.ofNullable(template.getActions())
                .map(t -> t.stream()
                        .map(com.commercetools.api.models.product_discount.ProductDiscountUpdateAction::deepCopy)
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductDiscountUpdate> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductDiscountUpdate>() {
            @Override
