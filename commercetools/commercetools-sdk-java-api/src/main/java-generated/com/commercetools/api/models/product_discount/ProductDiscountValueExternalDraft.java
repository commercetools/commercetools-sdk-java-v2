...
public interface ProductDiscountValueExternalDraft
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductDiscountValueExternalDraft> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductDiscountValueExternalDraft>() {
            @Override
