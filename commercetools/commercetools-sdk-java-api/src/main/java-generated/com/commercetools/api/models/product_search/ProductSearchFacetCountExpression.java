...
public interface ProductSearchFacetCountExpression extends ProductSearchFacetExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductSearchFacetCountExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductSearchFacetCountExpression>() {
            @Override
