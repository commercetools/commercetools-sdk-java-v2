...
public interface ProductSearchFacetDistinctExpression extends ProductSearchFacetExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductSearchFacetDistinctExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductSearchFacetDistinctExpression>() {
            @Override
