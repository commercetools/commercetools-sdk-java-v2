...
public class ProductSearchFacetRangesValueBuilder implements Builder<ProductSearchFacetRangesValue> {
    ...
    public ProductSearchFacetRangesValueBuilder count(
    ...
    public ProductSearchFacetRangesValueBuilder attributeType(
    ...
    public ProductSearchFacetRangesValue build() {
        ...
        return new ProductSearchFacetRangesValueImpl(name, scope, filter, count, field, ranges, language,
            attributeType);
    }
