...
public interface ProductSearchFacetResultBucketEntry {
    ...
    public ProductSearchFacetResultBucketEntry copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductSearchFacetResultBucketEntry> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductSearchFacetResultBucketEntry>() {
            @Override
