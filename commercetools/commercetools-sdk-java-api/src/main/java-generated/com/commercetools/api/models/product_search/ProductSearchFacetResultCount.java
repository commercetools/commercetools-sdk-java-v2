...
public interface ProductSearchFacetResultCount extends ProductSearchFacetResult {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductSearchFacetResultCount> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductSearchFacetResultCount>() {
            @Override
