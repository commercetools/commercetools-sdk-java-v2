...
public interface ProductSearchFacetStatsExpression extends ProductSearchFacetExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductSearchFacetStatsExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductSearchFacetStatsExpression>() {
            @Override
