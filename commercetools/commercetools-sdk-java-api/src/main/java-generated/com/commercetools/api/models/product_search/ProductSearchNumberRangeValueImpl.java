...
public class ProductSearchNumberRangeValueImpl implements ProductSearchNumberRangeValue, ModelBase {
     ...
     */
    @JsonCreator
    ProductSearchNumberRangeValueImpl(@JsonProperty("field") final String field,
            ...
            @JsonProperty("gte") final Double gte, @JsonProperty("gt") final Double gt,
            @JsonProperty("lte") final Double lte, @JsonProperty("lt") final Double lt) {
        this.field = field;
        this.boost = boost;
     ...
     */
    public ProductSearchNumberRangeValueImpl() {
    }
    ...
    public boolean equals(Object o) {
        ...
        ProductSearchNumberRangeValueImpl that = (ProductSearchNumberRangeValueImpl) o;
