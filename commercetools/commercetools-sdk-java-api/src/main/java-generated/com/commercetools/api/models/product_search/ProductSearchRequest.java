...
public interface ProductSearchRequest {
    ...
    public void setQuery(final ProductSearchQuery query);
    ...
    public void setPostFilter(final ProductSearchQuery postFilter);
    ...
    @JsonIgnore
    public void setSort(final ProductSearchSorting... sort);
    ...
    public void setSort(final List<ProductSearchSorting> sort);
    ...
    public void setProjection(final ProductSearchProjectionParams projection);
    ...
    public static ProductSearchRequest of(final ProductSearchRequest template) {
        ...
        instance.setProjection(template.getProjection());
    ...
    public static ProductSearchRequest deepCopy(@Nullable final ProductSearchRequest template) {
        ...
        ProductSearchRequestImpl instance = new ProductSearchRequestImpl();
        instance.setQuery(com.commercetools.api.models.product_search.ProductSearchQuery.deepCopy(template.getQuery()));
        instance.setPostFilter(
            com.commercetools.api.models.product_search.ProductSearchQuery.deepCopy(template.getPostFilter()));
        instance.setSort(Optional.ofNullable(template.getSort())
                .map(t -> t.stream()
                        .map(com.commercetools.api.models.product_search.ProductSearchSorting::deepCopy)
                        .collect(Collectors.toList()))
                .orElse(null));
        instance.setLimit(template.getLimit());
        instance.setOffset(template.getOffset());
        instance.setMarkMatchingVariants(template.getMarkMatchingVariants());
        instance.setProjection(com.commercetools.api.models.product_search.ProductSearchProjectionParams
                .deepCopy(template.getProjection()));
