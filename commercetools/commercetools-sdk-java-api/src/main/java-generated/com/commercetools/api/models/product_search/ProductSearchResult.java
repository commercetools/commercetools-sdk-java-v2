...
public interface ProductSearchResult {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductSearchResult> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductSearchResult>() {
            @Override
