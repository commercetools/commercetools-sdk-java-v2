...
public class ProductSelectionAddProductActionImpl implements ProductSelectionAddProductAction, ModelBase {
     ...
     */
    @JsonCreator
    ProductSelectionAddProductActionImpl(@JsonProperty("product") final com.commercetools.api.models.product.ProductResourceIdentifier product, @JsonProperty("variantSelection") final com.commercetools.api.models.product_selection.ProductVariantSelection variantSelection) {
