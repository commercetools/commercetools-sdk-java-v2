...
public interface ProductSelectionChangeNameAction extends ProductSelectionUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductSelectionChangeNameAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductSelectionChangeNameAction>() {
            @Override
