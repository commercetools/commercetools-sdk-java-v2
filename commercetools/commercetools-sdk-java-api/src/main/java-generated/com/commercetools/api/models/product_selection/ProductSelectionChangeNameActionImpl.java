...
public class ProductSelectionChangeNameActionImpl implements ProductSelectionChangeNameAction, ModelBase {
     ...
     */
    @JsonCreator
    ProductSelectionChangeNameActionImpl(@JsonProperty("name") final com.commercetools.api.models.common.LocalizedString name) {
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        ProductSelectionChangeNameActionImpl that = (ProductSelectionChangeNameActionImpl) o;
