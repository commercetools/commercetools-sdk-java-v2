...
public interface ProductSelectionPagedQueryResponse
     ...
     */
    @Nullable
    public static ProductSelectionPagedQueryResponse deepCopy(
            @Nullable final ProductSelectionPagedQueryResponse template) {
        if (template == null) {
            return null;
        }
        ProductSelectionPagedQueryResponseImpl instance = new ProductSelectionPagedQueryResponseImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductSelectionPagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductSelectionPagedQueryResponse>() {
            @Override
