...
public class ProductSelectionReferenceImpl implements ProductSelectionReference, ModelBase {
     ...
     */
    @JsonCreator
    ProductSelectionReferenceImpl(@JsonProperty("id") final String id, @JsonProperty("obj") final com.commercetools.api.models.product_selection.ProductSelection obj) {
        this.id = id;
        this.obj = obj;
