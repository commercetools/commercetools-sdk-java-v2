 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("removeProduct")
...
public interface ProductSelectionRemoveProductAction extends ProductSelectionUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductSelectionRemoveProductAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductSelectionRemoveProductAction>() {
            @Override
