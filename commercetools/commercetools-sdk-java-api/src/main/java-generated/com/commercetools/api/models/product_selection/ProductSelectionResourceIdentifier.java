...
public interface ProductSelectionResourceIdentifier extends ResourceIdentifier, com.commercetools.api.models.Identifiable<ProductSelection> {
     ...
     */
    @Nullable
    public static ProductSelectionResourceIdentifier deepCopy(@Nullable final ProductSelectionResourceIdentifier template) {
        if (template == null) {
            return null;
        }
        ProductSelectionResourceIdentifierImpl instance = new ProductSelectionResourceIdentifierImpl();
