...
/**
 *  <p>ResourceIdentifier to a ProductSelection. Either <code>id</code> or <code>key</code> is required. If both are set, an InvalidJsonInput error is returned.</p>
 */
...
public class ProductSelectionResourceIdentifierImpl implements ProductSelectionResourceIdentifier, ModelBase {
    ...
    /**
     *  <p>Unique identifier of the referenced ProductSelection. Required if <code>key</code> is absent.</p>
     */
    ...
    /**
     *  <p>User-defined unique identifier of the referenced ProductSelection. Required if <code>id</code> is absent.</p>
     */
