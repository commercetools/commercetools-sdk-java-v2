...
import com.commercetools.api.models.product_selection.ProductSelectionSetCustomFieldActionImpl;
...
public interface ProductSelectionSetCustomFieldAction extends ProductSelectionUpdateAction {
     ...
     */
    @Nullable
    public static ProductSelectionSetCustomFieldAction deepCopy(@Nullable final ProductSelectionSetCustomFieldAction template) {
        if (template == null) {
            return null;
        }
        ProductSelectionSetCustomFieldActionImpl instance = new ProductSelectionSetCustomFieldActionImpl();
     ...
     * @return builder
     */
    public static ProductSelectionSetCustomFieldActionBuilder builder(final ProductSelectionSetCustomFieldAction template) {
