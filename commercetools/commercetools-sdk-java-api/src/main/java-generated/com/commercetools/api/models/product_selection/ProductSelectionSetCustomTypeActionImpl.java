...
public class ProductSelectionSetCustomTypeActionImpl implements ProductSelectionSetCustomTypeAction, ModelBase {
     ...
     */
    @JsonCreator
    ProductSelectionSetCustomTypeActionImpl(@JsonProperty("type") final com.commercetools.api.models.type.TypeResourceIdentifier type, @JsonProperty("fields") final com.commercetools.api.models.type.FieldContainer fields) {
        this.type = type;
        this.fields = fields;
