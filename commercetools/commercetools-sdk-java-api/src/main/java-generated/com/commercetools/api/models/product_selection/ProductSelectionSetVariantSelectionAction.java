...
import com.commercetools.api.models.product_selection.ProductSelectionSetVariantSelectionActionImpl;
...
public interface ProductSelectionSetVariantSelectionAction extends ProductSelectionUpdateAction {
     ...
     */
    public static ProductSelectionSetVariantSelectionAction of(final ProductSelectionSetVariantSelectionAction template) {
     ...
     */
    @Nullable
    public static ProductSelectionSetVariantSelectionAction deepCopy(@Nullable final ProductSelectionSetVariantSelectionAction template) {
        if (template == null) {
            return null;
        }
        ProductSelectionSetVariantSelectionActionImpl instance = new ProductSelectionSetVariantSelectionActionImpl();
     ...
     * @return builder
     */
    public static ProductSelectionSetVariantSelectionActionBuilder builder(final ProductSelectionSetVariantSelectionAction template) {
     ...
     * @return mapped value
     */
    default <T> T withProductSelectionSetVariantSelectionAction(Function<ProductSelectionSetVariantSelectionAction, T> helper) {
