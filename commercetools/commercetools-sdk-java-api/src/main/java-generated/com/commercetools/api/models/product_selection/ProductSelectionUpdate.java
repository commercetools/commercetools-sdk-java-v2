...
public interface ProductSelectionUpdate extends
    ...
    public static ProductSelectionUpdate deepCopy(@Nullable final ProductSelectionUpdate template) {
        ...
        instance.setActions(Optional.ofNullable(template.getActions())
                .map(t -> t.stream()
                        .map(com.commercetools.api.models.product_selection.ProductSelectionUpdateAction::deepCopy)
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductSelectionUpdate> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductSelectionUpdate>() {
            @Override
