...
public class ProductSelectionUpdateBuilder implements Builder<ProductSelectionUpdate> {
    ...
    public ProductSelectionUpdateBuilder actions( final com.commercetools.api.models.product_selection.ProductSelectionUpdateAction ...actions) {
    ...
    public ProductSelectionUpdateBuilder actions( final java.util.List<com.commercetools.api.models.product_selection.ProductSelectionUpdateAction> actions) {
    ...
    public ProductSelectionUpdateBuilder plusActions( final com.commercetools.api.models.product_selection.ProductSelectionUpdateAction ...actions) {
    ...
    public ProductSelectionUpdateBuilder plusActions(Function<com.commercetools.api.models.product_selection.ProductSelectionUpdateActionBuilder, Builder<? extends com.commercetools.api.models.product_selection.ProductSelectionUpdateAction>> builder) {
        if (this.actions == null) {
            this.actions = new ArrayList<>();
        }
        this.actions.add(builder.apply(com.commercetools.api.models.product_selection.ProductSelectionUpdateActionBuilder.of()).build());
        return this;
    }
    ...
    public ProductSelectionUpdateBuilder withActions(Function<com.commercetools.api.models.product_selection.ProductSelectionUpdateActionBuilder, Builder<? extends com.commercetools.api.models.product_selection.ProductSelectionUpdateAction>> builder) {
        this.actions = new ArrayList<>();
        this.actions.add(builder.apply(com.commercetools.api.models.product_selection.ProductSelectionUpdateActionBuilder.of()).build());
        return this;
    }
