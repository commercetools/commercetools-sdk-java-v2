 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("includeAllExcept")
...
public interface ProductVariantSelectionIncludeAllExcept extends ProductVariantSelection {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductVariantSelectionIncludeAllExcept> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductVariantSelectionIncludeAllExcept>() {
            @Override
