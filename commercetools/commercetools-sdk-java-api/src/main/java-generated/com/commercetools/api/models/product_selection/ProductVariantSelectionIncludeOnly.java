...
public interface ProductVariantSelectionIncludeOnly extends ProductVariantSelection {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductVariantSelectionIncludeOnly> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductVariantSelectionIncludeOnly>() {
            @Override
