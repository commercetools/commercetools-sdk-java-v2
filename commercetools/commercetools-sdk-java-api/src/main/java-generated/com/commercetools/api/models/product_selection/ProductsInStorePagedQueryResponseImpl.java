...
/**
 *  <p><span>PagedQueryResult</span> containing an array of <a href="https://docs.commercetools.com/apis/ctp:api:type:ProductSelectionAssignment" rel="nofollow">ProductSelectionAssignment</a>.</p>
 */
...
public class ProductsInStorePagedQueryResponseImpl implements ProductsInStorePagedQueryResponse, ModelBase {
     ...
     */
    @JsonCreator
    ProductsInStorePagedQueryResponseImpl(@JsonProperty("limit") final Long limit,
            @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count,
            @JsonProperty("total") final Long total,
            @JsonProperty("results") final java.util.List<com.commercetools.api.models.product_selection.ProductSelectionAssignment> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
