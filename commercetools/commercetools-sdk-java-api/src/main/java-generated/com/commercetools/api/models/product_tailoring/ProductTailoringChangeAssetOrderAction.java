...
public interface ProductTailoringChangeAssetOrderAction extends ProductTailoringUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTailoringChangeAssetOrderAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTailoringChangeAssetOrderAction>() {
            @Override
