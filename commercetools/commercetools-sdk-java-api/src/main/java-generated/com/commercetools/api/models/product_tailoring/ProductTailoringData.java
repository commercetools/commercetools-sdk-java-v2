...
public interface ProductTailoringData {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTailoringData> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTailoringData>() {
            @Override
