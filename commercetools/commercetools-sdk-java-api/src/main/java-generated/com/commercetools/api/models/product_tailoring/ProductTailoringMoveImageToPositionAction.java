...
public interface ProductTailoringMoveImageToPositionAction extends ProductTailoringUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTailoringMoveImageToPositionAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTailoringMoveImageToPositionAction>() {
            @Override
