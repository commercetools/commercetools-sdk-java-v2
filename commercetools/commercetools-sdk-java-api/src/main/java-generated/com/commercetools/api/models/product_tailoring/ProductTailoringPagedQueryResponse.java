...
public interface ProductTailoringPagedQueryResponse {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTailoringPagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTailoringPagedQueryResponse>() {
            @Override
