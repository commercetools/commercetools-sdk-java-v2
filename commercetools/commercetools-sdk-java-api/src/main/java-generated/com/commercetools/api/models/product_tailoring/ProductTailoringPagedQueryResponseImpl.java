...
public class ProductTailoringPagedQueryResponseImpl implements ProductTailoringPagedQueryResponse, ModelBase {
     ...
     */
    @JsonCreator
    ProductTailoringPagedQueryResponseImpl(@JsonProperty("limit") final Long limit,
            @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count,
            @JsonProperty("total") final Long total,
            @JsonProperty("results") final java.util.List<com.commercetools.api.models.product_tailoring.ProductTailoring> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
     ...
     */
    public ProductTailoringPagedQueryResponseImpl() {
    }
    ...
    public void setResults(final com.commercetools.api.models.product_tailoring.ProductTailoring... results) {
    ...
    public boolean equals(Object o) {
        ...
        ProductTailoringPagedQueryResponseImpl that = (ProductTailoringPagedQueryResponseImpl) o;
