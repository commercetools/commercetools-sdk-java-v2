...
public interface ProductTailoringReference extends Reference {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTailoringReference> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTailoringReference>() {
            @Override
