...
public class ProductTailoringReferenceImpl implements ProductTailoringReference, ModelBase {
     ...
     */
    @JsonCreator
    ProductTailoringReferenceImpl(@JsonProperty("id") final String id,
            @JsonProperty("obj") final com.commercetools.api.models.product_tailoring.ProductTailoring obj) {
        this.id = id;
        this.obj = obj;
     ...
     */
    public ProductTailoringReferenceImpl() {
        this.typeId = ReferenceTypeId.findEnum("product-tailoring");
    }
    ...
    public void setObj(final com.commercetools.api.models.product_tailoring.ProductTailoring obj) {
        this.obj = obj;
    }
    ...
    public boolean equals(Object o) {
        ...
        ProductTailoringReferenceImpl that = (ProductTailoringReferenceImpl) o;
