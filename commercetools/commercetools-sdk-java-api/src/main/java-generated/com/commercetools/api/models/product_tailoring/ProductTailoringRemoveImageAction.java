...
public interface ProductTailoringRemoveImageAction extends ProductTailoringUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTailoringRemoveImageAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTailoringRemoveImageAction>() {
            @Override
