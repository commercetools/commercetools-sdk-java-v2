...
public interface ProductTailoringSetAssetKeyAction extends ProductTailoringUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTailoringSetAssetKeyAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTailoringSetAssetKeyAction>() {
            @Override
