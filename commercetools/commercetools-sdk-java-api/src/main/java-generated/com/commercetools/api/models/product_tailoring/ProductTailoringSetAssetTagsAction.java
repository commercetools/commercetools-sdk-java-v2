...
public interface ProductTailoringSetAssetTagsAction extends ProductTailoringUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTailoringSetAssetTagsAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTailoringSetAssetTagsAction>() {
            @Override
