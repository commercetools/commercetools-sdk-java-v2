...
public interface ProductTailoringSetAttributeAction extends ProductTailoringUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTailoringSetAttributeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTailoringSetAttributeAction>() {
            @Override
