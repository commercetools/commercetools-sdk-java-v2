...
public interface ProductTailoringSetImageLabelAction extends ProductTailoringUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTailoringSetImageLabelAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTailoringSetImageLabelAction>() {
            @Override
