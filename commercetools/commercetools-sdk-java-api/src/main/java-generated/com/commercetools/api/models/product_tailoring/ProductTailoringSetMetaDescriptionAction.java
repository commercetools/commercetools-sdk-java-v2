...
public interface ProductTailoringSetMetaDescriptionAction extends ProductTailoringUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTailoringSetMetaDescriptionAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTailoringSetMetaDescriptionAction>() {
            @Override
