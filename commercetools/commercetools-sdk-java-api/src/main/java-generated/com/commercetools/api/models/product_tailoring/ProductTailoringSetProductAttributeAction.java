...
public interface ProductTailoringSetProductAttributeAction extends ProductTailoringUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTailoringSetProductAttributeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTailoringSetProductAttributeAction>() {
            @Override
