...
/**
 *  <p>Attribute type for <a href="https://docs.commercetools.com/apis/ctp:api:type:Money" rel="nofollow">Money</a> type values.</p>
 *
 * <hr>
...
public interface AttributeMoneyType extends AttributeType {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AttributeMoneyType> typeReference() {
        return new tools.jackson.core.type.TypeReference<AttributeMoneyType>() {
            @Override
