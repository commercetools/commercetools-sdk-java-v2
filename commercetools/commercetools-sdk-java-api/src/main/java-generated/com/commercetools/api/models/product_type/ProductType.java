...
public interface ProductType extends BaseResource, AttributeDefinitionContainer, ProductTypeMixin, com.commercetools.api.models.DomainResource<ProductType>, com.commercetools.api.models.Referencable<ProductType>, com.commercetools.api.models.ResourceIdentifiable<ProductType>, com.commercetools.api.models.WithKey {
    ...
    public static ProductType deepCopy(@Nullable final ProductType template) {
        ...
        instance.setAttributes(Optional.ofNullable(template.getAttributes())
                .map(t -> t.stream().map(com.commercetools.api.models.product_type.AttributeDefinition::deepCopy).collect(Collectors.toList()))
                .orElse(null));
        return instance;
    }
