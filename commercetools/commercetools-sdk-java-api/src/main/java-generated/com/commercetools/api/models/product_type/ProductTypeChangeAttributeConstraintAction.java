...
/**
 *  <p>Updates the <code>attributeConstraint</code> of an <a href="https://docs.commercetools.com/apis/ctp:api:type:AttributeDefinition" rel="nofollow">AttributeDefinition</a>. For now only following changes are supported: <code>SameForAll</code> to <code>None</code> and <code>Unique</code> to <code>None</code>.</p>
 *
 * <hr>
...
public interface ProductTypeChangeAttributeConstraintAction extends ProductTypeUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTypeChangeAttributeConstraintAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTypeChangeAttributeConstraintAction>() {
            @Override
