...
public interface ProductTypeChangeDescriptionAction extends ProductTypeUpdateAction {
     ...
     */
    @Nullable
    public static ProductTypeChangeDescriptionAction deepCopy(
            @Nullable final ProductTypeChangeDescriptionAction template) {
        if (template == null) {
            return null;
        }
        ProductTypeChangeDescriptionActionImpl instance = new ProductTypeChangeDescriptionActionImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTypeChangeDescriptionAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTypeChangeDescriptionAction>() {
            @Override
