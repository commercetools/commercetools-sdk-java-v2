...
public interface ProductTypeChangeLabelAction extends ProductTypeUpdateAction {
     ...
     */
    @Nullable
    public static ProductTypeChangeLabelAction deepCopy(@Nullable final ProductTypeChangeLabelAction template) {
        if (template == null) {
            return null;
        }
        ProductTypeChangeLabelActionImpl instance = new ProductTypeChangeLabelActionImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTypeChangeLabelAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTypeChangeLabelAction>() {
            @Override
