...
public interface ProductTypeChangeNameAction extends ProductTypeUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTypeChangeNameAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTypeChangeNameAction>() {
            @Override
