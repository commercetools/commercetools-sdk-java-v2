...
public interface ProductTypeChangePlainEnumValueLabelAction extends ProductTypeUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTypeChangePlainEnumValueLabelAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTypeChangePlainEnumValueLabelAction>() {
            @Override
