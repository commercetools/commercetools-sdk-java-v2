...
public interface ProductTypeReference extends Reference, com.commercetools.api.models.Identifiable<ProductType>,
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTypeReference> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTypeReference>() {
            @Override
