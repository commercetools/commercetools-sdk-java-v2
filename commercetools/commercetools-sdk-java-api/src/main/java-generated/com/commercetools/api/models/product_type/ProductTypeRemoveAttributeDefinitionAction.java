...
/**
 *  <p>Removes an AttributeDefinition and also deletes all corresponding Attributes on all <span>Products</span> with this ProductType. Data from deleted Attributes cannot be recovered. The removal of the Attributes is <span>eventually consistent</span>.</p>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("removeAttributeDefinition")
...
public interface ProductTypeRemoveAttributeDefinitionAction extends ProductTypeUpdateAction {
    ...
    public ProductTypeRemoveAttributeDefinitionAction copyDeep();
