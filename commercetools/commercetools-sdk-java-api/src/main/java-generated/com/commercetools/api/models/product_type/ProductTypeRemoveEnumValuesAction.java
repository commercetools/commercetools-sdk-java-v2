...
public interface ProductTypeRemoveEnumValuesAction extends ProductTypeUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTypeRemoveEnumValuesAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTypeRemoveEnumValuesAction>() {
            @Override
