...
/**
 *  <p>ResourceIdentifier to a ProductType. Either <code>id</code> or <code>key</code> is required. If both are set, an InvalidJsonInput error is returned.</p>
 */
...
public class ProductTypeResourceIdentifierImpl implements ProductTypeResourceIdentifier, ModelBase {
    ...
    /**
     *  <p>Unique identifier of the referenced ProductType. Required if <code>key</code> is absent.</p>
     */
    ...
    /**
     *  <p>User-defined unique identifier of the referenced ProductType. Required if <code>id</code> is absent.</p>
     */
