...
public interface ProductTypeUpdate extends
    ...
    /**
     *  <p>Expected version of the ProductType on which the changes should be applied. If the expected version does not match the actual version, a <a href="https://docs.commercetools.com/apis/ctp:api:type:ConcurrentModificationError" rel="nofollow">ConcurrentModification</a> error will be returned.</p>
     * @return version
     */
    @NotNull
    ...
    public static ProductTypeUpdate deepCopy(@Nullable final ProductTypeUpdate template) {
        ...
        instance.setActions(Optional.ofNullable(template.getActions())
                .map(t -> t.stream()
                        .map(com.commercetools.api.models.product_type.ProductTypeUpdateAction::deepCopy)
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTypeUpdate> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTypeUpdate>() {
            @Override
