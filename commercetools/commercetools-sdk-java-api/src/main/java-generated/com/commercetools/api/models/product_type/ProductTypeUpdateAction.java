...
public interface ProductTypeUpdateAction
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTypeUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTypeUpdateAction>() {
            @Override
