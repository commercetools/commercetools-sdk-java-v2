...
public interface CartsConfiguration {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartsConfiguration> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartsConfiguration>() {
            @Override
