...
public final class CartsConfigurationImpl implements CartsConfiguration {
    ...
    @JsonCreator
    CartsConfigurationImpl(@JsonProperty("countryTaxRateFallbackEnabled") final Boolean countryTaxRateFallbackEnabled, @JsonProperty("deleteDaysAfterLastModification") final Long deleteDaysAfterLastModification) {
