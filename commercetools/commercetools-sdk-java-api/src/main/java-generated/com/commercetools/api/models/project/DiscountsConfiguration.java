...
public interface DiscountsConfiguration {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountsConfiguration> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountsConfiguration>() {
            @Override
