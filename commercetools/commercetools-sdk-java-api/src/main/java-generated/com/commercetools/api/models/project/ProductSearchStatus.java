...
public interface ProductSearchStatus extends JsonEnum {
    ...
    /**
    	<p>indicates that the <a href="/../api/projects/product-search#search-products">Search Products</a> endpoint is fully operational.</p>

    */
    ProductSearchStatus ACTIVATED = ProductSearchStatusEnum.ACTIVATED;
    /**
    	<p>indicates that the Product Search feature is currently not active, but can be activated by <a href="#change-product-search-status">update action</a>.</p>
