...
public interface Project extends com.commercetools.api.models.WithKey {
    ...
    public static Project deepCopy(@Nullable final Project template) {
        ...
        instance.setCreatedAt(template.getCreatedAt());
        instance.setTrialUntil(template.getTrialUntil());
        instance.setMessages(com.commercetools.api.models.message.MessagesConfiguration.deepCopy(template.getMessages()));
        instance.setCarts(com.commercetools.api.models.project.CartsConfiguration.deepCopy(template.getCarts()));
        instance.setShoppingLists(com.commercetools.api.models.project.ShoppingListsConfiguration.deepCopy(template.getShoppingLists()));
        ...
        instance.setSearchIndexing(com.commercetools.api.models.project.SearchIndexingConfiguration.deepCopy(template.getSearchIndexing()));
        instance.setBusinessUnits(com.commercetools.api.models.project.BusinessUnitConfiguration.deepCopy(template.getBusinessUnits()));
        return instance;
    }
