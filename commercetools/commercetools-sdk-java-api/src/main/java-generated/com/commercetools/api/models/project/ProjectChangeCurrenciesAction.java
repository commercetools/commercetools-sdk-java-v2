...
public interface ProjectChangeCurrenciesAction extends ProjectUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProjectChangeCurrenciesAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProjectChangeCurrenciesAction>() {
            @Override
