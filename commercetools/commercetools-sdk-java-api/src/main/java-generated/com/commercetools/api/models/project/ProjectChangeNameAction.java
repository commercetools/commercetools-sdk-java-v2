...
public interface ProjectChangeNameAction extends ProjectUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProjectChangeNameAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProjectChangeNameAction>() {
            @Override
