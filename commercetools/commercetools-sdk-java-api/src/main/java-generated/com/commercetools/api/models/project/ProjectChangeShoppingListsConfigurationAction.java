...
import com.commercetools.api.models.project.ProjectChangeShoppingListsConfigurationActionImpl;
...
public interface ProjectChangeShoppingListsConfigurationAction extends ProjectUpdateAction {
     ...
     */
    public static ProjectChangeShoppingListsConfigurationAction of(final ProjectChangeShoppingListsConfigurationAction template) {
     ...
     */
    @Nullable
    public static ProjectChangeShoppingListsConfigurationAction deepCopy(@Nullable final ProjectChangeShoppingListsConfigurationAction template) {
        if (template == null) {
            return null;
        }
        ProjectChangeShoppingListsConfigurationActionImpl instance = new ProjectChangeShoppingListsConfigurationActionImpl();
        instance.setShoppingListsConfiguration(com.commercetools.api.models.project.ShoppingListsConfiguration.deepCopy(template.getShoppingListsConfiguration()));
        return instance;
    }
     ...
     * @return builder
     */
    public static ProjectChangeShoppingListsConfigurationActionBuilder builder(final ProjectChangeShoppingListsConfigurationAction template) {
     ...
     * @return mapped value
     */
    default <T> T withProjectChangeShoppingListsConfigurationAction(Function<ProjectChangeShoppingListsConfigurationAction, T> helper) {
