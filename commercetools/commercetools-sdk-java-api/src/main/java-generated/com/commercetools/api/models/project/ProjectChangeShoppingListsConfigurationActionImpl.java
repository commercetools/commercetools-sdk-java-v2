...
public class ProjectChangeShoppingListsConfigurationActionImpl implements ProjectChangeShoppingListsConfigurationAction, ModelBase {
     ...
     */
    @JsonCreator
    ProjectChangeShoppingListsConfigurationActionImpl(@JsonProperty("shoppingListsConfiguration") final com.commercetools.api.models.project.ShoppingListsConfiguration shoppingListsConfiguration) {
    ...
    public void setShoppingListsConfiguration(final com.commercetools.api.models.project.ShoppingListsConfiguration shoppingListsConfiguration){
        this.shoppingListsConfiguration = shoppingListsConfiguration;
    }
    ...
    public int hashCode() {
        return new HashCodeBuilder(17, 37)
            .append(action)
            .append(shoppingListsConfiguration)
            .toHashCode();
    }
