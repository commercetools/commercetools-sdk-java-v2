...
public interface ProjectSetDiscountsConfigurationAction extends ProjectUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProjectSetDiscountsConfigurationAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProjectSetDiscountsConfigurationAction>() {
            @Override
