...
public interface ProjectSetReservationExpirationInMinutesAction extends ProjectUpdateAction {
     ...
     */
    public static com.fasterxml.jackson.core.type.TypeReference<ProjectSetReservationExpirationInMinutesAction> typeReference() {
        return new com.fasterxml.jackson.core.type.TypeReference<ProjectSetReservationExpirationInMinutesAction>() {
            @Override
