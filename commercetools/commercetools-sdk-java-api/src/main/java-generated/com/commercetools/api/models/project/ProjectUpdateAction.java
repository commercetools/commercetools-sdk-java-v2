...
@JsonSubTypes({
        @JsonSubTypes.Type(value = com.commercetools.api.models.project.ProjectChangeCartsConfigurationImpl.class, name = ProjectChangeCartsConfiguration.CHANGE_CARTS_CONFIGURATION),
        ...
        @JsonSubTypes.Type(value = com.commercetools.api.models.project.ProjectChangeShoppingListsConfigurationImpl.class, name = ProjectChangeShoppingListsConfiguration.CHANGE_SHOPPING_LISTS_CONFIGURATION),
