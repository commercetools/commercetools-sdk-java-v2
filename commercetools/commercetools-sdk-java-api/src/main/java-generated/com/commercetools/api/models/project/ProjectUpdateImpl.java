...
public class ProjectUpdateImpl implements ProjectUpdate, ModelBase {
    ...
    @JsonCreator
    ProjectUpdateImpl(@JsonProperty("version") final Long version,
            @JsonProperty("actions") final java.util.List<com.commercetools.api.models.project.ProjectUpdateAction> actions) {
    ...
    */
    ...
    public void setActions(final com.commercetools.api.models.project.ProjectUpdateAction... actions) {
    ...
    public boolean equals(Object o) {
        ...
        ProjectUpdateImpl that = (ProjectUpdateImpl) o;
