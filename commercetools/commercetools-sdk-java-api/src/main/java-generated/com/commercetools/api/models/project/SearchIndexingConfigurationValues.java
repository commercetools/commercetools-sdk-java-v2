...
public interface SearchIndexingConfigurationValues {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchIndexingConfigurationValues> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchIndexingConfigurationValues>() {
            @Override
