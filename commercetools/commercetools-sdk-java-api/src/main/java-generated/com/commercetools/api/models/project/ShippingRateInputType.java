...
public interface ShippingRateInputType {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingRateInputType> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingRateInputType>() {
            @Override
