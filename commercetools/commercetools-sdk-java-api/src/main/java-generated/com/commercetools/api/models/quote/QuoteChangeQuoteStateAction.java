...
public interface QuoteChangeQuoteStateAction extends QuoteUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<QuoteChangeQuoteStateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<QuoteChangeQuoteStateAction>() {
            @Override
