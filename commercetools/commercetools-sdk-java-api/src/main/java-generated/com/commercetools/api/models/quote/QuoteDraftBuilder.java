...
public class QuoteDraftBuilder implements Builder<QuoteDraft> {
    ...
    public QuoteDraftBuilder stagedQuote(Function<com.commercetools.api.models.staged_quote.StagedQuoteResourceIdentifierBuilder, com.commercetools.api.models.staged_quote.StagedQuoteResourceIdentifierBuilder> builder) {
        this.stagedQuote = builder.apply(com.commercetools.api.models.staged_quote.StagedQuoteResourceIdentifierBuilder.of()).build();
        return this;
    }
    ...
    public QuoteDraftBuilder withStagedQuote(Function<com.commercetools.api.models.staged_quote.StagedQuoteResourceIdentifierBuilder, com.commercetools.api.models.staged_quote.StagedQuoteResourceIdentifier> builder) {
        this.stagedQuote = builder.apply(com.commercetools.api.models.staged_quote.StagedQuoteResourceIdentifierBuilder.of());
        return this;
    }
    ...
    public QuoteDraftBuilder stagedQuote( final com.commercetools.api.models.staged_quote.StagedQuoteResourceIdentifier stagedQuote) {
    ...
    public QuoteDraftBuilder state(Function<com.commercetools.api.models.state.StateReferenceBuilder, com.commercetools.api.models.state.StateReferenceBuilder> builder) {
    ...
    public QuoteDraftBuilder withState(Function<com.commercetools.api.models.state.StateReferenceBuilder, com.commercetools.api.models.state.StateReference> builder) {
    ...
    public QuoteDraftBuilder custom(Function<com.commercetools.api.models.type.CustomFieldsDraftBuilder, com.commercetools.api.models.type.CustomFieldsDraftBuilder> builder) {
    ...
    public QuoteDraftBuilder withCustom(Function<com.commercetools.api.models.type.CustomFieldsDraftBuilder, com.commercetools.api.models.type.CustomFieldsDraft> builder) {
