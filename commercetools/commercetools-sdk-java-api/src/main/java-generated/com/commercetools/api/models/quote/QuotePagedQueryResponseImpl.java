...
/**
 *  <p><span>PagedQueryResult</span> with results containing an array of <a href="https://docs.commercetools.com/apis/ctp:api:type:Quote" rel="nofollow">Quote</a>.</p>
 */
...
public class QuotePagedQueryResponseImpl implements QuotePagedQueryResponse, ModelBase {
    ...
    QuotePagedQueryResponseImpl(@JsonProperty("limit") final Long limit, @JsonProperty("offset") final Long offset,
            ...
            @JsonProperty("results") final java.util.List<com.commercetools.api.models.quote.Quote> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
