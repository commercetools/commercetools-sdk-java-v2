...
public interface QuoteSetCustomFieldAction extends QuoteUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<QuoteSetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<QuoteSetCustomFieldAction>() {
            @Override
