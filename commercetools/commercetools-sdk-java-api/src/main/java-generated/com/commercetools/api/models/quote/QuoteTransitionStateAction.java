...
public interface QuoteTransitionStateAction extends QuoteUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<QuoteTransitionStateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<QuoteTransitionStateAction>() {
            @Override
