...
public class QuoteTransitionStateActionImpl implements QuoteTransitionStateAction, ModelBase {
     ...
     */
    @JsonCreator
    QuoteTransitionStateActionImpl(@JsonProperty("state") final com.commercetools.api.models.state.StateResourceIdentifier state, @JsonProperty("force") final Boolean force) {
        this.state = state;
        this.force = force;
