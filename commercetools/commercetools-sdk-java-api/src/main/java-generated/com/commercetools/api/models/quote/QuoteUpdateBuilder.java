...
public class QuoteUpdateBuilder implements Builder<QuoteUpdate> {
    ...
    public QuoteUpdateBuilder actions( final java.util.List<com.commercetools.api.models.quote.QuoteUpdateAction> actions) {
    ...
    public QuoteUpdateBuilder plusActions(Function<com.commercetools.api.models.quote.QuoteUpdateActionBuilder, Builder<? extends com.commercetools.api.models.quote.QuoteUpdateAction>> builder) {
        if (this.actions == null) {
            this.actions = new ArrayList<>();
        }
    ...
    public QuoteUpdateBuilder withActions(Function<com.commercetools.api.models.quote.QuoteUpdateActionBuilder, Builder<? extends com.commercetools.api.models.quote.QuoteUpdateAction>> builder) {
        this.actions = new ArrayList<>();
        this.actions.add(builder.apply(com.commercetools.api.models.quote.QuoteUpdateActionBuilder.of()).build());
        return this;
    }
