 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("changeQuoteRequestState")
...
public interface QuoteRequestChangeQuoteRequestStateAction extends QuoteRequestUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<QuoteRequestChangeQuoteRequestStateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<QuoteRequestChangeQuoteRequestStateAction>() {
            @Override
