...
public interface QuoteRequestPagedQueryResponse
    ...
    /**
     * factory method
     * @return instance of QuoteRequestPagedQueryResponse
     */
    ...
    /**
     * factory method to create a shallow copy QuoteRequestPagedQueryResponse
     ...
     */
    @Nullable
    public static QuoteRequestPagedQueryResponse deepCopy(@Nullable final QuoteRequestPagedQueryResponse template) {
        if (template == null) {
            return null;
        }
        QuoteRequestPagedQueryResponseImpl instance = new QuoteRequestPagedQueryResponseImpl();
    ...
    /**
     * builder factory method for QuoteRequestPagedQueryResponse
     * @return builder
     */
     ...
     */
    public static tools.jackson.core.type.TypeReference<QuoteRequestPagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<QuoteRequestPagedQueryResponse>() {
            @Override
