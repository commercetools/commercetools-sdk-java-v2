...
/**
 *  <p><span>PagedQueryResult</span> with results containing an array of <a href="https://docs.commercetools.com/apis/ctp:api:type:QuoteRequest" rel="nofollow">QuoteRequest</a>.</p>
 */
@Generated(value = "io.vrap.rmf.codegen.rendering.CoreCodeGenerator", comments = "https://github.com/commercetools/rmf-codegen")
public class QuoteRequestPagedQueryResponseImpl implements QuoteRequestPagedQueryResponse, ModelBase {
     ...
     */
    @JsonCreator
    QuoteRequestPagedQueryResponseImpl(@JsonProperty("limit") final Long limit,
            @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count,
            @JsonProperty("total") final Long total,
            @JsonProperty("results") final java.util.List<com.commercetools.api.models.quote_request.QuoteRequest> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
     ...
     */
    public QuoteRequestPagedQueryResponseImpl() {
    }
    ...
    public void setResults(final com.commercetools.api.models.quote_request.QuoteRequest... results) {
        this.results = new ArrayList<>(Arrays.asList(results));
    }

    public void setResults(final java.util.List<com.commercetools.api.models.quote_request.QuoteRequest> results) {
        this.results = results;
    }
    ...
    public boolean equals(Object o) {
        ...
        QuoteRequestPagedQueryResponseImpl that = (QuoteRequestPagedQueryResponseImpl) o;
