...
public interface QuoteRequestSetCustomFieldAction extends QuoteRequestUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<QuoteRequestSetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<QuoteRequestSetCustomFieldAction>() {
            @Override
