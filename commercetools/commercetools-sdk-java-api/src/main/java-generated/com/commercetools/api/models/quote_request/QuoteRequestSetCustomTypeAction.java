...
public interface QuoteRequestSetCustomTypeAction extends QuoteRequestUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<QuoteRequestSetCustomTypeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<QuoteRequestSetCustomTypeAction>() {
            @Override
