...
public interface QuoteRequestTransitionStateAction extends QuoteRequestUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<QuoteRequestTransitionStateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<QuoteRequestTransitionStateAction>() {
            @Override
