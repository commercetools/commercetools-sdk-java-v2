...
public class QuoteRequestTransitionStateActionImpl implements QuoteRequestTransitionStateAction, ModelBase {
     ...
     */
    @JsonCreator
    QuoteRequestTransitionStateActionImpl(@JsonProperty("state") final com.commercetools.api.models.state.StateResourceIdentifier state, @JsonProperty("force") final Boolean force) {
        this.state = state;
        this.force = force;
     ...
     */
    public QuoteRequestTransitionStateActionImpl() {
        this.action =  TRANSITION_STATE;
    }
    ...
    public boolean equals(Object o) {
        ...
        QuoteRequestTransitionStateActionImpl that = (QuoteRequestTransitionStateActionImpl) o;
