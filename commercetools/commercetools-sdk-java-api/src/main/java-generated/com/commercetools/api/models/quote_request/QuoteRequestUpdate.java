...
public interface QuoteRequestUpdate extends
     ...
     */
    public static tools.jackson.core.type.TypeReference<QuoteRequestUpdate> typeReference() {
        return new tools.jackson.core.type.TypeReference<QuoteRequestUpdate>() {
            @Override
