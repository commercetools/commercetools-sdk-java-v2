...
@JsonTypeInfo(
    ...
    property = "action",
    defaultImpl = QuoteRequestUpdateActionImpl.class,
    visible = true
)
...
public interface QuoteRequestUpdateAction extends com.commercetools.api.models.ResourceUpdateAction<QuoteRequestUpdateAction> {
    ...
    public static QuoteRequestUpdateAction deepCopy(@Nullable final QuoteRequestUpdateAction template) {
        ...
        if (template instanceof com.commercetools.api.models.quote_request.QuoteRequestChangeCustomerAction) {
            return com.commercetools.api.models.quote_request.QuoteRequestChangeCustomerAction.deepCopy((com.commercetools.api.models.quote_request.QuoteRequestChangeCustomerAction)template);
        }
        if (template instanceof com.commercetools.api.models.quote_request.QuoteRequestChangeQuoteRequestStateAction) {
            return com.commercetools.api.models.quote_request.QuoteRequestChangeQuoteRequestStateAction.deepCopy((com.commercetools.api.models.quote_request.QuoteRequestChangeQuoteRequestStateAction)template);
        }
        if (template instanceof com.commercetools.api.models.quote_request.QuoteRequestSetCustomFieldAction) {
            return com.commercetools.api.models.quote_request.QuoteRequestSetCustomFieldAction.deepCopy((com.commercetools.api.models.quote_request.QuoteRequestSetCustomFieldAction)template);
        }
        if (template instanceof com.commercetools.api.models.quote_request.QuoteRequestSetCustomTypeAction) {
            return com.commercetools.api.models.quote_request.QuoteRequestSetCustomTypeAction.deepCopy((com.commercetools.api.models.quote_request.QuoteRequestSetCustomTypeAction)template);
        }
        if (template instanceof com.commercetools.api.models.quote_request.QuoteRequestTransitionStateAction) {
            return com.commercetools.api.models.quote_request.QuoteRequestTransitionStateAction.deepCopy((com.commercetools.api.models.quote_request.QuoteRequestTransitionStateAction)template);
        }
