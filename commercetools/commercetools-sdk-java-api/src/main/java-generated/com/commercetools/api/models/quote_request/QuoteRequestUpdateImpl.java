...
public class QuoteRequestUpdateImpl implements QuoteRequestUpdate, ModelBase {
     ...
     */
    @JsonCreator
    QuoteRequestUpdateImpl(@JsonProperty("version") final Long version, @JsonProperty("actions") final java.util.List<com.commercetools.api.models.quote_request.QuoteRequestUpdateAction> actions) {
    ...
    public void setActions(final java.util.List<com.commercetools.api.models.quote_request.QuoteRequestUpdateAction> actions){
       this.actions = actions;
    }
