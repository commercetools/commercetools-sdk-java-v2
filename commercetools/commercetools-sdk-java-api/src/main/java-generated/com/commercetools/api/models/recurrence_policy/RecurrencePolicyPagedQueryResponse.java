...
public interface RecurrencePolicyPagedQueryResponse {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurrencePolicyPagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurrencePolicyPagedQueryResponse>() {
            @Override
