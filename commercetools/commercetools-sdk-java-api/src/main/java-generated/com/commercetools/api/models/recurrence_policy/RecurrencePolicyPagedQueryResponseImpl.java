...
/**
 *  <p><span>PagedQueryResult</span> with results containing an array of <a href="https://docs.commercetools.com/apis/ctp:api:type:RecurrencePolicy" rel="nofollow">RecurrencePolicy</a>.</p>
 */
@Generated(value = "io.vrap.rmf.codegen.rendering.CoreCodeGenerator", comments = "https://github.com/commercetools/rmf-codegen")
public class RecurrencePolicyPagedQueryResponseImpl implements RecurrencePolicyPagedQueryResponse, ModelBase {
     ...
     */
    @JsonCreator
    RecurrencePolicyPagedQueryResponseImpl(@JsonProperty("limit") final Long limit,
            @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count,
            @JsonProperty("total") final Long total,
            @JsonProperty("results") final java.util.List<com.commercetools.api.models.recurrence_policy.RecurrencePolicy> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
     ...
     */
    public RecurrencePolicyPagedQueryResponseImpl() {
    }
    ...
    /**
     *  <p><a href="https://docs.commercetools.com/apis/ctp:api:type:RecurrencePolicy" rel="nofollow">RecurrencePolicies</a> matching the query.</p>
     */
    ...
    public void setResults(final com.commercetools.api.models.recurrence_policy.RecurrencePolicy... results) {
    ...
    public boolean equals(Object o) {
        ...
        RecurrencePolicyPagedQueryResponseImpl that = (RecurrencePolicyPagedQueryResponseImpl) o;
    ...
    public RecurrencePolicyPagedQueryResponse copyDeep() {
        return RecurrencePolicyPagedQueryResponse.deepCopy(this);
    }
}
