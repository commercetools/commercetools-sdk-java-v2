...
public class RecurrencePolicyReferenceImpl implements RecurrencePolicyReference, ModelBase {
     ...
     */
    @JsonCreator
    RecurrencePolicyReferenceImpl(@JsonProperty("id") final String id,
            @JsonProperty("obj") final com.commercetools.api.models.recurrence_policy.RecurrencePolicy obj) {
        this.id = id;
        this.obj = obj;
     ...
     */
    public RecurrencePolicyReferenceImpl() {
        this.typeId = ReferenceTypeId.findEnum("recurrence-policy");
    }
    ...
    public void setObj(final com.commercetools.api.models.recurrence_policy.RecurrencePolicy obj) {
        this.obj = obj;
    }
    ...
    public boolean equals(Object o) {
        ...
        RecurrencePolicyReferenceImpl that = (RecurrencePolicyReferenceImpl) o;
    ...
    public RecurrencePolicyReference copyDeep() {
        return RecurrencePolicyReference.deepCopy(this);
    }
}
