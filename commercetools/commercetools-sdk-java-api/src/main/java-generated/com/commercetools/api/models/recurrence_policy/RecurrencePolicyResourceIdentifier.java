...
public interface RecurrencePolicyResourceIdentifier extends ResourceIdentifier {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurrencePolicyResourceIdentifier> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurrencePolicyResourceIdentifier>() {
            @Override
