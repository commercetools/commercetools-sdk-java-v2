...
public interface RecurrencePolicySchedule {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurrencePolicySchedule> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurrencePolicySchedule>() {
            @Override
