...
public interface RecurrencePolicyScheduleDraft {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurrencePolicyScheduleDraft> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurrencePolicyScheduleDraft>() {
            @Override
