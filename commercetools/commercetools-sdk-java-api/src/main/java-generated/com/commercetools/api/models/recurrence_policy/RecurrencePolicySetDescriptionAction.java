...
public interface RecurrencePolicySetDescriptionAction extends RecurrencePolicyUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurrencePolicySetDescriptionAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurrencePolicySetDescriptionAction>() {
            @Override
