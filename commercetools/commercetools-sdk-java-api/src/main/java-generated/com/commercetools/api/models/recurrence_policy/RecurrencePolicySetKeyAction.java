...
public interface RecurrencePolicySetKeyAction extends RecurrencePolicyUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurrencePolicySetKeyAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurrencePolicySetKeyAction>() {
            @Override
