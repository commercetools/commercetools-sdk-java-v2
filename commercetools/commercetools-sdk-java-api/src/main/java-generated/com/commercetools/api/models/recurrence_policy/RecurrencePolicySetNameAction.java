...
public interface RecurrencePolicySetNameAction extends RecurrencePolicyUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurrencePolicySetNameAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurrencePolicySetNameAction>() {
            @Override
