...
public interface RecurrencePolicySetScheduleAction extends RecurrencePolicyUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurrencePolicySetScheduleAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurrencePolicySetScheduleAction>() {
            @Override
