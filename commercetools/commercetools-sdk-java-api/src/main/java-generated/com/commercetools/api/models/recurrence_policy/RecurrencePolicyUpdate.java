...
public interface RecurrencePolicyUpdate {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurrencePolicyUpdate> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurrencePolicyUpdate>() {
            @Override
