...
public interface RecurrencePolicyUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurrencePolicyUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurrencePolicyUpdateAction>() {
            @Override
