...
public interface StandardScheduleDraft
     ...
     */
    public static tools.jackson.core.type.TypeReference<StandardScheduleDraft> typeReference() {
        return new tools.jackson.core.type.TypeReference<StandardScheduleDraft>() {
            @Override
