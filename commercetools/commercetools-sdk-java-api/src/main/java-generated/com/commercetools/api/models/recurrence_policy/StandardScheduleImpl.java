...
/**
 *  <p>Schedule of a RecurringOrder that occurs at a fixed interval—for example, every two weeks or every month.</p>
 */
...
public class StandardScheduleImpl implements StandardSchedule, ModelBase {
     ...
     */
    @JsonCreator
    StandardScheduleImpl(@JsonProperty("value") final Long value,
    ...
    public boolean equals(Object o) {
        ...
        StandardScheduleImpl that = (StandardScheduleImpl) o;
    ...
    public StandardSchedule copyDeep() {
        return StandardSchedule.deepCopy(this);
    }
}
