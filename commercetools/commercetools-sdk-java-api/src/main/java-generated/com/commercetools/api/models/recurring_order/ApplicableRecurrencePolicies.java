...
public interface ApplicableRecurrencePolicies extends RecurringOrderScope {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApplicableRecurrencePolicies> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApplicableRecurrencePolicies>() {
            @Override
