...
public interface NonRecurringOrdersOnly extends RecurringOrderScope {
     ...
     */
    public static tools.jackson.core.type.TypeReference<NonRecurringOrdersOnly> typeReference() {
        return new tools.jackson.core.type.TypeReference<NonRecurringOrdersOnly>() {
            @Override
