...
public interface NonRecurringOrdersOnlyDraft
     ...
     */
    public static tools.jackson.core.type.TypeReference<NonRecurringOrdersOnlyDraft> typeReference() {
        return new tools.jackson.core.type.TypeReference<NonRecurringOrdersOnlyDraft>() {
            @Override
