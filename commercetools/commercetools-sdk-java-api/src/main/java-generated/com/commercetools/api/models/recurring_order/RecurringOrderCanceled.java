...
public interface RecurringOrderCanceled extends RecurringOrderStateDraft {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrderCanceled> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrderCanceled>() {
            @Override
