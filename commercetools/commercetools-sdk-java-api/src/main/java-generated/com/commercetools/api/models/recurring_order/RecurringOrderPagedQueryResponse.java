...
public interface RecurringOrderPagedQueryResponse {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrderPagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrderPagedQueryResponse>() {
            @Override
