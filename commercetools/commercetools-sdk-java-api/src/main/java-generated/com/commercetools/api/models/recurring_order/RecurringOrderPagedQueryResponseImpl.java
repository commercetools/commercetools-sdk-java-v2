...
public class RecurringOrderPagedQueryResponseImpl implements RecurringOrderPagedQueryResponse, ModelBase {
     ...
     */
    @JsonCreator
    RecurringOrderPagedQueryResponseImpl(@JsonProperty("limit") final Long limit,
            @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count,
            @JsonProperty("total") final Long total,
            @JsonProperty("results") final java.util.List<com.commercetools.api.models.recurring_order.RecurringOrder> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
     ...
     */
    public RecurringOrderPagedQueryResponseImpl() {
    }
    ...
    public void setResults(final com.commercetools.api.models.recurring_order.RecurringOrder... results) {
        this.results = new ArrayList<>(Arrays.asList(results));
    }

    public void setResults(final java.util.List<com.commercetools.api.models.recurring_order.RecurringOrder> results) {
        this.results = results;
    }
    ...
    public boolean equals(Object o) {
        ...
        RecurringOrderPagedQueryResponseImpl that = (RecurringOrderPagedQueryResponseImpl) o;
    ...
    public RecurringOrderPagedQueryResponse copyDeep() {
        return RecurringOrderPagedQueryResponse.deepCopy(this);
    }
}
