...
public interface RecurringOrderPaused extends RecurringOrderStateDraft {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrderPaused> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrderPaused>() {
            @Override
