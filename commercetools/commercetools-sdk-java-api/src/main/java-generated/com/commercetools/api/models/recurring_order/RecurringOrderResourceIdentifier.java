...
public interface RecurringOrderResourceIdentifier extends ResourceIdentifier {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrderResourceIdentifier> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrderResourceIdentifier>() {
            @Override
