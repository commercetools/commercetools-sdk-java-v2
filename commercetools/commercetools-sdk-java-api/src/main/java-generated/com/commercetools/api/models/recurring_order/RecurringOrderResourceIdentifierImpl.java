...
public class RecurringOrderResourceIdentifierImpl implements RecurringOrderResourceIdentifier, ModelBase {
     ...
     */
    @JsonCreator
    RecurringOrderResourceIdentifierImpl(@JsonProperty("id") final String id, @JsonProperty("key") final String key) {
        this.id = id;
        this.key = key;
     ...
     */
    public RecurringOrderResourceIdentifierImpl() {
        this.typeId = ReferenceTypeId.findEnum("recurring-order");
    }
    ...
    public boolean equals(Object o) {
        ...
        RecurringOrderResourceIdentifierImpl that = (RecurringOrderResourceIdentifierImpl) o;
    ...
    public RecurringOrderResourceIdentifier copyDeep() {
        return RecurringOrderResourceIdentifier.deepCopy(this);
    }
}
