...
public interface RecurringOrderScopeDraft {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrderScopeDraft> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrderScopeDraft>() {
            @Override
