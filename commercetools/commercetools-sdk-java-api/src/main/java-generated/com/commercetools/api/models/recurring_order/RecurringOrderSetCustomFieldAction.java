...
public interface RecurringOrderSetCustomFieldAction extends RecurringOrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrderSetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrderSetCustomFieldAction>() {
            @Override
