...
public interface RecurringOrderSetKeyAction extends RecurringOrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrderSetKeyAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrderSetKeyAction>() {
            @Override
