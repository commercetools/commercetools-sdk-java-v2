...
public interface RecurringOrderSetOrderSkipConfigurationAction extends RecurringOrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrderSetOrderSkipConfigurationAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrderSetOrderSkipConfigurationAction>() {
            @Override
