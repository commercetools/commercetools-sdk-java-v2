...
public interface RecurringOrderSetStartsAtAction extends RecurringOrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrderSetStartsAtAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrderSetStartsAtAction>() {
            @Override
