...
public interface RecurringOrderSetStateAction extends RecurringOrderUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrderSetStateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrderSetStateAction>() {
            @Override
