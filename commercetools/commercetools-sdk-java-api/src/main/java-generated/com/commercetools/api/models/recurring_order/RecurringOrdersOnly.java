...
public interface RecurringOrdersOnly extends RecurringOrderScope {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrdersOnly> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrdersOnly>() {
            @Override
