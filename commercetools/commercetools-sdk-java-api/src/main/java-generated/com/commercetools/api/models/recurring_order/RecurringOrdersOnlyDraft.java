...
public interface RecurringOrdersOnlyDraft
     ...
     */
    public static tools.jackson.core.type.TypeReference<RecurringOrdersOnlyDraft> typeReference() {
        return new tools.jackson.core.type.TypeReference<RecurringOrdersOnlyDraft>() {
            @Override
