...
public interface SkipConfigurationDraft {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SkipConfigurationDraft> typeReference() {
        return new tools.jackson.core.type.TypeReference<SkipConfigurationDraft>() {
            @Override
