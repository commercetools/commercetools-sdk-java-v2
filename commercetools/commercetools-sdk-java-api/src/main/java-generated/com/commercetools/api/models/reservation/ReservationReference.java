...
public interface ReservationReference extends Reference {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ReservationReference> typeReference() {
        return new tools.jackson.core.type.TypeReference<ReservationReference>() {
            @Override
