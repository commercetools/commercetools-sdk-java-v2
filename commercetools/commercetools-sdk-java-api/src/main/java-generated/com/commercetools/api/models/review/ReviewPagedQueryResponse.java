...
public interface ReviewPagedQueryResponse extends com.commercetools.api.models.ResourcePagedQueryResponse<Review> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ReviewPagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<ReviewPagedQueryResponse>() {
            @Override
