...
public class ReviewPagedQueryResponseBuilder implements Builder<ReviewPagedQueryResponse> {
    ...
    public ReviewPagedQueryResponseBuilder results( final java.util.List<com.commercetools.api.models.review.Review> results) {
    ...
    public ReviewPagedQueryResponseBuilder plusResults(Function<com.commercetools.api.models.review.ReviewBuilder, com.commercetools.api.models.review.ReviewBuilder> builder) {
        if (this.results == null) {
            this.results = new ArrayList<>();
        }
    ...
    public ReviewPagedQueryResponseBuilder withResults(Function<com.commercetools.api.models.review.ReviewBuilder, com.commercetools.api.models.review.ReviewBuilder> builder) {
        this.results = new ArrayList<>();
        this.results.add(builder.apply(com.commercetools.api.models.review.ReviewBuilder.of()).build());
        return this;
    }
    ...
    public ReviewPagedQueryResponseBuilder addResults(Function<com.commercetools.api.models.review.ReviewBuilder, com.commercetools.api.models.review.Review> builder) {
    ...
    public ReviewPagedQueryResponseBuilder setResults(Function<com.commercetools.api.models.review.ReviewBuilder, com.commercetools.api.models.review.Review> builder) {
