...
public final class ReviewPagedQueryResponseImpl implements ReviewPagedQueryResponse {
    ...
    @JsonCreator
    ReviewPagedQueryResponseImpl(@JsonProperty("limit") final Long limit, @JsonProperty("count") final Long count, @JsonProperty("total") final Long total, @JsonProperty("offset") final Long offset, @JsonProperty("results") final java.util.List<com.commercetools.api.models.review.Review> results) {
        this.limit = limit;
        this.count = count;
        this.total = total;
        this.offset = offset;
