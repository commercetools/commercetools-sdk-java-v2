...
public interface ReviewResourceIdentifier
     ...
     */
    public static tools.jackson.core.type.TypeReference<ReviewResourceIdentifier> typeReference() {
        return new tools.jackson.core.type.TypeReference<ReviewResourceIdentifier>() {
            @Override
