...
public interface ReviewSetCustomFieldAction extends ReviewUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ReviewSetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ReviewSetCustomFieldAction>() {
            @Override
