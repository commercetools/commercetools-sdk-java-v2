...
public interface ReviewSetTitleAction extends ReviewUpdateAction {
    ...
    /**
     * factory method to create a shallow copy ReviewSetTitleAction
     ...
     */
    @Nullable
    public static ReviewSetTitleAction deepCopy(@Nullable final ReviewSetTitleAction template) {
        if (template == null) {
            return null;
        }
        ReviewSetTitleActionImpl instance = new ReviewSetTitleActionImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<ReviewSetTitleAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ReviewSetTitleAction>() {
            @Override
