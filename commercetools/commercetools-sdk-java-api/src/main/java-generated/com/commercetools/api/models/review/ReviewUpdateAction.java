...
public interface ReviewUpdateAction extends com.commercetools.api.models.ResourceUpdateAction<ReviewUpdateAction> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ReviewUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ReviewUpdateAction>() {
            @Override
