...
public interface SearchAndExpression extends SearchCompoundExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchAndExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchAndExpression>() {
            @Override
