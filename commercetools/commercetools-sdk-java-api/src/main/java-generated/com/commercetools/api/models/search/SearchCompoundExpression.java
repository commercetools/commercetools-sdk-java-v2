...
public interface SearchCompoundExpression extends SearchQuery {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchCompoundExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchCompoundExpression>() {
            @Override
