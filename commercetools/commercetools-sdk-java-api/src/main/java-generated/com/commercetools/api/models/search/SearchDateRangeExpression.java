...
public interface SearchDateRangeExpression extends SearchQueryExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchDateRangeExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchDateRangeExpression>() {
            @Override
