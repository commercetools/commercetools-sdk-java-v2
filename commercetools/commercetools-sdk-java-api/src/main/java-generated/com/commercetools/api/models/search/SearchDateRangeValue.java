...
public interface SearchDateRangeValue extends SearchQueryExpressionValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchDateRangeValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchDateRangeValue>() {
            @Override
