...
public interface SearchDateTimeRangeExpression extends SearchQueryExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchDateTimeRangeExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchDateTimeRangeExpression>() {
            @Override
