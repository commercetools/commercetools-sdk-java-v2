...
public interface SearchDateTimeRangeValue extends SearchQueryExpressionValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchDateTimeRangeValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchDateTimeRangeValue>() {
            @Override
