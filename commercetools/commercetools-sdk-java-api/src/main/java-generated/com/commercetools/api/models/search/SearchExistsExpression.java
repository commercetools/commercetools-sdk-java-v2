...
public interface SearchExistsExpression extends SearchQueryExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchExistsExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchExistsExpression>() {
            @Override
