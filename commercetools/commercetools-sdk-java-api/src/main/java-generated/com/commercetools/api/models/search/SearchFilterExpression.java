...
public interface SearchFilterExpression extends SearchCompoundExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchFilterExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchFilterExpression>() {
            @Override
