...
public interface SearchFullTextExpression extends SearchQueryExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchFullTextExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchFullTextExpression>() {
            @Override
