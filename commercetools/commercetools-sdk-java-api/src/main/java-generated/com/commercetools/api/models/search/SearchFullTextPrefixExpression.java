...
public interface SearchFullTextPrefixExpression extends SearchQueryExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchFullTextPrefixExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchFullTextPrefixExpression>() {
            @Override
