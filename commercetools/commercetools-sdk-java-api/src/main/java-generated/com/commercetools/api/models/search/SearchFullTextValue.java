...
public interface SearchFullTextValue extends SearchQueryExpressionValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchFullTextValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchFullTextValue>() {
            @Override
