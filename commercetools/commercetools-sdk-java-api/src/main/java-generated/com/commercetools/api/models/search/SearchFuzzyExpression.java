...
public interface SearchFuzzyExpression extends SearchQueryExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchFuzzyExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchFuzzyExpression>() {
            @Override
