...
public interface SearchLongRangeValue extends SearchQueryExpressionValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchLongRangeValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchLongRangeValue>() {
            @Override
