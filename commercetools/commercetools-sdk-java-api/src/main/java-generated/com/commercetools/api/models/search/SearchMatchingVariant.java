...
public interface SearchMatchingVariant {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchMatchingVariant> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchMatchingVariant>() {
            @Override
