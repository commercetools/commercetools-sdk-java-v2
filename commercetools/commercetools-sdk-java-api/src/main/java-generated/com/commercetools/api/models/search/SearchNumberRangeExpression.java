...
public interface SearchNumberRangeExpression extends SearchQueryExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchNumberRangeExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchNumberRangeExpression>() {
            @Override
