...
public interface SearchNumberRangeValue extends SearchQueryExpressionValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchNumberRangeValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchNumberRangeValue>() {
            @Override
