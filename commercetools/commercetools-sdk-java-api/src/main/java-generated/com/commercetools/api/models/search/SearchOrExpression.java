...
public interface SearchOrExpression extends SearchCompoundExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchOrExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchOrExpression>() {
            @Override
