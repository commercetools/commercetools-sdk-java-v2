...
public interface SearchPrefixExpression extends SearchQueryExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchPrefixExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchPrefixExpression>() {
            @Override
