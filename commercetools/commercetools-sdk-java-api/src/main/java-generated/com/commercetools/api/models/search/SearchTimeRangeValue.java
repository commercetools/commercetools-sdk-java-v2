...
public interface SearchTimeRangeValue extends SearchQueryExpressionValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchTimeRangeValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchTimeRangeValue>() {
            @Override
