...
public interface SearchWildCardExpression extends SearchQueryExpression {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SearchWildCardExpression> typeReference() {
        return new tools.jackson.core.type.TypeReference<SearchWildCardExpression>() {
            @Override
