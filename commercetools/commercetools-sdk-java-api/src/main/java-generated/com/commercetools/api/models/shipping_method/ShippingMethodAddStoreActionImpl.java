...
public class ShippingMethodAddStoreActionImpl implements ShippingMethodAddStoreAction, ModelBase {
     ...
     */
    @JsonCreator
    ShippingMethodAddStoreActionImpl(
     ...
     */
    public ShippingMethodAddStoreActionImpl() {
        this.action = ADD_STORE;
    }
    ...
    public boolean equals(Object o) {
        ...
        ShippingMethodAddStoreActionImpl that = (ShippingMethodAddStoreActionImpl) o;
    ...
    public ShippingMethodAddStoreAction copyDeep() {
        return ShippingMethodAddStoreAction.deepCopy(this);
    }
}
