 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("changeIsDefault")
...
public interface ShippingMethodChangeIsDefaultAction extends ShippingMethodUpdateAction {
     ...
     */
    @Nullable
    public static ShippingMethodChangeIsDefaultAction deepCopy(
            @Nullable final ShippingMethodChangeIsDefaultAction template) {
        if (template == null) {
            return null;
        }
        ShippingMethodChangeIsDefaultActionImpl instance = new ShippingMethodChangeIsDefaultActionImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodChangeIsDefaultAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodChangeIsDefaultAction>() {
            @Override
