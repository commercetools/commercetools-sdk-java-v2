...
public final class ShippingMethodPagedQueryResponseImpl implements ShippingMethodPagedQueryResponse {
    ...
    @JsonCreator
    ShippingMethodPagedQueryResponseImpl(@JsonProperty("limit") final Long limit, @JsonProperty("count") final Long count, @JsonProperty("total") final Long total, @JsonProperty("offset") final Long offset, @JsonProperty("results") final java.util.List<com.commercetools.api.models.shipping_method.ShippingMethod> results) {
        this.limit = limit;
        this.count = count;
        this.total = total;
        this.offset = offset;
