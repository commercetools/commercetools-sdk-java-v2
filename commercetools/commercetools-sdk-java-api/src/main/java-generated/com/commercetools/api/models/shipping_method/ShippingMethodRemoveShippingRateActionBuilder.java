...
public class ShippingMethodRemoveShippingRateActionBuilder implements Builder<ShippingMethodRemoveShippingRateAction> {
    ...
    public ShippingMethodRemoveShippingRateActionBuilder zone(Function<com.commercetools.api.models.zone.ZoneResourceIdentifierBuilder, com.commercetools.api.models.zone.ZoneResourceIdentifierBuilder> builder) {
    ...
    public ShippingMethodRemoveShippingRateActionBuilder withZone(Function<com.commercetools.api.models.zone.ZoneResourceIdentifierBuilder, com.commercetools.api.models.zone.ZoneResourceIdentifier> builder) {
    ...
    public ShippingMethodRemoveShippingRateActionBuilder shippingRate(Function<com.commercetools.api.models.shipping_method.ShippingRateDraftBuilder, com.commercetools.api.models.shipping_method.ShippingRateDraftBuilder> builder) {
    ...
    public ShippingMethodRemoveShippingRateActionBuilder withShippingRate(Function<com.commercetools.api.models.shipping_method.ShippingRateDraftBuilder, com.commercetools.api.models.shipping_method.ShippingRateDraft> builder) {
    ...
    public ShippingMethodRemoveShippingRateAction build() {
        ...
        Objects.requireNonNull(shippingRate, ShippingMethodRemoveShippingRateAction.class + ": shippingRate is missing");
