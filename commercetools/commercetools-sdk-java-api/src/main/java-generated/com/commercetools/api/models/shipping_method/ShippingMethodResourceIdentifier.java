...
public interface ShippingMethodResourceIdentifier
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodResourceIdentifier> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodResourceIdentifier>() {
            @Override
