...
/**
 *  <p>This action sets, overwrites, or removes any existing <span>Custom Field</span> for an existing ShippingMethod.</p>
 *
 * <hr>
...
public interface ShippingMethodSetCustomFieldAction extends ShippingMethodUpdateAction {
    ...
    public ShippingMethodSetCustomFieldAction copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodSetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodSetCustomFieldAction>() {
            @Override
