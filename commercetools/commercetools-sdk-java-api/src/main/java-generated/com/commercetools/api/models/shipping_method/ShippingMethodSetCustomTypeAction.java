...
public interface ShippingMethodSetCustomTypeAction extends ShippingMethodUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodSetCustomTypeAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodSetCustomTypeAction>() {
            @Override
