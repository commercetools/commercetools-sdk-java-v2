...
public interface ShippingMethodSetKeyAction extends ShippingMethodUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodSetKeyAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodSetKeyAction>() {
            @Override
