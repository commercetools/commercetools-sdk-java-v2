...
public class ZoneRateBuilder implements Builder<ZoneRate> {
    ...
    public ZoneRateBuilder zone(Function<com.commercetools.api.models.zone.ZoneReferenceBuilder, com.commercetools.api.models.zone.ZoneReferenceBuilder> builder) {
    ...
    public ZoneRateBuilder withZone(Function<com.commercetools.api.models.zone.ZoneReferenceBuilder, com.commercetools.api.models.zone.ZoneReference> builder) {
    ...
    public ZoneRateBuilder plusShippingRates( final com.commercetools.api.models.shipping_method.ShippingRate ...shippingRates) {
    ...
    public ZoneRateBuilder plusShippingRates(Function<com.commercetools.api.models.shipping_method.ShippingRateBuilder, com.commercetools.api.models.shipping_method.ShippingRateBuilder> builder) {
        if (this.shippingRates == null) {
            this.shippingRates = new ArrayList<>();
        }
        this.shippingRates.add(builder.apply(com.commercetools.api.models.shipping_method.ShippingRateBuilder.of()).build());
        return this;
    }
    ...
    public ZoneRateBuilder withShippingRates(Function<com.commercetools.api.models.shipping_method.ShippingRateBuilder, com.commercetools.api.models.shipping_method.ShippingRateBuilder> builder) {
        this.shippingRates = new ArrayList<>();
        this.shippingRates.add(builder.apply(com.commercetools.api.models.shipping_method.ShippingRateBuilder.of()).build());
        return this;
    }
    ...
    public ZoneRateBuilder addShippingRates(Function<com.commercetools.api.models.shipping_method.ShippingRateBuilder, com.commercetools.api.models.shipping_method.ShippingRate> builder) {
    ...
    public ZoneRateBuilder setShippingRates(Function<com.commercetools.api.models.shipping_method.ShippingRateBuilder, com.commercetools.api.models.shipping_method.ShippingRate> builder) {
