...
public interface ShoppingListChangeLineItemsOrderAction extends ShoppingListUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShoppingListChangeLineItemsOrderAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShoppingListChangeLineItemsOrderAction>() {
            @Override
