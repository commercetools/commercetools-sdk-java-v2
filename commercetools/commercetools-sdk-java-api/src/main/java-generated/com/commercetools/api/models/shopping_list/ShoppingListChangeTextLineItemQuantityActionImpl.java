...
public final class ShoppingListChangeTextLineItemQuantityActionImpl
        implements ShoppingListChangeTextLineItemQuantityAction {
    ...
    ShoppingListChangeTextLineItemQuantityActionImpl(@JsonProperty("textLineItemId") final String textLineItemId,
        ...
        this.action = ShoppingListChangeTextLineItemQuantityAction.CHANGE_TEXT_LINE_ITEM_QUANTITY;
    }
