...
public class ShoppingListLineItemDraftImpl implements ShoppingListLineItemDraft, ModelBase {
     ...
     */
    @JsonCreator
    ShoppingListLineItemDraftImpl(@JsonProperty("productId") final String productId, @JsonProperty("variantId") final Long variantId, @JsonProperty("sku") final String sku, @JsonProperty("addedAt") final java.time.ZonedDateTime addedAt, @JsonProperty("custom") final com.commercetools.api.models.type.CustomFieldsDraft custom, @JsonProperty("quantity") final Long quantity) {
