...
public interface ShoppingListPagedQueryResponse
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShoppingListPagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShoppingListPagedQueryResponse>() {
            @Override
