...
public class ShoppingListPagedQueryResponseBuilder implements Builder<ShoppingListPagedQueryResponse> {
    ...
    public ShoppingListPagedQueryResponseBuilder results( final com.commercetools.api.models.shopping_list.ShoppingList ...results) {
    ...
    public ShoppingListPagedQueryResponseBuilder plusResults( final com.commercetools.api.models.shopping_list.ShoppingList ...results) {
    ...
    public ShoppingListPagedQueryResponseBuilder plusResults(Function<com.commercetools.api.models.shopping_list.ShoppingListBuilder, com.commercetools.api.models.shopping_list.ShoppingListBuilder> builder) {
        if (this.results == null) {
            this.results = new ArrayList<>();
        }
    ...
    public ShoppingListPagedQueryResponseBuilder withResults(Function<com.commercetools.api.models.shopping_list.ShoppingListBuilder, com.commercetools.api.models.shopping_list.ShoppingListBuilder> builder) {
        this.results = new ArrayList<>();
        this.results.add(builder.apply(com.commercetools.api.models.shopping_list.ShoppingListBuilder.of()).build());
        return this;
    }
    ...
    public ShoppingListPagedQueryResponseBuilder addResults(Function<com.commercetools.api.models.shopping_list.ShoppingListBuilder, com.commercetools.api.models.shopping_list.ShoppingList> builder) {
    ...
    public ShoppingListPagedQueryResponseBuilder setResults(Function<com.commercetools.api.models.shopping_list.ShoppingListBuilder, com.commercetools.api.models.shopping_list.ShoppingList> builder) {
