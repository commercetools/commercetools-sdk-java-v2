...
public interface ShoppingListReference extends Reference, com.commercetools.api.models.Identifiable<ShoppingList>,
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShoppingListReference> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShoppingListReference>() {
            @Override
