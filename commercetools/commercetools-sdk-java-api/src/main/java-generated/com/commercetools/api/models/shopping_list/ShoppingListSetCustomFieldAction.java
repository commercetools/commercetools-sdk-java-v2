...
public interface ShoppingListSetCustomFieldAction extends ShoppingListUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShoppingListSetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShoppingListSetCustomFieldAction>() {
            @Override
