...
public interface ShoppingListSetKeyAction extends ShoppingListUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShoppingListSetKeyAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShoppingListSetKeyAction>() {
            @Override
