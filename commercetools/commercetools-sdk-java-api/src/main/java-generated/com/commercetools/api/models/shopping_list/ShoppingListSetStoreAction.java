...
public interface ShoppingListSetStoreAction extends ShoppingListUpdateAction {
    ...
    /**
     *  <p>The <a href="https://docs.commercetools.com/apis/ctp:api:type:Store" rel="nofollow">Store</a> the ShoppingList should be assigned to. If omitted, any existing value is removed.</p>
     * @return store
     */
    @Valid
    @JsonProperty("store")
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShoppingListSetStoreAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShoppingListSetStoreAction>() {
            @Override
