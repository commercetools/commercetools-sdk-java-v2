...
public interface ShoppingListUpdate extends
    ...
    public static ShoppingListUpdate deepCopy(@Nullable final ShoppingListUpdate template) {
        ...
        instance.setActions(Optional.ofNullable(template.getActions())
                .map(t -> t.stream()
                        .map(com.commercetools.api.models.shopping_list.ShoppingListUpdateAction::deepCopy)
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShoppingListUpdate> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShoppingListUpdate>() {
            @Override
