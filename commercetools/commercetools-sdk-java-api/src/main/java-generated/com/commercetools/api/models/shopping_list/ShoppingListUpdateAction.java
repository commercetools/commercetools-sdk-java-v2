...
public interface ShoppingListUpdateAction
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShoppingListUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShoppingListUpdateAction>() {
            @Override
