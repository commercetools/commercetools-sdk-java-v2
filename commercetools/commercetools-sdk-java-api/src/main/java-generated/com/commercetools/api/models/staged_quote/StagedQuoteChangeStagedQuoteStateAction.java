 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("changeStagedQuoteState")
...
public interface StagedQuoteChangeStagedQuoteStateAction extends StagedQuoteUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedQuoteChangeStagedQuoteStateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedQuoteChangeStagedQuoteStateAction>() {
            @Override
