...
import com.commercetools.api.models.staged_quote.StagedQuotePagedQueryResponse;
...
public class StagedQuotePagedQueryResponseBuilder implements Builder<StagedQuotePagedQueryResponse> {
    ...
    public StagedQuotePagedQueryResponseBuilder results( final com.commercetools.api.models.staged_quote.StagedQuote ...results) {
    ...
    public StagedQuotePagedQueryResponseBuilder results( final java.util.List<com.commercetools.api.models.staged_quote.StagedQuote> results) {
    ...
    public StagedQuotePagedQueryResponseBuilder plusResults( final com.commercetools.api.models.staged_quote.StagedQuote ...results) {
    ...
    public StagedQuotePagedQueryResponseBuilder plusResults(Function<com.commercetools.api.models.staged_quote.StagedQuoteBuilder, com.commercetools.api.models.staged_quote.StagedQuoteBuilder> builder) {
        if (this.results == null) {
            this.results = new ArrayList<>();
        }
    ...
    public StagedQuotePagedQueryResponseBuilder withResults(Function<com.commercetools.api.models.staged_quote.StagedQuoteBuilder, com.commercetools.api.models.staged_quote.StagedQuoteBuilder> builder) {
        this.results = new ArrayList<>();
        this.results.add(builder.apply(com.commercetools.api.models.staged_quote.StagedQuoteBuilder.of()).build());
        return this;
    }
    ...
    public StagedQuotePagedQueryResponseBuilder addResults(Function<com.commercetools.api.models.staged_quote.StagedQuoteBuilder, com.commercetools.api.models.staged_quote.StagedQuote> builder) {
    ...
    public StagedQuotePagedQueryResponseBuilder setResults(Function<com.commercetools.api.models.staged_quote.StagedQuoteBuilder, com.commercetools.api.models.staged_quote.StagedQuote> builder) {
