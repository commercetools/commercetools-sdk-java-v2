...
/**
 *  <p><span>PagedQueryResult</span> with results containing an array of <a href="https://docs.commercetools.com/apis/ctp:api:type:StagedQuote" rel="nofollow">StagedQuote</a>.</p>
 */
...
public class StagedQuotePagedQueryResponseImpl implements StagedQuotePagedQueryResponse, ModelBase {
    ...
    StagedQuotePagedQueryResponseImpl(@JsonProperty("limit") final Long limit,
            ...
            @JsonProperty("results") final java.util.List<com.commercetools.api.models.staged_quote.StagedQuote> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
