...
public interface StagedQuoteSetCustomFieldAction extends StagedQuoteUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedQuoteSetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedQuoteSetCustomFieldAction>() {
            @Override
