...
public interface StagedQuoteSetValidToAction extends StagedQuoteUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StagedQuoteSetValidToAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StagedQuoteSetValidToAction>() {
            @Override
