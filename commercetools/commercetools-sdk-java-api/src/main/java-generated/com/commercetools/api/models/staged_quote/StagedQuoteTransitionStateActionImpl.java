...
public class StagedQuoteTransitionStateActionImpl implements StagedQuoteTransitionStateAction, ModelBase {
     ...
     */
    @JsonCreator
    StagedQuoteTransitionStateActionImpl(@JsonProperty("state") final com.commercetools.api.models.state.StateResourceIdentifier state, @JsonProperty("force") final Boolean force) {
        this.state = state;
        this.force = force;
