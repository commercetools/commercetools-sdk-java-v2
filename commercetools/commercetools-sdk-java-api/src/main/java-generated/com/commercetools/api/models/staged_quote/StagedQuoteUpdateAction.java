...
@JsonTypeInfo(
    ...
    property = "action",
    defaultImpl = StagedQuoteUpdateActionImpl.class,
    visible = true
)
...
public interface StagedQuoteUpdateAction extends com.commercetools.api.models.ResourceUpdateAction<StagedQuoteUpdateAction> {
    ...
    public static StagedQuoteUpdateAction deepCopy(@Nullable final StagedQuoteUpdateAction template) {
        ...
        if (template instanceof com.commercetools.api.models.staged_quote.StagedQuoteChangeStagedQuoteStateAction) {
            return com.commercetools.api.models.staged_quote.StagedQuoteChangeStagedQuoteStateAction.deepCopy((com.commercetools.api.models.staged_quote.StagedQuoteChangeStagedQuoteStateAction)template);
        }
        if (template instanceof com.commercetools.api.models.staged_quote.StagedQuoteSetCustomFieldAction) {
            return com.commercetools.api.models.staged_quote.StagedQuoteSetCustomFieldAction.deepCopy((com.commercetools.api.models.staged_quote.StagedQuoteSetCustomFieldAction)template);
        }
        if (template instanceof com.commercetools.api.models.staged_quote.StagedQuoteSetCustomTypeAction) {
            return com.commercetools.api.models.staged_quote.StagedQuoteSetCustomTypeAction.deepCopy((com.commercetools.api.models.staged_quote.StagedQuoteSetCustomTypeAction)template);
        }
        if (template instanceof com.commercetools.api.models.staged_quote.StagedQuoteSetSellerCommentAction) {
            return com.commercetools.api.models.staged_quote.StagedQuoteSetSellerCommentAction.deepCopy((com.commercetools.api.models.staged_quote.StagedQuoteSetSellerCommentAction)template);
        }
        if (template instanceof com.commercetools.api.models.staged_quote.StagedQuoteSetValidToAction) {
            return com.commercetools.api.models.staged_quote.StagedQuoteSetValidToAction.deepCopy((com.commercetools.api.models.staged_quote.StagedQuoteSetValidToAction)template);
        }
        if (template instanceof com.commercetools.api.models.staged_quote.StagedQuoteTransitionStateAction) {
            return com.commercetools.api.models.staged_quote.StagedQuoteTransitionStateAction.deepCopy((com.commercetools.api.models.staged_quote.StagedQuoteTransitionStateAction)template);
        }
