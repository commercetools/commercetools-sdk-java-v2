...
public class StagedQuoteUpdateImpl implements StagedQuoteUpdate, ModelBase {
     ...
     */
    @JsonCreator
    StagedQuoteUpdateImpl(@JsonProperty("version") final Long version, @JsonProperty("actions") final java.util.List<com.commercetools.api.models.staged_quote.StagedQuoteUpdateAction> actions) {
    ...
    public void setActions(final java.util.List<com.commercetools.api.models.staged_quote.StagedQuoteUpdateAction> actions){
       this.actions = actions;
    }
