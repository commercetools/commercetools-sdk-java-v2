...
public class StagedStandalonePriceImpl implements StagedStandalonePrice, ModelBase {
     ...
     */
    @JsonCreator
    StagedStandalonePriceImpl(@JsonProperty("value") final com.commercetools.api.models.common.TypedMoney value, @JsonProperty("discounted") final com.commercetools.api.models.common.DiscountedPrice discounted) {
        this.value = value;
