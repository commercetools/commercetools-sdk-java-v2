...
/**
 *  <p><span>PagedQueryResult</span> with <code>results</code> containing an array of <a href="https://docs.commercetools.com/apis/ctp:api:type:StandalonePrice" rel="nofollow">StandalonePrice</a>.</p>
 */
...
public class StandalonePricePagedQueryResponseImpl implements StandalonePricePagedQueryResponse, ModelBase {
     ...
     */
    @JsonCreator
    StandalonePricePagedQueryResponseImpl(@JsonProperty("limit") final Long limit,
            @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count,
            @JsonProperty("total") final Long total,
            @JsonProperty("results") final java.util.List<com.commercetools.api.models.standalone_price.StandalonePrice> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
