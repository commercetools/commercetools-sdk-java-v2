...
public interface StandalonePriceSetValidFromAndUntilAction extends StandalonePriceUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StandalonePriceSetValidFromAndUntilAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StandalonePriceSetValidFromAndUntilAction>() {
            @Override
