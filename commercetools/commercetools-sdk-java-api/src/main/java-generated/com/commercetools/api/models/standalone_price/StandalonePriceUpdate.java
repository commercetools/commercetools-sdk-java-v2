...
public interface StandalonePriceUpdate extends
     ...
     */
    public static tools.jackson.core.type.TypeReference<StandalonePriceUpdate> typeReference() {
        return new tools.jackson.core.type.TypeReference<StandalonePriceUpdate>() {
            @Override
