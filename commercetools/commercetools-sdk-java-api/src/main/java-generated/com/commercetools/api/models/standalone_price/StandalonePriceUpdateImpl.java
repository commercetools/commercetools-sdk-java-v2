...
public class StandalonePriceUpdateImpl implements StandalonePriceUpdate, ModelBase {
     ...
     */
    @JsonCreator
    StandalonePriceUpdateImpl(@JsonProperty("version") final Long version, @JsonProperty("actions") final java.util.List<com.commercetools.api.models.standalone_price.StandalonePriceUpdateAction> actions) {
    ...
    public void setActions(final java.util.List<com.commercetools.api.models.standalone_price.StandalonePriceUpdateAction> actions){
       this.actions = actions;
    }
