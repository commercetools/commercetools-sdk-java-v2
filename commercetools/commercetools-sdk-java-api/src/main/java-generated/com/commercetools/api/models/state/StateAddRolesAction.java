...
public interface StateAddRolesAction extends StateUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StateAddRolesAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StateAddRolesAction>() {
            @Override
