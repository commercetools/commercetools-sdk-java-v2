...
public interface StateChangeKeyAction extends StateUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StateChangeKeyAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StateChangeKeyAction>() {
            @Override
