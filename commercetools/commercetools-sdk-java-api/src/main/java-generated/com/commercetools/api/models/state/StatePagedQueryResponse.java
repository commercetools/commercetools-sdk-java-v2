...
public interface StatePagedQueryResponse extends com.commercetools.api.models.ResourcePagedQueryResponse<State> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StatePagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<StatePagedQueryResponse>() {
            @Override
