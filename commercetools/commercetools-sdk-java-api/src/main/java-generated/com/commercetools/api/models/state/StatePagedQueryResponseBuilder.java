...
public class StatePagedQueryResponseBuilder implements Builder<StatePagedQueryResponse> {
    ...
    public StatePagedQueryResponseBuilder plusResults(Function<com.commercetools.api.models.state.StateBuilder, com.commercetools.api.models.state.StateBuilder> builder) {
        if (this.results == null) {
            this.results = new ArrayList<>();
        }
    ...
    public StatePagedQueryResponseBuilder withResults(Function<com.commercetools.api.models.state.StateBuilder, com.commercetools.api.models.state.StateBuilder> builder) {
        this.results = new ArrayList<>();
        this.results.add(builder.apply(com.commercetools.api.models.state.StateBuilder.of()).build());
        return this;
    }
    ...
    public StatePagedQueryResponseBuilder addResults(Function<com.commercetools.api.models.state.StateBuilder, com.commercetools.api.models.state.State> builder) {
    ...
    public StatePagedQueryResponseBuilder setResults(Function<com.commercetools.api.models.state.StateBuilder, com.commercetools.api.models.state.State> builder) {
