...
public class StatePagedQueryResponseImpl implements StatePagedQueryResponse {
    ...
    @JsonCreator
    StatePagedQueryResponseImpl(@JsonProperty("limit") final Long limit, @JsonProperty("count") final Long count,
