...
public interface StateRemoveRolesAction extends StateUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StateRemoveRolesAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StateRemoveRolesAction>() {
            @Override
