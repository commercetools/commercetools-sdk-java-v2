...
public interface StateResourceIdentifier extends ResourceIdentifier, com.commercetools.api.models.Identifiable<State> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StateResourceIdentifier> typeReference() {
        return new tools.jackson.core.type.TypeReference<StateResourceIdentifier>() {
            @Override
