...
/**
 *  <p>This update action produces the <a href="https://docs.commercetools.com/apis/ctp:api:type:StoreDistributionChannelsChangedMessage" rel="nofollow">StoreDistributionChannelsChanged</a> Message. It has no effect if a given distribution channel is already present in a Store.</p>
...
public interface StoreAddDistributionChannelAction extends StoreUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StoreAddDistributionChannelAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StoreAddDistributionChannelAction>() {
            @Override
