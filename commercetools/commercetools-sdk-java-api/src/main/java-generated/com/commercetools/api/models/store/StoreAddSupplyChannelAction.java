 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("addSupplyChannel")
...
public interface StoreAddSupplyChannelAction extends StoreUpdateAction {
     ...
     */
    @Nullable
    public static StoreAddSupplyChannelAction deepCopy(@Nullable final StoreAddSupplyChannelAction template) {
        if (template == null) {
            return null;
        }
        StoreAddSupplyChannelActionImpl instance = new StoreAddSupplyChannelActionImpl();
