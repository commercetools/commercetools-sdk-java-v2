...
public interface StoreChangeProductSelectionAction extends StoreUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StoreChangeProductSelectionAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StoreChangeProductSelectionAction>() {
            @Override
