...
public class StorePagedQueryResponseImpl implements StorePagedQueryResponse {
    ...
    @JsonCreator
    StorePagedQueryResponseImpl(@JsonProperty("limit") final Long limit, @JsonProperty("count") final Long count,
