...
public interface StoreRemoveDistributionChannelAction extends StoreUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StoreRemoveDistributionChannelAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StoreRemoveDistributionChannelAction>() {
            @Override
