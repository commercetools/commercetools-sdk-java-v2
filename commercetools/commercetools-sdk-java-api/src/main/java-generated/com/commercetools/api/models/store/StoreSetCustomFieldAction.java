...
public interface StoreSetCustomFieldAction extends StoreUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StoreSetCustomFieldAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<StoreSetCustomFieldAction>() {
            @Override
