...
public final class StoreSetCustomTypeActionImpl implements StoreSetCustomTypeAction {
    ...
    @JsonCreator
    StoreSetCustomTypeActionImpl(@JsonProperty("type") final com.commercetools.api.models.type.TypeResourceIdentifier type, @JsonProperty("fields") final com.fasterxml.jackson.databind.JsonNode fields) {
        this.type = type;
        this.fields = fields;
