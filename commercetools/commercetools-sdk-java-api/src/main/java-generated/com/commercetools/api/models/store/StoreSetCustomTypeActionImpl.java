...
public class StoreSetCustomTypeActionImpl implements StoreSetCustomTypeAction, ModelBase {
     ...
     */
    @JsonCreator
    StoreSetCustomTypeActionImpl(@JsonProperty("type") final com.commercetools.api.models.type.TypeResourceIdentifier type, @JsonProperty("fields") final com.commercetools.api.models.type.FieldContainer fields) {
        this.type = type;
        this.fields = fields;
