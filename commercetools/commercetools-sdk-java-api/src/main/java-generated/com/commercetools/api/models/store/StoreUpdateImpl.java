...
public class StoreUpdateImpl implements StoreUpdate, ModelBase {
     ...
     */
    @JsonCreator
    StoreUpdateImpl(@JsonProperty("version") final Long version,
            @JsonProperty("actions") final java.util.List<com.commercetools.api.models.store.StoreUpdateAction> actions) {
    ...
    /**
     *  <p>Expected version of the Store on which the changes should be applied. If the expected version does not match the actual version, a <a href="https://docs.commercetools.com/apis/ctp:api:type:ConcurrentModificationError" rel="nofollow">ConcurrentModification</a> error will be returned.</p>
     */
    ...
    public void setActions(final com.commercetools.api.models.store.StoreUpdateAction... actions) {
    ...
    public boolean equals(Object o) {
        ...
        StoreUpdateImpl that = (StoreUpdateImpl) o;
