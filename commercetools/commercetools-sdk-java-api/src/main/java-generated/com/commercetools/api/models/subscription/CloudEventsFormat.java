...
public interface CloudEventsFormat extends DeliveryFormat {
     ...
     */
    @Nullable
    public static CloudEventsFormat deepCopy(@Nullable final CloudEventsFormat template) {
        if (template == null) {
            return null;
        }
        CloudEventsFormatImpl instance = new CloudEventsFormatImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<CloudEventsFormat> typeReference() {
        return new tools.jackson.core.type.TypeReference<CloudEventsFormat>() {
            @Override
