...
public class MessageSubscriptionImpl implements MessageSubscription, ModelBase {
     ...
     */
    @JsonCreator
    MessageSubscriptionImpl(@JsonProperty("resourceTypeId") final com.commercetools.api.models.subscription.MessageSubscriptionResourceTypeId resourceTypeId, @JsonProperty("types") final java.util.List<String> types) {
    ...
    public void setResourceTypeId(final com.commercetools.api.models.subscription.MessageSubscriptionResourceTypeId resourceTypeId){
        this.resourceTypeId = resourceTypeId;
    }
