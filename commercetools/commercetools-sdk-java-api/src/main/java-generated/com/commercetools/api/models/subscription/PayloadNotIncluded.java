...
public interface PayloadNotIncluded {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PayloadNotIncluded> typeReference() {
        return new tools.jackson.core.type.TypeReference<PayloadNotIncluded>() {
            @Override
