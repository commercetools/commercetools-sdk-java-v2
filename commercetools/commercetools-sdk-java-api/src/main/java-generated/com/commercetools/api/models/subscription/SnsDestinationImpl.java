...
public class SnsDestinationImpl implements SnsDestination, ModelBase {
     ...
     */
    @JsonCreator
    SnsDestinationImpl(@JsonProperty("accessKey") final String accessKey, @JsonProperty("accessSecret") final String accessSecret, @JsonProperty("topicArn") final String topicArn, @JsonProperty("authenticationMode") final com.commercetools.api.models.subscription.AwsAuthenticationMode authenticationMode) {
