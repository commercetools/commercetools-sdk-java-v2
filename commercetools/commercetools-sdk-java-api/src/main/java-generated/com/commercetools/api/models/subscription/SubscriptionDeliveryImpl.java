...
public class SubscriptionDeliveryImpl implements SubscriptionDelivery, ModelBase {
    ...
    @JsonCreator
    SubscriptionDeliveryImpl(@JsonProperty("projectKey") final String projectKey,
