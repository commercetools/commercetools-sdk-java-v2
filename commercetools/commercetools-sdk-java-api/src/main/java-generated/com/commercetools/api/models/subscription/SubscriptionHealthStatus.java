...
public interface SubscriptionHealthStatus extends JsonEnum {
    ...
    /**
    <p>Does not deliver notifications with the current configuration and the delivery of the notifications is no longer attempted. After the configuration is fixed, undelivered notifications are not retained and will not be delivered. The <code>status</code> will not automatically change to <a href="https://docs.commercetools.com/apis/ctp:api:type:SubscriptionHealthStatus" rel="nofollow">Healthy</a>. To return your Subscription to a <a href="https://docs.commercetools.com/apis/ctp:api:type:SubscriptionHealthStatus" rel="nofollow">Healthy</a> status, use the <a href="https://docs.commercetools.com/apis/ctp:api:type:SubscriptionChangeDestinationAction" rel="nofollow">Change Destination</a> update action or recreate the Subscription.</p> */
