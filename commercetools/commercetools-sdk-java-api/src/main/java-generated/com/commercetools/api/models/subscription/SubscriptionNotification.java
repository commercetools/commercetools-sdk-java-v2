...
public interface SubscriptionNotification {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SubscriptionNotification> typeReference() {
        return new tools.jackson.core.type.TypeReference<SubscriptionNotification>() {
            @Override
