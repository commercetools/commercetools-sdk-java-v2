...
public interface SubscriptionPagedQueryResponse extends com.commercetools.api.models.ResourcePagedQueryResponse<Subscription> {
    ...
    public static SubscriptionPagedQueryResponse deepCopy(@Nullable final SubscriptionPagedQueryResponse template) {
        ...
        instance.setResults(Optional.ofNullable(template.getResults())
                .map(t -> t.stream().map(com.commercetools.api.models.subscription.Subscription::deepCopy).collect(Collectors.toList()))
                .orElse(null));
        return instance;
    }
