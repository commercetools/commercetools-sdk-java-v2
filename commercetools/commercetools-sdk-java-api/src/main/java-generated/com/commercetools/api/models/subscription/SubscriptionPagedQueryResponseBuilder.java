...
public class SubscriptionPagedQueryResponseBuilder implements Builder<SubscriptionPagedQueryResponse> {
    ...
    public SubscriptionPagedQueryResponseBuilder results( final com.commercetools.api.models.subscription.Subscription ...results) {
    ...
    public SubscriptionPagedQueryResponseBuilder plusResults( final com.commercetools.api.models.subscription.Subscription ...results) {
    ...
    public SubscriptionPagedQueryResponseBuilder plusResults(Function<com.commercetools.api.models.subscription.SubscriptionBuilder, com.commercetools.api.models.subscription.SubscriptionBuilder> builder) {
        if (this.results == null) {
            this.results = new ArrayList<>();
        }
    ...
    public SubscriptionPagedQueryResponseBuilder withResults(Function<com.commercetools.api.models.subscription.SubscriptionBuilder, com.commercetools.api.models.subscription.SubscriptionBuilder> builder) {
        this.results = new ArrayList<>();
        this.results.add(builder.apply(com.commercetools.api.models.subscription.SubscriptionBuilder.of()).build());
        return this;
    }
    ...
    public SubscriptionPagedQueryResponseBuilder addResults(Function<com.commercetools.api.models.subscription.SubscriptionBuilder, com.commercetools.api.models.subscription.Subscription> builder) {
    ...
    public SubscriptionPagedQueryResponseBuilder setResults(Function<com.commercetools.api.models.subscription.SubscriptionBuilder, com.commercetools.api.models.subscription.Subscription> builder) {
