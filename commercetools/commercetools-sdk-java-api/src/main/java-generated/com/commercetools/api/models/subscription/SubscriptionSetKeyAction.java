...
public interface SubscriptionSetKeyAction extends SubscriptionUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SubscriptionSetKeyAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SubscriptionSetKeyAction>() {
            @Override
