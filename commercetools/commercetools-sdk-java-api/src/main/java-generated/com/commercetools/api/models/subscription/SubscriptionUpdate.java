...
public interface SubscriptionUpdate extends
    ...
    /**
     *  <p>Expected version of the Subscription on which the changes should be applied. If the expected version does not match the actual version, a <a href="https://docs.commercetools.com/apis/ctp:api:type:ConcurrentModificationError" rel="nofollow">ConcurrentModification</a> error will be returned.</p>
     * @return version
     */
    @NotNull
     ...
     */
    public static tools.jackson.core.type.TypeReference<SubscriptionUpdate> typeReference() {
        return new tools.jackson.core.type.TypeReference<SubscriptionUpdate>() {
            @Override
