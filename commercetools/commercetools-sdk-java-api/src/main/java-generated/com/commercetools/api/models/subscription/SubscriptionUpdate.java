...
public interface SubscriptionUpdate extends com.commercetools.api.models.ResourceUpdate<SubscriptionUpdate, SubscriptionUpdateAction, SubscriptionUpdateBuilder> {
    ...
    public static SubscriptionUpdate deepCopy(@Nullable final SubscriptionUpdate template) {
        ...
        instance.setActions(Optional.ofNullable(template.getActions())
                .map(t -> t.stream().map(com.commercetools.api.models.subscription.SubscriptionUpdateAction::deepCopy).collect(Collectors.toList()))
                .orElse(null));
        return instance;
    }
