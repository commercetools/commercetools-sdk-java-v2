...
import com.commercetools.api.models.tax_category.TaxCategoryPagedQueryResponseImpl;
...
public interface TaxCategoryPagedQueryResponse extends com.commercetools.api.models.ResourcePagedQueryResponse<TaxCategory> {
    ...
    public static TaxCategoryPagedQueryResponse deepCopy(@Nullable final TaxCategoryPagedQueryResponse template) {
        ...
        instance.setResults(Optional.ofNullable(template.getResults())
                .map(t -> t.stream().map(com.commercetools.api.models.tax_category.TaxCategory::deepCopy).collect(Collectors.toList()))
                .orElse(null));
        return instance;
    }
