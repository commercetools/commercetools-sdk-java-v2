...
/**
 *  <p><span>PagedQueryResult</span> with <code>results</code> containing an array of <a href="https://docs.commercetools.com/apis/ctp:api:type:TaxCategory" rel="nofollow">TaxCategory</a>.</p>
 *
 * <hr>
...
public interface TaxCategoryPagedQueryResponse
    ...
    /**
     *  <p><a href="https://docs.commercetools.com/apis/ctp:api:type:TaxCategory" rel="nofollow">TaxCategories</a> matching the query.</p>
     * @return results
     */
    @NotNull
    @Valid
     ...
     */
    public static tools.jackson.core.type.TypeReference<TaxCategoryPagedQueryResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<TaxCategoryPagedQueryResponse>() {
            @Override
