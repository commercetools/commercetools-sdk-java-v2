...
public class TaxCategoryPagedQueryResponseBuilder implements Builder<TaxCategoryPagedQueryResponse> {
    ...
    public TaxCategoryPagedQueryResponseBuilder results( final com.commercetools.api.models.tax_category.TaxCategory ...results) {
    ...
    public TaxCategoryPagedQueryResponseBuilder results( final java.util.List<com.commercetools.api.models.tax_category.TaxCategory> results) {
    ...
    public TaxCategoryPagedQueryResponseBuilder plusResults( final com.commercetools.api.models.tax_category.TaxCategory ...results) {
    ...
    public TaxCategoryPagedQueryResponseBuilder plusResults(Function<com.commercetools.api.models.tax_category.TaxCategoryBuilder, com.commercetools.api.models.tax_category.TaxCategoryBuilder> builder) {
        if (this.results == null) {
            this.results = new ArrayList<>();
        }
    ...
    public TaxCategoryPagedQueryResponseBuilder withResults(Function<com.commercetools.api.models.tax_category.TaxCategoryBuilder, com.commercetools.api.models.tax_category.TaxCategoryBuilder> builder) {
        this.results = new ArrayList<>();
        this.results.add(builder.apply(com.commercetools.api.models.tax_category.TaxCategoryBuilder.of()).build());
        return this;
    }
    ...
    public TaxCategoryPagedQueryResponseBuilder addResults(Function<com.commercetools.api.models.tax_category.TaxCategoryBuilder, com.commercetools.api.models.tax_category.TaxCategory> builder) {
    ...
    public TaxCategoryPagedQueryResponseBuilder setResults(Function<com.commercetools.api.models.tax_category.TaxCategoryBuilder, com.commercetools.api.models.tax_category.TaxCategory> builder) {
