...
public class TaxCategoryPagedQueryResponseImpl implements TaxCategoryPagedQueryResponse, ModelBase {
     ...
     */
    @JsonCreator
    TaxCategoryPagedQueryResponseImpl(@JsonProperty("limit") final Long limit, @JsonProperty("offset") final Long offset, @JsonProperty("count") final Long count, @JsonProperty("total") final Long total, @JsonProperty("results") final java.util.List<com.commercetools.api.models.tax_category.TaxCategory> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
