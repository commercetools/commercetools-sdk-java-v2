 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("replaceTaxRate")
...
public interface TaxCategoryReplaceTaxRateAction extends TaxCategoryUpdateAction {
    ...
    public TaxCategoryReplaceTaxRateAction copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<TaxCategoryReplaceTaxRateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<TaxCategoryReplaceTaxRateAction>() {
            @Override
