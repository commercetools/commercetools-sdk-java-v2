...
public interface TaxCategorySetDescriptionAction extends TaxCategoryUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<TaxCategorySetDescriptionAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<TaxCategorySetDescriptionAction>() {
            @Override
