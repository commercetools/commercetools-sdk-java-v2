...
public interface TaxCategorySetKeyAction extends TaxCategoryUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<TaxCategorySetKeyAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<TaxCategorySetKeyAction>() {
            @Override
