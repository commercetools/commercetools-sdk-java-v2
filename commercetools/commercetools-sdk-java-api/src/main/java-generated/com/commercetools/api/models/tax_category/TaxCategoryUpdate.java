...
public interface TaxCategoryUpdate extends com.commercetools.api.models.ResourceUpdate<TaxCategoryUpdate, TaxCategoryUpdateAction, TaxCategoryUpdateBuilder> {
    ...
    public static TaxCategoryUpdate deepCopy(@Nullable final TaxCategoryUpdate template) {
        ...
        instance.setActions(Optional.ofNullable(template.getActions())
                .map(t -> t.stream().map(com.commercetools.api.models.tax_category.TaxCategoryUpdateAction::deepCopy).collect(Collectors.toList()))
                .orElse(null));
        return instance;
    }
