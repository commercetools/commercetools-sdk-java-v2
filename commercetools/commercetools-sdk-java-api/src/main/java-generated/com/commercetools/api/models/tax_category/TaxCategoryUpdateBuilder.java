...
public class TaxCategoryUpdateBuilder implements Builder<TaxCategoryUpdate> {
    ...
    public TaxCategoryUpdateBuilder plusActions( final com.commercetools.api.models.tax_category.TaxCategoryUpdateAction ...actions) {
    ...
    public TaxCategoryUpdateBuilder plusActions(Function<com.commercetools.api.models.tax_category.TaxCategoryUpdateActionBuilder, Builder<? extends com.commercetools.api.models.tax_category.TaxCategoryUpdateAction>> builder) {
        if (this.actions == null) {
            this.actions = new ArrayList<>();
        }
        this.actions.add(builder.apply(com.commercetools.api.models.tax_category.TaxCategoryUpdateActionBuilder.of()).build());
        return this;
    }
    ...
    public TaxCategoryUpdateBuilder withActions(Function<com.commercetools.api.models.tax_category.TaxCategoryUpdateActionBuilder, Builder<? extends com.commercetools.api.models.tax_category.TaxCategoryUpdateAction>> builder) {
        this.actions = new ArrayList<>();
        this.actions.add(builder.apply(com.commercetools.api.models.tax_category.TaxCategoryUpdateActionBuilder.of()).build());
        return this;
    }
