...
public interface CustomFieldBooleanType extends FieldType {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomFieldBooleanType> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomFieldBooleanType>() {
            @Override
