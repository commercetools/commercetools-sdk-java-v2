...
public interface CustomFieldDateTimeType extends FieldType {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomFieldDateTimeType> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomFieldDateTimeType>() {
            @Override
