...
public class CustomFieldEnumTypeBuilder implements Builder<CustomFieldEnumType> {
    ...
    public CustomFieldEnumTypeBuilder plusValues( final com.commercetools.api.models.type.CustomFieldEnumValue ...values) {
        if (this.values == null) {
    ...
    public CustomFieldEnumTypeBuilder plusValues(Function<com.commercetools.api.models.type.CustomFieldEnumValueBuilder, com.commercetools.api.models.type.CustomFieldEnumValueBuilder> builder) {
        if (this.values == null) {
            this.values = new ArrayList<>();
        }
    ...
    public CustomFieldEnumTypeBuilder withValues(Function<com.commercetools.api.models.type.CustomFieldEnumValueBuilder, com.commercetools.api.models.type.CustomFieldEnumValueBuilder> builder) {
        this.values = new ArrayList<>();
        this.values.add(builder.apply(com.commercetools.api.models.type.CustomFieldEnumValueBuilder.of()).build());
        return this;
    }
    ...
    public CustomFieldEnumTypeBuilder addValues(Function<com.commercetools.api.models.type.CustomFieldEnumValueBuilder, com.commercetools.api.models.type.CustomFieldEnumValue> builder) {
    ...
    public CustomFieldEnumTypeBuilder setValues(Function<com.commercetools.api.models.type.CustomFieldEnumValueBuilder, com.commercetools.api.models.type.CustomFieldEnumValue> builder) {
