...
public interface CustomFieldNumberType extends FieldType {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomFieldNumberType> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomFieldNumberType>() {
            @Override
