...
public interface TypeChangeEnumValueLabelAction extends TypeUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<TypeChangeEnumValueLabelAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<TypeChangeEnumValueLabelAction>() {
            @Override
