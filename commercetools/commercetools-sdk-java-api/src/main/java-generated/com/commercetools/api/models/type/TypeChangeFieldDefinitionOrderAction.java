...
public interface TypeChangeFieldDefinitionOrderAction extends TypeUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<TypeChangeFieldDefinitionOrderAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<TypeChangeFieldDefinitionOrderAction>() {
            @Override
