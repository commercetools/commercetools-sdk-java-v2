...
public interface TypeChangeNameAction extends TypeUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<TypeChangeNameAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<TypeChangeNameAction>() {
            @Override
