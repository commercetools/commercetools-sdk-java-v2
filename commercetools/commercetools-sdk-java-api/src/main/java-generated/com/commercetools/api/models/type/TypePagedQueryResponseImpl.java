...
public class TypePagedQueryResponseImpl implements TypePagedQueryResponse, ModelBase {
    ...
    TypePagedQueryResponseImpl(@JsonProperty("limit") final Long limit, @JsonProperty("offset") final Long offset,
            ...
            @JsonProperty("results") final java.util.List<com.commercetools.api.models.type.Type> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
    ...
    /**
     *  <p><a href="https://docs.commercetools.com/apis/ctp:api:type:Type" rel="nofollow">Types</a> matching the query.</p>
     */
    ...
    public void setResults(final com.commercetools.api.models.type.Type... results) {
        this.results = new ArrayList<>(Arrays.asList(results));
    }

    public void setResults(final java.util.List<com.commercetools.api.models.type.Type> results) {
        this.results = results;
    }
    ...
    public boolean equals(Object o) {
        ...
        TypePagedQueryResponseImpl that = (TypePagedQueryResponseImpl) o;
