...
public class TypeRemoveEnumValuesActionImpl implements TypeRemoveEnumValuesAction, ModelBase {
     ...
     */
    @JsonCreator
    TypeRemoveEnumValuesActionImpl(@JsonProperty("fieldName") final String fieldName,
     ...
     */
    public TypeRemoveEnumValuesActionImpl() {
        this.action = REMOVE_ENUM_VALUES;
    }
    ...
    public boolean equals(Object o) {
        ...
        TypeRemoveEnumValuesActionImpl that = (TypeRemoveEnumValuesActionImpl) o;
    ...
    public TypeRemoveEnumValuesAction copyDeep() {
        return TypeRemoveEnumValuesAction.deepCopy(this);
    }
}
