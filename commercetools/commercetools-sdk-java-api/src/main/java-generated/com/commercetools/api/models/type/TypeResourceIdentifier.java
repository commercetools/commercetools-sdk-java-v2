...
public interface TypeResourceIdentifier extends ResourceIdentifier, com.commercetools.api.models.Identifiable<Type> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<TypeResourceIdentifier> typeReference() {
        return new tools.jackson.core.type.TypeReference<TypeResourceIdentifier>() {
            @Override
