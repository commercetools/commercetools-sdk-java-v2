...
public class VariantPagedQueryResponseImpl implements VariantPagedQueryResponse, ModelBase {
     ...
     */
    @JsonCreator
    VariantPagedQueryResponseImpl(@JsonProperty("limit") final Long limit, @JsonProperty("offset") final Long offset,
            @JsonProperty("count") final Long count, @JsonProperty("total") final Long total,
            @JsonProperty("results") final java.util.List<com.commercetools.api.models.variant.Variant> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
     ...
     */
    public VariantPagedQueryResponseImpl() {
    }
    ...
    public void setResults(final com.commercetools.api.models.variant.Variant... results) {
        this.results = new ArrayList<>(Arrays.asList(results));
    }

    public void setResults(final java.util.List<com.commercetools.api.models.variant.Variant> results) {
        this.results = results;
    }
    ...
    public boolean equals(Object o) {
        ...
        VariantPagedQueryResponseImpl that = (VariantPagedQueryResponseImpl) o;
    ...
    public VariantPagedQueryResponse copyDeep() {
        return VariantPagedQueryResponse.deepCopy(this);
    }
}
