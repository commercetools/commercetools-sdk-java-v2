...
public class VariantProjectionPagedQueryResponseImpl implements VariantProjectionPagedQueryResponse, ModelBase {
     ...
     */
    @JsonCreator
    VariantProjectionPagedQueryResponseImpl(@JsonProperty("limit") final Long limit,
            @JsonProperty("count") final Long count, @JsonProperty("total") final Long total,
            @JsonProperty("offset") final Long offset,
            @JsonProperty("results") final java.util.List<com.commercetools.api.models.variant.VariantProjection> results) {
        this.limit = limit;
        this.count = count;
        this.total = total;
        this.offset = offset;
     ...
     */
    public VariantProjectionPagedQueryResponseImpl() {
    }
    ...
    public void setResults(final com.commercetools.api.models.variant.VariantProjection... results) {
        this.results = new ArrayList<>(Arrays.asList(results));
    }

    public void setResults(final java.util.List<com.commercetools.api.models.variant.VariantProjection> results) {
        this.results = results;
    }
    ...
    public boolean equals(Object o) {
        ...
        VariantProjectionPagedQueryResponseImpl that = (VariantProjectionPagedQueryResponseImpl) o;
    ...
    public VariantProjectionPagedQueryResponse copyDeep() {
        return VariantProjectionPagedQueryResponse.deepCopy(this);
    }
}
