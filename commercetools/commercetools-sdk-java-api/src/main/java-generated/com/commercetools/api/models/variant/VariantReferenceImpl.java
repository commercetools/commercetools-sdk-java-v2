...
public class VariantReferenceImpl implements VariantReference, ModelBase {
     ...
     */
    @JsonCreator
    VariantReferenceImpl(@JsonProperty("id") final String id,
            @JsonProperty("obj") final com.commercetools.api.models.variant.Variant obj) {
        this.id = id;
        this.obj = obj;
        this.typeId = ReferenceTypeId.findEnum("variant");
    }

    /**
     * create empty instance
     */
    public VariantReferenceImpl() {
        this.typeId = ReferenceTypeId.findEnum("variant");
    }
    ...
    public void setObj(final com.commercetools.api.models.variant.Variant obj) {
        this.obj = obj;
    }
    ...
    public boolean equals(Object o) {
        ...
        VariantReferenceImpl that = (VariantReferenceImpl) o;
    ...
    public VariantReference copyDeep() {
        return VariantReference.deepCopy(this);
    }
}
