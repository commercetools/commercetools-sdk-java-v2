...
public class VariantResourceIdentifierImpl implements VariantResourceIdentifier, ModelBase {
     ...
     */
    @JsonCreator
    VariantResourceIdentifierImpl(@JsonProperty("id") final String id, @JsonProperty("key") final String key) {
        this.id = id;
        this.key = key;
     ...
     */
    public VariantResourceIdentifierImpl() {
        this.typeId = ReferenceTypeId.findEnum("variant");
    }
    ...
    public boolean equals(Object o) {
        ...
        VariantResourceIdentifierImpl that = (VariantResourceIdentifierImpl) o;
    ...
    public VariantResourceIdentifier copyDeep() {
        return VariantResourceIdentifier.deepCopy(this);
    }
}
