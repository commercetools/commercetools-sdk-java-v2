...
public class VariantSetAttributeActionImpl implements VariantSetAttributeAction, ModelBase {
     ...
     */
    @JsonCreator
    VariantSetAttributeActionImpl(@JsonProperty("name") final String name,
     ...
     */
    public VariantSetAttributeActionImpl() {
        this.action = SET_ATTRIBUTE;
    }
    ...
    public boolean equals(Object o) {
        ...
        VariantSetAttributeActionImpl that = (VariantSetAttributeActionImpl) o;
    ...
    public VariantSetAttributeAction copyDeep() {
        return VariantSetAttributeAction.deepCopy(this);
    }
}
