...
public class VariantSetKeyActionImpl implements VariantSetKeyAction, ModelBase {
     ...
     */
    @JsonCreator
    VariantSetKeyActionImpl(@JsonProperty("key") final String key) {
        this.key = key;
        this.action = SET_KEY;
    }
     ...
     */
    public VariantSetKeyActionImpl() {
        this.action = SET_KEY;
    }
    ...
    public boolean equals(Object o) {
        ...
        VariantSetKeyActionImpl that = (VariantSetKeyActionImpl) o;
    ...
    public VariantSetKeyAction copyDeep() {
        return VariantSetKeyAction.deepCopy(this);
    }
}
