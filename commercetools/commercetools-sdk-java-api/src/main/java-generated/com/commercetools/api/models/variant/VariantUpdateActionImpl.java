...
public class VariantUpdateActionImpl implements VariantUpdateAction, ModelBase {
     ...
     */
    @JsonCreator
    VariantUpdateActionImpl(@JsonProperty("action") final String action) {
        this.action = action;
    }
     ...
     */
    public VariantUpdateActionImpl() {
    }
    ...
    public boolean equals(Object o) {
        ...
        VariantUpdateActionImpl that = (VariantUpdateActionImpl) o;
    ...
    public VariantUpdateAction copyDeep() {
        return VariantUpdateAction.deepCopy(this);
    }
}
