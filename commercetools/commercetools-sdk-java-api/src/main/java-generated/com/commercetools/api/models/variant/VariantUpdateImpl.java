...
public class VariantUpdateImpl implements VariantUpdate, ModelBase {
     ...
     */
    @JsonCreator
    VariantUpdateImpl(@JsonProperty("version") final Long version,
    ...
    public boolean equals(Object o) {
        ...
        VariantUpdateImpl that = (VariantUpdateImpl) o;
    ...
    public VariantUpdate copyDeep() {
        return VariantUpdate.deepCopy(this);
    }
}
