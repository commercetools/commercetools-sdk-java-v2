...
public interface CannotCreateReservationWarning extends WarningObject {
     ...
     */
    public static com.fasterxml.jackson.core.type.TypeReference<CannotCreateReservationWarning> typeReference() {
        return new com.fasterxml.jackson.core.type.TypeReference<CannotCreateReservationWarning>() {
            @Override
