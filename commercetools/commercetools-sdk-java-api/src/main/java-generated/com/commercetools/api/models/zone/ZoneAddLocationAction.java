...
public interface ZoneAddLocationAction extends ZoneUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ZoneAddLocationAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ZoneAddLocationAction>() {
            @Override
