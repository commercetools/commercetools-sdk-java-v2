...
public interface ZoneChangeNameAction extends ZoneUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ZoneChangeNameAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ZoneChangeNameAction>() {
            @Override
