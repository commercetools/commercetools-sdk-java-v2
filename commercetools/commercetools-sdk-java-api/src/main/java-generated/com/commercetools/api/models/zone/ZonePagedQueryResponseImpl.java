...
/**
 *  <p><span>PagedQueryResult</span> with <code>results</code> containing an array of <a href="https://docs.commercetools.com/apis/ctp:api:type:Zone" rel="nofollow">Zone</a>.</p>
 */
@Generated(value = "io.vrap.rmf.codegen.rendering.CoreCodeGenerator", comments = "https://github.com/commercetools/rmf-codegen")
public class ZonePagedQueryResponseImpl implements ZonePagedQueryResponse, ModelBase {
     ...
     */
    @JsonCreator
    ZonePagedQueryResponseImpl(@JsonProperty("limit") final Long limit, @JsonProperty("offset") final Long offset,
            @JsonProperty("count") final Long count, @JsonProperty("total") final Long total,
            @JsonProperty("results") final java.util.List<com.commercetools.api.models.zone.Zone> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
        this.total = total;
    ...
    /**
     *  <p><a href="https://docs.commercetools.com/apis/ctp:api:type:Zone" rel="nofollow">Zones</a> matching the query.</p>
     */
    ...
    public void setResults(final com.commercetools.api.models.zone.Zone... results) {
        this.results = new ArrayList<>(Arrays.asList(results));
    }

    public void setResults(final java.util.List<com.commercetools.api.models.zone.Zone> results) {
        this.results = results;
    }
    ...
    public boolean equals(Object o) {
        ...
        ZonePagedQueryResponseImpl that = (ZonePagedQueryResponseImpl) o;
