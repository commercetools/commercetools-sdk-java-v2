...
public interface ZoneSetDescriptionAction extends ZoneUpdateAction {
     ...
     */
    @Nullable
    public static ZoneSetDescriptionAction deepCopy(@Nullable final ZoneSetDescriptionAction template) {
        if (template == null) {
            return null;
        }
        ZoneSetDescriptionActionImpl instance = new ZoneSetDescriptionActionImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<ZoneSetDescriptionAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ZoneSetDescriptionAction>() {
            @Override
