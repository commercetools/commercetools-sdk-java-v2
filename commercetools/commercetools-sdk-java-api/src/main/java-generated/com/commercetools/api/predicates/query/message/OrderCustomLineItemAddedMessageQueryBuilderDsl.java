...
public class OrderCustomLineItemAddedMessageQueryBuilderDsl {
    ...
    public StringComparisonPredicateBuilder<OrderCustomLineItemAddedMessageQueryBuilderDsl> id() {
        return new StringComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("id")),
            p -> new CombinationQueryPredicate<>(p, OrderCustomLineItemAddedMessageQueryBuilderDsl::of));
    }

    public LongComparisonPredicateBuilder<OrderCustomLineItemAddedMessageQueryBuilderDsl> version() {
        return new LongComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("version")),
            p -> new CombinationQueryPredicate<>(p, OrderCustomLineItemAddedMessageQueryBuilderDsl::of));
    }

    public DateTimeComparisonPredicateBuilder<OrderCustomLineItemAddedMessageQueryBuilderDsl> createdAt() {
        return new DateTimeComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("createdAt")),
            p -> new CombinationQueryPredicate<>(p, OrderCustomLineItemAddedMessageQueryBuilderDsl::of));
    }

    public DateTimeComparisonPredicateBuilder<OrderCustomLineItemAddedMessageQueryBuilderDsl> lastModifiedAt() {
        return new DateTimeComparisonPredicateBuilder<>(
    ...
    public LongComparisonPredicateBuilder<OrderCustomLineItemAddedMessageQueryBuilderDsl> sequenceNumber() {
        return new LongComparisonPredicateBuilder<>(
    ...
    public LongComparisonPredicateBuilder<OrderCustomLineItemAddedMessageQueryBuilderDsl> resourceVersion() {
        return new LongComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("resourceVersion")),
            p -> new CombinationQueryPredicate<>(p, OrderCustomLineItemAddedMessageQueryBuilderDsl::of));
    }

    public StringComparisonPredicateBuilder<OrderCustomLineItemAddedMessageQueryBuilderDsl> type() {
