...
public class BusinessUnitExpansionBuilderDsl implements ExpansionDsl {

    private final List<String> path;

    private BusinessUnitExpansionBuilderDsl(final List<String> path) {
        this.path = path;
    }

    public static BusinessUnitExpansionBuilderDsl of() {
        return new BusinessUnitExpansionBuilderDsl(Collections.emptyList());
    }

    public static BusinessUnitExpansionBuilderDsl of(final List<String> path) {
        return new BusinessUnitExpansionBuilderDsl(path);
    }
