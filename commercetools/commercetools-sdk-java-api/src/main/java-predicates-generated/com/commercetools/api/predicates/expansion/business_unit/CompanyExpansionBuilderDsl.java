...
public class CompanyExpansionBuilderDsl implements ExpansionDsl {

    private final List<String> path;

    private CompanyExpansionBuilderDsl(final List<String> path) {
        this.path = path;
    }

    public static CompanyExpansionBuilderDsl of() {
        return new CompanyExpansionBuilderDsl(Collections.emptyList());
    }

    public static CompanyExpansionBuilderDsl of(final List<String> path) {
        return new CompanyExpansionBuilderDsl(path);
    }
