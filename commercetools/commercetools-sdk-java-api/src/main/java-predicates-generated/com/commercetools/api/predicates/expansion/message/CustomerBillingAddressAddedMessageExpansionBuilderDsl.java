...
public class CustomerBillingAddressAddedMessageExpansionBuilderDsl implements ExpansionDsl {
    ...
    private CustomerBillingAddressAddedMessageExpansionBuilderDsl(final List<String> path) {
        this.path = path;
    }
    ...
    public static CustomerBillingAddressAddedMessageExpansionBuilderDsl of(final List<String> path) {
