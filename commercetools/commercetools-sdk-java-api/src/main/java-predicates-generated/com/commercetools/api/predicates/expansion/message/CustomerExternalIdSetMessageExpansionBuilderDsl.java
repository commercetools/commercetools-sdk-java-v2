...
public class CustomerExternalIdSetMessageExpansionBuilderDsl implements ExpansionDsl {
    ...
    private CustomerExternalIdSetMessageExpansionBuilderDsl(final List<String> path) {
        this.path = path;
    }
    ...
    public static CustomerExternalIdSetMessageExpansionBuilderDsl of(final List<String> path) {
