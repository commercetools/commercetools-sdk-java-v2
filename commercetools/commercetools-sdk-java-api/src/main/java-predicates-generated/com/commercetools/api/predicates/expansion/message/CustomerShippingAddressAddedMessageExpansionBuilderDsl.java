...
public class CustomerShippingAddressAddedMessageExpansionBuilderDsl implements ExpansionDsl {
    ...
    private CustomerShippingAddressAddedMessageExpansionBuilderDsl(final List<String> path) {
        this.path = path;
    }
    ...
    public static CustomerShippingAddressAddedMessageExpansionBuilderDsl of(final List<String> path) {
