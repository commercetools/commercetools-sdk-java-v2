...
public class StagedOrderExpansionBuilderDsl implements ExpansionDsl {

    private final List<String> path;

    private StagedOrderExpansionBuilderDsl(final List<String> path) {
        this.path = path;
    }

    public static StagedOrderExpansionBuilderDsl of() {
        return new StagedOrderExpansionBuilderDsl(Collections.emptyList());
    }

    public static StagedOrderExpansionBuilderDsl of(final List<String> path) {
        return new StagedOrderExpansionBuilderDsl(path);
    }
