...
public class StoreExpansionBuilderDsl implements ExpansionDsl {

    private final List<String> path;

    private StoreExpansionBuilderDsl(final List<String> path) {
        this.path = path;
    }

    public static StoreExpansionBuilderDsl of() {
        return new StoreExpansionBuilderDsl(Collections.emptyList());
    }

    public static StoreExpansionBuilderDsl of(final List<String> path) {
        return new StoreExpansionBuilderDsl(path);
    }
