...
public class ApiClientQueryBuilderDsl  {
    ...
    public StringComparisonPredicateBuilder<ApiClientQueryBuilderDsl> secret() {
        return new StringComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("secret")),
        p -> new CombinationQueryPredicate<>(p, ApiClientQueryBuilderDsl::of));
    }
    public DateComparisonPredicateBuilder<ApiClientQueryBuilderDsl> lastUsedAt() {
        return new DateComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("lastUsedAt")),
        p -> new CombinationQueryPredicate<>(p, ApiClientQueryBuilderDsl::of));
    }
    public DateTimeComparisonPredicateBuilder<ApiClientQueryBuilderDsl> deleteAt() {
        return new DateTimeComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("deleteAt")),
        p -> new CombinationQueryPredicate<>(p, ApiClientQueryBuilderDsl::of));
    }
