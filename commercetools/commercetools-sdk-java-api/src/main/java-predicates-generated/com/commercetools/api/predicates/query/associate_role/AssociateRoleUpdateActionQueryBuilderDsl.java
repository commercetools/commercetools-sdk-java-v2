...
public class AssociateRoleUpdateActionQueryBuilderDsl {
    ...
    public CombinationQueryPredicate<AssociateRoleUpdateActionQueryBuilderDsl> asAddPermission(
        ...
        return new CombinationQueryPredicate<>(fn.apply(
            com.commercetools.api.predicates.query.associate_role.AssociateRoleAddPermissionActionQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<AssociateRoleUpdateActionQueryBuilderDsl> asChangeBuyerAssignable(
        ...
        return new CombinationQueryPredicate<>(fn.apply(
            com.commercetools.api.predicates.query.associate_role.AssociateRoleChangeBuyerAssignableActionQueryBuilderDsl
                    .of()),
            AssociateRoleUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<AssociateRoleUpdateActionQueryBuilderDsl> asRemovePermission(
        ...
        return new CombinationQueryPredicate<>(fn.apply(
            com.commercetools.api.predicates.query.associate_role.AssociateRoleRemovePermissionActionQueryBuilderDsl
                    .of()),
            AssociateRoleUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<AssociateRoleUpdateActionQueryBuilderDsl> asSetCustomField(
        ...
        return new CombinationQueryPredicate<>(fn.apply(
            com.commercetools.api.predicates.query.associate_role.AssociateRoleSetCustomFieldActionQueryBuilderDsl
                    .of()),
            AssociateRoleUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<AssociateRoleUpdateActionQueryBuilderDsl> asSetCustomType(
        ...
        return new CombinationQueryPredicate<>(fn.apply(
            com.commercetools.api.predicates.query.associate_role.AssociateRoleSetCustomTypeActionQueryBuilderDsl.of()),
            AssociateRoleUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<AssociateRoleUpdateActionQueryBuilderDsl> asSetName(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(
                com.commercetools.api.predicates.query.associate_role.AssociateRoleSetNameActionQueryBuilderDsl.of()),
            AssociateRoleUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<AssociateRoleUpdateActionQueryBuilderDsl> asSetPermissions(
        ...
        return new CombinationQueryPredicate<>(fn.apply(
            com.commercetools.api.predicates.query.associate_role.AssociateRoleSetPermissionsActionQueryBuilderDsl
                    .of()),
            AssociateRoleUpdateActionQueryBuilderDsl::of);
    }
}
