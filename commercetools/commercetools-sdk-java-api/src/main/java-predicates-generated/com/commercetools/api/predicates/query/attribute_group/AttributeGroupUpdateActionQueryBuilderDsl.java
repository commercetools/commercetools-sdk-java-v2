...
public class AttributeGroupUpdateActionQueryBuilderDsl  {
    ...
    public CombinationQueryPredicate<AttributeGroupUpdateActionQueryBuilderDsl> asAddAttribute(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.attribute_group.AttributeGroupAddAttributeActionQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<AttributeGroupUpdateActionQueryBuilderDsl> asChangeName(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.attribute_group.AttributeGroupChangeNameActionQueryBuilderDsl.of()),
            AttributeGroupUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<AttributeGroupUpdateActionQueryBuilderDsl> asRemoveAttribute(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.attribute_group.AttributeGroupRemoveAttributeActionQueryBuilderDsl.of()),
            AttributeGroupUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<AttributeGroupUpdateActionQueryBuilderDsl> asSetAttributes(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.attribute_group.AttributeGroupSetAttributesActionQueryBuilderDsl.of()),
            AttributeGroupUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<AttributeGroupUpdateActionQueryBuilderDsl> asSetDescription(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.attribute_group.AttributeGroupSetDescriptionActionQueryBuilderDsl.of()),
            AttributeGroupUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<AttributeGroupUpdateActionQueryBuilderDsl> asSetKey(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.attribute_group.AttributeGroupSetKeyActionQueryBuilderDsl.of()),
            AttributeGroupUpdateActionQueryBuilderDsl::of);
    }
}
