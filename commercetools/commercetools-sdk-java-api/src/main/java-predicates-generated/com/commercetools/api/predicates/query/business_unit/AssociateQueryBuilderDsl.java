...
public class AssociateQueryBuilderDsl  {
    ...
    public CombinationQueryPredicate<AssociateQueryBuilderDsl> associateRoleAssignments(
        ...
        return new CombinationQueryPredicate<>(ContainerQueryPredicate.of()
            ...
            .inner(fn.apply(com.commercetools.api.predicates.query.business_unit.AssociateRoleAssignmentQueryBuilderDsl.of())),
    ...
    public StringCollectionPredicateBuilder<AssociateQueryBuilderDsl> roles() {
