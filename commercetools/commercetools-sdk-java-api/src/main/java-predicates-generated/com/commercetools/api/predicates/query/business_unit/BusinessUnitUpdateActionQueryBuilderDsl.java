...
public class BusinessUnitUpdateActionQueryBuilderDsl  {
    ...
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asAddAddress(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitAddAddressActionQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asAddAssociate(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitAddAssociateActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asAddBillingAddressId(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitAddBillingAddressIdActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asAddShippingAddressId(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitAddShippingAddressIdActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asAddStore(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitAddStoreActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asChangeAddress(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitChangeAddressActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asChangeAssociate(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitChangeAssociateActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asChangeAssociateMode(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitChangeAssociateModeActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asChangeName(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitChangeNameActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asChangeParentUnit(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitChangeParentUnitActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asChangeStatus(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitChangeStatusActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asRemoveAddress(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitRemoveAddressActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asRemoveAssociate(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitRemoveAssociateActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asRemoveBillingAddressId(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitRemoveBillingAddressIdActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asRemoveShippingAddressId(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitRemoveShippingAddressIdActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asRemoveStore(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitRemoveStoreActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asSetAddressCustomField(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitSetAddressCustomFieldActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asSetAddressCustomType(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitSetAddressCustomTypeActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asSetAssociates(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitSetAssociatesActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asSetContactEmail(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitSetContactEmailActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asSetCustomField(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitSetCustomFieldActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asSetCustomType(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitSetCustomTypeActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asSetDefaultBillingAddress(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitSetDefaultBillingAddressActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asSetDefaultShippingAddress(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitSetDefaultShippingAddressActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asSetStoreMode(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitSetStoreModeActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<BusinessUnitUpdateActionQueryBuilderDsl> asSetStores(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitSetStoresActionQueryBuilderDsl.of()),
            BusinessUnitUpdateActionQueryBuilderDsl::of);
    }
}
