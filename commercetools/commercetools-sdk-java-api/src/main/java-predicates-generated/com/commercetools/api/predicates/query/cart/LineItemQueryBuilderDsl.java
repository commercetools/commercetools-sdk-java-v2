...
public class LineItemQueryBuilderDsl  {
    ...
    public StringComparisonPredicateBuilder<LineItemQueryBuilderDsl> productKey() {
        return new StringComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("productKey")),
        p -> new CombinationQueryPredicate<>(p, LineItemQueryBuilderDsl::of));
    }
    ...
    public CombinationQueryPredicate<LineItemQueryBuilderDsl> discountedPricePerQuantity(
        ...
        return new CombinationQueryPredicate<>(ContainerQueryPredicate.of()
            ...
            .inner(fn.apply(com.commercetools.api.predicates.query.cart.DiscountedLineItemPriceForQuantityQueryBuilderDsl.of())),
            LineItemQueryBuilderDsl::of);
    }
    public CollectionPredicateBuilder<LineItemQueryBuilderDsl> discountedPricePerQuantity() {
        return new CollectionPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("discountedPricePerQuantity")),
                p -> new CombinationQueryPredicate<>(p, LineItemQueryBuilderDsl::of));
    }
    ...
    public CollectionPredicateBuilder<LineItemQueryBuilderDsl> taxedPricePortions() {
        return new CollectionPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("taxedPricePortions")),
                p -> new CombinationQueryPredicate<>(p, LineItemQueryBuilderDsl::of));
    }
    ...
    public CollectionPredicateBuilder<LineItemQueryBuilderDsl> perMethodTaxRate() {
        return new CollectionPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("perMethodTaxRate")),
                p -> new CombinationQueryPredicate<>(p, LineItemQueryBuilderDsl::of));
    }
    ...
    public StringComparisonPredicateBuilder<LineItemQueryBuilderDsl> lineItemMode() {
        return new StringComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("lineItemMode")),
        p -> new CombinationQueryPredicate<>(p, LineItemQueryBuilderDsl::of));
    }
