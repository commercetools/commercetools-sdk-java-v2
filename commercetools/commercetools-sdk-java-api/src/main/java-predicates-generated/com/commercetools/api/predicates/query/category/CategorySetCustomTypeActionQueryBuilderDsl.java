...
public class CategorySetCustomTypeActionQueryBuilderDsl  {
    ...
    public StringComparisonPredicateBuilder<CategorySetCustomTypeActionQueryBuilderDsl> action() {
        return new StringComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("action")),
        p -> new CombinationQueryPredicate<>(p, CategorySetCustomTypeActionQueryBuilderDsl::of));
    }
