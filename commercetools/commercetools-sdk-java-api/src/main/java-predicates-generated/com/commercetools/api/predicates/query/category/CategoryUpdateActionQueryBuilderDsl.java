...
public class CategoryUpdateActionQueryBuilderDsl {
    ...
    public CombinationQueryPredicate<CategoryUpdateActionQueryBuilderDsl> asAddAsset(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.category.CategoryAddAssetActionQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<CategoryUpdateActionQueryBuilderDsl> asChangeAssetName(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.category.CategoryChangeAssetNameActionQueryBuilderDsl.of()),
            CategoryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CategoryUpdateActionQueryBuilderDsl> asChangeAssetOrder(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(
                com.commercetools.api.predicates.query.category.CategoryChangeAssetOrderActionQueryBuilderDsl.of()),
            CategoryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CategoryUpdateActionQueryBuilderDsl> asChangeName(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.category.CategoryChangeNameActionQueryBuilderDsl.of()),
            CategoryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CategoryUpdateActionQueryBuilderDsl> asChangeOrderHint(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.category.CategoryChangeOrderHintActionQueryBuilderDsl.of()),
            CategoryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CategoryUpdateActionQueryBuilderDsl> asChangeParent(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.category.CategoryChangeParentActionQueryBuilderDsl.of()),
            CategoryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CategoryUpdateActionQueryBuilderDsl> asChangeSlug(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.category.CategoryChangeSlugActionQueryBuilderDsl.of()),
            CategoryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CategoryUpdateActionQueryBuilderDsl> asSetAssetCustomField(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(
                com.commercetools.api.predicates.query.category.CategorySetAssetCustomFieldActionQueryBuilderDsl.of()),
            CategoryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CategoryUpdateActionQueryBuilderDsl> asSetAssetCustomType(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(
                com.commercetools.api.predicates.query.category.CategorySetAssetCustomTypeActionQueryBuilderDsl.of()),
            CategoryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CategoryUpdateActionQueryBuilderDsl> asSetAssetDescription(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(
                com.commercetools.api.predicates.query.category.CategorySetAssetDescriptionActionQueryBuilderDsl.of()),
            CategoryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CategoryUpdateActionQueryBuilderDsl> asSetAssetKey(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.category.CategorySetAssetKeyActionQueryBuilderDsl.of()),
            CategoryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CategoryUpdateActionQueryBuilderDsl> asSetAssetSources(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.category.CategorySetAssetSourcesActionQueryBuilderDsl.of()),
            CategoryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CategoryUpdateActionQueryBuilderDsl> asSetAssetTags(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.category.CategorySetAssetTagsActionQueryBuilderDsl.of()),
            CategoryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CategoryUpdateActionQueryBuilderDsl> asSetCustomField(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.category.CategorySetCustomFieldActionQueryBuilderDsl.of()),
            CategoryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CategoryUpdateActionQueryBuilderDsl> asSetCustomType(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.category.CategorySetCustomTypeActionQueryBuilderDsl.of()),
            CategoryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CategoryUpdateActionQueryBuilderDsl> asSetDescription(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.category.CategorySetDescriptionActionQueryBuilderDsl.of()),
            CategoryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CategoryUpdateActionQueryBuilderDsl> asSetExternalId(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.category.CategorySetExternalIdActionQueryBuilderDsl.of()),
            CategoryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CategoryUpdateActionQueryBuilderDsl> asSetKey(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.category.CategorySetKeyActionQueryBuilderDsl.of()),
            CategoryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CategoryUpdateActionQueryBuilderDsl> asSetMetaDescription(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(
                com.commercetools.api.predicates.query.category.CategorySetMetaDescriptionActionQueryBuilderDsl.of()),
            CategoryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CategoryUpdateActionQueryBuilderDsl> asSetMetaKeywords(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.category.CategorySetMetaKeywordsActionQueryBuilderDsl.of()),
            CategoryUpdateActionQueryBuilderDsl::of);
    }
