...
public class ResourceIdentifierQueryBuilderDsl  {
    ...
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asAssociateRole(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.associate_role.AssociateRoleResourceIdentifierQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asAttributeGroup(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.attribute_group.AttributeGroupResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asBusinessUnit(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.business_unit.BusinessUnitResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asCartDiscount(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.cart_discount.CartDiscountResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asCart(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.cart.CartResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asCategory(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.category.CategoryResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asChannel(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.channel.ChannelResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asCustomerGroup(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.customer_group.CustomerGroupResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asCustomer(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.customer.CustomerResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asDiscountCode(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.discount_code.DiscountCodeResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asInventoryEntry(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.inventory.InventoryEntryResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asOrderEdit(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.order_edit.OrderEditResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asOrder(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.order.OrderResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asPayment(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.payment.PaymentResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asProductDiscount(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.product_discount.ProductDiscountResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asProduct(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.product.ProductResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asProductSelection(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.product_selection.ProductSelectionResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asProductType(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.product_type.ProductTypeResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asQuoteRequest(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.quote_request.QuoteRequestResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asQuote(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.quote.QuoteResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asReview(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.review.ReviewResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asShippingMethod(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shipping_method.ShippingMethodResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asShoppingList(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asStagedQuote(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.staged_quote.StagedQuoteResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asStandalonePrice(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.standalone_price.StandalonePriceResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asState(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.state.StateResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asStore(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.store.StoreResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asTaxCategory(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.tax_category.TaxCategoryResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asType(
        Function<com.commercetools.api.predicates.query.type.TypeResourceIdentifierQueryBuilderDsl, CombinationQueryPredicate<com.commercetools.api.predicates.query.type.TypeResourceIdentifierQueryBuilderDsl>> fn) {
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.type.TypeResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ResourceIdentifierQueryBuilderDsl> asZone(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.zone.ZoneResourceIdentifierQueryBuilderDsl.of()),
            ResourceIdentifierQueryBuilderDsl::of);
    }
}
