...
public class CustomerUpdateActionQueryBuilderDsl {
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asAddAddress(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.customer.CustomerAddAddressActionQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asAddBillingAddressId(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(
                com.commercetools.api.predicates.query.customer.CustomerAddBillingAddressIdActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asAddShippingAddressId(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(
                com.commercetools.api.predicates.query.customer.CustomerAddShippingAddressIdActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asAddStore(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.customer.CustomerAddStoreActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asChangeAddress(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.customer.CustomerChangeAddressActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asChangeEmail(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.customer.CustomerChangeEmailActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asRemoveAddress(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.customer.CustomerRemoveAddressActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asRemoveShippingAddressId(
        ...
        return new CombinationQueryPredicate<>(fn.apply(
            com.commercetools.api.predicates.query.customer.CustomerRemoveShippingAddressIdActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asRemoveStore(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.customer.CustomerRemoveStoreActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asSetAddressCustomField(
        ...
        return new CombinationQueryPredicate<>(fn.apply(
            com.commercetools.api.predicates.query.customer.CustomerSetAddressCustomFieldActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asSetAddressCustomType(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(
                com.commercetools.api.predicates.query.customer.CustomerSetAddressCustomTypeActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asSetAuthenticationMode(
        ...
        return new CombinationQueryPredicate<>(fn.apply(
            com.commercetools.api.predicates.query.customer.CustomerSetAuthenticationModeActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asSetCompanyName(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.customer.CustomerSetCompanyNameActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asSetCustomField(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.customer.CustomerSetCustomFieldActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asSetCustomType(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.customer.CustomerSetCustomTypeActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asSetCustomerNumber(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(
                com.commercetools.api.predicates.query.customer.CustomerSetCustomerNumberActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asSetDateOfBirth(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.customer.CustomerSetDateOfBirthActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asSetDefaultBillingAddress(
        ...
        return new CombinationQueryPredicate<>(fn.apply(
            com.commercetools.api.predicates.query.customer.CustomerSetDefaultBillingAddressActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asSetDefaultShippingAddress(
        ...
        return new CombinationQueryPredicate<>(fn.apply(
            com.commercetools.api.predicates.query.customer.CustomerSetDefaultShippingAddressActionQueryBuilderDsl
                    .of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asSetExternalId(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.customer.CustomerSetExternalIdActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asSetFirstName(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.customer.CustomerSetFirstNameActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asSetKey(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.customer.CustomerSetKeyActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asSetLastName(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.customer.CustomerSetLastNameActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asSetLocale(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.customer.CustomerSetLocaleActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asSetMiddleName(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.customer.CustomerSetMiddleNameActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asSetSalutation(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.customer.CustomerSetSalutationActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asSetStores(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.customer.CustomerSetStoresActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asSetTitle(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.customer.CustomerSetTitleActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<CustomerUpdateActionQueryBuilderDsl> asSetVatId(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.customer.CustomerSetVatIdActionQueryBuilderDsl.of()),
            CustomerUpdateActionQueryBuilderDsl::of);
    }
}
