...
public class InventoryEntryUpdateActionQueryBuilderDsl {
    ...
    public CombinationQueryPredicate<InventoryEntryUpdateActionQueryBuilderDsl> asAddQuantity(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(
                com.commercetools.api.predicates.query.inventory.InventoryEntryAddQuantityActionQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<InventoryEntryUpdateActionQueryBuilderDsl> asChangeQuantity(
        ...
        return new CombinationQueryPredicate<>(fn.apply(
            com.commercetools.api.predicates.query.inventory.InventoryEntryChangeQuantityActionQueryBuilderDsl.of()),
            InventoryEntryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<InventoryEntryUpdateActionQueryBuilderDsl> asRemoveQuantity(
        ...
        return new CombinationQueryPredicate<>(fn.apply(
            com.commercetools.api.predicates.query.inventory.InventoryEntryRemoveQuantityActionQueryBuilderDsl.of()),
            InventoryEntryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<InventoryEntryUpdateActionQueryBuilderDsl> asSetCustomField(
        ...
        return new CombinationQueryPredicate<>(fn.apply(
            com.commercetools.api.predicates.query.inventory.InventoryEntrySetCustomFieldActionQueryBuilderDsl.of()),
            InventoryEntryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<InventoryEntryUpdateActionQueryBuilderDsl> asSetCustomType(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(
                com.commercetools.api.predicates.query.inventory.InventoryEntrySetCustomTypeActionQueryBuilderDsl.of()),
            InventoryEntryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<InventoryEntryUpdateActionQueryBuilderDsl> asSetExpectedDelivery(
        ...
        return new CombinationQueryPredicate<>(fn.apply(
            com.commercetools.api.predicates.query.inventory.InventoryEntrySetExpectedDeliveryActionQueryBuilderDsl
                    .of()),
            InventoryEntryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<InventoryEntryUpdateActionQueryBuilderDsl> asSetKey(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.inventory.InventoryEntrySetKeyActionQueryBuilderDsl.of()),
            InventoryEntryUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<InventoryEntryUpdateActionQueryBuilderDsl> asSetSupplyChannel(
        ...
        return new CombinationQueryPredicate<>(fn.apply(
            com.commercetools.api.predicates.query.inventory.InventoryEntrySetSupplyChannelActionQueryBuilderDsl.of()),
            InventoryEntryUpdateActionQueryBuilderDsl::of);
    }
}
