...
public class ApprovalFlowCompletedMessageQueryBuilderDsl {
    ...
    public StringComparisonPredicateBuilder<ApprovalFlowCompletedMessageQueryBuilderDsl> id() {
        return new StringComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("id")),
            p -> new CombinationQueryPredicate<>(p, ApprovalFlowCompletedMessageQueryBuilderDsl::of));
    }

    public LongComparisonPredicateBuilder<ApprovalFlowCompletedMessageQueryBuilderDsl> version() {
        return new LongComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("version")),
            p -> new CombinationQueryPredicate<>(p, ApprovalFlowCompletedMessageQueryBuilderDsl::of));
    }

    public DateTimeComparisonPredicateBuilder<ApprovalFlowCompletedMessageQueryBuilderDsl> createdAt() {
        return new DateTimeComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("createdAt")),
            p -> new CombinationQueryPredicate<>(p, ApprovalFlowCompletedMessageQueryBuilderDsl::of));
    }

    public DateTimeComparisonPredicateBuilder<ApprovalFlowCompletedMessageQueryBuilderDsl> lastModifiedAt() {
        return new DateTimeComparisonPredicateBuilder<>(
    ...
    public LongComparisonPredicateBuilder<ApprovalFlowCompletedMessageQueryBuilderDsl> sequenceNumber() {
        return new LongComparisonPredicateBuilder<>(
    ...
    public LongComparisonPredicateBuilder<ApprovalFlowCompletedMessageQueryBuilderDsl> resourceVersion() {
        return new LongComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("resourceVersion")),
            p -> new CombinationQueryPredicate<>(p, ApprovalFlowCompletedMessageQueryBuilderDsl::of));
    }

    public StringComparisonPredicateBuilder<ApprovalFlowCompletedMessageQueryBuilderDsl> type() {
    ...
    public StringComparisonPredicateBuilder<ApprovalFlowCompletedMessageQueryBuilderDsl> status() {
        return new StringComparisonPredicateBuilder<>(
