...
public class CartDiscountCreatedMessageQueryBuilderDsl {
    ...
    public StringComparisonPredicateBuilder<CartDiscountCreatedMessageQueryBuilderDsl> id() {
        return new StringComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("id")),
            p -> new CombinationQueryPredicate<>(p, CartDiscountCreatedMessageQueryBuilderDsl::of));
    }

    public LongComparisonPredicateBuilder<CartDiscountCreatedMessageQueryBuilderDsl> version() {
        return new LongComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("version")),
            p -> new CombinationQueryPredicate<>(p, CartDiscountCreatedMessageQueryBuilderDsl::of));
    }

    public DateTimeComparisonPredicateBuilder<CartDiscountCreatedMessageQueryBuilderDsl> createdAt() {
        return new DateTimeComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("createdAt")),
            p -> new CombinationQueryPredicate<>(p, CartDiscountCreatedMessageQueryBuilderDsl::of));
    }

    public DateTimeComparisonPredicateBuilder<CartDiscountCreatedMessageQueryBuilderDsl> lastModifiedAt() {
        return new DateTimeComparisonPredicateBuilder<>(
    ...
    public LongComparisonPredicateBuilder<CartDiscountCreatedMessageQueryBuilderDsl> sequenceNumber() {
        return new LongComparisonPredicateBuilder<>(
    ...
    public LongComparisonPredicateBuilder<CartDiscountCreatedMessageQueryBuilderDsl> resourceVersion() {
        return new LongComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("resourceVersion")),
            p -> new CombinationQueryPredicate<>(p, CartDiscountCreatedMessageQueryBuilderDsl::of));
    }

    public StringComparisonPredicateBuilder<CartDiscountCreatedMessageQueryBuilderDsl> type() {
