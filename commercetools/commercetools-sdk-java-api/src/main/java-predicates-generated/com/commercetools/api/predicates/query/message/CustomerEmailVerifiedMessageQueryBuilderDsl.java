...
public class CustomerEmailVerifiedMessageQueryBuilderDsl  {
    ...
    public StringComparisonPredicateBuilder<CustomerEmailVerifiedMessageQueryBuilderDsl> id() {
        return new StringComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("id")),
        p -> new CombinationQueryPredicate<>(p, CustomerEmailVerifiedMessageQueryBuilderDsl::of));
    }
    public LongComparisonPredicateBuilder<CustomerEmailVerifiedMessageQueryBuilderDsl> version() {
        return new LongComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("version")),
        p -> new CombinationQueryPredicate<>(p, CustomerEmailVerifiedMessageQueryBuilderDsl::of));
    }
    public DateTimeComparisonPredicateBuilder<CustomerEmailVerifiedMessageQueryBuilderDsl> createdAt() {
        return new DateTimeComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("createdAt")),
        p -> new CombinationQueryPredicate<>(p, CustomerEmailVerifiedMessageQueryBuilderDsl::of));
    }
    public DateTimeComparisonPredicateBuilder<CustomerEmailVerifiedMessageQueryBuilderDsl> lastModifiedAt() {
    ...
    public LongComparisonPredicateBuilder<CustomerEmailVerifiedMessageQueryBuilderDsl> sequenceNumber() {
    ...
    public LongComparisonPredicateBuilder<CustomerEmailVerifiedMessageQueryBuilderDsl> resourceVersion() {
        return new LongComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("resourceVersion")),
        p -> new CombinationQueryPredicate<>(p, CustomerEmailVerifiedMessageQueryBuilderDsl::of));
    }
    public StringComparisonPredicateBuilder<CustomerEmailVerifiedMessageQueryBuilderDsl> type() {
