...
public class DeliveryAddedMessageQueryBuilderDsl  {
    ...
    public StringComparisonPredicateBuilder<DeliveryAddedMessageQueryBuilderDsl> id() {
        return new StringComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("id")),
        p -> new CombinationQueryPredicate<>(p, DeliveryAddedMessageQueryBuilderDsl::of));
    }
    public LongComparisonPredicateBuilder<DeliveryAddedMessageQueryBuilderDsl> version() {
        return new LongComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("version")),
        p -> new CombinationQueryPredicate<>(p, DeliveryAddedMessageQueryBuilderDsl::of));
    }
    public DateTimeComparisonPredicateBuilder<DeliveryAddedMessageQueryBuilderDsl> createdAt() {
        return new DateTimeComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("createdAt")),
        p -> new CombinationQueryPredicate<>(p, DeliveryAddedMessageQueryBuilderDsl::of));
    }
    public DateTimeComparisonPredicateBuilder<DeliveryAddedMessageQueryBuilderDsl> lastModifiedAt() {
    ...
    public LongComparisonPredicateBuilder<DeliveryAddedMessageQueryBuilderDsl> sequenceNumber() {
    ...
    public LongComparisonPredicateBuilder<DeliveryAddedMessageQueryBuilderDsl> resourceVersion() {
        return new LongComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("resourceVersion")),
        p -> new CombinationQueryPredicate<>(p, DeliveryAddedMessageQueryBuilderDsl::of));
    }
    public StringComparisonPredicateBuilder<DeliveryAddedMessageQueryBuilderDsl> type() {
    ...
    public StringComparisonPredicateBuilder<DeliveryAddedMessageQueryBuilderDsl> shippingKey() {
