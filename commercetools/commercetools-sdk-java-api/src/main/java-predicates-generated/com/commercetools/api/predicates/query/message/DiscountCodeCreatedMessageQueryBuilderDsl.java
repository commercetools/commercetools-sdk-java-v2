...
public class DiscountCodeCreatedMessageQueryBuilderDsl {
    ...
    public StringComparisonPredicateBuilder<DiscountCodeCreatedMessageQueryBuilderDsl> id() {
        return new StringComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("id")),
            p -> new CombinationQueryPredicate<>(p, DiscountCodeCreatedMessageQueryBuilderDsl::of));
    }

    public LongComparisonPredicateBuilder<DiscountCodeCreatedMessageQueryBuilderDsl> version() {
        return new LongComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("version")),
            p -> new CombinationQueryPredicate<>(p, DiscountCodeCreatedMessageQueryBuilderDsl::of));
    }

    public DateTimeComparisonPredicateBuilder<DiscountCodeCreatedMessageQueryBuilderDsl> createdAt() {
        return new DateTimeComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("createdAt")),
            p -> new CombinationQueryPredicate<>(p, DiscountCodeCreatedMessageQueryBuilderDsl::of));
    }

    public DateTimeComparisonPredicateBuilder<DiscountCodeCreatedMessageQueryBuilderDsl> lastModifiedAt() {
        return new DateTimeComparisonPredicateBuilder<>(
    ...
    public LongComparisonPredicateBuilder<DiscountCodeCreatedMessageQueryBuilderDsl> sequenceNumber() {
        return new LongComparisonPredicateBuilder<>(
    ...
    public LongComparisonPredicateBuilder<DiscountCodeCreatedMessageQueryBuilderDsl> resourceVersion() {
        return new LongComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("resourceVersion")),
            p -> new CombinationQueryPredicate<>(p, DiscountCodeCreatedMessageQueryBuilderDsl::of));
    }

    public StringComparisonPredicateBuilder<DiscountCodeCreatedMessageQueryBuilderDsl> type() {
