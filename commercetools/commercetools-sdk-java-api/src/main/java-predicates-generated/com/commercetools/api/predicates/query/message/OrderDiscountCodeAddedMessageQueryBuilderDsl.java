...
public class OrderDiscountCodeAddedMessageQueryBuilderDsl {
    ...
    public StringComparisonPredicateBuilder<OrderDiscountCodeAddedMessageQueryBuilderDsl> id() {
        return new StringComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("id")),
            p -> new CombinationQueryPredicate<>(p, OrderDiscountCodeAddedMessageQueryBuilderDsl::of));
    }

    public LongComparisonPredicateBuilder<OrderDiscountCodeAddedMessageQueryBuilderDsl> version() {
        return new LongComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("version")),
            p -> new CombinationQueryPredicate<>(p, OrderDiscountCodeAddedMessageQueryBuilderDsl::of));
    }

    public DateTimeComparisonPredicateBuilder<OrderDiscountCodeAddedMessageQueryBuilderDsl> createdAt() {
        return new DateTimeComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("createdAt")),
            p -> new CombinationQueryPredicate<>(p, OrderDiscountCodeAddedMessageQueryBuilderDsl::of));
    }

    public DateTimeComparisonPredicateBuilder<OrderDiscountCodeAddedMessageQueryBuilderDsl> lastModifiedAt() {
        return new DateTimeComparisonPredicateBuilder<>(
    ...
    public LongComparisonPredicateBuilder<OrderDiscountCodeAddedMessageQueryBuilderDsl> sequenceNumber() {
        return new LongComparisonPredicateBuilder<>(
    ...
    public LongComparisonPredicateBuilder<OrderDiscountCodeAddedMessageQueryBuilderDsl> resourceVersion() {
        return new LongComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("resourceVersion")),
            p -> new CombinationQueryPredicate<>(p, OrderDiscountCodeAddedMessageQueryBuilderDsl::of));
    }

    public StringComparisonPredicateBuilder<OrderDiscountCodeAddedMessageQueryBuilderDsl> type() {
