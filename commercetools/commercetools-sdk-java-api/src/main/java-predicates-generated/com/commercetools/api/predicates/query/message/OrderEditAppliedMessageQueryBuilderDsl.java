...
public class OrderEditAppliedMessageQueryBuilderDsl {
    ...
    public StringComparisonPredicateBuilder<OrderEditAppliedMessageQueryBuilderDsl> id() {
        return new StringComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("id")),
            p -> new CombinationQueryPredicate<>(p, OrderEditAppliedMessageQueryBuilderDsl::of));
    }
    ...
    public CombinationQueryPredicate<OrderEditAppliedMessageQueryBuilderDsl> result(
        ...
        return new CombinationQueryPredicate<>(
            ContainerQueryPredicate.of()
                    ...
                    .inner(fn.apply(
                        com.commercetools.api.predicates.query.order_edit.OrderEditAppliedQueryBuilderDsl.of())),
            OrderEditAppliedMessageQueryBuilderDsl::of);
    }
