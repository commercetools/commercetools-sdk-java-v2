...
public class OrderImportedMessageQueryBuilderDsl {
    ...
    public StringComparisonPredicateBuilder<OrderImportedMessageQueryBuilderDsl> id() {
        return new StringComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("id")),
            p -> new CombinationQueryPredicate<>(p, OrderImportedMessageQueryBuilderDsl::of));
    }

    public LongComparisonPredicateBuilder<OrderImportedMessageQueryBuilderDsl> version() {
        return new LongComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("version")),
            p -> new CombinationQueryPredicate<>(p, OrderImportedMessageQueryBuilderDsl::of));
    }

    public DateTimeComparisonPredicateBuilder<OrderImportedMessageQueryBuilderDsl> createdAt() {
        return new DateTimeComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("createdAt")),
            p -> new CombinationQueryPredicate<>(p, OrderImportedMessageQueryBuilderDsl::of));
    }

    public DateTimeComparisonPredicateBuilder<OrderImportedMessageQueryBuilderDsl> lastModifiedAt() {
        return new DateTimeComparisonPredicateBuilder<>(
    ...
    public LongComparisonPredicateBuilder<OrderImportedMessageQueryBuilderDsl> sequenceNumber() {
        return new LongComparisonPredicateBuilder<>(
    ...
    public LongComparisonPredicateBuilder<OrderImportedMessageQueryBuilderDsl> resourceVersion() {
        return new LongComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("resourceVersion")),
            p -> new CombinationQueryPredicate<>(p, OrderImportedMessageQueryBuilderDsl::of));
    }

    public StringComparisonPredicateBuilder<OrderImportedMessageQueryBuilderDsl> type() {
