...
public class ProductCreatedMessageQueryBuilderDsl  {
    ...
    public StringComparisonPredicateBuilder<ProductCreatedMessageQueryBuilderDsl> id() {
        return new StringComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("id")),
        p -> new CombinationQueryPredicate<>(p, ProductCreatedMessageQueryBuilderDsl::of));
    }
    public LongComparisonPredicateBuilder<ProductCreatedMessageQueryBuilderDsl> version() {
        return new LongComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("version")),
        p -> new CombinationQueryPredicate<>(p, ProductCreatedMessageQueryBuilderDsl::of));
    }
    public DateTimeComparisonPredicateBuilder<ProductCreatedMessageQueryBuilderDsl> createdAt() {
        return new DateTimeComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("createdAt")),
        p -> new CombinationQueryPredicate<>(p, ProductCreatedMessageQueryBuilderDsl::of));
    }
    public DateTimeComparisonPredicateBuilder<ProductCreatedMessageQueryBuilderDsl> lastModifiedAt() {
    ...
    public LongComparisonPredicateBuilder<ProductCreatedMessageQueryBuilderDsl> sequenceNumber() {
    ...
    public LongComparisonPredicateBuilder<ProductCreatedMessageQueryBuilderDsl> resourceVersion() {
        return new LongComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("resourceVersion")),
        p -> new CombinationQueryPredicate<>(p, ProductCreatedMessageQueryBuilderDsl::of));
    }
    public StringComparisonPredicateBuilder<ProductCreatedMessageQueryBuilderDsl> type() {
