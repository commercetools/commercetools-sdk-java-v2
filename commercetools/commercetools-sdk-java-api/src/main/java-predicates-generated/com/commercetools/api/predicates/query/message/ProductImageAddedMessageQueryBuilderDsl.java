...
public class ProductImageAddedMessageQueryBuilderDsl  {
    ...
    public StringComparisonPredicateBuilder<ProductImageAddedMessageQueryBuilderDsl> id() {
        return new StringComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("id")),
        p -> new CombinationQueryPredicate<>(p, ProductImageAddedMessageQueryBuilderDsl::of));
    }
    public LongComparisonPredicateBuilder<ProductImageAddedMessageQueryBuilderDsl> version() {
        return new LongComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("version")),
        p -> new CombinationQueryPredicate<>(p, ProductImageAddedMessageQueryBuilderDsl::of));
    }
    public DateTimeComparisonPredicateBuilder<ProductImageAddedMessageQueryBuilderDsl> createdAt() {
        return new DateTimeComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("createdAt")),
        p -> new CombinationQueryPredicate<>(p, ProductImageAddedMessageQueryBuilderDsl::of));
    }
    public DateTimeComparisonPredicateBuilder<ProductImageAddedMessageQueryBuilderDsl> lastModifiedAt() {
    ...
    public LongComparisonPredicateBuilder<ProductImageAddedMessageQueryBuilderDsl> sequenceNumber() {
    ...
    public LongComparisonPredicateBuilder<ProductImageAddedMessageQueryBuilderDsl> resourceVersion() {
        return new LongComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("resourceVersion")),
        p -> new CombinationQueryPredicate<>(p, ProductImageAddedMessageQueryBuilderDsl::of));
    }
    public StringComparisonPredicateBuilder<ProductImageAddedMessageQueryBuilderDsl> type() {
    ...
    public LongComparisonPredicateBuilder<ProductImageAddedMessageQueryBuilderDsl> variantId() {
    ...
    public BooleanComparisonPredicateBuilder<ProductImageAddedMessageQueryBuilderDsl> staged() {
