...
public class ProductPriceChangedMessageQueryBuilderDsl {
    ...
    public StringComparisonPredicateBuilder<ProductPriceChangedMessageQueryBuilderDsl> id() {
        return new StringComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("id")),
            p -> new CombinationQueryPredicate<>(p, ProductPriceChangedMessageQueryBuilderDsl::of));
    }

    public LongComparisonPredicateBuilder<ProductPriceChangedMessageQueryBuilderDsl> version() {
        return new LongComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("version")),
            p -> new CombinationQueryPredicate<>(p, ProductPriceChangedMessageQueryBuilderDsl::of));
    }

    public DateTimeComparisonPredicateBuilder<ProductPriceChangedMessageQueryBuilderDsl> createdAt() {
        return new DateTimeComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("createdAt")),
            p -> new CombinationQueryPredicate<>(p, ProductPriceChangedMessageQueryBuilderDsl::of));
    }

    public DateTimeComparisonPredicateBuilder<ProductPriceChangedMessageQueryBuilderDsl> lastModifiedAt() {
        return new DateTimeComparisonPredicateBuilder<>(
    ...
    public LongComparisonPredicateBuilder<ProductPriceChangedMessageQueryBuilderDsl> sequenceNumber() {
        return new LongComparisonPredicateBuilder<>(
    ...
    public LongComparisonPredicateBuilder<ProductPriceChangedMessageQueryBuilderDsl> resourceVersion() {
        return new LongComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("resourceVersion")),
            p -> new CombinationQueryPredicate<>(p, ProductPriceChangedMessageQueryBuilderDsl::of));
    }

    public StringComparisonPredicateBuilder<ProductPriceChangedMessageQueryBuilderDsl> type() {
    ...
    public LongComparisonPredicateBuilder<ProductPriceChangedMessageQueryBuilderDsl> variantId() {
        return new LongComparisonPredicateBuilder<>(
    ...
    public BooleanComparisonPredicateBuilder<ProductPriceChangedMessageQueryBuilderDsl> staged() {
