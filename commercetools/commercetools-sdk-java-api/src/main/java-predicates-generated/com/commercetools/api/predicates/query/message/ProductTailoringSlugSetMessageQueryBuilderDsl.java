...
public class ProductTailoringSlugSetMessageQueryBuilderDsl {
    ...
    public StringComparisonPredicateBuilder<ProductTailoringSlugSetMessageQueryBuilderDsl> id() {
        return new StringComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("id")),
            p -> new CombinationQueryPredicate<>(p, ProductTailoringSlugSetMessageQueryBuilderDsl::of));
    }

    public LongComparisonPredicateBuilder<ProductTailoringSlugSetMessageQueryBuilderDsl> version() {
        return new LongComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("version")),
            p -> new CombinationQueryPredicate<>(p, ProductTailoringSlugSetMessageQueryBuilderDsl::of));
    }

    public DateTimeComparisonPredicateBuilder<ProductTailoringSlugSetMessageQueryBuilderDsl> createdAt() {
        return new DateTimeComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("createdAt")),
            p -> new CombinationQueryPredicate<>(p, ProductTailoringSlugSetMessageQueryBuilderDsl::of));
    }

    public DateTimeComparisonPredicateBuilder<ProductTailoringSlugSetMessageQueryBuilderDsl> lastModifiedAt() {
        return new DateTimeComparisonPredicateBuilder<>(
    ...
    public LongComparisonPredicateBuilder<ProductTailoringSlugSetMessageQueryBuilderDsl> sequenceNumber() {
        return new LongComparisonPredicateBuilder<>(
    ...
    public LongComparisonPredicateBuilder<ProductTailoringSlugSetMessageQueryBuilderDsl> resourceVersion() {
        return new LongComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("resourceVersion")),
            p -> new CombinationQueryPredicate<>(p, ProductTailoringSlugSetMessageQueryBuilderDsl::of));
    }

    public StringComparisonPredicateBuilder<ProductTailoringSlugSetMessageQueryBuilderDsl> type() {
    ...
    public StringComparisonPredicateBuilder<ProductTailoringSlugSetMessageQueryBuilderDsl> productKey() {
        return new StringComparisonPredicateBuilder<>(
