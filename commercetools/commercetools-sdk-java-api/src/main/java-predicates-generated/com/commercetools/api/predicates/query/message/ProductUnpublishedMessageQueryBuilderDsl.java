...
public class ProductUnpublishedMessageQueryBuilderDsl  {
    ...
    public StringComparisonPredicateBuilder<ProductUnpublishedMessageQueryBuilderDsl> id() {
        return new StringComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("id")),
        p -> new CombinationQueryPredicate<>(p, ProductUnpublishedMessageQueryBuilderDsl::of));
    }
    public LongComparisonPredicateBuilder<ProductUnpublishedMessageQueryBuilderDsl> version() {
        return new LongComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("version")),
        p -> new CombinationQueryPredicate<>(p, ProductUnpublishedMessageQueryBuilderDsl::of));
    }
    public DateTimeComparisonPredicateBuilder<ProductUnpublishedMessageQueryBuilderDsl> createdAt() {
        return new DateTimeComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("createdAt")),
        p -> new CombinationQueryPredicate<>(p, ProductUnpublishedMessageQueryBuilderDsl::of));
    }
    public DateTimeComparisonPredicateBuilder<ProductUnpublishedMessageQueryBuilderDsl> lastModifiedAt() {
    ...
    public LongComparisonPredicateBuilder<ProductUnpublishedMessageQueryBuilderDsl> sequenceNumber() {
    ...
    public LongComparisonPredicateBuilder<ProductUnpublishedMessageQueryBuilderDsl> resourceVersion() {
        return new LongComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("resourceVersion")),
        p -> new CombinationQueryPredicate<>(p, ProductUnpublishedMessageQueryBuilderDsl::of));
    }
    public StringComparisonPredicateBuilder<ProductUnpublishedMessageQueryBuilderDsl> type() {
