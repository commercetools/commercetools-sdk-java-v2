...
public class OrderEditResultQueryBuilderDsl {
    ...
    public CombinationQueryPredicate<OrderEditResultQueryBuilderDsl> asApplied(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.order_edit.OrderEditAppliedQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<OrderEditResultQueryBuilderDsl> asNotProcessed(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.order_edit.OrderEditNotProcessedQueryBuilderDsl.of()),
            OrderEditResultQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<OrderEditResultQueryBuilderDsl> asPreviewFailure(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.order_edit.OrderEditPreviewFailureQueryBuilderDsl.of()),
            OrderEditResultQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<OrderEditResultQueryBuilderDsl> asPreviewSuccess(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.order_edit.OrderEditPreviewSuccessQueryBuilderDsl.of()),
            OrderEditResultQueryBuilderDsl::of);
    }
}
