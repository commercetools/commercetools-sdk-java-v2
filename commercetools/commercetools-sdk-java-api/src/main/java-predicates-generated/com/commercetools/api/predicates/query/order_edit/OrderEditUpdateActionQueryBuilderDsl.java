...
public class OrderEditUpdateActionQueryBuilderDsl  {
    ...
    public CombinationQueryPredicate<OrderEditUpdateActionQueryBuilderDsl> asAddStagedAction(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.order_edit.OrderEditAddStagedActionActionQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<OrderEditUpdateActionQueryBuilderDsl> asSetComment(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.order_edit.OrderEditSetCommentActionQueryBuilderDsl.of()),
            OrderEditUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<OrderEditUpdateActionQueryBuilderDsl> asSetCustomField(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.order_edit.OrderEditSetCustomFieldActionQueryBuilderDsl.of()),
            OrderEditUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<OrderEditUpdateActionQueryBuilderDsl> asSetCustomType(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.order_edit.OrderEditSetCustomTypeActionQueryBuilderDsl.of()),
            OrderEditUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<OrderEditUpdateActionQueryBuilderDsl> asSetKey(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.order_edit.OrderEditSetKeyActionQueryBuilderDsl.of()),
            OrderEditUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<OrderEditUpdateActionQueryBuilderDsl> asSetStagedActions(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.order_edit.OrderEditSetStagedActionsActionQueryBuilderDsl.of()),
            OrderEditUpdateActionQueryBuilderDsl::of);
    }
}
