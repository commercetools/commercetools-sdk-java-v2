...
public class ProductDiscountValueQueryBuilderDsl  {
    ...
    public CombinationQueryPredicate<ProductDiscountValueQueryBuilderDsl> asAbsolute(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.product_discount.ProductDiscountValueAbsoluteQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<ProductDiscountValueQueryBuilderDsl> asExternal(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.product_discount.ProductDiscountValueExternalQueryBuilderDsl.of()),
            ProductDiscountValueQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProductDiscountValueQueryBuilderDsl> asRelative(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.product_discount.ProductDiscountValueRelativeQueryBuilderDsl.of()),
            ProductDiscountValueQueryBuilderDsl::of);
    }
}
