...
public class ProductSearchFacetDistinctValueQueryBuilderDsl {
    ...
    public StringComparisonPredicateBuilder<ProductSearchFacetDistinctValueQueryBuilderDsl> count() {
        return new StringComparisonPredicateBuilder<>(
    ...
    public CombinationQueryPredicate<ProductSearchFacetDistinctValueQueryBuilderDsl> startsWith(
            Function<com.commercetools.api.predicates.query.product_search.ProductSearchFacetDistinctStartsWithQueryBuilderDsl, CombinationQueryPredicate<com.commercetools.api.predicates.query.product_search.ProductSearchFacetDistinctStartsWithQueryBuilderDsl>> fn) {
        return new CombinationQueryPredicate<>(ContainerQueryPredicate.of()
                .parent(ConstantQueryPredicate.of().constant("startsWith"))
                .inner(fn.apply(
                    com.commercetools.api.predicates.query.product_search.ProductSearchFacetDistinctStartsWithQueryBuilderDsl
                            .of())),
            ProductSearchFacetDistinctValueQueryBuilderDsl::of);
    }
    ...
    public LongComparisonPredicateBuilder<ProductSearchFacetDistinctValueQueryBuilderDsl> size() {
        return new LongComparisonPredicateBuilder<>(BinaryQueryPredicate.of().left(new ConstantQueryPredicate("size")),
            p -> new CombinationQueryPredicate<>(p, ProductSearchFacetDistinctValueQueryBuilderDsl::of));
    }
    ...
    public StringComparisonPredicateBuilder<ProductSearchFacetDistinctValueQueryBuilderDsl> attributeType() {
        return new StringComparisonPredicateBuilder<>(
