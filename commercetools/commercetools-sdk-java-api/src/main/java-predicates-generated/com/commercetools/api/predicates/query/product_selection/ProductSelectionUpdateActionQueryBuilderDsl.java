...
public class ProductSelectionUpdateActionQueryBuilderDsl  {
    ...
    public CombinationQueryPredicate<ProductSelectionUpdateActionQueryBuilderDsl> asAddProduct(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.product_selection.ProductSelectionAddProductActionQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<ProductSelectionUpdateActionQueryBuilderDsl> asChangeName(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.product_selection.ProductSelectionChangeNameActionQueryBuilderDsl.of()),
            ProductSelectionUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProductSelectionUpdateActionQueryBuilderDsl> asExcludeProduct(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.product_selection.ProductSelectionExcludeProductActionQueryBuilderDsl.of()),
            ProductSelectionUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProductSelectionUpdateActionQueryBuilderDsl> asRemoveProduct(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.product_selection.ProductSelectionRemoveProductActionQueryBuilderDsl.of()),
            ProductSelectionUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProductSelectionUpdateActionQueryBuilderDsl> asSetCustomField(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.product_selection.ProductSelectionSetCustomFieldActionQueryBuilderDsl.of()),
            ProductSelectionUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProductSelectionUpdateActionQueryBuilderDsl> asSetCustomType(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.product_selection.ProductSelectionSetCustomTypeActionQueryBuilderDsl.of()),
            ProductSelectionUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProductSelectionUpdateActionQueryBuilderDsl> asSetKey(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.product_selection.ProductSelectionSetKeyActionQueryBuilderDsl.of()),
            ProductSelectionUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProductSelectionUpdateActionQueryBuilderDsl> asSetVariantExclusion(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.product_selection.ProductSelectionSetVariantExclusionActionQueryBuilderDsl.of()),
            ProductSelectionUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProductSelectionUpdateActionQueryBuilderDsl> asSetVariantSelection(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.product_selection.ProductSelectionSetVariantSelectionActionQueryBuilderDsl.of()),
            ProductSelectionUpdateActionQueryBuilderDsl::of);
    }
}
