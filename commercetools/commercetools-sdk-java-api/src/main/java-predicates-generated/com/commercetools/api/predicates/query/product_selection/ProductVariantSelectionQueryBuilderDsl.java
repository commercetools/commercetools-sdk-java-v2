...
public class ProductVariantSelectionQueryBuilderDsl  {
    ...
    public CombinationQueryPredicate<ProductVariantSelectionQueryBuilderDsl> asExclusion(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.product_selection.ProductVariantSelectionExclusionQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<ProductVariantSelectionQueryBuilderDsl> asIncludeAllExcept(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.product_selection.ProductVariantSelectionIncludeAllExceptQueryBuilderDsl.of()),
            ProductVariantSelectionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProductVariantSelectionQueryBuilderDsl> asIncludeOnly(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.product_selection.ProductVariantSelectionIncludeOnlyQueryBuilderDsl.of()),
            ProductVariantSelectionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProductVariantSelectionQueryBuilderDsl> asInclusion(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.product_selection.ProductVariantSelectionInclusionQueryBuilderDsl.of()),
            ProductVariantSelectionQueryBuilderDsl::of);
    }
}
