...
public class ProjectQueryBuilderDsl {
    ...
    public StringComparisonPredicateBuilder<ProjectQueryBuilderDsl> trialUntil() {
        return new StringComparisonPredicateBuilder<>(
            BinaryQueryPredicate.of().left(new ConstantQueryPredicate("trialUntil")),
            p -> new CombinationQueryPredicate<>(p, ProjectQueryBuilderDsl::of));
    }
    ...
    public CombinationQueryPredicate<ProjectQueryBuilderDsl> messages(
        ...
        return new CombinationQueryPredicate<>(
            ContainerQueryPredicate.of()
                    ...
                    .inner(fn.apply(
                        com.commercetools.api.predicates.query.message.MessagesConfigurationQueryBuilderDsl.of())),
    ...
    public CombinationQueryPredicate<ProjectQueryBuilderDsl> carts(
        ...
        return new CombinationQueryPredicate<>(
            ContainerQueryPredicate.of()
                    ...
                    .inner(fn.apply(
                        com.commercetools.api.predicates.query.project.CartsConfigurationQueryBuilderDsl.of())),
            ProjectQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<ProjectQueryBuilderDsl> searchIndexing(
        ...
        return new CombinationQueryPredicate<>(ContainerQueryPredicate.of()
                ...
                .inner(fn.apply(
                    com.commercetools.api.predicates.query.project.SearchIndexingConfigurationQueryBuilderDsl.of())),
            ProjectQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<ProjectQueryBuilderDsl> businessUnits(
        ...
        return new CombinationQueryPredicate<>(
            ContainerQueryPredicate.of()
                    ...
                    .inner(fn.apply(
                        com.commercetools.api.predicates.query.project.BusinessUnitConfigurationQueryBuilderDsl.of())),
            ProjectQueryBuilderDsl::of);
    }
