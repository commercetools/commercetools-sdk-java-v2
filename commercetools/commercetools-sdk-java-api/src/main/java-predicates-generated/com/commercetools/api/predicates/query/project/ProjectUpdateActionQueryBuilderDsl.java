...
public class ProjectUpdateActionQueryBuilderDsl  {
    ...
    public CombinationQueryPredicate<ProjectUpdateActionQueryBuilderDsl> asChangeMyBusinessUnitStatusOnCreation(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.project.ProjectChangeBusinessUnitStatusOnCreationActionQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<ProjectUpdateActionQueryBuilderDsl> asChangeCartsConfiguration(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.project.ProjectChangeCartsConfigurationActionQueryBuilderDsl.of()),
            ProjectUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProjectUpdateActionQueryBuilderDsl> asChangeCountries(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.project.ProjectChangeCountriesActionQueryBuilderDsl.of()),
            ProjectUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProjectUpdateActionQueryBuilderDsl> asChangeCountryTaxRateFallbackEnabled(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.project.ProjectChangeCountryTaxRateFallbackEnabledActionQueryBuilderDsl.of()),
            ProjectUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProjectUpdateActionQueryBuilderDsl> asChangeCurrencies(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.project.ProjectChangeCurrenciesActionQueryBuilderDsl.of()),
            ProjectUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProjectUpdateActionQueryBuilderDsl> asChangeLanguages(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.project.ProjectChangeLanguagesActionQueryBuilderDsl.of()),
            ProjectUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProjectUpdateActionQueryBuilderDsl> asChangeMessagesConfiguration(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.project.ProjectChangeMessagesConfigurationActionQueryBuilderDsl.of()),
            ProjectUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProjectUpdateActionQueryBuilderDsl> asChangeName(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.project.ProjectChangeNameActionQueryBuilderDsl.of()),
            ProjectUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProjectUpdateActionQueryBuilderDsl> asChangeOrderSearchStatus(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.project.ProjectChangeOrderSearchStatusActionQueryBuilderDsl.of()),
            ProjectUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProjectUpdateActionQueryBuilderDsl> asChangeProductSearchIndexingEnabled(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.project.ProjectChangeProductSearchIndexingEnabledActionQueryBuilderDsl.of()),
            ProjectUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProjectUpdateActionQueryBuilderDsl> asChangeShoppingListsConfiguration(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.project.ProjectChangeShoppingListsConfigurationActionQueryBuilderDsl.of()),
            ProjectUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProjectUpdateActionQueryBuilderDsl> asSetMyBusinessUnitAssociateRoleOnCreation(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.project.ProjectSetBusinessUnitAssociateRoleOnCreationActionQueryBuilderDsl.of()),
            ProjectUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProjectUpdateActionQueryBuilderDsl> asSetExternalOAuth(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.project.ProjectSetExternalOAuthActionQueryBuilderDsl.of()),
            ProjectUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ProjectUpdateActionQueryBuilderDsl> asSetShippingRateInputType(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.project.ProjectSetShippingRateInputTypeActionQueryBuilderDsl.of()),
            ProjectUpdateActionQueryBuilderDsl::of);
    }
}
