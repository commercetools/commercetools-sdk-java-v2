...
public class QuoteQueryBuilderDsl {
    ...
    public CombinationQueryPredicate<QuoteQueryBuilderDsl> quoteRequest(
        ...
        return new CombinationQueryPredicate<>(ContainerQueryPredicate.of()
                ...
                .inner(fn.apply(
                    com.commercetools.api.predicates.query.quote_request.QuoteRequestReferenceQueryBuilderDsl.of())),
            QuoteQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<QuoteQueryBuilderDsl> stagedQuote(
        ...
        return new CombinationQueryPredicate<>(
            ContainerQueryPredicate.of()
                    ...
                    .inner(fn.apply(
                        com.commercetools.api.predicates.query.staged_quote.StagedQuoteReferenceQueryBuilderDsl.of())),
            QuoteQueryBuilderDsl::of);
    }
    ...
    public StringComparisonPredicateBuilder<QuoteQueryBuilderDsl> priceRoundingMode() {
        return new StringComparisonPredicateBuilder<>(
