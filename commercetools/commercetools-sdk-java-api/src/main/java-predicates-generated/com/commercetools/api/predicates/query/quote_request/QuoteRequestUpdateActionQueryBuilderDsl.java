...
public class QuoteRequestUpdateActionQueryBuilderDsl  {
    ...
    public CombinationQueryPredicate<QuoteRequestUpdateActionQueryBuilderDsl> asChangeCustomer(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.quote_request.QuoteRequestChangeCustomerActionQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<QuoteRequestUpdateActionQueryBuilderDsl> asChangeQuoteRequestState(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.quote_request.QuoteRequestChangeQuoteRequestStateActionQueryBuilderDsl.of()),
            QuoteRequestUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<QuoteRequestUpdateActionQueryBuilderDsl> asSetCustomField(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.quote_request.QuoteRequestSetCustomFieldActionQueryBuilderDsl.of()),
            QuoteRequestUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<QuoteRequestUpdateActionQueryBuilderDsl> asSetCustomType(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.quote_request.QuoteRequestSetCustomTypeActionQueryBuilderDsl.of()),
            QuoteRequestUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<QuoteRequestUpdateActionQueryBuilderDsl> asTransitionState(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.quote_request.QuoteRequestTransitionStateActionQueryBuilderDsl.of()),
            QuoteRequestUpdateActionQueryBuilderDsl::of);
    }
}
