...
public class ReviewUpdateActionQueryBuilderDsl {
    ...
    public CombinationQueryPredicate<ReviewUpdateActionQueryBuilderDsl> asSetAuthorName(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.review.ReviewSetAuthorNameActionQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<ReviewUpdateActionQueryBuilderDsl> asSetCustomField(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.review.ReviewSetCustomFieldActionQueryBuilderDsl.of()),
            ReviewUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<ReviewUpdateActionQueryBuilderDsl> asSetCustomType(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.review.ReviewSetCustomTypeActionQueryBuilderDsl.of()),
            ReviewUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<ReviewUpdateActionQueryBuilderDsl> asSetCustomer(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.review.ReviewSetCustomerActionQueryBuilderDsl.of()),
            ReviewUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<ReviewUpdateActionQueryBuilderDsl> asSetKey(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.review.ReviewSetKeyActionQueryBuilderDsl.of()),
            ReviewUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<ReviewUpdateActionQueryBuilderDsl> asSetLocale(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.review.ReviewSetLocaleActionQueryBuilderDsl.of()),
            ReviewUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<ReviewUpdateActionQueryBuilderDsl> asSetRating(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.review.ReviewSetRatingActionQueryBuilderDsl.of()),
            ReviewUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<ReviewUpdateActionQueryBuilderDsl> asSetTarget(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.review.ReviewSetTargetActionQueryBuilderDsl.of()),
            ReviewUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<ReviewUpdateActionQueryBuilderDsl> asSetText(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.review.ReviewSetTextActionQueryBuilderDsl.of()),
            ReviewUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<ReviewUpdateActionQueryBuilderDsl> asSetTitle(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.review.ReviewSetTitleActionQueryBuilderDsl.of()),
            ReviewUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<ReviewUpdateActionQueryBuilderDsl> asTransitionState(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.review.ReviewTransitionStateActionQueryBuilderDsl.of()),
            ReviewUpdateActionQueryBuilderDsl::of);
    }
}
