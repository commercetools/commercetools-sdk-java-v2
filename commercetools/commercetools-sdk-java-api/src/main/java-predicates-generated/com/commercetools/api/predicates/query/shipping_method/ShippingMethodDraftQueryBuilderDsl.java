...
public class ShippingMethodDraftQueryBuilderDsl {
    ...
    public CombinationQueryPredicate<ShippingMethodDraftQueryBuilderDsl> zoneRates(
        ...
        return new CombinationQueryPredicate<>(
            ContainerQueryPredicate.of()
                    ...
                    .inner(fn.apply(
                        com.commercetools.api.predicates.query.shipping_method.ZoneRateDraftQueryBuilderDsl.of())),
            ShippingMethodDraftQueryBuilderDsl::of);
    }
    ...
    public BooleanComparisonPredicateBuilder<ShippingMethodDraftQueryBuilderDsl> active() {
