...
public class ShippingMethodUpdateActionQueryBuilderDsl  {
    ...
    public CombinationQueryPredicate<ShippingMethodUpdateActionQueryBuilderDsl> asAddShippingRate(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shipping_method.ShippingMethodAddShippingRateActionQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<ShippingMethodUpdateActionQueryBuilderDsl> asAddZone(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shipping_method.ShippingMethodAddZoneActionQueryBuilderDsl.of()),
            ShippingMethodUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShippingMethodUpdateActionQueryBuilderDsl> asChangeIsDefault(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shipping_method.ShippingMethodChangeIsDefaultActionQueryBuilderDsl.of()),
            ShippingMethodUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShippingMethodUpdateActionQueryBuilderDsl> asChangeName(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shipping_method.ShippingMethodChangeNameActionQueryBuilderDsl.of()),
            ShippingMethodUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShippingMethodUpdateActionQueryBuilderDsl> asChangeTaxCategory(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shipping_method.ShippingMethodChangeTaxCategoryActionQueryBuilderDsl.of()),
            ShippingMethodUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShippingMethodUpdateActionQueryBuilderDsl> asRemoveShippingRate(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shipping_method.ShippingMethodRemoveShippingRateActionQueryBuilderDsl.of()),
            ShippingMethodUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShippingMethodUpdateActionQueryBuilderDsl> asRemoveZone(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shipping_method.ShippingMethodRemoveZoneActionQueryBuilderDsl.of()),
            ShippingMethodUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShippingMethodUpdateActionQueryBuilderDsl> asSetCustomField(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shipping_method.ShippingMethodSetCustomFieldActionQueryBuilderDsl.of()),
            ShippingMethodUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShippingMethodUpdateActionQueryBuilderDsl> asSetCustomType(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shipping_method.ShippingMethodSetCustomTypeActionQueryBuilderDsl.of()),
            ShippingMethodUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShippingMethodUpdateActionQueryBuilderDsl> asSetDescription(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shipping_method.ShippingMethodSetDescriptionActionQueryBuilderDsl.of()),
            ShippingMethodUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShippingMethodUpdateActionQueryBuilderDsl> asSetKey(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shipping_method.ShippingMethodSetKeyActionQueryBuilderDsl.of()),
            ShippingMethodUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShippingMethodUpdateActionQueryBuilderDsl> asSetLocalizedDescription(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shipping_method.ShippingMethodSetLocalizedDescriptionActionQueryBuilderDsl.of()),
            ShippingMethodUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShippingMethodUpdateActionQueryBuilderDsl> asSetLocalizedName(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shipping_method.ShippingMethodSetLocalizedNameActionQueryBuilderDsl.of()),
            ShippingMethodUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShippingMethodUpdateActionQueryBuilderDsl> asSetPredicate(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shipping_method.ShippingMethodSetPredicateActionQueryBuilderDsl.of()),
            ShippingMethodUpdateActionQueryBuilderDsl::of);
    }
}
