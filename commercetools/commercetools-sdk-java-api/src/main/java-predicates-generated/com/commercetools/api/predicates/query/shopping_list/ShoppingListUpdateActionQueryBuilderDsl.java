...
public class ShoppingListUpdateActionQueryBuilderDsl  {
    ...
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asAddLineItem(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListAddLineItemActionQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asAddTextLineItem(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListAddTextLineItemActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asChangeLineItemQuantity(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListChangeLineItemQuantityActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asChangeLineItemsOrder(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListChangeLineItemsOrderActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asChangeName(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListChangeNameActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asChangeTextLineItemName(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListChangeTextLineItemNameActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asChangeTextLineItemQuantity(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListChangeTextLineItemQuantityActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asChangeTextLineItemsOrder(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListChangeTextLineItemsOrderActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asRemoveLineItem(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListRemoveLineItemActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asRemoveTextLineItem(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListRemoveTextLineItemActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asSetAnonymousId(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListSetAnonymousIdActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asSetCustomField(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListSetCustomFieldActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asSetCustomType(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListSetCustomTypeActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asSetCustomer(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListSetCustomerActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asSetDeleteDaysAfterLastModification(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListSetDeleteDaysAfterLastModificationActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asSetDescription(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListSetDescriptionActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asSetKey(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListSetKeyActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asSetLineItemCustomField(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListSetLineItemCustomFieldActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asSetLineItemCustomType(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListSetLineItemCustomTypeActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asSetSlug(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListSetSlugActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asSetStore(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListSetStoreActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asSetTextLineItemCustomField(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListSetTextLineItemCustomFieldActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asSetTextLineItemCustomType(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListSetTextLineItemCustomTypeActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<ShoppingListUpdateActionQueryBuilderDsl> asSetTextLineItemDescription(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.shopping_list.ShoppingListSetTextLineItemDescriptionActionQueryBuilderDsl.of()),
            ShoppingListUpdateActionQueryBuilderDsl::of);
    }
}
