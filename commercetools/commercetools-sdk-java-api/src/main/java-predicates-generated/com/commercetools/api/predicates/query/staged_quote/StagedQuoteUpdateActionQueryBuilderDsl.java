...
public class StagedQuoteUpdateActionQueryBuilderDsl  {
    ...
    public CombinationQueryPredicate<StagedQuoteUpdateActionQueryBuilderDsl> asChangeStagedQuoteState(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.staged_quote.StagedQuoteChangeStagedQuoteStateActionQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<StagedQuoteUpdateActionQueryBuilderDsl> asSetCustomField(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.staged_quote.StagedQuoteSetCustomFieldActionQueryBuilderDsl.of()),
            StagedQuoteUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<StagedQuoteUpdateActionQueryBuilderDsl> asSetCustomType(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.staged_quote.StagedQuoteSetCustomTypeActionQueryBuilderDsl.of()),
            StagedQuoteUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<StagedQuoteUpdateActionQueryBuilderDsl> asSetSellerComment(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.staged_quote.StagedQuoteSetSellerCommentActionQueryBuilderDsl.of()),
            StagedQuoteUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<StagedQuoteUpdateActionQueryBuilderDsl> asSetValidTo(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.staged_quote.StagedQuoteSetValidToActionQueryBuilderDsl.of()),
            StagedQuoteUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<StagedQuoteUpdateActionQueryBuilderDsl> asTransitionState(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.staged_quote.StagedQuoteTransitionStateActionQueryBuilderDsl.of()),
            StagedQuoteUpdateActionQueryBuilderDsl::of);
    }
}
