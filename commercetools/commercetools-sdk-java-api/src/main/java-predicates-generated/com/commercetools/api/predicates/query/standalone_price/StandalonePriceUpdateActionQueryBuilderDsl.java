...
public class StandalonePriceUpdateActionQueryBuilderDsl  {
    ...
    public CombinationQueryPredicate<StandalonePriceUpdateActionQueryBuilderDsl> asApplyStagedChanges(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.standalone_price.StandalonePriceApplyStagedChangesActionQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<StandalonePriceUpdateActionQueryBuilderDsl> asChangeActive(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.standalone_price.StandalonePriceChangeActiveActionQueryBuilderDsl.of()),
            StandalonePriceUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<StandalonePriceUpdateActionQueryBuilderDsl> asChangeValue(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.standalone_price.StandalonePriceChangeValueActionQueryBuilderDsl.of()),
            StandalonePriceUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<StandalonePriceUpdateActionQueryBuilderDsl> asSetCustomField(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.standalone_price.StandalonePriceSetCustomFieldActionQueryBuilderDsl.of()),
            StandalonePriceUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<StandalonePriceUpdateActionQueryBuilderDsl> asSetCustomType(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.standalone_price.StandalonePriceSetCustomTypeActionQueryBuilderDsl.of()),
            StandalonePriceUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<StandalonePriceUpdateActionQueryBuilderDsl> asSetDiscountedPrice(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.standalone_price.StandalonePriceSetDiscountedPriceActionQueryBuilderDsl.of()),
            StandalonePriceUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<StandalonePriceUpdateActionQueryBuilderDsl> asSetKey(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.standalone_price.StandalonePriceSetKeyActionQueryBuilderDsl.of()),
            StandalonePriceUpdateActionQueryBuilderDsl::of);
    }
}
