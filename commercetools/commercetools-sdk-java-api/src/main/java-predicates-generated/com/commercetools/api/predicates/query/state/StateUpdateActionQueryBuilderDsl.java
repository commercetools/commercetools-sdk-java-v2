...
public class StateUpdateActionQueryBuilderDsl {
    ...
    public CombinationQueryPredicate<StateUpdateActionQueryBuilderDsl> asAddRoles(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.state.StateAddRolesActionQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<StateUpdateActionQueryBuilderDsl> asChangeInitial(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.state.StateChangeInitialActionQueryBuilderDsl.of()),
            StateUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<StateUpdateActionQueryBuilderDsl> asChangeKey(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.state.StateChangeKeyActionQueryBuilderDsl.of()),
            StateUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<StateUpdateActionQueryBuilderDsl> asChangeType(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.state.StateChangeTypeActionQueryBuilderDsl.of()),
            StateUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<StateUpdateActionQueryBuilderDsl> asRemoveRoles(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.state.StateRemoveRolesActionQueryBuilderDsl.of()),
            StateUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<StateUpdateActionQueryBuilderDsl> asSetDescription(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.state.StateSetDescriptionActionQueryBuilderDsl.of()),
            StateUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<StateUpdateActionQueryBuilderDsl> asSetName(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.state.StateSetNameActionQueryBuilderDsl.of()),
            StateUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<StateUpdateActionQueryBuilderDsl> asSetRoles(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.state.StateSetRolesActionQueryBuilderDsl.of()),
            StateUpdateActionQueryBuilderDsl::of);
    }
    ...
    public CombinationQueryPredicate<StateUpdateActionQueryBuilderDsl> asSetTransitions(
        ...
        return new CombinationQueryPredicate<>(
            fn.apply(com.commercetools.api.predicates.query.state.StateSetTransitionsActionQueryBuilderDsl.of()),
            StateUpdateActionQueryBuilderDsl::of);
    }
}
