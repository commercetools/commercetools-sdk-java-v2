...
public class DeliveryPayloadQueryBuilderDsl  {
    ...
    public CombinationQueryPredicate<DeliveryPayloadQueryBuilderDsl> asMessage(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.subscription.MessageDeliveryPayloadQueryBuilderDsl.of()),
            DeliveryPayloadQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<DeliveryPayloadQueryBuilderDsl> asResourceCreated(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.subscription.ResourceCreatedDeliveryPayloadQueryBuilderDsl.of()),
            DeliveryPayloadQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<DeliveryPayloadQueryBuilderDsl> asResourceDeleted(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.subscription.ResourceDeletedDeliveryPayloadQueryBuilderDsl.of()),
            DeliveryPayloadQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<DeliveryPayloadQueryBuilderDsl> asResourceUpdated(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.subscription.ResourceUpdatedDeliveryPayloadQueryBuilderDsl.of()),
            DeliveryPayloadQueryBuilderDsl::of);
    }
}
