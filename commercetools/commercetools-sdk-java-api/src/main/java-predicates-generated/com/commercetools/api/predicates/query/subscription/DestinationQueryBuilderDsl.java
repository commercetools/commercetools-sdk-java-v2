...
public class DestinationQueryBuilderDsl  {
    ...
    public CombinationQueryPredicate<DestinationQueryBuilderDsl> asEventGrid(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.subscription.AzureEventGridDestinationQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<DestinationQueryBuilderDsl> asAzureServiceBus(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.subscription.AzureServiceBusDestinationQueryBuilderDsl.of()),
            DestinationQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<DestinationQueryBuilderDsl> asEventBridge(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.subscription.EventBridgeDestinationQueryBuilderDsl.of()),
            DestinationQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<DestinationQueryBuilderDsl> asGoogleCloudPubSub(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.subscription.GoogleCloudPubSubDestinationQueryBuilderDsl.of()),
            DestinationQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<DestinationQueryBuilderDsl> asSns(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.subscription.SnsDestinationQueryBuilderDsl.of()),
            DestinationQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<DestinationQueryBuilderDsl> asSqs(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.subscription.SqsDestinationQueryBuilderDsl.of()),
            DestinationQueryBuilderDsl::of);
    }
}
