...
public class TaxCategoryUpdateActionQueryBuilderDsl  {
    ...
    public CombinationQueryPredicate<TaxCategoryUpdateActionQueryBuilderDsl> asAddTaxRate(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.tax_category.TaxCategoryAddTaxRateActionQueryBuilderDsl.of()),
    ...
    public CombinationQueryPredicate<TaxCategoryUpdateActionQueryBuilderDsl> asChangeName(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.tax_category.TaxCategoryChangeNameActionQueryBuilderDsl.of()),
            TaxCategoryUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<TaxCategoryUpdateActionQueryBuilderDsl> asRemoveTaxRate(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.tax_category.TaxCategoryRemoveTaxRateActionQueryBuilderDsl.of()),
            TaxCategoryUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<TaxCategoryUpdateActionQueryBuilderDsl> asReplaceTaxRate(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.tax_category.TaxCategoryReplaceTaxRateActionQueryBuilderDsl.of()),
            TaxCategoryUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<TaxCategoryUpdateActionQueryBuilderDsl> asSetDescription(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.tax_category.TaxCategorySetDescriptionActionQueryBuilderDsl.of()),
            TaxCategoryUpdateActionQueryBuilderDsl::of);
    }
    public CombinationQueryPredicate<TaxCategoryUpdateActionQueryBuilderDsl> asSetKey(
        ...
        return new CombinationQueryPredicate<>(fn.apply(com.commercetools.api.predicates.query.tax_category.TaxCategorySetKeyActionQueryBuilderDsl.of()),
            TaxCategoryUpdateActionQueryBuilderDsl::of);
    }
}
