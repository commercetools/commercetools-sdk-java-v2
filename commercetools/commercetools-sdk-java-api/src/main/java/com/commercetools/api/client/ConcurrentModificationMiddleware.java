...
public class ConcurrentModificationMiddleware implements Middleware {
    ...
    public ConcurrentModificationMiddleware() {
        this(1, DEFAULT_INITIAL_DELAY, DEFAULT_MAX_DELAY, new ObjectMapper());
    }

    public ConcurrentModificationMiddleware(final int maxRetries) {
        this(maxRetries, DEFAULT_INITIAL_DELAY, DEFAULT_MAX_DELAY, new ObjectMapper());
    }

    public ConcurrentModificationMiddleware(final int maxRetries, final long delay, final long maxDelay) {
