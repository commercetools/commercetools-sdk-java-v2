...
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "type", defaultImpl = CentPrecisionMoneyRepresentation.class)
@JsonSubTypes({ @JsonSubTypes.Type(value = CentPrecisionMoneyRepresentation.class, name = "centPrecision"),
        @JsonSubTypes.Type(value = HighPrecisionMoneyRepresentation.class, name = "highPrecision") })
public abstract class MoneyRepresentation {
