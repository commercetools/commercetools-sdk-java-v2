        ...
        return new Object[][] {
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                ...
                                .withExpand("expand")
                                .createHttpRequest(),
                        "get", "test_projectKey/as-associate/test_associateId/business-units/test_ID?expand=expand", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .asAssociate()
                                .withAssociateIdValue("test_associateId")
                                ...
                                .get()
                                .createHttpRequest(),
                        "get", "test_projectKey/as-associate/test_associateId/business-units/test_ID", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .asAssociate()
                                .withAssociateIdValue("test_associateId")
                                ...
                                .head()
                                .createHttpRequest(),
                        "head", "test_projectKey/as-associate/test_associateId/business-units/test_ID", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .asAssociate()
                                .withAssociateIdValue("test_associateId")
                                ...
                                .withExpand("expand")
                                .createHttpRequest(),
                        "post", "test_projectKey/as-associate/test_associateId/business-units/test_ID?expand=expand", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .asAssociate()
                                .withAssociateIdValue("test_associateId")
