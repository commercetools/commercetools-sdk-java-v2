...
public class ByProjectKeyAsAssociateByAssociateIdInBusinessUnitKeyByBusinessUnitKeyApprovalRulesKeyByKeyTest {
        ...
        return new Object[][] { new Object[] {
                ...
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                ...
                                .approvalRules()
                                .withKey("test_key")
                                .post(com.commercetools.api.models.approval_rule.ApprovalRuleUpdate.of())
                                .withExpand("expand")
                                .createHttpRequest(),
                        "post",
                        "test_projectKey/as-associate/test_associateId/in-business-unit/key=test_businessUnitKey/approval-rules/key=test_key?expand=expand", },
