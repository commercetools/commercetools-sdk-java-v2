...
public class ByProjectKeyCartsByIDTest {
    ...
    private Object[] requestWithMethodParameters() {
        return new Object[] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .delete()
                        .withVersion(2)
                        .createHttpRequest(), "delete", "/test_projectKey/carts/test_ID?version=2", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .carts()
                        .withId("test_ID")
                        .delete()
        ...
        return new Object[] {
                new Object[] {
                        new ApiHttpRequest(ApiHttpMethod.GET,
                            new ByProjectKeyCartsByIDGet(apiHttpClientMock, projectKey, null).createHttpRequest()
                                    .getUri(),
                            null, null) },
                new Object[] {
                        new ApiHttpRequest(ApiHttpMethod.GET,
                ...
                new Object[] { new ApiHttpRequest(ApiHttpMethod.POST,
                    new ByProjectKeyCartsByIDPost(apiHttpClientMock, projectKey, null, null).createHttpRequest()
                            .getUri(),
                    null, null) },
                new Object[] { new ApiHttpRequest(ApiHttpMethod.POST,
                    new ByProjectKeyCartsByIDPost(apiHttpClientMock, projectKey, null, null).createHttpRequest()
                ...
                new Object[] {
                        new ApiHttpRequest(ApiHttpMethod.DELETE,
                            new ByProjectKeyCartsByIDDelete(apiHttpClientMock, projectKey, null).createHttpRequest()
                                    .getUri(),
                            null, null) },
                new Object[] {
                        new ApiHttpRequest(ApiHttpMethod.DELETE,
                ...
                new Object[] { new ApiHttpRequest(ApiHttpMethod.DELETE,
                    new ByProjectKeyCartsByIDDelete(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(),
                    null, null) } };
    }
}
