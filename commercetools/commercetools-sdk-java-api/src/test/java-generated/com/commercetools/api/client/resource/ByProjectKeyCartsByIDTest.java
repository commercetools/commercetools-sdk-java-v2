    ...
    public static Object[][] executeMethodParameters() {
        return new Object[][] { new Object[] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .post(null)
                        .withExpand("expand"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").carts().withId("test_ID").post(null), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .carts()
                        .withId("test_ID")
                        .delete()
                        .withDataErasure(true), },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").carts().withId("test_ID").delete().withVersion(2), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .carts()
                        .withId("test_ID")
                        .delete()
                        .withExpand("expand"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").carts().withId("test_ID").delete(), } };
    }
}
