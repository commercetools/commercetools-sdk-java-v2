...
public class ByProjectKeyChannelsTest {
    ...
    public static Object[][] executeMethodParameters() {
        return new Object[][] {
                new Object[] { apiRoot.withProjectKey("test_projectKey").channels().get().withExpand("expand"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").channels().get().withSort("sort"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").channels().get().withLimit(7), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").channels().get().withOffset(3), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").channels().get().withWithTotal(true), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").channels().get().withWhere("where"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .channels()
                        .get()
                        .withPredicateVar("varName", "var.varName"), },
