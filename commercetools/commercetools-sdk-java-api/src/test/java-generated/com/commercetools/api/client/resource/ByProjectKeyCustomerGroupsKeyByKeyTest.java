...
public class ByProjectKeyCustomerGroupsKeyByKeyTest {
    ...
    public static Object[][] requestWithMethodParameters() {
        return new Object[][] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .withKey("test_key")
                        .head()
                        .createHttpRequest(), "head", "test_projectKey/customer-groups/key=test_key", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .customerGroups()
                                .withKey("test_key")
    ...
    public static Object[][] executeMethodParameters() {
        return new Object[][] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey").customerGroups().withKey("test_key").head(), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .customerGroups()
                        .withKey("test_key")
                        .post(com.commercetools.api.models.customer_group.CustomerGroupUpdate.of())
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .withExpand("expand"), },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").customerGroups().withKey("test_key").delete(), } };
    }
}
