        ...
        return new Object[] {
                new Object[] {
                        new ApiHttpRequest(ApiHttpMethod.GET,
                            new ByProjectKeyCustomerGroupsGet(apiHttpClientMock, projectKey).createHttpRequest()
                                    .getUri(),
                            null, null) },
                new Object[] {
                        new ApiHttpRequest(ApiHttpMethod.GET,
                ...
                new Object[] { new ApiHttpRequest(ApiHttpMethod.POST,
                    new ByProjectKeyCustomerGroupsPost(apiHttpClientMock, projectKey, null).createHttpRequest()
                            .getUri(),
                    null, null) },
                new Object[] { new ApiHttpRequest(ApiHttpMethod.POST,
                    new ByProjectKeyCustomerGroupsPost(apiHttpClientMock, projectKey, null).createHttpRequest()
