...
public class ByProjectKeyDiscountCodesTest {
    ...
    private Object[] requestWithMethodParameters() {
        return new Object[] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .get()
                        .withLimit(7)
                        .createHttpRequest(), "get", "/test_projectKey/discount-codes?limit=7", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .discountCodes()
                        .get()
                        .withOffset(3)
                        .createHttpRequest(), "get", "/test_projectKey/discount-codes?offset=3", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .discountCodes()
                        .get()
                        .withWithTotal(true)
    ...
    private Object[] executeMethodParameters() {
        return new Object[] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey").discountCodes().get().withSort("sort"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").discountCodes().get().withLimit(7), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").discountCodes().get().withOffset(3), },
