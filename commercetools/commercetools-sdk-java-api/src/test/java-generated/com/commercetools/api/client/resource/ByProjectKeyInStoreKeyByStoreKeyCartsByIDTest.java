    ...
    private Object[] requestWithMethodParameters() {
        return new Object[] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .carts()
                        .withId("test_ID")
                        .get(), "get", "test_projectKey/in-store/key=test_storeKey/carts/test_ID", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .carts()
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .carts()
                        .withId("test_ID")
                        .post(null), "post", "test_projectKey/in-store/key=test_storeKey/carts/test_ID", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .carts()
                ...
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                ...
                                .delete()
                                .withVersion(7L),
                        "delete", "test_projectKey/in-store/key=test_storeKey/carts/test_ID?version=7L", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .carts()
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .carts()
                        .withId("test_ID")
                        .delete(), "delete", "test_projectKey/in-store/key=test_storeKey/carts/test_ID", } };
    }
