    ...
    private Object[] requestWithMethodParameters() {
        return new Object[] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .carts()
                        .withKey("test_key")
                        .get(), "get", "test_projectKey/in-store/key=test_storeKey/carts/key=test_key", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .carts()
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .carts()
                        .withKey("test_key")
                        .post(null), "post", "test_projectKey/in-store/key=test_storeKey/carts/key=test_key", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .carts()
                ...
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                ...
                                .delete()
                                .withVersion(9L),
                        "delete", "test_projectKey/in-store/key=test_storeKey/carts/key=test_key?version=9L", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .carts()
