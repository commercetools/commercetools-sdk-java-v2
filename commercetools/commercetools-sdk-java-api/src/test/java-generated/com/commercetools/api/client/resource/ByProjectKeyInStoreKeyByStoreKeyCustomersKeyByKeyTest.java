...
public class ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyTest {
    ...
    private Object[] executeMethodParameters() {
        return new Object[] {
                new Object[] { new ApiHttpRequest(ApiHttpMethod.GET,
                    new ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyGet(apiHttpClientMock, projectKey, null, null)
                            .createHttpRequest()
                            .getUri(),
                    null, null) },
                new Object[] { new ApiHttpRequest(ApiHttpMethod.GET,
                ...
                new Object[] { new ApiHttpRequest(ApiHttpMethod.POST,
                    new ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyPost(apiHttpClientMock, projectKey, null, null,
                ...
                new Object[] { new ApiHttpRequest(ApiHttpMethod.DELETE,
                    new ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyDelete(apiHttpClientMock, projectKey, null,
                        null).createHttpRequest().getUri(),
                    null, null) },
                new Object[] { new ApiHttpRequest(ApiHttpMethod.DELETE,
                    new ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyDelete(apiHttpClientMock, projectKey, null,
                ...
                new Object[] {
                        new ApiHttpRequest(ApiHttpMethod.DELETE,
                            new ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyDelete(apiHttpClientMock, projectKey,
