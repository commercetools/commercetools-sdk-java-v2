...
public class ByProjectKeyInStoreKeyByStoreKeyMeOrdersTest {
    ...
    private Object[] requestWithMethodParameters() {
        return new Object[] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .orders()
                        .get()
                        .withLimit(9), "get", "test_projectKey/in-store/key=test_storeKey/me/orders?limit=9", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .me()
                                ...
                                .get()
                                .withOffset(4),
                        "get", "test_projectKey/in-store/key=test_storeKey/me/orders?offset=4", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .me()
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .me()
                        .orders()
                        .get(), "get", "test_projectKey/in-store/key=test_storeKey/me/orders", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .me()
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .me()
                        .orders()
                        .post(null), "post", "test_projectKey/in-store/key=test_storeKey/me/orders", } };
    }
    ...
    private Object[] resourcesParameters() {
        return new Object[] { new Object[] { apiRoot.withProjectKey("test_projectKey")
                ...
                .me()
                .orders()
                .withId("test_ID"), "test_projectKey/in-store/key=test_storeKey/me/orders/test_ID", } };
    }

    private Object[] executeMethodParameters() {
        return new Object[] { new Object[] { new ApiHttpRequest(ApiHttpMethod.GET,
            new ByProjectKeyInStoreKeyByStoreKeyMeOrdersGet(apiHttpClientMock, projectKey, null).createHttpRequest()
                    .getUri(),
            null, null) },
                new Object[] { new ApiHttpRequest(ApiHttpMethod.GET,
                    new ByProjectKeyInStoreKeyByStoreKeyMeOrdersGet(apiHttpClientMock, projectKey, null)
                            .createHttpRequest()
                            .getUri(),
                    null, null) },
                new Object[] { new ApiHttpRequest(ApiHttpMethod.GET,
                ...
                new Object[] { new ApiHttpRequest(ApiHttpMethod.POST,
                    new ByProjectKeyInStoreKeyByStoreKeyMeOrdersPost(apiHttpClientMock, projectKey, null, null)
                            .createHttpRequest()
                            .getUri(),
                    null, null) },
                new Object[] { new ApiHttpRequest(ApiHttpMethod.POST,
