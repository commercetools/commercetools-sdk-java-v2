...
public class ByProjectKeyInStoreKeyByStoreKeyMeShoppingListsKeyByKeyTest {
        ...
        return new Object[][] {
                ...
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                ...
                                .get()
                                .createHttpRequest(),
                        "get", "test_projectKey/in-store/key=test_storeKey/me/shopping-lists/key=test_key", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .me()
                                ...
                                .head()
                                .createHttpRequest(),
                        "head", "test_projectKey/in-store/key=test_storeKey/me/shopping-lists/key=test_key", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .me()
                ...
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                ...
                                .delete()
                                .createHttpRequest(),
                        "delete", "test_projectKey/in-store/key=test_storeKey/me/shopping-lists/key=test_key", } };
    }
