        ...
        return new Object[][] {
                ...
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                ...
                                .head()
                                .createHttpRequest(),
                        "head", "test_projectKey/in-store/key=test_storeKey/shopping-lists/key=test_key", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .shoppingLists()
                ...
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                ...
                                .withVersion(2)
                                .createHttpRequest(),
                        "delete", "test_projectKey/in-store/key=test_storeKey/shopping-lists/key=test_key?version=2", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .shoppingLists()
