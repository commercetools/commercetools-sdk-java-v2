...
public class ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyTest {
    ...
    private Object[] executeMethodParameters() {
        return new Object[] {
                new Object[] { new ApiHttpRequest(ApiHttpMethod.GET,
                    new ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyGet(apiHttpClientMock, projectKey, null,
                ...
                new Object[] { new ApiHttpRequest(ApiHttpMethod.POST,
                    new ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyPost(apiHttpClientMock, projectKey, null,
                ...
                new Object[] { new ApiHttpRequest(ApiHttpMethod.DELETE,
                    new ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyDelete(apiHttpClientMock, projectKey, null,
                        null).createHttpRequest().getUri(),
                    null, null) },
                new Object[] { new ApiHttpRequest(ApiHttpMethod.DELETE,
                    new ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyDelete(apiHttpClientMock, projectKey, null,
                ...
                new Object[] {
                        new ApiHttpRequest(ApiHttpMethod.DELETE,
                            new ByProjectKeyInStoreKeyByStoreKeyShoppingListsKeyByKeyDelete(apiHttpClientMock,
