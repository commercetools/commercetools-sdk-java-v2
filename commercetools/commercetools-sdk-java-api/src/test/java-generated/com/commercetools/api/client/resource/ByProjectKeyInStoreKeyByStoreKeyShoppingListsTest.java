        ...
        return new Object[] {
                ...
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                ...
                                .get()
                                .withLimit(6),
                        "get", "test_projectKey/in-store/key=test_storeKey/shopping-lists?limit=6", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .shoppingLists()
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .inStoreKeyWithStoreKeyValue("test_storeKey")
                        .shoppingLists()
                        .get(), "get", "test_projectKey/in-store/key=test_storeKey/shopping-lists", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .shoppingLists()
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .inStoreKeyWithStoreKeyValue("test_storeKey")
                        .shoppingLists()
                        .post(null), "post", "test_projectKey/in-store/key=test_storeKey/shopping-lists", } };
    }
    ...
    private Object[] executeMethodParameters() {
        return new Object[] {
                new Object[] { new ApiHttpRequest(ApiHttpMethod.GET,
                    new ByProjectKeyInStoreKeyByStoreKeyShoppingListsGet(apiHttpClientMock, projectKey, null)
                            .createHttpRequest()
                            .getUri(),
                    null, null) },
                new Object[] { new ApiHttpRequest(ApiHttpMethod.GET,
                ...
                new Object[] { new ApiHttpRequest(ApiHttpMethod.POST,
                    new ByProjectKeyInStoreKeyByStoreKeyShoppingListsPost(apiHttpClientMock, projectKey, null, null)
                            .createHttpRequest()
                            .getUri(),
                    null, null) },
                new Object[] { new ApiHttpRequest(ApiHttpMethod.POST,
