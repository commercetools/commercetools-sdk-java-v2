...
public class ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsByIDTest {
        ...
        return new Object[][] {
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                ...
                                .withStaged(true)
                                .createHttpRequest(),
                        "get", "test_projectKey/in-store/key=test_storeKey/variant-projections/test_ID?staged=true", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .variantProjections()
                ...
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                ...
                                .get()
                                .createHttpRequest(),
                        "get", "test_projectKey/in-store/key=test_storeKey/variant-projections/test_ID", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .variantProjections()
                                ...
                                .withStaged(true)
                                .createHttpRequest(),
                        "head", "test_projectKey/in-store/key=test_storeKey/variant-projections/test_ID?staged=true", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .variantProjections()
                ...
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                ...
                                .head()
                                .createHttpRequest(),
                        "head", "test_projectKey/in-store/key=test_storeKey/variant-projections/test_ID", } };
    }
