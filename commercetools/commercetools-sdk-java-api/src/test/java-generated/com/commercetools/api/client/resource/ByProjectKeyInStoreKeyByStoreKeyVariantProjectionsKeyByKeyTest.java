...
public class ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsKeyByKeyTest {
        ...
        return new Object[][] {
                ...
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                ...
                                .get()
                                .createHttpRequest(),
                        "get", "test_projectKey/in-store/key=test_storeKey/variant-projections/key=test_key", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .variantProjections()
                ...
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                ...
                                .head()
                                .createHttpRequest(),
                        "head", "test_projectKey/in-store/key=test_storeKey/variant-projections/key=test_key", } };
    }
