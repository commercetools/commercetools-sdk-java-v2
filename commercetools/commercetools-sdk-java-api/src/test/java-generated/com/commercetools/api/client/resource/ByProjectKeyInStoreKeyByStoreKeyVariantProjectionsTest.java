...
public class ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsTest {
        ...
        return new Object[][] {
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                ...
                                .withStaged(true)
                                .createHttpRequest(),
                        "get", "test_projectKey/in-store/key=test_storeKey/variant-projections?staged=true", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .variantProjections()
                ...
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                ...
                                .withExpand("expand")
                                .createHttpRequest(),
                        "get", "test_projectKey/in-store/key=test_storeKey/variant-projections?expand=expand", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .variantProjections()
                                ...
                                .withSort("sort")
                                .createHttpRequest(),
                        "get", "test_projectKey/in-store/key=test_storeKey/variant-projections?sort=sort", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .variantProjections()
                                ...
                                .withLimit(7)
                                .createHttpRequest(),
                        "get", "test_projectKey/in-store/key=test_storeKey/variant-projections?limit=7", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .variantProjections()
                                ...
                                .withOffset(3)
                                .createHttpRequest(),
                        "get", "test_projectKey/in-store/key=test_storeKey/variant-projections?offset=3", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .variantProjections()
                                ...
                                .withWithTotal(true)
                                .createHttpRequest(),
                        "get", "test_projectKey/in-store/key=test_storeKey/variant-projections?withTotal=true", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .variantProjections()
                                ...
                                .withWhere("where")
                                .createHttpRequest(),
                        "get", "test_projectKey/in-store/key=test_storeKey/variant-projections?where=where", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .variantProjections()
                ...
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                ...
                                .get()
                                .createHttpRequest(),
                        "get", "test_projectKey/in-store/key=test_storeKey/variant-projections", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .variantProjections()
                                ...
                                .withWhere("where")
                                .createHttpRequest(),
                        "head", "test_projectKey/in-store/key=test_storeKey/variant-projections?where=where", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .variantProjections()
                                ...
                                .withStaged(true)
                                .createHttpRequest(),
                        "head", "test_projectKey/in-store/key=test_storeKey/variant-projections?staged=true", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .inStoreKeyWithStoreKeyValue("test_storeKey")
                                .variantProjections()
                ...
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                ...
                                .head()
                                .createHttpRequest(),
                        "head", "test_projectKey/in-store/key=test_storeKey/variant-projections", } };
    }
