...
public class ByProjectKeyInventoryByIDTest {
    ...
    private Object[] requestWithMethodParameters() {
        return new Object[] { new Object[] {
                ...
                "get", "test_projectKey/inventory/test_ID?expand=expand", },
                new Object[] { apiRoot.withProjectKey("test_projectKey").inventory().withId("test_ID").get(), "get",
                        "test_projectKey/inventory/test_ID", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .inventory()
                        .withId("test_ID")
                        .post(null)
                        .withExpand("expand"), "post", "test_projectKey/inventory/test_ID?expand=expand", },
                new Object[] { apiRoot.withProjectKey("test_projectKey").inventory().withId("test_ID").post(null),
                        "post", "test_projectKey/inventory/test_ID", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .inventory()
                        .withId("test_ID")
                        .delete()
                        .withVersion(4L), "delete", "test_projectKey/inventory/test_ID?version=4L", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .inventory()
                        .withId("test_ID")
                        .delete()
                        .withExpand("expand"), "delete", "test_projectKey/inventory/test_ID?expand=expand", },
                new Object[] { apiRoot.withProjectKey("test_projectKey").inventory().withId("test_ID").delete(),
                        "delete", "test_projectKey/inventory/test_ID", } };
    }
