...
public class ByProjectKeyMeBusinessUnitsTest {
    ...
    public static Object[][] executeMethodParameters() {
        return new Object[][] {
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").me().businessUnits().get().withExpand("expand"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().businessUnits().get().withSort("sort"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().businessUnits().get().withLimit(7), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().businessUnits().get().withOffset(3), },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").me().businessUnits().get().withWithTotal(true), },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").me().businessUnits().get().withWhere("where"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .me()
                        .businessUnits()
                        .get()
