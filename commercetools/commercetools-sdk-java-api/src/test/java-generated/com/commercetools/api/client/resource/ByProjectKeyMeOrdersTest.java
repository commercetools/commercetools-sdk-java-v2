...
public class ByProjectKeyMeOrdersTest {
    ...
    public static Object[][] requestWithMethodParameters() {
        return new Object[][] { new Object[] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .head()
                        .withWhere("where")
                        .createHttpRequest(), "head", "test_projectKey/me/orders?where=where", },
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().orders().head().createHttpRequest(),
                        "head", "test_projectKey/me/orders", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .me()
                        .orders()
    ...
    public static Object[][] executeMethodParameters() {
        return new Object[][] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().orders().get().withSort("sort"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().orders().get().withLimit(7), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().orders().get().withOffset(3), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().orders().get().withWithTotal(true), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().orders().get().withWhere("where"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .me()
                        .orders()
                        .get()
                        .withPredicateVar("varName", "var.varName"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().orders().get(), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().orders().head().withWhere("where"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().orders().head(), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .me()
                        .orders()
                        .post(com.commercetools.api.models.me.MyOrderFromCartDraft.of())
