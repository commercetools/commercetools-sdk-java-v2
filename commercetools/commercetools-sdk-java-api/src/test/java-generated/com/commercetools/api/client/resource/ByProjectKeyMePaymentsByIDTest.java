    ...
    private Object[] requestWithMethodParameters() {
        return new Object[] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .delete()
                        .withVersion(2)
                        .createHttpRequest(), "delete", "/test_projectKey/me/payments/test_ID?version=2", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .me()
                        .payments()
                        .withId("test_ID")
    ...
    private Object[] executeMethodParameters() {
        return new Object[] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .withExpand("expand"), },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").me().payments().withId("test_ID").post(null), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .me()
                        .payments()
                        .withId("test_ID")
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .withExpand("expand"), },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").me().payments().withId("test_ID").delete(), } };
    }
}
