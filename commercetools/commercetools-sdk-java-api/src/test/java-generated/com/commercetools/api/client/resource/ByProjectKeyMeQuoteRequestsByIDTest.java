...
public class ByProjectKeyMeQuoteRequestsByIDTest {
    ...
    public static Object[][] requestWithMethodParameters() {
        return new Object[][] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .withId("test_ID")
                        .head()
                        .createHttpRequest(), "head", "test_projectKey/me/quote-requests/test_ID", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .me()
                                .quoteRequests()
                                ...
                                .withExpand("expand")
                                .createHttpRequest(),
                        "post", "test_projectKey/me/quote-requests/test_ID?expand=expand", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .me()
                        .quoteRequests()
                        .withId("test_ID")
    ...
    public static Object[][] executeMethodParameters() {
        return new Object[][] {
                ...
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").me().quoteRequests().withId("test_ID").head(), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .me()
                        .quoteRequests()
                        .withId("test_ID")
