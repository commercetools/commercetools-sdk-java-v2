...
public class ByProjectKeyMeQuoteRequestsTest {
    ...
    public static Object[][] requestWithMethodParameters() {
        return new Object[][] {
                ...
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").me().quoteRequests().post(null).createHttpRequest(),
                        "post", "/test_projectKey/me/quote-requests", } };
    }
    ...
    public static Object[][] executeMethodParameters() {
        return new Object[][] {
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").me().quoteRequests().get().withExpand("expand"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().quoteRequests().get().withSort("sort"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().quoteRequests().get().withLimit(7), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().quoteRequests().get().withOffset(3), },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").me().quoteRequests().get().withWithTotal(true), },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").me().quoteRequests().get().withWhere("where"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .me()
                        .quoteRequests()
                        .get()
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .post(null)
                        .withExpand("expand"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().quoteRequests().post(null), } };
    }
}
