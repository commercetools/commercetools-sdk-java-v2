...
public class ByProjectKeyMeTest {
    ...
    private Object[] executeMethodParameters() {
        return new Object[] { new Object[] { apiRoot.withProjectKey("test_projectKey").me().get().withSort("sort"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().get().withLimit(7), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().get().withOffset(3), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().get().withWithTotal(true), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().get().withExpand("expand"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").me().get().withWhere("where"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .me()
                        .get()
                        .withPredicateVar("varName", "var.varName"), },
