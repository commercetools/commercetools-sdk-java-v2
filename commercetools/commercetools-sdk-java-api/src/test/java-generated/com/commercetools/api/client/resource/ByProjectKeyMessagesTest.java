...
public class ByProjectKeyMessagesTest {
    ...
    private Object[] executeMethodParameters() {
        return new Object[] {
                new Object[] { apiRoot.withProjectKey("test_projectKey").messages().get().withExpand("expand"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").messages().get().withSort("sort"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").messages().get().withLimit(7), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").messages().get().withOffset(3), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").messages().get().withWithTotal(true), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").messages().get().withWhere("where"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .messages()
                        .get()
                        .withPredicateVar("varName", "var.varName"), },
