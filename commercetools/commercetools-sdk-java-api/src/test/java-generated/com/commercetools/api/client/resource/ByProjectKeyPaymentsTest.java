...
public class ByProjectKeyPaymentsTest {
    ...
    public static Object[][] requestWithMethodParameters() {
        return new Object[][] { new Object[] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .head()
                        .withWhere("where")
                        .createHttpRequest(), "head", "test_projectKey/payments?where=where", },
                new Object[] { apiRoot.withProjectKey("test_projectKey").payments().head().createHttpRequest(), "head",
                        "test_projectKey/payments", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .payments()
    ...
    public static Object[][] executeMethodParameters() {
        return new Object[][] {
                new Object[] { apiRoot.withProjectKey("test_projectKey").payments().get().withExpand("expand"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").payments().get().withSort("sort"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").payments().get().withLimit(7), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").payments().get().withOffset(3), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").payments().get().withWithTotal(true), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").payments().get().withWhere("where"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .payments()
                        .get()
                        .withPredicateVar("varName", "var.varName"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").payments().get(), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").payments().head().withWhere("where"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").payments().head(), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .payments()
                        .post(com.commercetools.api.models.payment.PaymentDraft.of())
                        .withExpand("expand"), },
