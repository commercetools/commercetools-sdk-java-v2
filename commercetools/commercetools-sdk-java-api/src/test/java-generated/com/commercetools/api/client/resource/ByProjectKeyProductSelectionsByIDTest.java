...
public class ByProjectKeyProductSelectionsByIDTest {
    ...
    public static Object[][] requestWithMethodParameters() {
        return new Object[][] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .withId("test_ID")
                        .head()
                        .createHttpRequest(), "head", "test_projectKey/product-selections/test_ID", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .productSelections()
                                .withId("test_ID")
    ...
    public static Object[][] executeMethodParameters() {
        return new Object[][] {
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .get()
                        .withExpand("expand"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").productSelections().withId("test_ID").get(), },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").productSelections().withId("test_ID").head(), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .productSelections()
                        .withId("test_ID")
                        .post(com.commercetools.api.models.product_selection.ProductSelectionUpdate.of())
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .withExpand("expand"), },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").productSelections().withId("test_ID").delete(), } };
    }
}
