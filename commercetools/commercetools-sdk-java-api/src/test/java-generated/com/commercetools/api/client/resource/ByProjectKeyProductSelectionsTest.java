...
public class ByProjectKeyProductSelectionsTest {
    ...
    public static Object[][] requestWithMethodParameters() {
        return new Object[][] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .head()
                        .withWhere("where")
                        .createHttpRequest(), "head", "test_projectKey/product-selections?where=where", },
                new Object[] { apiRoot.withProjectKey("test_projectKey").productSelections().head().createHttpRequest(),
                        "head", "test_projectKey/product-selections", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .productSelections()
    ...
    public static Object[][] executeMethodParameters() {
        return new Object[][] {
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").productSelections().get().withExpand("expand"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").productSelections().get().withSort("sort"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").productSelections().get().withLimit(7), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").productSelections().get().withOffset(3), },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").productSelections().get().withWithTotal(true), },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").productSelections().get().withWhere("where"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .productSelections()
                        .get()
                        .withPredicateVar("varName", "var.varName"), },
                ...
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").productSelections().head().withWhere("where"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").productSelections().head(), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .productSelections()
                        .post(com.commercetools.api.models.product_selection.ProductSelectionDraft.of())
                        .withExpand("expand"), },
