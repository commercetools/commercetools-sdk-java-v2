...
public class ByProjectKeyProductTypesKeyByKeyTest {
    ...
    public static Object[][] executeMethodParameters() {
        return new Object[][] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey").productTypes().withKey("test_key").head(), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .productTypes()
                        .withKey("test_key")
                        .post(null)
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .withExpand("expand"), },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").productTypes().withKey("test_key").delete(), } };
    }
}
