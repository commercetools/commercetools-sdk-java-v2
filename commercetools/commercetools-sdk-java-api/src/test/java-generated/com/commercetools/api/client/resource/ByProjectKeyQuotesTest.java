...
public class ByProjectKeyQuotesTest {
    ...
    public static Object[][] requestWithMethodParameters() {
        return new Object[][] { new Object[] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .head()
                        .withWhere("where")
                        .createHttpRequest(), "head", "test_projectKey/quotes?where=where", },
                new Object[] { apiRoot.withProjectKey("test_projectKey").quotes().head().createHttpRequest(), "head",
                        "test_projectKey/quotes", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .quotes()
    ...
    public static Object[][] executeMethodParameters() {
        return new Object[][] {
                new Object[] { apiRoot.withProjectKey("test_projectKey").quotes().get().withExpand("expand"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").quotes().get().withSort("sort"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").quotes().get().withLimit(7), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").quotes().get().withOffset(3), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").quotes().get().withWithTotal(true), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").quotes().get().withWhere("where"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .quotes()
                        .get()
                        .withPredicateVar("varName", "var.varName"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").quotes().get(), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").quotes().head().withWhere("where"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").quotes().head(), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .quotes()
                        .post(com.commercetools.api.models.quote.QuoteDraft.of())
                        .withExpand("expand"), },
