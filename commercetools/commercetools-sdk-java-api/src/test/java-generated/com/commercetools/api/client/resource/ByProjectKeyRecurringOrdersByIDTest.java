        ...
        return new Object[][] {
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                ...
                                .withExpand("expand")
                                .createHttpRequest(),
                        "get", "test_projectKey/recurring-orders/test_ID?expand=expand", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .recurringOrders()
                        .withId("test_ID")
                        .get()
                        .createHttpRequest(), "get", "test_projectKey/recurring-orders/test_ID", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .recurringOrders()
                        .withId("test_ID")
                        .head()
                        .createHttpRequest(), "head", "test_projectKey/recurring-orders/test_ID", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .recurringOrders()
                                .withId("test_ID")
                                ...
                                .withExpand("expand")
                                .createHttpRequest(),
                        "post", "test_projectKey/recurring-orders/test_ID?expand=expand", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .recurringOrders()
                        .withId("test_ID")
                        .post(com.commercetools.api.models.recurring_order.RecurringOrderUpdate.of())
    ...
    public static Object[][] executeMethodParameters() {
        return new Object[][] {
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .get()
                        .withExpand("expand"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").recurringOrders().withId("test_ID").get(), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").recurringOrders().withId("test_ID").head(), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .recurringOrders()
                        .withId("test_ID")
                        .post(com.commercetools.api.models.recurring_order.RecurringOrderUpdate.of())
