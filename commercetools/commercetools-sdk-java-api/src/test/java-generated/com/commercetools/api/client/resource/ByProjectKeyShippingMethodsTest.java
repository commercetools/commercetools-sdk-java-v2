...
public class ByProjectKeyShippingMethodsTest {
    ...
    private Object[] executeMethodParameters() {
        return new Object[] {
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").shippingMethods().get().withExpand("expand"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").shippingMethods().get().withSort("sort"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").shippingMethods().get().withLimit(7), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").shippingMethods().get().withOffset(3), },
