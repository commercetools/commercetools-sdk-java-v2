...
public class ByProjectKeyShoppingListsByIDTest {
    ...
    private Object[] requestWithMethodParameters() {
        return new Object[] { new Object[] {
                apiRoot.withProjectKey("test_projectKey").shoppingLists().withId("test_ID").get().withExpand("expand"),
                "get", "test_projectKey/shopping-lists/test_ID?expand=expand", },
                new Object[] { apiRoot.withProjectKey("test_projectKey").shoppingLists().withId("test_ID").get(), "get",
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey").shoppingLists().withId("test_ID").post(null),
                        "post", "test_projectKey/shopping-lists/test_ID", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .shoppingLists()
                                .withId("test_ID")
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .withId("test_ID")
                        .delete()
                        .withVersion(9L), "delete", "test_projectKey/shopping-lists/test_ID?version=9L", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .shoppingLists()
                                .withId("test_ID")
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey").shoppingLists().withId("test_ID").delete(),
                        "delete", "test_projectKey/shopping-lists/test_ID", } };
    }
