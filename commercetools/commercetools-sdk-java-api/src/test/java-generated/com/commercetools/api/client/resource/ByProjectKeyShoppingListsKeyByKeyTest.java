...
public class ByProjectKeyShoppingListsKeyByKeyTest {
    ...
    public static Object[][] requestWithMethodParameters() {
        return new Object[][] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .withKey("test_key")
                        .head()
                        .createHttpRequest(), "head", "test_projectKey/shopping-lists/key=test_key", },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey")
                                .shoppingLists()
                                .withKey("test_key")
    ...
    public static Object[][] executeMethodParameters() {
        return new Object[][] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey").shoppingLists().withKey("test_key").head(), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .shoppingLists()
                        .withKey("test_key")
                        .post(com.commercetools.api.models.shopping_list.ShoppingListUpdate.of())
