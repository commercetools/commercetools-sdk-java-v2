...
public class ByProjectKeyStatesTest {
    ...
    private Object[] executeMethodParameters() {
        return new Object[] {
                new Object[] { apiRoot.withProjectKey("test_projectKey").states().get().withExpand("expand"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").states().get().withSort("sort"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").states().get().withLimit(7), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").states().get().withOffset(3), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").states().get().withWithTotal(true), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").states().get().withWhere("where"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .states()
                        .get()
                        .withPredicateVar("varName", "var.varName"), },
