...
public class ByProjectKeySubscriptionsByIDTest {
    ...
    private Object[] requestWithMethodParameters() {
        return new Object[] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .delete()
                        .withVersion(2)
                        .createHttpRequest(), "delete", "/test_projectKey/subscriptions/test_ID?version=2", },
                new Object[] {
    ...
    private Object[] executeMethodParameters() {
        return new Object[] {
                new Object[] { new ApiHttpRequest(ApiHttpMethod.GET,
                    new ByProjectKeySubscriptionsByIDGet(apiHttpClientMock, projectKey, null).createHttpRequest()
                            .getUri(),
                    null, null) },
                new Object[] { new ApiHttpRequest(ApiHttpMethod.GET,
                    new ByProjectKeySubscriptionsByIDGet(apiHttpClientMock, projectKey, null).createHttpRequest()
                ...
                new Object[] { new ApiHttpRequest(ApiHttpMethod.POST,
                    new ByProjectKeySubscriptionsByIDPost(apiHttpClientMock, projectKey, null, null).createHttpRequest()
                            .getUri(),
                    null, null) },
                new Object[] { new ApiHttpRequest(ApiHttpMethod.POST,
                    new ByProjectKeySubscriptionsByIDPost(apiHttpClientMock, projectKey, null, null).createHttpRequest()
                ...
                new Object[] { new ApiHttpRequest(ApiHttpMethod.DELETE,
                    new ByProjectKeySubscriptionsByIDDelete(apiHttpClientMock, projectKey, null).createHttpRequest()
                            .getUri(),
                    null, null) },
                new Object[] { new ApiHttpRequest(ApiHttpMethod.DELETE,
                    new ByProjectKeySubscriptionsByIDDelete(apiHttpClientMock, projectKey, null).createHttpRequest()
