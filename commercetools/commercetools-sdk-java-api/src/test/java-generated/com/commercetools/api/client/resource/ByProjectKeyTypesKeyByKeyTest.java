    ...
    private Object[] executeMethodParameters() {
        return new Object[] { new Object[] {
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .post(null)
                        .withExpand("expand"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").types().withKey("test_key").post(null), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .types()
                        .withKey("test_key")
                        .delete()
                ...
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .delete()
                        .withExpand("expand"), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").types().withKey("test_key").delete(), } };
    }
}
