...
public class BusinessUnitResourceIdentifierTest {
    ...
    public void buildUnchecked(BusinessUnitResourceIdentifierBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { BusinessUnitResourceIdentifier.builder().id("id") },
                new Object[] { BusinessUnitResourceIdentifier.builder().key("key") } };
    }
