...
public class AnonymousIdAlreadyInUseErrorTest {
    ...
    public void buildUnchecked(AnonymousIdAlreadyInUseErrorBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { AnonymousIdAlreadyInUseError.builder().message("message") } };
    }
