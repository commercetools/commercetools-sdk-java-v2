...
public class MaxStoreReferencesReachedErrorTest {
    ...
    public void buildUnchecked(MaxStoreReferencesReachedErrorBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { MaxStoreReferencesReachedError.builder().message("message") } };
    }
