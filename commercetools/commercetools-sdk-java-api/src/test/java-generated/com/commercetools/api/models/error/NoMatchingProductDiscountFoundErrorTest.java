...
public class NoMatchingProductDiscountFoundErrorTest {
    ...
    public void buildUnchecked(NoMatchingProductDiscountFoundErrorBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { NoMatchingProductDiscountFoundError.builder().message("message") } };
    }
