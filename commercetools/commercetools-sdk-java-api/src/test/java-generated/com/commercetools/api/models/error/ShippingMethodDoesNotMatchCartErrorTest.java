...
public class ShippingMethodDoesNotMatchCartErrorTest {
    ...
    public void buildUnchecked(ShippingMethodDoesNotMatchCartErrorBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { ShippingMethodDoesNotMatchCartError.builder().message("message") } };
    }
