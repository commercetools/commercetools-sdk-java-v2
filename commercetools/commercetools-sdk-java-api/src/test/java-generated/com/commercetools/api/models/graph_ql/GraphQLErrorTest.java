...
public class GraphQLErrorTest {
    ...
    public void locations() {
        GraphQLError value = GraphQLError.of();
        value.setLocations(
            Collections.singletonList(new com.commercetools.api.models.graph_ql.GraphQLErrorLocationImpl()));
    ...
    public void extensions() {
        GraphQLError value = GraphQLError.of();
        value.setExtensions(new com.commercetools.api.models.error.GraphQLErrorObjectImpl());
        Assertions.assertThat(value.getExtensions())
                .isEqualTo(new com.commercetools.api.models.error.GraphQLErrorObjectImpl());
    }
}
