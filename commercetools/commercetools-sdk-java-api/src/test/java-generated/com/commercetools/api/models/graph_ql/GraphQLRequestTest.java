...
public class GraphQLRequestTest {
    ...
    public void variables() {
        GraphQLRequest value = GraphQLRequest.of();
        value.setVariables(new com.commercetools.api.models.graph_ql.GraphQLVariablesMapImpl());
        Assertions.assertThat(value.getVariables())
                .isEqualTo(new com.commercetools.api.models.graph_ql.GraphQLVariablesMapImpl());
    }
}
