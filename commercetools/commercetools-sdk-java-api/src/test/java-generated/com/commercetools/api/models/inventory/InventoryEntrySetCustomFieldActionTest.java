...
public class InventoryEntrySetCustomFieldActionTest {
    ...
    public void buildUnchecked(String name, InventoryEntrySetCustomFieldActionBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { "name", InventoryEntrySetCustomFieldAction.builder().name("name") },
                new Object[] { "value", InventoryEntrySetCustomFieldAction.builder().value("value") } };
    }
