...
public class MyCustomerSetDateOfBirthActionTest {
    ...
    public void buildUnchecked(MyCustomerSetDateOfBirthActionBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] {
                new Object[] { MyCustomerSetDateOfBirthAction.builder().dateOfBirth(LocalDate.parse("2023-06-01")) } };
    }
