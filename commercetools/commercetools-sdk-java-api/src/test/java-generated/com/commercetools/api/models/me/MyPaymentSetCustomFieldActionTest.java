...
public class MyPaymentSetCustomFieldActionTest {
    ...
    public void buildUnchecked(MyPaymentSetCustomFieldActionBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { MyPaymentSetCustomFieldAction.builder().name("name") },
                new Object[] { MyPaymentSetCustomFieldAction.builder().value("value") } };
    }
