...
public class MyShoppingListUpdateTest {
    ...
    public void buildUnchecked(MyShoppingListUpdateBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { MyShoppingListUpdate.builder().version(2L) },
                new Object[] { MyShoppingListUpdate.builder()
