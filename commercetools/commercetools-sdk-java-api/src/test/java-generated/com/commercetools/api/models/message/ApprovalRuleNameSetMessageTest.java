...
public class ApprovalRuleNameSetMessageTest {
    ...
    public void buildUnchecked(ApprovalRuleNameSetMessageBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { ApprovalRuleNameSetMessage.builder().name("name") },
                new Object[] { ApprovalRuleNameSetMessage.builder().oldName("oldName") } };
    }
