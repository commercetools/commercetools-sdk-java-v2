...
public class BusinessUnitAddressCustomFieldRemovedMessageTest {
    ...
    public void buildUnchecked(String name, BusinessUnitAddressCustomFieldRemovedMessageBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] {
                new Object[] { "name", BusinessUnitAddressCustomFieldRemovedMessage.builder().name("name") },
                new Object[] { "addressId",
                        BusinessUnitAddressCustomFieldRemovedMessage.builder().addressId("addressId") } };
    }
