...
public class BusinessUnitCustomFieldAddedMessageTest {
    ...
    public void buildUnchecked(BusinessUnitCustomFieldAddedMessageBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { BusinessUnitCustomFieldAddedMessage.builder().name("name") },
                new Object[] { BusinessUnitCustomFieldAddedMessage.builder().value("value") } };
    }
