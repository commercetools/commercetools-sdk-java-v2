...
public class BusinessUnitDefaultShippingAddressSetMessagePayloadTest {
    ...
    public void buildUnchecked(String name, BusinessUnitDefaultShippingAddressSetMessagePayloadBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { "address", BusinessUnitDefaultShippingAddressSetMessagePayload.builder()
