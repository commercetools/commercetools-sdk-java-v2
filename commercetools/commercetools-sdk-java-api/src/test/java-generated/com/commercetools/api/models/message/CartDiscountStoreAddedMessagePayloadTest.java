...
public class CartDiscountStoreAddedMessagePayloadTest {
    ...
    public void buildUnchecked(String name, CartDiscountStoreAddedMessagePayloadBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { "store", CartDiscountStoreAddedMessagePayload.builder()
