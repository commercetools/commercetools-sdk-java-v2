...
public class CustomerGroupCustomFieldAddedMessageTest {
    ...
    public void buildUnchecked(CustomerGroupCustomFieldAddedMessageBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { CustomerGroupCustomFieldAddedMessage.builder().name("name") },
                new Object[] { CustomerGroupCustomFieldAddedMessage.builder().value("value") } };
    }
