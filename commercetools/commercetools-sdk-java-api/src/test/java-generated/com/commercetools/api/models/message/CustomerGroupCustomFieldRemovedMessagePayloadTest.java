...
public class CustomerGroupCustomFieldRemovedMessagePayloadTest {
    ...
    public void buildUnchecked(CustomerGroupCustomFieldRemovedMessagePayloadBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { CustomerGroupCustomFieldRemovedMessagePayload.builder().name("name") } };
    }
