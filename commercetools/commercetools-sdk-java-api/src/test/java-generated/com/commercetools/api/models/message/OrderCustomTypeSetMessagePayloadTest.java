...
public class OrderCustomTypeSetMessagePayloadTest {
    ...
    public void buildUnchecked(String name, OrderCustomTypeSetMessagePayloadBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] {
                new Object[] { "customFields",
                        OrderCustomTypeSetMessagePayload.builder()
                                .customFields(new com.commercetools.api.models.type.CustomFieldsImpl()) },
                new Object[] { "previousTypeId",
                        OrderCustomTypeSetMessagePayload.builder().previousTypeId("previousTypeId") } };
    }
