...
public class OrderStoreSetMessagePayloadTest {
    ...
    public void buildUnchecked(String name, OrderStoreSetMessagePayloadBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { "store", OrderStoreSetMessagePayload.builder()
