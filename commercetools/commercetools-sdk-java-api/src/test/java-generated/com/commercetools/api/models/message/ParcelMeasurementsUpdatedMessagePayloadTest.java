...
public class ParcelMeasurementsUpdatedMessagePayloadTest {
    ...
    public void buildUnchecked(ParcelMeasurementsUpdatedMessagePayloadBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] {
                new Object[] { ParcelMeasurementsUpdatedMessagePayload.builder().deliveryId("deliveryId") },
                new Object[] { ParcelMeasurementsUpdatedMessagePayload.builder().parcelId("parcelId") },
                new Object[] { ParcelMeasurementsUpdatedMessagePayload.builder()
                        .measurements(new com.commercetools.api.models.order.ParcelMeasurementsImpl()) },
                new Object[] { ParcelMeasurementsUpdatedMessagePayload.builder().shippingKey("shippingKey") } };
    }
