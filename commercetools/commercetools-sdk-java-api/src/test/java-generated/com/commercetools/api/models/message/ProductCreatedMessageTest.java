...
public class ProductCreatedMessageTest {
    ...
    public void buildUnchecked(String name, ProductCreatedMessageBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { "productProjection", ProductCreatedMessage.builder()
