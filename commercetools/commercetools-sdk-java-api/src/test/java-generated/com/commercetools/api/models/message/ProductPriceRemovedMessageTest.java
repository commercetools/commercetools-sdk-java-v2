...
public class ProductPriceRemovedMessageTest {
    ...
    public void buildUnchecked(ProductPriceRemovedMessageBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { ProductPriceRemovedMessage.builder().variantId(5L) },
                new Object[] { ProductPriceRemovedMessage.builder()
                        .price(new com.commercetools.api.models.common.PriceImpl()) },
                new Object[] { ProductPriceRemovedMessage.builder().staged(true) } };
    }
