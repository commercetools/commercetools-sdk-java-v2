...
public class OrderSetBillingAddressCustomFieldActionTest {
    ...
    public void buildUnchecked(OrderSetBillingAddressCustomFieldActionBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { OrderSetBillingAddressCustomFieldAction.builder().name("name") },
                new Object[] { OrderSetBillingAddressCustomFieldAction.builder().value("value") } };
    }
