...
public class OrderSetDeliveryAddressCustomTypeActionTest {
    ...
    public void buildUnchecked(OrderSetDeliveryAddressCustomTypeActionBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] {
                new Object[] { OrderSetDeliveryAddressCustomTypeAction.builder().deliveryId("deliveryId") },
                new Object[] { OrderSetDeliveryAddressCustomTypeAction.builder().deliveryKey("deliveryKey") },
                new Object[] { OrderSetDeliveryAddressCustomTypeAction.builder()
