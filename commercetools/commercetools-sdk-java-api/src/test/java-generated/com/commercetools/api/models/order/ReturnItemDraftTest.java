...
public class ReturnItemDraftTest {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { "key", ReturnItemDraft.builder().key("key") },
                new Object[] { "quantity", ReturnItemDraft.builder().quantity(8L) },
                ...
                new Object[] { "shipmentState", ReturnItemDraft.builder()
                        .shipmentState(com.commercetools.api.models.order.ReturnShipmentState.findEnum("Advised")) },
                new Object[] { "custom", ReturnItemDraft.builder()
