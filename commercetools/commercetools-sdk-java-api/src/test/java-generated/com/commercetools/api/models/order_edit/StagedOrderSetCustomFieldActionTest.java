...
public class StagedOrderSetCustomFieldActionTest {
    ...
    public void buildUnchecked(StagedOrderSetCustomFieldActionBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { StagedOrderSetCustomFieldAction.builder().name("name") },
                new Object[] { StagedOrderSetCustomFieldAction.builder().value("value") } };
    }
