...
public class StagedOrderSetDeliveryAddressActionTest {
    ...
    public void buildUnchecked(StagedOrderSetDeliveryAddressActionBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { StagedOrderSetDeliveryAddressAction.builder().deliveryId("deliveryId") },
                new Object[] { StagedOrderSetDeliveryAddressAction.builder().deliveryKey("deliveryKey") },
                new Object[] { StagedOrderSetDeliveryAddressAction.builder()
