...
public class ProductPagedQueryResponseTest {
    ...
    public void buildUnchecked(String name, ProductPagedQueryResponseBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { "limit", ProductPagedQueryResponse.builder().limit(7L) },
                new Object[] { "offset", ProductPagedQueryResponse.builder().offset(3L) },
                new Object[] { "count", ProductPagedQueryResponse.builder().count(2L) },
                new Object[] { "total", ProductPagedQueryResponse.builder().total(1L) },
                new Object[] { "results", ProductPagedQueryResponse.builder()
