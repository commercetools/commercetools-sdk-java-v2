...
public class ProductPagedSearchResponseTest {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { ProductPagedSearchResponse.builder().total(1L) },
                ...
                new Object[] { ProductPagedSearchResponse.builder()
                        .facets(new com.commercetools.api.models.product_search.ProductSearchFacetResultImpl()) },
                new Object[] { ProductPagedSearchResponse.builder()
                        .hits(Collections.singletonList(
                            new com.commercetools.api.models.product_search.ProductSearchHitImpl())) } };
    }
    ...
    public void facets() {
        ProductPagedSearchResponse value = ProductPagedSearchResponse.of();
        value.setFacets(new com.commercetools.api.models.product_search.ProductSearchFacetResultImpl());
        Assertions.assertThat(value.getFacets())
                .isEqualTo(new com.commercetools.api.models.product_search.ProductSearchFacetResultImpl());
    }
    ...
    public void hits() {
        ProductPagedSearchResponse value = ProductPagedSearchResponse.of();
        value.setHits(
            Collections.singletonList(new com.commercetools.api.models.product_search.ProductSearchHitImpl()));
