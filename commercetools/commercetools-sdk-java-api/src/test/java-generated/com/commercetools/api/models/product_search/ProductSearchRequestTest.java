...
public class ProductSearchRequestTest {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] {
                new Object[] { ProductSearchRequest.builder()
                        .query(new com.commercetools.api.models.product_search.ProductSearchQueryImpl()) },
                new Object[] { ProductSearchRequest.builder()
                        .postFilter(new com.commercetools.api.models.product_search.ProductSearchQueryImpl()) },
                new Object[] { ProductSearchRequest.builder()
                        .sort(Collections.singletonList(
                            new com.commercetools.api.models.product_search.ProductSearchSortingImpl())) },
    ...
    public void query() {
        ...
        value.setQuery(new com.commercetools.api.models.product_search.ProductSearchQueryImpl());
    ...
    public void postFilter() {
        ProductSearchRequest value = ProductSearchRequest.of();
        value.setPostFilter(new com.commercetools.api.models.product_search.ProductSearchQueryImpl());
    ...
    public void sort() {
        ProductSearchRequest value = ProductSearchRequest.of();
        value.setSort(
            Collections.singletonList(new com.commercetools.api.models.product_search.ProductSearchSortingImpl()));
        Assertions.assertThat(value.getSort())
                .isEqualTo(Collections
                        .singletonList(new com.commercetools.api.models.product_search.ProductSearchSortingImpl()));
    }
    ...
    public void projection() {
        ProductSearchRequest value = ProductSearchRequest.of();
        value.setProjection(new com.commercetools.api.models.product_search.ProductSearchProjectionParamsImpl());
        Assertions.assertThat(value.getProjection())
