...
public class ProductTypeChangeAttributeNameActionTest {
    ...
    public void buildUnchecked(ProductTypeChangeAttributeNameActionBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] {
                new Object[] { ProductTypeChangeAttributeNameAction.builder().attributeName("attributeName") },
                new Object[] { ProductTypeChangeAttributeNameAction.builder().newAttributeName("newAttributeName") } };
    }
