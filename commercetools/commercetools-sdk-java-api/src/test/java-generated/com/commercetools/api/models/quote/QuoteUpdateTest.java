...
public class QuoteUpdateTest {
    ...
    public void buildUnchecked(QuoteUpdateBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { QuoteUpdate.builder().version(2L) }, new Object[] { QuoteUpdate.builder()
                .actions(Collections.singletonList(new com.commercetools.api.models.quote.QuoteUpdateActionImpl())) } };
    }
