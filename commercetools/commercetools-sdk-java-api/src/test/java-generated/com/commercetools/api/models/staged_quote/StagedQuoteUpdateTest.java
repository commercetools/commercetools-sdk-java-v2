...
public class StagedQuoteUpdateTest {
    ...
    public void buildUnchecked(StagedQuoteUpdateBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { StagedQuoteUpdate.builder().version(2L) },
                new Object[] { StagedQuoteUpdate.builder()
