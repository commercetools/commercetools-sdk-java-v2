...
public class ResourceByProjectKeyCartsReplicateTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyCartsReplicatePost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.POST,
                      new ByProjectKeyCartsReplicatePost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
