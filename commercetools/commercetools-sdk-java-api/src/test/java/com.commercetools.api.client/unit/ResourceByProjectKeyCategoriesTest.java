    ...
    private Object[] requestWithMethodParameters() {
       return new Object [] {
               ...
               new Object[] {           
                   ...
                   .withLimit(3),
                   "get",
                   "test_projectKey/categories?limit=3",
               },
               new Object[] {           
                   apiRoot
                   .withProjectKey("test_projectKey")
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyCategoriesGet(apiHttpClientMock, projectKey).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.GET,
                      new ByProjectKeyCategoriesGet(apiHttpClientMock, projectKey).createHttpRequest().getUri(), null, null)
               ...
               new Object[] {
                      ...
                      new ByProjectKeyCategoriesPost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.POST,
                      new ByProjectKeyCategoriesPost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
