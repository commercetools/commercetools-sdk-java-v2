...
public class ResourceByProjectKeyCustomObjectsByContainerByKeyTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyCustomObjectsByContainerByKeyGet(apiHttpClientMock, projectKey, null, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.GET,
                      new ByProjectKeyCustomObjectsByContainerByKeyGet(apiHttpClientMock, projectKey, null, null).createHttpRequest().getUri(), null, null)
               ...
               new Object[] {
                      ...
                      new ByProjectKeyCustomObjectsByContainerByKeyDelete(apiHttpClientMock, projectKey, null, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.DELETE,
                      new ByProjectKeyCustomObjectsByContainerByKeyDelete(apiHttpClientMock, projectKey, null, null).createHttpRequest().getUri(), null, null)
