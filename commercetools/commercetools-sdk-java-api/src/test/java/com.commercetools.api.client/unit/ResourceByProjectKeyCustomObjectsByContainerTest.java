...
public class ResourceByProjectKeyCustomObjectsByContainerTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyCustomObjectsByContainerGet(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.GET,
                      new ByProjectKeyCustomObjectsByContainerGet(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
