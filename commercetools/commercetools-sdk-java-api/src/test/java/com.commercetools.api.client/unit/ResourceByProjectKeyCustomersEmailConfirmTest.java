...
public class ResourceByProjectKeyCustomersEmailConfirmTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyCustomersEmailConfirmPost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.POST,
                      new ByProjectKeyCustomersEmailConfirmPost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
