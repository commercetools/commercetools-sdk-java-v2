...
public class ResourceByProjectKeyCustomersEmailTokenByEmailTokenTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyCustomersEmailTokenByEmailTokenGet(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.GET,
                      new ByProjectKeyCustomersEmailTokenByEmailTokenGet(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
