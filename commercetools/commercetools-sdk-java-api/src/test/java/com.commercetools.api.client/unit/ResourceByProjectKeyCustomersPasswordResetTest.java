...
public class ResourceByProjectKeyCustomersPasswordResetTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyCustomersPasswordResetPost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.POST,
                      new ByProjectKeyCustomersPasswordResetPost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
