...
public class ResourceByProjectKeyCustomersPasswordTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyCustomersPasswordPost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.POST,
                      new ByProjectKeyCustomersPasswordPost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
