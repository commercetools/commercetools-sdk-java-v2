...
public class ResourceByProjectKeyCustomersPasswordTokenByPasswordTokenTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyCustomersPasswordTokenByPasswordTokenGet(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.GET,
                      new ByProjectKeyCustomersPasswordTokenByPasswordTokenGet(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
