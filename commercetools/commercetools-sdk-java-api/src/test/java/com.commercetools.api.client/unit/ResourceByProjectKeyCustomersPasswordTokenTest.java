...
public class ResourceByProjectKeyCustomersPasswordTokenTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyCustomersPasswordTokenPost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.POST,
                      new ByProjectKeyCustomersPasswordTokenPost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
