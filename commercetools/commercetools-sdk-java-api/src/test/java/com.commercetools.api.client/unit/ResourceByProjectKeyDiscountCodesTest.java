...
public class ResourceByProjectKeyDiscountCodesTest {
    ...
    private Object[] requestWithMethodParameters() {
       return new Object [] {
               ...
               new Object[] {           
                   ...
                   .withLimit(2),
                   "get",
                   "test_projectKey/discount-codes?limit=2",
               },
               new Object[] {           
                   apiRoot
                   .withProjectKey("test_projectKey")
                   ...
                   .withOffset(1),
                   "get",
                   "test_projectKey/discount-codes?offset=1",
               },
               new Object[] {           
                   apiRoot
                   .withProjectKey("test_projectKey")
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyDiscountCodesGet(apiHttpClientMock, projectKey).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.GET,
                      new ByProjectKeyDiscountCodesGet(apiHttpClientMock, projectKey).createHttpRequest().getUri(), null, null)
               ...
               new Object[] {
                      ...
                      new ByProjectKeyDiscountCodesPost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.POST,
                      new ByProjectKeyDiscountCodesPost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
