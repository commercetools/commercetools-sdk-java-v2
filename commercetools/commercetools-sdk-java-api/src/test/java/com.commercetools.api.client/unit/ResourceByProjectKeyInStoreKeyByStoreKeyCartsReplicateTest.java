...
public class ResourceByProjectKeyInStoreKeyByStoreKeyCartsReplicateTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyInStoreKeyByStoreKeyCartsReplicatePost(apiHttpClientMock, projectKey, null, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.POST,
                      new ByProjectKeyInStoreKeyByStoreKeyCartsReplicatePost(apiHttpClientMock, projectKey, null, null).createHttpRequest().getUri(), null, null)
