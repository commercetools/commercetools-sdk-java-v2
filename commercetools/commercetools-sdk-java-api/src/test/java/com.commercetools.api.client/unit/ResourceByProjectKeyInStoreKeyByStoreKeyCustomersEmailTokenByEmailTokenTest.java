...
public class ResourceByProjectKeyInStoreKeyByStoreKeyCustomersEmailTokenByEmailTokenTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyInStoreKeyByStoreKeyCustomersEmailTokenByEmailTokenGet(apiHttpClientMock, projectKey, null, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.GET,
                      new ByProjectKeyInStoreKeyByStoreKeyCustomersEmailTokenByEmailTokenGet(apiHttpClientMock, projectKey, null, null).createHttpRequest().getUri(), null, null)
