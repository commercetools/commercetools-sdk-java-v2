...
public class ResourceByProjectKeyInStoreKeyByStoreKeyMeActiveCartTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyInStoreKeyByStoreKeyMeActiveCartGet(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.GET,
                      new ByProjectKeyInStoreKeyByStoreKeyMeActiveCartGet(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
