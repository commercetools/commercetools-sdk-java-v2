...
public class ResourceByProjectKeyInStoreKeyByStoreKeyMeOrdersByIDTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyInStoreKeyByStoreKeyMeOrdersByIDGet(apiHttpClientMock, projectKey, null, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.GET,
                      new ByProjectKeyInStoreKeyByStoreKeyMeOrdersByIDGet(apiHttpClientMock, projectKey, null, null).createHttpRequest().getUri(), null, null)
