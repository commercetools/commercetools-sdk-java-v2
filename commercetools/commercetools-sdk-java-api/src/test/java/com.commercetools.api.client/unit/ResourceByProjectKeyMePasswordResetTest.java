...
public class ResourceByProjectKeyMePasswordResetTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyMePasswordResetPost(apiHttpClientMock, projectKey).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.POST,
                      new ByProjectKeyMePasswordResetPost(apiHttpClientMock, projectKey).createHttpRequest().getUri(), null, null)
