...
public class ResourceByProjectKeyMePaymentsTest {
    ...
    private Object[] requestWithMethodParameters() {
       return new Object [] {
               ...
               new Object[] {           
                   ...
                   .withLimit(8),
                   "get",
                   "test_projectKey/me/payments?limit=8",
               },
               new Object[] {           
                   apiRoot
                   .withProjectKey("test_projectKey")
                   ...
                   .withOffset(9),
                   "get",
                   "test_projectKey/me/payments?offset=9",
               },
               new Object[] {           
                   apiRoot
                   .withProjectKey("test_projectKey")
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyMePaymentsGet(apiHttpClientMock, projectKey).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.GET,
                      new ByProjectKeyMePaymentsGet(apiHttpClientMock, projectKey).createHttpRequest().getUri(), null, null)
               ...
               new Object[] {
                      ...
                      new ByProjectKeyMePaymentsPost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.POST,
                      new ByProjectKeyMePaymentsPost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
