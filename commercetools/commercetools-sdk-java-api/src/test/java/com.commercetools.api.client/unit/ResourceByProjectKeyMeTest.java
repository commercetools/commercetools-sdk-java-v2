...
public class ResourceByProjectKeyMeTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               ...
               new Object[] {
                      ...
                      new ByProjectKeyMePost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.POST,
                      new ByProjectKeyMePost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
