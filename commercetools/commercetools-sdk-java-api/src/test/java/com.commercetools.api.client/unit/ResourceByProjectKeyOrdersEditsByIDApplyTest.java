...
public class ResourceByProjectKeyOrdersEditsByIDApplyTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyOrdersEditsByIDApplyPost(apiHttpClientMock, projectKey, null, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.POST,
                      new ByProjectKeyOrdersEditsByIDApplyPost(apiHttpClientMock, projectKey, null, null).createHttpRequest().getUri(), null, null)
