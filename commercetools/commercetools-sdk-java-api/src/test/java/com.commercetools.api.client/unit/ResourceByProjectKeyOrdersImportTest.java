...
public class ResourceByProjectKeyOrdersImportTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyOrdersImportPost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.POST,
                      new ByProjectKeyOrdersImportPost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
