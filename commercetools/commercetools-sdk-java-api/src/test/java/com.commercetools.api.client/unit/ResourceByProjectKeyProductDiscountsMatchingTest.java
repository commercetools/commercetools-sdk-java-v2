...
public class ResourceByProjectKeyProductDiscountsMatchingTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyProductDiscountsMatchingPost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.POST,
                      new ByProjectKeyProductDiscountsMatchingPost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
