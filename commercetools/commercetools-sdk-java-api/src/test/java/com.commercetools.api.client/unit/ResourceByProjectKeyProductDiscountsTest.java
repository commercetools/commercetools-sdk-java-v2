...
public class ResourceByProjectKeyProductDiscountsTest {
    ...
    private Object[] requestWithMethodParameters() {
       return new Object [] {
               ...
               new Object[] {           
                   ...
                   .withLimit(6),
                   "get",
                   "test_projectKey/product-discounts?limit=6",
               },
               new Object[] {           
                   apiRoot
                   .withProjectKey("test_projectKey")
                   ...
                   .withOffset(9),
                   "get",
                   "test_projectKey/product-discounts?offset=9",
               },
               new Object[] {           
                   apiRoot
                   .withProjectKey("test_projectKey")
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyProductDiscountsGet(apiHttpClientMock, projectKey).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.GET,
                      new ByProjectKeyProductDiscountsGet(apiHttpClientMock, projectKey).createHttpRequest().getUri(), null, null)
               ...
               new Object[] {
                      ...
                      new ByProjectKeyProductDiscountsPost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.POST,
                      new ByProjectKeyProductDiscountsPost(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
