...
public class ResourceByProjectKeyProductProjectionsByIDTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyProductProjectionsByIDGet(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.GET,
                      new ByProjectKeyProductProjectionsByIDGet(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
