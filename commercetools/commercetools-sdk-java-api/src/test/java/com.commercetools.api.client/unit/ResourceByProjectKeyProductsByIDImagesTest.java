...
public class ResourceByProjectKeyProductsByIDImagesTest {
    ...
    private Object[] requestWithMethodParameters() {
       return new Object [] {
               ...
               new Object[] {           
                   ...
                   .images()
                   .post(null)
                   .withVariant(0.6285261),
                   "post",
                   "test_projectKey/products/test_ID/images?variant=0.6285261",
               },
               new Object[] {           
                   apiRoot
                   .withProjectKey("test_projectKey")
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyProductsByIDImagesPost(apiHttpClientMock, projectKey, null, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.POST,
                      new ByProjectKeyProductsByIDImagesPost(apiHttpClientMock, projectKey, null, null).createHttpRequest().getUri(), null, null)
