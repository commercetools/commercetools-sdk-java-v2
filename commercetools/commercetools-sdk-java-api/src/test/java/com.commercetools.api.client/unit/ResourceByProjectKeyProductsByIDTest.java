...
public class ResourceByProjectKeyProductsByIDTest {
    ...
    private Object[] requestWithMethodParameters() {
       return new Object [] {
               ...
               new Object[] {           
                   ...
                   .withVersion(4L),
                   "delete",
                   "test_projectKey/products/test_ID?version=4L",
               },
               new Object[] {           
                   apiRoot
                   .withProjectKey("test_projectKey")
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyProductsByIDGet(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.GET,
                      new ByProjectKeyProductsByIDGet(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
               ...
               new Object[] {
                      ...
                      new ByProjectKeyProductsByIDPost(apiHttpClientMock, projectKey, null, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.POST,
                      new ByProjectKeyProductsByIDPost(apiHttpClientMock, projectKey, null, null).createHttpRequest().getUri(), null, null)
               ...
               new Object[] {
                      ...
                      new ByProjectKeyProductsByIDDelete(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.DELETE,
                      new ByProjectKeyProductsByIDDelete(apiHttpClientMock, projectKey, null).createHttpRequest().getUri(), null, null)
