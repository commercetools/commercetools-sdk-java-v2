...
public class ResourceByProjectKeyShippingMethodsMatchingCartTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyShippingMethodsMatchingCartGet(apiHttpClientMock, projectKey).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.GET,
                      new ByProjectKeyShippingMethodsMatchingCartGet(apiHttpClientMock, projectKey).createHttpRequest().getUri(), null, null)
