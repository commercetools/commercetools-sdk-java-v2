...
public class ResourceByProjectKeyShippingMethodsMatchingOrdereditTest {
    ...
    private Object[] executeMethodParameters() {
       return new Object [] {
               new Object[] {
                      ...
                      new ByProjectKeyShippingMethodsMatchingOrdereditGet(apiHttpClientMock, projectKey).createHttpRequest().getUri(), null, null)
                   },
               new Object[] {
                      new ApiHttpRequest(ApiHttpMethod.GET,
                      new ByProjectKeyShippingMethodsMatchingOrdereditGet(apiHttpClientMock, projectKey).createHttpRequest().getUri(), null, null)
