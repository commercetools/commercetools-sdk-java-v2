...
public class MoneyTest {
    ...
    public void testMonetaryToMoney() {
        CentPrecisionMoney centMoney = MoneyUtil.asCentPrecision(FastMoney.of(1.000, "EUR"));
        ...
        CentPrecisionMoney jpyCentMoney = MoneyUtil.asCentPrecision(FastMoney.of(1.000, "JPY"));
        ...
        CentPrecisionMoneyDraft centMoneyDraft = MoneyUtil.asCentPrecisionDraft(FastMoney.of(1.000, "EUR"));
        ...
        CentPrecisionMoneyDraft jpyCentMoneyDraft = MoneyUtil.asCentPrecisionDraft(FastMoney.of(1.000, "JPY"));
        ...
        HighPrecisionMoney highMoney = MoneyUtil.asHighPrecision(FastMoney.of(1.0010, "EUR"), 3);
        ...
        HighPrecisionMoney jpyHighMoney = MoneyUtil.asHighPrecision(FastMoney.of(1.0010, "JPY"), 3);
        ...
        HighPrecisionMoneyDraft highMoneyDraft = MoneyUtil.asHighPrecisionDraft(FastMoney.of(1.0010, "EUR"), 3);
        ...
        HighPrecisionMoneyDraft jpyHighMoneyDraft = MoneyUtil.asHighPrecisionDraft(FastMoney.of(1.0010, "JPY"), 3);
        ...
        HighPrecisionMoney highMoneyUpscale = MoneyUtil.asHighPrecision(FastMoney.of(1.001, "EUR"), 6);
        ...
        HighPrecisionMoney jpyHighMoneyUpscale = MoneyUtil.asHighPrecision(FastMoney.of(1.001, "JPY"), 6);
        ...
        HighPrecisionMoneyDraft highMoneyDraftUpscale = MoneyUtil.asHighPrecisionDraft(FastMoney.of(1.001, "EUR"), 6);
        ...
        HighPrecisionMoneyDraft jpyHighMoneyDraftUpscale = MoneyUtil.asHighPrecisionDraft(FastMoney.of(1.001, "JPY"), 6);
        ...
        HighPrecisionMoney highMoneyDownscale = MoneyUtil.asHighPrecision(FastMoney.of(1.23456, "EUR"), 3);
        ...
        HighPrecisionMoney jpyHighMoneyDownscale = MoneyUtil.asHighPrecision(FastMoney.of(1.23456, "JPY"), 3);
        ...
        HighPrecisionMoneyDraft highMoneyDraftDownscale = MoneyUtil.asHighPrecisionDraft(FastMoney.of(1.23456, "EUR"), 3);
        ...
        HighPrecisionMoneyDraft jpyHighMoneyDraftDownscale = MoneyUtil.asHighPrecisionDraft(FastMoney.of(1.23456, "JPY"), 3);
