...
public class ByProjectKeyCartDiscountsByIDRequestBuilder {
    ...
    public ByProjectKeyCartDiscountsByIDPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyCartDiscountsByIDPost(apiHttpClient, projectKey, ID, update);
    }
