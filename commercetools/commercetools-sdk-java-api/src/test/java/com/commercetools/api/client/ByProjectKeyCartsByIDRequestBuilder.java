...
public class ByProjectKeyCartsByIDRequestBuilder {
    ...
    public ByProjectKeyCartsByIDPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyCartsByIDPost(apiHttpClient, projectKey, ID, update);
    }
