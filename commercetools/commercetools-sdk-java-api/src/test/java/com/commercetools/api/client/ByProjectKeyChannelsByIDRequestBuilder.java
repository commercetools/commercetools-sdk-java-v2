...
public class ByProjectKeyChannelsByIDRequestBuilder {
    ...
    public ByProjectKeyChannelsByIDPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyChannelsByIDPost(apiHttpClient, projectKey, ID, update);
    }
