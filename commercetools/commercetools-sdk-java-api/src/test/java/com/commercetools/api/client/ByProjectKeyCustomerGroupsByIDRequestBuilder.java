...
public class ByProjectKeyCustomerGroupsByIDRequestBuilder {
    ...
    public ByProjectKeyCustomerGroupsByIDPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyCustomerGroupsByIDPost(apiHttpClient, projectKey, ID, update);
    }
