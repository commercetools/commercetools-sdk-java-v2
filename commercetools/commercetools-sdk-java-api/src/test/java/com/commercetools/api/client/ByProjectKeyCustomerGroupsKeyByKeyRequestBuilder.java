...
public class ByProjectKeyCustomerGroupsKeyByKeyRequestBuilder {
    ...
    public ByProjectKeyCustomerGroupsKeyByKeyPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyCustomerGroupsKeyByKeyPost(apiHttpClient, projectKey, key, update);
    }
