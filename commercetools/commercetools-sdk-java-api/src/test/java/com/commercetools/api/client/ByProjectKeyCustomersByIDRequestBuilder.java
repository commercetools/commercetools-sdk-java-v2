...
public class ByProjectKeyCustomersByIDRequestBuilder {
    ...
    public ByProjectKeyCustomersByIDPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyCustomersByIDPost(apiHttpClient, projectKey, ID, update);
    }
