...
public class ByProjectKeyCustomersKeyByKeyRequestBuilder {
    ...
    public ByProjectKeyCustomersKeyByKeyPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyCustomersKeyByKeyPost(apiHttpClient, projectKey, key, update);
    }
