...
public class ByProjectKeyDiscountCodesByIDRequestBuilder {
    ...
    public ByProjectKeyDiscountCodesByIDPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyDiscountCodesByIDPost(apiHttpClient, projectKey, ID, update);
    }
