...
public class ByProjectKeyExtensionsByIDRequestBuilder {
    ...
    public ByProjectKeyExtensionsByIDPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyExtensionsByIDPost(apiHttpClient, projectKey, ID, update);
    }
