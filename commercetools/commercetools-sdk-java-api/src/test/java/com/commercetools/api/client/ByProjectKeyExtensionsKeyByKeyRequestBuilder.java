...
public class ByProjectKeyExtensionsKeyByKeyRequestBuilder {
    ...
    public ByProjectKeyExtensionsKeyByKeyPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyExtensionsKeyByKeyPost(apiHttpClient, projectKey, key, update);
    }
