...
public class ByProjectKeyInStoreKeyByStoreKeyShippingMethodsMatchingCartRequestBuilder {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyShippingMethodsMatchingCartRequestBuilder (final ApiHttpClient apiHttpClient,final String projectKey,final String storeKey) {
