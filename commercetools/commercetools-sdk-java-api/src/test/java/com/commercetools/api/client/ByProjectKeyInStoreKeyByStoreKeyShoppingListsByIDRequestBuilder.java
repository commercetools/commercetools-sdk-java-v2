...
public class ByProjectKeyInStoreKeyByStoreKeyShoppingListsByIDRequestBuilder {
    ...
    public ByProjectKeyInStoreKeyByStoreKeyShoppingListsByIDPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyInStoreKeyByStoreKeyShoppingListsByIDPost(apiHttpClient, projectKey, storeKey, ID, update);
    }
