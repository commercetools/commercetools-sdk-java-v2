...
public class ByProjectKeyInventoryByIDRequestBuilder {
    ...
    public ByProjectKeyInventoryByIDPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyInventoryByIDPost(apiHttpClient, projectKey, ID, update);
    }
