...
public class ByProjectKeyMeShoppingListsByIDRequestBuilder {
    ...
    public ByProjectKeyMeShoppingListsByIDPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyMeShoppingListsByIDPost(apiHttpClient, projectKey, ID, update);
    }
