...
public class ByProjectKeyOrdersByIDRequestBuilder {
    ...
    public ByProjectKeyOrdersByIDPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyOrdersByIDPost(apiHttpClient, projectKey, ID, update);
    }
