...
public class ByProjectKeyOrdersOrderNumberByOrderNumberRequestBuilder {
    ...
    public ByProjectKeyOrdersOrderNumberByOrderNumberPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyOrdersOrderNumberByOrderNumberPost(apiHttpClient, projectKey, orderNumber, update);
    }
