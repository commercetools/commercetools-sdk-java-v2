...
public class ByProjectKeyPaymentsByIDRequestBuilder {
    ...
    public ByProjectKeyPaymentsByIDPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyPaymentsByIDPost(apiHttpClient, projectKey, ID, update);
    }
