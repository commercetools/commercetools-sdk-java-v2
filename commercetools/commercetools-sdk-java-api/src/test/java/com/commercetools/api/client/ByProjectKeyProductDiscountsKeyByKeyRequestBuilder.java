...
public class ByProjectKeyProductDiscountsKeyByKeyRequestBuilder {
    ...
    public ByProjectKeyProductDiscountsKeyByKeyPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyProductDiscountsKeyByKeyPost(apiHttpClient, projectKey, key, update);
    }
