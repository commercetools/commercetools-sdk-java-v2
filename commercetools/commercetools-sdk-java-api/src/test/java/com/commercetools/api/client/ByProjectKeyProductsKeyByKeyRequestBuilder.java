...
public class ByProjectKeyProductsKeyByKeyRequestBuilder {
    ...
    public ByProjectKeyProductsKeyByKeyPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyProductsKeyByKeyPost(apiHttpClient, projectKey, key, update);
    }
