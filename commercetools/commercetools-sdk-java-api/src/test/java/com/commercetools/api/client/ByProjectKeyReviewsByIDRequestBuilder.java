...
public class ByProjectKeyReviewsByIDRequestBuilder {
    ...
    public ByProjectKeyReviewsByIDPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyReviewsByIDPost(apiHttpClient, projectKey, ID, update);
    }
