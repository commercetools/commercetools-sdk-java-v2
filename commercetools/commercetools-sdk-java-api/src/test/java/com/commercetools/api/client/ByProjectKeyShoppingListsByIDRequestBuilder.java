...
public class ByProjectKeyShoppingListsByIDRequestBuilder {
    ...
    public ByProjectKeyShoppingListsByIDPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyShoppingListsByIDPost(apiHttpClient, projectKey, ID, update);
    }
