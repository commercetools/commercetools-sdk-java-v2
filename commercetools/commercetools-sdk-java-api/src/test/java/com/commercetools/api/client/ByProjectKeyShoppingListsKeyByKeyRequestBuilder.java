...
public class ByProjectKeyShoppingListsKeyByKeyRequestBuilder {
    ...
    public ByProjectKeyShoppingListsKeyByKeyPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyShoppingListsKeyByKeyPost(apiHttpClient, projectKey, key, update);
    }
