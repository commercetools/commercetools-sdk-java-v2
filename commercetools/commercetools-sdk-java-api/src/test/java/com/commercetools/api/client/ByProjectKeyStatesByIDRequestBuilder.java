...
public class ByProjectKeyStatesByIDRequestBuilder {
    ...
    public ByProjectKeyStatesByIDPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyStatesByIDPost(apiHttpClient, projectKey, ID, update);
    }
