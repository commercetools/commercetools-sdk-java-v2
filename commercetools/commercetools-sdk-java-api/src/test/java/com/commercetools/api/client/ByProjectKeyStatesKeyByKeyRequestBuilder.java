...
public class ByProjectKeyStatesKeyByKeyRequestBuilder {
    ...
    public ByProjectKeyStatesKeyByKeyPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyStatesKeyByKeyPost(apiHttpClient, projectKey, key, update);
    }
