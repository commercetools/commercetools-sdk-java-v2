...
public class ByProjectKeyStoresByIDRequestBuilder {
    ...
    public ByProjectKeyStoresByIDPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyStoresByIDPost(apiHttpClient, projectKey, ID, update);
    }
