...
public class ByProjectKeySubscriptionsByIDRequestBuilder {
    ...
    public ByProjectKeySubscriptionsByIDPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeySubscriptionsByIDPost(apiHttpClient, projectKey, ID, update);
    }
