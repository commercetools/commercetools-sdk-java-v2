...
public class ByProjectKeyTaxCategoriesKeyByKeyRequestBuilder {
    ...
    public ByProjectKeyTaxCategoriesKeyByKeyPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyTaxCategoriesKeyByKeyPost(apiHttpClient, projectKey, key, update);
    }
