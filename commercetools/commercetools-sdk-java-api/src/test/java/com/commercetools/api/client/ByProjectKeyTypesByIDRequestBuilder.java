...
public class ByProjectKeyTypesByIDRequestBuilder {
    ...
    public ByProjectKeyTypesByIDPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyTypesByIDPost(apiHttpClient, projectKey, ID, update);
    }
