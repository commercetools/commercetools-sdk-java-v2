...
public class ByProjectKeyZonesByIDRequestBuilder {
    ...
    public ByProjectKeyZonesByIDPost post(com.commercetools.api.models.common.Update update) {
        return new ByProjectKeyZonesByIDPost(apiHttpClient, projectKey, ID, update);
    }
