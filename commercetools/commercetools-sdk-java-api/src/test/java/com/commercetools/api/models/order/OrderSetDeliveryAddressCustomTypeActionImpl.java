...
public final class OrderSetDeliveryAddressCustomTypeActionImpl implements OrderSetDeliveryAddressCustomTypeAction {
    ...
    @JsonCreator
    OrderSetDeliveryAddressCustomTypeActionImpl(@JsonProperty("deliveryId") final String deliveryId, @JsonProperty("name") final String name, @JsonProperty("value") final java.lang.Object value) {
