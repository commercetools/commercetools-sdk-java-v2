...
public final class OrderEditSetBillingAddressCustomTypeActionBuilder {
    ...
    public OrderEditSetBillingAddressCustomTypeActionBuilder type(@Nullable final com.commercetools.api.models.type.TypeResourceIdentifier type) {
        this.type = type;
        return this;
    }
    
    
    public OrderEditSetBillingAddressCustomTypeActionBuilder fields(@Nullable final com.commercetools.api.models.type.FieldContainer fields) {
        this.fields = fields;
        return this;
    }
    ...
    public static OrderEditSetBillingAddressCustomTypeActionBuilder of(final OrderEditSetBillingAddressCustomTypeAction template) {
