...
public final class FacetResultTermImpl implements FacetResultTerm {
    ...
    @JsonCreator
    FacetResultTermImpl(@JsonProperty("term") final java.lang.Object term, @JsonProperty("count") final Long count, @JsonProperty("productCount") final Long productCount) {
        this.term = term;
        this.count = count;
