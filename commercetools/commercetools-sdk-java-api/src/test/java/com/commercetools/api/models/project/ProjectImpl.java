...
public final class ProjectImpl implements Project {
    ...
    @JsonCreator
    ProjectImpl(@JsonProperty("version") final Long version, @JsonProperty("key") final String key, @JsonProperty("name") final String name, @JsonProperty("countries") final java.util.List<String> countries, @JsonProperty("currencies") final java.util.List<String> currencies, @JsonProperty("languages") final java.util.List<String> languages, @JsonProperty("createdAt") final java.time.ZonedDateTime createdAt, @JsonProperty("trialUntil") final String trialUntil, @JsonProperty("messages") final com.commercetools.api.models.message.MessageConfiguration messages, @JsonProperty("shippingRateInputType") final com.commercetools.api.models.project.ShippingRateInputType shippingRateInputType, @JsonProperty("externalOAuth") final com.commercetools.api.models.project.ExternalOAuth externalOAuth, @JsonProperty("carts") final com.commercetools.api.models.project.CartsConfiguration carts, @JsonProperty("searchIndexing") final com.commercetools.api.models.project.SearchIndexingConfiguration searchIndexing) {
