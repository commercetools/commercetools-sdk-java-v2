...
public final class StoreSetCustomTypeActionImpl implements StoreSetCustomTypeAction {
    ...
    @JsonCreator
    StoreSetCustomTypeActionImpl(@JsonProperty("type") final com.commercetools.api.models.type.TypeResourceIdentifier type, @JsonProperty("fields") final java.lang.Object fields) {
        this.type = type;
        this.fields = fields;
