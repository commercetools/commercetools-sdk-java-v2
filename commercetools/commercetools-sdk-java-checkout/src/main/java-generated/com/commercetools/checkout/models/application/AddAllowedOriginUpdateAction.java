...
public interface AddAllowedOriginUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AddAllowedOriginUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<AddAllowedOriginUpdateAction>() {
            @Override
