...
public interface AddApplicationAgreementUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AddApplicationAgreementUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<AddApplicationAgreementUpdateAction>() {
            @Override
