...
public interface AddCountryUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AddCountryUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<AddCountryUpdateAction>() {
            @Override
