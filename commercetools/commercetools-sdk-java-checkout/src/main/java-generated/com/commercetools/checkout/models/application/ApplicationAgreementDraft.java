...
public interface ApplicationAgreementDraft extends io.vrap.rmf.base.client.Draft<ApplicationAgreementDraft> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApplicationAgreementDraft> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApplicationAgreementDraft>() {
            @Override
