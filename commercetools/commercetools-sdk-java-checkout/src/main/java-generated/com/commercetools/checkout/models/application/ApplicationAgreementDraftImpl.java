...
public class ApplicationAgreementDraftImpl implements ApplicationAgreementDraft, ModelBase {
     ...
     */
    @JsonCreator
    ApplicationAgreementDraftImpl(@JsonProperty("name") final String name,
     ...
     */
    public ApplicationAgreementDraftImpl() {
    }
    ...
    public boolean equals(Object o) {
        ...
        ApplicationAgreementDraftImpl that = (ApplicationAgreementDraftImpl) o;
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder(17, 37).append(name).append(type).append(status).append(text).toHashCode();
    }
    ...
    public ApplicationAgreementDraft copyDeep() {
        return ApplicationAgreementDraft.deepCopy(this);
    }
}
