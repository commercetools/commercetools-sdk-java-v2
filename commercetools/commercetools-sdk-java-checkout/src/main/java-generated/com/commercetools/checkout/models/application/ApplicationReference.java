...
public interface ApplicationReference extends Reference {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApplicationReference> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApplicationReference>() {
            @Override
