...
public interface ApplicationResourceIdentifier extends ResourceIdentifier {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApplicationResourceIdentifier> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApplicationResourceIdentifier>() {
            @Override
