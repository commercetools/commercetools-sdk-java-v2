...
/**
 *  <p>Resource identifier to an <a href="https://docs.commercetools.com/apis/ctp:checkout:type:Application" rel="nofollow">Application</a>. Either <code>id</code> or <code>key</code> is required. If both are set, an <span>InvalidJsonInput</span> error is returned.</p>
 */
@Generated(value = "io.vrap.rmf.codegen.rendering.CoreCodeGenerator", comments = "https://github.com/commercetools/rmf-codegen")
public class ApplicationResourceIdentifierImpl implements ApplicationResourceIdentifier, ModelBase {
     ...
     */
    @JsonCreator
    ApplicationResourceIdentifierImpl(@JsonProperty("id") final String id, @JsonProperty("key") final String key) {
        this.id = id;
        this.key = key;
     ...
     */
    public ApplicationResourceIdentifierImpl() {
        this.typeId = ReferenceTypeId.findEnum("application");
    }
    ...
    public boolean equals(Object o) {
        ...
        ApplicationResourceIdentifierImpl that = (ApplicationResourceIdentifierImpl) o;
    ...
    public ApplicationResourceIdentifier copyDeep() {
        return ApplicationResourceIdentifier.deepCopy(this);
    }
}
