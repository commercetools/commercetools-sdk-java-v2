...
public class ApplicationUpdateActionImpl implements ApplicationUpdateAction, ModelBase {
     ...
     */
    @JsonCreator
    ApplicationUpdateActionImpl(@JsonProperty("action") final String action) {
        this.action = action;
    }
     ...
     */
    public ApplicationUpdateActionImpl() {
    }
    ...
    public boolean equals(Object o) {
        ...
        ApplicationUpdateActionImpl that = (ApplicationUpdateActionImpl) o;
    ...
    public ApplicationUpdateAction copyDeep() {
        return ApplicationUpdateAction.deepCopy(this);
    }
}
