...
public interface ApplicationUpdateActions {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApplicationUpdateActions> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApplicationUpdateActions>() {
            @Override
