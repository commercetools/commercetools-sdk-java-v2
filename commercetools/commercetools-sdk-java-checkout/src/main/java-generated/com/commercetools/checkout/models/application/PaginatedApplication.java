...
public interface PaginatedApplication {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaginatedApplication> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaginatedApplication>() {
            @Override
