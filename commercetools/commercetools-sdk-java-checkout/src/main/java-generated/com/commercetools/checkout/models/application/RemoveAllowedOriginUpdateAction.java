...
public interface RemoveAllowedOriginUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RemoveAllowedOriginUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<RemoveAllowedOriginUpdateAction>() {
            @Override
