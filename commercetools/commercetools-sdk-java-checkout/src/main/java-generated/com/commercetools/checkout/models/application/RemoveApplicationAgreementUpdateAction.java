...
public interface RemoveApplicationAgreementUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RemoveApplicationAgreementUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<RemoveApplicationAgreementUpdateAction>() {
            @Override
