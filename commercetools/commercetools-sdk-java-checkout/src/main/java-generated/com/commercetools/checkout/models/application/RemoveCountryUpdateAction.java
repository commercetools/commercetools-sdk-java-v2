...
public interface RemoveCountryUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RemoveCountryUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<RemoveCountryUpdateAction>() {
            @Override
