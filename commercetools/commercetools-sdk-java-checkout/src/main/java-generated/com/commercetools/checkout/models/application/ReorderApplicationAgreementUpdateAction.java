...
public interface ReorderApplicationAgreementUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ReorderApplicationAgreementUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<ReorderApplicationAgreementUpdateAction>() {
            @Override
