...
public interface SetActivePaymentComponentTypeUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetActivePaymentComponentTypeUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetActivePaymentComponentTypeUpdateAction>() {
            @Override
