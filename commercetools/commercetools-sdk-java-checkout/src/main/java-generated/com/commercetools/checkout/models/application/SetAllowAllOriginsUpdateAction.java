...
public interface SetAllowAllOriginsUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetAllowAllOriginsUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetAllowAllOriginsUpdateAction>() {
            @Override
