...
public interface SetAllowedOriginsUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetAllowedOriginsUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetAllowedOriginsUpdateAction>() {
            @Override
