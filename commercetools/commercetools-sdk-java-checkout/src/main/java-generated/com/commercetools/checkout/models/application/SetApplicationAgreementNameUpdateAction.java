...
public interface SetApplicationAgreementNameUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetApplicationAgreementNameUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetApplicationAgreementNameUpdateAction>() {
            @Override
