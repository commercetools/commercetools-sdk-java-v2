...
public interface SetApplicationAgreementStatusUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetApplicationAgreementStatusUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetApplicationAgreementStatusUpdateAction>() {
            @Override
