...
public interface SetApplicationAgreementTextUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetApplicationAgreementTextUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetApplicationAgreementTextUpdateAction>() {
            @Override
