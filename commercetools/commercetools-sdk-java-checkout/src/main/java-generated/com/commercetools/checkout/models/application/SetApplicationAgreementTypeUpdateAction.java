...
public interface SetApplicationAgreementTypeUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetApplicationAgreementTypeUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetApplicationAgreementTypeUpdateAction>() {
            @Override
