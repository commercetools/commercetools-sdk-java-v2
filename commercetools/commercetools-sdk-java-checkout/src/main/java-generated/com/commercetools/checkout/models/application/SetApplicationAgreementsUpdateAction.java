...
public interface SetApplicationAgreementsUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetApplicationAgreementsUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetApplicationAgreementsUpdateAction>() {
            @Override
