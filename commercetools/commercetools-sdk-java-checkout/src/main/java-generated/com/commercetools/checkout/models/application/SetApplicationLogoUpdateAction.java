...
public interface SetApplicationLogoUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetApplicationLogoUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetApplicationLogoUpdateAction>() {
            @Override
