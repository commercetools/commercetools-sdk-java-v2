...
public interface SetApplicationNameUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetApplicationNameUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetApplicationNameUpdateAction>() {
            @Override
