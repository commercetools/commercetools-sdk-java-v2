...
public interface SetCountriesUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetCountriesUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetCountriesUpdateAction>() {
            @Override
