...
public interface SetDescriptionUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetDescriptionUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetDescriptionUpdateAction>() {
            @Override
