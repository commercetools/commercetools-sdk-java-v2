...
public interface SetDiscountsConfigurationUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetDiscountsConfigurationUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetDiscountsConfigurationUpdateAction>() {
            @Override
