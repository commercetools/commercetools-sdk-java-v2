...
public interface SetPaymentReturnUrlUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetPaymentReturnUrlUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetPaymentReturnUrlUpdateAction>() {
            @Override
