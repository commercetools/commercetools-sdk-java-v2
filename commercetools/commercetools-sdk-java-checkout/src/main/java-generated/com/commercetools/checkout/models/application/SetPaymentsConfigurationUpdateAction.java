...
public interface SetPaymentsConfigurationUpdateAction extends ApplicationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetPaymentsConfigurationUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetPaymentsConfigurationUpdateAction>() {
            @Override
