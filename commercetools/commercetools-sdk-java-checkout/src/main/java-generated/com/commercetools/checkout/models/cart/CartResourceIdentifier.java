...
/**
 *  <p>Resource identifier to a <span>Cart</span>. Either <code>id</code> or <code>key</code> is required. If both are set, an <a href="https://docs.commercetools.com/apis/ctp:api:type:InvalidJsonInputError" rel="nofollow">InvalidJsonInput</a> error is returned.</p>
 *
 * <hr>
...
public interface CartResourceIdentifier extends ResourceIdentifier {
    ...
    /**
     *  <p>Unique identifier of the referenced <span>Cart</span>. Required if <code>key</code> is absent.</p>
     * @return id
     */
    ...
    /**
     *  <p>User-defined unique identifier of the referenced <span>Cart</span>. Required if <code>id</code> is absent.</p>
     * @return key
     */
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartResourceIdentifier> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartResourceIdentifier>() {
            @Override
