...
public interface ConnectorFailedError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ConnectorFailedError> typeReference() {
        return new tools.jackson.core.type.TypeReference<ConnectorFailedError>() {
            @Override
