...
public interface ErrorResponse {
    ...
    public static ErrorResponse deepCopy(@Nullable final ErrorResponse template) {
        ...
        instance.setErrors(Optional.ofNullable(template.getErrors())
                .map(t -> t.stream()
                        .map(com.commercetools.checkout.models.error.ErrorObject::deepCopy)
     ...
     */
    public static tools.jackson.core.type.TypeReference<ErrorResponse> typeReference() {
        return new tools.jackson.core.type.TypeReference<ErrorResponse>() {
            @Override
