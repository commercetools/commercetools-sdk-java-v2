...
public class ErrorResponseBuilder implements Builder<ErrorResponse> {
    ...
    @Nullable
    private java.util.List<com.commercetools.checkout.models.error.ErrorObject> errors;
    ...
    public ErrorResponseBuilder errors(@Nullable final com.commercetools.checkout.models.error.ErrorObject... errors) {
    ...
    public ErrorResponseBuilder errors(
            @Nullable final java.util.List<com.commercetools.checkout.models.error.ErrorObject> errors) {
        this.errors = errors;
        return this;
    }
    ...
    public ErrorResponseBuilder plusErrors(
            @Nullable final com.commercetools.checkout.models.error.ErrorObject... errors) {
        if (this.errors == null) {
    ...
    public ErrorResponseBuilder plusErrors(
            Function<com.commercetools.checkout.models.error.ErrorObjectBuilder, Builder<? extends com.commercetools.checkout.models.error.ErrorObject>> builder) {
        if (this.errors == null) {
            this.errors = new ArrayList<>();
        }
        this.errors.add(builder.apply(com.commercetools.checkout.models.error.ErrorObjectBuilder.of()).build());
        return this;
    }
    ...
    @Nullable
    public java.util.List<com.commercetools.checkout.models.error.ErrorObject> getErrors() {
        return this.errors;
    }
