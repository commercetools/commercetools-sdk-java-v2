...
public class ErrorResponseImpl implements ErrorResponse, ModelBase {
    ...
    ErrorResponseImpl(@JsonProperty("statusCode") final Integer statusCode,
            ...
            @JsonProperty("errors") final java.util.List<com.commercetools.checkout.models.error.ErrorObject> errors) {
    ...
    public void setErrors(final com.commercetools.checkout.models.error.ErrorObject... errors) {
        this.errors = new ArrayList<>(Arrays.asList(errors));
    }

    public void setErrors(final java.util.List<com.commercetools.checkout.models.error.ErrorObject> errors) {
        this.errors = errors;
    }
