...
public interface MissingProjectKeyError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MissingProjectKeyError> typeReference() {
        return new tools.jackson.core.type.TypeReference<MissingProjectKeyError>() {
            @Override
