...
public interface MultipleActionsNotAllowedError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MultipleActionsNotAllowedError> typeReference() {
        return new tools.jackson.core.type.TypeReference<MultipleActionsNotAllowedError>() {
            @Override
