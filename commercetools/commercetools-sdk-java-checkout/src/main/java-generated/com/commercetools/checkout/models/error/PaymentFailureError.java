...
public interface PaymentFailureError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentFailureError> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentFailureError>() {
            @Override
