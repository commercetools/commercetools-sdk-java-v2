...
public interface ServiceUnavailableError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ServiceUnavailableError> typeReference() {
        return new tools.jackson.core.type.TypeReference<ServiceUnavailableError>() {
            @Override
