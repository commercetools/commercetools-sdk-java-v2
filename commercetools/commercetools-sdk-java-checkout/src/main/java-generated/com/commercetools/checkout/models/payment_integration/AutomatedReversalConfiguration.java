...
public interface AutomatedReversalConfiguration {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AutomatedReversalConfiguration> typeReference() {
        return new tools.jackson.core.type.TypeReference<AutomatedReversalConfiguration>() {
            @Override
