...
public interface ConnectorDeploymentReference {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ConnectorDeploymentReference> typeReference() {
        return new tools.jackson.core.type.TypeReference<ConnectorDeploymentReference>() {
            @Override
