...
public interface PaginatedPaymentIntegration {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaginatedPaymentIntegration> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaginatedPaymentIntegration>() {
            @Override
