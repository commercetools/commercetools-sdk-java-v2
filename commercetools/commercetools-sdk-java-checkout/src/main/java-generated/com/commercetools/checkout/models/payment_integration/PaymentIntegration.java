...
public interface PaymentIntegration {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentIntegration> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentIntegration>() {
            @Override
