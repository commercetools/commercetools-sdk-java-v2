...
public interface PaymentIntegrationReference extends Reference {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentIntegrationReference> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentIntegrationReference>() {
            @Override
