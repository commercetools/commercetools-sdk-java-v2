...
public interface PaymentIntegrationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentIntegrationUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentIntegrationUpdateAction>() {
            @Override
