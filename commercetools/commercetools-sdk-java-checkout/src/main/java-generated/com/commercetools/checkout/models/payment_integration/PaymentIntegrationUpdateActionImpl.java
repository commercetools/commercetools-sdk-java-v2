...
public class PaymentIntegrationUpdateActionImpl implements PaymentIntegrationUpdateAction, ModelBase {
     ...
     */
    @JsonCreator
    PaymentIntegrationUpdateActionImpl(@JsonProperty("action") final String action) {
        this.action = action;
    }
     ...
     */
    public PaymentIntegrationUpdateActionImpl() {
    }
    ...
    public boolean equals(Object o) {
        ...
        PaymentIntegrationUpdateActionImpl that = (PaymentIntegrationUpdateActionImpl) o;
    ...
    public PaymentIntegrationUpdateAction copyDeep() {
        return PaymentIntegrationUpdateAction.deepCopy(this);
    }
}
