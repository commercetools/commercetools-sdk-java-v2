...
public interface PaymentIntegrationUpdateActions {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentIntegrationUpdateActions> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentIntegrationUpdateActions>() {
            @Override
