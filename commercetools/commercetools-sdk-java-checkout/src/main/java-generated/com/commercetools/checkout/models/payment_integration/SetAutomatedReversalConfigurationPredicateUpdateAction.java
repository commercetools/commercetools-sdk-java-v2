...
public interface SetAutomatedReversalConfigurationPredicateUpdateAction extends PaymentIntegrationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetAutomatedReversalConfigurationPredicateUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetAutomatedReversalConfigurationPredicateUpdateAction>() {
            @Override
