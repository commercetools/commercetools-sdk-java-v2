...
public interface SetAutomatedReversalConfigurationUpdateAction extends PaymentIntegrationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetAutomatedReversalConfigurationUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetAutomatedReversalConfigurationUpdateAction>() {
            @Override
