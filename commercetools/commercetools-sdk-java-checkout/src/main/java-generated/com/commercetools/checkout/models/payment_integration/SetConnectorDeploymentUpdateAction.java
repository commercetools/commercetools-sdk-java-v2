...
public interface SetConnectorDeploymentUpdateAction extends PaymentIntegrationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetConnectorDeploymentUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetConnectorDeploymentUpdateAction>() {
            @Override
