...
public interface SetDisplayInfoDescriptionUpdateAction extends PaymentIntegrationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetDisplayInfoDescriptionUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetDisplayInfoDescriptionUpdateAction>() {
            @Override
