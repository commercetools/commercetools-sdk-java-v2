...
public interface SetDisplayInfoLogoUrlUpdateAction extends PaymentIntegrationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetDisplayInfoLogoUrlUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetDisplayInfoLogoUrlUpdateAction>() {
            @Override
