...
public interface SetDisplayInfoPayButtonTextUpdateAction extends PaymentIntegrationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetDisplayInfoPayButtonTextUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetDisplayInfoPayButtonTextUpdateAction>() {
            @Override
