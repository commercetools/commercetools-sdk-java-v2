...
public interface SetDisplayInfoUpdateAction extends PaymentIntegrationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetDisplayInfoUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetDisplayInfoUpdateAction>() {
            @Override
