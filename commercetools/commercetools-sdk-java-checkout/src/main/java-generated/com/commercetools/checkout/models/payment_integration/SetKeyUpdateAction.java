...
public interface SetKeyUpdateAction extends PaymentIntegrationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetKeyUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetKeyUpdateAction>() {
            @Override
