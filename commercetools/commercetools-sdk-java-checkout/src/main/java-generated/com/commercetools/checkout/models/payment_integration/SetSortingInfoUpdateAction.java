...
public interface SetSortingInfoUpdateAction extends PaymentIntegrationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetSortingInfoUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetSortingInfoUpdateAction>() {
            @Override
