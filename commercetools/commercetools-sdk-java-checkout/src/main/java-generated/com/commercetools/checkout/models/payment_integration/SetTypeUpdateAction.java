...
public interface SetTypeUpdateAction extends PaymentIntegrationUpdateAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetTypeUpdateAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetTypeUpdateAction>() {
            @Override
