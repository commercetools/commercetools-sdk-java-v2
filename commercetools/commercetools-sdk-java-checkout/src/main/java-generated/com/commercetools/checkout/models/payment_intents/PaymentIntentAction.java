...
public interface PaymentIntentAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentIntentAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentIntentAction>() {
            @Override
