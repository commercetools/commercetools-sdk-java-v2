...
public interface PaymentIntentReverseAction extends PaymentIntentAction {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentIntentReverseAction> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentIntentReverseAction>() {
            @Override
