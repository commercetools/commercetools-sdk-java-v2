...
public interface AddDiscountCodeError extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AddDiscountCodeError> typeReference() {
        return new tools.jackson.core.type.TypeReference<AddDiscountCodeError>() {
            @Override
