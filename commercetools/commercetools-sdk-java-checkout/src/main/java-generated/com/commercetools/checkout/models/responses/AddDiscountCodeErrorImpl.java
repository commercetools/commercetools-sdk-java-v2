...
public class AddDiscountCodeErrorImpl implements AddDiscountCodeError, ModelBase {
     ...
     */
    @JsonCreator
    AddDiscountCodeErrorImpl(@JsonProperty("severity") final String severity,
     ...
     */
    public AddDiscountCodeErrorImpl() {
        this.code = ADD_DISCOUNT_CODE_ERROR;
    }
    ...
    public boolean equals(Object o) {
        ...
        AddDiscountCodeErrorImpl that = (AddDiscountCodeErrorImpl) o;
    ...
    public AddDiscountCodeError copyDeep() {
        return AddDiscountCodeError.deepCopy(this);
    }
}
