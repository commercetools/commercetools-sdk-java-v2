...
public interface ApplicationDeactivated extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ApplicationDeactivated> typeReference() {
        return new tools.jackson.core.type.TypeReference<ApplicationDeactivated>() {
            @Override
