...
public class BadInputDataImpl implements BadInputData, ModelBase {
     ...
     */
    @JsonCreator
    BadInputDataImpl(@JsonProperty("severity") final String severity, @JsonProperty("message") final String message,
    ...
    public boolean equals(Object o) {
        ...
        BadInputDataImpl that = (BadInputDataImpl) o;
    ...
    public BadInputData copyDeep() {
        return BadInputData.deepCopy(this);
    }
}
