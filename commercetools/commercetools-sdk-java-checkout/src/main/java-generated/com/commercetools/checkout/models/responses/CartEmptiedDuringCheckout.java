...
public interface CartEmptiedDuringCheckout extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartEmptiedDuringCheckout> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartEmptiedDuringCheckout>() {
            @Override
