...
public class CartEmptyImpl implements CartEmpty, ModelBase {
     ...
     */
    @JsonCreator
    CartEmptyImpl(@JsonProperty("severity") final String severity, @JsonProperty("message") final String message,
    ...
    public boolean equals(Object o) {
        ...
        CartEmptyImpl that = (CartEmptyImpl) o;
    ...
    public CartEmpty copyDeep() {
        return CartEmpty.deepCopy(this);
    }
}
