...
public class CartNotFoundImpl implements CartNotFound, ModelBase {
     ...
     */
    @JsonCreator
    CartNotFoundImpl(@JsonProperty("severity") final String severity, @JsonProperty("message") final String message,
    ...
    public boolean equals(Object o) {
        ...
        CartNotFoundImpl that = (CartNotFoundImpl) o;
    ...
    public CartNotFound copyDeep() {
        return CartNotFound.deepCopy(this);
    }
}
