...
public interface CartWithExistingPayment extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartWithExistingPayment> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartWithExistingPayment>() {
            @Override
