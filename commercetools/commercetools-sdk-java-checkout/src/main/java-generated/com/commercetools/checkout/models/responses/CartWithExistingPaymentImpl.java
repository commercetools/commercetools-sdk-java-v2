...
public class CartWithExistingPaymentImpl implements CartWithExistingPayment, ModelBase {
     ...
     */
    @JsonCreator
    CartWithExistingPaymentImpl(@JsonProperty("severity") final String severity,
    ...
    public boolean equals(Object o) {
        ...
        CartWithExistingPaymentImpl that = (CartWithExistingPaymentImpl) o;
    ...
    public CartWithExistingPayment copyDeep() {
        return CartWithExistingPayment.deepCopy(this);
    }
}
