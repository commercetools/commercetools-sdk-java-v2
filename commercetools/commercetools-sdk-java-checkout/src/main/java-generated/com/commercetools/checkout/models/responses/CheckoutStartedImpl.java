...
public class CheckoutStartedImpl implements CheckoutStarted, ModelBase {
     ...
     */
    @JsonCreator
    CheckoutStartedImpl(@JsonProperty("severity") final String severity, @JsonProperty("message") final String message,
    ...
    public boolean equals(Object o) {
        ...
        CheckoutStartedImpl that = (CheckoutStartedImpl) o;
    ...
    public CheckoutStarted copyDeep() {
        return CheckoutStarted.deepCopy(this);
    }
}
