...
public class ConnectorErrorImpl implements ConnectorError, ModelBase {
     ...
     */
    @JsonCreator
    ConnectorErrorImpl(@JsonProperty("severity") final String severity, @JsonProperty("message") final String message,
    ...
    public boolean equals(Object o) {
        ...
        ConnectorErrorImpl that = (ConnectorErrorImpl) o;
    ...
    public ConnectorError copyDeep() {
        return ConnectorError.deepCopy(this);
    }
}
