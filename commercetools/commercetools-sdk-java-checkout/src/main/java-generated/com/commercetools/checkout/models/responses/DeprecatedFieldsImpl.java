...
public class DeprecatedFieldsImpl implements DeprecatedFields, ModelBase {
     ...
     */
    @JsonCreator
    DeprecatedFieldsImpl(@JsonProperty("severity") final String severity, @JsonProperty("message") final String message,
    ...
    public boolean equals(Object o) {
        ...
        DeprecatedFieldsImpl that = (DeprecatedFieldsImpl) o;
    ...
    public DeprecatedFields copyDeep() {
        return DeprecatedFields.deepCopy(this);
    }
}
