...
public interface DiscountCodeNotApplicable extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountCodeNotApplicable> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountCodeNotApplicable>() {
            @Override
