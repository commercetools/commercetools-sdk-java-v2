...
public class DiscountCodeNotApplicableImpl implements DiscountCodeNotApplicable, ModelBase {
     ...
     */
    @JsonCreator
    DiscountCodeNotApplicableImpl(@JsonProperty("severity") final String severity,
     ...
     */
    public DiscountCodeNotApplicableImpl() {
        this.code = DISCOUNT_CODE_NOT_APPLICABLE;
    }
    ...
    public boolean equals(Object o) {
        ...
        DiscountCodeNotApplicableImpl that = (DiscountCodeNotApplicableImpl) o;
    ...
    public DiscountCodeNotApplicable copyDeep() {
        return DiscountCodeNotApplicable.deepCopy(this);
    }
}
