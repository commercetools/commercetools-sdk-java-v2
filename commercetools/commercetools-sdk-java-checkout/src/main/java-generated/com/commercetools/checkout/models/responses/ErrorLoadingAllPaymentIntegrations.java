...
public interface ErrorLoadingAllPaymentIntegrations extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ErrorLoadingAllPaymentIntegrations> typeReference() {
        return new tools.jackson.core.type.TypeReference<ErrorLoadingAllPaymentIntegrations>() {
            @Override
