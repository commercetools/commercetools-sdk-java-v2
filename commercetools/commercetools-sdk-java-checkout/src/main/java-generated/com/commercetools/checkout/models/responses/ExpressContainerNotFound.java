...
public interface ExpressContainerNotFound extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ExpressContainerNotFound> typeReference() {
        return new tools.jackson.core.type.TypeReference<ExpressContainerNotFound>() {
            @Override
