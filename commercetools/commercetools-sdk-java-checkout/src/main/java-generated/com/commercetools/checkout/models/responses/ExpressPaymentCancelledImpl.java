...
public class ExpressPaymentCancelledImpl implements ExpressPaymentCancelled, ModelBase {
     ...
     */
    @JsonCreator
    ExpressPaymentCancelledImpl(@JsonProperty("severity") final String severity,
     ...
     */
    public ExpressPaymentCancelledImpl() {
        this.code = EXPRESS_PAYMENT_CANCELLED;
    }
    ...
    public boolean equals(Object o) {
        ...
        ExpressPaymentCancelledImpl that = (ExpressPaymentCancelledImpl) o;
    ...
    public ExpressPaymentCancelled copyDeep() {
        return ExpressPaymentCancelled.deepCopy(this);
    }
}
