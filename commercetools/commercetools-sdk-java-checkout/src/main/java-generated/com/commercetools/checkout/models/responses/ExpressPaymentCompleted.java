...
public interface ExpressPaymentCompleted extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ExpressPaymentCompleted> typeReference() {
        return new tools.jackson.core.type.TypeReference<ExpressPaymentCompleted>() {
            @Override
