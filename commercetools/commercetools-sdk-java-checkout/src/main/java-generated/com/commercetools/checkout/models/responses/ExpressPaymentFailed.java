...
public interface ExpressPaymentFailed extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ExpressPaymentFailed> typeReference() {
        return new tools.jackson.core.type.TypeReference<ExpressPaymentFailed>() {
            @Override
