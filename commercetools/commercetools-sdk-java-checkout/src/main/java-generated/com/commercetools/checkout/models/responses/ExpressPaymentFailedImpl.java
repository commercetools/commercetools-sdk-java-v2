...
public class ExpressPaymentFailedImpl implements ExpressPaymentFailed, ModelBase {
     ...
     */
    @JsonCreator
    ExpressPaymentFailedImpl(@JsonProperty("severity") final String severity,
     ...
     */
    public ExpressPaymentFailedImpl() {
        this.code = EXPRESS_PAYMENT_FAILED;
    }
    ...
    public boolean equals(Object o) {
        ...
        ExpressPaymentFailedImpl that = (ExpressPaymentFailedImpl) o;
    ...
    public ExpressPaymentFailed copyDeep() {
        return ExpressPaymentFailed.deepCopy(this);
    }
}
