...
public interface ExpressPaymentInterrupted extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ExpressPaymentInterrupted> typeReference() {
        return new tools.jackson.core.type.TypeReference<ExpressPaymentInterrupted>() {
            @Override
