...
public class ExpressPaymentInterruptedImpl implements ExpressPaymentInterrupted, ModelBase {
     ...
     */
    @JsonCreator
    ExpressPaymentInterruptedImpl(@JsonProperty("severity") final String severity,
     ...
     */
    public ExpressPaymentInterruptedImpl() {
        this.code = EXPRESS_PAYMENT_INTERRUPTED;
    }
    ...
    public boolean equals(Object o) {
        ...
        ExpressPaymentInterruptedImpl that = (ExpressPaymentInterruptedImpl) o;
    ...
    public ExpressPaymentInterrupted copyDeep() {
        return ExpressPaymentInterrupted.deepCopy(this);
    }
}
