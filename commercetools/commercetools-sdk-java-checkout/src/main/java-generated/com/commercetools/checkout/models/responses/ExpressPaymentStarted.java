...
public interface ExpressPaymentStarted extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ExpressPaymentStarted> typeReference() {
        return new tools.jackson.core.type.TypeReference<ExpressPaymentStarted>() {
            @Override
