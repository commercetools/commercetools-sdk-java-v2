...
public class ExpressPaymentStartedImpl implements ExpressPaymentStarted, ModelBase {
     ...
     */
    @JsonCreator
    ExpressPaymentStartedImpl(@JsonProperty("severity") final String severity,
     ...
     */
    public ExpressPaymentStartedImpl() {
        this.code = EXPRESS_PAYMENT_STARTED;
    }
    ...
    public boolean equals(Object o) {
        ...
        ExpressPaymentStartedImpl that = (ExpressPaymentStartedImpl) o;
    ...
    public ExpressPaymentStarted copyDeep() {
        return ExpressPaymentStarted.deepCopy(this);
    }
}
