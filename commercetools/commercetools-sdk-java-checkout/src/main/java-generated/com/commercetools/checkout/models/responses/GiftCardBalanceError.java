...
public interface GiftCardBalanceError extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GiftCardBalanceError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GiftCardBalanceError>() {
            @Override
