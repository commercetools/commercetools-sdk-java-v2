...
public class GiftCardBalanceErrorImpl implements GiftCardBalanceError, ModelBase {
     ...
     */
    @JsonCreator
    GiftCardBalanceErrorImpl(@JsonProperty("severity") final String severity,
     ...
     */
    public GiftCardBalanceErrorImpl() {
        this.code = GIFT_CARD_BALANCE_ERROR;
    }
    ...
    public boolean equals(Object o) {
        ...
        GiftCardBalanceErrorImpl that = (GiftCardBalanceErrorImpl) o;
    ...
    public GiftCardBalanceError copyDeep() {
        return GiftCardBalanceError.deepCopy(this);
    }
}
