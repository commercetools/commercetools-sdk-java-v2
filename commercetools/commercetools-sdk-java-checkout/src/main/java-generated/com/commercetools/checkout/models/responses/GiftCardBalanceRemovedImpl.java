...
public class GiftCardBalanceRemovedImpl implements GiftCardBalanceRemoved, ModelBase {
     ...
     */
    @JsonCreator
    GiftCardBalanceRemovedImpl(@JsonProperty("severity") final String severity,
     ...
     */
    public GiftCardBalanceRemovedImpl() {
        this.code = GIFT_CARD_BALANCE_REMOVED;
    }
    ...
    public boolean equals(Object o) {
        ...
        GiftCardBalanceRemovedImpl that = (GiftCardBalanceRemovedImpl) o;
    ...
    public GiftCardBalanceRemoved copyDeep() {
        return GiftCardBalanceRemoved.deepCopy(this);
    }
}
