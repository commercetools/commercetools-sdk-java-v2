...
public interface GiftCardBalanceSuccess extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GiftCardBalanceSuccess> typeReference() {
        return new tools.jackson.core.type.TypeReference<GiftCardBalanceSuccess>() {
            @Override
