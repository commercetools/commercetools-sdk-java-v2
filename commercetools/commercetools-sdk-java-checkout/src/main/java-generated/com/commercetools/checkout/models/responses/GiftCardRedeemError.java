...
public interface GiftCardRedeemError extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GiftCardRedeemError> typeReference() {
        return new tools.jackson.core.type.TypeReference<GiftCardRedeemError>() {
            @Override
