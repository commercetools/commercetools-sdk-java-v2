...
public class GiftCardRedeemErrorImpl implements GiftCardRedeemError, ModelBase {
     ...
     */
    @JsonCreator
    GiftCardRedeemErrorImpl(@JsonProperty("severity") final String severity,
     ...
     */
    public GiftCardRedeemErrorImpl() {
        this.code = GIFT_CARD_REDEEM_ERROR;
    }
    ...
    public boolean equals(Object o) {
        ...
        GiftCardRedeemErrorImpl that = (GiftCardRedeemErrorImpl) o;
    ...
    public GiftCardRedeemError copyDeep() {
        return GiftCardRedeemError.deepCopy(this);
    }
}
