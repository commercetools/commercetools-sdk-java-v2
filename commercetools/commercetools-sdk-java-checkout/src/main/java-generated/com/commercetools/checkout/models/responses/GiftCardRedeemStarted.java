...
public interface GiftCardRedeemStarted extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GiftCardRedeemStarted> typeReference() {
        return new tools.jackson.core.type.TypeReference<GiftCardRedeemStarted>() {
            @Override
