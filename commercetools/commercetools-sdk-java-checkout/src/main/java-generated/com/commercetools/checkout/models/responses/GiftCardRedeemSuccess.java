...
public interface GiftCardRedeemSuccess extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GiftCardRedeemSuccess> typeReference() {
        return new tools.jackson.core.type.TypeReference<GiftCardRedeemSuccess>() {
            @Override
