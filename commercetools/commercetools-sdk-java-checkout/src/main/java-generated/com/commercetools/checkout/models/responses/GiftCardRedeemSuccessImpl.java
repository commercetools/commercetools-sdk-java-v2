...
public class GiftCardRedeemSuccessImpl implements GiftCardRedeemSuccess, ModelBase {
     ...
     */
    @JsonCreator
    GiftCardRedeemSuccessImpl(@JsonProperty("severity") final String severity,
     ...
     */
    public GiftCardRedeemSuccessImpl() {
        this.code = GIFT_CARD_REDEEM_SUCCESS;
    }
    ...
    public boolean equals(Object o) {
        ...
        GiftCardRedeemSuccessImpl that = (GiftCardRedeemSuccessImpl) o;
    ...
    public GiftCardRedeemSuccess copyDeep() {
        return GiftCardRedeemSuccess.deepCopy(this);
    }
}
