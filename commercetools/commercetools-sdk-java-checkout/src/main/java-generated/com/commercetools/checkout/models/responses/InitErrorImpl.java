...
public class InitErrorImpl implements InitError, ModelBase {
     ...
     */
    @JsonCreator
    InitErrorImpl(@JsonProperty("severity") final String severity, @JsonProperty("message") final String message,
    ...
    public boolean equals(Object o) {
        ...
        InitErrorImpl that = (InitErrorImpl) o;
    ...
    public InitError copyDeep() {
        return InitError.deepCopy(this);
    }
}
