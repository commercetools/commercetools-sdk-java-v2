...
public class InitTimeoutImpl implements InitTimeout, ModelBase {
     ...
     */
    @JsonCreator
    InitTimeoutImpl(@JsonProperty("severity") final String severity, @JsonProperty("message") final String message,
    ...
    public boolean equals(Object o) {
        ...
        InitTimeoutImpl that = (InitTimeoutImpl) o;
    ...
    public InitTimeout copyDeep() {
        return InitTimeout.deepCopy(this);
    }
}
