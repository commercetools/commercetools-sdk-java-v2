...
public class InvalidModeImpl implements InvalidMode, ModelBase {
     ...
     */
    @JsonCreator
    InvalidModeImpl(@JsonProperty("severity") final String severity, @JsonProperty("message") final String message,
    ...
    public boolean equals(Object o) {
        ...
        InvalidModeImpl that = (InvalidModeImpl) o;
    ...
    public InvalidMode copyDeep() {
        return InvalidMode.deepCopy(this);
    }
}
