...
public interface MultipleVendorButtonContainers extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<MultipleVendorButtonContainers> typeReference() {
        return new tools.jackson.core.type.TypeReference<MultipleVendorButtonContainers>() {
            @Override
