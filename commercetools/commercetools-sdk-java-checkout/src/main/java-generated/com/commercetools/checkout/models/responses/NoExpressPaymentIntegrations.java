...
public interface NoExpressPaymentIntegrations extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<NoExpressPaymentIntegrations> typeReference() {
        return new tools.jackson.core.type.TypeReference<NoExpressPaymentIntegrations>() {
            @Override
