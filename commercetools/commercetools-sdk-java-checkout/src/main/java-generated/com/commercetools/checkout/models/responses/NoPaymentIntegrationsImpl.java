...
public class NoPaymentIntegrationsImpl implements NoPaymentIntegrations, ModelBase {
     ...
     */
    @JsonCreator
    NoPaymentIntegrationsImpl(@JsonProperty("severity") final String severity,
     ...
     */
    public NoPaymentIntegrationsImpl() {
        this.code = NO_PAYMENT_INTEGRATIONS;
    }
    ...
    public boolean equals(Object o) {
        ...
        NoPaymentIntegrationsImpl that = (NoPaymentIntegrationsImpl) o;
    ...
    public NoPaymentIntegrations copyDeep() {
        return NoPaymentIntegrations.deepCopy(this);
    }
}
