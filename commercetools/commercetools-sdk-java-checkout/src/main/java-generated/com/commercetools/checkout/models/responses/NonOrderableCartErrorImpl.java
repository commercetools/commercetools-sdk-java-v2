...
public class NonOrderableCartErrorImpl implements NonOrderableCartError, ModelBase {
     ...
     */
    @JsonCreator
    NonOrderableCartErrorImpl(@JsonProperty("severity") final String severity,
     ...
     */
    public NonOrderableCartErrorImpl() {
        this.code = NON_ORDERABLE_CART_ERROR;
    }
    ...
    public boolean equals(Object o) {
        ...
        NonOrderableCartErrorImpl that = (NonOrderableCartErrorImpl) o;
    ...
    public NonOrderableCartError copyDeep() {
        return NonOrderableCartError.deepCopy(this);
    }
}
