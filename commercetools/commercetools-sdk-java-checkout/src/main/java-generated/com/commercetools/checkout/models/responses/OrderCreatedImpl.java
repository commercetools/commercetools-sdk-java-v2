...
public class OrderCreatedImpl implements OrderCreated, ModelBase {
     ...
     */
    @JsonCreator
    OrderCreatedImpl(@JsonProperty("severity") final String severity, @JsonProperty("message") final String message,
    ...
    public boolean equals(Object o) {
        ...
        OrderCreatedImpl that = (OrderCreatedImpl) o;
    ...
    public OrderCreated copyDeep() {
        return OrderCreated.deepCopy(this);
    }
}
