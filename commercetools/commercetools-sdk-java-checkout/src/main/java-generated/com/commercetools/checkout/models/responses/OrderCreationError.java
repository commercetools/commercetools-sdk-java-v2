...
public interface OrderCreationError extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderCreationError> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderCreationError>() {
            @Override
