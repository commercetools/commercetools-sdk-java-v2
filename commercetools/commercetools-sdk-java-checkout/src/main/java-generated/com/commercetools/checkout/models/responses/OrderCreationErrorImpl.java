...
public class OrderCreationErrorImpl implements OrderCreationError, ModelBase {
     ...
     */
    @JsonCreator
    OrderCreationErrorImpl(@JsonProperty("severity") final String severity,
    ...
    public boolean equals(Object o) {
        ...
        OrderCreationErrorImpl that = (OrderCreationErrorImpl) o;
    ...
    public OrderCreationError copyDeep() {
        return OrderCreationError.deepCopy(this);
    }
}
