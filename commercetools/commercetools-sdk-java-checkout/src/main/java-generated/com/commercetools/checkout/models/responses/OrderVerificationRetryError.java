...
public interface OrderVerificationRetryError extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderVerificationRetryError> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderVerificationRetryError>() {
            @Override
