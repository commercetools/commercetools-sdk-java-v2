...
public class OrderVerificationRetryErrorImpl implements OrderVerificationRetryError, ModelBase {
     ...
     */
    @JsonCreator
    OrderVerificationRetryErrorImpl(@JsonProperty("severity") final String severity,
     ...
     */
    public OrderVerificationRetryErrorImpl() {
        this.code = ORDER_VERIFICATION_RETRY_ERROR;
    }
    ...
    public boolean equals(Object o) {
        ...
        OrderVerificationRetryErrorImpl that = (OrderVerificationRetryErrorImpl) o;
    ...
    public OrderVerificationRetryError copyDeep() {
        return OrderVerificationRetryError.deepCopy(this);
    }
}
