...
public interface OrderVerificationStarted extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderVerificationStarted> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderVerificationStarted>() {
            @Override
