...
public interface OrderVerificationTimeout extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<OrderVerificationTimeout> typeReference() {
        return new tools.jackson.core.type.TypeReference<OrderVerificationTimeout>() {
            @Override
