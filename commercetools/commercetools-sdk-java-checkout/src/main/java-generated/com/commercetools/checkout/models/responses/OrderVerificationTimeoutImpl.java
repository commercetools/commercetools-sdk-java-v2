...
public class OrderVerificationTimeoutImpl implements OrderVerificationTimeout, ModelBase {
     ...
     */
    @JsonCreator
    OrderVerificationTimeoutImpl(@JsonProperty("severity") final String severity,
     ...
     */
    public OrderVerificationTimeoutImpl() {
        this.code = ORDER_VERIFICATION_TIMEOUT;
    }
    ...
    public boolean equals(Object o) {
        ...
        OrderVerificationTimeoutImpl that = (OrderVerificationTimeoutImpl) o;
    ...
    public OrderVerificationTimeout copyDeep() {
        return OrderVerificationTimeout.deepCopy(this);
    }
}
