...
public class PaymentCancelledImpl implements PaymentCancelled, ModelBase {
     ...
     */
    @JsonCreator
    PaymentCancelledImpl(@JsonProperty("severity") final String severity, @JsonProperty("message") final String message,
    ...
    public boolean equals(Object o) {
        ...
        PaymentCancelledImpl that = (PaymentCancelledImpl) o;
    ...
    public PaymentCancelled copyDeep() {
        return PaymentCancelled.deepCopy(this);
    }
}
