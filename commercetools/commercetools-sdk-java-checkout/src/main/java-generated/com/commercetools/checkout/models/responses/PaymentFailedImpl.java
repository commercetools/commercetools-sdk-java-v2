...
public class PaymentFailedImpl implements PaymentFailed, ModelBase {
     ...
     */
    @JsonCreator
    PaymentFailedImpl(@JsonProperty("severity") final String severity, @JsonProperty("message") final String message,
    ...
    public boolean equals(Object o) {
        ...
        PaymentFailedImpl that = (PaymentFailedImpl) o;
    ...
    public PaymentFailed copyDeep() {
        return PaymentFailed.deepCopy(this);
    }
}
