...
public interface PaymentIntegrationLoaded extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentIntegrationLoaded> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentIntegrationLoaded>() {
            @Override
