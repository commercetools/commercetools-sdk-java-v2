...
public class PaymentIntegrationLoadedImpl implements PaymentIntegrationLoaded, ModelBase {
     ...
     */
    @JsonCreator
    PaymentIntegrationLoadedImpl(@JsonProperty("severity") final String severity,
     ...
     */
    public PaymentIntegrationLoadedImpl() {
        this.code = PAYMENT_INTEGRATION_LOADED;
    }
    ...
    public boolean equals(Object o) {
        ...
        PaymentIntegrationLoadedImpl that = (PaymentIntegrationLoadedImpl) o;
    ...
    public PaymentIntegrationLoaded copyDeep() {
        return PaymentIntegrationLoaded.deepCopy(this);
    }
}
