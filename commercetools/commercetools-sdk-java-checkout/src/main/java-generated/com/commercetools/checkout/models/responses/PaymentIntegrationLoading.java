...
public interface PaymentIntegrationLoading extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentIntegrationLoading> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentIntegrationLoading>() {
            @Override
