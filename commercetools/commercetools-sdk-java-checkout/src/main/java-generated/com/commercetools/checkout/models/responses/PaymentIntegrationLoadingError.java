...
public interface PaymentIntegrationLoadingError extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentIntegrationLoadingError> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentIntegrationLoadingError>() {
            @Override
