...
public interface PaymentIntegrationNotAvailable extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentIntegrationNotAvailable> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentIntegrationNotAvailable>() {
            @Override
