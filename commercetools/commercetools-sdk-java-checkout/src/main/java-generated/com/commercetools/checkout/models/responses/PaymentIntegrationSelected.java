...
public interface PaymentIntegrationSelected extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentIntegrationSelected> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentIntegrationSelected>() {
            @Override
