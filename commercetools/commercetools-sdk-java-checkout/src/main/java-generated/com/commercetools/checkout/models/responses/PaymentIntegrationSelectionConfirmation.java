...
public interface PaymentIntegrationSelectionConfirmation extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentIntegrationSelectionConfirmation> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentIntegrationSelectionConfirmation>() {
            @Override
