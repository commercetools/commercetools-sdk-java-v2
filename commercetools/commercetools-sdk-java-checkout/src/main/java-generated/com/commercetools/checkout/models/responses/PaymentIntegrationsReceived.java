...
public interface PaymentIntegrationsReceived extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentIntegrationsReceived> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentIntegrationsReceived>() {
            @Override
