...
public class PaymentStartedImpl implements PaymentStarted, ModelBase {
     ...
     */
    @JsonCreator
    PaymentStartedImpl(@JsonProperty("severity") final String severity, @JsonProperty("message") final String message,
    ...
    public boolean equals(Object o) {
        ...
        PaymentStartedImpl that = (PaymentStartedImpl) o;
    ...
    public PaymentStarted copyDeep() {
        return PaymentStarted.deepCopy(this);
    }
}
