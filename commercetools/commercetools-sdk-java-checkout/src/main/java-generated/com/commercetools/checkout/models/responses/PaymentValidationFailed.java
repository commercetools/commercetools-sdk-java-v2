...
public interface PaymentValidationFailed extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentValidationFailed> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentValidationFailed>() {
            @Override
