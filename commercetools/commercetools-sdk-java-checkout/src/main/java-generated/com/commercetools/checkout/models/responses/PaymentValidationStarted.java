...
public interface PaymentValidationStarted extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<PaymentValidationStarted> typeReference() {
        return new tools.jackson.core.type.TypeReference<PaymentValidationStarted>() {
            @Override
