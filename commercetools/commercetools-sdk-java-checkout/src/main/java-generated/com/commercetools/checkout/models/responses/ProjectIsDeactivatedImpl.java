...
public class ProjectIsDeactivatedImpl implements ProjectIsDeactivated, ModelBase {
     ...
     */
    @JsonCreator
    ProjectIsDeactivatedImpl(@JsonProperty("severity") final String severity,
     ...
     */
    public ProjectIsDeactivatedImpl() {
        this.code = PROJECT_DEACTIVATED;
    }
    ...
    public boolean equals(Object o) {
        ...
        ProjectIsDeactivatedImpl that = (ProjectIsDeactivatedImpl) o;
    ...
    public ProjectIsDeactivated copyDeep() {
        return ProjectIsDeactivated.deepCopy(this);
    }
}
