...
public interface RemoveDiscountCodeError extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RemoveDiscountCodeError> typeReference() {
        return new tools.jackson.core.type.TypeReference<RemoveDiscountCodeError>() {
            @Override
