...
public class RemoveDiscountCodeErrorImpl implements RemoveDiscountCodeError, ModelBase {
     ...
     */
    @JsonCreator
    RemoveDiscountCodeErrorImpl(@JsonProperty("severity") final String severity,
     ...
     */
    public RemoveDiscountCodeErrorImpl() {
        this.code = REMOVE_DISCOUNT_CODE_ERROR;
    }
    ...
    public boolean equals(Object o) {
        ...
        RemoveDiscountCodeErrorImpl that = (RemoveDiscountCodeErrorImpl) o;
    ...
    public RemoveDiscountCodeError copyDeep() {
        return RemoveDiscountCodeError.deepCopy(this);
    }
}
