...
public interface SetShippingAddressError extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetShippingAddressError> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetShippingAddressError>() {
            @Override
