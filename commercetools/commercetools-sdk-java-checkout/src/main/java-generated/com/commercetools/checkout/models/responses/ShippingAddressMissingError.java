...
public interface ShippingAddressMissingError extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingAddressMissingError> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingAddressMissingError>() {
            @Override
