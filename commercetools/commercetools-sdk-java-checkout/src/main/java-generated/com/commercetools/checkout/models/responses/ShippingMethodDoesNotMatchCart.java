...
public interface ShippingMethodDoesNotMatchCart extends Message {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodDoesNotMatchCart> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodDoesNotMatchCart>() {
            @Override
