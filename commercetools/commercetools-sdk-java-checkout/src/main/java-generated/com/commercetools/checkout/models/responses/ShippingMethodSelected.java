...
public interface ShippingMethodSelected extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodSelected> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodSelected>() {
            @Override
