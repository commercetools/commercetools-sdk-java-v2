...
public interface ShippingMethodSelectionConfirmation extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodSelectionConfirmation> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodSelectionConfirmation>() {
            @Override
