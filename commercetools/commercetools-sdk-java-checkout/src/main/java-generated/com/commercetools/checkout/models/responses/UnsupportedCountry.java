...
public interface UnsupportedCountry extends ResponseMessage {
     ...
     */
    public static tools.jackson.core.type.TypeReference<UnsupportedCountry> typeReference() {
        return new tools.jackson.core.type.TypeReference<UnsupportedCountry>() {
            @Override
