...
public class ByProjectKeyApplicationsKeyByKeyTest {
    ...
    public static Object[][] requestWithMethodParameters() {
        return new Object[][] { new Object[] {
                apiRoot.withProjectKey("test_projectKey").applications().withKey("test_key").get().createHttpRequest(),
                "get", "test_projectKey/applications/key=test_key", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .applications()
                        .withKey("test_key")
                        .post(com.commercetools.checkout.models.application.ApplicationUpdateActions.of())
                        .createHttpRequest(), "post", "test_projectKey/applications/key=test_key", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .applications()
                        .withKey("test_key")
                        .head()
    ...
    public static Object[][] executeMethodParameters() {
        return new Object[][] {
                new Object[] { apiRoot.withProjectKey("test_projectKey").applications().withKey("test_key").get(), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .applications()
                        .withKey("test_key")
                        .post(com.commercetools.checkout.models.application.ApplicationUpdateActions.of()), },
                new Object[] { apiRoot.withProjectKey("test_projectKey").applications().withKey("test_key").head(), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .applications()
                        .withKey("test_key")
                        .delete()
