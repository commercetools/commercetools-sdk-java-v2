...
public class ByProjectKeyPaymentIntegrationsByIdTest {
    ...
    public static Object[][] requestWithMethodParameters() {
        return new Object[][] {
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .withId("test_id")
                        .get()
                        .createHttpRequest(), "get", "test_projectKey/payment-integrations/test_id", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .paymentIntegrations()
                        .withId("test_id")
                        .head()
                        .createHttpRequest(), "head", "test_projectKey/payment-integrations/test_id", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .paymentIntegrations()
                        .withId("test_id")
                        .post(
    ...
    public static Object[][] executeMethodParameters() {
        return new Object[][] {
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").paymentIntegrations().withId("test_id").get(), },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").paymentIntegrations().withId("test_id").head(), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .paymentIntegrations()
                        .withId("test_id")
