...
public class ByProjectKeyPaymentIntegrationsKeyByKeyTest {
    ...
    public static Object[][] requestWithMethodParameters() {
        return new Object[][] {
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        ...
                        .withKey("test_key")
                        .get()
                        .createHttpRequest(), "get", "test_projectKey/payment-integrations/key=test_key", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .paymentIntegrations()
                        .withKey("test_key")
                        .post(
                            com.commercetools.checkout.models.payment_integration.PaymentIntegrationUpdateActions.of())
                        .createHttpRequest(), "post", "test_projectKey/payment-integrations/key=test_key", },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .paymentIntegrations()
                        .withKey("test_key")
                        .head()
                        .createHttpRequest(), "head", "test_projectKey/payment-integrations/key=test_key", },
                new Object[] {
    ...
    public static Object[][] executeMethodParameters() {
        return new Object[][] {
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").paymentIntegrations().withKey("test_key").get(), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .paymentIntegrations()
                        .withKey("test_key")
                        .post(com.commercetools.checkout.models.payment_integration.PaymentIntegrationUpdateActions
                                .of()), },
                new Object[] {
                        apiRoot.withProjectKey("test_projectKey").paymentIntegrations().withKey("test_key").head(), },
                new Object[] { apiRoot.withProjectKey("test_projectKey")
                        .paymentIntegrations()
                        .withKey("test_key")
                        .delete(com.commercetools.checkout.models.payment_integration.PaymentIntegration.of()), } };
