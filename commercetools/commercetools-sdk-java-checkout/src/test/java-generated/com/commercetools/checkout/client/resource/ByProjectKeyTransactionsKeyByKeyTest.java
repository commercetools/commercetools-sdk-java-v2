...
public class ByProjectKeyTransactionsKeyByKeyTest {
    ...
    public static Object[][] requestWithMethodParameters() {
        return new Object[][] { new Object[] {
                apiRoot.withProjectKey("test_projectKey").transactions().withKey("test_key").get().createHttpRequest(),
                "get", "test_projectKey/transactions/key=test_key", } };
    }

    public static Object[][] executeMethodParameters() {
        return new Object[][] {
                new Object[] { apiRoot.withProjectKey("test_projectKey").transactions().withKey("test_key").get(), } };
    }
}
