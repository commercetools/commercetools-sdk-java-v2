...
public class ByProjectKeyGet extends ApiMethod<ByProjectKeyGet, com.commercetools.history.models.change_history.RecordPagedQueryResponse> {
    ...
    public <TValue> ByProjectKeyGet withResourceTypes(final Collection<TValue> resourceTypes) {
        return copy().withoutQueryParam("resourceTypes").addQueryParams(resourceTypes.stream().map(s -> new ParamEntry<>("resourceTypes", s.toString())).collect(Collectors.toList())); 
    }
    ...
    public <TValue> ByProjectKeyGet addResourceTypes(final Collection<TValue> resourceTypes) {
        return copy().addQueryParams(resourceTypes.stream().map(s -> new ParamEntry<>("resourceTypes", s.toString())).collect(Collectors.toList())); 
    }
     ...
     * @return ByProjectKeyGet
     */
    public <TValue> ByProjectKeyGet withExcludePlatformInitiatedChanges(final Collection<TValue> excludePlatformInitiatedChanges) {
     ...
     * @return ByProjectKeyGet
     */
    public <TValue> ByProjectKeyGet addExcludePlatformInitiatedChanges(final Collection<TValue> excludePlatformInitiatedChanges) {
