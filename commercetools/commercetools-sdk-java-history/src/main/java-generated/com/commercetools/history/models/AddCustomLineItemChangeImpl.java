...
public final class AddCustomLineItemChangeImpl implements AddCustomLineItemChange {
    ...
    AddCustomLineItemChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("nextValue") final com.commercetools.history.models.CustomLineItem nextValue,
            @JsonProperty("previousValue") final com.commercetools.history.models.CustomLineItem previousValue) {
        this.change = change;
    ...
    */
    ...
    public void setNextValue(final com.commercetools.history.models.CustomLineItem nextValue) {
        this.nextValue = nextValue;
    }

    public void setPreviousValue(final com.commercetools.history.models.CustomLineItem previousValue) {
        this.previousValue = previousValue;
    }
