...
public final class AddFieldDefinitionChangeImpl implements AddFieldDefinitionChange {

    private String type;

    private String change;

    private com.commercetools.history.models.FieldDefinition nextValue;

    @JsonCreator
    AddFieldDefinitionChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("nextValue") final com.commercetools.history.models.FieldDefinition nextValue) {
        this.change = change;
    ...
    */
    ...
    public com.commercetools.history.models.FieldDefinition getNextValue() {
    ...
    public void setNextValue(final com.commercetools.history.models.FieldDefinition nextValue) {
        this.nextValue = nextValue;
    }
