...
public final class AddInterfaceInteractionChangeImpl implements AddInterfaceInteractionChange {
    ...
    AddInterfaceInteractionChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("nextValue") final com.commercetools.history.models.CustomFieldExpandedValue nextValue) {
        this.change = change;
    ...
    */
    ...
    public void setNextValue(final com.commercetools.history.models.CustomFieldExpandedValue nextValue) {
        this.nextValue = nextValue;
    }
