...
public final class AddItemShippingAddressesChangeImpl implements AddItemShippingAddressesChange {
    ...
    @JsonCreator
    AddItemShippingAddressesChangeImpl(@JsonProperty("change") final String change,
