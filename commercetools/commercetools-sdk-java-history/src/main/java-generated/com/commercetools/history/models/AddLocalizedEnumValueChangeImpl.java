...
public final class AddLocalizedEnumValueChangeImpl implements AddLocalizedEnumValueChange {
    ...
    private com.commercetools.history.models.LocalizedEnumValue nextValue;

    @JsonCreator
    AddLocalizedEnumValueChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("fieldName") final String fieldName,
            @JsonProperty("attributeName") final String attributeName,
            @JsonProperty("nextValue") final com.commercetools.history.models.LocalizedEnumValue nextValue) {
        this.change = change;
    ...
    */
    ...
    public com.commercetools.history.models.LocalizedEnumValue getNextValue() {
