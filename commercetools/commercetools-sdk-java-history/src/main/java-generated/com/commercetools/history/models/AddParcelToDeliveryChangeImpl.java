...
public final class AddParcelToDeliveryChangeImpl implements AddParcelToDeliveryChange {
    ...
    AddParcelToDeliveryChangeImpl(@JsonProperty("change") final String change,
            ...
            @JsonProperty("nextValue") final com.commercetools.history.models.Parcel nextValue) {
        this.change = change;
    ...
    */
    ...
    public void setNextValue(final com.commercetools.history.models.Parcel nextValue) {
        this.nextValue = nextValue;
    }
