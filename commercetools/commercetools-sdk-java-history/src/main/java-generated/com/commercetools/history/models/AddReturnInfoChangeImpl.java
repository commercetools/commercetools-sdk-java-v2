...
public final class AddReturnInfoChangeImpl implements AddReturnInfoChange {
    ...
    AddReturnInfoChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("nextValue") final com.commercetools.history.models.ReturnInfo nextValue) {
        this.change = change;
    ...
    */
    ...
    public void setNextValue(final com.commercetools.history.models.ReturnInfo nextValue) {
        this.nextValue = nextValue;
    }
