...
public final class AddTransactionChangeImpl implements AddTransactionChange {
    ...
    AddTransactionChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("nextValue") final com.commercetools.history.models.Transaction nextValue) {
        this.change = change;
    ...
    */
    ...
    public void setNextValue(final com.commercetools.history.models.Transaction nextValue) {
        this.nextValue = nextValue;
    }
