...
public final class AssetSourceImpl implements AssetSource {
    ...
    AssetSourceImpl(@JsonProperty("uri") final String uri, @JsonProperty("key") final String key,
            @JsonProperty("dimensions") final com.commercetools.history.models.AssetDimensions dimensions,
    ...
    public void setDimensions(final com.commercetools.history.models.AssetDimensions dimensions) {
        this.dimensions = dimensions;
    }
