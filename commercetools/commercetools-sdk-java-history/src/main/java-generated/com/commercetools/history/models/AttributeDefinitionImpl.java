...
public final class AttributeDefinitionImpl implements AttributeDefinition {
    ...
    AttributeDefinitionImpl(@JsonProperty("type") final java.lang.Object type, @JsonProperty("name") final String name,
            @JsonProperty("label") final com.commercetools.history.models.LocalizedString label,
            @JsonProperty("isRequired") final Boolean isRequired,
            @JsonProperty("attributeConstraint") final com.commercetools.history.models.AttributeConstraintEnum attributeConstraint,
            @JsonProperty("inputTip") final com.commercetools.history.models.LocalizedString inputTip,
            @JsonProperty("inputHint") final com.commercetools.history.models.TextInputHint inputHint,
    ...
    */
    ...
    public void setLabel(final com.commercetools.history.models.LocalizedString label) {
        this.label = label;
    }
    ...
    public void setInputTip(final com.commercetools.history.models.LocalizedString inputTip) {
        this.inputTip = inputTip;
    }

    public void setInputHint(final com.commercetools.history.models.TextInputHint inputHint) {
        this.inputHint = inputHint;
    }
