...
public final class ChangeAssetOrderChangeImpl implements ChangeAssetOrderChange {
    ...
    ChangeAssetOrderChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("previousValue") final java.util.List<com.commercetools.history.models.LocalizedString> previousValue,
            @JsonProperty("nextValue") final java.util.List<com.commercetools.history.models.LocalizedString> nextValue) {
        this.change = change;
    ...
    public void setPreviousValue(final java.util.List<com.commercetools.history.models.LocalizedString> previousValue) {
        this.previousValue = previousValue;
    }
    ...
    public void setNextValue(final java.util.List<com.commercetools.history.models.LocalizedString> nextValue) {
        this.nextValue = nextValue;
    }
