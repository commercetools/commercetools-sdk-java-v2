...
public final class ChangeAttributeConstraintChangeImpl implements ChangeAttributeConstraintChange {
    ...
    ChangeAttributeConstraintChangeImpl(@JsonProperty("change") final String change,
            ...
            @JsonProperty("previousValue") final com.commercetools.history.models.AttributeConstraintEnum previousValue,
            @JsonProperty("nextValue") final com.commercetools.history.models.AttributeConstraintEnum nextValue) {
        this.change = change;
    ...
    */
    ...
    public void setPreviousValue(final com.commercetools.history.models.AttributeConstraintEnum previousValue) {
        this.previousValue = previousValue;
    }

    public void setNextValue(final com.commercetools.history.models.AttributeConstraintEnum nextValue) {
        this.nextValue = nextValue;
    }
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder().append(type, that.type).append(change, that.change).append(attributeName,
            that.attributeName).append(previousValue, that.previousValue).append(nextValue, that.nextValue).isEquals();
    }
