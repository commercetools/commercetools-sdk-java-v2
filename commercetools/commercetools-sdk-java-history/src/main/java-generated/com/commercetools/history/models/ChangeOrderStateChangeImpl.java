...
public final class ChangeOrderStateChangeImpl implements ChangeOrderStateChange {
    ...
    ChangeOrderStateChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("nextValue") final com.commercetools.history.models.OrderState nextValue,
            @JsonProperty("previousValue") final com.commercetools.history.models.OrderState previousValue) {
        this.change = change;
    ...
    */
    ...
    public void setNextValue(final com.commercetools.history.models.OrderState nextValue) {
        this.nextValue = nextValue;
    }

    public void setPreviousValue(final com.commercetools.history.models.OrderState previousValue) {
        this.previousValue = previousValue;
    }
