...
public final class ChangeShipmentStateChangeImpl implements ChangeShipmentStateChange {
    ...
    ChangeShipmentStateChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("nextValue") final com.commercetools.history.models.ShipmentState nextValue,
            @JsonProperty("previousValue") final com.commercetools.history.models.ShipmentState previousValue) {
        this.change = change;
    ...
    */
    ...
    public void setNextValue(final com.commercetools.history.models.ShipmentState nextValue) {
        this.nextValue = nextValue;
    }

    public void setPreviousValue(final com.commercetools.history.models.ShipmentState previousValue) {
        this.previousValue = previousValue;
    }
