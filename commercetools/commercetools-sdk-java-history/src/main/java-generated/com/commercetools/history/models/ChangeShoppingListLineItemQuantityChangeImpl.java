...
public final class ChangeShoppingListLineItemQuantityChangeImpl implements ChangeShoppingListLineItemQuantityChange {
    ...
    ChangeShoppingListLineItemQuantityChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("lineItem") final com.commercetools.history.models.ShoppingListLineItemValue lineItem,
    ...
    public void setLineItem(final com.commercetools.history.models.ShoppingListLineItemValue lineItem) {
        this.lineItem = lineItem;
    }
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder().append(type, that.type).append(change, that.change).append(lineItem,
            that.lineItem).append(previousValue, that.previousValue).append(nextValue, that.nextValue).isEquals();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder(17, 37).append(type).append(change).append(lineItem).append(previousValue).append(
