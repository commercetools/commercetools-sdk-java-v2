...
public final class ChangeShoppingListLineItemsOrderChangeImpl implements ChangeShoppingListLineItemsOrderChange {
    ...
    ChangeShoppingListLineItemsOrderChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("previousValue") final java.util.List<com.commercetools.history.models.ShoppingListLineItemValue> previousValue,
            @JsonProperty("nextValue") final java.util.List<com.commercetools.history.models.ShoppingListLineItemValue> nextValue) {
        this.change = change;
    ...
    public void setPreviousValue(final com.commercetools.history.models.ShoppingListLineItemValue... previousValue) {
    ...
    public void setNextValue(final com.commercetools.history.models.ShoppingListLineItemValue... nextValue) {
