...
public final class ChangeStackingModeChangeImpl implements ChangeStackingModeChange {
    ...
    ChangeStackingModeChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("nextValue") final com.commercetools.history.models.StackingMode nextValue,
            @JsonProperty("previousValue") final com.commercetools.history.models.StackingMode previousValue) {
        this.change = change;
    ...
    */
    ...
    public void setNextValue(final com.commercetools.history.models.StackingMode nextValue) {
        this.nextValue = nextValue;
    }

    public void setPreviousValue(final com.commercetools.history.models.StackingMode previousValue) {
        this.previousValue = previousValue;
    }
