...
public final class ChangeStateTypeChangeImpl implements ChangeStateTypeChange {
    ...
    ChangeStateTypeChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("previousValue") final com.commercetools.history.models.StateType previousValue,
            @JsonProperty("nextValue") final com.commercetools.history.models.StateType nextValue) {
        this.change = change;
    ...
    */
    ...
    public void setPreviousValue(final com.commercetools.history.models.StateType previousValue) {
        this.previousValue = previousValue;
    }

    public void setNextValue(final com.commercetools.history.models.StateType nextValue) {
        this.nextValue = nextValue;
    }
