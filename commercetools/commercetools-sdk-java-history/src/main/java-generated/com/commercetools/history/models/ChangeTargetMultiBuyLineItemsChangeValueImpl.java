...
public final class ChangeTargetMultiBuyLineItemsChangeValueImpl implements ChangeTargetMultiBuyLineItemsChangeValue {
    ...
    ChangeTargetMultiBuyLineItemsChangeValueImpl(@JsonProperty("predicate") final String predicate,
            ...
            @JsonProperty("selectionMode") final com.commercetools.history.models.SelectionMode selectionMode) {
    ...
    */
    ...
    public void setSelectionMode(final com.commercetools.history.models.SelectionMode selectionMode) {
        this.selectionMode = selectionMode;
    }
