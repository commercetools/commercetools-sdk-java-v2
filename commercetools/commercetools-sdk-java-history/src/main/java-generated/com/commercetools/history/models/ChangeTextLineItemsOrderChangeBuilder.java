...
public final class ChangeTextLineItemsOrderChangeBuilder {
    ...
    public ChangeTextLineItemsOrderChangeBuilder previousValue(
            final com.commercetools.history.models.TextLineItemValue... previousValue) {
    ...
    public ChangeTextLineItemsOrderChangeBuilder nextValue(
            final com.commercetools.history.models.TextLineItemValue... nextValue) {
        this.nextValue = new ArrayList<>(Arrays.asList(nextValue));
        return this;
    }

    public ChangeTextLineItemsOrderChangeBuilder nextValue(
            final java.util.List<com.commercetools.history.models.TextLineItemValue> nextValue) {
