...
public final class ChangeTransactionStateChangeImpl implements ChangeTransactionStateChange {
    ...
    ChangeTransactionStateChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("transaction") final com.commercetools.history.models.TransactionChangeValue transaction,
            @JsonProperty("nextValue") final com.commercetools.history.models.TransactionState nextValue,
            @JsonProperty("previousValue") final com.commercetools.history.models.TransactionState previousValue) {
        this.change = change;
    ...
    */
    ...
    public void setTransaction(final com.commercetools.history.models.TransactionChangeValue transaction) {
        this.transaction = transaction;
    }

    public void setNextValue(final com.commercetools.history.models.TransactionState nextValue) {
        this.nextValue = nextValue;
    }

    public void setPreviousValue(final com.commercetools.history.models.TransactionState previousValue) {
        this.previousValue = previousValue;
    }
