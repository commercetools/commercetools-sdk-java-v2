...
public final class ChangeValueAbsoluteChangeValueImpl implements ChangeValueAbsoluteChangeValue {
    ...
    ChangeValueAbsoluteChangeValueImpl(
            @JsonProperty("money") final java.util.List<com.commercetools.history.models.Money> money) {
        this.money = money;
        this.type = ABSOLUTE;
    }
    ...
    public void setMoney(final java.util.List<com.commercetools.history.models.Money> money) {
        this.money = money;
    }
