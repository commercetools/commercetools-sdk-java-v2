...
public final class ChangeValueChangeImpl implements ChangeValueChange {
    ...
    ChangeValueChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("nextValue") final com.commercetools.history.models.ChangeValueChangeValue nextValue,
            @JsonProperty("previousValue") final com.commercetools.history.models.ChangeValueChangeValue previousValue) {
        this.change = change;
    ...
    */
    ...
    public void setNextValue(final com.commercetools.history.models.ChangeValueChangeValue nextValue) {
        this.nextValue = nextValue;
    }

    public void setPreviousValue(final com.commercetools.history.models.ChangeValueChangeValue previousValue) {
        this.previousValue = previousValue;
    }
