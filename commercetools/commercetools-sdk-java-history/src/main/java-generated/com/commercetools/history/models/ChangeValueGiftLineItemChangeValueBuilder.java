...
public final class ChangeValueGiftLineItemChangeValueBuilder {
    ...
    public ChangeValueGiftLineItemChangeValueBuilder product(final com.commercetools.history.models.Reference product) {
    ...
    public ChangeValueGiftLineItemChangeValueBuilder supplyChannel(
            final com.commercetools.history.models.Reference supplyChannel) {
        this.supplyChannel = supplyChannel;
        return this;
    }

    public ChangeValueGiftLineItemChangeValueBuilder distributionChannel(
            final com.commercetools.history.models.Reference distributionChannel) {
