...
public final class CustomLineItemImpl implements CustomLineItem {
    ...
    CustomLineItemImpl(@JsonProperty("id") final String id,
            ...
            @JsonProperty("money") final com.commercetools.history.models.Money money,
            @JsonProperty("taxedPrice") final com.commercetools.history.models.TaxedItemPrice taxedPrice,
            @JsonProperty("totalPrice") final com.commercetools.history.models.Money totalPrice,
    ...
    */
    ...
    public void setMoney(final com.commercetools.history.models.Money money) {
        this.money = money;
    }

    public void setTaxedPrice(final com.commercetools.history.models.TaxedItemPrice taxedPrice) {
        this.taxedPrice = taxedPrice;
    }

    public void setTotalPrice(final com.commercetools.history.models.Money totalPrice) {
        this.totalPrice = totalPrice;
    }
