...
public final class DeliveryBuilder {
    ...
    public DeliveryBuilder items(final com.commercetools.history.models.DeliveryItem... items) {
        this.items = new ArrayList<>(Arrays.asList(items));
        return this;
    }

    public DeliveryBuilder items(final java.util.List<com.commercetools.history.models.DeliveryItem> items) {
        this.items = items;
        return this;
    }

    public DeliveryBuilder parcels(final com.commercetools.history.models.Parcel... parcels) {
        this.parcels = new ArrayList<>(Arrays.asList(parcels));
        return this;
    }

    public DeliveryBuilder parcels(final java.util.List<com.commercetools.history.models.Parcel> parcels) {
        this.parcels = parcels;
        return this;
    }

    public DeliveryBuilder address(final com.commercetools.history.models.Address address) {
