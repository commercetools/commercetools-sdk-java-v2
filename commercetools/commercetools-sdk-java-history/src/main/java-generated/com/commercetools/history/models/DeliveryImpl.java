...
public final class DeliveryImpl implements Delivery {
    ...
    DeliveryImpl(@JsonProperty("id") final String id, @JsonProperty("createdAt") final String createdAt,
            @JsonProperty("items") final java.util.List<com.commercetools.history.models.DeliveryItem> items,
            @JsonProperty("parcels") final java.util.List<com.commercetools.history.models.Parcel> parcels,
            @JsonProperty("address") final com.commercetools.history.models.Address address) {
        this.id = id;
    ...
    public void setItems(final com.commercetools.history.models.DeliveryItem... items) {
        this.items = new ArrayList<>(Arrays.asList(items));
    }

    public void setItems(final java.util.List<com.commercetools.history.models.DeliveryItem> items) {
        this.items = items;
    }

    public void setParcels(final com.commercetools.history.models.Parcel... parcels) {
        this.parcels = new ArrayList<>(Arrays.asList(parcels));
    }

    public void setParcels(final java.util.List<com.commercetools.history.models.Parcel> parcels) {
        this.parcels = parcels;
    }

    public void setAddress(final com.commercetools.history.models.Address address) {
        this.address = address;
    }
