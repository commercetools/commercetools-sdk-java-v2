...
public final class DiscountedLineItemPriceImpl implements DiscountedLineItemPrice {
    ...
    @JsonCreator
    DiscountedLineItemPriceImpl(@JsonProperty("value") final com.commercetools.history.models.Money value,
            @JsonProperty("includedDiscounts") final java.util.List<com.commercetools.history.models.DiscountedLineItemPortion> includedDiscounts) {
        this.value = value;
    ...
    public void setValue(final com.commercetools.history.models.Money value) {
        this.value = value;
    }
