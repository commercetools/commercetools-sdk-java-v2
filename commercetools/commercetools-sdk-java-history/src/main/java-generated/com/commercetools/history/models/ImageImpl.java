...
public final class ImageImpl implements Image {
    ...
    ImageImpl(@JsonProperty("url") final String url,
            @JsonProperty("dimensions") final com.commercetools.history.models.ImageDimensions dimensions,
    ...
    public void setDimensions(final com.commercetools.history.models.ImageDimensions dimensions) {
        this.dimensions = dimensions;
    }
