...
public final class ItemShippingDetailsBuilder {
    ...
    public ItemShippingDetailsBuilder targets(final com.commercetools.history.models.ItemShippingTarget... targets) {
        this.targets = new ArrayList<>(Arrays.asList(targets));
        return this;
    }

    public ItemShippingDetailsBuilder targets(
            final java.util.List<com.commercetools.history.models.ItemShippingTarget> targets) {
