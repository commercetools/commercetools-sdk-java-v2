...
public final class ItemShippingDetailsImpl implements ItemShippingDetails {
    ...
    private java.util.List<com.commercetools.history.models.ItemShippingTarget> targets;

    private Boolean valid;

    @JsonCreator
    ItemShippingDetailsImpl(
            @JsonProperty("targets") final java.util.List<com.commercetools.history.models.ItemShippingTarget> targets,
    ...
    public java.util.List<com.commercetools.history.models.ItemShippingTarget> getTargets() {
        return this.targets;
    }
    ...
    */
    ...
    public void setTargets(final com.commercetools.history.models.ItemShippingTarget... targets) {
        this.targets = new ArrayList<>(Arrays.asList(targets));
    }

    public void setTargets(final java.util.List<com.commercetools.history.models.ItemShippingTarget> targets) {
        this.targets = targets;
    }
