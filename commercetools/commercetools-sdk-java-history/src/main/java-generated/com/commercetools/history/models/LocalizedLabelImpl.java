...
public final class LocalizedLabelImpl implements LocalizedLabel {
    ...
    @JsonCreator
    LocalizedLabelImpl(@JsonProperty("value") final com.commercetools.history.models.LocalizedString value) {
        this.value = value;
    ...
    public void setValue(final com.commercetools.history.models.LocalizedString value) {
        this.value = value;
    }
