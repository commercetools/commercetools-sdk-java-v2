...
public final class MoveImageToPositionChangeImpl implements MoveImageToPositionChange {
    ...
    private java.util.List<com.commercetools.history.models.Image> previousValue;

    private java.util.List<com.commercetools.history.models.Image> nextValue;

    @JsonCreator
    MoveImageToPositionChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("catalogData") final String catalogData,
            @JsonProperty("previousValue") final java.util.List<com.commercetools.history.models.Image> previousValue,
            @JsonProperty("nextValue") final java.util.List<com.commercetools.history.models.Image> nextValue) {
        this.change = change;
    ...
    */
    ...
    public java.util.List<com.commercetools.history.models.Image> getPreviousValue() {
        return this.previousValue;
    }

    public java.util.List<com.commercetools.history.models.Image> getNextValue() {
    ...
    public void setPreviousValue(final java.util.List<com.commercetools.history.models.Image> previousValue) {
        this.previousValue = previousValue;
    }
    ...
    public void setNextValue(final java.util.List<com.commercetools.history.models.Image> nextValue) {
        this.nextValue = nextValue;
    }
