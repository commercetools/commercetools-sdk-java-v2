...
public final class ParcelImpl implements Parcel {
    ...
    ParcelImpl(@JsonProperty("id") final String id, @JsonProperty("createdAt") final String createdAt,
            @JsonProperty("measurements") final com.commercetools.history.models.ParcelMeasurements measurements,
            @JsonProperty("trackingData") final com.commercetools.history.models.TrackingData trackingData,
    ...
    public void setMeasurements(final com.commercetools.history.models.ParcelMeasurements measurements) {
        this.measurements = measurements;
    }

    public void setTrackingData(final com.commercetools.history.models.TrackingData trackingData) {
        this.trackingData = trackingData;
    }
