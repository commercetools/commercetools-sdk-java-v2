...
public final class PaymentInfoImpl implements PaymentInfo {
    ...
    @JsonCreator
    PaymentInfoImpl(
            @JsonProperty("payments") final java.util.List<com.commercetools.history.models.Reference> payments) {
    ...
    public void setPayments(final com.commercetools.history.models.Reference... payments) {
        this.payments = new ArrayList<>(Arrays.asList(payments));
    }

    public void setPayments(final java.util.List<com.commercetools.history.models.Reference> payments) {
        this.payments = payments;
    }
