...
public final class ProductVariantAvailabilityImpl implements ProductVariantAvailability {
    ...
    ProductVariantAvailabilityImpl(@JsonProperty("isOnStock") final Boolean isOnStock,
            ...
            @JsonProperty("channels") final com.commercetools.history.models.ProductVariantChannelAvailabilityMap channels) {
    ...
    public void setChannels(final com.commercetools.history.models.ProductVariantChannelAvailabilityMap channels) {
        this.channels = channels;
    }
