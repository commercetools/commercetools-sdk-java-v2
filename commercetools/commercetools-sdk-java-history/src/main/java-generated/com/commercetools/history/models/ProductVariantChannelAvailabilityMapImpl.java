...
public final class ProductVariantChannelAvailabilityMapImpl implements ProductVariantChannelAvailabilityMap {
    ...
    ProductVariantChannelAvailabilityMapImpl(
            @JsonProperty("values") final Map<String, com.commercetools.history.models.ProductVariantChannelAvailability> values) {
        this.values = values;
    }
    ...
    public Map<String, com.commercetools.history.models.ProductVariantChannelAvailability> values() {
        return values;
    }

    public void setValue(String key, com.commercetools.history.models.ProductVariantChannelAvailability value) {
        if (values == null) {
            values = new HashMap<>();
        }
