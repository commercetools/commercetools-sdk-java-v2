...
public final class RemoveAttributeDefinitionChangeImpl implements RemoveAttributeDefinitionChange {
    ...
    private com.commercetools.history.models.AttributeDefinition previousValue;

    @JsonCreator
    RemoveAttributeDefinitionChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("previousValue") final com.commercetools.history.models.AttributeDefinition previousValue) {
        this.change = change;
    ...
    */
    ...
    public com.commercetools.history.models.AttributeDefinition getPreviousValue() {
    ...
    public void setPreviousValue(final com.commercetools.history.models.AttributeDefinition previousValue) {
        this.previousValue = previousValue;
    }
