...
public final class RemoveDeliveryItemsChangeImpl implements RemoveDeliveryItemsChange {
    ...
    private com.commercetools.history.models.Delivery previousValue;

    @JsonCreator
    RemoveDeliveryItemsChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("previousValue") final com.commercetools.history.models.Delivery previousValue) {
        this.change = change;
    ...
    */
    ...
    public com.commercetools.history.models.Delivery getPreviousValue() {
    ...
    public void setPreviousValue(final com.commercetools.history.models.Delivery previousValue) {
        this.previousValue = previousValue;
    }
