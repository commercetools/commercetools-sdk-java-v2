...
public final class RemoveEnumValuesChangeImpl implements RemoveEnumValuesChange {
    ...
    RemoveEnumValuesChangeImpl(@JsonProperty("change") final String change,
            ...
            @JsonProperty("previousValue") final com.commercetools.history.models.EnumValue previousValue) {
        this.change = change;
