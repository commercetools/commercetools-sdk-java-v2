...
public final class RemoveFieldDefinitionChangeImpl implements RemoveFieldDefinitionChange {
    ...
    RemoveFieldDefinitionChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("previousValue") final com.commercetools.history.models.FieldDefinition previousValue) {
        this.change = change;
    ...
    */
    ...
    public void setPreviousValue(final com.commercetools.history.models.FieldDefinition previousValue) {
        this.previousValue = previousValue;
    }
