...
public final class RemoveFromCategoryChangeImpl implements RemoveFromCategoryChange {
    ...
    RemoveFromCategoryChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("category") final com.commercetools.history.models.Reference category,
    ...
    */
    ...
    public void setCategory(final com.commercetools.history.models.Reference category) {
        this.category = category;
    }
