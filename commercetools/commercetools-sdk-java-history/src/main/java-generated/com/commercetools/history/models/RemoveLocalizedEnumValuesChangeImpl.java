...
public final class RemoveLocalizedEnumValuesChangeImpl implements RemoveLocalizedEnumValuesChange {
    ...
    RemoveLocalizedEnumValuesChangeImpl(@JsonProperty("change") final String change,
            ...
            @JsonProperty("previousValue") final com.commercetools.history.models.LocalizedEnumValue previousValue) {
        this.change = change;
