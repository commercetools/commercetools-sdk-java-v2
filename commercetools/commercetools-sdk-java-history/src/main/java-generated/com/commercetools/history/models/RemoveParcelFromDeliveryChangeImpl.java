...
public final class RemoveParcelFromDeliveryChangeImpl implements RemoveParcelFromDeliveryChange {
    ...
    private com.commercetools.history.models.Parcel previousValue;
    ...
    RemoveParcelFromDeliveryChangeImpl(@JsonProperty("change") final String change,
            ...
            @JsonProperty("previousValue") final com.commercetools.history.models.Parcel previousValue) {
        this.change = change;
    ...
    */
    ...
    public com.commercetools.history.models.Parcel getPreviousValue() {
    ...
    public void setPreviousValue(final com.commercetools.history.models.Parcel previousValue) {
        this.previousValue = previousValue;
    }
