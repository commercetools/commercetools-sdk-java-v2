...
public final class RemoveShoppingListLineItemChangeImpl implements RemoveShoppingListLineItemChange {
    ...
    RemoveShoppingListLineItemChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("previousValue") final com.commercetools.history.models.LineItem previousValue,
            @JsonProperty("nextValue") final com.commercetools.history.models.LineItem nextValue) {
        this.change = change;
    ...
    public void setPreviousValue(final com.commercetools.history.models.LineItem previousValue) {
        this.previousValue = previousValue;
    }

    public void setNextValue(final com.commercetools.history.models.LineItem nextValue) {
        this.nextValue = nextValue;
    }
