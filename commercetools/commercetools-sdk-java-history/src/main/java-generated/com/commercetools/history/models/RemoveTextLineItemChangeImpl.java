...
public final class RemoveTextLineItemChangeImpl implements RemoveTextLineItemChange {
    ...
    RemoveTextLineItemChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("previousValue") final com.commercetools.history.models.TextLineItem previousValue,
            @JsonProperty("nextValue") final com.commercetools.history.models.TextLineItem nextValue) {
        this.change = change;
    ...
    public void setPreviousValue(final com.commercetools.history.models.TextLineItem previousValue) {
        this.previousValue = previousValue;
    }

    public void setNextValue(final com.commercetools.history.models.TextLineItem nextValue) {
        this.nextValue = nextValue;
    }
