...
public final class ReturnInfoBuilder {
    ...
    public ReturnInfoBuilder items(final com.commercetools.history.models.ReturnItem... items) {
        this.items = new ArrayList<>(Arrays.asList(items));
        return this;
    }

    public ReturnInfoBuilder items(final java.util.List<com.commercetools.history.models.ReturnItem> items) {
        this.items = items;
        return this;
    }
