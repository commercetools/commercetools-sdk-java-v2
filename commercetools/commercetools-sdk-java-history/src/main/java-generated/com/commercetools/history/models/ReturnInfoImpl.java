...
public final class ReturnInfoImpl implements ReturnInfo {
    ...
    private java.util.List<com.commercetools.history.models.ReturnItem> items;
    ...
    @JsonCreator
    ReturnInfoImpl(@JsonProperty("items") final java.util.List<com.commercetools.history.models.ReturnItem> items,
    ...
    public java.util.List<com.commercetools.history.models.ReturnItem> getItems() {
        return this.items;
    }
    ...
    */
    ...
    public void setItems(final com.commercetools.history.models.ReturnItem... items) {
        this.items = new ArrayList<>(Arrays.asList(items));
    }

    public void setItems(final java.util.List<com.commercetools.history.models.ReturnItem> items) {
        this.items = items;
    }
