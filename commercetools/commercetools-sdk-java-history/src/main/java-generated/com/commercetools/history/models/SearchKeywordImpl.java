...
public final class SearchKeywordImpl implements SearchKeyword {
    ...
    SearchKeywordImpl(@JsonProperty("text") final String text,
            @JsonProperty("suggestTokenizer") final com.commercetools.history.models.SuggestTokenizer suggestTokenizer) {
        this.text = text;
    ...
    public void setSuggestTokenizer(final com.commercetools.history.models.SuggestTokenizer suggestTokenizer) {
        this.suggestTokenizer = suggestTokenizer;
    }
