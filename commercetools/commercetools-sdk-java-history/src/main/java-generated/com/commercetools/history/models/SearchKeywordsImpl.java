...
public final class SearchKeywordsImpl implements SearchKeywords {
    ...
    @JsonCreator
    SearchKeywordsImpl(
            @JsonProperty("values") final Map<String, java.util.List<com.commercetools.history.models.SearchKeyword>> values) {
        this.values = values;
    }
    ...
    public Map<String, java.util.List<com.commercetools.history.models.SearchKeyword>> values() {
        return values;
    }

    public void setValue(String key, java.util.List<com.commercetools.history.models.SearchKeyword> value) {
        if (values == null) {
            values = new HashMap<>();
        }
