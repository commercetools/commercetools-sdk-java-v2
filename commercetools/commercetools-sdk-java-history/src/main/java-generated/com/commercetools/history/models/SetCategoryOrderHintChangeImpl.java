...
public final class SetCategoryOrderHintChangeImpl implements SetCategoryOrderHintChange {
    ...
    SetCategoryOrderHintChangeImpl(@JsonProperty("change") final String change,
            ...
            @JsonProperty("previousValue") final com.commercetools.history.models.CategoryOrderHints previousValue,
            @JsonProperty("nextValue") final com.commercetools.history.models.CategoryOrderHints nextValue) {
        this.change = change;
    ...
    */
    ...
    public void setPreviousValue(final com.commercetools.history.models.CategoryOrderHints previousValue) {
        this.previousValue = previousValue;
    }

    public void setNextValue(final com.commercetools.history.models.CategoryOrderHints nextValue) {
        this.nextValue = nextValue;
    }
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder().append(type, that.type).append(change, that.change).append(catalogData,
            that.catalogData).append(categoryId, that.categoryId).append(previousValue, that.previousValue).append(
                nextValue, that.nextValue).isEquals();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder(17, 37).append(type).append(change).append(catalogData).append(categoryId).append(
