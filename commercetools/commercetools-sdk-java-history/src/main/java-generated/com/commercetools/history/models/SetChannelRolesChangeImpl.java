...
public final class SetChannelRolesChangeImpl implements SetChannelRolesChange {
    ...
    SetChannelRolesChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("previousValue") final java.util.List<com.commercetools.history.models.ChannelRole> previousValue,
            @JsonProperty("nextValue") final java.util.List<com.commercetools.history.models.ChannelRole> nextValue) {
        this.change = change;
    ...
    public SetChannelRolesChangeImpl() {
        this.type = SET_CHANNEL_ROLES_CHANGE;
    }
    ...
    public void setPreviousValue(final com.commercetools.history.models.ChannelRole... previousValue) {
        this.previousValue = new ArrayList<>(Arrays.asList(previousValue));
    }

    public void setPreviousValue(final java.util.List<com.commercetools.history.models.ChannelRole> previousValue) {
        this.previousValue = previousValue;
    }

    public void setNextValue(final com.commercetools.history.models.ChannelRole... nextValue) {
        this.nextValue = new ArrayList<>(Arrays.asList(nextValue));
    }

    public void setNextValue(final java.util.List<com.commercetools.history.models.ChannelRole> nextValue) {
        this.nextValue = nextValue;
    }
