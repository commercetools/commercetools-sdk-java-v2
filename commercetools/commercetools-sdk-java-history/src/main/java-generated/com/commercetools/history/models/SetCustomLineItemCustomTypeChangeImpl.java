...
public final class SetCustomLineItemCustomTypeChangeImpl implements SetCustomLineItemCustomTypeChange {
    ...
    */
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder().append(type, that.type).append(change, that.change).append(customLineItem,
            that.customLineItem).append(nextValue, that.nextValue).append(previousValue, that.previousValue).isEquals();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder(17, 37).append(type).append(change).append(customLineItem).append(nextValue).append(
