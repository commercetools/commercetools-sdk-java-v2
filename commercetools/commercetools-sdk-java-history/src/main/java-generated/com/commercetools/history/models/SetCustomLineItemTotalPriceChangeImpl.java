...
public final class SetCustomLineItemTotalPriceChangeImpl implements SetCustomLineItemTotalPriceChange {
    ...
    SetCustomLineItemTotalPriceChangeImpl(@JsonProperty("change") final String change,
            ...
            @JsonProperty("nextValue") final com.commercetools.history.models.Money nextValue,
            @JsonProperty("previousValue") final com.commercetools.history.models.Money previousValue) {
        this.change = change;
    ...
    */
    ...
    public void setNextValue(final com.commercetools.history.models.Money nextValue) {
        this.nextValue = nextValue;
    }

    public void setPreviousValue(final com.commercetools.history.models.Money previousValue) {
        this.previousValue = previousValue;
    }
    ...
    public boolean equals(Object o) {
        ...
        SetCustomLineItemTotalPriceChangeImpl that = (SetCustomLineItemTotalPriceChangeImpl) o;
