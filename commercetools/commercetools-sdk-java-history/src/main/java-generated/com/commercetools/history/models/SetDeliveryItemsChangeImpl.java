...
public final class SetDeliveryItemsChangeImpl implements SetDeliveryItemsChange {
    ...
    SetDeliveryItemsChangeImpl(@JsonProperty("change") final String change,
            ...
            @JsonProperty("nextValue") final java.util.List<com.commercetools.history.models.DeliveryItem> nextValue,
            @JsonProperty("previousValue") final java.util.List<com.commercetools.history.models.DeliveryItem> previousValue) {
        this.change = change;
    ...
    */
    ...
    public void setNextValue(final com.commercetools.history.models.DeliveryItem... nextValue) {
        this.nextValue = new ArrayList<>(Arrays.asList(nextValue));
    }

    public void setNextValue(final java.util.List<com.commercetools.history.models.DeliveryItem> nextValue) {
        this.nextValue = nextValue;
    }

    public void setPreviousValue(final com.commercetools.history.models.DeliveryItem... previousValue) {
        this.previousValue = new ArrayList<>(Arrays.asList(previousValue));
    }

    public void setPreviousValue(final java.util.List<com.commercetools.history.models.DeliveryItem> previousValue) {
        this.previousValue = previousValue;
    }
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder().append(type, that.type).append(change, that.change).append(deliveryId,
            that.deliveryId).append(nextValue, that.nextValue).append(previousValue, that.previousValue).isEquals();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder(17, 37).append(type).append(change).append(deliveryId).append(nextValue).append(
