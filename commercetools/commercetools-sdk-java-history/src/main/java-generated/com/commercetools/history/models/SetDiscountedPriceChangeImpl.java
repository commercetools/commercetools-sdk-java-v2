...
public final class SetDiscountedPriceChangeImpl implements SetDiscountedPriceChange {
    ...
    SetDiscountedPriceChangeImpl(@JsonProperty("change") final String change,
            ...
            @JsonProperty("previousValue") final com.commercetools.history.models.Price previousValue,
            @JsonProperty("nextValue") final com.commercetools.history.models.Price nextValue) {
        this.change = change;
