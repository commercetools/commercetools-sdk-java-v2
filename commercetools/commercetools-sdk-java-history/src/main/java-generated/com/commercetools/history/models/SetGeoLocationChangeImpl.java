...
public final class SetGeoLocationChangeImpl implements SetGeoLocationChange {
    ...
    SetGeoLocationChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("nextValue") final com.commercetools.history.models.GeoLocation nextValue,
            @JsonProperty("previousValue") final com.commercetools.history.models.GeoLocation previousValue) {
        this.change = change;
    ...
    */
    ...
    public void setNextValue(final com.commercetools.history.models.GeoLocation nextValue) {
        this.nextValue = nextValue;
    }

    public void setPreviousValue(final com.commercetools.history.models.GeoLocation previousValue) {
        this.previousValue = previousValue;
    }
