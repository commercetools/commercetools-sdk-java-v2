...
public final class SetLineItemDiscountedPricePerQuantityChangeImpl
        implements SetLineItemDiscountedPricePerQuantityChange {
    ...
    SetLineItemDiscountedPricePerQuantityChangeImpl(@JsonProperty("change") final String change,
            ...
            @JsonProperty("nextValue") final com.commercetools.history.models.DiscountedLineItemPriceForQuantity nextValue,
            @JsonProperty("previousValue") final com.commercetools.history.models.DiscountedLineItemPriceForQuantity previousValue) {
        this.change = change;
    ...
    */
    ...
    public void setNextValue(final com.commercetools.history.models.DiscountedLineItemPriceForQuantity nextValue) {
        this.nextValue = nextValue;
    }
