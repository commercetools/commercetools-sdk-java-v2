...
public final class SetLineItemTaxRateChangeBuilder {
    ...
    public SetLineItemTaxRateChangeBuilder lineItem(final com.commercetools.history.models.LocalizedString lineItem) {
        this.lineItem = lineItem;
        return this;
    }

    public SetLineItemTaxRateChangeBuilder nextValue(final com.commercetools.history.models.TaxRate nextValue) {
        this.nextValue = nextValue;
        return this;
    }

    public SetLineItemTaxRateChangeBuilder previousValue(final com.commercetools.history.models.TaxRate previousValue) {
