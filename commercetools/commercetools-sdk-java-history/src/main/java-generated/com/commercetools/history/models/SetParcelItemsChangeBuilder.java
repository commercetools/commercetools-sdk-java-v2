...
public final class SetParcelItemsChangeBuilder {
    ...
    public SetParcelItemsChangeBuilder parcel(final com.commercetools.history.models.ParcelChangeValue parcel) {
        this.parcel = parcel;
        return this;
    }

    public SetParcelItemsChangeBuilder nextValue(final com.commercetools.history.models.DeliveryItem... nextValue) {
