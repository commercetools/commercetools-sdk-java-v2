...
public final class SetParcelItemsChangeImpl implements SetParcelItemsChange {
    ...
    SetParcelItemsChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("parcel") final com.commercetools.history.models.ParcelChangeValue parcel,
    ...
    */
    ...
    public void setParcel(final com.commercetools.history.models.ParcelChangeValue parcel) {
        this.parcel = parcel;
    }
