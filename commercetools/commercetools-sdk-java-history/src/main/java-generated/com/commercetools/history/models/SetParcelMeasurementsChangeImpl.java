...
public final class SetParcelMeasurementsChangeImpl implements SetParcelMeasurementsChange {
    ...
    SetParcelMeasurementsChangeImpl(@JsonProperty("change") final String change,
            ...
            @JsonProperty("nextValue") final com.commercetools.history.models.ParcelMeasurements nextValue,
            @JsonProperty("previousValue") final com.commercetools.history.models.ParcelMeasurements previousValue) {
        this.change = change;
        this.parcel = parcel;
    ...
    */
    ...
    public void setNextValue(final com.commercetools.history.models.ParcelMeasurements nextValue) {
        this.nextValue = nextValue;
    }

    public void setPreviousValue(final com.commercetools.history.models.ParcelMeasurements previousValue) {
        this.previousValue = previousValue;
    }
