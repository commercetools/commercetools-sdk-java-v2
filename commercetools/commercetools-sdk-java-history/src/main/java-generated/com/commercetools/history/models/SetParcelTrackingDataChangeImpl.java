...
public final class SetParcelTrackingDataChangeImpl implements SetParcelTrackingDataChange {
    ...
    SetParcelTrackingDataChangeImpl(@JsonProperty("change") final String change,
            ...
            @JsonProperty("nextValue") final com.commercetools.history.models.TrackingData nextValue,
            @JsonProperty("previousValue") final com.commercetools.history.models.TrackingData previousValue) {
        this.change = change;
        this.parcel = parcel;
    ...
    */
    ...
    public void setNextValue(final com.commercetools.history.models.TrackingData nextValue) {
        this.nextValue = nextValue;
    }

    public void setPreviousValue(final com.commercetools.history.models.TrackingData previousValue) {
        this.previousValue = previousValue;
    }
