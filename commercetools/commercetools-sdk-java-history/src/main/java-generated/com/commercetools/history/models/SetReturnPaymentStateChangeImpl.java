...
public final class SetReturnPaymentStateChangeImpl implements SetReturnPaymentStateChange {
    ...
    SetReturnPaymentStateChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("nextValue") final com.commercetools.history.models.ReturnPaymentState nextValue,
            @JsonProperty("previousValue") final com.commercetools.history.models.ReturnPaymentState previousValue) {
        this.change = change;
    ...
    */
    ...
    public void setNextValue(final com.commercetools.history.models.ReturnPaymentState nextValue) {
        this.nextValue = nextValue;
    }

    public void setPreviousValue(final com.commercetools.history.models.ReturnPaymentState previousValue) {
        this.previousValue = previousValue;
    }
