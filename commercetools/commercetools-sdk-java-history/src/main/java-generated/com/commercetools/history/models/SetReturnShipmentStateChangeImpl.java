...
public final class SetReturnShipmentStateChangeImpl implements SetReturnShipmentStateChange {
    ...
    SetReturnShipmentStateChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("nextValue") final com.commercetools.history.models.ReturnShipmentState nextValue,
            @JsonProperty("previousValue") final com.commercetools.history.models.ReturnShipmentState previousValue) {
        this.change = change;
    ...
    */
    ...
    public void setNextValue(final com.commercetools.history.models.ReturnShipmentState nextValue) {
        this.nextValue = nextValue;
    }

    public void setPreviousValue(final com.commercetools.history.models.ReturnShipmentState previousValue) {
        this.previousValue = previousValue;
    }
