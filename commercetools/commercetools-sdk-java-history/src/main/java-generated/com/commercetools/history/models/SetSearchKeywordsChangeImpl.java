...
public final class SetSearchKeywordsChangeImpl implements SetSearchKeywordsChange {
    ...
    SetSearchKeywordsChangeImpl(@JsonProperty("change") final String change,
            ...
            @JsonProperty("previousValue") final com.commercetools.history.models.SearchKeywords previousValue,
            @JsonProperty("nextValue") final com.commercetools.history.models.SearchKeywords nextValue) {
        this.change = change;
    ...
    */
    ...
    public void setPreviousValue(final com.commercetools.history.models.SearchKeywords previousValue) {
        this.previousValue = previousValue;
    }

    public void setNextValue(final com.commercetools.history.models.SearchKeywords nextValue) {
        this.nextValue = nextValue;
    }
