...
public final class SetVariantAvailabilityChangeImpl implements SetVariantAvailabilityChange {
    ...
    SetVariantAvailabilityChangeImpl(@JsonProperty("change") final String change,
            ...
            @JsonProperty("previousValue") final com.commercetools.history.models.ProductVariantAvailability previousValue,
            @JsonProperty("nextValue") final com.commercetools.history.models.ProductVariantAvailability nextValue) {
        this.change = change;
    ...
    */
    ...
    public void setPreviousValue(final com.commercetools.history.models.ProductVariantAvailability previousValue) {
        this.previousValue = previousValue;
    }

    public void setNextValue(final com.commercetools.history.models.ProductVariantAvailability nextValue) {
        this.nextValue = nextValue;
    }
