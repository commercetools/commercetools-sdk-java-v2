...
public final class SyncInfoImpl implements SyncInfo {
    ...
    @JsonCreator
    SyncInfoImpl(@JsonProperty("channel") final com.commercetools.history.models.Reference channel,
    ...
    */
    ...
    public void setChannel(final com.commercetools.history.models.Reference channel) {
        this.channel = channel;
    }
