...
public final class TaxRateImpl implements TaxRate {
    ...
    private com.commercetools.history.models.SubRate subRates;
    ...
    TaxRateImpl(@JsonProperty("id") final String id, @JsonProperty("name") final String name,
            ...
            @JsonProperty("subRates") final com.commercetools.history.models.SubRate subRates) {
        this.id = id;
        this.name = name;
        this.amount = amount;
    ...
    */
    ...
    public com.commercetools.history.models.SubRate getSubRates() {
    ...
    public void setSubRates(final com.commercetools.history.models.SubRate subRates) {
        this.subRates = subRates;
    }
