...
public final class TransactionImpl implements Transaction {
    ...
    TransactionImpl(@JsonProperty("id") final String id, @JsonProperty("timestamp") final String timestamp,
            @JsonProperty("type") final com.commercetools.history.models.TransactionType type,
            @JsonProperty("amount") final com.commercetools.history.models.Money amount,
            @JsonProperty("interactionId") final String interactionId,
            @JsonProperty("state") final com.commercetools.history.models.TransactionState state) {
        this.id = id;
    ...
    */
    ...
    public void setType(final com.commercetools.history.models.TransactionType type) {
        this.type = type;
    }

    public void setAmount(final com.commercetools.history.models.Money amount) {
        this.amount = amount;
    }
    ...
    public void setState(final com.commercetools.history.models.TransactionState state) {
        this.state = state;
    }
