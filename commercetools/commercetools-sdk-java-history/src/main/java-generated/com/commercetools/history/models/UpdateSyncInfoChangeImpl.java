...
public final class UpdateSyncInfoChangeImpl implements UpdateSyncInfoChange {
    ...
    UpdateSyncInfoChangeImpl(@JsonProperty("change") final String change,
            ...
            @JsonProperty("nextValue") final com.commercetools.history.models.SyncInfo nextValue) {
        this.change = change;
    ...
    */
    ...
    public void setNextValue(final com.commercetools.history.models.SyncInfo nextValue) {
        this.nextValue = nextValue;
    }
