...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:CustomerAddAddressAction" rel="nofollow">Add Address</a> update action.</p>
 *
 * <hr>
...
public interface AddAddressChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AddAddressChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<AddAddressChange>() {
            @Override
