...
public class AddAssetChangeImpl implements AddAssetChange, ModelBase {
     ...
     */
    @JsonCreator
    AddAssetChangeImpl(@JsonProperty("change") final String change, @JsonProperty("nextValue") final com.commercetools.history.models.common.Asset nextValue, @JsonProperty("previousValue") final com.commercetools.history.models.common.Asset previousValue) {
        this.change = change;
