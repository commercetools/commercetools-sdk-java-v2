...
public interface AddAttributeDefinitionChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AddAttributeDefinitionChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<AddAttributeDefinitionChange>() {
            @Override
