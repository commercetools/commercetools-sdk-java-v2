...
public class AddAttributeDefinitionChangeImpl implements AddAttributeDefinitionChange, ModelBase {
     ...
     */
    @JsonCreator
    AddAttributeDefinitionChangeImpl(@JsonProperty("change") final String change, @JsonProperty("nextValue") final com.commercetools.history.models.common.AttributeDefinition nextValue) {
        this.change = change;
