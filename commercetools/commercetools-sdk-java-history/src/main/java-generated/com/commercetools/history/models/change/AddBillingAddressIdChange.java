...
public interface AddBillingAddressIdChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AddBillingAddressIdChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<AddBillingAddressIdChange>() {
            @Override
