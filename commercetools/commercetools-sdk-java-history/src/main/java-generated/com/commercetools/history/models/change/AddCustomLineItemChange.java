...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:StagedOrderAddCustomLineItemAction" rel="nofollow">Add CustomLineItem</a> update action.</p>
 *
 * <hr>
...
public interface AddCustomLineItemChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AddCustomLineItemChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<AddCustomLineItemChange>() {
            @Override
