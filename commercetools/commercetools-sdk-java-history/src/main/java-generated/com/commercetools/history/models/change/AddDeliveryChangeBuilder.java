...
public class AddDeliveryChangeBuilder implements Builder<AddDeliveryChange> {
    ...
    public AddDeliveryChangeBuilder nextValue(Function<com.commercetools.history.models.change_value.DeliveryChangeValueBuilder, com.commercetools.history.models.change_value.DeliveryChangeValueBuilder> builder) {
        this.nextValue = builder.apply(com.commercetools.history.models.change_value.DeliveryChangeValueBuilder.of()).build();
        return this;
    }
    ...
    public AddDeliveryChangeBuilder withNextValue(Function<com.commercetools.history.models.change_value.DeliveryChangeValueBuilder, com.commercetools.history.models.change_value.DeliveryChangeValue> builder) {
    ...
    public AddDeliveryChangeBuilder nextValue( final com.commercetools.history.models.change_value.DeliveryChangeValue nextValue) {
    ...
    public AddDeliveryChangeBuilder previousValue(Function<com.commercetools.history.models.change_value.DeliveryChangeValueBuilder, com.commercetools.history.models.change_value.DeliveryChangeValueBuilder> builder) {
        this.previousValue = builder.apply(com.commercetools.history.models.change_value.DeliveryChangeValueBuilder.of()).build();
        return this;
    }
    ...
    public AddDeliveryChangeBuilder withPreviousValue(Function<com.commercetools.history.models.change_value.DeliveryChangeValueBuilder, com.commercetools.history.models.change_value.DeliveryChangeValue> builder) {
        this.previousValue = builder.apply(com.commercetools.history.models.change_value.DeliveryChangeValueBuilder.of());
        return this;
    }
    ...
    public AddDeliveryChangeBuilder previousValue( final com.commercetools.history.models.change_value.DeliveryChangeValue previousValue) {
