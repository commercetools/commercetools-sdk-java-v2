...
public class AddDiscountCodeChangeImpl implements AddDiscountCodeChange, ModelBase {
     ...
     */
    @JsonCreator
    AddDiscountCodeChangeImpl(@JsonProperty("change") final String change, @JsonProperty("nextValue") final com.commercetools.history.models.common.DiscountCodeInfo nextValue) {
        this.change = change;
