...
public class AddEnumValueChangeImpl implements AddEnumValueChange, ModelBase {
     ...
     */
    @JsonCreator
    AddEnumValueChangeImpl(@JsonProperty("change") final String change, @JsonProperty("fieldName") final String fieldName, @JsonProperty("nextValue") final com.commercetools.history.models.change_value.EnumValue nextValue) {
        this.change = change;
