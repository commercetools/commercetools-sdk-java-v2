...
public interface AddExternalImageChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AddExternalImageChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<AddExternalImageChange>() {
            @Override
