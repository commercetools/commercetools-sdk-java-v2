...
public interface AddFieldDefinitionChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AddFieldDefinitionChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<AddFieldDefinitionChange>() {
            @Override
