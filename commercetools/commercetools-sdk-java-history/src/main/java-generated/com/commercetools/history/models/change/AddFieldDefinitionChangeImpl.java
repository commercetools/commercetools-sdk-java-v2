...
public class AddFieldDefinitionChangeImpl implements AddFieldDefinitionChange, ModelBase {
     ...
     */
    @JsonCreator
    AddFieldDefinitionChangeImpl(@JsonProperty("change") final String change, @JsonProperty("nextValue") final com.commercetools.history.models.common.FieldDefinition nextValue) {
        this.change = change;
