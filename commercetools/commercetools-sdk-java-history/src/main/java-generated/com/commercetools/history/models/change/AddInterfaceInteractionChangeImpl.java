...
public class AddInterfaceInteractionChangeImpl implements AddInterfaceInteractionChange, ModelBase {
     ...
     */
    @JsonCreator
    AddInterfaceInteractionChangeImpl(@JsonProperty("change") final String change, @JsonProperty("nextValue") final com.commercetools.history.models.change_value.CustomFieldExpandedValue nextValue) {
        this.change = change;
