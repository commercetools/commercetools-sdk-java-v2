...
public interface AddItemShippingAddressesChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AddItemShippingAddressesChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<AddItemShippingAddressesChange>() {
            @Override
