...
public class AddLocalizedEnumValueChangeImpl implements AddLocalizedEnumValueChange, ModelBase {
     ...
     */
    @JsonCreator
    AddLocalizedEnumValueChangeImpl(@JsonProperty("change") final String change, @JsonProperty("fieldName") final String fieldName, @JsonProperty("attributeName") final String attributeName, @JsonProperty("nextValue") final com.commercetools.history.models.change_value.LocalizedEnumValue nextValue) {
        this.change = change;
