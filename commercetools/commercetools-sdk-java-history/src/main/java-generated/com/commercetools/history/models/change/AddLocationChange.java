...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:ZoneAddLocationAction" rel="nofollow">Add Location</a> update action.</p>
 *
 * <hr>
...
public interface AddLocationChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AddLocationChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<AddLocationChange>() {
            @Override
