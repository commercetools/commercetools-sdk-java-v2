...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:StagedOrderAddLineItemAction" rel="nofollow">Add LineItem</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("AddOrderLineItemChange")
...
public interface AddOrderLineItemChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AddOrderLineItemChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<AddOrderLineItemChange>() {
            @Override
