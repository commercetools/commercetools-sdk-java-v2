...
public class AddPlainEnumValueChangeImpl implements AddPlainEnumValueChange, ModelBase {
     ...
     */
    @JsonCreator
    AddPlainEnumValueChangeImpl(@JsonProperty("change") final String change, @JsonProperty("attributeName") final String attributeName, @JsonProperty("nextValue") final com.commercetools.history.models.change_value.EnumValue nextValue) {
        this.change = change;
