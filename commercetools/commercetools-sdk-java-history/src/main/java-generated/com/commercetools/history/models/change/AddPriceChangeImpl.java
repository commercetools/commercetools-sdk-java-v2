...
public class AddPriceChangeImpl implements AddPriceChange, ModelBase {
     ...
     */
    @JsonCreator
    AddPriceChangeImpl(@JsonProperty("change") final String change, @JsonProperty("catalogData") final String catalogData, @JsonProperty("priceId") final String priceId, @JsonProperty("nextValue") final com.commercetools.history.models.common.Price nextValue) {
        this.change = change;
