...
public class AddProductSelectionChangeImpl implements AddProductSelectionChange, ModelBase {
     ...
     */
    @JsonCreator
    AddProductSelectionChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("previousValue") final com.commercetools.history.models.common.ProductSelectionSetting previousValue,
            @JsonProperty("nextValue") final com.commercetools.history.models.common.ProductSelectionSetting nextValue) {
        this.change = change;
        this.previousValue = previousValue;
        this.nextValue = nextValue;
        this.type = ADD_PRODUCT_SELECTION_CHANGE;
    }

    /**
     * create empty instance
     */
    public AddProductSelectionChangeImpl() {
        this.type = ADD_PRODUCT_SELECTION_CHANGE;
    }
    ...
    public boolean equals(Object o) {
        ...
        AddProductSelectionChangeImpl that = (AddProductSelectionChangeImpl) o;
    ...
    @Override
    public AddProductSelectionChange copyDeep() {
        return AddProductSelectionChange.deepCopy(this);
    }
}
