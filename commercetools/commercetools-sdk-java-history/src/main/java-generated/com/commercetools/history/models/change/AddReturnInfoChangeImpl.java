...
public class AddReturnInfoChangeImpl implements AddReturnInfoChange, ModelBase {
     ...
     */
    @JsonCreator
    AddReturnInfoChangeImpl(@JsonProperty("change") final String change, @JsonProperty("nextValue") final com.commercetools.history.models.common.ReturnInfo nextValue) {
        this.change = change;
