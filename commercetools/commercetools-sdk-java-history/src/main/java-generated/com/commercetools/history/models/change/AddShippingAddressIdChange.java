...
public interface AddShippingAddressIdChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AddShippingAddressIdChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<AddShippingAddressIdChange>() {
            @Override
