...
public class AddShippingAddressIdChangeImpl implements AddShippingAddressIdChange, ModelBase {
     ...
     */
    @JsonCreator
    AddShippingAddressIdChangeImpl(@JsonProperty("change") final String change, @JsonProperty("nextValue") final java.util.List<String> nextValue, @JsonProperty("previousValue") final java.util.List<String> previousValue, @JsonProperty("address") final com.commercetools.history.models.common.Address address) {
        this.change = change;
