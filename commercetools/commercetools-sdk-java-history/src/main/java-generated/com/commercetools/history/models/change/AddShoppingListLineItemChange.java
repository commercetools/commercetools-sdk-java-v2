...
public interface AddShoppingListLineItemChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AddShoppingListLineItemChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<AddShoppingListLineItemChange>() {
            @Override
