...
public class AddShoppingListLineItemChangeImpl implements AddShoppingListLineItemChange, ModelBase {
     ...
     */
    @JsonCreator
    AddShoppingListLineItemChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final com.commercetools.history.models.common.LineItem previousValue, @JsonProperty("nextValue") final com.commercetools.history.models.common.LineItem nextValue) {
        this.change = change;
