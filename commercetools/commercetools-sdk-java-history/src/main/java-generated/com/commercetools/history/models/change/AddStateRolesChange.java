...
public interface AddStateRolesChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AddStateRolesChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<AddStateRolesChange>() {
            @Override
