 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("AddTaxRateChange")
...
public interface AddTaxRateChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AddTaxRateChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<AddTaxRateChange>() {
            @Override
