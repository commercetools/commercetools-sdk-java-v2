...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:ShoppingListAddTextLineItemAction" rel="nofollow">Add TextLineItem</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("AddTextLineItemChange")
...
public interface AddTextLineItemChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AddTextLineItemChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<AddTextLineItemChange>() {
            @Override
