 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("AddTransactionChange")
...
public interface AddTransactionChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AddTransactionChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<AddTransactionChange>() {
            @Override
