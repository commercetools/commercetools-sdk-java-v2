...
public class AddTransactionChangeImpl implements AddTransactionChange, ModelBase {
     ...
     */
    @JsonCreator
    AddTransactionChangeImpl(@JsonProperty("change") final String change, @JsonProperty("nextValue") final com.commercetools.history.models.common.Transaction nextValue) {
        this.change = change;
