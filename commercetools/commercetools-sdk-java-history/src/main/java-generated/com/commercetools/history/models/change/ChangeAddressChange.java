...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:CustomerChangeAddressAction" rel="nofollow">Change Address</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ChangeAddressChange")
...
public interface ChangeAddressChange extends Change {
    ...
    public ChangeAddressChange copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeAddressChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeAddressChange>() {
            @Override
