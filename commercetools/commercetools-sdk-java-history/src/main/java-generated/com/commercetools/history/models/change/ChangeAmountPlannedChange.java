...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:PaymentChangeAmountPlannedAction" rel="nofollow">Change AmountPlanned</a> update action.</p>
 *
 * <hr>
...
public interface ChangeAmountPlannedChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeAmountPlannedChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeAmountPlannedChange>() {
            @Override
