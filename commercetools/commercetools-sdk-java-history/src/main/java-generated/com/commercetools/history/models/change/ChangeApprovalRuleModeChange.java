...
public interface ChangeApprovalRuleModeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeApprovalRuleModeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeApprovalRuleModeChange>() {
            @Override
