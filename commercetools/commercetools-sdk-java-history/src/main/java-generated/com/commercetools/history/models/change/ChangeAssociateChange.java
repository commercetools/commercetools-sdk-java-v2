 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ChangeAssociateChange")
...
public interface ChangeAssociateChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeAssociateChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeAssociateChange>() {
            @Override
