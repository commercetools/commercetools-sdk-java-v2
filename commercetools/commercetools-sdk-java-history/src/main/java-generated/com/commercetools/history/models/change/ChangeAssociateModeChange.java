...
public interface ChangeAssociateModeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeAssociateModeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeAssociateModeChange>() {
            @Override
