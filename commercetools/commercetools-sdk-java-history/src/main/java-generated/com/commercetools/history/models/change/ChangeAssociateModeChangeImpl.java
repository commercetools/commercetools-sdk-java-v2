...
/**
 *  <p>Change triggered by the Change Associate Mode update action.</p>
 */
...
public class ChangeAssociateModeChangeImpl implements ChangeAssociateModeChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangeAssociateModeChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("previousValue") final com.commercetools.history.models.common.BusinessUnitAssociateMode previousValue,
            @JsonProperty("nextValue") final com.commercetools.history.models.common.BusinessUnitAssociateMode nextValue) {
        this.change = change;
        this.previousValue = previousValue;
        this.nextValue = nextValue;
        this.type = CHANGE_ASSOCIATE_MODE_CHANGE;
    }
    ...
    public void setNextValue(final com.commercetools.history.models.common.BusinessUnitAssociateMode nextValue) {
        this.nextValue = nextValue;
    }
    ...
    public boolean equals(Object o) {
        ...
        ChangeAssociateModeChangeImpl that = (ChangeAssociateModeChangeImpl) o;
