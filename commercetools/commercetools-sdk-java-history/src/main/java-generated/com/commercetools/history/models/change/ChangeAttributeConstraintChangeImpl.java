...
public class ChangeAttributeConstraintChangeImpl implements ChangeAttributeConstraintChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangeAttributeConstraintChangeImpl(@JsonProperty("change") final String change, @JsonProperty("attributeName") final String attributeName, @JsonProperty("previousValue") final com.commercetools.history.models.common.AttributeConstraintEnum previousValue, @JsonProperty("nextValue") final com.commercetools.history.models.common.AttributeConstraintEnum nextValue) {
        this.change = change;
