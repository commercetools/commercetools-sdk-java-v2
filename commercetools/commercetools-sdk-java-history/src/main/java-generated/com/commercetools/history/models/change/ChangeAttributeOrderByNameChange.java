...
public interface ChangeAttributeOrderByNameChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeAttributeOrderByNameChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeAttributeOrderByNameChange>() {
            @Override
