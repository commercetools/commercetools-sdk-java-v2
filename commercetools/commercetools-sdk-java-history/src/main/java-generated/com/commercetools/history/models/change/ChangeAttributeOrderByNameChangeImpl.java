...
public class ChangeAttributeOrderByNameChangeImpl implements ChangeAttributeOrderByNameChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangeAttributeOrderByNameChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final java.util.List<String> previousValue, @JsonProperty("nextValue") final java.util.List<String> nextValue) {
        this.change = change;
