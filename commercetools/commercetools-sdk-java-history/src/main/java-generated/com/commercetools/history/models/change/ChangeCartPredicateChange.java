...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:CartDiscountChangeCartPredicateAction" rel="nofollow">Change Cart Predicate</a> update action.</p>
 *
 * <hr>
...
public interface ChangeCartPredicateChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeCartPredicateChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeCartPredicateChange>() {
            @Override
