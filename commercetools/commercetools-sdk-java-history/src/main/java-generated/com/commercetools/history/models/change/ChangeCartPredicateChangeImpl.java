...
public class ChangeCartPredicateChangeImpl implements ChangeCartPredicateChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangeCartPredicateChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final String previousValue, @JsonProperty("nextValue") final String nextValue) {
        this.change = change;
