...
public interface ChangeCustomerChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeCustomerChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeCustomerChange>() {
            @Override
