...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:ProductTypeChangeDescriptionAction" rel="nofollow">Change Description</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ChangeDescriptionChange")
...
public interface ChangeDescriptionChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeDescriptionChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeDescriptionChange>() {
            @Override
