...
public class ChangeDescriptionChangeImpl implements ChangeDescriptionChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangeDescriptionChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final String previousValue, @JsonProperty("nextValue") final String nextValue) {
        this.change = change;
