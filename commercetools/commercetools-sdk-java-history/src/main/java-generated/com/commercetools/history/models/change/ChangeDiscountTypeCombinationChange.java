...
public interface ChangeDiscountTypeCombinationChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeDiscountTypeCombinationChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeDiscountTypeCombinationChange>() {
            @Override
