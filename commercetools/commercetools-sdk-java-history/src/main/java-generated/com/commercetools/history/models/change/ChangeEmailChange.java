...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:CustomerChangeEmailAction" rel="nofollow">Change Email</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ChangeEmailChange")
...
public interface ChangeEmailChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeEmailChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeEmailChange>() {
            @Override
