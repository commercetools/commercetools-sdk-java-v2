...
public class ChangeEnumValueOrderChangeImpl implements ChangeEnumValueOrderChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangeEnumValueOrderChangeImpl(@JsonProperty("change") final String change, @JsonProperty("fieldName") final String fieldName, @JsonProperty("nextValue") final java.util.List<com.commercetools.history.models.change_value.EnumValue> nextValue, @JsonProperty("previousValue") final java.util.List<com.commercetools.history.models.change_value.EnumValue> previousValue) {
        this.change = change;
