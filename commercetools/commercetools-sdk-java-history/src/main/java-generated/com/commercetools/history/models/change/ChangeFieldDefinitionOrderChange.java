...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:TypeChangeFieldDefinitionOrderAction" rel="nofollow">Change the order of FieldDefinitions</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ChangeFieldDefinitionOrderChange")
...
public interface ChangeFieldDefinitionOrderChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeFieldDefinitionOrderChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeFieldDefinitionOrderChange>() {
            @Override
