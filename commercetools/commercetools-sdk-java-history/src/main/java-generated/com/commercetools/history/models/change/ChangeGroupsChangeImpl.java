...
public class ChangeGroupsChangeImpl implements ChangeGroupsChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangeGroupsChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final java.util.List<String> previousValue, @JsonProperty("nextValue") final java.util.List<String> nextValue) {
        this.change = change;
    ...
    public boolean equals(Object o) {
        ...
        ChangeGroupsChangeImpl that = (ChangeGroupsChangeImpl) o;
