...
public interface ChangeIncludedInStatisticsChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeIncludedInStatisticsChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeIncludedInStatisticsChange>() {
            @Override
