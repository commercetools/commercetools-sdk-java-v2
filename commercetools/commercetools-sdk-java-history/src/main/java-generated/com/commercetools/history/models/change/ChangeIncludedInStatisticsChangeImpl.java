...
public class ChangeIncludedInStatisticsChangeImpl implements ChangeIncludedInStatisticsChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangeIncludedInStatisticsChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("previousValue") final Boolean previousValue,
            @JsonProperty("nextValue") final Boolean nextValue) {
        this.change = change;
        this.previousValue = previousValue;
        this.nextValue = nextValue;
        this.type = CHANGE_INCLUDED_IN_STATISTICS_CHANGE;
    }

    /**
     * create empty instance
     */
    public ChangeIncludedInStatisticsChangeImpl() {
        this.type = CHANGE_INCLUDED_IN_STATISTICS_CHANGE;
    }
    ...
    public boolean equals(Object o) {
        ...
        ChangeIncludedInStatisticsChangeImpl that = (ChangeIncludedInStatisticsChangeImpl) o;
    ...
    public ChangeIncludedInStatisticsChange copyDeep() {
        return ChangeIncludedInStatisticsChange.deepCopy(this);
    }
}
