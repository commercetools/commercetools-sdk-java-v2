 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ChangeInheritedAssociateChange")
...
public interface ChangeInheritedAssociateChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeInheritedAssociateChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeInheritedAssociateChange>() {
            @Override
