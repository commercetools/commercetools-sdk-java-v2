...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:StateChangeInitialAction" rel="nofollow">Change initial State</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ChangeInitialChange")
...
public interface ChangeInitialChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeInitialChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeInitialChange>() {
            @Override
