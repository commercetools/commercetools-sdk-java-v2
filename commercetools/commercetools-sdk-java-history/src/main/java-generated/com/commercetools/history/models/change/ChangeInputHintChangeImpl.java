...
public class ChangeInputHintChangeImpl implements ChangeInputHintChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangeInputHintChangeImpl(@JsonProperty("change") final String change, @JsonProperty("fieldName") final String fieldName, @JsonProperty("attributeName") final String attributeName, @JsonProperty("nextValue") final com.commercetools.history.models.common.TextInputHint nextValue, @JsonProperty("previousValue") final com.commercetools.history.models.common.TextInputHint previousValue) {
        this.change = change;
