...
public class ChangeIsActiveChangeImpl implements ChangeIsActiveChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangeIsActiveChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final Boolean previousValue, @JsonProperty("nextValue") final Boolean nextValue) {
        this.change = change;
