...
public interface ChangeLastVariantIdChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeLastVariantIdChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeLastVariantIdChange>() {
            @Override
