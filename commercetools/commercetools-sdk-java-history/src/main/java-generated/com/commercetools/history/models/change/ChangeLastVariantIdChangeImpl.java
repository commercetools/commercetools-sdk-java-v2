...
public class ChangeLastVariantIdChangeImpl implements ChangeLastVariantIdChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangeLastVariantIdChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("previousValue") final Integer previousValue,
            @JsonProperty("nextValue") final Integer nextValue) {
        this.change = change;
        this.previousValue = previousValue;
        this.nextValue = nextValue;
        this.type = CHANGE_LAST_VARIANT_ID_CHANGE;
    }

    /**
     * create empty instance
     */
    public ChangeLastVariantIdChangeImpl() {
        this.type = CHANGE_LAST_VARIANT_ID_CHANGE;
    }
    ...
    public boolean equals(Object o) {
        ...
        ChangeLastVariantIdChangeImpl that = (ChangeLastVariantIdChangeImpl) o;
    ...
    public ChangeLastVariantIdChange copyDeep() {
        return ChangeLastVariantIdChange.deepCopy(this);
    }
}
