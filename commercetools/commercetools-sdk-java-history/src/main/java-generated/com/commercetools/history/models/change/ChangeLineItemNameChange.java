...
public interface ChangeLineItemNameChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeLineItemNameChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeLineItemNameChange>() {
            @Override
