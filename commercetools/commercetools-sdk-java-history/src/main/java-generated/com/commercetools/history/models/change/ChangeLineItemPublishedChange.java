...
public interface ChangeLineItemPublishedChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeLineItemPublishedChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeLineItemPublishedChange>() {
            @Override
