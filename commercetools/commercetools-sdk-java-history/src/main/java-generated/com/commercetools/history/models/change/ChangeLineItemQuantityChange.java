...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:StagedOrderChangeLineItemQuantityAction" rel="nofollow">Change LineItem Quantity</a> update action.</p>
 *
 * <hr>
...
public interface ChangeLineItemQuantityChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeLineItemQuantityChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeLineItemQuantityChange>() {
            @Override
