...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:ChannelChangeDescriptionAction" rel="nofollow">Change Description</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ChangeLocalizedDescriptionChange")
...
public interface ChangeLocalizedDescriptionChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeLocalizedDescriptionChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeLocalizedDescriptionChange>() {
            @Override
