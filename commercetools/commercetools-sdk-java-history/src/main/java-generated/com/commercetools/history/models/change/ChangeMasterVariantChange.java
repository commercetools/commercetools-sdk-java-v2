...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:ProductChangeMasterVariantAction" rel="nofollow">Change Master Variant</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ChangeMasterVariantChange")
...
public interface ChangeMasterVariantChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeMasterVariantChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeMasterVariantChange>() {
            @Override
