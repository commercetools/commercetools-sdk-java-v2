...
public class ChangeNameChangeImpl implements ChangeNameChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangeNameChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final String previousValue, @JsonProperty("nextValue") final String nextValue) {
        this.change = change;
