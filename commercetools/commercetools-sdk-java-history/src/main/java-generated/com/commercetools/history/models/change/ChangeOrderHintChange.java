...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:CategoryChangeOrderHintAction" rel="nofollow">Change OrderHint</a> update action.</p>
 *
 * <hr>
...
public interface ChangeOrderHintChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeOrderHintChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeOrderHintChange>() {
            @Override
