...
public class ChangeOrderStateChangeImpl implements ChangeOrderStateChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangeOrderStateChangeImpl(@JsonProperty("change") final String change, @JsonProperty("nextValue") final com.commercetools.history.models.common.OrderState nextValue, @JsonProperty("previousValue") final com.commercetools.history.models.common.OrderState previousValue) {
        this.change = change;
