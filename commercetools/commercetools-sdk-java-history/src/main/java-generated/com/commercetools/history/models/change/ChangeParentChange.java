...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:CategoryChangeParentAction" rel="nofollow">Change Parent</a> update action.</p>
 *
 * <hr>
...
public interface ChangeParentChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeParentChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeParentChange>() {
            @Override
