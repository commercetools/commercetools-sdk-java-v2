...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:BusinessUnitChangeParentUnitAction" rel="nofollow">Change Parent Unit</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ChangeParentUnitChange")
...
public interface ChangeParentUnitChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeParentUnitChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeParentUnitChange>() {
            @Override
