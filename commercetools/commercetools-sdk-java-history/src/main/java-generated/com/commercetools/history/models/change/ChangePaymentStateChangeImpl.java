...
public class ChangePaymentStateChangeImpl implements ChangePaymentStateChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangePaymentStateChangeImpl(@JsonProperty("change") final String change, @JsonProperty("nextValue") final com.commercetools.history.models.common.PaymentState nextValue, @JsonProperty("previousValue") final com.commercetools.history.models.common.PaymentState previousValue) {
        this.change = change;
