...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:ProductDiscountChangePredicateAction" rel="nofollow">Change Predicate</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ChangePredicateChange")
...
public interface ChangePredicateChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangePredicateChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangePredicateChange>() {
            @Override
