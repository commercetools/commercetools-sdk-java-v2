...
public class ChangePredicateChangeImpl implements ChangePredicateChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangePredicateChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final String previousValue, @JsonProperty("nextValue") final String nextValue) {
        this.change = change;
