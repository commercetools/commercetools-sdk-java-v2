...
public interface ChangePriceRoundingModeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangePriceRoundingModeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangePriceRoundingModeChange>() {
            @Override
