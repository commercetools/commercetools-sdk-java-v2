...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:StoreChangeProductSelectionAction" rel="nofollow">Change Product Selection Active</a> update action.</p>
 *
 * <hr>
...
public interface ChangeProductSelectionActiveChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeProductSelectionActiveChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeProductSelectionActiveChange>() {
            @Override
