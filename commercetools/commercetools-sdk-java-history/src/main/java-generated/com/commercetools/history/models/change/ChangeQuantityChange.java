...
import com.commercetools.history.models.change.ChangeQuantityChangeImpl;
...
public interface ChangeQuantityChange extends Change {
    ...
    public static ChangeQuantityChange deepCopy(@Nullable final ChangeQuantityChange template) {
        ...
        ChangeQuantityChangeImpl instance = new ChangeQuantityChangeImpl();
        instance.setChange(template.getChange());
        instance.setNextValue(com.commercetools.history.models.change_value.InventoryQuantityValue.deepCopy(template.getNextValue()));
        instance.setPreviousValue(com.commercetools.history.models.change_value.InventoryQuantityValue.deepCopy(template.getPreviousValue()));
        return instance;
    }
