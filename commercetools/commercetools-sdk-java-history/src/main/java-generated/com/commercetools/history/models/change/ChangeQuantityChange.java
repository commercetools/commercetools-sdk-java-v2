...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:InventoryEntryChangeQuantityAction" rel="nofollow">Change Quantity</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ChangeQuantityChange")
...
public interface ChangeQuantityChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeQuantityChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeQuantityChange>() {
            @Override
