...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:QuoteRequestChangeQuoteRequestStateAction" rel="nofollow">Change Quote Request State</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ChangeQuoteRequestStateChange")
...
public interface ChangeQuoteRequestStateChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeQuoteRequestStateChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeQuoteRequestStateChange>() {
            @Override
