...
public class ChangeQuoteRequestStateChangeImpl implements ChangeQuoteRequestStateChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangeQuoteRequestStateChangeImpl(@JsonProperty("change") final String change, @JsonProperty("nextValue") final com.commercetools.history.models.common.QuoteRequestState nextValue, @JsonProperty("previousValue") final com.commercetools.history.models.common.QuoteRequestState previousValue) {
        this.change = change;
