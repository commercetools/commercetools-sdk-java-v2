 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ChangeQuoteStateChange")
...
public interface ChangeQuoteStateChange extends Change {
    ...
    public ChangeQuoteStateChange copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeQuoteStateChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeQuoteStateChange>() {
            @Override
