...
public interface ChangeRequiresDiscountCodeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeRequiresDiscountCodeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeRequiresDiscountCodeChange>() {
            @Override
