...
public class ChangeRequiresDiscountCodeChangeImpl implements ChangeRequiresDiscountCodeChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangeRequiresDiscountCodeChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final Boolean previousValue, @JsonProperty("nextValue") final Boolean nextValue) {
        this.change = change;
