...
public class ChangeReviewRatingStatisticsChangeBuilder implements Builder<ChangeReviewRatingStatisticsChange> {
    ...
    public ChangeReviewRatingStatisticsChangeBuilder nextValue(Function<com.commercetools.history.models.common.ReviewRatingStatisticsBuilder, com.commercetools.history.models.common.ReviewRatingStatisticsBuilder> builder) {
        this.nextValue = builder.apply(com.commercetools.history.models.common.ReviewRatingStatisticsBuilder.of()).build();
        return this;
    }
    ...
    public ChangeReviewRatingStatisticsChangeBuilder withNextValue(Function<com.commercetools.history.models.common.ReviewRatingStatisticsBuilder, com.commercetools.history.models.common.ReviewRatingStatistics> builder) {
    ...
    public ChangeReviewRatingStatisticsChangeBuilder nextValue( final com.commercetools.history.models.common.ReviewRatingStatistics nextValue) {
    ...
    public ChangeReviewRatingStatisticsChangeBuilder previousValue(Function<com.commercetools.history.models.common.ReviewRatingStatisticsBuilder, com.commercetools.history.models.common.ReviewRatingStatisticsBuilder> builder) {
        this.previousValue = builder.apply(com.commercetools.history.models.common.ReviewRatingStatisticsBuilder.of()).build();
        return this;
    }
    ...
    public ChangeReviewRatingStatisticsChangeBuilder withPreviousValue(Function<com.commercetools.history.models.common.ReviewRatingStatisticsBuilder, com.commercetools.history.models.common.ReviewRatingStatistics> builder) {
    ...
    public ChangeReviewRatingStatisticsChangeBuilder previousValue( final com.commercetools.history.models.common.ReviewRatingStatistics previousValue) {
