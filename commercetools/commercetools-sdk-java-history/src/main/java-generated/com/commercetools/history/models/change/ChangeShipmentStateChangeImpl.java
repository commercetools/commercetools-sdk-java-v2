...
public class ChangeShipmentStateChangeImpl implements ChangeShipmentStateChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangeShipmentStateChangeImpl(@JsonProperty("change") final String change, @JsonProperty("nextValue") final com.commercetools.history.models.common.ShipmentState nextValue, @JsonProperty("previousValue") final com.commercetools.history.models.common.ShipmentState previousValue) {
        this.change = change;
