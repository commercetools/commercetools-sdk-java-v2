...
public class ChangeShoppingListLineItemQuantityChangeImpl implements ChangeShoppingListLineItemQuantityChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangeShoppingListLineItemQuantityChangeImpl(@JsonProperty("change") final String change, @JsonProperty("lineItem") final com.commercetools.history.models.change_value.ShoppingListLineItemValue lineItem, @JsonProperty("previousValue") final Integer previousValue, @JsonProperty("nextValue") final Integer nextValue) {
        this.change = change;
