...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:ShoppingListChangeLineItemsOrderAction" rel="nofollow">Change ShoppingListLineItems Order</a> update action.</p>
 *
 * <hr>
...
public interface ChangeShoppingListLineItemsOrderChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeShoppingListLineItemsOrderChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeShoppingListLineItemsOrderChange>() {
            @Override
