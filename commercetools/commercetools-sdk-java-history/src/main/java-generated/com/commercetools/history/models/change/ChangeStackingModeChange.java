...
public interface ChangeStackingModeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeStackingModeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeStackingModeChange>() {
            @Override
