...
public interface ChangeStateTypeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeStateTypeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeStateTypeChange>() {
            @Override
