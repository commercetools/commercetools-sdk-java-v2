 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ChangeStatusChange")
...
public interface ChangeStatusChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeStatusChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeStatusChange>() {
            @Override
