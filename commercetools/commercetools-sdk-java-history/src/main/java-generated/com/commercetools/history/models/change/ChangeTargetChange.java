...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:CartDiscountChangeTargetAction" rel="nofollow">Change Target</a> update action.</p>
 *
 * <hr>
...
public interface ChangeTargetChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeTargetChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeTargetChange>() {
            @Override
