...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:StagedOrderChangeTaxCalculationModeAction" rel="nofollow">Change TaxCalculationMode</a> update action.</p>
 */
...
public class ChangeTaxCalculationModeChangeImpl implements ChangeTaxCalculationModeChange, ModelBase {
    ...
    ChangeTaxCalculationModeChangeImpl(@JsonProperty("change") final String change,
            ...
            @JsonProperty("nextValue") final com.commercetools.history.models.common.TaxCalculationMode nextValue) {
        this.change = change;
