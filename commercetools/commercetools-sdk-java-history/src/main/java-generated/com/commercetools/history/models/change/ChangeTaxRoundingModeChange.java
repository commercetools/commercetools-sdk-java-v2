...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:StagedOrderChangeTaxRoundingModeAction" rel="nofollow">Change Tax RoundingMode</a> update action.</p>
 *
 * <hr>
...
public interface ChangeTaxRoundingModeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeTaxRoundingModeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeTaxRoundingModeChange>() {
            @Override
