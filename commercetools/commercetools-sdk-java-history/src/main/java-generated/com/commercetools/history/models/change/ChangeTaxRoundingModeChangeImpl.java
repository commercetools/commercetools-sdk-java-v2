...
public class ChangeTaxRoundingModeChangeImpl implements ChangeTaxRoundingModeChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangeTaxRoundingModeChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final com.commercetools.history.models.common.RoundingMode previousValue, @JsonProperty("nextValue") final com.commercetools.history.models.common.RoundingMode nextValue) {
        this.change = change;
