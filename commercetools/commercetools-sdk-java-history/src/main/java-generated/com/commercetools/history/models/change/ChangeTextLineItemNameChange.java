...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:ShoppingListChangeTextLineItemNameAction" rel="nofollow">Change TextLineItem Name</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ChangeTextLineItemNameChange")
...
public interface ChangeTextLineItemNameChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeTextLineItemNameChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeTextLineItemNameChange>() {
            @Override
