...
public interface ChangeTextLineItemQuantityChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeTextLineItemQuantityChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeTextLineItemQuantityChange>() {
            @Override
