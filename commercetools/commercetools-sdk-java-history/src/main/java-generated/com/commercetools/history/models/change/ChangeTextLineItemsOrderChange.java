...
public interface ChangeTextLineItemsOrderChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeTextLineItemsOrderChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeTextLineItemsOrderChange>() {
            @Override
