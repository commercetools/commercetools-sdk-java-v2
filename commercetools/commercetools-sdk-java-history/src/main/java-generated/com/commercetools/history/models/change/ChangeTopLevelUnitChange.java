...
public interface ChangeTopLevelUnitChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeTopLevelUnitChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeTopLevelUnitChange>() {
            @Override
