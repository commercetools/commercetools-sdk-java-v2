...
import com.commercetools.history.models.change.ChangeTransactionInteractionIdChangeImpl;
...
public interface ChangeTransactionInteractionIdChange extends Change {
     ...
     */
    @Nullable
    public static ChangeTransactionInteractionIdChange deepCopy(@Nullable final ChangeTransactionInteractionIdChange template) {
        if (template == null) {
            return null;
        }
        ChangeTransactionInteractionIdChangeImpl instance = new ChangeTransactionInteractionIdChangeImpl();
     ...
     * @return builder
     */
    public static ChangeTransactionInteractionIdChangeBuilder builder(final ChangeTransactionInteractionIdChange template) {
