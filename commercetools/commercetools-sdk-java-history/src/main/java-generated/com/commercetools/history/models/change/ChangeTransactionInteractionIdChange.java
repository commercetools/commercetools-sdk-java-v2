...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:PaymentChangeTransactionInteractionIdAction" rel="nofollow">Change TransactionInteractionId</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("ChangeTransactionInteractionIdChange")
...
public interface ChangeTransactionInteractionIdChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeTransactionInteractionIdChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeTransactionInteractionIdChange>() {
            @Override
