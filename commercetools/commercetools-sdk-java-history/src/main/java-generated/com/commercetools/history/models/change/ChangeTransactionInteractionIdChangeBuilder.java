...
public class ChangeTransactionInteractionIdChangeBuilder implements Builder<ChangeTransactionInteractionIdChange> {
    ...
    public ChangeTransactionInteractionIdChangeBuilder transaction(Function<com.commercetools.history.models.change_value.TransactionChangeValueBuilder, com.commercetools.history.models.change_value.TransactionChangeValueBuilder> builder) {
    ...
    public ChangeTransactionInteractionIdChangeBuilder withTransaction(Function<com.commercetools.history.models.change_value.TransactionChangeValueBuilder, com.commercetools.history.models.change_value.TransactionChangeValue> builder) {
    ...
    public ChangeTransactionInteractionIdChangeBuilder transaction( final com.commercetools.history.models.change_value.TransactionChangeValue transaction) {
    ...
    public ChangeTransactionInteractionIdChange build() {
        ...
        Objects.requireNonNull(previousValue, ChangeTransactionInteractionIdChange.class + ": previousValue is missing");
