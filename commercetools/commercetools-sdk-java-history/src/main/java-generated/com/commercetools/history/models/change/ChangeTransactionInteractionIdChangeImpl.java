...
public class ChangeTransactionInteractionIdChangeImpl implements ChangeTransactionInteractionIdChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangeTransactionInteractionIdChangeImpl(@JsonProperty("change") final String change, @JsonProperty("transaction") final com.commercetools.history.models.change_value.TransactionChangeValue transaction, @JsonProperty("nextValue") final String nextValue, @JsonProperty("previousValue") final String previousValue) {
        this.change = change;
