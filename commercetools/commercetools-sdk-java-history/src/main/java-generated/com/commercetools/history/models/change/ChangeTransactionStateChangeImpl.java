...
public class ChangeTransactionStateChangeImpl implements ChangeTransactionStateChange, ModelBase {
     ...
     */
    @JsonCreator
    ChangeTransactionStateChangeImpl(@JsonProperty("change") final String change, @JsonProperty("transaction") final com.commercetools.history.models.change_value.TransactionChangeValue transaction, @JsonProperty("nextValue") final com.commercetools.history.models.common.TransactionState nextValue, @JsonProperty("previousValue") final com.commercetools.history.models.common.TransactionState previousValue) {
        this.change = change;
