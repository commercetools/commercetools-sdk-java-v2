...
public interface ChangeTransactionTimestampChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeTransactionTimestampChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeTransactionTimestampChange>() {
            @Override
