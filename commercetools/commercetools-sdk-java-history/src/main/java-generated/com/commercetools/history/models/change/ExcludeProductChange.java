...
public interface ExcludeProductChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ExcludeProductChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ExcludeProductChange>() {
            @Override
