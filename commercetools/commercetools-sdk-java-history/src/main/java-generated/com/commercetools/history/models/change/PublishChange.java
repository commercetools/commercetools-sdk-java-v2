...
public interface PublishChange extends Change {
     ...
     */
    @Nullable
    public static PublishChange deepCopy(@Nullable final PublishChange template) {
        if (template == null) {
            return null;
        }
        PublishChangeImpl instance = new PublishChangeImpl();
     ...
     */
    public static tools.jackson.core.type.TypeReference<PublishChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<PublishChange>() {
            @Override
