...
public class RemoveAddressChangeImpl implements RemoveAddressChange, ModelBase {
     ...
     */
    @JsonCreator
    RemoveAddressChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final com.commercetools.history.models.common.Address previousValue) {
        this.change = change;
