...
public class RemoveAssetChangeImpl implements RemoveAssetChange, ModelBase {
     ...
     */
    @JsonCreator
    RemoveAssetChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final com.commercetools.history.models.common.Asset previousValue) {
        this.change = change;
