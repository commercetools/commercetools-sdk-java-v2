...
public interface RemoveAttributeDefinitionChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RemoveAttributeDefinitionChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<RemoveAttributeDefinitionChange>() {
            @Override
