...
public class RemoveAttributeDefinitionChangeImpl implements RemoveAttributeDefinitionChange, ModelBase {
     ...
     */
    @JsonCreator
    RemoveAttributeDefinitionChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final com.commercetools.history.models.common.AttributeDefinition previousValue) {
        this.change = change;
