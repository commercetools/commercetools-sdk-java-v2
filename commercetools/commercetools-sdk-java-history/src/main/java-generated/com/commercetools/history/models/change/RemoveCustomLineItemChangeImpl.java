...
public class RemoveCustomLineItemChangeImpl implements RemoveCustomLineItemChange, ModelBase {
     ...
     */
    @JsonCreator
    RemoveCustomLineItemChangeImpl(@JsonProperty("change") final String change, @JsonProperty("nextValue") final com.commercetools.history.models.common.CustomLineItem nextValue, @JsonProperty("previousValue") final com.commercetools.history.models.common.CustomLineItem previousValue) {
        this.change = change;
