...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:StagedOrderRemoveDiscountCodeAction" rel="nofollow">Remove DiscountCode</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("RemoveDiscountCodeChange")
...
public interface RemoveDiscountCodeChange extends Change {
    ...
    public RemoveDiscountCodeChange copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<RemoveDiscountCodeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<RemoveDiscountCodeChange>() {
            @Override
