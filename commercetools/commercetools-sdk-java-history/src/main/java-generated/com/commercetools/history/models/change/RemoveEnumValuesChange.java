...
public interface RemoveEnumValuesChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RemoveEnumValuesChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<RemoveEnumValuesChange>() {
            @Override
