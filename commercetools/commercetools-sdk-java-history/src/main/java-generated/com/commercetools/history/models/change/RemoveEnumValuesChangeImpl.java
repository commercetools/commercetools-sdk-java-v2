...
public class RemoveEnumValuesChangeImpl implements RemoveEnumValuesChange, ModelBase {
     ...
     */
    @JsonCreator
    RemoveEnumValuesChangeImpl(@JsonProperty("change") final String change, @JsonProperty("attributeName") final String attributeName, @JsonProperty("previousValue") final com.commercetools.history.models.change_value.EnumValue previousValue) {
        this.change = change;
