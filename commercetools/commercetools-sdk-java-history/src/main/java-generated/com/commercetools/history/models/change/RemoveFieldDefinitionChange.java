...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:TypeRemoveFieldDefinitionAction" rel="nofollow">Remove FieldDefinition</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("RemoveFieldDefinitionChange")
...
public interface RemoveFieldDefinitionChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RemoveFieldDefinitionChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<RemoveFieldDefinitionChange>() {
            @Override
