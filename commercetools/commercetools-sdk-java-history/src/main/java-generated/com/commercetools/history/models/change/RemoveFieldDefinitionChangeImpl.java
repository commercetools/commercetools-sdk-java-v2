...
public class RemoveFieldDefinitionChangeImpl implements RemoveFieldDefinitionChange, ModelBase {
     ...
     */
    @JsonCreator
    RemoveFieldDefinitionChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final com.commercetools.history.models.common.FieldDefinition previousValue) {
        this.change = change;
