...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:ProductRemoveFromCategoryAction" rel="nofollow">Remove from Category</a> update action.</p>
 *
 * <hr>
...
public interface RemoveFromCategoryChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RemoveFromCategoryChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<RemoveFromCategoryChange>() {
            @Override
