...
public class RemoveFromCategoryChangeImpl implements RemoveFromCategoryChange, ModelBase {
     ...
     */
    @JsonCreator
    RemoveFromCategoryChangeImpl(@JsonProperty("change") final String change, @JsonProperty("category") final com.commercetools.history.models.common.Reference category, @JsonProperty("previousValue") final java.util.List<com.commercetools.history.models.common.Reference> previousValue, @JsonProperty("nextValue") final java.util.List<com.commercetools.history.models.common.Reference> nextValue) {
        this.change = change;
