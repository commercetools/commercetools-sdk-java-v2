...
public interface RemoveItemShippingAddressesChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RemoveItemShippingAddressesChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<RemoveItemShippingAddressesChange>() {
            @Override
