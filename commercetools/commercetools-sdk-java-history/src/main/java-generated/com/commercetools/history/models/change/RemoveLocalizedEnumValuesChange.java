...
public interface RemoveLocalizedEnumValuesChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RemoveLocalizedEnumValuesChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<RemoveLocalizedEnumValuesChange>() {
            @Override
