...
public class RemoveLocalizedEnumValuesChangeImpl implements RemoveLocalizedEnumValuesChange, ModelBase {
     ...
     */
    @JsonCreator
    RemoveLocalizedEnumValuesChangeImpl(@JsonProperty("change") final String change, @JsonProperty("attributeName") final String attributeName, @JsonProperty("previousValue") final com.commercetools.history.models.change_value.LocalizedEnumValue previousValue) {
        this.change = change;
