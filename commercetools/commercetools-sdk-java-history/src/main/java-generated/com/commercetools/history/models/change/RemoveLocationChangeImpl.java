...
public class RemoveLocationChangeImpl implements RemoveLocationChange, ModelBase {
     ...
     */
    @JsonCreator
    RemoveLocationChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final com.commercetools.history.models.common.Location previousValue, @JsonProperty("nextValue") final com.commercetools.history.models.common.Location nextValue) {
        this.change = change;
    ...
    public boolean equals(Object o) {
        ...
        RemoveLocationChangeImpl that = (RemoveLocationChangeImpl) o;
