...
public interface RemovePaymentChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RemovePaymentChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<RemovePaymentChange>() {
            @Override
