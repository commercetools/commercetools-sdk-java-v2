...
public class RemovePaymentChangeImpl implements RemovePaymentChange, ModelBase {
     ...
     */
    @JsonCreator
    RemovePaymentChangeImpl(@JsonProperty("change") final String change, @JsonProperty("nextValue") final com.commercetools.history.models.common.PaymentInfo nextValue, @JsonProperty("previousValue") final com.commercetools.history.models.common.PaymentInfo previousValue) {
        this.change = change;
