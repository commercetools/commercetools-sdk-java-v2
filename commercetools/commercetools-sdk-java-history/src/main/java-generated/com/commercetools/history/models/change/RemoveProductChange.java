...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:ProductSelectionRemoveProductAction" rel="nofollow">Remove Product</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("RemoveProductChange")
...
public interface RemoveProductChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RemoveProductChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<RemoveProductChange>() {
            @Override
