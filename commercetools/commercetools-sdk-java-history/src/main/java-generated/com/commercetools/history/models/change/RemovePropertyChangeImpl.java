...
public class RemovePropertyChangeImpl implements RemovePropertyChange, ModelBase {
     ...
     */
    @JsonCreator
    RemovePropertyChangeImpl(@JsonProperty("change") final String change, @JsonProperty("path") final String path, @JsonProperty("previousValue") final java.lang.Object previousValue) {
        this.change = change;
        this.path = path;
