...
public class RemoveShippingAddressIdChangeImpl implements RemoveShippingAddressIdChange, ModelBase {
     ...
     */
    @JsonCreator
    RemoveShippingAddressIdChangeImpl(@JsonProperty("change") final String change, @JsonProperty("nextValue") final java.util.List<String> nextValue, @JsonProperty("previousValue") final java.util.List<String> previousValue, @JsonProperty("address") final com.commercetools.history.models.common.Address address) {
        this.change = change;
    ...
    public boolean equals(Object o) {
        ...
        RemoveShippingAddressIdChangeImpl that = (RemoveShippingAddressIdChangeImpl) o;
