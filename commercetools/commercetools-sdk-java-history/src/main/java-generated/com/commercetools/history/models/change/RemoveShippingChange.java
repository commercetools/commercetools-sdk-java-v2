...
public interface RemoveShippingChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RemoveShippingChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<RemoveShippingChange>() {
            @Override
