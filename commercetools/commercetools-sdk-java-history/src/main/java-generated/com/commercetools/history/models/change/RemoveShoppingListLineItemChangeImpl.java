...
public class RemoveShoppingListLineItemChangeImpl implements RemoveShoppingListLineItemChange, ModelBase {
     ...
     */
    @JsonCreator
    RemoveShoppingListLineItemChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final com.commercetools.history.models.common.LineItem previousValue, @JsonProperty("nextValue") final com.commercetools.history.models.common.LineItem nextValue) {
        this.change = change;
