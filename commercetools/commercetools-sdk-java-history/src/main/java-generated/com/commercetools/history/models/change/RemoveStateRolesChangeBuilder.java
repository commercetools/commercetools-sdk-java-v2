...
public class RemoveStateRolesChangeBuilder implements Builder<RemoveStateRolesChange> {
    ...
    public RemoveStateRolesChangeBuilder previousValue( final com.commercetools.history.models.common.StateRole ...previousValue) {
    ...
    public RemoveStateRolesChangeBuilder previousValue( final java.util.List<com.commercetools.history.models.common.StateRole> previousValue) {
    ...
    public RemoveStateRolesChangeBuilder plusPreviousValue( final com.commercetools.history.models.common.StateRole ...previousValue) {
    ...
    public RemoveStateRolesChangeBuilder nextValue( final com.commercetools.history.models.common.StateRole ...nextValue) {
    ...
    public RemoveStateRolesChangeBuilder nextValue( final java.util.List<com.commercetools.history.models.common.StateRole> nextValue) {
    ...
    public RemoveStateRolesChangeBuilder plusNextValue( final com.commercetools.history.models.common.StateRole ...nextValue) {
