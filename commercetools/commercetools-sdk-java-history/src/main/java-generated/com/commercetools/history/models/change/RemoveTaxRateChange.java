...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:TaxCategoryRemoveTaxRateAction" rel="nofollow">Remove TaxRate</a> update action.</p>
 *
 * <hr>
...
public interface RemoveTaxRateChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RemoveTaxRateChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<RemoveTaxRateChange>() {
            @Override
