...
public interface RemoveTextLineItemChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RemoveTextLineItemChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<RemoveTextLineItemChange>() {
            @Override
