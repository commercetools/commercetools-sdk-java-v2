...
public interface RevertStagedChangesChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RevertStagedChangesChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<RevertStagedChangesChange>() {
            @Override
