...
public class SetAncestorsChangeImpl implements SetAncestorsChange, ModelBase {
     ...
     */
    @JsonCreator
    SetAncestorsChangeImpl(@JsonProperty("change") final String change,
        ...
        this.type = SET_ANCESTORS_CHANGE;
    }

    /**
     * create empty instance
     */
    public SetAncestorsChangeImpl() {
        this.type = SET_ANCESTORS_CHANGE;
    }
    ...
    public boolean equals(Object o) {
        ...
        SetAncestorsChangeImpl that = (SetAncestorsChangeImpl) o;
    ...
    public SetAncestorsChange copyDeep() {
        return SetAncestorsChange.deepCopy(this);
    }
}
