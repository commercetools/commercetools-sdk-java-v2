...
public interface SetAssetDescriptionChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetAssetDescriptionChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetAssetDescriptionChange>() {
            @Override
