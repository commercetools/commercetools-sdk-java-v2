...
public interface SetAssetTagsChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetAssetTagsChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetAssetTagsChange>() {
            @Override
