...
public interface SetAssociatesChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetAssociatesChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetAssociatesChange>() {
            @Override
