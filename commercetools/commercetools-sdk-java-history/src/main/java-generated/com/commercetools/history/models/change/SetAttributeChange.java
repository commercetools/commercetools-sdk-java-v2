...
public interface SetAttributeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetAttributeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetAttributeChange>() {
            @Override
