...
public class SetAuthenticationModeChangeImpl implements SetAuthenticationModeChange, ModelBase {
     ...
     */
    @JsonCreator
    SetAuthenticationModeChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final com.commercetools.history.models.common.AuthenticationMode previousValue, @JsonProperty("nextValue") final com.commercetools.history.models.common.AuthenticationMode nextValue) {
        this.change = change;
