...
public interface SetAuthorNameChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetAuthorNameChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetAuthorNameChange>() {
            @Override
