 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetBillingAddressChange")
...
public interface SetBillingAddressChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetBillingAddressChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetBillingAddressChange>() {
            @Override
