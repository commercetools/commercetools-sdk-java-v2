...
public interface SetBillingAddressCustomTypeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetBillingAddressCustomTypeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetBillingAddressCustomTypeChange>() {
            @Override
