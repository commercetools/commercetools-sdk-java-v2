...
public interface SetBusinessUnitChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetBusinessUnitChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetBusinessUnitChange>() {
            @Override
