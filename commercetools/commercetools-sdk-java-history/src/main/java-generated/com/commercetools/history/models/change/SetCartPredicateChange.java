...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:DiscountCodeSetCartPredicateAction" rel="nofollow">Set Cart Predicate</a> update action.</p>
 *
 * <hr>
...
public interface SetCartPredicateChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetCartPredicateChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetCartPredicateChange>() {
            @Override
