...
public class SetCartPredicateChangeImpl implements SetCartPredicateChange, ModelBase {
     ...
     */
    @JsonCreator
    SetCartPredicateChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final String previousValue, @JsonProperty("nextValue") final String nextValue) {
        this.change = change;
