...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:CustomerSetCompanyNameAction" rel="nofollow">Set Company Name</a> update action.</p>
 *
 * <hr>
...
public interface SetCompanyNameChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetCompanyNameChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetCompanyNameChange>() {
            @Override
