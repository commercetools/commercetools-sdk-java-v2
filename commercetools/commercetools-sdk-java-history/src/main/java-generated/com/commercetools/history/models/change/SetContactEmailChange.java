 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetContactEmailChange")
...
public interface SetContactEmailChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetContactEmailChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetContactEmailChange>() {
            @Override
