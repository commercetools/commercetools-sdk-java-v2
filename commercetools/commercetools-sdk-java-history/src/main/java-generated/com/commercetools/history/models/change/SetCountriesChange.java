...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:StoreSetCountriesAction" rel="nofollow">Set Countries</a> update action.</p>
 *
 * <hr>
...
public interface SetCountriesChange extends Change {
    ...
    public List<StoreCountry> getAddedItems();
    ...
    public List<StoreCountry> getRemovedItems();
    ...
    @JsonIgnore
    public void setAddedItems(final StoreCountry... addedItems);
    ...
    public void setAddedItems(final List<StoreCountry> addedItems);
    ...
    @JsonIgnore
    public void setRemovedItems(final StoreCountry... removedItems);
    ...
    public void setRemovedItems(final List<StoreCountry> removedItems);
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetCountriesChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetCountriesChange>() {
            @Override
