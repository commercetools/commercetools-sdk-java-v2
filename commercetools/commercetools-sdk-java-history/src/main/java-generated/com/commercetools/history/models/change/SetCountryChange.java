...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:StagedOrderSetCountryAction" rel="nofollow">Set Country</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetCountryChange")
...
public interface SetCountryChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetCountryChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetCountryChange>() {
            @Override
