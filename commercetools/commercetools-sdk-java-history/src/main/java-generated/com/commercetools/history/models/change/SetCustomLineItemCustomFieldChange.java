...
import com.commercetools.history.models.change.SetCustomLineItemCustomFieldChangeImpl;
...
public interface SetCustomLineItemCustomFieldChange extends Change {
     ...
     */
    @Nullable
    public static SetCustomLineItemCustomFieldChange deepCopy(@Nullable final SetCustomLineItemCustomFieldChange template) {
        if (template == null) {
            return null;
        }
        SetCustomLineItemCustomFieldChangeImpl instance = new SetCustomLineItemCustomFieldChangeImpl();
