...
public interface SetCustomLineItemDiscountedPriceChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetCustomLineItemDiscountedPriceChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetCustomLineItemDiscountedPriceChange>() {
            @Override
