...
public interface SetCustomLineItemDiscountedPricePerQuantityChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetCustomLineItemDiscountedPricePerQuantityChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetCustomLineItemDiscountedPricePerQuantityChange>() {
            @Override
