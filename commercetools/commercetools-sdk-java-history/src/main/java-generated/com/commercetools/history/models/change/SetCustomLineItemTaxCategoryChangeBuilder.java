...
public class SetCustomLineItemTaxCategoryChangeBuilder implements Builder<SetCustomLineItemTaxCategoryChange> {
    ...
    public SetCustomLineItemTaxCategoryChangeBuilder customLineItem(Function<com.commercetools.history.models.common.LocalizedStringBuilder, com.commercetools.history.models.common.LocalizedStringBuilder> builder) {
    ...
    public SetCustomLineItemTaxCategoryChangeBuilder withCustomLineItem(Function<com.commercetools.history.models.common.LocalizedStringBuilder, com.commercetools.history.models.common.LocalizedString> builder) {
    ...
    public SetCustomLineItemTaxCategoryChangeBuilder customLineItem( final com.commercetools.history.models.common.LocalizedString customLineItem) {
    ...
    public SetCustomLineItemTaxCategoryChangeBuilder nextValue(Function<com.commercetools.history.models.common.ReferenceBuilder, com.commercetools.history.models.common.ReferenceBuilder> builder) {
    ...
    public SetCustomLineItemTaxCategoryChangeBuilder withNextValue(Function<com.commercetools.history.models.common.ReferenceBuilder, com.commercetools.history.models.common.Reference> builder) {
    ...
    public SetCustomLineItemTaxCategoryChangeBuilder nextValue( final com.commercetools.history.models.common.Reference nextValue) {
    ...
    public SetCustomLineItemTaxCategoryChangeBuilder previousValue(Function<com.commercetools.history.models.common.ReferenceBuilder, com.commercetools.history.models.common.ReferenceBuilder> builder) {
    ...
    public SetCustomLineItemTaxCategoryChangeBuilder withPreviousValue(Function<com.commercetools.history.models.common.ReferenceBuilder, com.commercetools.history.models.common.Reference> builder) {
    ...
    public SetCustomLineItemTaxCategoryChangeBuilder previousValue( final com.commercetools.history.models.common.Reference previousValue) {
    ...
    public SetCustomLineItemTaxCategoryChange build() {
        ...
        Objects.requireNonNull(customLineItem, SetCustomLineItemTaxCategoryChange.class + ": customLineItem is missing");
        Objects.requireNonNull(customLineItemId, SetCustomLineItemTaxCategoryChange.class + ": customLineItemId is missing");
        ...
        return new SetCustomLineItemTaxCategoryChangeImpl(change, customLineItem, customLineItemId, nextValue, previousValue);
    }
