...
public interface SetCustomLineItemTaxRateChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetCustomLineItemTaxRateChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetCustomLineItemTaxRateChange>() {
            @Override
