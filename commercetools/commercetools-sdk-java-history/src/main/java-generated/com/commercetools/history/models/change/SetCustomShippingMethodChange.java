...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:StagedOrderSetCustomShippingMethodAction" rel="nofollow">Set Custom ShippingMethod</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetCustomShippingMethodChange")
...
public interface SetCustomShippingMethodChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetCustomShippingMethodChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetCustomShippingMethodChange>() {
            @Override
