...
public interface SetCustomerEmailChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetCustomerEmailChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetCustomerEmailChange>() {
            @Override
