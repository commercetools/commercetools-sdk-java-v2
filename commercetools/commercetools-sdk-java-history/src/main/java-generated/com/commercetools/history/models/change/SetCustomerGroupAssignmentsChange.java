...
public interface SetCustomerGroupAssignmentsChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetCustomerGroupAssignmentsChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetCustomerGroupAssignmentsChange>() {
            @Override
