...
public class SetCustomerGroupChangeImpl implements SetCustomerGroupChange, ModelBase {
     ...
     */
    @JsonCreator
    SetCustomerGroupChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final com.commercetools.history.models.common.Reference previousValue, @JsonProperty("nextValue") final com.commercetools.history.models.common.Reference nextValue) {
        this.change = change;
    ...
    public boolean equals(Object o) {
        ...
        SetCustomerGroupChangeImpl that = (SetCustomerGroupChangeImpl) o;
