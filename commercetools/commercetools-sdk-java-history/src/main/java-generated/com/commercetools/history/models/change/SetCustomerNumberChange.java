...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:CustomerSetCustomerNumberAction" rel="nofollow">Set Customer Number</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetCustomerNumberChange")
...
public interface SetCustomerNumberChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetCustomerNumberChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetCustomerNumberChange>() {
            @Override
