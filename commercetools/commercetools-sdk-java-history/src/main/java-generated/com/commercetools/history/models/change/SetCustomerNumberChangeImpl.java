...
public class SetCustomerNumberChangeImpl implements SetCustomerNumberChange, ModelBase {
     ...
     */
    @JsonCreator
    SetCustomerNumberChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final String previousValue, @JsonProperty("nextValue") final String nextValue) {
        this.change = change;
    ...
    public boolean equals(Object o) {
        ...
        SetCustomerNumberChangeImpl that = (SetCustomerNumberChangeImpl) o;
