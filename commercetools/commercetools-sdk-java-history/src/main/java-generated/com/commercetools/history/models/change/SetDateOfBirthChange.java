...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:CustomerSetDateOfBirthAction" rel="nofollow">Set Date of Birth</a> update action.</p>
 *
 * <hr>
...
public interface SetDateOfBirthChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetDateOfBirthChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetDateOfBirthChange>() {
            @Override
