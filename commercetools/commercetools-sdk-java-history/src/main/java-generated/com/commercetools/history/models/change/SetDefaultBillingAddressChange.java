 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetDefaultBillingAddressChange")
...
public interface SetDefaultBillingAddressChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetDefaultBillingAddressChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetDefaultBillingAddressChange>() {
            @Override
