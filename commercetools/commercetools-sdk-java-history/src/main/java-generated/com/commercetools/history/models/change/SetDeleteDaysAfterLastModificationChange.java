...
public interface SetDeleteDaysAfterLastModificationChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetDeleteDaysAfterLastModificationChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetDeleteDaysAfterLastModificationChange>() {
            @Override
