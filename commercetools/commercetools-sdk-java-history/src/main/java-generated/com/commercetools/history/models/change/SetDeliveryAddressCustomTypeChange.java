...
public interface SetDeliveryAddressCustomTypeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetDeliveryAddressCustomTypeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetDeliveryAddressCustomTypeChange>() {
            @Override
