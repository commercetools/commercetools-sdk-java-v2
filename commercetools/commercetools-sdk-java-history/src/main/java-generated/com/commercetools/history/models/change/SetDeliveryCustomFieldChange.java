...
public interface SetDeliveryCustomFieldChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetDeliveryCustomFieldChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetDeliveryCustomFieldChange>() {
            @Override
