...
public class SetDeliveryCustomFieldChangeImpl implements SetDeliveryCustomFieldChange, ModelBase {
     ...
     */
    @JsonCreator
    SetDeliveryCustomFieldChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("deliveryId") final String deliveryId, @JsonProperty("name") final String name,
        ...
        this.type = SET_DELIVERY_CUSTOM_FIELD_CHANGE;
    }

    /**
     * create empty instance
     */
    public SetDeliveryCustomFieldChangeImpl() {
        this.type = SET_DELIVERY_CUSTOM_FIELD_CHANGE;
    }
    ...
    public boolean equals(Object o) {
        ...
        SetDeliveryCustomFieldChangeImpl that = (SetDeliveryCustomFieldChangeImpl) o;
    ...
    public SetDeliveryCustomFieldChange copyDeep() {
        return SetDeliveryCustomFieldChange.deepCopy(this);
    }
}
