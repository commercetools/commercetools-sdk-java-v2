...
public interface SetDeliveryCustomTypeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetDeliveryCustomTypeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetDeliveryCustomTypeChange>() {
            @Override
