 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetDescriptionChange")
...
public interface SetDescriptionChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetDescriptionChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetDescriptionChange>() {
            @Override
