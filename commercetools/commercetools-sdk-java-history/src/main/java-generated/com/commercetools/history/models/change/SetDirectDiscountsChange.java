...
public interface SetDirectDiscountsChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetDirectDiscountsChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetDirectDiscountsChange>() {
            @Override
