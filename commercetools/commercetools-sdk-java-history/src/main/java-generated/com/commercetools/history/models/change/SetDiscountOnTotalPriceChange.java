...
public interface SetDiscountOnTotalPriceChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetDiscountOnTotalPriceChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetDiscountOnTotalPriceChange>() {
            @Override
