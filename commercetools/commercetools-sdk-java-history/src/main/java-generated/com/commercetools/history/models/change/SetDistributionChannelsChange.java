...
public interface SetDistributionChannelsChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetDistributionChannelsChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetDistributionChannelsChange>() {
            @Override
