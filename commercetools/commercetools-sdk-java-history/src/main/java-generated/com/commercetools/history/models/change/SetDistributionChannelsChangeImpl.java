...
public class SetDistributionChannelsChangeImpl implements SetDistributionChannelsChange, ModelBase {
     ...
     */
    @JsonCreator
    SetDistributionChannelsChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final java.util.List<com.commercetools.history.models.common.Reference> previousValue, @JsonProperty("nextValue") final java.util.List<com.commercetools.history.models.common.Reference> nextValue) {
        this.change = change;
    ...
    public boolean equals(Object o) {
        ...
        SetDistributionChannelsChangeImpl that = (SetDistributionChannelsChangeImpl) o;
