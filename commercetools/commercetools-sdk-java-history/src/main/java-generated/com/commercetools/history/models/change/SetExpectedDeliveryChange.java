...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:InventoryEntrySetExpectedDeliveryAction" rel="nofollow">Set ExpectedDelivery</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetExpectedDeliveryChange")
...
public interface SetExpectedDeliveryChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetExpectedDeliveryChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetExpectedDeliveryChange>() {
            @Override
