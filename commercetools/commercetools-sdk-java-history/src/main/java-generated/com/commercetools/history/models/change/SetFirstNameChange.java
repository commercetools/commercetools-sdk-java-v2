...
public interface SetFirstNameChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetFirstNameChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetFirstNameChange>() {
            @Override
