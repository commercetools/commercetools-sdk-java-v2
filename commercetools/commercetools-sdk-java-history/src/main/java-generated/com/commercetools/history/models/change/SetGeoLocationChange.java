...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:ChannelSetGeoLocationAction" rel="nofollow">Set GeoLocation</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetGeoLocationChange")
...
public interface SetGeoLocationChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetGeoLocationChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetGeoLocationChange>() {
            @Override
