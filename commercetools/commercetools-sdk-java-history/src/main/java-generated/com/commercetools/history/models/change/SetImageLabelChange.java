...
public interface SetImageLabelChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetImageLabelChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetImageLabelChange>() {
            @Override
