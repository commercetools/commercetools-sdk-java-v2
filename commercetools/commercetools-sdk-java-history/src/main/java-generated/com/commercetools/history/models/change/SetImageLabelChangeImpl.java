...
public class SetImageLabelChangeImpl implements SetImageLabelChange, ModelBase {
     ...
     */
    @JsonCreator
    SetImageLabelChangeImpl(@JsonProperty("change") final String change, @JsonProperty("catalogData") final String catalogData, @JsonProperty("previousValue") final com.commercetools.history.models.common.Image previousValue, @JsonProperty("nextValue") final com.commercetools.history.models.common.Image nextValue) {
        this.change = change;
