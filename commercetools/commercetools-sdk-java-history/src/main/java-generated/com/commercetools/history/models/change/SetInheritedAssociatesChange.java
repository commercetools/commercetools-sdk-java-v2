...
public interface SetInheritedAssociatesChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetInheritedAssociatesChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetInheritedAssociatesChange>() {
            @Override
