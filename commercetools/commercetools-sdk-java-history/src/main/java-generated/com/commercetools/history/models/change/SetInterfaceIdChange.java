...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:PaymentSetInterfaceIdAction" rel="nofollow">Set InterfaceId</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetInterfaceIdChange")
...
public interface SetInterfaceIdChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetInterfaceIdChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetInterfaceIdChange>() {
            @Override
