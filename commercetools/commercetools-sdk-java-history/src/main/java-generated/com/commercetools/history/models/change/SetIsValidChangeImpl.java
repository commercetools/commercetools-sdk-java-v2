...
public class SetIsValidChangeImpl implements SetIsValidChange, ModelBase {
     ...
     */
    @JsonCreator
    SetIsValidChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final Boolean previousValue, @JsonProperty("nextValue") final Boolean nextValue) {
        this.change = change;
