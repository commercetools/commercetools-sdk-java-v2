...
public interface SetItemShippingAddressCustomTypeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetItemShippingAddressCustomTypeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetItemShippingAddressCustomTypeChange>() {
            @Override
