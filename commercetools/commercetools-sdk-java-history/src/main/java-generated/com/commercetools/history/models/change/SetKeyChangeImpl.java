...
public class SetKeyChangeImpl implements SetKeyChange, ModelBase {
     ...
     */
    @JsonCreator
    SetKeyChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final String previousValue, @JsonProperty("nextValue") final String nextValue) {
        this.change = change;
