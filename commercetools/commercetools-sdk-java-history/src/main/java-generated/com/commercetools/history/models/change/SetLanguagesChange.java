...
/**
 *  <p>Change triggered by <a href="https://docs.commercetools.com/apis/ctp:api:type:StoreSetLanguagesAction" rel="nofollow">Set Languages</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetLanguagesChange")
...
public interface SetLanguagesChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetLanguagesChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetLanguagesChange>() {
            @Override
