...
public class SetLanguagesChangeImpl implements SetLanguagesChange, ModelBase {
     ...
     */
    @JsonCreator
    SetLanguagesChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final java.util.List<String> previousValue, @JsonProperty("nextValue") final java.util.List<String> nextValue) {
        this.change = change;
