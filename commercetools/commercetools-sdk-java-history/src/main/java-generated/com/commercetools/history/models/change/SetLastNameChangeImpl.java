...
public class SetLastNameChangeImpl implements SetLastNameChange, ModelBase {
     ...
     */
    @JsonCreator
    SetLastNameChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final String previousValue, @JsonProperty("nextValue") final String nextValue) {
        this.change = change;
