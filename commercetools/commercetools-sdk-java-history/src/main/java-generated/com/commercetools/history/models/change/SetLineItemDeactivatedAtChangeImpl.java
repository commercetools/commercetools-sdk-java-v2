...
public class SetLineItemDeactivatedAtChangeImpl implements SetLineItemDeactivatedAtChange, ModelBase {
     ...
     */
    @JsonCreator
    SetLineItemDeactivatedAtChangeImpl(@JsonProperty("change") final String change, @JsonProperty("lineItem") final com.commercetools.history.models.change_value.ShoppingListLineItemValue lineItem, @JsonProperty("previousValue") final String previousValue, @JsonProperty("nextValue") final String nextValue) {
        this.change = change;
