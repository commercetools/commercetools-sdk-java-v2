...
import com.commercetools.history.models.change.SetLineItemDiscountedPricePerQuantityChangeImpl;
...
public interface SetLineItemDiscountedPricePerQuantityChange extends Change {
     ...
     */
    public static SetLineItemDiscountedPricePerQuantityChange of(final SetLineItemDiscountedPricePerQuantityChange template) {
     ...
     */
    @Nullable
    public static SetLineItemDiscountedPricePerQuantityChange deepCopy(@Nullable final SetLineItemDiscountedPricePerQuantityChange template) {
        if (template == null) {
            return null;
        }
        SetLineItemDiscountedPricePerQuantityChangeImpl instance = new SetLineItemDiscountedPricePerQuantityChangeImpl();
        ...
        instance.setVariant(template.getVariant());
        instance.setNextValue(com.commercetools.history.models.common.DiscountedLineItemPriceForQuantity.deepCopy(template.getNextValue()));
        instance.setPreviousValue(com.commercetools.history.models.common.DiscountedLineItemPriceForQuantity.deepCopy(template.getPreviousValue()));
        return instance;
    }
     ...
     * @return builder
     */
    public static SetLineItemDiscountedPricePerQuantityChangeBuilder builder(final SetLineItemDiscountedPricePerQuantityChange template) {
     ...
     * @return mapped value
     */
    default <T> T withSetLineItemDiscountedPricePerQuantityChange(Function<SetLineItemDiscountedPricePerQuantityChange, T> helper) {
