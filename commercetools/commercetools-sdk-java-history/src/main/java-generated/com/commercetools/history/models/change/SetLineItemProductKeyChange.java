...
public interface SetLineItemProductKeyChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetLineItemProductKeyChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetLineItemProductKeyChange>() {
            @Override
