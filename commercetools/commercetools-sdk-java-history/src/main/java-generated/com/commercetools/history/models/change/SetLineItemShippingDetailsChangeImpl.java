...
public class SetLineItemShippingDetailsChangeImpl implements SetLineItemShippingDetailsChange, ModelBase {
     ...
     */
    @JsonCreator
    SetLineItemShippingDetailsChangeImpl(@JsonProperty("change") final String change, @JsonProperty("lineItemId") final String lineItemId, @JsonProperty("nextValue") final com.commercetools.history.models.common.ItemShippingDetails nextValue, @JsonProperty("previousValue") final com.commercetools.history.models.common.ItemShippingDetails previousValue) {
        this.change = change;
