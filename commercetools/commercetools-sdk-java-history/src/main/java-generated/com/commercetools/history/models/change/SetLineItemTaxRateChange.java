...
public interface SetLineItemTaxRateChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetLineItemTaxRateChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetLineItemTaxRateChange>() {
            @Override
