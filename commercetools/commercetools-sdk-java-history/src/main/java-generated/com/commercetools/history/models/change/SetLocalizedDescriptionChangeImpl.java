...
public class SetLocalizedDescriptionChangeImpl implements SetLocalizedDescriptionChange, ModelBase {
     ...
     */
    @JsonCreator
    SetLocalizedDescriptionChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final com.commercetools.history.models.common.LocalizedString previousValue, @JsonProperty("nextValue") final com.commercetools.history.models.common.LocalizedString nextValue) {
        this.change = change;
