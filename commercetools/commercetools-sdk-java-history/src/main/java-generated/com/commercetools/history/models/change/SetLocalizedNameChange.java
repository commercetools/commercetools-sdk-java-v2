...
public interface SetLocalizedNameChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetLocalizedNameChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetLocalizedNameChange>() {
            @Override
