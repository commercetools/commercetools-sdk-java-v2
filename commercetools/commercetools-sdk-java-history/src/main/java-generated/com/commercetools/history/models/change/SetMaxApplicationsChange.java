...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:DiscountCodeSetMaxApplicationsAction" rel="nofollow">Set Max Applications</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetMaxApplicationsChange")
...
public interface SetMaxApplicationsChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetMaxApplicationsChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetMaxApplicationsChange>() {
            @Override
