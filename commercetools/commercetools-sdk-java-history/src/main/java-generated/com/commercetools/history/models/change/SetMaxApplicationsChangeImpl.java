...
public class SetMaxApplicationsChangeImpl implements SetMaxApplicationsChange, ModelBase {
     ...
     */
    @JsonCreator
    SetMaxApplicationsChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final Integer previousValue, @JsonProperty("nextValue") final Integer nextValue) {
        this.change = change;
