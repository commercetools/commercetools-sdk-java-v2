...
import com.commercetools.history.models.change.SetMaxApplicationsPerCustomerChangeImpl;
...
public interface SetMaxApplicationsPerCustomerChange extends Change {
     ...
     */
    @Nullable
    public static SetMaxApplicationsPerCustomerChange deepCopy(@Nullable final SetMaxApplicationsPerCustomerChange template) {
        if (template == null) {
            return null;
        }
        SetMaxApplicationsPerCustomerChangeImpl instance = new SetMaxApplicationsPerCustomerChangeImpl();
     ...
     * @return builder
     */
    public static SetMaxApplicationsPerCustomerChangeBuilder builder(final SetMaxApplicationsPerCustomerChange template) {
