 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetMaxApplicationsPerCustomerChange")
...
public interface SetMaxApplicationsPerCustomerChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetMaxApplicationsPerCustomerChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetMaxApplicationsPerCustomerChange>() {
            @Override
