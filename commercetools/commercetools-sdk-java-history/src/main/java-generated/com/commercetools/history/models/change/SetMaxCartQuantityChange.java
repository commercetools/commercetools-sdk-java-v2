...
public interface SetMaxCartQuantityChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetMaxCartQuantityChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetMaxCartQuantityChange>() {
            @Override
