...
public interface SetMetaDescriptionChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetMetaDescriptionChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetMetaDescriptionChange>() {
            @Override
