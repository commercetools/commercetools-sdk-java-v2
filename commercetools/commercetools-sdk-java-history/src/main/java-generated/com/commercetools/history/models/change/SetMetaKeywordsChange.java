 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetMetaKeywordsChange")
...
public interface SetMetaKeywordsChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetMetaKeywordsChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetMetaKeywordsChange>() {
            @Override
