...
public class SetMetaKeywordsChangeImpl implements SetMetaKeywordsChange, ModelBase {
     ...
     */
    @JsonCreator
    SetMetaKeywordsChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final com.commercetools.history.models.common.LocalizedString previousValue, @JsonProperty("nextValue") final com.commercetools.history.models.common.LocalizedString nextValue) {
        this.change = change;
    ...
    public boolean equals(Object o) {
        ...
        SetMetaKeywordsChangeImpl that = (SetMetaKeywordsChangeImpl) o;
