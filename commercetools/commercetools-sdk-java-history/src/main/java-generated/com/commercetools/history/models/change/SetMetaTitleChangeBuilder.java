...
public class SetMetaTitleChangeBuilder implements Builder<SetMetaTitleChange> {
    ...
    public SetMetaTitleChangeBuilder catalogData(final String catalogData) {
    ...
    public SetMetaTitleChange build() {
        ...
        Objects.requireNonNull(catalogData, SetMetaTitleChange.class + ": catalogData is missing");
        return new SetMetaTitleChangeImpl(change, previousValue, nextValue, catalogData);
    }
