...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:PaymentSetMethodInfoInterfaceAction" rel="nofollow">Set MethodInfoInterface</a> update action.</p>
 *
 * <hr>
...
public interface SetMethodInfoInterfaceChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetMethodInfoInterfaceChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetMethodInfoInterfaceChange>() {
            @Override
