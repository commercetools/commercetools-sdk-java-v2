...
public class SetMethodInfoInterfaceChangeImpl implements SetMethodInfoInterfaceChange, ModelBase {
     ...
     */
    @JsonCreator
    SetMethodInfoInterfaceChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final String previousValue, @JsonProperty("nextValue") final String nextValue) {
        this.change = change;
    ...
    public boolean equals(Object o) {
        ...
        SetMethodInfoInterfaceChangeImpl that = (SetMethodInfoInterfaceChangeImpl) o;
