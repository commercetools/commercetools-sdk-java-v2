...
public interface SetMethodInfoMethodChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetMethodInfoMethodChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetMethodInfoMethodChange>() {
            @Override
