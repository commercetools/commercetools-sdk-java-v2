...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:PaymentSetMethodInfoNameAction" rel="nofollow">Set MethodInfoName</a> update action.</p>
 *
 * <hr>
...
public interface SetMethodInfoNameChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetMethodInfoNameChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetMethodInfoNameChange>() {
            @Override
