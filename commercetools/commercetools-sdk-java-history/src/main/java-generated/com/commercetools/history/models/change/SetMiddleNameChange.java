...
public interface SetMiddleNameChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetMiddleNameChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetMiddleNameChange>() {
            @Override
