...
public interface SetMinCartQuantityChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetMinCartQuantityChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetMinCartQuantityChange>() {
            @Override
