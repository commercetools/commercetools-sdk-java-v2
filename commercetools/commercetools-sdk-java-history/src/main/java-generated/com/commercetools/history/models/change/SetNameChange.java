...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:AssociateRoleSetNameAction" rel="nofollow">Set Name</a> update action.</p>
 *
 * <hr>
...
public interface SetNameChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetNameChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetNameChange>() {
            @Override
