...
public class SetOrderTaxedPriceChangeImpl implements SetOrderTaxedPriceChange, ModelBase {
     ...
     */
    @JsonCreator
    SetOrderTaxedPriceChangeImpl(@JsonProperty("change") final String change, @JsonProperty("taxMode") final com.commercetools.history.models.common.TaxMode taxMode, @JsonProperty("nextValue") final com.commercetools.history.models.common.TaxedItemPrice nextValue, @JsonProperty("previousValue") final com.commercetools.history.models.common.TaxedItemPrice previousValue) {
        this.change = change;
