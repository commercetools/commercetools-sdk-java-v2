...
public interface SetOrderTotalPriceChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetOrderTotalPriceChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetOrderTotalPriceChange>() {
            @Override
