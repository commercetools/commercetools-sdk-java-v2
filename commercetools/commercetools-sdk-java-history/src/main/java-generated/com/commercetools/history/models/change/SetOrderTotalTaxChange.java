...
public interface SetOrderTotalTaxChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetOrderTotalTaxChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetOrderTotalTaxChange>() {
            @Override
