...
public interface SetParcelCustomFieldChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetParcelCustomFieldChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetParcelCustomFieldChange>() {
            @Override
