...
public interface SetParcelCustomTypeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetParcelCustomTypeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetParcelCustomTypeChange>() {
            @Override
