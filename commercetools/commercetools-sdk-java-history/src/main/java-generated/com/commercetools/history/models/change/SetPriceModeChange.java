...
public interface SetPriceModeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetPriceModeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetPriceModeChange>() {
            @Override
