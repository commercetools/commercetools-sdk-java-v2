...
public interface SetProductAttributeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetProductAttributeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetProductAttributeChange>() {
            @Override
