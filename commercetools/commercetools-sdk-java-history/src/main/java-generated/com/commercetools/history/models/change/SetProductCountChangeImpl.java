...
public class SetProductCountChangeImpl implements SetProductCountChange, ModelBase {
     ...
     */
    @JsonCreator
    SetProductCountChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final Integer previousValue, @JsonProperty("nextValue") final Integer nextValue) {
        this.change = change;
