...
public class SetProductSelectionsChangeImpl implements SetProductSelectionsChange, ModelBase {
    ...
    SetProductSelectionsChangeImpl(@JsonProperty("change") final String change,
            ...
            @JsonProperty("addedItems") final java.util.List<com.commercetools.history.models.common.ProductSelectionSetting> addedItems,
            @JsonProperty("removedItems") final java.util.List<com.commercetools.history.models.common.ProductSelectionSetting> removedItems) {
        this.change = change;
    ...
    public void setAddedItems(final com.commercetools.history.models.common.ProductSelectionSetting... addedItems) {
    ...
    public void setRemovedItems(final com.commercetools.history.models.common.ProductSelectionSetting... removedItems) {
