...
public class SetProductVariantKeyChangeImpl implements SetProductVariantKeyChange, ModelBase {
     ...
     */
    @JsonCreator
    SetProductVariantKeyChangeImpl(@JsonProperty("change") final String change, @JsonProperty("catalogData") final String catalogData, @JsonProperty("previousValue") final String previousValue, @JsonProperty("nextValue") final String nextValue) {
        this.change = change;
