...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:endpoint:/{projectKey}/custom-objects:POST" rel="nofollow">Update CustomObject</a> request when an existing property is updated.</p>
 *
 * <hr>
...
public interface SetPropertyChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetPropertyChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetPropertyChange>() {
            @Override
