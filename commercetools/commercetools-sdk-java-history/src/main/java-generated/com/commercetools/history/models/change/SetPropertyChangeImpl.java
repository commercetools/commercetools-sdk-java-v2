...
public class SetPropertyChangeImpl implements SetPropertyChange, ModelBase {
     ...
     */
    @JsonCreator
    SetPropertyChangeImpl(@JsonProperty("change") final String change, @JsonProperty("path") final String path, @JsonProperty("nextValue") final java.lang.Object nextValue, @JsonProperty("previousValue") final java.lang.Object previousValue) {
        this.change = change;
        this.path = path;
