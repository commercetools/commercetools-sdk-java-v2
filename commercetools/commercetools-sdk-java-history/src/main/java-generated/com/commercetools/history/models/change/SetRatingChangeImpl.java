...
public class SetRatingChangeImpl implements SetRatingChange, ModelBase {
     ...
     */
    @JsonCreator
    SetRatingChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final Integer previousValue, @JsonProperty("nextValue") final Integer nextValue) {
        this.change = change;
