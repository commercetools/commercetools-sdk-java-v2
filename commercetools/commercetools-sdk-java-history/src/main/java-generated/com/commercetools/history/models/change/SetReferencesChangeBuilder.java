...
public class SetReferencesChangeBuilder implements Builder<SetReferencesChange> {
    ...
    public SetReferencesChangeBuilder change(final String change) {
        this.change = change;
        return this;
    }
    ...
    public SetReferencesChangeBuilder addedItems(
    ...
    public SetReferencesChangeBuilder plusAddedItems(
            final com.commercetools.history.models.common.Reference... addedItems) {
    ...
    public SetReferencesChangeBuilder withAddedItems(
            Function<com.commercetools.history.models.common.ReferenceBuilder, Builder<? extends com.commercetools.history.models.common.Reference>> builder) {
        this.addedItems = new ArrayList<>();
        this.addedItems.add(builder.apply(com.commercetools.history.models.common.ReferenceBuilder.of()).build());
        return this;
    ...
    public SetReferencesChangeBuilder removedItems(
    ...
    public SetReferencesChangeBuilder plusRemovedItems(
            final com.commercetools.history.models.common.Reference... removedItems) {
    ...
    public SetReferencesChangeBuilder withRemovedItems(
            Function<com.commercetools.history.models.common.ReferenceBuilder, Builder<? extends com.commercetools.history.models.common.Reference>> builder) {
        this.removedItems = new ArrayList<>();
        this.removedItems.add(builder.apply(com.commercetools.history.models.common.ReferenceBuilder.of()).build());
        return this;
    ...
    public SetReferencesChangeBuilder previousValue(
    ...
    public SetReferencesChangeBuilder plusPreviousValue(
            final com.commercetools.history.models.common.Reference... previousValue) {
    ...
    public SetReferencesChangeBuilder withPreviousValue(
            Function<com.commercetools.history.models.common.ReferenceBuilder, Builder<? extends com.commercetools.history.models.common.Reference>> builder) {
        this.previousValue = new ArrayList<>();
        this.previousValue.add(builder.apply(com.commercetools.history.models.common.ReferenceBuilder.of()).build());
        return this;
    ...
    public SetReferencesChangeBuilder nextValue(final com.commercetools.history.models.common.Reference... nextValue) {
    ...
    public SetReferencesChangeBuilder nextValue(
    ...
    public SetReferencesChangeBuilder plusNextValue(
    ...
    public SetReferencesChangeBuilder withNextValue(
            Function<com.commercetools.history.models.common.ReferenceBuilder, Builder<? extends com.commercetools.history.models.common.Reference>> builder) {
        this.nextValue = new ArrayList<>();
        this.nextValue.add(builder.apply(com.commercetools.history.models.common.ReferenceBuilder.of()).build());
        return this;
    ...
    /**
     * builds SetReferencesChange with checking for non-null required values
     * @return SetReferencesChange
     */
    public SetReferencesChange build() {
        Objects.requireNonNull(change, SetReferencesChange.class + ": change is missing");
        Objects.requireNonNull(addedItems, SetReferencesChange.class + ": addedItems is missing");
        Objects.requireNonNull(removedItems, SetReferencesChange.class + ": removedItems is missing");
        Objects.requireNonNull(previousValue, SetReferencesChange.class + ": previousValue is missing");
        Objects.requireNonNull(nextValue, SetReferencesChange.class + ": nextValue is missing");
        return new SetReferencesChangeImpl(change, addedItems, removedItems, previousValue, nextValue);
    }

    /**
     * builds SetReferencesChange without checking for non-null required values
     * @return SetReferencesChange
     */
    public SetReferencesChange buildUnchecked() {
        return new SetReferencesChangeImpl(change, addedItems, removedItems, previousValue, nextValue);
    }

    /**
     * factory method for an instance of SetReferencesChangeBuilder
     * @return builder
     */
    public static SetReferencesChangeBuilder of() {
        return new SetReferencesChangeBuilder();
    }

    /**
     * create builder for SetReferencesChange instance
     * @param template instance with prefilled values for the builder
     * @return builder
     */
    public static SetReferencesChangeBuilder of(final SetReferencesChange template) {
        SetReferencesChangeBuilder builder = new SetReferencesChangeBuilder();
