...
public class SetReferencesChangeImpl implements SetReferencesChange, ModelBase {
     ...
     */
    @JsonCreator
    SetReferencesChangeImpl(@JsonProperty("change") final String change,
        ...
        this.type = SET_REFERENCES_CHANGE;
    }

    /**
     * create empty instance
     */
    public SetReferencesChangeImpl() {
        this.type = SET_REFERENCES_CHANGE;
    }
    ...
    public boolean equals(Object o) {
        ...
        SetReferencesChangeImpl that = (SetReferencesChangeImpl) o;
    ...
    public SetReferencesChange copyDeep() {
        return SetReferencesChange.deepCopy(this);
    }
}
