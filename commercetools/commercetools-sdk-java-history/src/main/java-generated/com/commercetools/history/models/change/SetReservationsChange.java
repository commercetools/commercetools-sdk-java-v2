...
import com.commercetools.history.models.change.SetReservationsChangeImpl;
...
public interface SetReservationsChange extends Change {
    ...
    public static SetReservationsChange deepCopy(@Nullable final SetReservationsChange template) {
        ...
        instance.setNextValue(Optional.ofNullable(template.getNextValue())
                .map(t -> t.stream().map(com.commercetools.history.models.common.Reservation::deepCopy).collect(Collectors.toList()))
                .orElse(null));
