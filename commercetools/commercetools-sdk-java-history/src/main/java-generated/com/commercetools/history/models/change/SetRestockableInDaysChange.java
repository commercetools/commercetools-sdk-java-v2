...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:InventoryEntrySetRestockableInDaysAction" rel="nofollow">Set RestockableInDays</a> update action.</p>
 *
 * <hr>
...
public interface SetRestockableInDaysChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetRestockableInDaysChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetRestockableInDaysChange>() {
            @Override
