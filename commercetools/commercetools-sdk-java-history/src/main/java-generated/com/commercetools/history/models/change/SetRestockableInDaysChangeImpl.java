...
public class SetRestockableInDaysChangeImpl implements SetRestockableInDaysChange, ModelBase {
     ...
     */
    @JsonCreator
    SetRestockableInDaysChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final Integer previousValue, @JsonProperty("nextValue") final Integer nextValue) {
        this.change = change;
