...
public interface SetReturnInfoChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetReturnInfoChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetReturnInfoChange>() {
            @Override
