...
public interface SetReturnItemCustomLineItemCustomTypeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetReturnItemCustomLineItemCustomTypeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetReturnItemCustomLineItemCustomTypeChange>() {
            @Override
