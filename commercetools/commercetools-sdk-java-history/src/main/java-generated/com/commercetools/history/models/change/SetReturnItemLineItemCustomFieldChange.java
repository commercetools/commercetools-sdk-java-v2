...
public interface SetReturnItemLineItemCustomFieldChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetReturnItemLineItemCustomFieldChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetReturnItemLineItemCustomFieldChange>() {
            @Override
