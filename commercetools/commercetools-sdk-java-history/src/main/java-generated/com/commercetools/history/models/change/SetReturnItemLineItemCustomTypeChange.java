...
public interface SetReturnItemLineItemCustomTypeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetReturnItemLineItemCustomTypeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetReturnItemLineItemCustomTypeChange>() {
            @Override
