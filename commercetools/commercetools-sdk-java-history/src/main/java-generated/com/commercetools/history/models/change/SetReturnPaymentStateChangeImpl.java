...
public class SetReturnPaymentStateChangeImpl implements SetReturnPaymentStateChange, ModelBase {
     ...
     */
    @JsonCreator
    SetReturnPaymentStateChangeImpl(@JsonProperty("change") final String change, @JsonProperty("nextValue") final com.commercetools.history.models.common.ReturnPaymentState nextValue, @JsonProperty("previousValue") final com.commercetools.history.models.common.ReturnPaymentState previousValue) {
        this.change = change;
