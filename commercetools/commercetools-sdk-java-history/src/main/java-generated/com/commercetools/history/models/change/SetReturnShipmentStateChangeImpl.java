...
public class SetReturnShipmentStateChangeImpl implements SetReturnShipmentStateChange, ModelBase {
     ...
     */
    @JsonCreator
    SetReturnShipmentStateChangeImpl(@JsonProperty("change") final String change, @JsonProperty("nextValue") final com.commercetools.history.models.common.ReturnShipmentState nextValue, @JsonProperty("previousValue") final com.commercetools.history.models.common.ReturnShipmentState previousValue) {
        this.change = change;
