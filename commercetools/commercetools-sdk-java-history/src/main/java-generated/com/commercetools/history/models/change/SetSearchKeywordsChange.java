...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:ProductSetSearchKeywordsAction" rel="nofollow">Set SearchKeywords</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetSearchKeywordsChange")
...
public interface SetSearchKeywordsChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetSearchKeywordsChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetSearchKeywordsChange>() {
            @Override
