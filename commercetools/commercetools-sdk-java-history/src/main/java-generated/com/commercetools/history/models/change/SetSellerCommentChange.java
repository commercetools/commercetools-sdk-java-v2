...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:StagedQuoteSetSellerCommentAction" rel="nofollow">Set Seller Comment</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetSellerCommentChange")
...
public interface SetSellerCommentChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetSellerCommentChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetSellerCommentChange>() {
            @Override
