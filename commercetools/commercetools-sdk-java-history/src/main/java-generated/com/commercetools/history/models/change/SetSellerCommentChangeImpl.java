...
public class SetSellerCommentChangeImpl implements SetSellerCommentChange, ModelBase {
     ...
     */
    @JsonCreator
    SetSellerCommentChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final String previousValue, @JsonProperty("nextValue") final String nextValue) {
        this.change = change;
    ...
    public boolean equals(Object o) {
        ...
        SetSellerCommentChangeImpl that = (SetSellerCommentChangeImpl) o;
