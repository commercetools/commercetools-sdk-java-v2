...
public class SetShippingAddressChangeImpl implements SetShippingAddressChange, ModelBase {
     ...
     */
    @JsonCreator
    SetShippingAddressChangeImpl(@JsonProperty("change") final String change, @JsonProperty("nextValue") final com.commercetools.history.models.common.Address nextValue, @JsonProperty("previousValue") final com.commercetools.history.models.common.Address previousValue) {
        this.change = change;
