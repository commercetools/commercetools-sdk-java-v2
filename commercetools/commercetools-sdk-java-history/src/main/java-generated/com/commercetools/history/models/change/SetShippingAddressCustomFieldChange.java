...
public interface SetShippingAddressCustomFieldChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetShippingAddressCustomFieldChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetShippingAddressCustomFieldChange>() {
            @Override
