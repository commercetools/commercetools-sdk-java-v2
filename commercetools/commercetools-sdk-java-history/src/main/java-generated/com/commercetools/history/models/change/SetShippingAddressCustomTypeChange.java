...
public interface SetShippingAddressCustomTypeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetShippingAddressCustomTypeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetShippingAddressCustomTypeChange>() {
            @Override
