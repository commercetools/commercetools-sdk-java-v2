...
public interface SetShippingCustomFieldChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetShippingCustomFieldChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetShippingCustomFieldChange>() {
            @Override
