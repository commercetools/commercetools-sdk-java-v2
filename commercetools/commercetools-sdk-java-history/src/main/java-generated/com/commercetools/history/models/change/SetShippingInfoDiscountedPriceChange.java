...
public interface SetShippingInfoDiscountedPriceChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetShippingInfoDiscountedPriceChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetShippingInfoDiscountedPriceChange>() {
            @Override
