...
public interface SetShippingInfoPriceChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetShippingInfoPriceChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetShippingInfoPriceChange>() {
            @Override
