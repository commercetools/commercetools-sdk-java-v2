...
import com.commercetools.history.models.change.SetShippingInfoTaxedPriceChangeImpl;
...
public interface SetShippingInfoTaxedPriceChange extends Change {
    ...
    public static SetShippingInfoTaxedPriceChange deepCopy(@Nullable final SetShippingInfoTaxedPriceChange template) {
        ...
        instance.setPreviousValue(com.commercetools.history.models.common.TaxedPrice.deepCopy(template.getPreviousValue()));
        return instance;
    }
