...
public class SetShippingInfoTaxedPriceChangeImpl implements SetShippingInfoTaxedPriceChange, ModelBase {
     ...
     */
    @JsonCreator
    SetShippingInfoTaxedPriceChangeImpl(@JsonProperty("change") final String change, @JsonProperty("nextValue") final com.commercetools.history.models.common.TaxedPrice nextValue, @JsonProperty("previousValue") final com.commercetools.history.models.common.TaxedPrice previousValue) {
        this.change = change;
