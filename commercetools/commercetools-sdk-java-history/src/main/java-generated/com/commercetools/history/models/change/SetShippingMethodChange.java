...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:StagedOrderSetShippingMethodAction" rel="nofollow">Set ShippingMethod</a> update action.</p>
 *
 * <hr>
...
public interface SetShippingMethodChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetShippingMethodChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetShippingMethodChange>() {
            @Override
