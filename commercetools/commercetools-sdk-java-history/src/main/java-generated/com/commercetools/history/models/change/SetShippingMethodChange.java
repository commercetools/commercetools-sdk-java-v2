...
import com.commercetools.history.models.change.SetShippingMethodChangeImpl;
...
public interface SetShippingMethodChange extends Change {
    ...
    public static SetShippingMethodChange deepCopy(@Nullable final SetShippingMethodChange template) {
        ...
        SetShippingMethodChangeImpl instance = new SetShippingMethodChangeImpl();
        instance.setChange(template.getChange());
        instance.setNextValue(com.commercetools.history.models.change_value.ShippingMethodChangeValue.deepCopy(template.getNextValue()));
        instance.setPreviousValue(com.commercetools.history.models.change_value.ShippingMethodChangeValue.deepCopy(template.getPreviousValue()));
        return instance;
    }
