...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:StagedOrderSetShippingMethodTaxAmountAction" rel="nofollow">Set ShippingMethod TaxAmount</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetShippingMethodTaxAmountChange")
...
public interface SetShippingMethodTaxAmountChange extends Change {
    ...
    public SetShippingMethodTaxAmountChange copyDeep();
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetShippingMethodTaxAmountChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetShippingMethodTaxAmountChange>() {
            @Override
