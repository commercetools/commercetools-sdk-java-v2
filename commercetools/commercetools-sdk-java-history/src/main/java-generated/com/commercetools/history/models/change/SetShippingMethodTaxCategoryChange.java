...
public interface SetShippingMethodTaxCategoryChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetShippingMethodTaxCategoryChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetShippingMethodTaxCategoryChange>() {
            @Override
