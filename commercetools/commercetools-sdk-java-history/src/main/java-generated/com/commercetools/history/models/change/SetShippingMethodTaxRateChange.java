...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:StagedOrderSetShippingMethodTaxRateAction" rel="nofollow">Set ShippingMethod TaxRate</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetShippingMethodTaxRateChange")
...
public interface SetShippingMethodTaxRateChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetShippingMethodTaxRateChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetShippingMethodTaxRateChange>() {
            @Override
