...
public class SetShippingMethodTaxRateChangeImpl implements SetShippingMethodTaxRateChange, ModelBase {
     ...
     */
    @JsonCreator
    SetShippingMethodTaxRateChangeImpl(@JsonProperty("change") final String change, @JsonProperty("taxMode") final com.commercetools.history.models.common.TaxMode taxMode, @JsonProperty("nextValue") final com.commercetools.history.models.common.TaxRate nextValue, @JsonProperty("previousValue") final com.commercetools.history.models.common.TaxRate previousValue) {
        this.change = change;
