...
public class SetShippingRateChangeImpl implements SetShippingRateChange, ModelBase {
     ...
     */
    @JsonCreator
    SetShippingRateChangeImpl(@JsonProperty("change") final String change, @JsonProperty("nextValue") final com.commercetools.history.models.common.Money nextValue, @JsonProperty("previousValue") final com.commercetools.history.models.common.Money previousValue) {
        this.change = change;
