...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:ShoppingListSetLineItemCustomTypeAction" rel="nofollow">Set ShoppingListLineItem Custom Type</a> update action.</p>
 *
 * <hr>
...
public interface SetShoppingListLineItemCustomTypeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetShoppingListLineItemCustomTypeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetShoppingListLineItemCustomTypeChange>() {
            @Override
