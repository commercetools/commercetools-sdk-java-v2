...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:ShoppingListSetSlugAction" rel="nofollow">Set Slug</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetSlugChange")
...
public interface SetSlugChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetSlugChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetSlugChange>() {
            @Override
