...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:PaymentSetStatusInterfaceCodeAction" rel="nofollow">Set StatusInterfaceCode</a> update action.</p>
 *
 * <hr>
...
public interface SetStatusInterfaceCodeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetStatusInterfaceCodeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetStatusInterfaceCodeChange>() {
            @Override
