...
public class SetStatusInterfaceCodeChangeImpl implements SetStatusInterfaceCodeChange, ModelBase {
     ...
     */
    @JsonCreator
    SetStatusInterfaceCodeChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final String previousValue, @JsonProperty("nextValue") final String nextValue) {
        this.change = change;
