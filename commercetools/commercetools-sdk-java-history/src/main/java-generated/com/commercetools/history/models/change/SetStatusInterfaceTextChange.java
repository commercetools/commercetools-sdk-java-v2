...
public interface SetStatusInterfaceTextChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetStatusInterfaceTextChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetStatusInterfaceTextChange>() {
            @Override
