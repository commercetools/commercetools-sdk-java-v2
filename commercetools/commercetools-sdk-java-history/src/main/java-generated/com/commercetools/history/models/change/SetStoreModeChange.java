...
public interface SetStoreModeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetStoreModeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetStoreModeChange>() {
            @Override
