...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:InventoryEntrySetSupplyChannelAction" rel="nofollow">Set SupplyChannel</a> update action.</p>
 *
 * <hr>
...
public interface SetSupplyChannelChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetSupplyChannelChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetSupplyChannelChange>() {
            @Override
