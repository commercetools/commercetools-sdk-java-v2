...
public class SetSupplyChannelChangeImpl implements SetSupplyChannelChange, ModelBase {
     ...
     */
    @JsonCreator
    SetSupplyChannelChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final com.commercetools.history.models.common.Reference previousValue, @JsonProperty("nextValue") final com.commercetools.history.models.common.Reference nextValue) {
        this.change = change;
