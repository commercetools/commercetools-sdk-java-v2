...
public class SetSupplyChannelsChangeImpl implements SetSupplyChannelsChange, ModelBase {
     ...
     */
    @JsonCreator
    SetSupplyChannelsChangeImpl(@JsonProperty("change") final String change, @JsonProperty("previousValue") final java.util.List<com.commercetools.history.models.common.Reference> previousValue, @JsonProperty("nextValue") final java.util.List<com.commercetools.history.models.common.Reference> nextValue) {
        this.change = change;
