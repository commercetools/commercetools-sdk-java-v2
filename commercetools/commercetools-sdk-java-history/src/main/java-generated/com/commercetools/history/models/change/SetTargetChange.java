 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetTargetChange")
...
public interface SetTargetChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetTargetChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetTargetChange>() {
            @Override
