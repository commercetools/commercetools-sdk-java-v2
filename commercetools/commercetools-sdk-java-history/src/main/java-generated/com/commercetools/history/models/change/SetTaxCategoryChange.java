...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:ProductSetTaxCategoryAction" rel="nofollow">Set TaxCategory</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetTaxCategoryChange")
...
public interface SetTaxCategoryChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetTaxCategoryChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetTaxCategoryChange>() {
            @Override
