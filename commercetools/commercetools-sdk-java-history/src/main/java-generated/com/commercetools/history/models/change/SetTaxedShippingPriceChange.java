...
public interface SetTaxedShippingPriceChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetTaxedShippingPriceChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetTaxedShippingPriceChange>() {
            @Override
