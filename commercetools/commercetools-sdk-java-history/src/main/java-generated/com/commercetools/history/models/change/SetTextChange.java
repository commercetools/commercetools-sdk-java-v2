...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:ReviewSetTextAction" rel="nofollow">Set Text</a> update action.</p>
 *
 * <hr>
...
public interface SetTextChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetTextChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetTextChange>() {
            @Override
