...
public interface SetTextLineItemCustomFieldChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetTextLineItemCustomFieldChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetTextLineItemCustomFieldChange>() {
            @Override
