...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:ShoppingListSetTextLineItemDescriptionAction" rel="nofollow">Set TextLineItem Description</a> update action.</p>
 *
 * <hr>
...
public interface SetTextLineItemDescriptionChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetTextLineItemDescriptionChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetTextLineItemDescriptionChange>() {
            @Override
