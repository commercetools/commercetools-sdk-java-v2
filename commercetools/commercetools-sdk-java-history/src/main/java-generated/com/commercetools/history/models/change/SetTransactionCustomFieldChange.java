...
public interface SetTransactionCustomFieldChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetTransactionCustomFieldChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetTransactionCustomFieldChange>() {
            @Override
