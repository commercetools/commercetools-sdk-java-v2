...
public interface SetTransactionCustomTypeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetTransactionCustomTypeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetTransactionCustomTypeChange>() {
            @Override
