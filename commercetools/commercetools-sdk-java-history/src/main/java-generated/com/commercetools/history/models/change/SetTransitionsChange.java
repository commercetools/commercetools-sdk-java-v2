...
public interface SetTransitionsChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetTransitionsChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetTransitionsChange>() {
            @Override
