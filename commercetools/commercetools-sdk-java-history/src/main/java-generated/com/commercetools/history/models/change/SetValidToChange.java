 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetValidToChange")
...
public interface SetValidToChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetValidToChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetValidToChange>() {
            @Override
