...
public interface SetVariantAvailabilityChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetVariantAvailabilityChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetVariantAvailabilityChange>() {
            @Override
