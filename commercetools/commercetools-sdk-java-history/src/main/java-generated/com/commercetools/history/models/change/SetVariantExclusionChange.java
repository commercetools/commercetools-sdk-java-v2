...
public interface SetVariantExclusionChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetVariantExclusionChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetVariantExclusionChange>() {
            @Override
