...
/**
 *  <p>Change triggered by the <a href="https://docs.commercetools.com/apis/ctp:api:type:CustomerSetVatIdAction" rel="nofollow">Set Vat ID</a> update action.</p>
 *
 * <hr>
 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("SetVatIdChange")
...
public interface SetVatIdChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetVatIdChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetVatIdChange>() {
            @Override
