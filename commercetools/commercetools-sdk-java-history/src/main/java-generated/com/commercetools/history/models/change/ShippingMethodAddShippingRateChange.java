...
public interface ShippingMethodAddShippingRateChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodAddShippingRateChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodAddShippingRateChange>() {
            @Override
