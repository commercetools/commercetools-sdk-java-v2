...
public interface ShippingMethodAddZoneChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodAddZoneChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodAddZoneChange>() {
            @Override
