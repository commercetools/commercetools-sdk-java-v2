...
public class ShippingMethodAddZoneChangeImpl implements ShippingMethodAddZoneChange, ModelBase {
     ...
     */
    @JsonCreator
    ShippingMethodAddZoneChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("nextValue") final com.commercetools.history.models.common.Reference nextValue) {
        this.change = change;
        this.nextValue = nextValue;
        this.type = SHIPPING_METHOD_ADD_ZONE_CHANGE;
    }

    /**
     * create empty instance
     */
    public ShippingMethodAddZoneChangeImpl() {
        this.type = SHIPPING_METHOD_ADD_ZONE_CHANGE;
    }
    ...
    public boolean equals(Object o) {
        ...
        ShippingMethodAddZoneChangeImpl that = (ShippingMethodAddZoneChangeImpl) o;
    ...
    public ShippingMethodAddZoneChange copyDeep() {
        return ShippingMethodAddZoneChange.deepCopy(this);
    }
}
