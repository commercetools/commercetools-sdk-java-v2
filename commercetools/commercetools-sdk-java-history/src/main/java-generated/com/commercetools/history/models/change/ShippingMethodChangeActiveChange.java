...
public interface ShippingMethodChangeActiveChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodChangeActiveChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodChangeActiveChange>() {
            @Override
