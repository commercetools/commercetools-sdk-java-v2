...
public class ShippingMethodChangeActiveChangeImpl implements ShippingMethodChangeActiveChange, ModelBase {
     ...
     */
    @JsonCreator
    ShippingMethodChangeActiveChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("previousValue") final Boolean previousValue,
            @JsonProperty("nextValue") final Boolean nextValue) {
        this.change = change;
        this.previousValue = previousValue;
        this.nextValue = nextValue;
        this.type = SHIPPING_METHOD_CHANGE_ACTIVE_CHANGE;
    }

    /**
     * create empty instance
     */
    public ShippingMethodChangeActiveChangeImpl() {
        this.type = SHIPPING_METHOD_CHANGE_ACTIVE_CHANGE;
    }
    ...
    public boolean equals(Object o) {
        ...
        ShippingMethodChangeActiveChangeImpl that = (ShippingMethodChangeActiveChangeImpl) o;
    ...
    public ShippingMethodChangeActiveChange copyDeep() {
        return ShippingMethodChangeActiveChange.deepCopy(this);
    }
}
