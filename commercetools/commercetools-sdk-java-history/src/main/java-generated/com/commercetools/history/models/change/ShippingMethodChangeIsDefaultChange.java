...
public interface ShippingMethodChangeIsDefaultChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodChangeIsDefaultChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodChangeIsDefaultChange>() {
            @Override
