...
public interface ShippingMethodChangeTaxCategoryChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodChangeTaxCategoryChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodChangeTaxCategoryChange>() {
            @Override
