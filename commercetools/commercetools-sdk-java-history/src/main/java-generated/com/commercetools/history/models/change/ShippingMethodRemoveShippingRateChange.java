...
public interface ShippingMethodRemoveShippingRateChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodRemoveShippingRateChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodRemoveShippingRateChange>() {
            @Override
