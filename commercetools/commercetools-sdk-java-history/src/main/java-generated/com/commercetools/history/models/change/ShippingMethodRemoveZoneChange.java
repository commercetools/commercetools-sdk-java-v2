...
public interface ShippingMethodRemoveZoneChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodRemoveZoneChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodRemoveZoneChange>() {
            @Override
