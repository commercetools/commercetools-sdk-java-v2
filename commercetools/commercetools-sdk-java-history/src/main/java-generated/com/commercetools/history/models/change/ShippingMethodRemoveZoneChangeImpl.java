...
public class ShippingMethodRemoveZoneChangeImpl implements ShippingMethodRemoveZoneChange, ModelBase {
     ...
     */
    @JsonCreator
    ShippingMethodRemoveZoneChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("previousValue") final com.commercetools.history.models.common.Reference previousValue) {
        this.change = change;
        this.previousValue = previousValue;
        this.type = SHIPPING_METHOD_REMOVE_ZONE_CHANGE;
    }

    /**
     * create empty instance
     */
    public ShippingMethodRemoveZoneChangeImpl() {
        this.type = SHIPPING_METHOD_REMOVE_ZONE_CHANGE;
    }
    ...
    public boolean equals(Object o) {
        ...
        ShippingMethodRemoveZoneChangeImpl that = (ShippingMethodRemoveZoneChangeImpl) o;
    ...
    public ShippingMethodRemoveZoneChange copyDeep() {
        return ShippingMethodRemoveZoneChange.deepCopy(this);
    }
}
