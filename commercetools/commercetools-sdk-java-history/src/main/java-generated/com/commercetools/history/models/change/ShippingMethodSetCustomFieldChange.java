...
public interface ShippingMethodSetCustomFieldChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodSetCustomFieldChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodSetCustomFieldChange>() {
            @Override
