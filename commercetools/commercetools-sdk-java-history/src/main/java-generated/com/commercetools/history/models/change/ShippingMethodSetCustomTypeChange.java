...
public interface ShippingMethodSetCustomTypeChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodSetCustomTypeChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodSetCustomTypeChange>() {
            @Override
