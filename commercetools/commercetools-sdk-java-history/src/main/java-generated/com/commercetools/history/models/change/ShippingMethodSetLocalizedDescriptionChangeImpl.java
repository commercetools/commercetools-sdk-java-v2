...
public class ShippingMethodSetLocalizedDescriptionChangeImpl
        implements ShippingMethodSetLocalizedDescriptionChange, ModelBase {
     ...
     */
    @JsonCreator
    ShippingMethodSetLocalizedDescriptionChangeImpl(@JsonProperty("change") final String change,
     ...
     */
    public ShippingMethodSetLocalizedDescriptionChangeImpl() {
        this.type = SHIPPING_METHOD_SET_LOCALIZED_DESCRIPTION_CHANGE;
    }
    ...
    public boolean equals(Object o) {
        ...
        ShippingMethodSetLocalizedDescriptionChangeImpl that = (ShippingMethodSetLocalizedDescriptionChangeImpl) o;
    ...
    public ShippingMethodSetLocalizedDescriptionChange copyDeep() {
        return ShippingMethodSetLocalizedDescriptionChange.deepCopy(this);
    }
}
