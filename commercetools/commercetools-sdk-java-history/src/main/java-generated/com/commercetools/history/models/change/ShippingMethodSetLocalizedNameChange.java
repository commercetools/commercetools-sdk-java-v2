...
public interface ShippingMethodSetLocalizedNameChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodSetLocalizedNameChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodSetLocalizedNameChange>() {
            @Override
