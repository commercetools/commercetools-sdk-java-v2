...
public interface ShippingMethodSetPredicateChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodSetPredicateChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodSetPredicateChange>() {
            @Override
