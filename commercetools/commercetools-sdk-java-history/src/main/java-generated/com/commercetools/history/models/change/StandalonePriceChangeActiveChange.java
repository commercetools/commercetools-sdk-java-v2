...
public interface StandalonePriceChangeActiveChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StandalonePriceChangeActiveChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<StandalonePriceChangeActiveChange>() {
            @Override
