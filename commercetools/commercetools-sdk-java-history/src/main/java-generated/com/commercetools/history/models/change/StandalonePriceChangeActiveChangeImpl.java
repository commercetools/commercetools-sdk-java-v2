...
public class StandalonePriceChangeActiveChangeImpl implements StandalonePriceChangeActiveChange, ModelBase {
     ...
     */
    @JsonCreator
    StandalonePriceChangeActiveChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("previousValue") final Boolean previousValue,
            @JsonProperty("nextValue") final Boolean nextValue) {
        this.change = change;
        this.previousValue = previousValue;
        this.nextValue = nextValue;
        this.type = STANDALONE_PRICE_CHANGE_ACTIVE_CHANGE;
    }

    /**
     * create empty instance
     */
    public StandalonePriceChangeActiveChangeImpl() {
        this.type = STANDALONE_PRICE_CHANGE_ACTIVE_CHANGE;
    }
    ...
    public boolean equals(Object o) {
        ...
        StandalonePriceChangeActiveChangeImpl that = (StandalonePriceChangeActiveChangeImpl) o;
    ...
    public StandalonePriceChangeActiveChange copyDeep() {
        return StandalonePriceChangeActiveChange.deepCopy(this);
    }
}
