...
public interface StandalonePriceSetCustomFieldChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StandalonePriceSetCustomFieldChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<StandalonePriceSetCustomFieldChange>() {
            @Override
