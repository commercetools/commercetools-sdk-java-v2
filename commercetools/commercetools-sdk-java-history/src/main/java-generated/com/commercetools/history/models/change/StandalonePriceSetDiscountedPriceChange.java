...
public interface StandalonePriceSetDiscountedPriceChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StandalonePriceSetDiscountedPriceChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<StandalonePriceSetDiscountedPriceChange>() {
            @Override
