...
public interface StandalonePriceSetKeyChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StandalonePriceSetKeyChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<StandalonePriceSetKeyChange>() {
            @Override
