...
public interface StandalonePriceSetPriceTiersChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StandalonePriceSetPriceTiersChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<StandalonePriceSetPriceTiersChange>() {
            @Override
