...
public class StandalonePriceSetValidFromAndUntilChangeImpl
        implements StandalonePriceSetValidFromAndUntilChange, ModelBase {
     ...
     */
    @JsonCreator
    StandalonePriceSetValidFromAndUntilChangeImpl(@JsonProperty("change") final String change,
            @JsonProperty("previousValue") final com.commercetools.history.models.change_value.ValidFromAndUntilValue previousValue,
            @JsonProperty("nextValue") final com.commercetools.history.models.change_value.ValidFromAndUntilValue nextValue) {
        this.change = change;
        this.previousValue = previousValue;
        this.nextValue = nextValue;
        this.type = STANDALONE_PRICE_SET_VALID_FROM_AND_UNTIL_CHANGE;
    }

    /**
     * create empty instance
     */
    public StandalonePriceSetValidFromAndUntilChangeImpl() {
        this.type = STANDALONE_PRICE_SET_VALID_FROM_AND_UNTIL_CHANGE;
    }
    ...
    public boolean equals(Object o) {
        ...
        StandalonePriceSetValidFromAndUntilChangeImpl that = (StandalonePriceSetValidFromAndUntilChangeImpl) o;
    ...
    public StandalonePriceSetValidFromAndUntilChange copyDeep() {
        return StandalonePriceSetValidFromAndUntilChange.deepCopy(this);
    }
}
