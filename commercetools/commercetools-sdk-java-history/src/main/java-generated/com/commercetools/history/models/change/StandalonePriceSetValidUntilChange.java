...
public interface StandalonePriceSetValidUntilChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StandalonePriceSetValidUntilChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<StandalonePriceSetValidUntilChange>() {
            @Override
