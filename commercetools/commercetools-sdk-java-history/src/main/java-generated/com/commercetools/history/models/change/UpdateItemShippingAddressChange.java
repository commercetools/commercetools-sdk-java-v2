...
public interface UpdateItemShippingAddressChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<UpdateItemShippingAddressChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<UpdateItemShippingAddressChange>() {
            @Override
