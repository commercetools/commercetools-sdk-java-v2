 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("UpdateSyncInfoChange")
...
public interface UpdateSyncInfoChange extends Change {
     ...
     */
    public static tools.jackson.core.type.TypeReference<UpdateSyncInfoChange> typeReference() {
        return new tools.jackson.core.type.TypeReference<UpdateSyncInfoChange>() {
            @Override
