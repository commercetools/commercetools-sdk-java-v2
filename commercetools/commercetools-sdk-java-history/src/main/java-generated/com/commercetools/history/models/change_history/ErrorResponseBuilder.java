...
import com.commercetools.history.models.change_history.ErrorResponse;
...
public class ErrorResponseBuilder implements Builder<ErrorResponse> {
    ...
    public ErrorResponseBuilder errors(@Nullable final com.commercetools.history.models.change_history.ErrorObject ...errors) {
    ...
    public ErrorResponseBuilder errors(@Nullable final java.util.List<com.commercetools.history.models.change_history.ErrorObject> errors) {
        this.errors = errors;
        return this;
    }
    ...
    public ErrorResponseBuilder plusErrors(@Nullable final com.commercetools.history.models.change_history.ErrorObject ...errors) {
        if (this.errors == null) {
    ...
    public ErrorResponseBuilder plusErrors(Function<com.commercetools.history.models.change_history.ErrorObjectBuilder, com.commercetools.history.models.change_history.ErrorObjectBuilder> builder) {
        if (this.errors == null) {
            this.errors = new ArrayList<>();
        }
    ...
    public ErrorResponseBuilder withErrors(Function<com.commercetools.history.models.change_history.ErrorObjectBuilder, com.commercetools.history.models.change_history.ErrorObjectBuilder> builder) {
        this.errors = new ArrayList<>();
        this.errors.add(builder.apply(com.commercetools.history.models.change_history.ErrorObjectBuilder.of()).build());
        return this;
    }
    ...
    public ErrorResponseBuilder addErrors(Function<com.commercetools.history.models.change_history.ErrorObjectBuilder, com.commercetools.history.models.change_history.ErrorObject> builder) {
    ...
    public ErrorResponseBuilder setErrors(Function<com.commercetools.history.models.change_history.ErrorObjectBuilder, com.commercetools.history.models.change_history.ErrorObject> builder) {
