...
public class RecordImpl implements Record, ModelBase {
     ...
     */
    @JsonCreator
    RecordImpl(@JsonProperty("version") final Integer version, @JsonProperty("previousVersion") final Integer previousVersion, @JsonProperty("type") final String type, @JsonProperty("modifiedBy") final com.commercetools.history.models.change_history.ModifiedBy modifiedBy, @JsonProperty("modifiedAt") final String modifiedAt, @JsonProperty("label") final com.commercetools.history.models.label.Label label, @JsonProperty("previousLabel") final com.commercetools.history.models.label.Label previousLabel, @JsonProperty("changes") final java.util.List<com.commercetools.history.models.change.Change> changes, @JsonProperty("resource") final com.commercetools.history.models.common.Reference resource, @JsonProperty("stores") final java.util.List<com.commercetools.history.models.common.KeyReference> stores, @JsonProperty("withoutChanges") final Boolean withoutChanges) {
