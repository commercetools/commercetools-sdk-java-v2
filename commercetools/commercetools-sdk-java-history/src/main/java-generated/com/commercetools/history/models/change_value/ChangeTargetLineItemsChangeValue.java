...
public interface ChangeTargetLineItemsChangeValue extends ChangeTargetChangeValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeTargetLineItemsChangeValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeTargetLineItemsChangeValue>() {
            @Override
