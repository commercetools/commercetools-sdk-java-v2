...
public interface ChangeValueAbsoluteChangeValue extends ChangeValueChangeValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeValueAbsoluteChangeValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeValueAbsoluteChangeValue>() {
            @Override
