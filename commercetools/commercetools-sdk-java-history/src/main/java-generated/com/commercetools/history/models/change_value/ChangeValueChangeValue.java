...
public interface ChangeValueChangeValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeValueChangeValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeValueChangeValue>() {
            @Override
