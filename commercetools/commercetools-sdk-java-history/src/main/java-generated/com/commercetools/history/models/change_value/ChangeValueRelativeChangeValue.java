...
public interface ChangeValueRelativeChangeValue extends ChangeValueChangeValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChangeValueRelativeChangeValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChangeValueRelativeChangeValue>() {
            @Override
