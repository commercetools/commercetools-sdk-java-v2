...
public interface CustomShippingMethodChangeValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomShippingMethodChangeValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomShippingMethodChangeValue>() {
            @Override
