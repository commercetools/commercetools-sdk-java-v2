...
public interface InventoryQuantityValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<InventoryQuantityValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<InventoryQuantityValue>() {
            @Override
