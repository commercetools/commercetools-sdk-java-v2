...
public interface SetCartClassificationShippingRateInputValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetCartClassificationShippingRateInputValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetCartClassificationShippingRateInputValue>() {
            @Override
