...
public class SetCartClassificationShippingRateInputValueImpl implements SetCartClassificationShippingRateInputValue, ModelBase {
     ...
     */
    @JsonCreator
    SetCartClassificationShippingRateInputValueImpl(@JsonProperty("type") final String type, @JsonProperty("key") final String key, @JsonProperty("label") final com.commercetools.history.models.common.LocalizedString label) {
        this.type = type;
        this.key = key;
        this.label = label;
    }
