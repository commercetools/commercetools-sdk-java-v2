...
public interface SetCartScoreShippingRateInputValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<SetCartScoreShippingRateInputValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<SetCartScoreShippingRateInputValue>() {
            @Override
