...
public interface ShippingMethodChangeValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodChangeValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodChangeValue>() {
            @Override
