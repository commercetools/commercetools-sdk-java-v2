...
public interface ShippingMethodTaxAmountChangeValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodTaxAmountChangeValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodTaxAmountChangeValue>() {
            @Override
