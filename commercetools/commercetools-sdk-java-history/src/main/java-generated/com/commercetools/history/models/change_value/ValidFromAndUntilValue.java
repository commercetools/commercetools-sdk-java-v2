...
public interface ValidFromAndUntilValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ValidFromAndUntilValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<ValidFromAndUntilValue>() {
            @Override
