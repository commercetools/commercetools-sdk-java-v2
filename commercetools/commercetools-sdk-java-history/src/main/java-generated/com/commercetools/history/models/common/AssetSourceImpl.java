...
public class AssetSourceImpl implements AssetSource, ModelBase {
     ...
     */
    @JsonCreator
    AssetSourceImpl(@JsonProperty("uri") final String uri, @JsonProperty("key") final String key, @JsonProperty("dimensions") final com.commercetools.history.models.common.AssetDimensions dimensions, @JsonProperty("contentType") final String contentType) {
        this.uri = uri;
        this.key = key;
    ...
    public void setDimensions(final com.commercetools.history.models.common.AssetDimensions dimensions){
        this.dimensions = dimensions;
    }
