...
public interface AssociateRoleAssignment {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AssociateRoleAssignment> typeReference() {
        return new tools.jackson.core.type.TypeReference<AssociateRoleAssignment>() {
            @Override
