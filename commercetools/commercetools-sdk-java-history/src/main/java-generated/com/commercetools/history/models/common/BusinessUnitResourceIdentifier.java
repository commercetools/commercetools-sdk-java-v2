...
public interface BusinessUnitResourceIdentifier extends ResourceIdentifier {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitResourceIdentifier> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitResourceIdentifier>() {
            @Override
