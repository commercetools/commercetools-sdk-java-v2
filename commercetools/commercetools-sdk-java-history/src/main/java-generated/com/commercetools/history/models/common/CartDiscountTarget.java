...
public interface CartDiscountTarget {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartDiscountTarget> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartDiscountTarget>() {
            @Override
