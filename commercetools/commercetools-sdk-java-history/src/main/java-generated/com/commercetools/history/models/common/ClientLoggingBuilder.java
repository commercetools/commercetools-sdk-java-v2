...
public class ClientLoggingBuilder implements Builder<ClientLogging> {
    ...
    @Nullable
    private com.commercetools.history.models.common.CustomerReference associate;
    ...
    public ClientLoggingBuilder customer(
            @Nullable final com.commercetools.history.models.common.CustomerReference customer) {
    ...
    public ClientLoggingBuilder associate(
            Function<com.commercetools.history.models.common.CustomerReferenceBuilder, com.commercetools.history.models.common.CustomerReferenceBuilder> builder) {
        this.associate = builder.apply(com.commercetools.history.models.common.CustomerReferenceBuilder.of()).build();
        return this;
    }
    ...
    public ClientLoggingBuilder withAssociate(
            Function<com.commercetools.history.models.common.CustomerReferenceBuilder, com.commercetools.history.models.common.CustomerReference> builder) {
        this.associate = builder.apply(com.commercetools.history.models.common.CustomerReferenceBuilder.of());
        return this;
    }
    ...
    public ClientLoggingBuilder associate(
            @Nullable final com.commercetools.history.models.common.CustomerReference associate) {
    ...
    @Nullable
    public com.commercetools.history.models.common.CustomerReference getAssociate() {
