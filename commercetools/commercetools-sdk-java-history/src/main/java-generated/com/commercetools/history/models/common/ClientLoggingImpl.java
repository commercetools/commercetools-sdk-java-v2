...
public class ClientLoggingImpl implements ClientLogging, ModelBase {
    ...
    ClientLoggingImpl(@JsonProperty("clientId") final String clientId,
            ...
            @JsonProperty("associate") final com.commercetools.history.models.common.CustomerReference associate) {
    ...
    public void setAssociate(final com.commercetools.history.models.common.CustomerReference associate) {
        this.associate = associate;
    }
