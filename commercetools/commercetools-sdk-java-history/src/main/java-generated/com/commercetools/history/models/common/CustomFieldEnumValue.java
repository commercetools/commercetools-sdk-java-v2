...
public interface CustomFieldEnumValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomFieldEnumValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomFieldEnumValue>() {
            @Override
