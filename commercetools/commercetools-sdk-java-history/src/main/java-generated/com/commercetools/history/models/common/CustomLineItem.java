...
public interface CustomLineItem {
    ...
    public CustomLineItemRecurrenceInfo getRecurrenceInfo();
    ...
    public void setRecurrenceInfo(final CustomLineItemRecurrenceInfo recurrenceInfo);
    ...
    public static CustomLineItem deepCopy(@Nullable final CustomLineItem template) {
        ...
        instance.setMoney(com.commercetools.history.models.common.TypedMoney.deepCopy(template.getMoney()));
        ...
        instance.setPriceMode(template.getPriceMode());
        instance.setRecurrenceInfo(com.commercetools.history.models.common.CustomLineItemRecurrenceInfo
