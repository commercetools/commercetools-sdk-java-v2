...
public interface CustomLineItemRecurrenceInfo {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomLineItemRecurrenceInfo> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomLineItemRecurrenceInfo>() {
            @Override
