...
public interface DirectDiscount {
    ...
    public static DirectDiscount deepCopy(@Nullable final DirectDiscount template) {
        ...
        DirectDiscountImpl instance = new DirectDiscountImpl();
        instance.setId(template.getId());
        instance.setValue(com.commercetools.history.models.common.CartDiscountValue.deepCopy(template.getValue()));
        instance.setTarget(com.commercetools.history.models.common.CartDiscountTarget.deepCopy(template.getTarget()));
        return instance;
    }
     ...
     */
    public static tools.jackson.core.type.TypeReference<DirectDiscount> typeReference() {
        return new tools.jackson.core.type.TypeReference<DirectDiscount>() {
            @Override
