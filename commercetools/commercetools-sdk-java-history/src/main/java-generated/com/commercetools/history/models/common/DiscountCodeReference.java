...
public interface DiscountCodeReference extends Reference {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountCodeReference> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountCodeReference>() {
            @Override
