...
public interface DiscountOnTotalPrice {
    ...
    public static DiscountOnTotalPrice deepCopy(@Nullable final DiscountOnTotalPrice template) {
        ...
        instance.setIncludedDiscounts(Optional.ofNullable(template.getIncludedDiscounts())
                .map(t -> t.stream()
                        .map(com.commercetools.history.models.common.DiscountedTotalPricePortion::deepCopy)
                        .collect(Collectors.toList()))
                .orElse(null));
        instance.setDiscountedNetAmount(
            com.commercetools.history.models.common.TypedMoney.deepCopy(template.getDiscountedNetAmount()));
        instance.setDiscountedGrossAmount(
            com.commercetools.history.models.common.TypedMoney.deepCopy(template.getDiscountedGrossAmount()));
        return instance;
    }
