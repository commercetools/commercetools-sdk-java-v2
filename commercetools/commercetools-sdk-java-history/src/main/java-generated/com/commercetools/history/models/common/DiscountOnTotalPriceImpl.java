...
public class DiscountOnTotalPriceImpl implements DiscountOnTotalPrice, ModelBase {
    ...
    DiscountOnTotalPriceImpl(
            ...
            @JsonProperty("includedDiscounts") final java.util.List<com.commercetools.history.models.common.DiscountedTotalPricePortion> includedDiscounts,
            @JsonProperty("discountedNetAmount") final com.commercetools.history.models.common.TypedMoney discountedNetAmount,
            @JsonProperty("discountedGrossAmount") final com.commercetools.history.models.common.TypedMoney discountedGrossAmount) {
    ...
    public void setDiscountedNetAmount(final com.commercetools.history.models.common.TypedMoney discountedNetAmount) {
        this.discountedNetAmount = discountedNetAmount;
    }

    public void setDiscountedGrossAmount(
