...
public class DiscountedPriceBuilder implements Builder<DiscountedPrice> {
    ...
    public DiscountedPriceBuilder value(final com.commercetools.history.models.common.TypedMoney value) {
        this.value = value;
        return this;
    }
    ...
    public DiscountedPriceBuilder discount(
            Function<com.commercetools.history.models.common.ProductDiscountReferenceBuilder, com.commercetools.history.models.common.ProductDiscountReferenceBuilder> builder) {
        this.discount = builder.apply(com.commercetools.history.models.common.ProductDiscountReferenceBuilder.of())
                .build();
        return this;
    }
    ...
    public DiscountedPriceBuilder withDiscount(
            Function<com.commercetools.history.models.common.ProductDiscountReferenceBuilder, com.commercetools.history.models.common.ProductDiscountReference> builder) {
        this.discount = builder.apply(com.commercetools.history.models.common.ProductDiscountReferenceBuilder.of());
        return this;
    }
    ...
    public DiscountedPriceBuilder discount(
            final com.commercetools.history.models.common.ProductDiscountReference discount) {
