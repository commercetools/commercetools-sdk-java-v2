...
public class MoneyImpl implements Money, ModelBase {
     ...
     */
    @JsonCreator
    MoneyImpl(@JsonProperty("currencyCode") final String currencyCode, @JsonProperty("centAmount") final Integer centAmount, @JsonProperty("fractionDigits") final Integer fractionDigits, @JsonProperty("type") final com.commercetools.history.models.common.MoneyType type) {
