...
public interface Parcel  {
    ...
    public static Parcel deepCopy(@Nullable final Parcel template) {
        ...
        instance.setId(template.getId());
        instance.setCreatedAt(template.getCreatedAt());
        instance.setMeasurements(com.commercetools.history.models.common.ParcelMeasurements.deepCopy(template.getMeasurements()));
        instance.setTrackingData(com.commercetools.history.models.common.TrackingData.deepCopy(template.getTrackingData()));
