...
public class ParcelMeasurementsImpl implements ParcelMeasurements, ModelBase {
     ...
     */
    @JsonCreator
    ParcelMeasurementsImpl(@JsonProperty("heightInMillimeter") final Integer heightInMillimeter, @JsonProperty("lengthInMillimeter") final Integer lengthInMillimeter, @JsonProperty("widthInMillimeter") final Integer widthInMillimeter, @JsonProperty("weightInGram") final Integer weightInGram) {
