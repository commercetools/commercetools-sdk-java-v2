...
public class PaymentInfoBuilder implements Builder<PaymentInfo> {
    ...
    public PaymentInfoBuilder payments( final java.util.List<com.commercetools.history.models.common.Reference> payments) {
    ...
    public PaymentInfoBuilder plusPayments(Function<com.commercetools.history.models.common.ReferenceBuilder, com.commercetools.history.models.common.ReferenceBuilder> builder) {
        if (this.payments == null) {
            this.payments = new ArrayList<>();
        }
    ...
    public PaymentInfoBuilder withPayments(Function<com.commercetools.history.models.common.ReferenceBuilder, com.commercetools.history.models.common.ReferenceBuilder> builder) {
        this.payments = new ArrayList<>();
        this.payments.add(builder.apply(com.commercetools.history.models.common.ReferenceBuilder.of()).build());
        return this;
    }
    ...
    public PaymentInfoBuilder addPayments(Function<com.commercetools.history.models.common.ReferenceBuilder, com.commercetools.history.models.common.Reference> builder) {
    ...
    public PaymentInfoBuilder setPayments(Function<com.commercetools.history.models.common.ReferenceBuilder, com.commercetools.history.models.common.Reference> builder) {
