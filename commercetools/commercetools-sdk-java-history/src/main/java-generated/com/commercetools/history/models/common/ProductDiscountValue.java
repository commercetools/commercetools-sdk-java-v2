...
public interface ProductDiscountValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductDiscountValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductDiscountValue>() {
            @Override
