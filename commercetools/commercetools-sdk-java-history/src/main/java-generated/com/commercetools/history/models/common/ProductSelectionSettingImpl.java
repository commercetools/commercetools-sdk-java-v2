...
public class ProductSelectionSettingImpl implements ProductSelectionSetting, ModelBase {
     ...
     */
    @JsonCreator
    ProductSelectionSettingImpl(@JsonProperty("productSelection") final com.commercetools.history.models.common.Reference productSelection, @JsonProperty("active") final Boolean active) {
