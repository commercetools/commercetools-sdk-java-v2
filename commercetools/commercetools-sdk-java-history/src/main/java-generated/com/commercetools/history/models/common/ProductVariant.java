...
public interface ProductVariant {
    ...
    public static ProductVariant deepCopy(@Nullable final ProductVariant template) {
        ...
        instance.setAttributes(Optional.ofNullable(template.getAttributes())
                .map(t -> t.stream()
                        .map(com.commercetools.history.models.common.Attribute::deepCopy)
                        .collect(Collectors.toList()))
                .orElse(null));
        ...
        instance.setAvailability(
            com.commercetools.history.models.common.ProductVariantAvailability.deepCopy(template.getAvailability()));
        instance.setIsMatchingVariant(template.getIsMatchingVariant());
        instance.setScopedPrice(
            com.commercetools.history.models.common.ScopedPrice.deepCopy(template.getScopedPrice()));
        instance.setScopedPriceDiscounted(template.getScopedPriceDiscounted());
