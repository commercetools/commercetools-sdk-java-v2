...
public class ProductVariantAvailabilityBuilder implements Builder<ProductVariantAvailability> {
    ...
    public ProductVariantAvailabilityBuilder channels(Function<com.commercetools.history.models.common.ProductVariantChannelAvailabilityMapBuilder, com.commercetools.history.models.common.ProductVariantChannelAvailabilityMapBuilder> builder) {
        this.channels = builder.apply(com.commercetools.history.models.common.ProductVariantChannelAvailabilityMapBuilder.of()).build();
        return this;
    }
    ...
    public ProductVariantAvailabilityBuilder withChannels(Function<com.commercetools.history.models.common.ProductVariantChannelAvailabilityMapBuilder, com.commercetools.history.models.common.ProductVariantChannelAvailabilityMap> builder) {
        this.channels = builder.apply(com.commercetools.history.models.common.ProductVariantChannelAvailabilityMapBuilder.of());
        return this;
    }
    ...
    public ProductVariantAvailabilityBuilder channels( final com.commercetools.history.models.common.ProductVariantChannelAvailabilityMap channels) {
