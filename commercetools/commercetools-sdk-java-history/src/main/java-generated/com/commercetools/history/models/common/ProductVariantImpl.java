...
public class ProductVariantImpl implements ProductVariant, ModelBase {
    ...
    ProductVariantImpl(@JsonProperty("id") final Long id, @JsonProperty("sku") final String sku,
            ...
            @JsonProperty("prices") final java.util.List<com.commercetools.history.models.common.Price> prices,
            @JsonProperty("attributes") final java.util.List<com.commercetools.history.models.common.Attribute> attributes,
            @JsonProperty("price") final com.commercetools.history.models.common.Price price,
            @JsonProperty("images") final java.util.List<com.commercetools.history.models.common.Image> images,
            @JsonProperty("assets") final java.util.List<com.commercetools.history.models.common.Asset> assets,
            @JsonProperty("availability") final com.commercetools.history.models.common.ProductVariantAvailability availability,
            @JsonProperty("isMatchingVariant") final Boolean isMatchingVariant,
            @JsonProperty("scopedPrice") final com.commercetools.history.models.common.ScopedPrice scopedPrice,
            @JsonProperty("scopedPriceDiscounted") final Boolean scopedPriceDiscounted,
            @JsonProperty("recurrencePrices") final java.util.List<com.commercetools.history.models.common.Price> recurrencePrices) {
        this.id = id;
        this.sku = sku;
        this.key = key;
        this.prices = prices;
    ...
    public void setPrices(final com.commercetools.history.models.common.Price... prices) {
        this.prices = new ArrayList<>(Arrays.asList(prices));
    }

    public void setPrices(final java.util.List<com.commercetools.history.models.common.Price> prices) {
        this.prices = prices;
    }

    public void setAttributes(final com.commercetools.history.models.common.Attribute... attributes) {
        this.attributes = new ArrayList<>(Arrays.asList(attributes));
    }

    public void setAttributes(final java.util.List<com.commercetools.history.models.common.Attribute> attributes) {
        this.attributes = attributes;
    }
    ...
    public void setImages(final com.commercetools.history.models.common.Image... images) {
        this.images = new ArrayList<>(Arrays.asList(images));
    }

    public void setImages(final java.util.List<com.commercetools.history.models.common.Image> images) {
        this.images = images;
    }

    public void setAssets(final com.commercetools.history.models.common.Asset... assets) {
        this.assets = new ArrayList<>(Arrays.asList(assets));
    }

    public void setAssets(final java.util.List<com.commercetools.history.models.common.Asset> assets) {
        this.assets = assets;
    }

    public void setAvailability(final com.commercetools.history.models.common.ProductVariantAvailability availability) {
        this.availability = availability;
    }
    ...
    public void setScopedPrice(final com.commercetools.history.models.common.ScopedPrice scopedPrice) {
        this.scopedPrice = scopedPrice;
    }
    ...
    public void setRecurrencePrices(final com.commercetools.history.models.common.Price... recurrencePrices) {
        this.recurrencePrices = new ArrayList<>(Arrays.asList(recurrencePrices));
    }

    public void setRecurrencePrices(
            final java.util.List<com.commercetools.history.models.common.Price> recurrencePrices) {
        this.recurrencePrices = recurrencePrices;
    }
