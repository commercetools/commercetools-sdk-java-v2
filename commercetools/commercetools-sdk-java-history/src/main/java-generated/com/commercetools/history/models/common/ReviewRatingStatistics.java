...
public interface ReviewRatingStatistics {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ReviewRatingStatistics> typeReference() {
        return new tools.jackson.core.type.TypeReference<ReviewRatingStatistics>() {
            @Override
