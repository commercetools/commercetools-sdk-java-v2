...
public class ShippingImpl implements Shipping, ModelBase {
    ...
    ShippingImpl(@JsonProperty("shippingKey") final String shippingKey,
            @JsonProperty("shippingInfo") final com.commercetools.history.models.common.ShippingInfo shippingInfo,
            @JsonProperty("shippingAddress") final com.commercetools.history.models.common.Address shippingAddress,
            @JsonProperty("shippingRateInput") final com.commercetools.history.models.common.ShippingRateInput shippingRateInput,
            @JsonProperty("shippingCustomFields") final com.commercetools.history.models.common.CustomFields shippingCustomFields) {
    ...
    public void setShippingInfo(final com.commercetools.history.models.common.ShippingInfo shippingInfo) {
        this.shippingInfo = shippingInfo;
    }

    public void setShippingAddress(final com.commercetools.history.models.common.Address shippingAddress) {
        this.shippingAddress = shippingAddress;
    }

    public void setShippingRateInput(
            final com.commercetools.history.models.common.ShippingRateInput shippingRateInput) {
        this.shippingRateInput = shippingRateInput;
    }

    public void setShippingCustomFields(
            final com.commercetools.history.models.common.CustomFields shippingCustomFields) {
        this.shippingCustomFields = shippingCustomFields;
    }
