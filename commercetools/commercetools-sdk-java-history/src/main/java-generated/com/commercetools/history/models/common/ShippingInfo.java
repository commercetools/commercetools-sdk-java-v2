...
public interface ShippingInfo {
    ...
    public static ShippingInfo deepCopy(@Nullable final ShippingInfo template) {
        ...
        instance.setShippingRate(
            com.commercetools.history.models.common.ShippingRate.deepCopy(template.getShippingRate()));
        ...
        instance.setTaxCategory(
            com.commercetools.history.models.common.TaxCategoryReference.deepCopy(template.getTaxCategory()));
        instance.setShippingMethod(
            com.commercetools.history.models.common.ShippingMethodReference.deepCopy(template.getShippingMethod()));
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingInfo> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingInfo>() {
            @Override
