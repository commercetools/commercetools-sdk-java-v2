...
public class ShippingInfoImpl implements ShippingInfo, ModelBase {
    ...
    ShippingInfoImpl(@JsonProperty("shippingMethodName") final String shippingMethodName,
            @JsonProperty("price") final com.commercetools.history.models.common.CentPrecisionMoney price,
            @JsonProperty("shippingRate") final com.commercetools.history.models.common.ShippingRate shippingRate,
            ...
            @JsonProperty("shippingMethod") final com.commercetools.history.models.common.ShippingMethodReference shippingMethod,
            @JsonProperty("deliveries") final java.util.List<com.commercetools.history.models.common.Delivery> deliveries,
            @JsonProperty("discountedPrice") final com.commercetools.history.models.common.DiscountedLineItemPrice discountedPrice,
            @JsonProperty("shippingMethodState") final com.commercetools.history.models.common.ShippingMethodState shippingMethodState) {
    ...
    public void setShippingRate(final com.commercetools.history.models.common.ShippingRate shippingRate) {
        this.shippingRate = shippingRate;
    }
    ...
    public void setShippingMethod(
            final com.commercetools.history.models.common.ShippingMethodReference shippingMethod) {
        this.shippingMethod = shippingMethod;
    }

    public void setDeliveries(final com.commercetools.history.models.common.Delivery... deliveries) {
        this.deliveries = new ArrayList<>(Arrays.asList(deliveries));
    }

    public void setDeliveries(final java.util.List<com.commercetools.history.models.common.Delivery> deliveries) {
        this.deliveries = deliveries;
    }
