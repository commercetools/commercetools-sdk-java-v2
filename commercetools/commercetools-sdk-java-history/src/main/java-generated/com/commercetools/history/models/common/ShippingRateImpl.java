...
public class ShippingRateImpl implements ShippingRate, ModelBase {
     ...
     */
    @JsonCreator
    ShippingRateImpl(@JsonProperty("price") final com.commercetools.history.models.common.Money price, @JsonProperty("freeAbove") final com.commercetools.history.models.common.Money freeAbove, @JsonProperty("isMatching") final Boolean isMatching, @JsonProperty("tiers") final java.util.List<com.commercetools.history.models.common.ShippingRatePriceTier> tiers) {
        this.price = price;
