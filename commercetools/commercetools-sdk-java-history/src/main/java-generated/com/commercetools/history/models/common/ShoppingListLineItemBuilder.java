...
public class ShoppingListLineItemBuilder implements Builder<ShoppingListLineItem> {
    ...
    public ShoppingListLineItemBuilder custom(
            @Nullable final com.commercetools.history.models.common.CustomFields custom) {
        this.custom = custom;
        return this;
    }
    ...
    public ShoppingListLineItemBuilder name(final com.commercetools.history.models.common.LocalizedString name) {
        this.name = name;
        return this;
    }
    ...
    public ShoppingListLineItemBuilder productType(
            final com.commercetools.history.models.common.ProductTypeReference productType) {
    ...
    public ShoppingListLineItemBuilder variant(
            @Nullable final com.commercetools.history.models.common.ProductVariant variant) {
