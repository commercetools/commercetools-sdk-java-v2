...
public interface GraphQLErrorLocation {
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLErrorLocation> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLErrorLocation>() {
            @Override
