...
public interface GraphQLRequest {
    ...
    public static GraphQLRequest deepCopy(@Nullable final GraphQLRequest template) {
        ...
        instance.setVariables(
            com.commercetools.history.models.graph_ql.GraphQLVariablesMap.deepCopy(template.getVariables()));
        return instance;
    }
     ...
     */
    public static tools.jackson.core.type.TypeReference<GraphQLRequest> typeReference() {
        return new tools.jackson.core.type.TypeReference<GraphQLRequest>() {
            @Override
