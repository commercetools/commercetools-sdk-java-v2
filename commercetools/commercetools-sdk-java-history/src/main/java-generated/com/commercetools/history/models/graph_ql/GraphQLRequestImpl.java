...
public class GraphQLRequestImpl implements GraphQLRequest, ModelBase {
    ...
    GraphQLRequestImpl(@JsonProperty("query") final String query,
            ...
            @JsonProperty("variables") final com.commercetools.history.models.graph_ql.GraphQLVariablesMap variables) {
        this.query = query;
    ...
    public void setVariables(final com.commercetools.history.models.graph_ql.GraphQLVariablesMap variables) {
        this.variables = variables;
    }
