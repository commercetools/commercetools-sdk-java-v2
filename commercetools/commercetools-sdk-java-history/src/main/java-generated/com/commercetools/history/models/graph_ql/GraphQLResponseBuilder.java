...
public class GraphQLResponseBuilder implements Builder<GraphQLResponse> {
    ...
    public GraphQLResponseBuilder errors(
            @Nullable final com.commercetools.history.models.graph_ql.GraphQLError... errors) {
    ...
    public GraphQLResponseBuilder errors(
            @Nullable final java.util.List<com.commercetools.history.models.graph_ql.GraphQLError> errors) {
        this.errors = errors;
        return this;
    }
    ...
    public GraphQLResponseBuilder plusErrors(
            Function<com.commercetools.history.models.graph_ql.GraphQLErrorBuilder, com.commercetools.history.models.graph_ql.GraphQLErrorBuilder> builder) {
        if (this.errors == null) {
            this.errors = new ArrayList<>();
        }
        this.errors.add(builder.apply(com.commercetools.history.models.graph_ql.GraphQLErrorBuilder.of()).build());
        return this;
    }
    ...
    public GraphQLResponseBuilder addErrors(
            Function<com.commercetools.history.models.graph_ql.GraphQLErrorBuilder, com.commercetools.history.models.graph_ql.GraphQLError> builder) {
        return plusErrors(builder.apply(com.commercetools.history.models.graph_ql.GraphQLErrorBuilder.of()));
    }
    ...
    public GraphQLResponseBuilder setErrors(
            Function<com.commercetools.history.models.graph_ql.GraphQLErrorBuilder, com.commercetools.history.models.graph_ql.GraphQLError> builder) {
        return errors(builder.apply(com.commercetools.history.models.graph_ql.GraphQLErrorBuilder.of()));
    }
