...
public class QuoteLabelImpl implements QuoteLabel, ModelBase {
     ...
     */
    @JsonCreator
    QuoteLabelImpl(@JsonProperty("key") final String key, @JsonProperty("customer") final com.commercetools.history.models.common.Reference customer, @JsonProperty("stagedQuote") final com.commercetools.history.models.common.Reference stagedQuote, @JsonProperty("quoteRequest") final com.commercetools.history.models.common.Reference quoteRequest) {
        this.key = key;
