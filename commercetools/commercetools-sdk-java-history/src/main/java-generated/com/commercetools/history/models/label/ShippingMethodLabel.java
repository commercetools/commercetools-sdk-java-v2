...
public interface ShippingMethodLabel extends Label {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingMethodLabel> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingMethodLabel>() {
            @Override
