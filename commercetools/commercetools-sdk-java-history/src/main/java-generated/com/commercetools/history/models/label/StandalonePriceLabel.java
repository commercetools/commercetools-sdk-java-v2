...
public interface StandalonePriceLabel extends Label {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StandalonePriceLabel> typeReference() {
        return new tools.jackson.core.type.TypeReference<StandalonePriceLabel>() {
            @Override
