 ...
 * </div>
 */
@io.vrap.rmf.base.client.utils.json.SubType("StringLabel")
...
public interface StringLabel extends Label {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StringLabel> typeReference() {
        return new tools.jackson.core.type.TypeReference<StringLabel>() {
            @Override
