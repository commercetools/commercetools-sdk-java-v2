...
public class ChangeLocalizedDescriptionChangeTest {
    ...
    public void buildUnchecked(ChangeLocalizedDescriptionChangeBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { ChangeLocalizedDescriptionChange.builder().change("change") },
                new Object[] { ChangeLocalizedDescriptionChange.builder()
