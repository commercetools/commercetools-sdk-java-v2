...
public class RemoveCustomLineItemChangeTest {
    ...
    public void buildUnchecked(RemoveCustomLineItemChangeBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { RemoveCustomLineItemChange.builder().change("change") },
                new Object[] { RemoveCustomLineItemChange.builder()
