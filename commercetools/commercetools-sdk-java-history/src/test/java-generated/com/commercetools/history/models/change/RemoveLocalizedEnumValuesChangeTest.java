...
public class RemoveLocalizedEnumValuesChangeTest {
    ...
    public void buildUnchecked(RemoveLocalizedEnumValuesChangeBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { RemoveLocalizedEnumValuesChange.builder().change("change") },
                new Object[] { RemoveLocalizedEnumValuesChange.builder()
                        .previousValue(new com.commercetools.history.models.change_value.LocalizedEnumValueImpl()) },
                new Object[] { RemoveLocalizedEnumValuesChange.builder().attributeName("attributeName") } };
    }
