...
public class RemoveTextLineItemChangeTest {
    ...
    public void buildUnchecked(RemoveTextLineItemChangeBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { RemoveTextLineItemChange.builder().change("change") },
                new Object[] { RemoveTextLineItemChange.builder()
