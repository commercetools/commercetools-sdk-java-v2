...
public class SetMaxApplicationsPerCustomerChangeTest {
    ...
    public void buildUnchecked(String name, SetMaxApplicationsPerCustomerChangeBuilder builder) {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] {
                new Object[] { "change", SetMaxApplicationsPerCustomerChange.builder().change("change") },
                new Object[] { "previousValue", SetMaxApplicationsPerCustomerChange.builder().previousValue(8) },
                new Object[] { "nextValue", SetMaxApplicationsPerCustomerChange.builder().nextValue(7) } };
    }
