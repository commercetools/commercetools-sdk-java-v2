...
public class AssetSourceTest {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { "uri", AssetSource.builder().uri("uri") },
                ...
                new Object[] { "dimensions",
                        AssetSource.builder()
                                .dimensions(new com.commercetools.history.models.common.AssetDimensionsImpl()) },
    ...
    public void dimensions() {
        AssetSource value = AssetSource.of();
        value.setDimensions(new com.commercetools.history.models.common.AssetDimensionsImpl());
        Assertions.assertThat(value.getDimensions())
                .isEqualTo(new com.commercetools.history.models.common.AssetDimensionsImpl());
    }
