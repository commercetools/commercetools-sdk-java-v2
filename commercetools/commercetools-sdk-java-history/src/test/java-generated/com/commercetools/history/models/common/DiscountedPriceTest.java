...
public class DiscountedPriceTest {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] {
                new Object[] { "value",
                        DiscountedPrice.builder().value(new com.commercetools.history.models.common.TypedMoneyImpl()) },
                new Object[] { "discount", DiscountedPrice.builder()
                        .discount(new com.commercetools.history.models.common.ProductDiscountReferenceImpl()) } };
    }
    ...
    public void discount() {
        DiscountedPrice value = DiscountedPrice.of();
        value.setDiscount(new com.commercetools.history.models.common.ProductDiscountReferenceImpl());
        Assertions.assertThat(value.getDiscount())
                .isEqualTo(new com.commercetools.history.models.common.ProductDiscountReferenceImpl());
    }
}
