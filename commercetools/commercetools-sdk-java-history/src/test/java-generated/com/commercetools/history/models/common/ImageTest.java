...
public class ImageTest {
    ...
    public void dimensions() {
        Image value = Image.of();
        value.setDimensions(new com.commercetools.history.models.common.ImageDimensionsImpl());
        Assertions.assertThat(value.getDimensions())
                .isEqualTo(new com.commercetools.history.models.common.ImageDimensionsImpl());
    }
