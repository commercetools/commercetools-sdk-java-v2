...
public class ProductVariantTest {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { "id", ProductVariant.builder().id(2L) },
                ...
                new Object[] { "price",
                        ProductVariant.builder().price(new com.commercetools.history.models.common.PriceImpl()) },
                new Object[] { "images",
                        ProductVariant.builder()
                                .images(Collections
                ...
                new Object[] { "assets",
                        ProductVariant.builder()
                                .assets(Collections
                                        .singletonList(new com.commercetools.history.models.common.AssetImpl())) },
                new Object[] { "availability", ProductVariant.builder()
                        .availability(new com.commercetools.history.models.common.ProductVariantAvailabilityImpl()) },
                new Object[] { "isMatchingVariant", ProductVariant.builder().isMatchingVariant(true) },
                new Object[] { "scopedPrice",
                        ProductVariant.builder()
                                .scopedPrice(new com.commercetools.history.models.common.ScopedPriceImpl()) },
                new Object[] { "scopedPriceDiscounted", ProductVariant.builder().scopedPriceDiscounted(true) },
                new Object[] { "recurrencePrices", ProductVariant.builder()
                        .recurrencePrices(
    ...
    public void prices() {
        ProductVariant value = ProductVariant.of();
        value.setPrices(Collections.singletonList(new com.commercetools.history.models.common.PriceImpl()));
    ...
    public void attributes() {
        ProductVariant value = ProductVariant.of();
        value.setAttributes(Collections.singletonList(new com.commercetools.history.models.common.AttributeImpl()));
        Assertions.assertThat(value.getAttributes())
                .isEqualTo(Collections.singletonList(new com.commercetools.history.models.common.AttributeImpl()));
    }
    ...
    public void images() {
        ProductVariant value = ProductVariant.of();
        value.setImages(Collections.singletonList(new com.commercetools.history.models.common.ImageImpl()));
    ...
    public void assets() {
        ProductVariant value = ProductVariant.of();
        value.setAssets(Collections.singletonList(new com.commercetools.history.models.common.AssetImpl()));
        Assertions.assertThat(value.getAssets())
                .isEqualTo(Collections.singletonList(new com.commercetools.history.models.common.AssetImpl()));
    }

    @Test
    public void availability() {
        ProductVariant value = ProductVariant.of();
        value.setAvailability(new com.commercetools.history.models.common.ProductVariantAvailabilityImpl());
    ...
    public void scopedPrice() {
        ProductVariant value = ProductVariant.of();
        value.setScopedPrice(new com.commercetools.history.models.common.ScopedPriceImpl());
        Assertions.assertThat(value.getScopedPrice())
                .isEqualTo(new com.commercetools.history.models.common.ScopedPriceImpl());
    }
    ...
    public void recurrencePrices() {
        ProductVariant value = ProductVariant.of();
        value.setRecurrencePrices(Collections.singletonList(new com.commercetools.history.models.common.PriceImpl()));
