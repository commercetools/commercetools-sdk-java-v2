...
public class GraphQLResponseTest {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { GraphQLResponse.builder().data("data") },
                new Object[] { GraphQLResponse.builder()
                        .errors(Collections
                                .singletonList(new com.commercetools.history.models.graph_ql.GraphQLErrorImpl())) } };
    }
    ...
    public void errors() {
        GraphQLResponse value = GraphQLResponse.of();
        value.setErrors(Collections.singletonList(new com.commercetools.history.models.graph_ql.GraphQLErrorImpl()));
        Assertions.assertThat(value.getErrors())
                .isEqualTo(Collections.singletonList(new com.commercetools.history.models.graph_ql.GraphQLErrorImpl()));
    }
}
