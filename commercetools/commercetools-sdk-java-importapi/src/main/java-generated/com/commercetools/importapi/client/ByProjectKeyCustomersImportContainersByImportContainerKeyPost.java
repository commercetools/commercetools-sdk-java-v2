...
public class ByProjectKeyCustomersImportContainersByImportContainerKeyPost extends BodyApiMethod<ByProjectKeyCustomersImportContainersByImportContainerKeyPost, com.commercetools.importapi.models.importrequests.ImportResponse, com.commercetools.importapi.models.importrequests.CustomerImportRequest> implements com.commercetools.importapi.client.Secured_by_manage_customersTrait<ByProjectKeyCustomersImportContainersByImportContainerKeyPost> {
    ...
    public ByProjectKeyCustomersImportContainersByImportContainerKeyPost(final ApiHttpClient apiHttpClient, String projectKey, String importContainerKey, com.commercetools.importapi.models.importrequests.CustomerImportRequest customerImportRequest) {
        super(apiHttpClient);
    ...
    public ByProjectKeyCustomersImportContainersByImportContainerKeyPost(ByProjectKeyCustomersImportContainersByImportContainerKeyPost t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        String httpRequestPath = String.format("%s/customers/import-containers/%s", this.projectKey, this.importContainerKey);
        if (!params.isEmpty()) {
            httpRequestPath += "?" + String.join("&", params);
        }
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(customerImportRequest)));
    ...
    public ByProjectKeyCustomersImportContainersByImportContainerKeyPost withBody(com.commercetools.importapi.models.importrequests.CustomerImportRequest customerImportRequest) {
