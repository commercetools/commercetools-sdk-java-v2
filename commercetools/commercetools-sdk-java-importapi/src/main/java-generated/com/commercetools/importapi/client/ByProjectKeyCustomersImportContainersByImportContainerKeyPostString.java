...
public class ByProjectKeyCustomersImportContainersByImportContainerKeyPostString extends StringBodyApiMethod<ByProjectKeyCustomersImportContainersByImportContainerKeyPostString, com.commercetools.importapi.models.importrequests.ImportResponse> implements com.commercetools.importapi.client.Secured_by_manage_customersTrait<ByProjectKeyCustomersImportContainersByImportContainerKeyPostString> {
    ...
    public ByProjectKeyCustomersImportContainersByImportContainerKeyPostString(final ApiHttpClient apiHttpClient, String projectKey, String importContainerKey, String customerImportRequest) {
        super(apiHttpClient);
    ...
    public ByProjectKeyCustomersImportContainersByImportContainerKeyPostString(ByProjectKeyCustomersImportContainersByImportContainerKeyPostString t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), customerImportRequest.getBytes(StandardCharsets.UTF_8));
