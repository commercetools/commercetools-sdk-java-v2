...
public class ByProjectKeyImportContainersByImportContainerKeyGet extends ApiMethod<ByProjectKeyImportContainersByImportContainerKeyGet, com.commercetools.importapi.models.importcontainers.ImportContainer> implements com.commercetools.importapi.client.Secured_by_view_import_containersTrait<ByProjectKeyImportContainersByImportContainerKeyGet> {
    ...
    public ByProjectKeyImportContainersByImportContainerKeyGet(final ApiHttpClient apiHttpClient, String projectKey, String importContainerKey) {
        super(apiHttpClient);
