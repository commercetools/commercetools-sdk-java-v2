...
public class ByProjectKeyImportContainersByImportContainerKeyImportSummariesGet extends ApiMethod<ByProjectKeyImportContainersByImportContainerKeyImportSummariesGet, com.commercetools.importapi.models.importsummaries.ImportSummary> implements com.commercetools.importapi.client.Secured_by_view_import_containersTrait<ByProjectKeyImportContainersByImportContainerKeyImportSummariesGet> {
    ...
    public ByProjectKeyImportContainersByImportContainerKeyImportSummariesGet(final ApiHttpClient apiHttpClient, String projectKey, String importContainerKey) {
        super(apiHttpClient);
        this.projectKey = projectKey;
        this.importContainerKey = importContainerKey;
    }

    public ByProjectKeyImportContainersByImportContainerKeyImportSummariesGet(ByProjectKeyImportContainersByImportContainerKeyImportSummariesGet t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        String httpRequestPath = String.format("%s/import-containers/%s/import-summaries", this.projectKey, this.importContainerKey);
        if (!params.isEmpty()) {
    ...
    @Override
    public ApiHttpResponse<com.commercetools.importapi.models.importsummaries.ImportSummary> executeBlocking(final ApiHttpClient client, final Duration timeout) {
        return executeBlocking(client, timeout, com.commercetools.importapi.models.importsummaries.ImportSummary.class);
    }

    @Override
    public CompletableFuture<ApiHttpResponse<com.commercetools.importapi.models.importsummaries.ImportSummary>> execute(final ApiHttpClient client) {
