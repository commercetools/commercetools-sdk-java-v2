...
public class ByProjectKeyInventoriesImportContainersByImportContainerKeyPostString extends StringBodyApiMethod<ByProjectKeyInventoriesImportContainersByImportContainerKeyPostString, com.commercetools.importapi.models.importrequests.ImportResponse> implements com.commercetools.importapi.client.Secured_by_manage_productsTrait<ByProjectKeyInventoriesImportContainersByImportContainerKeyPostString> {
    ...
    public ByProjectKeyInventoriesImportContainersByImportContainerKeyPostString(final ApiHttpClient apiHttpClient, String projectKey, String importContainerKey, String inventoryImportRequest) {
        super(apiHttpClient);
    ...
    public ByProjectKeyInventoriesImportContainersByImportContainerKeyPostString(ByProjectKeyInventoriesImportContainersByImportContainerKeyPostString t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), inventoryImportRequest.getBytes(StandardCharsets.UTF_8));
    ...
    public ByProjectKeyInventoriesImportContainersByImportContainerKeyPostString withBody(String inventoryImportRequest) {
