...
public class ByProjectKeyOrderPatchesImportContainersByImportContainerKeyPost extends BodyApiMethod<ByProjectKeyOrderPatchesImportContainersByImportContainerKeyPost, com.commercetools.importapi.models.importrequests.ImportResponse, com.commercetools.importapi.models.importrequests.OrderPatchImportRequest> implements com.commercetools.importapi.client.Secured_by_manage_ordersTrait<ByProjectKeyOrderPatchesImportContainersByImportContainerKeyPost> {
    ...
    public ByProjectKeyOrderPatchesImportContainersByImportContainerKeyPost(final ApiHttpClient apiHttpClient, String projectKey, String importContainerKey, com.commercetools.importapi.models.importrequests.OrderPatchImportRequest orderPatchImportRequest) {
        super(apiHttpClient);
    ...
    public ByProjectKeyOrderPatchesImportContainersByImportContainerKeyPost(ByProjectKeyOrderPatchesImportContainersByImportContainerKeyPost t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(orderPatchImportRequest)));
    ...
    public ByProjectKeyOrderPatchesImportContainersByImportContainerKeyPost withBody(com.commercetools.importapi.models.importrequests.OrderPatchImportRequest orderPatchImportRequest) {
