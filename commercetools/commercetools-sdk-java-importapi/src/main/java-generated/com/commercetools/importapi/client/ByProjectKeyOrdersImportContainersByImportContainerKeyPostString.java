...
public class ByProjectKeyOrdersImportContainersByImportContainerKeyPostString extends StringBodyApiMethod<ByProjectKeyOrdersImportContainersByImportContainerKeyPostString, com.commercetools.importapi.models.importrequests.ImportResponse> implements com.commercetools.importapi.client.Secured_by_manage_ordersTrait<ByProjectKeyOrdersImportContainersByImportContainerKeyPostString> {
    ...
    public ByProjectKeyOrdersImportContainersByImportContainerKeyPostString(final ApiHttpClient apiHttpClient, String projectKey, String importContainerKey, String orderImportRequest) {
        super(apiHttpClient);
    ...
    public ByProjectKeyOrdersImportContainersByImportContainerKeyPostString(ByProjectKeyOrdersImportContainersByImportContainerKeyPostString t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), orderImportRequest.getBytes(StandardCharsets.UTF_8));
