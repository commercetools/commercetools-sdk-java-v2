...
public class ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsByIdRequestBuilder {
    ...
    public ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsByIdRequestBuilder(
    ...
    public ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsByIdGet get() {
        return new ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsByIdGet(apiHttpClient, projectKey,
            importSinkKey, id);
    }
