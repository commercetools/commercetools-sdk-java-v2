...
public class ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsRequestBuilder {
    ...
    public ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsRequestBuilder(
    ...
    public ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsGet get() {
        return new ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsGet(apiHttpClient, projectKey,
            importSinkKey);
    }

    public ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsByIdRequestBuilder withIdValue(String id) {
        return new ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsByIdRequestBuilder(apiHttpClient,
