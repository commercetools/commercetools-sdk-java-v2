...
public class ByProjectKeyPricesImportContainersByImportContainerKeyPost extends BodyApiMethod<ByProjectKeyPricesImportContainersByImportContainerKeyPost, com.commercetools.importapi.models.importrequests.ImportResponse, com.commercetools.importapi.models.importrequests.PriceImportRequest> implements com.commercetools.importapi.client.Secured_by_manage_productsTrait<ByProjectKeyPricesImportContainersByImportContainerKeyPost> {
    ...
    public ByProjectKeyPricesImportContainersByImportContainerKeyPost(final ApiHttpClient apiHttpClient, String projectKey, String importContainerKey, com.commercetools.importapi.models.importrequests.PriceImportRequest priceImportRequest) {
        super(apiHttpClient);
    ...
    public ByProjectKeyPricesImportContainersByImportContainerKeyPost(ByProjectKeyPricesImportContainersByImportContainerKeyPost t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(priceImportRequest)));
    ...
    public ByProjectKeyPricesImportContainersByImportContainerKeyPost withBody(com.commercetools.importapi.models.importrequests.PriceImportRequest priceImportRequest) {
        ByProjectKeyPricesImportContainersByImportContainerKeyPost t = copy();
