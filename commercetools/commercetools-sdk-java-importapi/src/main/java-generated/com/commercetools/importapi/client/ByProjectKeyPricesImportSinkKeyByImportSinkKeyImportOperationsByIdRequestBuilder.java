...
public class ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsByIdRequestBuilder {
    ...
    public ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsByIdRequestBuilder(
    ...
    public ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsByIdGet get() {
        return new ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsByIdGet(apiHttpClient, projectKey,
            importSinkKey, id);
    }
