...
public class ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsRequestBuilder {
    ...
    public ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsRequestBuilder(
    ...
    public ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsGet get() {
        return new ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsGet(apiHttpClient, projectKey,
            importSinkKey);
    }

    public ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsByIdRequestBuilder withIdValue(String id) {
        return new ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsByIdRequestBuilder(apiHttpClient,
