...
public class ByProjectKeyProductDraftsImportSinkKeyByImportSinkKeyImportOperationsRequestBuilder {
    ...
    public ByProjectKeyProductDraftsImportSinkKeyByImportSinkKeyImportOperationsRequestBuilder(
    ...
    public ByProjectKeyProductDraftsImportSinkKeyByImportSinkKeyImportOperationsGet get() {
        return new ByProjectKeyProductDraftsImportSinkKeyByImportSinkKeyImportOperationsGet(apiHttpClient, projectKey,
            importSinkKey);
    }

    public ByProjectKeyProductDraftsImportSinkKeyByImportSinkKeyImportOperationsByIdRequestBuilder withIdValue(
            String id) {
