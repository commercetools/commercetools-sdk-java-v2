...
public class ByProjectKeyProductVariantsImportContainersByImportContainerKeyPost extends BodyApiMethod<ByProjectKeyProductVariantsImportContainersByImportContainerKeyPost, com.commercetools.importapi.models.importrequests.ImportResponse, com.commercetools.importapi.models.importrequests.ProductVariantImportRequest> implements com.commercetools.importapi.client.Secured_by_manage_productsTrait<ByProjectKeyProductVariantsImportContainersByImportContainerKeyPost> {
    ...
    public ByProjectKeyProductVariantsImportContainersByImportContainerKeyPost(final ApiHttpClient apiHttpClient, String projectKey, String importContainerKey, com.commercetools.importapi.models.importrequests.ProductVariantImportRequest productVariantImportRequest) {
        super(apiHttpClient);
    ...
    public ByProjectKeyProductVariantsImportContainersByImportContainerKeyPost(ByProjectKeyProductVariantsImportContainersByImportContainerKeyPost t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(productVariantImportRequest)));
    ...
    public ByProjectKeyProductVariantsImportContainersByImportContainerKeyPost withBody(com.commercetools.importapi.models.importrequests.ProductVariantImportRequest productVariantImportRequest) {
