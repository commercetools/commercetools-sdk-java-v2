...
public class ByProjectKeyProductsImportContainersByImportContainerKeyPostString extends StringBodyApiMethod<ByProjectKeyProductsImportContainersByImportContainerKeyPostString, com.commercetools.importapi.models.importrequests.ImportResponse> implements com.commercetools.importapi.client.Secured_by_manage_productsTrait<ByProjectKeyProductsImportContainersByImportContainerKeyPostString> {
    ...
    public ByProjectKeyProductsImportContainersByImportContainerKeyPostString(final ApiHttpClient apiHttpClient, String projectKey, String importContainerKey, String productImportRequest) {
        super(apiHttpClient);
    ...
    public ByProjectKeyProductsImportContainersByImportContainerKeyPostString(ByProjectKeyProductsImportContainersByImportContainerKeyPostString t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), productImportRequest.getBytes(StandardCharsets.UTF_8));
