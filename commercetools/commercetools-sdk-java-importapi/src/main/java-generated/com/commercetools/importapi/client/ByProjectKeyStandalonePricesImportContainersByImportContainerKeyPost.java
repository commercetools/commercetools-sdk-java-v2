...
public class ByProjectKeyStandalonePricesImportContainersByImportContainerKeyPost extends BodyApiMethod<ByProjectKeyStandalonePricesImportContainersByImportContainerKeyPost, com.commercetools.importapi.models.importrequests.ImportResponse, com.commercetools.importapi.models.importrequests.StandalonePriceImportRequest> implements com.commercetools.importapi.client.Secured_by_manage_standalone_pricesTrait<ByProjectKeyStandalonePricesImportContainersByImportContainerKeyPost> {
    ...
    public ByProjectKeyStandalonePricesImportContainersByImportContainerKeyPost(final ApiHttpClient apiHttpClient, String projectKey, String importContainerKey, com.commercetools.importapi.models.importrequests.StandalonePriceImportRequest standalonePriceImportRequest) {
        super(apiHttpClient);
    ...
    public ByProjectKeyStandalonePricesImportContainersByImportContainerKeyPost(ByProjectKeyStandalonePricesImportContainersByImportContainerKeyPost t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(standalonePriceImportRequest)));
    ...
    public ByProjectKeyStandalonePricesImportContainersByImportContainerKeyPost withBody(com.commercetools.importapi.models.importrequests.StandalonePriceImportRequest standalonePriceImportRequest) {
