...
public class ByProjectKeyTypesImportContainersByImportContainerKeyPost extends BodyApiMethod<ByProjectKeyTypesImportContainersByImportContainerKeyPost, com.commercetools.importapi.models.importrequests.ImportResponse, com.commercetools.importapi.models.importrequests.TypeImportRequest> implements com.commercetools.importapi.client.Secured_by_manage_typesTrait<ByProjectKeyTypesImportContainersByImportContainerKeyPost> {
    ...
    public ByProjectKeyTypesImportContainersByImportContainerKeyPost(final ApiHttpClient apiHttpClient, String projectKey, String importContainerKey, com.commercetools.importapi.models.importrequests.TypeImportRequest typeImportRequest) {
        super(apiHttpClient);
    ...
    public ByProjectKeyTypesImportContainersByImportContainerKeyPost(ByProjectKeyTypesImportContainersByImportContainerKeyPost t) {
        super(t);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(typeImportRequest)));
    ...
    public ByProjectKeyTypesImportContainersByImportContainerKeyPost withBody(com.commercetools.importapi.models.importrequests.TypeImportRequest typeImportRequest) {
