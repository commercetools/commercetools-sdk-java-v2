...
public interface AssociateRoleAssignmentDraft extends io.vrap.rmf.base.client.Draft<AssociateRoleAssignmentDraft> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AssociateRoleAssignmentDraft> typeReference() {
        return new tools.jackson.core.type.TypeReference<AssociateRoleAssignmentDraft>() {
            @Override
