...
public interface CompanyBusinessUnitImport extends BusinessUnitImport {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CompanyBusinessUnitImport> typeReference() {
        return new tools.jackson.core.type.TypeReference<CompanyBusinessUnitImport>() {
            @Override
