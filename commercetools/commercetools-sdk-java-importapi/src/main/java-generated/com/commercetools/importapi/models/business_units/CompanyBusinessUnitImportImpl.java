...
/**
 *  <p>Represents a Company, the top-level of a business.</p>
 */
@Generated(value = "io.vrap.rmf.codegen.rendering.CoreCodeGenerator", comments = "https://github.com/commercetools/rmf-codegen")
public class CompanyBusinessUnitImportImpl implements CompanyBusinessUnitImport, ModelBase {
     ...
     */
    @JsonCreator
    CompanyBusinessUnitImportImpl(@JsonProperty("key") final String key, @JsonProperty("name") final String name,
     ...
     */
    public CompanyBusinessUnitImportImpl() {
        this.unitType = BusinessUnitType.findEnum("Company");
    }
    ...
    public boolean equals(Object o) {
        ...
        CompanyBusinessUnitImportImpl that = (CompanyBusinessUnitImportImpl) o;
    ...
    public CompanyBusinessUnitImport copyDeep() {
        return CompanyBusinessUnitImport.deepCopy(this);
    }
}
