...
public class DivisionBusinessUnitImportBuilder implements Builder<DivisionBusinessUnitImport> {
    ...
    public DivisionBusinessUnitImportBuilder key(final String key) {
        this.key = key;
        return this;
    }
    ...
    public DivisionBusinessUnitImportBuilder name(final String name) {
        this.name = name;
        return this;
    }
    ...
    public DivisionBusinessUnitImportBuilder status(
    ...
    public DivisionBusinessUnitImportBuilder contactEmail(@Nullable final String contactEmail) {
    ...
    public DivisionBusinessUnitImportBuilder associates(
    ...
    public DivisionBusinessUnitImportBuilder plusAssociates(
            @Nullable final com.commercetools.importapi.models.business_units.AssociateDraft... associates) {
    ...
    public DivisionBusinessUnitImportBuilder withAssociates(
            Function<com.commercetools.importapi.models.business_units.AssociateDraftBuilder, com.commercetools.importapi.models.business_units.AssociateDraftBuilder> builder) {
        this.associates = new ArrayList<>();
        this.associates.add(
            builder.apply(com.commercetools.importapi.models.business_units.AssociateDraftBuilder.of()).build());
    ...
    public DivisionBusinessUnitImportBuilder addAssociates(
    ...
    public DivisionBusinessUnitImportBuilder setAssociates(
            Function<com.commercetools.importapi.models.business_units.AssociateDraftBuilder, com.commercetools.importapi.models.business_units.AssociateDraft> builder) {
    ...
    public DivisionBusinessUnitImportBuilder addresses(
    ...
    public DivisionBusinessUnitImportBuilder plusAddresses(
            @Nullable final com.commercetools.importapi.models.common.Address... addresses) {
    ...
    public DivisionBusinessUnitImportBuilder withAddresses(
            Function<com.commercetools.importapi.models.common.AddressBuilder, com.commercetools.importapi.models.common.AddressBuilder> builder) {
        this.addresses = new ArrayList<>();
        this.addresses.add(builder.apply(com.commercetools.importapi.models.common.AddressBuilder.of()).build());
        return this;
    ...
    public DivisionBusinessUnitImportBuilder addAddresses(
    ...
    public DivisionBusinessUnitImportBuilder setAddresses(
            Function<com.commercetools.importapi.models.common.AddressBuilder, com.commercetools.importapi.models.common.Address> builder) {
    ...
    public DivisionBusinessUnitImportBuilder shippingAddresses(@Nullable final Integer... shippingAddresses) {
    ...
    public DivisionBusinessUnitImportBuilder shippingAddresses(
    ...
    public DivisionBusinessUnitImportBuilder plusShippingAddresses(@Nullable final Integer... shippingAddresses) {
    ...
    public DivisionBusinessUnitImportBuilder defaultShippingAddress(@Nullable final Integer defaultShippingAddress) {
    ...
    public DivisionBusinessUnitImportBuilder billingAddresses(@Nullable final Integer... billingAddresses) {
    ...
    public DivisionBusinessUnitImportBuilder billingAddresses(
            @Nullable final java.util.List<Integer> billingAddresses) {
    ...
    public DivisionBusinessUnitImportBuilder plusBillingAddresses(@Nullable final Integer... billingAddresses) {
    ...
    public DivisionBusinessUnitImportBuilder defaultBillingAddress(@Nullable final Integer defaultBillingAddress) {
    ...
    public DivisionBusinessUnitImportBuilder stores(
    ...
    public DivisionBusinessUnitImportBuilder plusStores(
            @Nullable final com.commercetools.importapi.models.common.StoreKeyReference... stores) {
        if (this.stores == null) {
    ...
    public DivisionBusinessUnitImportBuilder withStores(
            Function<com.commercetools.importapi.models.common.StoreKeyReferenceBuilder, com.commercetools.importapi.models.common.StoreKeyReferenceBuilder> builder) {
        this.stores = new ArrayList<>();
        this.stores.add(builder.apply(com.commercetools.importapi.models.common.StoreKeyReferenceBuilder.of()).build());
        return this;
    ...
    public DivisionBusinessUnitImportBuilder addStores(
    ...
    public DivisionBusinessUnitImportBuilder setStores(
            Function<com.commercetools.importapi.models.common.StoreKeyReferenceBuilder, com.commercetools.importapi.models.common.StoreKeyReference> builder) {
    ...
    public DivisionBusinessUnitImportBuilder custom(
    ...
    public DivisionBusinessUnitImportBuilder withCustom(
    ...
    public DivisionBusinessUnitImportBuilder storeMode(
    ...
    public DivisionBusinessUnitImportBuilder parentUnit(
            Function<com.commercetools.importapi.models.common.BusinessUnitKeyReferenceBuilder, com.commercetools.importapi.models.common.BusinessUnitKeyReferenceBuilder> builder) {
        this.parentUnit = builder.apply(com.commercetools.importapi.models.common.BusinessUnitKeyReferenceBuilder.of())
                .build();
        return this;
    }
    ...
    public DivisionBusinessUnitImportBuilder withParentUnit(
            Function<com.commercetools.importapi.models.common.BusinessUnitKeyReferenceBuilder, com.commercetools.importapi.models.common.BusinessUnitKeyReference> builder) {
        this.parentUnit = builder.apply(com.commercetools.importapi.models.common.BusinessUnitKeyReferenceBuilder.of());
        return this;
    }
    ...
    public DivisionBusinessUnitImportBuilder parentUnit(
            final com.commercetools.importapi.models.common.BusinessUnitKeyReference parentUnit) {
    ...
    public DivisionBusinessUnitImportBuilder associateMode(
            @Nullable final com.commercetools.importapi.models.business_units.BusinessUnitAssociateMode associateMode) {
    ...
    public DivisionBusinessUnitImportBuilder approvalRuleMode(
            @Nullable final com.commercetools.importapi.models.business_units.BusinessUnitApprovalRuleMode approvalRuleMode) {
    ...
    /**
     * builds DivisionBusinessUnitImport with checking for non-null required values
     * @return DivisionBusinessUnitImport
     */
    public DivisionBusinessUnitImport build() {
        Objects.requireNonNull(key, DivisionBusinessUnitImport.class + ": key is missing");
        Objects.requireNonNull(name, DivisionBusinessUnitImport.class + ": name is missing");
        Objects.requireNonNull(parentUnit, DivisionBusinessUnitImport.class + ": parentUnit is missing");
        return new DivisionBusinessUnitImportImpl(key, name, status, contactEmail, associates, addresses,
            shippingAddresses, defaultShippingAddress, billingAddresses, defaultBillingAddress, stores, custom,
            storeMode, parentUnit, associateMode, approvalRuleMode);
    }

    /**
     * builds DivisionBusinessUnitImport without checking for non-null required values
     * @return DivisionBusinessUnitImport
     */
    public DivisionBusinessUnitImport buildUnchecked() {
        return new DivisionBusinessUnitImportImpl(key, name, status, contactEmail, associates, addresses,
            shippingAddresses, defaultShippingAddress, billingAddresses, defaultBillingAddress, stores, custom,
            storeMode, parentUnit, associateMode, approvalRuleMode);
    }
    ...
    /**
     * factory method for an instance of DivisionBusinessUnitImportBuilder
     * @return builder
     */
    public static DivisionBusinessUnitImportBuilder of() {
        return new DivisionBusinessUnitImportBuilder();
    }
     ...
     * @return builder
     */
    public static DivisionBusinessUnitImportBuilder of(final DivisionBusinessUnitImport template) {
        DivisionBusinessUnitImportBuilder builder = new DivisionBusinessUnitImportBuilder();
