...
/**
 *  <p>Used by the <span>Import API</span> to identify a Cart</p>
 *
 * <hr>
...
public interface CartKeyReference extends KeyReference {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CartKeyReference> typeReference() {
        return new tools.jackson.core.type.TypeReference<CartKeyReference>() {
            @Override
