...
public interface ChannelKeyReference extends KeyReference {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ChannelKeyReference> typeReference() {
        return new tools.jackson.core.type.TypeReference<ChannelKeyReference>() {
            @Override
