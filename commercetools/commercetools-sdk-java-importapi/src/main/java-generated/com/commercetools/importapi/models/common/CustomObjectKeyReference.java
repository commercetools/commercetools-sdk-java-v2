...
public interface CustomObjectKeyReference extends KeyReference {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomObjectKeyReference> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomObjectKeyReference>() {
            @Override
