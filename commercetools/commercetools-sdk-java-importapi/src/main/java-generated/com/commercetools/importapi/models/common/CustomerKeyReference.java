...
/**
 *  <p>Used by the <span>Import API</span> to identify a Customer.</p>
 *
 * <hr>
...
public interface CustomerKeyReference extends KeyReference {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomerKeyReference> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomerKeyReference>() {
            @Override
