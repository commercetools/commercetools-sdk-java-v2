...
/**
 *  <p>Used by the <span>Import API</span> to identify a DiscountCode.</p>
 *
 * <hr>
...
public interface DiscountCodeKeyReference extends KeyReference {
     ...
     */
    public static tools.jackson.core.type.TypeReference<DiscountCodeKeyReference> typeReference() {
        return new tools.jackson.core.type.TypeReference<DiscountCodeKeyReference>() {
            @Override
