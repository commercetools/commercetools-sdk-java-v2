...
public interface ProductTypeKeyReference extends KeyReference {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductTypeKeyReference> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductTypeKeyReference>() {
            @Override
