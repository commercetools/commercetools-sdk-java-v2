...
/**
 *  <p>Used by the <span>Import API</span> to identify a Type.</p>
 *
 * <hr>
...
public interface TypeKeyReference extends KeyReference {
     ...
     */
    public static tools.jackson.core.type.TypeReference<TypeKeyReference> typeReference() {
        return new tools.jackson.core.type.TypeReference<TypeKeyReference>() {
            @Override
