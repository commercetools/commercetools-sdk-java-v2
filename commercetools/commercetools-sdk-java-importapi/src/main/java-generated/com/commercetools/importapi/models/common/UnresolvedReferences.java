...
public interface UnresolvedReferences {
     ...
     */
    public static tools.jackson.core.type.TypeReference<UnresolvedReferences> typeReference() {
        return new tools.jackson.core.type.TypeReference<UnresolvedReferences>() {
            @Override
