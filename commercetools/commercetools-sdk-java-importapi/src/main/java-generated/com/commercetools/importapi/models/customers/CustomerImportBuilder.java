...
public final class CustomerImportBuilder {
    ...
    public CustomerImportBuilder addresses(@Nullable final java.util.List<com.commercetools.importapi.models.common.Address> addresses) {
        this.addresses = addresses;
        return this;
    }
    
    public CustomerImportBuilder defaultBillingAddress(@Nullable final com.commercetools.importapi.models.common.Address defaultBillingAddress) {
        this.defaultBillingAddress = defaultBillingAddress;
        return this;
    }
    
    public CustomerImportBuilder billingAddresses(@Nullable final com.commercetools.importapi.models.common.Address billingAddresses) {
        this.billingAddresses = billingAddresses;
        return this;
    }
    
    public CustomerImportBuilder defaultShippingAddress(@Nullable final com.commercetools.importapi.models.common.Address defaultShippingAddress) {
        this.defaultShippingAddress = defaultShippingAddress;
        return this;
    }
    
    public CustomerImportBuilder shippingAddresses(@Nullable final com.commercetools.importapi.models.common.Address shippingAddresses) {
