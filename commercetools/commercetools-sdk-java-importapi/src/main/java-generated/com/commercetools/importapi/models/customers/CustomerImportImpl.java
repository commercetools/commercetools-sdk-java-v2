...
public final class CustomerImportImpl implements CustomerImport {
    ...
    @JsonCreator
    CustomerImportImpl(@JsonProperty("key") final String key, @JsonProperty("customerNumber") final String customerNumber, @JsonProperty("email") final String email, @JsonProperty("password") final String password, @JsonProperty("firstName") final String firstName, @JsonProperty("lastName") final String lastName, @JsonProperty("middleName") final String middleName, @JsonProperty("title") final String title, @JsonProperty("salutation") final String salutation, @JsonProperty("externalId") final String externalId, @JsonProperty("dateOfBirth") final java.time.LocalDate dateOfBirth, @JsonProperty("companyName") final String companyName, @JsonProperty("vatId") final String vatId, @JsonProperty("isEmailVerified") final Boolean isEmailVerified, @JsonProperty("customerGroup") final com.commercetools.importapi.models.common.CustomerGroupKeyReference customerGroup, @JsonProperty("addresses") final java.util.List<com.commercetools.importapi.models.common.Address> addresses, @JsonProperty("defaultBillingAddress") final com.commercetools.importapi.models.common.Address defaultBillingAddress, @JsonProperty("billingAddresses") final com.commercetools.importapi.models.common.Address billingAddresses, @JsonProperty("defaultShippingAddress") final com.commercetools.importapi.models.common.Address defaultShippingAddress, @JsonProperty("shippingAddresses") final com.commercetools.importapi.models.common.Address shippingAddresses, @JsonProperty("locale") final String locale, @JsonProperty("custom") final com.commercetools.importapi.models.customfields.Custom custom) {
        this.key = key;
