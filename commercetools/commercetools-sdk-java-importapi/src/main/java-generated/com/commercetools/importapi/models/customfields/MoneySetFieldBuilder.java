...
public class MoneySetFieldBuilder implements Builder<MoneySetField> {
    ...
    public MoneySetFieldBuilder plusValue(Function<com.commercetools.importapi.models.common.MoneyBuilder, com.commercetools.importapi.models.common.MoneyBuilder> builder) {
        if (this.value == null) {
            this.value = new ArrayList<>();
        }
    ...
    public MoneySetFieldBuilder withValue(Function<com.commercetools.importapi.models.common.MoneyBuilder, com.commercetools.importapi.models.common.MoneyBuilder> builder) {
        this.value = new ArrayList<>();
        this.value.add(builder.apply(com.commercetools.importapi.models.common.MoneyBuilder.of()).build());
        return this;
    }
    ...
    public MoneySetFieldBuilder addValue(Function<com.commercetools.importapi.models.common.MoneyBuilder, com.commercetools.importapi.models.common.Money> builder) {
    ...
    public MoneySetFieldBuilder setValue(Function<com.commercetools.importapi.models.common.MoneyBuilder, com.commercetools.importapi.models.common.Money> builder) {
