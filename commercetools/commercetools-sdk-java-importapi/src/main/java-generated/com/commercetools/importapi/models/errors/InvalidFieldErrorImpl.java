...
public class InvalidFieldErrorImpl implements InvalidFieldError, ModelBase {
     ...
     */
    @JsonCreator
    InvalidFieldErrorImpl(@JsonProperty("message") final String message, @JsonProperty("field") final String field, @JsonProperty("invalidValue") final java.lang.Object invalidValue, @JsonProperty("allowedValues") final java.util.List<java.lang.Object> allowedValues, @JsonProperty("resourceIndex") final Long resourceIndex) {
