...
public interface InvalidFieldsUpdateError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<InvalidFieldsUpdateError> typeReference() {
        return new tools.jackson.core.type.TypeReference<InvalidFieldsUpdateError>() {
            @Override
