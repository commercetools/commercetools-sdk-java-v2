...
public interface NewMasterVariantAdditionNotAllowedError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<NewMasterVariantAdditionNotAllowedError> typeReference() {
        return new tools.jackson.core.type.TypeReference<NewMasterVariantAdditionNotAllowedError>() {
            @Override
