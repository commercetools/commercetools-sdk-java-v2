...
public interface ResourceCreationError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ResourceCreationError> typeReference() {
        return new tools.jackson.core.type.TypeReference<ResourceCreationError>() {
            @Override
