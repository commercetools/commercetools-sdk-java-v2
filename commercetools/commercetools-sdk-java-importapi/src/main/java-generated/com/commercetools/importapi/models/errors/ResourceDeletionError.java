...
public interface ResourceDeletionError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ResourceDeletionError> typeReference() {
        return new tools.jackson.core.type.TypeReference<ResourceDeletionError>() {
            @Override
