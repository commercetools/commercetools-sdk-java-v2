...
public interface ResourceUpdateError extends ErrorObject {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ResourceUpdateError> typeReference() {
        return new tools.jackson.core.type.TypeReference<ResourceUpdateError>() {
            @Override
