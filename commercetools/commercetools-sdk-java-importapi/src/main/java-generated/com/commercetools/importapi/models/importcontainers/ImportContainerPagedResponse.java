...
import com.commercetools.importapi.models.importcontainers.ImportContainerPagedResponseImpl;
...
public interface ImportContainerPagedResponse  {
    ...
    public static ImportContainerPagedResponse deepCopy(@Nullable final ImportContainerPagedResponse template) {
        ...
        instance.setResults(Optional.ofNullable(template.getResults())
                .map(t -> t.stream().map(com.commercetools.importapi.models.importcontainers.ImportContainer::deepCopy).collect(Collectors.toList()))
                .orElse(null));
        return instance;
    }
