...
public interface TimeToLiveRetentionPolicy extends RetentionPolicy {
     ...
     */
    public static tools.jackson.core.type.TypeReference<TimeToLiveRetentionPolicy> typeReference() {
        return new tools.jackson.core.type.TypeReference<TimeToLiveRetentionPolicy>() {
            @Override
