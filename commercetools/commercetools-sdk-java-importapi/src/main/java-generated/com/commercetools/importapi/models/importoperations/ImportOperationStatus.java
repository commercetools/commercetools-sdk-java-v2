...
public interface ImportOperationStatus {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ImportOperationStatus> typeReference() {
        return new tools.jackson.core.type.TypeReference<ImportOperationStatus>() {
            @Override
