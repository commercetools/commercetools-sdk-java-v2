...
public interface BusinessUnitImportRequest extends ImportRequest {
     ...
     */
    public static tools.jackson.core.type.TypeReference<BusinessUnitImportRequest> typeReference() {
        return new tools.jackson.core.type.TypeReference<BusinessUnitImportRequest>() {
            @Override
