...
public class ProductTailoringImportRequestImpl implements ProductTailoringImportRequest, ModelBase {
     ...
     */
    @JsonCreator
    ProductTailoringImportRequestImpl(
            @JsonProperty("resources") final java.util.List<com.commercetools.importapi.models.product_tailoring.ProductTailoringImport> resources) {
        this.resources = resources;
        this.type = ImportResourceType.findEnum("product-tailoring");
    }

    /**
     * create empty instance
     */
    public ProductTailoringImportRequestImpl() {
        this.type = ImportResourceType.findEnum("product-tailoring");
    }
    ...
    public boolean equals(Object o) {
        ...
        ProductTailoringImportRequestImpl that = (ProductTailoringImportRequestImpl) o;
    ...
    public ProductTailoringImportRequest copyDeep() {
        return ProductTailoringImportRequest.deepCopy(this);
    }
}
