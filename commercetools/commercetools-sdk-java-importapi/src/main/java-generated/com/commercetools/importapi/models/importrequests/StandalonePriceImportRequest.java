...
public interface StandalonePriceImportRequest extends ImportRequest {
     ...
     */
    public static tools.jackson.core.type.TypeReference<StandalonePriceImportRequest> typeReference() {
        return new tools.jackson.core.type.TypeReference<StandalonePriceImportRequest>() {
            @Override
