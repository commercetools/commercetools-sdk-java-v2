...
public class StandalonePriceImportRequestImpl implements StandalonePriceImportRequest, ModelBase {
     ...
     */
    @JsonCreator
    StandalonePriceImportRequestImpl(@JsonProperty("resources") final java.util.List<com.commercetools.importapi.models.standalone_prices.StandalonePriceImport> resources) {
    ...
    public void setResources(final com.commercetools.importapi.models.standalone_prices.StandalonePriceImport ...resources){
       this.resources = new ArrayList<>(Arrays.asList(resources));
    }
    
    
    public void setResources(final java.util.List<com.commercetools.importapi.models.standalone_prices.StandalonePriceImport> resources){
       this.resources = resources;
    }
