...
public final class InventoryImportImpl implements InventoryImport {
    ...
    @JsonCreator
    InventoryImportImpl(@JsonProperty("key") final String key, @JsonProperty("sku") final String sku, @JsonProperty("quantityOnStock") final Double quantityOnStock, @JsonProperty("restockableInDays") final Double restockableInDays, @JsonProperty("expectedDelivery") final java.time.ZonedDateTime expectedDelivery, @JsonProperty("supplyChannel") final com.commercetools.importapi.models.common.ChannelKeyReference supplyChannel, @JsonProperty("custom") final com.commercetools.importapi.models.customfields.Custom custom) {
        this.key = key;
        this.sku = sku;
