...
public class OrderFieldImpl implements OrderField, ModelBase {
     ...
     */
    @JsonCreator
    OrderFieldImpl(@JsonProperty("addReturnInfo") final com.commercetools.importapi.models.order_patches.ReturnInfo addReturnInfo, @JsonProperty("addParcelToDelivery") final com.commercetools.importapi.models.order_patches.DeliveryParcel addParcelToDelivery, @JsonProperty("addDeliveries") final java.util.List<com.commercetools.importapi.models.order_patches.DeliveryDraft> addDeliveries, @JsonProperty("removeDelivery") final com.commercetools.importapi.models.order_patches.RemoveDeliveryDraft removeDelivery, @JsonProperty("removeParcelFromDelivery") final com.commercetools.importapi.models.order_patches.RemoveParcelFromDeliveryDraft removeParcelFromDelivery, @JsonProperty("setDeliveryAddress") final com.commercetools.importapi.models.order_patches.DeliveryAddressDraft setDeliveryAddress, @JsonProperty("setParcelMeasurements") final com.commercetools.importapi.models.order_patches.ParcelMeasurementDraft setParcelMeasurements, @JsonProperty("setParcelTrackingData") final com.commercetools.importapi.models.order_patches.ParcelTrackingData setParcelTrackingData, @JsonProperty("setParcelItems") final java.util.List<com.commercetools.importapi.models.order_patches.ParcelItems> setParcelItems) {
    ...
    public void setAddParcelToDelivery(final com.commercetools.importapi.models.order_patches.DeliveryParcel addParcelToDelivery){
        this.addParcelToDelivery = addParcelToDelivery;
    }
    
    
    public void setAddDeliveries(final com.commercetools.importapi.models.order_patches.DeliveryDraft ...addDeliveries){
       this.addDeliveries = new ArrayList<>(Arrays.asList(addDeliveries));
    }
    
    
    public void setAddDeliveries(final java.util.List<com.commercetools.importapi.models.order_patches.DeliveryDraft> addDeliveries){
       this.addDeliveries = addDeliveries;
    }
    
    
    public void setRemoveDelivery(final com.commercetools.importapi.models.order_patches.RemoveDeliveryDraft removeDelivery){
        this.removeDelivery = removeDelivery;
    }
    
    
    public void setRemoveParcelFromDelivery(final com.commercetools.importapi.models.order_patches.RemoveParcelFromDeliveryDraft removeParcelFromDelivery){
        this.removeParcelFromDelivery = removeParcelFromDelivery;
    }
    
    
    public void setSetDeliveryAddress(final com.commercetools.importapi.models.order_patches.DeliveryAddressDraft setDeliveryAddress){
        this.setDeliveryAddress = setDeliveryAddress;
    }
    
    
    public void setSetParcelMeasurements(final com.commercetools.importapi.models.order_patches.ParcelMeasurementDraft setParcelMeasurements){
        this.setParcelMeasurements = setParcelMeasurements;
    }
    
    
    public void setSetParcelTrackingData(final com.commercetools.importapi.models.order_patches.ParcelTrackingData setParcelTrackingData){
        this.setParcelTrackingData = setParcelTrackingData;
    }
    
    
    public void setSetParcelItems(final com.commercetools.importapi.models.order_patches.ParcelItems ...setParcelItems){
       this.setParcelItems = new ArrayList<>(Arrays.asList(setParcelItems));
    }
    
    
    public void setSetParcelItems(final java.util.List<com.commercetools.importapi.models.order_patches.ParcelItems> setParcelItems){
       this.setParcelItems = setParcelItems;
    }
