...
public class ParcelItemsImpl implements ParcelItems, ModelBase {
     ...
     */
    @JsonCreator
    ParcelItemsImpl(@JsonProperty("parcelId") final String parcelId, @JsonProperty("items") final java.util.List<com.commercetools.importapi.models.orders.DeliveryItem> items) {
