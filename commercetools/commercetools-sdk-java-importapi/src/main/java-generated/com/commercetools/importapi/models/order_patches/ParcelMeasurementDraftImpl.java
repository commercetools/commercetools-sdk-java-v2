...
public class ParcelMeasurementDraftImpl implements ParcelMeasurementDraft, ModelBase {
     ...
     */
    @JsonCreator
    ParcelMeasurementDraftImpl(@JsonProperty("parcelId") final String parcelId, @JsonProperty("measurements") final com.commercetools.importapi.models.orders.ParcelMeasurements measurements) {
