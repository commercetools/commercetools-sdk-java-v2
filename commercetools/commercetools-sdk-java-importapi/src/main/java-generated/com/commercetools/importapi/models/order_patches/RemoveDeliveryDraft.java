...
public interface RemoveDeliveryDraft extends io.vrap.rmf.base.client.Draft<RemoveDeliveryDraft> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RemoveDeliveryDraft> typeReference() {
        return new tools.jackson.core.type.TypeReference<RemoveDeliveryDraft>() {
            @Override
