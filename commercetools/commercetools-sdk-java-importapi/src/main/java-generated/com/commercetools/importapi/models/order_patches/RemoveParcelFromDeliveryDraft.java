...
public interface RemoveParcelFromDeliveryDraft extends io.vrap.rmf.base.client.Draft<RemoveParcelFromDeliveryDraft> {
     ...
     */
    public static tools.jackson.core.type.TypeReference<RemoveParcelFromDeliveryDraft> typeReference() {
        return new tools.jackson.core.type.TypeReference<RemoveParcelFromDeliveryDraft>() {
            @Override
