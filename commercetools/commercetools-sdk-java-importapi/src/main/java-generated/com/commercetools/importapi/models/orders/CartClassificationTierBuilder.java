...
public class CartClassificationTierBuilder implements Builder<CartClassificationTier> {
    ...
    public CartClassificationTierBuilder price(Function<com.commercetools.importapi.models.common.MoneyBuilder, com.commercetools.importapi.models.common.MoneyBuilder> builder) {
    ...
    public CartClassificationTierBuilder withPrice(Function<com.commercetools.importapi.models.common.MoneyBuilder, com.commercetools.importapi.models.common.Money> builder) {
    ...
    public CartClassificationTierBuilder plusTiers( final com.commercetools.importapi.models.orders.ShippingRatePriceTier ...tiers) {
        if (this.tiers == null) {
    ...
    public CartClassificationTierBuilder plusTiers(Function<com.commercetools.importapi.models.orders.ShippingRatePriceTierBuilder, Builder<? extends com.commercetools.importapi.models.orders.ShippingRatePriceTier>> builder) {
        if (this.tiers == null) {
            this.tiers = new ArrayList<>();
        }
    ...
    public CartClassificationTierBuilder withTiers(Function<com.commercetools.importapi.models.orders.ShippingRatePriceTierBuilder, Builder<? extends com.commercetools.importapi.models.orders.ShippingRatePriceTier>> builder) {
        this.tiers = new ArrayList<>();
        this.tiers.add(builder.apply(com.commercetools.importapi.models.orders.ShippingRatePriceTierBuilder.of()).build());
        return this;
    }
