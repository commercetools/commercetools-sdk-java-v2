...
public interface ClassificationShippingRateInput extends ShippingRateInput {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ClassificationShippingRateInput> typeReference() {
        return new tools.jackson.core.type.TypeReference<ClassificationShippingRateInput>() {
            @Override
