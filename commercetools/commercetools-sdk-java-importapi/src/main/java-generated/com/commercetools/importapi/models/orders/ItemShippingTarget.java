...
public interface ItemShippingTarget {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ItemShippingTarget> typeReference() {
        return new tools.jackson.core.type.TypeReference<ItemShippingTarget>() {
            @Override
