...
public class OrderImportImpl implements OrderImport, ModelBase {
     ...
     */
    @JsonCreator
    OrderImportImpl(@JsonProperty("orderNumber") final String orderNumber, @JsonProperty("customer") final com.commercetools.importapi.models.common.CustomerKeyReference customer, @JsonProperty("customerEmail") final String customerEmail, @JsonProperty("lineItems") final java.util.List<com.commercetools.importapi.models.orders.LineItemImportDraft> lineItems, @JsonProperty("customLineItems") final java.util.List<com.commercetools.importapi.models.orders.CustomLineItemDraft> customLineItems, @JsonProperty("totalPrice") final com.commercetools.importapi.models.common.TypedMoney totalPrice, @JsonProperty("taxedPrice") final com.commercetools.importapi.models.orders.TaxedPrice taxedPrice, @JsonProperty("shippingAddress") final com.commercetools.importapi.models.common.Address shippingAddress, @JsonProperty("billingAddress") final com.commercetools.importapi.models.common.Address billingAddress, @JsonProperty("customerGroup") final com.commercetools.importapi.models.common.CustomerGroupKeyReference customerGroup, @JsonProperty("country") final String country, @JsonProperty("orderState") final com.commercetools.importapi.models.orders.OrderState orderState, @JsonProperty("shipmentState") final com.commercetools.importapi.models.orders.ShipmentState shipmentState, @JsonProperty("paymentState") final com.commercetools.importapi.models.orders.PaymentState paymentState, @JsonProperty("shippingInfo") final com.commercetools.importapi.models.orders.ShippingInfoImportDraft shippingInfo, @JsonProperty("completedAt") final java.time.ZonedDateTime completedAt, @JsonProperty("custom") final com.commercetools.importapi.models.customfields.Custom custom, @JsonProperty("inventoryMode") final com.commercetools.importapi.models.orders.InventoryMode inventoryMode, @JsonProperty("taxRoundingMode") final com.commercetools.importapi.models.orders.RoundingMode taxRoundingMode, @JsonProperty("taxCalculationMode") final com.commercetools.importapi.models.orders.TaxCalculationMode taxCalculationMode, @JsonProperty("origin") final com.commercetools.importapi.models.orders.CartOrigin origin, @JsonProperty("itemShippingAddresses") final java.util.List<com.commercetools.importapi.models.common.Address> itemShippingAddresses, @JsonProperty("store") final com.commercetools.importapi.models.common.StoreKeyReference store, @JsonProperty("state") final com.commercetools.importapi.models.common.StateKeyReference state) {
    ...
    public void setTaxCalculationMode(final com.commercetools.importapi.models.orders.TaxCalculationMode taxCalculationMode){
        this.taxCalculationMode = taxCalculationMode;
    }
