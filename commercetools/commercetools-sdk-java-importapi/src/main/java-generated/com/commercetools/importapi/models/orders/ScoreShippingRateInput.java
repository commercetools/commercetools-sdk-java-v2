...
public interface ScoreShippingRateInput extends ShippingRateInput {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ScoreShippingRateInput> typeReference() {
        return new tools.jackson.core.type.TypeReference<ScoreShippingRateInput>() {
            @Override
