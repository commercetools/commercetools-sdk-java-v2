...
public interface ShippingRatePriceTier {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ShippingRatePriceTier> typeReference() {
        return new tools.jackson.core.type.TypeReference<ShippingRatePriceTier>() {
            @Override
