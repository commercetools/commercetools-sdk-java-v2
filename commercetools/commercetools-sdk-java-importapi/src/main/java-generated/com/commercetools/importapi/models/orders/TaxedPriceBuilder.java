...
public class TaxedPriceBuilder implements Builder<TaxedPrice> {
    ...
    public TaxedPriceBuilder totalNet(Function<com.commercetools.importapi.models.common.MoneyBuilder, com.commercetools.importapi.models.common.MoneyBuilder> builder) {
    ...
    public TaxedPriceBuilder withTotalNet(Function<com.commercetools.importapi.models.common.MoneyBuilder, com.commercetools.importapi.models.common.Money> builder) {
    ...
    public TaxedPriceBuilder totalGross(Function<com.commercetools.importapi.models.common.MoneyBuilder, com.commercetools.importapi.models.common.MoneyBuilder> builder) {
    ...
    public TaxedPriceBuilder withTotalGross(Function<com.commercetools.importapi.models.common.MoneyBuilder, com.commercetools.importapi.models.common.Money> builder) {
    ...
    public TaxedPriceBuilder plusTaxPortions( final com.commercetools.importapi.models.orders.TaxPortion ...taxPortions) {
    ...
    public TaxedPriceBuilder plusTaxPortions(Function<com.commercetools.importapi.models.orders.TaxPortionBuilder, com.commercetools.importapi.models.orders.TaxPortionBuilder> builder) {
        if (this.taxPortions == null) {
            this.taxPortions = new ArrayList<>();
        }
    ...
    public TaxedPriceBuilder withTaxPortions(Function<com.commercetools.importapi.models.orders.TaxPortionBuilder, com.commercetools.importapi.models.orders.TaxPortionBuilder> builder) {
        this.taxPortions = new ArrayList<>();
        this.taxPortions.add(builder.apply(com.commercetools.importapi.models.orders.TaxPortionBuilder.of()).build());
        return this;
    }
    ...
    public TaxedPriceBuilder addTaxPortions(Function<com.commercetools.importapi.models.orders.TaxPortionBuilder, com.commercetools.importapi.models.orders.TaxPortion> builder) {
    ...
    public TaxedPriceBuilder setTaxPortions(Function<com.commercetools.importapi.models.orders.TaxPortionBuilder, com.commercetools.importapi.models.orders.TaxPortion> builder) {
