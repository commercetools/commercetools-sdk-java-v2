...
public interface ProductVariantTailoringImport {
     ...
     */
    public static com.fasterxml.jackson.core.type.TypeReference<ProductVariantTailoringImport> typeReference() {
        return new com.fasterxml.jackson.core.type.TypeReference<ProductVariantTailoringImport>() {
            @Override
