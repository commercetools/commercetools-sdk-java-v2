...
public interface ProductVariantDraftImport {
     ...
     */
    public static tools.jackson.core.type.TypeReference<ProductVariantDraftImport> typeReference() {
        return new tools.jackson.core.type.TypeReference<ProductVariantDraftImport>() {
            @Override
