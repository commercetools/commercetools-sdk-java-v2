...
public interface AttributeNumberType extends AttributeType {
     ...
     */
    public static tools.jackson.core.type.TypeReference<AttributeNumberType> typeReference() {
        return new tools.jackson.core.type.TypeReference<AttributeNumberType>() {
            @Override
