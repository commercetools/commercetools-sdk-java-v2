...
public final class LocalizableTextSetAttributeImpl implements LocalizableTextSetAttribute {
    ...
    @JsonCreator
    LocalizableTextSetAttributeImpl(@JsonProperty("name") final String name, @JsonProperty("value") final java.util.List<com.commercetools.importapi.models.common.LocalizedString> value) {
        this.name = name;
        this.value = value;
        this.type = "ltext-set";
    }
