...
public final class MoneySetAttributeImpl implements MoneySetAttribute {
    ...
    @JsonCreator
    MoneySetAttributeImpl(@JsonProperty("name") final String name, @JsonProperty("value") final java.util.List<com.commercetools.importapi.models.common.TypedMoney> value) {
        this.name = name;
        this.value = value;
        this.type = "money-set";
    }
