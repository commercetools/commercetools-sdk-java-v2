...
public class CustomFieldLocalizedEnumTypeImpl implements CustomFieldLocalizedEnumType, ModelBase {
     ...
     */
    @JsonCreator
    CustomFieldLocalizedEnumTypeImpl(@JsonProperty("values") final java.util.List<com.commercetools.importapi.models.types.CustomFieldLocalizedEnumValue> values) {
        this.values = values;
    ...
    public void setValues(final java.util.List<com.commercetools.importapi.models.types.CustomFieldLocalizedEnumValue> values){
       this.values = values;
    }
