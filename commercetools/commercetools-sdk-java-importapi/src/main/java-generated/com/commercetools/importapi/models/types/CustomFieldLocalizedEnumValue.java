...
/**
 *  <p>Defines an allowed value of a <a href="https://docs.commercetools.com/apis/ctp:import:type:CustomFieldLocalizedEnumType" rel="nofollow">CustomFieldLocalizedEnumType</a> field.</p>
 *
 * <hr>
...
public interface CustomFieldLocalizedEnumValue {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomFieldLocalizedEnumValue> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomFieldLocalizedEnumValue>() {
            @Override
