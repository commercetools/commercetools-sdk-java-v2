...
public interface CustomFieldLocalizedStringType extends FieldType {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomFieldLocalizedStringType> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomFieldLocalizedStringType>() {
            @Override
