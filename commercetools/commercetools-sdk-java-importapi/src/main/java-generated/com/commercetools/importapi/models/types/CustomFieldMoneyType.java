...
/**
 *  <p>Field type for <a href="https://docs.commercetools.com/apis/ctp:api:type:CentPrecisionMoney" rel="nofollow">CentPrecisionMoney</a> values.</p>
 *
 * <hr>
...
public interface CustomFieldMoneyType extends FieldType {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomFieldMoneyType> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomFieldMoneyType>() {
            @Override
