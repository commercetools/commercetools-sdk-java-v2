...
public interface CustomFieldStringType extends FieldType {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomFieldStringType> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomFieldStringType>() {
            @Override
