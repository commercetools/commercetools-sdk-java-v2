...
/**
 *  <p>Field type for <a href="https://docs.commercetools.com/apis/ctp:api:type:Time" rel="nofollow">Time</a> values.</p>
 *
 * <hr>
...
public interface CustomFieldTimeType extends FieldType {
     ...
     */
    public static tools.jackson.core.type.TypeReference<CustomFieldTimeType> typeReference() {
        return new tools.jackson.core.type.TypeReference<CustomFieldTimeType>() {
            @Override
