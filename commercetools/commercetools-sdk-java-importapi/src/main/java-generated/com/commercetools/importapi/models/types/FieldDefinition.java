...
import com.commercetools.importapi.models.types.FieldDefinitionImpl;
...
public interface FieldDefinition  {
    ...
    public static FieldDefinition deepCopy(@Nullable final FieldDefinition template) {
        ...
        FieldDefinitionImpl instance = new FieldDefinitionImpl();
        instance.setType(com.commercetools.importapi.models.types.FieldType.deepCopy(template.getType()));
        instance.setName(template.getName());
