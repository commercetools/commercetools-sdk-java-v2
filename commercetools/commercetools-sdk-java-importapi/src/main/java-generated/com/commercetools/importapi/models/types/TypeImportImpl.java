...
public class TypeImportImpl implements TypeImport, ModelBase {
     ...
     */
    @JsonCreator
    TypeImportImpl(@JsonProperty("key") final String key, @JsonProperty("name") final com.commercetools.importapi.models.common.LocalizedString name, @JsonProperty("description") final com.commercetools.importapi.models.common.LocalizedString description, @JsonProperty("resourceTypeIds") final java.util.List<com.commercetools.importapi.models.types.ResourceTypeId> resourceTypeIds, @JsonProperty("fieldDefinitions") final java.util.List<com.commercetools.importapi.models.types.FieldDefinition> fieldDefinitions) {
        this.key = key;
        this.name = name;
    ...
    public void setResourceTypeIds(final java.util.List<com.commercetools.importapi.models.types.ResourceTypeId> resourceTypeIds){
       this.resourceTypeIds = resourceTypeIds;
    }
    
    
    public void setFieldDefinitions(final com.commercetools.importapi.models.types.FieldDefinition ...fieldDefinitions){
       this.fieldDefinitions = new ArrayList<>(Arrays.asList(fieldDefinitions));
    }
    
    
    public void setFieldDefinitions(final java.util.List<com.commercetools.importapi.models.types.FieldDefinition> fieldDefinitions){
       this.fieldDefinitions = fieldDefinitions;
    }
