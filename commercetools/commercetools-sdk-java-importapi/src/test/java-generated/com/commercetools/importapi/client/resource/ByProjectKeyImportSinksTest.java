...
public class ByProjectKeyImportSinksTest {
    ...
    private Object[] requestWithMethodParameters() {
        return new Object[] {
                new Object[] {
                        apiRoot.withProjectKeyValue("test_projectKey").importSinks().post(null).createHttpRequest(),
                        "post", "/test_projectKey/import-sinks", },
                new Object[] { apiRoot.withProjectKeyValue("test_projectKey")
                        .importSinks()
                        .get()
                        .withLimit(0.26748633)
                        .createHttpRequest(), "get", "/test_projectKey/import-sinks?limit=0.26748633", },
                new Object[] { apiRoot.withProjectKeyValue("test_projectKey")
                        .importSinks()
                        .get()
    ...
    private Object[] executeMethodParameters() {
        return new Object[] { new Object[] { apiRoot.withProjectKeyValue("test_projectKey").importSinks().post(null), },
                new Object[] {
