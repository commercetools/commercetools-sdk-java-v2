...
public class PriceTierTest {
    ...
    public static Object[][] objectBuilder() {
        return new Object[][] { new Object[] { PriceTier.builder().minimumQuantity(1L) }, new Object[] {
                PriceTier.builder().value(new com.commercetools.importapi.models.common.TypedMoneyImpl()) } };
    }
