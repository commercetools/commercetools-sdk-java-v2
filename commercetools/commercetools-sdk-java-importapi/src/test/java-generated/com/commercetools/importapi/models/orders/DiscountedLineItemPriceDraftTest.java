...
public class DiscountedLineItemPriceDraftTest {
        ...
        return new Object[][] {
                new Object[] { "value",
                        DiscountedLineItemPriceDraft.builder()
                                .value(new com.commercetools.importapi.models.common.MoneyImpl()) },
                new Object[] { "includedDiscounts",
                        DiscountedLineItemPriceDraft.builder()
                                .includedDiscounts(Collections.singletonList(
                                    new com.commercetools.importapi.models.orders.DiscountedLineItemPortionImpl())) } };
    }

    @Test
    public void value() {
        DiscountedLineItemPriceDraft value = DiscountedLineItemPriceDraft.of();
        value.setValue(new com.commercetools.importapi.models.common.MoneyImpl());
        Assertions.assertThat(value.getValue()).isEqualTo(new com.commercetools.importapi.models.common.MoneyImpl());
    }
    ...
    public void includedDiscounts() {
        ...
        value.setIncludedDiscounts(
            Collections.singletonList(new com.commercetools.importapi.models.orders.DiscountedLineItemPortionImpl()));
        Assertions.assertThat(value.getIncludedDiscounts())
                .isEqualTo(Collections
                        .singletonList(new com.commercetools.importapi.models.orders.DiscountedLineItemPortionImpl()));
    }
}
