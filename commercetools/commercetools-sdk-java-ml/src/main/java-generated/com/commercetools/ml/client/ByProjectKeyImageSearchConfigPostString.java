...
public class ByProjectKeyImageSearchConfigPostString extends StringBodyApiMethod<ByProjectKeyImageSearchConfigPostString, com.commercetools.ml.models.image_search_config.ImageSearchConfigResponse> {
    ...
    public ByProjectKeyImageSearchConfigPostString(final ApiHttpClient apiHttpClient, String projectKey, String imageSearchConfigRequest) {
        super(apiHttpClient);
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), imageSearchConfigRequest.getBytes(StandardCharsets.UTF_8));
    ...
    public int hashCode() {
        return new HashCodeBuilder(17, 37)
            .append(projectKey)
            .append(imageSearchConfigRequest)
            .toHashCode();
    }
