...
public class ByProjectKeyMissingDataAttributesRequestBuilder {
    ...
    public ByProjectKeyMissingDataAttributesPost post(com.commercetools.ml.models.missing_data.MissingAttributesSearchRequest missingAttributesSearchRequest) {
