...
public class ByProjectKeyRecommendationsProjectCategoriesByProductIdRequestBuilder {
    ...
    public ByProjectKeyRecommendationsProjectCategoriesByProductIdRequestBuilder(final ApiHttpClient apiHttpClient,
            final String projectKey, final String productId) {
