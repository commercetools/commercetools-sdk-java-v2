...
public class ByProjectKeySimilaritiesProductsPost extends BodyApiMethod<ByProjectKeySimilaritiesProductsPost, com.commercetools.ml.models.common.TaskToken, com.commercetools.ml.models.similar_products.SimilarProductSearchRequest> {
    ...
    protected ApiHttpRequest buildHttpRequest() {
        ...
        return new ApiHttpRequest(ApiHttpMethod.POST, URI.create(httpRequestPath), getHeaders(), io.vrap.rmf.base.client.utils.json.JsonUtils.executing(() -> apiHttpClient().getSerializerService().toJsonByteArray(similarProductSearchRequest)));
    ...
    public ByProjectKeySimilaritiesProductsPost withBody(com.commercetools.ml.models.similar_products.SimilarProductSearchRequest similarProductSearchRequest) {
