...
public class ByProjectKeySimilaritiesProductsRequestBuilder  {
    ...
    public ByProjectKeySimilaritiesProductsPost post(com.commercetools.ml.models.similar_products.SimilarProductSearchRequest similarProductSearchRequest) {
    ...
    public ByProjectKeySimilaritiesProductsPost post(UnaryOperator<com.commercetools.ml.models.similar_products.SimilarProductSearchRequestBuilder> op) {
        return post(op.apply(com.commercetools.ml.models.similar_products.SimilarProductSearchRequestBuilder.of()).build());
    }
