...
public class ProjectCategoryRecommendationPagedQueryResponseBuilder implements Builder<ProjectCategoryRecommendationPagedQueryResponse> {
    ...
    public ProjectCategoryRecommendationPagedQueryResponseBuilder plusResults( final com.commercetools.ml.models.category_recommendations.ProjectCategoryRecommendation ...results) {
    ...
    public ProjectCategoryRecommendationPagedQueryResponseBuilder plusResults(Function<com.commercetools.ml.models.category_recommendations.ProjectCategoryRecommendationBuilder, com.commercetools.ml.models.category_recommendations.ProjectCategoryRecommendationBuilder> builder) {
        if (this.results == null) {
            this.results = new ArrayList<>();
        }
        this.results.add(builder.apply(com.commercetools.ml.models.category_recommendations.ProjectCategoryRecommendationBuilder.of()).build());
        return this;
    }
    ...
    public ProjectCategoryRecommendationPagedQueryResponseBuilder withResults(Function<com.commercetools.ml.models.category_recommendations.ProjectCategoryRecommendationBuilder, com.commercetools.ml.models.category_recommendations.ProjectCategoryRecommendationBuilder> builder) {
        this.results = new ArrayList<>();
        this.results.add(builder.apply(com.commercetools.ml.models.category_recommendations.ProjectCategoryRecommendationBuilder.of()).build());
        return this;
    }
    ...
    public ProjectCategoryRecommendationPagedQueryResponseBuilder addResults(Function<com.commercetools.ml.models.category_recommendations.ProjectCategoryRecommendationBuilder, com.commercetools.ml.models.category_recommendations.ProjectCategoryRecommendation> builder) {
        return plusResults(builder.apply(com.commercetools.ml.models.category_recommendations.ProjectCategoryRecommendationBuilder.of()));
    }
    ...
    public ProjectCategoryRecommendationPagedQueryResponseBuilder setResults(Function<com.commercetools.ml.models.category_recommendations.ProjectCategoryRecommendationBuilder, com.commercetools.ml.models.category_recommendations.ProjectCategoryRecommendation> builder) {
        return results(builder.apply(com.commercetools.ml.models.category_recommendations.ProjectCategoryRecommendationBuilder.of()));
    }
    ...
    public ProjectCategoryRecommendationPagedQueryResponseBuilder meta(Function<com.commercetools.ml.models.category_recommendations.ProjectCategoryRecommendationMetaBuilder, com.commercetools.ml.models.category_recommendations.ProjectCategoryRecommendationMetaBuilder> builder) {
        this.meta = builder.apply(com.commercetools.ml.models.category_recommendations.ProjectCategoryRecommendationMetaBuilder.of()).build();
        return this;
    }
    ...
    public ProjectCategoryRecommendationPagedQueryResponseBuilder withMeta(Function<com.commercetools.ml.models.category_recommendations.ProjectCategoryRecommendationMetaBuilder, com.commercetools.ml.models.category_recommendations.ProjectCategoryRecommendationMeta> builder) {
        this.meta = builder.apply(com.commercetools.ml.models.category_recommendations.ProjectCategoryRecommendationMetaBuilder.of());
        return this;
    }
