...
public final class MissingImagesTaskStatusImpl implements MissingImagesTaskStatus {
    ...
    @JsonCreator
    MissingImagesTaskStatusImpl(@JsonProperty("state") final com.commercetools.ml.models.common.TaskStatusEnum state, @JsonProperty("expires") final java.time.ZonedDateTime expires, @JsonProperty("result") final com.commercetools.ml.models.missing_data.MissingImagesPagedQueryResult result) {
        this.state = state;
