...
import com.commercetools.ml.models.similar_products.ProductSetSelectorImpl;
...
public interface ProductSetSelector  {
    ...
    public static ProductSetSelector deepCopy(@Nullable final ProductSetSelector template) {
        ...
        ProductSetSelectorImpl instance = new ProductSetSelectorImpl();
        instance.setProjectKey(template.getProjectKey());
        instance.setProductIds(Optional.ofNullable(template.getProductIds())
                .map(ArrayList::new)
                .orElse(null));
        instance.setProductTypeIds(Optional.ofNullable(template.getProductTypeIds())
                .map(ArrayList::new)
                .orElse(null));
        instance.setStaged(template.getStaged());
        instance.setIncludeVariants(template.getIncludeVariants());
