...
public class SimilarProductPairBuilder implements Builder<SimilarProductPair> {
    ...
    public SimilarProductPairBuilder plusProducts( final com.commercetools.ml.models.similar_products.SimilarProduct ...products) {
    ...
    public SimilarProductPairBuilder plusProducts(Function<com.commercetools.ml.models.similar_products.SimilarProductBuilder, com.commercetools.ml.models.similar_products.SimilarProductBuilder> builder) {
        if (this.products == null) {
            this.products = new ArrayList<>();
        }
        this.products.add(builder.apply(com.commercetools.ml.models.similar_products.SimilarProductBuilder.of()).build());
        return this;
    }
    ...
    public SimilarProductPairBuilder withProducts(Function<com.commercetools.ml.models.similar_products.SimilarProductBuilder, com.commercetools.ml.models.similar_products.SimilarProductBuilder> builder) {
        this.products = new ArrayList<>();
        this.products.add(builder.apply(com.commercetools.ml.models.similar_products.SimilarProductBuilder.of()).build());
        return this;
    }
    ...
    public SimilarProductPairBuilder addProducts(Function<com.commercetools.ml.models.similar_products.SimilarProductBuilder, com.commercetools.ml.models.similar_products.SimilarProduct> builder) {
    ...
    public SimilarProductPairBuilder setProducts(Function<com.commercetools.ml.models.similar_products.SimilarProductBuilder, com.commercetools.ml.models.similar_products.SimilarProduct> builder) {
