...
public class ByProjectKeyImageSearchConfigPost {
    ...
    public ByProjectKeyImageSearchConfigPost addHeader(final String key, final String value) {
        this.headers.addHeader(key, value);
        return this;
    }
    
    public ByProjectKeyImageSearchConfigPost withHeaders(final ApiHttpHeaders headers) {
    ...
    public ByProjectKeyImageSearchConfigPost addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
        this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
        return this;
    }
    
    public ByProjectKeyImageSearchConfigPost setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
