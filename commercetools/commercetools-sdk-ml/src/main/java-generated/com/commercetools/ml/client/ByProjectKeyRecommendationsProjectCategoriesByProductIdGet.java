...
public class ByProjectKeyRecommendationsProjectCategoriesByProductIdGet {
    ...
    public ByProjectKeyRecommendationsProjectCategoriesByProductIdGet withConfidenceMin(final List<Double> confidenceMin){
    ...
    public ByProjectKeyRecommendationsProjectCategoriesByProductIdGet withConfidenceMax(final List<Double> confidenceMax){
