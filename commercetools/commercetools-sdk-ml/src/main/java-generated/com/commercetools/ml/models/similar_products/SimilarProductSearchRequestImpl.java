...
public final class SimilarProductSearchRequestImpl implements SimilarProductSearchRequest {
    ...
    @JsonCreator
    SimilarProductSearchRequestImpl(@JsonProperty("limit") final Long limit, @JsonProperty("offset") final Long offset, @JsonProperty("language") final String language, @JsonProperty("currencyCode") final String currencyCode, @JsonProperty("similarityMeasures") final com.commercetools.ml.models.similar_products.SimilarityMeasures similarityMeasures, @JsonProperty("productSetSelectors") final java.util.List<com.commercetools.ml.models.similar_products.ProductSetSelector> productSetSelectors, @JsonProperty("confidenceMin") final Double confidenceMin, @JsonProperty("confidenceMax") final Double confidenceMax) {
        this.limit = limit;
        this.offset = offset;
