...
public class ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsGet {
   ...
   public ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsGet addLimit(final Integer limit){
      this.limit.add(limit);
      return this;
   }
   
   public ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsGet withLimit(final List<Integer> limit){
      this.limit = limit;
      return this;
   }
   
   public ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsGet addOffset(final Integer offset){
      this.offset.add(offset);
      return this;
   }
   
   public ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsGet withOffset(final List<Integer> offset){
      this.offset = offset;
      return this;
   }
   ...
   public ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsGet addHeader(final String key, final String value) {
