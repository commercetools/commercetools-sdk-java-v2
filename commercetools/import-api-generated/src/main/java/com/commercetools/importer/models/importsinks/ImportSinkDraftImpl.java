...
public final class ImportSinkDraftImpl implements ImportSinkDraft {
   ...
   @JsonCreator
   ImportSinkDraftImpl(@JsonProperty("version") final Long version, @JsonProperty("key") final String key, @JsonProperty("resourceType") final com.commercetools.importer.models.common.ImportResourceType resourceType) {
