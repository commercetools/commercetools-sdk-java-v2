...
public final class ImportSinkPagedResponseImpl implements ImportSinkPagedResponse {
   ...
   @JsonCreator
   ImportSinkPagedResponseImpl(@JsonProperty("limit") final Integer limit, @JsonProperty("offset") final Integer offset, @JsonProperty("count") final Integer count, @JsonProperty("results") final java.util.List<com.commercetools.importer.models.importsinks.ImportSink> results) {
      this.limit = limit;
      this.offset = offset;
      this.count = count;
