...
public final class ProductVariantPatchImpl implements ProductVariantPatch {
   ...
   @JsonCreator
   ProductVariantPatchImpl(@JsonProperty("productVariant") final com.commercetools.importer.models.common.ProductVariantKeyReference productVariant, @JsonProperty("product") final com.commercetools.importer.models.common.ProductKeyReference product, @JsonProperty("attributes") final com.commercetools.importer.models.productvariants.Attributes attributes) {
