...
public class ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyRequestBuilder {
   ...
   public ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyPost post(com.commercetools.api.generated.models.common.Update update) {
      return new ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyPost(apiHttpClient, projectKey, storeKey, key, update);
   }
