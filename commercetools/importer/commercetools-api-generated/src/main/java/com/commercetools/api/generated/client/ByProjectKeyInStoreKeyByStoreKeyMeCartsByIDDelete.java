...
public class ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDDelete {
   ...
   public ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDDelete addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDDelete withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDDelete addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDDelete setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
