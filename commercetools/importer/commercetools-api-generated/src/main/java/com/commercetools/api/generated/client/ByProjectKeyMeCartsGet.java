...
public class ByProjectKeyMeCartsGet {
   ...
   public ApiHttpResponse<com.commercetools.api.generated.models.cart.CartPagedQueryResponse> executeBlocking(){
      try {
          return execute().get();
      } catch (Exception e) {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.generated.models.cart.CartPagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  if(response.getStatusCode() >= 400){
                      throw new ApiHttpException(response.getStatusCode(), new String(response.getBody()), response.getHeaders());
                  }
                  return Utils.convertResponse(response,com.commercetools.api.generated.models.cart.CartPagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyMeCartsGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyMeCartsGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyMeCartsGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyMeCartsGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
