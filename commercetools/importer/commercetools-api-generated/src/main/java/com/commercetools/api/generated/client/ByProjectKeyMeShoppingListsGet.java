...
public class ByProjectKeyMeShoppingListsGet {
   ...
   public ByProjectKeyMeShoppingListsGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyMeShoppingListsGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyMeShoppingListsGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyMeShoppingListsGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
