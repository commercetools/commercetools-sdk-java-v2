...
public class ByProjectKeyOrdersGet {
   ...
   public ApiHttpResponse<com.commercetools.api.generated.models.order.OrderPagedQueryResponse> executeBlocking(){
      try {
          return execute().get();
      } catch (Exception e) {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.generated.models.order.OrderPagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  if(response.getStatusCode() >= 400){
                      throw new ApiHttpException(response.getStatusCode(), new String(response.getBody()), response.getHeaders());
                  }
                  return Utils.convertResponse(response,com.commercetools.api.generated.models.order.OrderPagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyOrdersGet addHeader(final String key, final String value) {
      this.headers.addHeader(key, value);
      return this;
   }
   
   public ByProjectKeyOrdersGet withHeaders(final ApiHttpHeaders headers) {
   ...
   public ByProjectKeyOrdersGet addAdditionalQueryParam(final String additionalQueryParamKey, final String additionalQueryParamValue) {
      this.additionalQueryParams.put(additionalQueryParamKey, additionalQueryParamValue);
      return this;
   }
   
   public ByProjectKeyOrdersGet setAdditionalQueryParams(final Map<String, String> additionalQueryParams) {
