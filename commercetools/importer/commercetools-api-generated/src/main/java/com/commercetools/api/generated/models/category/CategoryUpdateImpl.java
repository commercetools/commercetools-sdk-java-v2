...
public final class CategoryUpdateImpl implements CategoryUpdate {
   ...
   @JsonCreator
   CategoryUpdateImpl(@JsonProperty("actions") final java.util.List<com.commercetools.api.generated.models.category.CategoryUpdateAction> actions, @JsonProperty("version") final Long version) {
   ...
   public void setActions(final java.util.List<com.commercetools.api.generated.models.category.CategoryUpdateAction> actions){
      this.actions = actions;
   }
