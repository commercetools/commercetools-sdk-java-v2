...
public final class DuplicateVariantValuesErrorImpl implements DuplicateVariantValuesError {
   ...
   @JsonCreator
   DuplicateVariantValuesErrorImpl(@JsonProperty("message") final String message, @JsonProperty("variantValues") final com.commercetools.api.generated.models.error.VariantValues variantValues) {
   ...
   public void setVariantValues(final com.commercetools.api.generated.models.error.VariantValues variantValues){
      this.variantValues = variantValues;
   }
