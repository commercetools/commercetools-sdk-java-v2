...
public final class StagedOrderSetParcelItemsActionImpl implements StagedOrderSetParcelItemsAction {
   ...
   @JsonCreator
   StagedOrderSetParcelItemsActionImpl(@JsonProperty("items") final java.util.List<com.commercetools.api.generated.models.order.DeliveryItem> items, @JsonProperty("parcelId") final String parcelId) {
      this.items = items;
