...
public final class StagedOrderTransitionStateActionImpl implements StagedOrderTransitionStateAction {
   ...
   @JsonCreator
   StagedOrderTransitionStateActionImpl(@JsonProperty("force") final Boolean force, @JsonProperty("state") final com.commercetools.api.generated.models.state.StateResourceIdentifier state) {
      this.force = force;
      this.state = state;
