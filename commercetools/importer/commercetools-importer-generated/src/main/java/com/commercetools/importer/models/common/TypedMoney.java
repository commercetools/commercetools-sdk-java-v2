...
@JsonSubTypes({
   @JsonSubTypes.Type(value = com.commercetools.importer.models.common.HighPrecisionMoneyImpl.class, name = "highPrecision"),
   @JsonSubTypes.Type(value = com.commercetools.importer.models.common.MoneyImpl.class, name = "centPrecision")
})
@JsonTypeInfo(
