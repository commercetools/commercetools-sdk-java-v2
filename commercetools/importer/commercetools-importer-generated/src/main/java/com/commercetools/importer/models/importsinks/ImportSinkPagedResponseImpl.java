...
public final class ImportSinkPagedResponseImpl implements ImportSinkPagedResponse {
    ...
    @JsonCreator
    ImportSinkPagedResponseImpl(@JsonProperty("limit") final Double limit, @JsonProperty("offset") final Double offset, @JsonProperty("count") final Double count, @JsonProperty("results") final java.util.List<com.commercetools.importer.models.importsinks.ImportSink> results) {
        this.limit = limit;
        this.offset = offset;
        this.count = count;
