...
public final class ShippingRateDraftImpl implements ShippingRateDraft {
    ...
    private com.commercetools.importer.models.common.Money freeAbove;
    
    private java.util.List<com.commercetools.importer.models.orders.ShippingRatePriceTier> tiers;

    @JsonCreator
    ShippingRateDraftImpl(@JsonProperty("price") final com.commercetools.importer.models.common.Money price, @JsonProperty("freeAbove") final com.commercetools.importer.models.common.Money freeAbove, @JsonProperty("tiers") final java.util.List<com.commercetools.importer.models.orders.ShippingRatePriceTier> tiers) {
        this.price = price;
    ...
    public com.commercetools.importer.models.common.Money getFreeAbove(){
    ...
    public void setFreeAbove(final com.commercetools.importer.models.common.Money freeAbove){
        this.freeAbove = freeAbove;
    }
