...
public final class AttributeLocalizedEnumTypeImpl implements AttributeLocalizedEnumType {
    ...
    @JsonCreator
    AttributeLocalizedEnumTypeImpl(@JsonProperty("values") final java.util.List<com.commercetools.importer.models.producttypes.AttributeLocalizedEnumValue> values) {
        this.values = values;
        this.name = "lenum";
    }
    ...
    public void setValues(final java.util.List<com.commercetools.importer.models.producttypes.AttributeLocalizedEnumValue> values){
        this.values = values;
    }
