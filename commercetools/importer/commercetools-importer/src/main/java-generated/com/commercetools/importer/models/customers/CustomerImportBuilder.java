...
public final class CustomerImportBuilder {
    ...
    public CustomerImportBuilder customerGroup(@Nullable final com.commercetools.importer.models.common.CustomerGroupKeyReference customerGroup) {
        this.customerGroup = customerGroup;
        return this;
    }
    
    public CustomerImportBuilder addresses(@Nullable final java.util.List<com.commercetools.importer.models.common.Address> addresses) {
        this.addresses = addresses;
        return this;
    }
    
    public CustomerImportBuilder defaultBillingAddress(@Nullable final com.commercetools.importer.models.common.Address defaultBillingAddress) {
        this.defaultBillingAddress = defaultBillingAddress;
        return this;
    }
    
    public CustomerImportBuilder billingAddresses(@Nullable final com.commercetools.importer.models.common.Address billingAddresses) {
        this.billingAddresses = billingAddresses;
        return this;
    }
    
    public CustomerImportBuilder defaultShippingAddress(@Nullable final com.commercetools.importer.models.common.Address defaultShippingAddress) {
        this.defaultShippingAddress = defaultShippingAddress;
        return this;
    }
    
    public CustomerImportBuilder shippingAddresses(@Nullable final com.commercetools.importer.models.common.Address shippingAddresses) {
    ...
    public CustomerImportBuilder custom(@Nullable final com.commercetools.importer.models.customfields.Custom custom) {
        this.custom = custom;
        return this;
    }
    ...
    public CustomerImport build() {
        return new CustomerImportImpl(key, customerNumber, email, password, firstName, lastName, middleName, title, salutation, externalId, dateOfBirth, companyName, vatId, isEmailVerified, customerGroup, addresses, defaultBillingAddress, billingAddresses, defaultShippingAddress, shippingAddresses, locale, custom);
    }
