...
public final class OrderImportRequestImpl implements OrderImportRequest {
    ...
    @JsonCreator
    OrderImportRequestImpl(@JsonProperty("resources") final java.util.List<com.commercetools.importer.models.orders.OrderImport> resources) {
    ...
    */
    ...
    public void setResources(final java.util.List<com.commercetools.importer.models.orders.OrderImport> resources){
        this.resources = resources;
    }
