...
public class ByProjectKeyProductVariantPatchesImportSinkKeyByImportSinkKeyPost {
   ...
   private com.commercetools.importer.models.importrequests.ProductVariantPatchRequest productVariantPatchRequest;
   
   public ByProjectKeyProductVariantPatchesImportSinkKeyByImportSinkKeyPost(final ApiHttpClient apiHttpClient, String projectKey, String importSinkKey, com.commercetools.importer.models.importrequests.ProductVariantPatchRequest productVariantPatchRequest){
   ...
   public ByProjectKeyProductVariantPatchesImportSinkKeyByImportSinkKeyPost addHeader(final String key, final String value) {
