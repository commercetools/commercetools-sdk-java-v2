...
/**
    ...
    {@include.example com.commercetools.compat.CompatClientTest#compatClient()}

    <h3>Using a SphereClient with the v2 SDK</h3>

    <p></p>

    {@include.example com.commercetools.compat.CompatClientTest#compatClientCategories()}
 */
