...
public class ByProjectKeyMissingDataAttributesStatusByTaskIdGet {
   ...
   public ApiHttpResponse<com.commercetools.api.ml.generated.models.missing_data.MissingDataTaskStatus> executeBlocking(){
      try {
          return execute().get();
      } catch (Exception e) {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.ml.generated.models.missing_data.MissingDataTaskStatus>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  if(response.getStatusCode() >= 400){
                      throw new ApiHttpException(response.getStatusCode(), new String(response.getBody()), response.getHeaders());
                  }
                  return Utils.convertResponse(response,com.commercetools.api.ml.generated.models.missing_data.MissingDataTaskStatus.class);
              });
   }
