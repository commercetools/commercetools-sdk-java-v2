...
public class ByProjectKeyRecommendationsGeneralCategoriesGet {
   ...
   public ApiHttpResponse<com.commercetools.api.ml.generated.models.general_category_recommendations.GeneralCategoryRecommendationPagedQueryResponse> executeBlocking(){
      try {
          return execute().get();
      } catch (Exception e) {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.ml.generated.models.general_category_recommendations.GeneralCategoryRecommendationPagedQueryResponse>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  if(response.getStatusCode() >= 400){
                      throw new ApiHttpException(response.getStatusCode(), new String(response.getBody()), response.getHeaders());
                  }
                  return Utils.convertResponse(response,com.commercetools.api.ml.generated.models.general_category_recommendations.GeneralCategoryRecommendationPagedQueryResponse.class);
              });
   }
   ...
   public ByProjectKeyRecommendationsGeneralCategoriesGet addConfidenceMin(final Integer confidenceMin){
      this.confidenceMin.add(confidenceMin);
      return this;
   }
   
   public ByProjectKeyRecommendationsGeneralCategoriesGet withConfidenceMin(final List<Integer> confidenceMin){
      this.confidenceMin = confidenceMin;
      return this;
   }
   
   public ByProjectKeyRecommendationsGeneralCategoriesGet addConfidenceMax(final Integer confidenceMax){
      this.confidenceMax.add(confidenceMax);
      return this;
   }
   
   public ByProjectKeyRecommendationsGeneralCategoriesGet withConfidenceMax(final List<Integer> confidenceMax){
