...
public class ByProjectKeySimilaritiesProductsStatusByTaskIdGet {
   ...
   public ApiHttpResponse<com.commercetools.api.ml.generated.models.similar_products.SimilarProductsTaskStatus> executeBlocking(){
      try {
          return execute().get();
      } catch (Exception e) {
   ...
   public CompletableFuture<ApiHttpResponse<com.commercetools.api.ml.generated.models.similar_products.SimilarProductsTaskStatus>> execute(){
      return apiHttpClient.execute(this.createHttpRequest())
              .thenApply(response -> {
                  if(response.getStatusCode() >= 400){
                      throw new ApiHttpException(response.getStatusCode(), new String(response.getBody()), response.getHeaders());
                  }
                  return Utils.convertResponse(response,com.commercetools.api.ml.generated.models.similar_products.SimilarProductsTaskStatus.class);
              });
   }
