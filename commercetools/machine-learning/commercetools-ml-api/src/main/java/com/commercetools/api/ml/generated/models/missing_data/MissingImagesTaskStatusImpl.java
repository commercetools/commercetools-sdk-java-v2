...
public final class MissingImagesTaskStatusImpl implements MissingImagesTaskStatus {
   ...
   @JsonCreator
   MissingImagesTaskStatusImpl(@JsonProperty("state") final TaskStatusEnum state, @JsonProperty("expires") final ZonedDateTime expires, @JsonProperty("result") final com.commercetools.api.ml.generated.models.missing_data.MissingImagesPagedQueryResult result) {
      this.state = state;
