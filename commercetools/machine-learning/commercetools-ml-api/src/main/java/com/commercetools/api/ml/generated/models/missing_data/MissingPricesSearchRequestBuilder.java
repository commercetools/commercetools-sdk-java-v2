...
import com.commercetools.api.ml.generated.models.missing_data.MissingPricesSearchRequest;
...
public final class MissingPricesSearchRequestBuilder {
   ...
   public MissingPricesSearchRequest build() {
       return new MissingPricesSearchRequestImpl(limit, offset, staged, productSetLimit, includeVariants, currencyCode, checkDate, validFrom, validUntil, productIds, productTypeIds);
   }
