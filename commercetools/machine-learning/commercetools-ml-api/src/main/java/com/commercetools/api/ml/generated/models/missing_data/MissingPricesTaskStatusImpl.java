...
public final class MissingPricesTaskStatusImpl implements MissingPricesTaskStatus {
   ...
   @JsonCreator
   MissingPricesTaskStatusImpl(@JsonProperty("state") final TaskStatusEnum state, @JsonProperty("expires") final ZonedDateTime expires, @JsonProperty("result") final com.commercetools.api.ml.generated.models.missing_data.MissingPricesPagedQueryResult result) {
      this.state = state;
