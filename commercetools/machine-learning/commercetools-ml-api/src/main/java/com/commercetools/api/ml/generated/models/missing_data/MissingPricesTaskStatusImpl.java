...
public final class MissingPricesTaskStatusImpl implements MissingPricesTaskStatus {
   ...
   @JsonCreator
   MissingPricesTaskStatusImpl(@JsonProperty("state") final com.commercetools.api.ml.generated.models.common.TaskStatusEnum state, @JsonProperty("expires") final java.time.ZonedDateTime expires, @JsonProperty("result") final com.commercetools.api.ml.generated.models.missing_data.MissingPricesPagedQueryResult result) {
      this.state = state;
   ...
   */
   ...
   public void setResult(final com.commercetools.api.ml.generated.models.missing_data.MissingPricesPagedQueryResult result){
      this.result = result;
   }
