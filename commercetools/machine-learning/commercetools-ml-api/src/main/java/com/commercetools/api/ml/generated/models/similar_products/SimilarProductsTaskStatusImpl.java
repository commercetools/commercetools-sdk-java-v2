...
public final class SimilarProductsTaskStatusImpl implements SimilarProductsTaskStatus {
   ...
   @JsonCreator
   SimilarProductsTaskStatusImpl(@JsonProperty("state") final com.commercetools.api.ml.generated.models.common.TaskStatusEnum state, @JsonProperty("expires") final java.time.ZonedDateTime expires, @JsonProperty("result") final com.commercetools.api.ml.generated.models.similar_products.SimilarProductsPagedQueryResult result) {
      this.state = state;
   ...
   */
   ...
   public void setResult(final com.commercetools.api.ml.generated.models.similar_products.SimilarProductsPagedQueryResult result){
      this.result = result;
   }
