...
public final class SimilarProductsTaskStatusImpl implements SimilarProductsTaskStatus {
   ...
   @JsonCreator
   SimilarProductsTaskStatusImpl(@JsonProperty("state") final TaskStatusEnum state, @JsonProperty("expires") final ZonedDateTime expires, @JsonProperty("result") final com.commercetools.api.ml.generated.models.similar_products.SimilarProductsPagedQueryResult result) {
      this.state = state;
