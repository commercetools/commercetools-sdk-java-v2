...
public final class ProjectCategoryRecommendationImpl implements ProjectCategoryRecommendation {
   ...
   @JsonCreator
   ProjectCategoryRecommendationImpl(@JsonProperty("category") final com.commercetools.ml.models.common.CategoryReference category, @JsonProperty("confidence") final Integer confidence, @JsonProperty("path") final String path) {
