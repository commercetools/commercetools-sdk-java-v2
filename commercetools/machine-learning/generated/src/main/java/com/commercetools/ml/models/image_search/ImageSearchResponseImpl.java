...
public final class ImageSearchResponseImpl implements ImageSearchResponse {
   ...
   @JsonCreator
   ImageSearchResponseImpl(@JsonProperty("count") final Integer count, @JsonProperty("offset") final Integer offset, @JsonProperty("total") final Integer total, @JsonProperty("results") final java.util.List<com.commercetools.ml.models.image_search.ResultItem> results) {
      this.count = count;
      this.offset = offset;
      this.total = total;
