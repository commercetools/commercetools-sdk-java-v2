...
public class ApiHttpException extends BaseException {
    ...
    public ApiHttpException(final int statusCode, @Nullable final String body, @Nullable final ApiHttpHeaders headers, @Nullable final String message, @Nullable final ApiHttpResponse<byte[]> response, @Nullable final ApiHttpRequest request) {
        super(message);
    ...
    public final String getMessage() {
        return Optional.ofNullable(super.getMessage()).map(s -> "detailMessage: " + s + "\n").orElse("") +
                ...
                "http response: " + Optional.ofNullable(getResponse()).map(Object::toString).orElse("<unknown>") + "\n" +
