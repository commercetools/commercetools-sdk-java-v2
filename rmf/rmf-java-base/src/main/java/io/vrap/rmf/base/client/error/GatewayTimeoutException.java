...
public class GatewayTimeoutException extends ApiServerException {
    ...
    public GatewayTimeoutException(final int statusCode, final String body, final ApiHttpHeaders headers, final String message, final ApiHttpResponse<byte[]> response, final ApiHttpRequest request) {
