...
public class CommercetoolsObjectMapperTests {
    ...
    public void deserializeZonedDateTime() throws IOException {
        ...
        ZonedDateTime zonedDateTime = VrapJsonUtils.fromJsonString(zonedDateTimeSerialized, ZonedDateTime.class);
    ...
    public void deserializeLocalDate() throws IOException {
        ...
        LocalDate localDate = VrapJsonUtils.fromJsonString(localDateSerialized, LocalDate.class);
    ...
    public void deserializeLocalTime() throws IOException {
        ...
        LocalTime localTime = VrapJsonUtils.fromJsonString(localTimeSerialized, LocalTime.class);
